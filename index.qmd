...
For details on the conventions used in this book, check out the [Conventions](./conventions.qmd) section.
...
A big thanks to everyone who's helped make this book what it is! You can see the full list of individual contributors [here](./contributors.qmd) and additional GitHub style details [here](https://github.com/harvard-edge/cs249r_book/graphs/contributors). Join us as a contributor!