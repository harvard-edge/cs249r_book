...
When referencing this book in your research, academic papers, or professional documents, please adhere to the below citation format. This ensures that the book is appropriately credited and easily identifiable in academic and professional contexts.

```@book{mlsysbook,
      title={Machine Learning Systems for TinyML}, 
      year={2023},
      publisher={Open Source Press},
      author={Reddi, Vijay Janapa, and Stewart, Matthew, and Uchendu, Ikechukwu, and others},
      doi={10.5281/zenodo.5520405},
