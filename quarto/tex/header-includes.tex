...
% Table captions: Small font, bold label, centered
...
% Changed from \scriptsize to \small for better Windows LaTeX compatibility
% \scriptsize was too aggressive and caused "Infinite glue shrinkage" errors
\AtBeginEnvironment{longtable}{\small}

% Increase vertical spacing in table cells (default is 1.0)
% Reduced from 1.4 to 1.3 for better page breaking on Windows
