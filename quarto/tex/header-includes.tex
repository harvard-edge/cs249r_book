...
\usepackage[verbose]{placeins} % logs each FloatBarrier, helpful in Quarto
\usepackage{trace} % if installed, or use the kernel tracing below

% Kernel tracing, turn on briefly to inspect page making
\tracingpages=1
...
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{latexsym}  % Additional symbols like \Diamond
\usepackage{pifont}   % For additional symbols
% Define blacklozenge if it doesn't exist
\providecommand{\blacklozenge}{\ding{117}}  % Black diamond from pifont
\usepackage{enumitem}
