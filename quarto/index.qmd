...
<style>
  ...
  .abstract-content {
    /* Text will flow around the floated book card */
  }
...
<div class="abstract-section">
  ...
  <a href="https://mlsysbook.ai/pdf" target="_blank" class="book-card-link" title="Download PDF version">
    <div class="book-card">
      ...
      <p style="font-size: 0.8em; color: #6c757d; margin-top: 8px;">📖 Click anywhere to download PDF</p>
    </div>
  </a>
</div>
```
