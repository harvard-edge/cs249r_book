...
: Maliciously crafted inputs designed to fool machine learning models into making incorrect predictions, often by adding imperceptible perturbations to legitimate data
...
**autoencoder**
: A neural network architecture that learns to compress data into a lower-dimensional representation and then reconstruct the original data, often used as a building block for generative models
...
: Specialized processor designed specifically for artificial neural network computations, optimized for the mathematical operations common in machine learning workloads
  *Appears in: @sec-benchmarking, @sec-hw-acceleration*
...
: Google's custom ASIC designed specifically for neural network workloads, achieving significant performance and energy efficiency improvements over general-purpose processors
  *Appears in: @sec-benchmarking, @sec-hw-acceleration*
...
*Generated on 2025-09-15 at 16:32*
