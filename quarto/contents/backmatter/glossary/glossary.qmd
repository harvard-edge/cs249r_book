...
: A pruning method that evaluates the average activation values of neurons or filters over a dataset to identify and remove neurons that consistently produce low activations and contribute little information to the network's decision process.
  *Chapter: @sec-model-optimizations*
...
: A training technique where two neural networks compete against each other, with one generating data and another trying to distinguish real from generated content
  *Appears in: @sec-generative-ai, @sec-security-privacy, @sec-responsible-ai, @sec-robust-ai*
...
: A hypothetical form of AI that matches or exceeds human cognitive abilities across all domains, representing the ultimate goal of AI research beyond current narrow AI systems.
  *Chapter: @sec-frontiers-ml-systems*
...
: Automated Machine Learning that uses machine learning itself to automate model design decisions, including architecture search, hyperparameter optimization, and feature selection to create efficient models without manual intervention
  *Appears in: @sec-efficient-ai, @sec-frontiers-ml-systems, @sec-model-optimizations*
...
: The ability of machine learning systems to learn continuously from a stream of data while retaining previously acquired knowledge, addressing the challenge of catastrophic forgetting in neural networks
  *Appears in: @sec-frontiers-ml-systems, @sec-ondevice-learning, @sec-robust-ai*
...
: A distributed training strategy that splits the dataset across multiple devices while each device maintains a complete copy of the model, enabling parallel computation of gradients.
  *Appears in: @sec-benchmarking-ai, @sec-efficient-ai, @sec-ai-training*
...
: A machine learning approach that trains algorithms across decentralized edge devices or servers holding local data samples, without exchanging the raw data.
  *Appears in: @sec-ai-good, @sec-conclusion, @sec-ai-frameworks, @sec-frontiers-ml-systems, @sec-ml-systems, @sec-ondevice-learning, @sec-security-privacy, @sec-responsible-ai, @sec-sustainable-ai, @sec-ai-workflow*
...
: Large-scale machine learning models trained on broad data that can be adapted to a wide range of downstream tasks, serving as a base for specialized applications.
  *Appears in: @sec-generative-ai, @sec-ml-systems*
...
: Large-scale, general-purpose AI models trained on broad data that can be adapted for many tasks, including models like GPT-3, BERT, and DALL-E with billions of parameters
  *Appears in: @sec-efficient-ai, @sec-frontiers-ml-systems*
...
: A model compression technique where a smaller "student" network learns to mimic the behavior of a larger "teacher" network by training on the teacher's soft output probabilities rather than just hard labels
  *Appears in: @sec-efficient-ai, @sec-ondevice-learning, @sec-model-optimizations, @sec-sustainable-ai*
...
: The process of learning how to learn, where models are trained to quickly adapt to new tasks with minimal data, particularly useful for personalization in on-device systems
  *Appears in: @sec-frontiers-ml-systems, @sec-ondevice-learning*
...
: An automated approach that uses machine learning algorithms to discover optimal neural network architectures by searching through possible combinations of layers, connections, and hyperparameters for specific constraints
  *Appears in: @sec-efficient-ai, @sec-frontiers-ml-systems, @sec-model-optimizations, @sec-sustainable-ai*
...
: Computing architectures inspired by the structure and function of biological neural networks, designed to process information more efficiently than traditional digital computers
  *Appears in: @sec-conclusion, @sec-frontiers-ml-systems*
...
: The practice of designing and optimizing text prompts to effectively communicate with large language models and achieve desired outputs from AI systems
  *Appears in: @sec-frontiers-ml-systems, @sec-generative-ai*
...
: The practice of developing and deploying AI systems in ways that are ethical, fair, transparent, and beneficial to society while minimizing potential harms and biases
  *Appears in: @sec-frontiers-ml-systems, @sec-responsible-ai*
...
: A machine learning technique that leverages knowledge gained from pre-trained models on related tasks, allowing faster training and better performance on new tasks with limited data by reusing learned features and representations
  *Appears in: @sec-conclusion, @sec-data-engineering, @sec-efficient-ai, @sec-ai-frameworks, @sec-frontiers-ml-systems, @sec-ondevice-learning, @sec-robust-ai, @sec-sustainable-ai, @sec-ai-workflow*
...
: A neural network architecture based entirely on attention mechanisms, eliminating recurrence and convolution while achieving state-of-the-art performance across many domains.
  *Appears in: @sec-benchmarking-ai, @sec-dnn-architectures, @sec-efficient-ai, @sec-generative-ai, @sec-sustainable-ai*
...
*Generated on 2025-09-15 at 19:03*
