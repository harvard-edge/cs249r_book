...
## Overview {#sec-agi-systems-overview-8d3a}
...
Energy-based models offer an alternative framework that could bridge this gap, providing optimization-driven reasoning that mimics how biological systems solve problems through energy minimization (detailed in @sec-agi-systems-energybased-models-optimization-intelligence-79ea). Rather than predicting the most probable next token, these systems find configurations that minimize global energy functions, potentially enabling genuine reasoning about cause and effect.
...
Beyond routing efficiency, compound systems require memory architectures that scale beyond individual model constraints. As detailed in @sec-agi-systems-state-space-models-linear-longcontext-scaling-d552, transformers face quadratic memory scaling with sequence length, limiting knowledge access during inference and preventing long-context reasoning across system components.
...
## Beyond Transformers: New Architectures {#sec-agi-systems-beyond-transformers-new-architectures-8915}
...
### State Space Models: Linear Long-Context Scaling {#sec-agi-systems-state-space-models-linear-longcontext-scaling-d552}
...
### Energy-Based Models: Optimization Intelligence {#sec-agi-systems-energybased-models-optimization-intelligence-79ea}
...
### World Models and Predictive Learning {#sec-agi-systems-world-models-predictive-learning-f0fd}
...
### Architectural Synthesis: Future Pathways {#sec-agi-systems-architectural-synthesis-future-pathways-4325}
...
### Training Compound Intelligence {#sec-agi-systems-training-compound-intelligence-0058}
...
#### Alignment Across Components {#sec-agi-systems-alignment-across-components-713b}
...
#### Human Feedback for Component Training {#sec-agi-systems-human-feedback-component-training-1391}
...
#### Constitutional AI: Principled Self-Improvement {#sec-agi-systems-constitutional-ai-principled-selfimprovement-7b17}
...
#### Continual Learning: Adapting Without Forgetting {#sec-agi-systems-continual-learning-adapting-without-forgetting-ffcb}
...
### Infrastructure: Integration with Existing Systems {#sec-agi-systems-infrastructure-integration-existing-systems-9bed}
...
#### Optimization: Dynamic Intelligence Allocation {#sec-agi-systems-optimization-dynamic-intelligence-allocation-8908}
...
#### Hardware: Scaling Beyond Moore's Law {#sec-agi-systems-hardware-scaling-beyond-moores-law-df35}
...
[^fn-moores-end]: **End of Moore's Law**: Transistor density improvements slowed dramatically due to physical limits including quantum tunneling at 3-5nm nodes, manufacturing costs exceeding $20B per fab, and power density approaching extreme levels. This requires exploration of alternative computing paradigms.
...
#### Operations: Continuous System Evolution {#sec-agi-systems-operations-continuous-system-evolution-356a}
...
### Synthesis: Building Blocks Working in Concert {#sec-agi-systems-synthesis-building-blocks-working-concert-c2be}
...
### Context and Memory: Intelligence Bottlenecks {#sec-agi-systems-context-memory-intelligence-bottlenecks-0fe1}
...
### Energy and Sustainability: Scale Challenges {#sec-agi-systems-energy-sustainability-scale-challenges-9aab}
...
### Embodiment and Grounding: Symbol Problems {#sec-agi-systems-embodiment-grounding-symbol-problems-e35f}
...
## Engineering AGI: Opportunities and Challenges {#sec-agi-systems-engineering-agi-opportunities-challenges-bc9f}
...
### Opportunity Landscape: Infrastructure to Apps {#sec-agi-systems-opportunity-landscape-infrastructure-apps-aba9}
...
#### Infrastructure Platforms: The Foundation Layer {#sec-agi-systems-infrastructure-platforms-foundation-layer-30ee}
...
[^fn-realtime-requirements]: **Real-Time Latency Requirements**: Different applications impose strict timing constraints. The difference between 200ms and 2000ms changes interaction patterns: the former feels like conversation, the latter like operating a slow computer.
...
#### End-User Applications: Automation and Augmentation {#sec-agi-systems-enduser-applications-automation-augmentation-81c2}
...
### Challenge Landscape: Technical and Social Barriers {#sec-agi-systems-challenge-landscape-technical-social-barriers-33e4}
...
#### Technical Challenges: Reliability and Performance {#sec-agi-systems-technical-challenges-reliability-performance-fb00}
...
#### Operational Challenges: Testing and Deployment {#sec-agi-systems-operational-challenges-testing-deployment-898b}
...
#### Societal Challenges: Privacy, Alignment, and Access {#sec-agi-systems-societal-challenges-privacy-alignment-access-3cd7}
...
### Synthesis: Navigating Opportunities and Challenges {#sec-agi-systems-synthesis-navigating-opportunities-challenges-ffcb}
...
## Integrating Frameworks: Systems View of AGI {#sec-agi-systems-integrating-frameworks-systems-view-agi-d502}
...
### The Compound AI Systems Framework as Foundation {#sec-agi-systems-compound-ai-systems-framework-foundation-d767}
...
### Opportunities Aligned with Building Blocks {#sec-agi-systems-opportunities-aligned-building-blocks-36d7}

The opportunity landscape (@sec-agi-systems-opportunity-landscape-infrastructure-apps-aba9) emerges naturally from the building blocks explored earlier (@sec-agi-systems-data-engineering-scale-91a0 through @sec-agi-systems-synthesis-building-blocks-working-concert-c2be), with each category of opportunities mapping directly to specific technical capabilities.

Infrastructure opportunities including high-performance training platforms and post-Moore's Law hardware directly operationalize the hardware building block (@sec-agi-systems-hardware-scaling-beyond-moores-law-df35) and optimization advances (@sec-agi-systems-optimization-dynamic-intelligence-allocation-8908). These foundational platforms enable all higher-level capabilities by providing the computational substrate necessary for AGI-scale systems.

Foundation model opportunities such as efficient architectures and continual learning systems implement the architectural building blocks (@sec-agi-systems-dynamic-architectures-compound-systems-fca0) and training paradigms (@sec-agi-systems-training-compound-intelligence-0058). These models serve as the intelligent core components that power compound systems and end-user applications.
...
### Biological Principles as Cross-Cutting Insights {#sec-agi-systems-biological-principles-crosscutting-insights-c5f6}
...
### Framework Synthesis: Navigating AGI Development {#sec-agi-systems-framework-synthesis-navigating-agi-development-5e2b}

Integrating these frameworks provides strategic guidance for AGI development:

#### Architectural Decisions {#sec-agi-systems-architectural-decisions-26b7}
The compound AI framework guides system decomposition. When facing capability gaps, ask: "Can this be addressed through specialized components and orchestration, or does it require model innovations?" The former enables incremental progress; the latter demands research breakthroughs.

#### Resource Allocation {#sec-agi-systems-resource-allocation-9f01}
...
#### Risk Management {#sec-agi-systems-risk-management-5e8b}
...
#### Timeline Expectations {#sec-agi-systems-timeline-expectations-3de7}
Recognizing how frameworks interconnect tempers both excessive optimism and pessimism. Compound systems enable significant near-term progress without solving all barriers. Biological efficiency gaps suggest innovations remain necessary. AGI likely emerges through sustained engineering advances rather than single breakthroughs.

#### Skill Development {#sec-agi-systems-skill-development-7c42}
The framework integration reveals competencies required for AGI engineering. Systems thinking to decompose complex problems, distributed systems expertise to orchestrate components at scale, ML principles to build and train models, domain knowledge to guide specialization, and safety awareness to ensure beneficial deployment.

### Putting Frameworks into Practice {#sec-agi-systems-putting-frameworks-practice-c4e1}

For practicing ML systems engineers, this integrated view suggests concrete strategies:

#### Near-term (1-3 years) {#sec-agi-systems-nearterm-13-years-5def}
...
#### Medium-term (3-7 years) {#sec-agi-systems-mediumterm-37-years-b99c}
...
#### Long-term (7-15+ years) {#sec-agi-systems-longterm-715-years-032a}
