...
[^fn-agi-compute-requirements]: **AGI Compute Requirements**: Estimates range from 2.5 × 10²⁶ FLOPs based on scaling laws extrapolation to 6.3 × 10²³ operations using biological baselines (human brain processing over 20 years). This represents roughly 250× more compute than GPT-4's estimated training requirements. Estimates carry significant uncertainty (±1 order of magnitude) depending on architectural breakthroughs.

[^fn-agi-infrastructure-scale]: **AGI Infrastructure Scale**: Training an AGI system would require approximately 175,000 H100 GPUs running continuously for one year, consuming 159 MW of power. Total costs estimated at $52 billion including hardware ($5.25B), infrastructure ($15B), power ($10B), and operations ($20B). This unprecedented scale would require 14 petabytes of memory and 158 PB/s network bandwidth. Post-Moore's Law efficiency gains could reduce costs to $5-10B.
