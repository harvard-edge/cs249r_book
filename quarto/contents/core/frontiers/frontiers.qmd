...
[^fn-agi-compute-requirements]: **AGI Compute Requirements**: Estimates based on brain computation (10¹⁵-10¹⁶ operations/second for 20 years of learning) suggest 10²⁶-10²⁸ FLOPs total. Alternative estimates from scaling laws project similar requirements. Current frontier models (GPT-4: ~10²³ FLOPs) remain 3-5 orders of magnitude below these thresholds.
