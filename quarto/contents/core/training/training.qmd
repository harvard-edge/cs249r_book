...
These system limitations motivated the development of more efficient optimization approaches. SGD[^fn-training-sgd] is a big shift in the optimization strategy. Rather than computing gradients over the entire dataset, SGD estimates gradients using individual training examples:
...
[^fn-training-sgd]: **SGD (Stochastic Gradient Descent)**: First introduced by Herbert Robbins and Sutton Monro in 1951 for stochastic approximation, SGD became the foundation of modern ML training after Rumelhart et al.'s 1986 backpropagation paper, enabling neural networks to learn from individual examples rather than entire datasets.
