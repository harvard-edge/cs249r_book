...
[^fn-architecture-search]: **Architecture Search**: Automated methods for finding optimal model structures. Neural Architecture Search (NAS) techniques covered in @sec-model-optimizations-neural-architecture-search-e18e.
...
[^fn-pruning-technique]: **Pruning Technique**: Method for removing unnecessary model components to improve efficiency. Comprehensive coverage in @sec-model-optimizations-pruning-02bc.
