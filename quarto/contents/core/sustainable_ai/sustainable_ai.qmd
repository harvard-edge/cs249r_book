...
Environmental responsibility represents a fundamental dimension of trustworthy AI systems, alongside the fairness, safety, and transparency considerations explored in @sec-responsible-ai. Just as reliable systems must function correctly under diverse conditions, sustainable systems must operate within environmental constraints that preserve long-term technological and societal viability. This chapter extends the trustworthy systems framework to include environmental stewardship as an essential design principle.
...
Understanding AI's sustainability crisis requires examining both its technical dimensions and ethical implications. The scale of resource consumption documented above creates not just engineering constraints, but fundamental questions about responsibility and justice in AI development. AI's environmental impact extends beyond technical metrics to questions of equity, justice, and long-term viability that define the urgency of addressing these challenges.
...
In stark contrast, training a single large language model like GPT-3 consumes 1,287 MWh, creating a 10⁶× energy efficiency gap between artificial and biological intelligence. This comparison illustrates the fundamental sustainability challenge: while the human brain achieves superior learning capabilities on the power consumption of a light bulb, current AI systems require industrial-scale energy infrastructure to achieve comparable cognitive tasks.
