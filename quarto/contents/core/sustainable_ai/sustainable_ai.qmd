...
::: {.callout-definition title="Definition of Sustainable AI"}

***Sustainable AI*** is the _engineering discipline_ that integrates _environmental considerations into every stage of machine learning systems design, development, and deployment_. It encompasses _measuring and minimizing energy consumption_, _reducing carbon emissions_, _optimizing hardware utilization_, and _managing the complete lifecycle environmental impact_ of AI systems from manufacturing through disposal. Sustainable AI treats _resource efficiency as a core engineering constraint_ alongside performance and cost, ensuring systems operate within _planetary resource boundaries_ while achieving computational objectives through _systematic measurement, modeling, and mitigation_ of environmental impacts.
