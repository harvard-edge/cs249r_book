...
This chapter builds on the foundational robustness principles established in @sec-robust-ai, extending beyond hardware fault tolerance and adversarial robustness to encompass broader security and privacy concerns. While @sec-robust-ai focuses on system resilience against faults and specific attack vectors, this chapter addresses the comprehensive protection of ML systems against unauthorized access, data breaches, and privacy violations across the entire operational lifecycle.
...
Security and privacy, although closely related, address distinct aspects of ML system protection. While both aim to protect systems and data, they differ in their objectives, threat models, and technical responses. Security focuses on preventing unauthorized access and system disruption, while privacy emphasizes controlling the exposure of sensitive information. These concepts often interact and reinforce one another, but they require distinct mechanisms and design considerations detailed in @sec-security-privacy-definitions-distinctions-8f62.
