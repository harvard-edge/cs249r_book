...
### Supply Chain Compromise: Stuxnet {#sec-security-privacy-supply-chain-compromise-stuxnet-5565}
...
### Insufficient Isolation: Jeep Cherokee Hack {#sec-security-privacy-insufficient-isolation-jeep-cherokee-hack-7a62}
...
### Weaponized Endpoints: Mirai Botnet {#sec-security-privacy-weaponized-endpoints-mirai-botnet-6f87}
...
## From Historical Lessons to ML-Specific Threats {#sec-security-privacy-historical-lessons-mlspecific-threats-5e1e}
...
## Threat Prioritization Framework {#sec-security-privacy-threat-prioritization-framework-466d}
...
@tbl-ml-threat-assessment presents a risk assessment matrix that evaluates common ML threats across these dimensions:
...
: **ML Threat Risk Assessment Matrix**: This table evaluates common machine learning security threats across multiple dimensions—likelihood of occurrence, potential impact severity, required attacker skill level, and resulting priority for defensive measures. Understanding these threat profiles enables organizations to allocate security resources effectively based on their specific deployment context and risk tolerance. {#tbl-ml-threat-assessment}
...
### The Layered Defense Principle {#sec-security-privacy-layered-defense-principle-63ba}
...
### Case Study: GPT-3 Data Extraction Attack {#sec-security-privacy-case-study-gpt3-data-extraction-attack-adc0}
...
##### Hardware-Software Security Co-Design {#sec-security-privacy-hardwaresoftware-security-codesign-6c89}
...
### Selecting Appropriate Defenses: A Decision Framework {#sec-security-privacy-selecting-appropriate-defenses-decision-framework-491e}
...
def measure_privacy_utility_tradeoff(model, data, epsilon_values):
    ...
    for eps in epsilon_values:
        dp_model = apply_differential_privacy(
            model, epsilon=eps)
...
def calibrate_adversarial_detector(
        detector, clean_data, attack_data):
    ...
    for threshold in thresholds:
        ...
        print(f"Threshold {threshold}: FP={fp_rate:.3f}, " +
