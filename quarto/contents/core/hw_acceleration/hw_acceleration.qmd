...
\node[Box={col2!50},below=of 2BB2](2BB3){NVIDIA GeForce 256 -- First Programmable GPU[^fn-first-gpu] (1999)};
\node[Box={col2!50},below=of 2BB3](2BB4){Rise of SIMD Processing Units};

[^fn-first-gpu]: **First Programmable GPU**: NVIDIA's GeForce 256 (1999) introduced programmable shaders, transforming GPUs from fixed-function graphics processors into flexible parallel computing engines that would eventually revolutionize machine learning by enabling CUDA programming a decade later.
%
