...
## AI Hardware Acceleration Fundamentals {#sec-ai-acceleration-overview-47d1}
...
The fundamental principle remains consistent: data flows systematically through processing elements, with inputs moving horizontally and vertically to compute partial sums in a synchronized fashion. However, as detailed in @sec-ai-acceleration-ai-memory-wall-challenge-fb2c, practical effectiveness is ultimately constrained by memory bandwidth bottlenecks.
...
### Understanding the AI Memory Wall {#sec-ai-acceleration-ai-memory-wall-challenge-fb2c}
...
#### Quantifying the Compute-Memory Performance Gap {#sec-ai-acceleration-growing-computememory-imbalance-eb58}
...
#### Memory Access Patterns in ML Workloads {#sec-ai-acceleration-memoryintensive-machine-learning-workloads-3a75}
...
#### Irregular Memory Access {#sec-ai-acceleration-irregular-memory-access-c10f}
...
Building on the memory wall analysis established in @sec-ai-acceleration-ai-memory-wall-challenge-fb2c, this section quantifies how specific bandwidth characteristics impact system performance across different deployment scenarios.
...
## Hardware Mapping Fundamentals for Neural Networks {#sec-ai-acceleration-mapping-neural-networks-hardware-437e}

The memory system challenges examined in the previous section—bandwidth limitations, hierarchical access costs, and model-specific pressure patterns—directly determine how effectively neural networks execute on accelerators. A systolic array with 1,200 GB/s on-chip bandwidth and sophisticated memory hierarchies delivers no performance benefit if computations are mapped without considering these memory access patterns. As established in @sec-ai-acceleration-ai-memory-wall-challenge-fb2c, the extreme energy penalty for memory access means that mapping strategies must prioritize data reuse and locality above all other considerations. This reality drives the need for systematic mapping approaches that coordinate computation placement, memory allocation, and data movement to exploit hardware capabilities while respecting memory constraints.
...
### Computation Placement {#sec-ai-acceleration-computation-placement-45ef}
...
#### Computation Placement Definition {#sec-ai-acceleration-computation-placement-definition-2a14}
...
#### Computation Placement Importance {#sec-ai-acceleration-computation-placement-importance-86d8}
...
#### Effective Computation Placement {#sec-ai-acceleration-effective-computation-placement-728e}
...
### Memory Allocation {#sec-ai-acceleration-memory-allocation-e296}
...
#### Memory Allocation Definition {#sec-ai-acceleration-memory-allocation-definition-f56a}
...
#### Memory Challenges for Different Workloads {#sec-ai-acceleration-memory-challenges-different-workloads-72ed}
...
### Combinatorial Complexity {#sec-ai-acceleration-combinatorial-complexity-3b3a}
...
#### Exploring the Configuration Space {#sec-ai-acceleration-exploring-configuration-space-187d}
...
#### Ordering Computation and Execution {#sec-ai-acceleration-ordering-computation-execution-5093}
...
#### Parallelization Across Processing Elements {#sec-ai-acceleration-parallelization-across-processing-elements-ecd6}
...
#### Memory Placement and Data Movement {#sec-ai-acceleration-memory-placement-data-movement-647f}
...
#### Mapping Search Space {#sec-ai-acceleration-mapping-search-space-a9d0}
...
## Dataflow Optimization Strategies {#sec-ai-acceleration-optimization-strategies-1a35}
...
### Building Blocks of Mapping Strategies {#sec-ai-acceleration-building-blocks-mapping-strategies-70da}
...
#### Data Movement Patterns {#sec-ai-acceleration-data-movement-patterns-ba33}
...
##### Weight Stationary {#sec-ai-acceleration-weight-stationary-1bfd}
...
##### Output Stationary {#sec-ai-acceleration-output-stationary-8393}
...
##### Input Stationary {#sec-ai-acceleration-input-stationary-0cbe}
...
#### Memory-Efficient Tensor Layouts {#sec-ai-acceleration-memoryefficient-tensor-layouts-324d}
...
##### Row-Major Layout {#sec-ai-acceleration-rowmajor-layout-24b1}
...
##### Channel-Major Layout {#sec-ai-acceleration-channelmajor-layout-22ac}
...
##### Comparing Row-Major and Channel-Major Layouts {#sec-ai-acceleration-comparing-rowmajor-channelmajor-layouts-04aa}
...
#### Kernel Fusion {#sec-ai-acceleration-kernel-fusion-a026}
...
##### Intermediate Memory Write {#sec-ai-acceleration-intermediate-memory-write-70b5}
...
##### Kernel Fusion for Memory Efficiency {#sec-ai-acceleration-kernel-fusion-memory-efficiency-f3b0}
...
##### Performance Benefits and Constraints {#sec-ai-acceleration-performance-benefits-constraints-26e2}
...
#### Memory-Efficient Tiling Strategies {#sec-ai-acceleration-memoryefficient-tiling-strategies-c384}
...
##### Tiling Fundamentals {#sec-ai-acceleration-tiling-fundamentals-3d1b}
...
##### Performance Benefits of Tiling {#sec-ai-acceleration-performance-benefits-tiling-6ac9}
...
##### Tiling Methods {#sec-ai-acceleration-tiling-methods-0a9c}
...
###### Spatial Tiling {#sec-ai-acceleration-spatial-tiling-6018}
...
###### Temporal Tiling {#sec-ai-acceleration-temporal-tiling-c362}
...
##### Tiling Challenges and Trade-offs {#sec-ai-acceleration-tiling-challenges-tradeoffs-8dd3}
...
### Applying Mapping Strategies to Neural Networks {#sec-ai-acceleration-applying-mapping-strategies-neural-networks-7479}
...
#### Convolutional Neural Networks {#sec-ai-acceleration-convolutional-neural-networks-be99}
...
#### Transformer Architectures {#sec-ai-acceleration-transformer-architectures-1f49}
...
#### Multi-Layer Perceptrons {#sec-ai-acceleration-multilayer-perceptrons-daeb}
...
### Hardware Implementations of Hybrid Strategies {#sec-ai-acceleration-hardware-implementations-hybrid-strategies-76d5}
...
### Compiler Design Differences for ML Workloads {#sec-ai-acceleration-machine-learning-vs-traditional-compilers-c24c}
...
### Runtime Architecture Differences for ML Systems {#sec-ai-acceleration-machine-learning-vs-traditional-runtimes-1e6c}
