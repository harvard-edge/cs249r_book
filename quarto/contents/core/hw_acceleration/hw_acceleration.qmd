...
[^fn-l1-cache]: **L1 Cache**: The fastest but smallest memory in a CPU, typically 32-64KB per core with <1ns access time. The 30,000x size mismatch between neural network parameters (gigabytes) and L1 cache capacity (kilobytes) illustrates why traditional memory hierarchies fail for AI workloads. Specialized accelerators like Google's TPU provide 128MB of on-chip memory running at 900 GB/s, dramatically reducing latency and energy consumption for large-scale models.
