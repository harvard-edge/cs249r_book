...
[^fn-model-memorization]: **Model Memorization**: The phenomenon where ML models inadvertently store training data verbatim, allowing extraction through carefully crafted queries. Nicholas Carlini and others demonstrated in 2023 that GPT-2 could reproduce entire email addresses, phone numbers, and personal information from training data. Large language models like ChatGPT memorize roughly 1% of their training data, raising concerns about privacy violations when models are trained on personal information without explicit consent.
