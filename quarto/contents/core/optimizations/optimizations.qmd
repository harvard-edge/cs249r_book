...
To understand this mathematically, consider a simple concrete example before examining the general case. Suppose we have a small 3×3 weight matrix:
...
This simple example demonstrates the L0-norm constraint: we've reduced the number of nonzero parameters from 9 to 4, satisfying k=4 in our optimization formulation.
...
To make this concrete, consider quantizing FP32 weights to INT8 (8-bit integers):
