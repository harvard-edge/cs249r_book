...
***Pruning*** is a _model optimization technique_ that removes _unnecessary parameters_ from a neural network while maintaining _predictive performance_. By systematically eliminating _redundant weights, neurons, or layers_, pruning reduces _model size and computational cost_, making it more efficient for _storage, inference, and deployment_.
