...
Machine learning system efficiency cannot be achieved by optimizing single metrics in isolation but requires balancing trade-offs across algorithmic complexity, computational resources, and data utilization. Improvements in one dimension often degrade performance in others, creating fundamental engineering tensions. Algorithmic efficiency reduces computational requirements but may increase development complexity. Compute efficiency maximizes hardware utilization but may limit model expressiveness. Data efficiency enables learning with fewer examples but may require more sophisticated training procedures. These interdependent relationships demand systematic approaches optimizing across multiple competing objectives simultaneously. Understanding efficiency trade-offs enables engineers to design systems achieving maximum performance within practical constraints of time, energy, and cost, making efficiency a core engineering discipline rather than an optional optimization.
...
Underlying this consistent progress is the scaling hypothesis: larger models possess increased capacity to capture intricate data patterns, facilitating improved accuracy and generalization. However, this scaling comes with critical constraints that make efficiency paramount. Training GPT-3 required approximately 314 sextillion[^fn-sextillion] floating-point operations (314 followed by 21 zeros), equivalent to running a modern gaming PC continuously for over 350 years. The financial cost reached $4.6 million, and the energy consumption generated 502 tons of CO₂ equivalent [@strubell2019energy].
...
Rather than asking "how much more can we scale," efficient AI systems ask "how can we achieve more with less?" This shift in perspective leads to three complementary efficiency dimensions, each addressing a specific limitation exposed by scaling laws:
