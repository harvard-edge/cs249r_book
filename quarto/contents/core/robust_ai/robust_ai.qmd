...
[^fn-smart-cities]: **Smart Cities**: Urban areas that use IoT devices, data analytics, and AI to optimize infrastructure, energy usage, and public services. Expected to encompass 68% of the global population by 2050 [@un2018world], generating over 2.5 quintillion bytes of data daily.
...
[^fn-single-event-upsets]: **Single Event Upsets (SEUs)**: Radiation-induced bit flips in memory or logic caused by cosmic rays or alpha particles. Occur roughly once per gigabit per month at sea level [@baumann2005soft], increasing exponentially with altitude, with commercial aircraft experiencing 300x higher rates.
