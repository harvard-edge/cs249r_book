...
::: {#fig-three-pillars-framework fig-cap="**Three Pillars Framework**: The three fundamental categories of robustness challenges that AI systems must address to ensure reliable operation in real-world deployments." fig-env="figure" fig-pos="h"}
```{.tikz}
\documentclass[tikz,border=10pt]{standalone}
\usetikzlibrary{shadows,calc,positioning,shapes.geometric,decorations.pathmorphing}
...
% Foundation
\node[foundation] (foundation) at (0,-0.5) {};
\node[font=\footnotesize\bfseries] at (foundation) {Robust AI Foundation};
...
% Connecting lines from pillars to foundation
\draw[gray!60, thick] (pillar1.south) -- ($(foundation.north) + (-2.5,0)$);
\draw[gray!60, thick] (pillar2.south) -- (foundation.north);
\draw[gray!60, thick] (pillar3.south) -- ($(foundation.north) + (2.5,0)$);
...
### Hardware Fault Impact on ML Systems {#sec-robust-ai-understanding-hardware-fault-impact-ml-systems-3009}
...
#### Fault Analysis and Performance Impact {#sec-robust-ai-quantitative-fault-analysis-performance-impact-561d}
...
#### Memory Hierarchy and Bandwidth Impact {#sec-robust-ai-memory-hierarchy-robustness-bandwidth-implications-f107}
...
### Data Poisoning Attacks {#sec-robust-ai-data-poisoning-attacks-e2d1-attacks-e2d1}
...
### Adversarial Attacks {#sec-robust-ai-adversarial-attacks-264d-77be}
...
### Data Poisoning {#sec-robust-ai-data-poisoning-attacks-e2d1-6841}
...
#### System Implications of Distribution Shifts {#sec-robust-ai-summary-distribution-shifts-system-implications-3837}
...
#### Adversarial Attacks {#sec-robust-ai-adversarial-attacks-264d-87e2}
...
#### Data Poisoning {#sec-robust-ai-data-poisoning-attacks-e2d1-2886}
...
#### Self-Supervised Learning for Robustness {#sec-robust-ai-selfsupervised-learning-robust-representations-0dad}
