...
::: {.callout-definition}
**Definition: AI and ML: Key Definitions**
...
::: {.callout-example title="Example: STUDENT (1964)"}
```
...
::: {.callout-example title="Example: MYCIN (1976)"}
```
...
::: {.callout-example title="Example: Early Spam Detection Systems"}
```
Rule-based (1980s):
...
::: {.callout-example title="Example: Traditional Computer Vision Pipeline"}
```
