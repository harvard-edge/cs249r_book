...
::: {.callout-colab title="🔬 Hands-On: Rule-Based vs. Data-Driven Systems"}

You have learned about the fundamental shift from symbolic AI to machine learning. But what does this difference actually look like in practice? How do rule-based and data-driven systems differ in their behavior, adaptability, and engineering requirements?

This hands-on demonstration contrasts rule-based and data-driven approaches on the same task, revealing why ML has become the dominant paradigm for building intelligent systems.

In @sec-data-engineering, you will explore how to build robust data pipelines that feed ML systems. In @sec-ai-frameworks, you will learn about frameworks that enable efficient model training. In @sec-efficient-ai, you will discover how to optimize learned models for production deployment.

**For now**: Experience the practical differences between programming intelligence and learning intelligence from data.

**Learning Objective**: Understand why data-driven machine learning supersedes hand-crafted rules for building intelligent systems.

**What You'll Compare**:

- **Rule-Based System**: Implement a chess position evaluator using hand-crafted heuristics (material count, piece positioning, king safety)
- **Data-Driven System**: Train a neural network to evaluate chess positions by learning from master games
- **Adaptability**: Observe how each system handles novel positions and strategic patterns
- **Engineering Trade-offs**: Measure development time, performance, and maintenance requirements for both approaches

**Estimated Time**: 10-12 minutes

**Interactive Notebook**: [Open in Google Colab](https://colab.research.google.com/github/harvard-edge/cs249r_book/blob/main/colabs/ch01_introduction/rule_based_vs_ml.ipynb)
