...
## The Engineering Revolution in Artificial Intelligence {#sec-introduction-overview-c3be}
...
## From Artificial Intelligence Vision to Machine Learning Practice {#sec-introduction-ai-ml-basics-fa82}
...
- ***Artificial Intelligence (AI)***: The goal of creating systems that can perform tasks requiring human-like intelligence, including _learning_, _reasoning_, and _adapting to new situations_.

- ***Machine Learning (ML)***: The practical approach to achieving AI by building systems that automatically discover _patterns in data_ through _computational techniques_, rather than following predetermined rules.
:::
...
A ***Machine Learning System*** is an integrated computing system comprising three core components: (1) _data_ that guides algorithmic behavior, (2) _learning algorithms_ that extract patterns from this data, and (3) _computing infrastructure_ that enables both the learning process (i.e., _training_) and the application of learned knowledge (i.e., _inference/serving_). Together, these components create a computing system capable of making _predictions_, generating _content_, or taking _actions_ based on learned patterns.
:::
...
## Historical Evolution of AI Paradigms {#sec-introduction-ai-evolution-8ff4}
...
## Understanding ML System Lifecycle and Deployment {#sec-introduction-lifecycle-ml-systems-6194}
...
## Case Studies in Real-World ML Systems {#sec-introduction-practical-applications-0728}
...
### Case Study: Autonomous Vehicles {#sec-introduction-case-study-autonomous-vehicles-b529}
...
#### Data Considerations {#sec-introduction-data-considerations-04a1}
...
#### Algorithmic Considerations {#sec-introduction-algorithmic-considerations-358a}
...
#### Infrastructure Considerations {#sec-introduction-infrastructure-considerations-0ae4}
...
#### Future Implications {#sec-introduction-future-implications-e262}
...
\medskip
## Core Engineering Challenges in ML Systems {#sec-introduction-challenges-ml-systems-7167}
...
### Data Challenges {#sec-introduction-data-challenges-6400}
...
### Model Challenges {#sec-introduction-model-challenges-9f46}
...
### System Challenges {#sec-introduction-system-challenges-2fb4}
...
### Understanding Challenge Interconnections {#sec-introduction-challenge-interdependencies-f267}
...
***AI Engineering*** is the engineering discipline focused on building _reliable_, _efficient_, and _scalable_ machine learning systems across computational platforms, ranging from _embedded devices_ to _data centers_. It spans the entire lifecycle, including _data acquisition_, _model development_, _system integration_, _deployment_, and _operations_, with an emphasis on _resource-awareness_ and _system-level_ optimization_.
:::
...
## Organizing ML Systems Engineering: The Five-Pillar Framework {#sec-introduction-challenges-solutions-fivepillar-framework-f4e1}
...
### Future Directions in ML Systems Engineering {#sec-introduction-evolution-emerging-trends-2f42}
...
### How to Use This Textbook {#sec-introduction-navigating-book-3f89}
