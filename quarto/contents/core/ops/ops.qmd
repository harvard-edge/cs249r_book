...
This systems-oriented view of MLOps also sets the stage for the next phase of this book. The remaining chapters in Part IV examine specific application contexts and operational concerns that depend on the foundational capabilities developed in this chapter. @sec-ondevice-learning explores how MLOps principles adapt to resource-constrained edge environments where continuous connectivity cannot be assumed. @sec-robust-ai extends the monitoring and reliability patterns introduced here to address adversarial threats, distribution shift, and safety-critical deployment scenarios. @sec-security-privacy examines how operational practices must integrate privacy-preserving techniques and security controls, particularly relevant for the healthcare applications demonstrated in the ClinAIOps case study. These topics represent not merely extensions of model performance, but domains in which operational maturity directly enables feasibility, safety, and long-term value.
