...
### Infrastructure and Development Summary {#sec-ml-operations-infrastructure-development-summary-4fba}
...
def transform_data():
    import pandas as pd
    df = pd.read_parquet(
        '/data/staged/sensor_data.parquet')
    df['rolling_avg'] = (
      df['temperature']
      .rolling(window=10)
      .mean()
...
# TensorFlow Privacy
import tensorflow as tf
from tensorflow_privacy.privacy.optimizers \
    .dp_optimizer_keras import DPKerasAdamOptimizer
