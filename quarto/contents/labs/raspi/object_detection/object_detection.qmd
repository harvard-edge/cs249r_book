...
## Overview {#sec-object-detection-overview-1133}
...
### Object Detection Fundamentals {#sec-object-detection-object-detection-fundamentals-4931}
...
#### Image Classification vs. Object Detection {#sec-object-detection-image-classification-vs-object-detection-bc62}
...
\noindent
![](images/jpeg/objxclas.jpg){width=85% fig-align="center"}
...
#### Key Components of Object Detection {#sec-object-detection-key-components-object-detection-e651}
...
#### Challenges in Object Detection {#sec-object-detection-challenges-object-detection-a1a5}
...
#### Approaches to Object Detection {#sec-object-detection-approaches-object-detection-7338}
...
#### Evaluation Metrics {#sec-object-detection-evaluation-metrics-970b}
...
## Pre-Trained Object Detection Models Overview {#sec-object-detection-pretrained-object-detection-models-overview-b4a3}
...
\noindent
![](images/png/model-deploy.png){width=85% fig-align="center"}

### Setting Up the TFLite Environment {#sec-object-detection-setting-tflite-environment-0a36}
...
### Creating a Working Directory: {#sec-object-detection-creating-working-directory-42e0}
...
### Inference and Post-Processing {#sec-object-detection-inference-postprocessing-5f07}
...
\noindent
![](images/png/inference result.png){width=95% fig-align="center"}
...
\noindent
![](images/png/boulding-boxes.png){width=55% fig-align="center"}
...
\noindent
![](images/png/cat-dog.png){width=55% fig-align="center"}
...
\noindent
![](images/png/infer-mobv1.png){width=85% fig-align="center"}
...
\noindent
![](images/png/visual_inf.png){width=65% fig-align="center"}

### EfficientDet {#sec-object-detection-efficientdet-88c8}
...
## Object Detection Project {#sec-object-detection-object-detection-project-22de}
...
### The Goal {#sec-object-detection-goal-d34f}
...
\noindent
![](images/jpeg/proj_goal.jpg){width=70% fig-align="center"}
...
### Raw Data Collection {#sec-object-detection-raw-data-collection-8d16}
...
\noindent
![](images/png/cap-img.png){width=80% fig-align="center"}
...
### Labeling Data {#sec-object-detection-labeling-data-b166}
...
\noindent
![](images/png/create-project-rf.png){width=70% fig-align="center"}

> We will not enter in deep details about the Roboflow process once many tutorials are available.

#### Annotate {#sec-object-detection-annotate-dae6}
...
\noindent
![](images/png/annotation.png){width=85% fig-align="center"}

Once all images are annotated, you should split them into training, validation, and testing.

\noindent
![](images/png/dataset_rf.png){width=85% fig-align="center"}

#### Data Pre-Processing {#sec-object-detection-data-preprocessing-02ef}
...
\noindent
![](images/png/pre-proc.png){width=85% fig-align="center"}
...
\noindent
![](images/png/dataset-struct.png){width=90% fig-align="center"}
...
> The pre-processed dataset can be found at the [Roboflow site](https://universe.roboflow.com/marcelo-rovai-riila/box-versus-wheel-auto-dataset).</a>

## Training an SSD MobileNet Model on Edge Impulse Studio {#sec-object-detection-training-ssd-mobilenet-model-edge-impulse-studio-b43a}
...
### Uploading the annotated data {#sec-object-detection-uploading-annotated-data-6406}
...
\noindent
![](images/png/upload-data.png){width=90% fig-align="center"}
...
\noindent
![](images/png/ei-dataset.png){width=90% fig-align="center"}

### The Impulse Design {#sec-object-detection-impulse-design-d9ea}
...
\noindent
![](images/png/target-device.png){width=90% fig-align="center"}
...
\noindent
![](images/png/impulse-design.png){width=90% fig-align="center"}

### Preprocessing all dataset {#sec-object-detection-preprocessing-dataset-942e}

In the section `Image`, select **Color depth** as `RGB`, and press  `Save parameters`.

\noindent
![](images/png/ei-image-pre.png){width=90% fig-align="center"}
...
### Model Design, Training, and Test {#sec-object-detection-model-design-training-test-3c9f}
...
\noindent
![](images/png/ei-train-result.png){width=80% fig-align="center"}
...
### Deploying the model {#sec-object-detection-deploying-model-6262}
...
\noindent
![](images/png/ei-deploy-int8.png){width=80% fig-align="center"}
...
### Inference and Post-Processing {#sec-object-detection-inference-postprocessing-1b11}
...
\noindent
![](images/png/orig-img.png){width=65% fig-align="center"}
...
\noindent
![](images/png/infer-text.png){width=90% fig-align="center"}
...
\noindent
![](images/png/infer-visual.png){width=90% fig-align="center"}

But what happens if we reduce the threshold to 0.3, for example?

\noindent
![](images/png/infer-mult.png){width=75% fig-align="center"}
...
\noindent
![](images/png/infer-iou.png){width=75% fig-align="center"}

## Training a FOMO Model at Edge Impulse Studio {#sec-object-detection-training-fomo-model-edge-impulse-studio-d41c}
...
### How FOMO works? {#sec-object-detection-fomo-works-3d28}
...
\noindent
![](images/png/fomo-1.png){width=80% fig-align="center"}
...
\noindent
![](images/png/fomo-works.png){width=75% fig-align="center"}
...
### Impulse Design, new Training and Testing {#sec-object-detection-impulse-design-new-training-testing-3fad}
...
\noindent
![](images/png/impulse-2.png){width=85% fig-align="center"}
...
\noindent
![](images/png/model-choice.png){width=85% fig-align="center"}
...
\noindent
![](images/png/fomo-train-result.png){width=85% fig-align="center"}
...
### Deploying the model {#sec-object-detection-deploying-model-fd8e}
...
\noindent
![](images/png/deploy-linux.png){width=75% fig-align="center"}
...
### Inference and Post-Processing {#sec-object-detection-inference-postprocessing-5d67}
...
\noindent
![](images/png/orig-fomo-img.png){width=75% fig-align="center"}
...
\noindent
![](images/png/infer-fomo-result.png){width=70% fig-align="center"}

## Exploring a YOLO Model using Ultralytics {#sec-object-detection-exploring-yolo-model-using-ultralitics-943a}
...
### Talking about the YOLO Model {#sec-object-detection-talking-yolo-model-70b3}
...
#### Key Features: {#sec-object-detection-key-features-0e21}
...
3. **Evolution of Versions**:
    ...
    \noindent
    ![](images/jpeg/versions.jpg){width=85% fig-align="center"}
...
### Installation {#sec-object-detection-installation-ea18}
...
### Testing the YOLO {#sec-object-detection-testing-yolo-1163}
...
\noindent
![](images/png/yolo-bus.png){width=80% fig-align="center"}
...
### Export Model to NCNN format {#sec-object-detection-export-model-ncnn-format-f896}
...
### Exploring YOLO with Python {#sec-object-detection-exploring-yolo-python-874f}
...
\noindent
![](images/png/result-bus.png){width=95% fig-align="center"}
...
\noindent
![](images/png/data-bus.png){width=95% fig-align="center"}
...
#### Critical points on the Notebook: {#sec-object-detection-critical-points-notebook-67e8}
...
\noindent
![](images/png/matrix.png){width=80% fig-align="center"}
...
\noindent
![](images/png/test-infer-yolo.png){width=80% fig-align="center"}
...
### Inference with the trained model, using the Raspi {#sec-object-detection-inference-trained-model-using-raspi-46ed}
...
## Object Detection on a live stream {#sec-object-detection-object-detection-live-stream-7df0}
...
- On the Raspberry Pi itself (if you have a GUI): Open a web browser and go to `http://localhost:5000`
- From another device on the same network: Open a web browser and go to `http://<raspberry_pi_ip>:5000` (Replace `<raspberry_pi_ip>` with your Raspberry Pi's IP address). For example: `http://192.168.4.210:`
`5000/`

Here are some screenshots of the app running on an external desktop

\noindent
![](images/png/app-running.png){width=80% fig-align="center"}
...
## Summary {#sec-object-detection-summary-680e}
...
## Resources {#sec-object-detection-resources-17bf}
