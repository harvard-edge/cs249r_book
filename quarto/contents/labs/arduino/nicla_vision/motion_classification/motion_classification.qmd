...
## Overview {#sec-motion-classification-anomaly-detection-overview-b1a8}
...
## Learning Objectives {#sec-motion-classification-anomaly-detection-learning-objectives-03f0}
...
## IMU Installation and testing {#sec-motion-classification-anomaly-detection-imu-installation-testing-deff}
...
### Defining the Sampling frequency: {#sec-motion-classification-anomaly-detection-defining-sampling-frequency-7405}
...
## The Case Study: Simulated Container Transportation {#sec-motion-classification-anomaly-detection-case-study-simulated-container-transportation-1b32}
...
## Data Collection {#sec-motion-classification-anomaly-detection-data-collection-aa04}
...
### Connecting the device to Edge Impulse {#sec-motion-classification-anomaly-detection-connecting-device-edge-impulse-b8c0}
...
### Data Collection {#sec-motion-classification-anomaly-detection-data-collection-5657}
...
## Impulse Design {#sec-motion-classification-anomaly-detection-impulse-design-076e}
...
### Data Pre-Processing Overview {#sec-motion-classification-anomaly-detection-data-preprocessing-overview-52c4}
...
### EI Studio Spectral Features {#sec-motion-classification-anomaly-detection-ei-studio-spectral-features-ed14}
...
### Generating features {#sec-motion-classification-anomaly-detection-generating-features-2e22}
...
## Models Training {#sec-motion-classification-anomaly-detection-models-training-3795}
...
## Testing {#sec-motion-classification-anomaly-detection-testing-5598}
...
## Deploy {#sec-motion-classification-anomaly-detection-deploy-1e77}
...
### Inference {#sec-motion-classification-anomaly-detection-inference-b173}
...
### Post-processing {#sec-motion-classification-anomaly-detection-postprocessing-3f0d}
...
## Summary {#sec-motion-classification-anomaly-detection-summary-b36e}
...
### Case Applications {#sec-motion-classification-anomaly-detection-case-applications-b15e}

#### Industrial and Manufacturing {#sec-motion-classification-anomaly-detection-industrial-manufacturing-faae}
...
#### Healthcare {#sec-motion-classification-anomaly-detection-healthcare-33cd}
...
#### Consumer Electronics {#sec-motion-classification-anomaly-detection-consumer-electronics-346f}
...
#### Transportation and Logistics {#sec-motion-classification-anomaly-detection-transportation-logistics-1ec8}
...
#### Smart Cities and Infrastructure {#sec-motion-classification-anomaly-detection-smart-cities-infrastructure-3a9c}
...
#### Security and Surveillance {#sec-motion-classification-anomaly-detection-security-surveillance-10e2}
...
#### Agriculture {#sec-motion-classification-anomaly-detection-agriculture-6782}
...
#### Environmental Monitoring {#sec-motion-classification-anomaly-detection-environmental-monitoring-0d3f}
...
### Nicla 3D case {#sec-motion-classification-anomaly-detection-nicla-3d-case-f3b8}
...
## Resources {#sec-motion-classification-anomaly-detection-resources-a2eb}
