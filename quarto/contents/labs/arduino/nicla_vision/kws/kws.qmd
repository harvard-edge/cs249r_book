...
## Overview {#sec-keyword-spotting-kws-overview-0ae6}
...
## How does a voice assistant work? {#sec-keyword-spotting-kws-voice-assistant-work-7c16}
...
## The KWS Hands-On Project {#sec-keyword-spotting-kws-kws-handson-project-d8cd}
...
### The Machine Learning workflow {#sec-keyword-spotting-kws-machine-learning-workflow-bc51}
...
## Dataset {#sec-keyword-spotting-kws-dataset-bd0d}
...
### Uploading the dataset to the Edge Impulse Studio {#sec-keyword-spotting-kws-uploading-dataset-edge-impulse-studio-fb56}
...
### Capturing additional Audio Data {#sec-keyword-spotting-kws-capturing-additional-audio-data-6177}
...
#### Using the NiclaV and the Edge Impulse Studio {#sec-keyword-spotting-kws-using-niclav-edge-impulse-studio-23b8}
...
#### Using a smartphone and the EI Studio {#sec-keyword-spotting-kws-using-smartphone-ei-studio-c13b}
...
## Creating Impulse (Pre-Process / Model definition) {#sec-keyword-spotting-kws-creating-impulse-preprocess-model-definition-5c3e}

*An* **impulse** *takes raw data, uses signal processing to extract features, and then uses a learning block to classify new data.*

### Impulse Design {#sec-keyword-spotting-kws-impulse-design-0a62}
...
### Pre-Processing (MFCC) {#sec-keyword-spotting-kws-preprocessing-mfcc-0c8d}
...
### Going under the hood {#sec-keyword-spotting-kws-going-hood-36e4}
...
## Model Design and Training {#sec-keyword-spotting-kws-model-design-training-1c97}
...
### Going under the hood {#sec-keyword-spotting-kws-going-hood-f766}
...
## Testing {#sec-keyword-spotting-kws-testing-bd97}
...
### Live Classification {#sec-keyword-spotting-kws-live-classification-ef76}
...
## Deploy and Inference {#sec-keyword-spotting-kws-deploy-inference-152d}
...
## Post-processing {#sec-keyword-spotting-kws-postprocessing-ce62}
...
## Resources {#sec-keyword-spotting-kws-resources-a202}
