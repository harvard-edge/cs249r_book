...
## Overview {#sec-dsp-spectral-features-overview-a7be}
...
## Extracting Features Review {#sec-dsp-spectral-features-extracting-features-review-b821}
...
## A TinyML Motion Classification project {#sec-dsp-spectral-features-tinyml-motion-classification-project-7321}
...
## Data Pre-Processing {#sec-dsp-spectral-features-data-preprocessing-78cc}
...
### Edge Impulse - Spectral Analysis Block V.2 under the hood {#sec-dsp-spectral-features-edge-impulse-spectral-analysis-block-v2-hood-a114}
...
## Time Domain Statistical features {#sec-dsp-spectral-features-time-domain-statistical-features-0125}
...
## Spectral features {#sec-dsp-spectral-features-spectral-features-5a1c}
...
## Time-frequency domain {#sec-dsp-spectral-features-timefrequency-domain-0a7d}

### Wavelets {#sec-dsp-spectral-features-wavelets-9aaa}
...
### Wavelet Analysis {#sec-dsp-spectral-features-wavelet-analysis-53f3}
...
### Feature Extraction {#sec-dsp-spectral-features-feature-extraction-b4e2}
...
## Summary {#sec-dsp-spectral-features-summary-6245}
