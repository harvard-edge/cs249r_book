...
## Overview {#sec-kws-feature-engineering-overview-afdf}
...
## The KWS {#sec-kws-feature-engineering-kws-218a}
...
### Applications of KWS {#sec-kws-feature-engineering-applications-kws-7525}
...
### Differences from General Speech Recognition {#sec-kws-feature-engineering-differences-general-speech-recognition-1197}
...
## Overview to Audio Signals {#sec-kws-feature-engineering-overview-audio-signals-aeff}
...
### Why Not Raw Audio? {#sec-kws-feature-engineering-raw-audio-acf4}
...
## Overview to MFCCs {#sec-kws-feature-engineering-overview-mfccs-3f21}

### What are MFCCs? {#sec-kws-feature-engineering-mfccs-5af9}
...
### Why are MFCCs important? {#sec-kws-feature-engineering-mfccs-important-ac83}
...
### Computing MFCCs {#sec-kws-feature-engineering-computing-mfccs-00e6}
...
## Hands-On using Python {#sec-kws-feature-engineering-handson-using-python-af55}
...
## Summary {#sec-kws-feature-engineering-summary-2713}
...
### MFCCs are particularly strong for {#sec-kws-feature-engineering-mfccs-particularly-strong-28ca}
...
### Spectrograms or MFEs are often more suitable for {#sec-kws-feature-engineering-spectrograms-mfes-often-suitable-568e}
...
## Resources {#sec-kws-feature-engineering-resources-9922}
