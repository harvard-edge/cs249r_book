...
![](images/imgs_dsp_spectral_features/spectral_block.jpeg){fig-align="center" width="6.5in"}
...
![](images/imgs_dsp_spectral_features/case_study.png){fig-align="center" width="6.5in"}

Below is one sample (raw data) of 10 seconds, captured with a sampling frequency of 50Hz:

![](images/imgs_dsp_spectral_features/data_sample.png){fig-align="center" width="6.5in"}
...
![](images/imgs_dsp_spectral_features/v1.png){fig-align="center" width="6.5in"}
...
![](images/imgs_dsp_spectral_features/v1_features.png){fig-align="center" width="6.5in"}
...
![](images/imgs_dsp_spectral_features/impulse.png){fig-align="center" width="5.6in"}
...
![](images/imgs_dsp_spectral_features/features.png){fig-align="center" width="6.5in"}
...
![](images/imgs_dsp_spectral_features/process_features.png){fig-align="center" width="4.57in"}
...
![](images/imgs_dsp_spectral_features/sample.png){fig-align="center" width="6.5in"}
...
![](images/imgs_dsp_spectral_features/sample_no_mean.png){fig-align="center" width="6.5in"}
...
![](images/imgs_dsp_spectral_features/rms.png){fig-align="center"}
...
![](images/imgs_dsp_spectral_features/skew.png){fig-align="center" width="6.5in"}
...
![](images/imgs_dsp_spectral_features/skew_2.png){fig-align="center" width="4.65in"}
...
![](images/imgs_dsp_spectral_features/kurto.png){fig-align="center"}
...
![](images/imgs_dsp_spectral_features/fft.png){fig-align="center" width="6.5in"}
...
![](images/imgs_dsp_spectral_features/fft_result.png){fig-align="center"}
...
![](images/imgs_dsp_spectral_features/wav.png){fig-align="center" width="6.5in"}

As we did before, let's copy and past the Processed Features:

![](images/imgs_dsp_spectral_features/wav_processed.png){fig-align="center" width="6.5in"}
...
![](images/imgs_dsp_spectral_features/wavelet_input.png){fig-align="center" width="6.5in"}
...
![](images/imgs_dsp_spectral_features/wav_result.png){fig-align="center" width="3.58in"}
