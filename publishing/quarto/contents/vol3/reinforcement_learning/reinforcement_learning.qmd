...
::: {#fig-vol3-rlvr-emergent-reasoning fig-env="figure" fig-pos="htb" fig-cap="**Emergent reasoning under pure RLVR**: As reinforcement learning on verifiable rewards progresses, the policy discovers that allocating more test-time compute (internal reasoning tokens) directly increases its success rate on complex problems. This inflection point marks the spontaneous emergence of autonomous self-correction and backtracking."}
