...
When policy optimization rewards self-correction and exploration, deliberative reasoning emerges as a native behavior. In @sec-vol3-test-time-search, we explore the inference-time counterpart to policy training: allocating dynamic compute to test-time search, tree exploration, and verification oracles.
