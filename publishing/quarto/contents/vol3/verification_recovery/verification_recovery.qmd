...
With execution boundaries, sandboxing, and fault recovery established, **Part V: Scale, Evaluation, and Operations** addresses the macro-systems challenges of autonomous agency: beginning in @sec-vol3-multi-agent with multi-agent coordination, hierarchical delegation, and distributed IPC topologies.
