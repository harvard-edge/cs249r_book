...
While supervised fine-tuning compiles known demonstration trajectories into weights, it remains bound to existing expert demonstrations. In @sec-vol3-reinforcement-learning, we step beyond static imitation to examine active environment reinforcement learning, where policies explore state spaces and optimize for sparse delayed rewards.
