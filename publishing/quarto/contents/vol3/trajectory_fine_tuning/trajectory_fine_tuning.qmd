...
::: {#fig-vol3-context-length-scaling fig-env="figure" fig-pos="htb" fig-cap="**The Context Window Explosion**: Foundation model context lengths have scaled exponentially over the last five years. However, while maximum context sizes have reached millions of tokens, populating these contexts with repetitive tool definitions and few-shot exemplars introduces severe KV-cache memory saturation and inference latency penalties."}
