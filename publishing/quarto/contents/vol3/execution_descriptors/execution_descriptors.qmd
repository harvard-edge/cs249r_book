...
To resolve this, modern agent runtimes implement **Shared Memory IPC** through **KV-Cache Prefix Sharing** (such as RadixAttention [@zheng2023sglang] or native prompt caching, see @sec-vol3-prefix-caching-paging). Analogous to operating system virtual memory paging with Copy-On-Write (COW) semantics:
