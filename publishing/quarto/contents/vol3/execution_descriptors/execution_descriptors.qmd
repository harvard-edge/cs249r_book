...
::: {#dfn-acb .definition title="Agent Control Block (ACB)"}
...
::: {#dfn-capability-lease .definition title="Capability Lease"}
...
::: {#dfn-causality-vector .definition title="ACB Causality Vector"}
