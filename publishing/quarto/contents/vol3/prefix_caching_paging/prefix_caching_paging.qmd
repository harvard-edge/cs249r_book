...
::: {#fig-vol3-caching-context-scaling fig-env="figure" fig-pos="htb" fig-cap="**The context window explosion**: Maximum supported context lengths for frontier models from 2020 to 2024. As contexts scale exponentially from 2k to 2M tokens, Key-Value cache memory footprints grow proportionally, rendering stateless recomputation computationally ruinous and forcing a transition to stateful serving architectures." fig-alt="Log-scale scatter of frontier model context length against release date from 2020 to 2024, colored by organization, rising from two thousand tokens to two million."}
