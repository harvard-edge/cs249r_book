...
With memory-efficient prefix sharing and paging established at the single-node layer, @sec-vol3-trajectory-scheduling examines how clusters coordinate these stateful workloads: scheduling trajectories under unknown service times, heavy-tailed arrivals, and asynchronous tool stalls.
