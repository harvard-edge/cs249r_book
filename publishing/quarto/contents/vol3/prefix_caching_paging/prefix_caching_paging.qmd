...
This design ensures that if the agent issues its next turn before memory pressure forces eviction, the system achieves a 100 percent cache hit on the existing prefix.
