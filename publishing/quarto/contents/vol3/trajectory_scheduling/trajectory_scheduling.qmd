...
The fitted distribution places 1.0% of tasks beyond 142 steps, which is exactly what a P99 of $142$ asserts, so the tail index and the table agree. Conditioning on 50 attained steps is then a ratio of survival probabilities, and the scale parameter cancels:
