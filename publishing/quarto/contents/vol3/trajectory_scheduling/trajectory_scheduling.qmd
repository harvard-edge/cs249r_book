...
With serving runtimes and memory scheduling established, **Part IV: Security, Isolation, and Red Teaming** turns to the execution boundary where non-deterministic neural policies meet the external world: beginning in @sec-vol3-tool-interfaces with standardized tool interfaces and the Model Context Protocol.
