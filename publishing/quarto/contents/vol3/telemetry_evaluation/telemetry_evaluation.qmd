...
## Introduction to Telemetry, Tracing, and Evaluation: Observability in Stochastic Runtimes {#sec-vol3-telemetry-intro}
...
- **Hierarchical Distributed Tracing:** Implementing the OpenTelemetry GenAI Semantic Conventions to organize multi-turn agent steps, subagent delegations, tool invocations, and model generations into structured, causal Directed Acyclic Graphs (DAGs).
