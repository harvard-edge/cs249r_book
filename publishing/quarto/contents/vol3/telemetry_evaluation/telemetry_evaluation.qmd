...
::: {#fig-vol3-static-vs-agentic fig-env="figure" fig-pos="htb" fig-cap="**The divergence of Static vs. Agentic benchmarks (2023–2024)**: While model scores on static evaluations like MMLU rapidly saturated near 90%, capability on agentic execution gyms (SWE-bench Lite) reveals the true frontier of reasoning and trajectory stability." fig-alt="Two-line chart from 2023 to late 2024 comparing static MMLU success rate, which stays flat near ninety percent, against agentic SWE-bench Lite success rate, which climbs from near zero to about fifty percent."}
