...
::: {#fig-vol3-static-vs-agentic fig-env="figure" fig-pos="htb" fig-cap="**The Divergence of Static vs. Agentic Benchmarks (2023–2024)**: While model scores on static evaluations like MMLU rapidly saturated near 90%, capability on agentic execution gyms (SWE-bench Lite) reveals the true frontier of reasoning and trajectory stability."}
...
data = pd.read_csv("data/static_vs_agentic.csv")
