...
- **Hermetic Execution Gyms**: at the evaluation layer, static datasets (MMLU, GSM8K) have collapsed. Agentic systems must be benchmarked inside reproducible execution gyms (SWE-bench, WebArena).
...
::: {#dfn-vol3-trajectory-goodput .callout-definition}
...
::: {#dfn-vol3-cost-per-goal .callout-definition}
