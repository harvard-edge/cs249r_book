...
- **The Enforcement Domain (Deterministic Runtime Enclosure):** The outer software harness intercepts the proposed action before execution. It validates the proposal against strict formal invariants:
  ...
  - **Capability Invariants:** Verifies that the proposed function and arguments adhere to cryptographic capability tokens, role-based access control (RBAC) policies, and file path sandboxing rules, rigidly enforcing the **Principle of Least Privilege**.
