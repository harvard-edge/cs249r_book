...
::: {#fig-reliability-wall fig-env="figure" fig-pos="htb" fig-cap="**The Compounding Reliability Wall**: Trajectory success probability decays exponentially as the task horizon ($N$) increases. Even with 99% single-step accuracy, reliability collapses over long horizons, demonstrating the necessity of runtime verification over open-loop execution."}
...
data = pd.read_csv("data/reliability_wall.csv")
sns.set_theme(style="whitegrid")
plt.figure(figsize=(8, 5))

sns.lineplot(
    data=data,
    x="Trajectory Length (N)",
