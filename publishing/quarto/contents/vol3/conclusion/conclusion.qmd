...
::: {#fig-vol3-trajectory-decay fig-env="figure" fig-pos="htb" fig-cap="**The sovereign law of agency**: Unverified trajectory success decays exponentially with horizon length $H$. Introducing an intermediate verification oracle with precision $v$ counteracts this decay, restoring viability for long-horizon tasks." fig-alt="Four decay curves of trajectory success probability against task horizon comparing unverified and verified execution at different step accuracies. Unverified curves fall steeply below a marked ninety-five percent reliability target while verified curves stay near it."}
...
df = pd.read_csv("data/trajectory_decay.csv")
