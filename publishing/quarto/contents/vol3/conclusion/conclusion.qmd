...
::: {#fig-vol3-trajectory-decay fig-env="figure" fig-pos="htb" fig-cap="**The Sovereign Law of Agency**: Unverified trajectory success decays exponentially with horizon length $H$. Introducing an intermediate verification oracle with precision $v$ counteracts this decay, restoring viability for long-horizon tasks."}
