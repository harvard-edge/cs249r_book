...
- **The Deep Approach (Universal Primitive):**
  ...
  The model uses its pretrained understanding of the `kubectl` CLI syntax to compose commands dynamically, reducing schema overhead by 99.7 percent while supporting the entire surface area of the Kubernetes API.
...
| **System Prompt Footprint** |         20,000--60,000 tokens          |          500--1,500 tokens          | Saves 92--99% of prefill compute and KV memory |
