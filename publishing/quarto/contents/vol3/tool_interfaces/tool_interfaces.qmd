...
::: {#fig-tool-syntax-errors fig-env="figure" fig-pos="htb" fig-cap="**Tool invocation syntax error rates (2022–2025)**: The transition across three generations of agent-to-software interfaces. First-generation text scraping suffered from high syntax failure rates. Second-generation native JSON function calling (introduced mid-2023) reduced parsing errors significantly but left residual hallucination. Third-generation grammar-constrained decoding engines (introduced mid-2024) physically prevent malformed generation, driving the structural error rate to absolute zero." fig-alt="Chart of tool invocation syntax error rate over time across three generations, dropping from about twenty-one percent under text scraping to near zero under constrained decoding, with vertical markers at each generational transition."}
