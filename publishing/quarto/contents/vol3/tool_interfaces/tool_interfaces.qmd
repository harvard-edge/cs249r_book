...
While typed ABIs and grammar masks guarantee that tool calls are well-formed, they cannot guarantee that they are safe. In @sec-vol3-sandboxing-isolation, we move beneath the wire protocol to explore the operating system sandboxes—from Linux cgroups to microVMs—that isolate non-deterministic agents from host environments.
