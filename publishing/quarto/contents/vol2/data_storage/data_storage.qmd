...
::: {#fig-storage-compute-gap fig-env="figure" fig-pos="htb" fig-cap="**The Storage-Compute Gap**: While accelerator compute (TFLOPS) and internal high-bandwidth memory (HBM) have grown exponentially, local storage bandwidth (NVMe) has scaled much slower. This growing divergence creates a fuel-line bottleneck where computation must pause to wait for data delivery."}
