...
::: {#fig-gpu-memory-wall fig-env="figure" fig-pos="htb" fig-cap="**The GPU Memory Wall**: Over the last decade, theoretical compute (peak TFLOPS) has scaled much faster than memory bandwidth (GB/s). The widening gap dramatically increases arithmetic intensity constraints, making large language model inference severely memory-bandwidth bound."}
...
df = pd.read_csv("data/gpu_memory_wall.csv")

color1 = '#E67817' # Orange
ax1.set_xlabel('Year', fontweight='bold')
ax1.set_ylabel('Peak Compute (TFLOPS)', color=color1, fontweight='bold')
line1 = ax1.plot(df['Year'], df['Peak_TFLOPS'], color=color1, marker='o', linewidth=2.5, label='Peak Compute (TFLOPS)')
ax1.tick_params(axis='y', labelcolor=color1)
ax1.set_yscale('log')

ax2 = ax1.twinx()
color2 = '#005A9C' # Blue
ax2.set_ylabel('Memory Bandwidth (GB/s)', color=color2, fontweight='bold')
line2 = ax2.plot(df['Year'], df['Memory_Bandwidth_GBps'], color=color2, marker='s', linewidth=2.5, label='Memory Bandwidth (GB/s)')
ax2.tick_params(axis='y', labelcolor=color2)
ax2.set_yscale('log')

ax1.set_xticks(df['Year'])
ax1.set_xticklabels([f"{y}\n({g})" for y, g in zip(df['Year'], df['GPU'])])

# Combined legend
lines = line1 + line2
labels = [l.get_label() for l in lines]
ax1.legend(lines, labels, loc='upper left', frameon=True, facecolor='white', framealpha=0.95, edgecolor='gray', fancybox=True)
