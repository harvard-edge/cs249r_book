...
sns.lineplot(data=data, x="Year", y="Standard_Accuracy", marker="o", label="Standard Accuracy", ax=ax, linewidth=2)
sns.lineplot(data=data, x="Year", y="Robust_Accuracy", marker="s", label="Robust Accuracy ($\ell_\infty$)", ax=ax, linewidth=2)
