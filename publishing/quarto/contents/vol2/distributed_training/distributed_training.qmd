...
::: {#fig-memory-wall-trend fig-env="figure" fig-pos="htb" fig-cap="**The memory wall**: The gap between single-device memory capacity and the memory required to train state-of-the-art models has widened exponentially. Training large language models natively requires distributing weights, gradients, and optimizer states across multiple accelerators."}
