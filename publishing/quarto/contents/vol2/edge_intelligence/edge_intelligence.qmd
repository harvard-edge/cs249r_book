...
::: {#fig-edge-npu-tops fig-env="figure" fig-pos="htb" fig-cap="**Mobile NPU performance scaling**: The computational capacity of dedicated edge accelerators (measured in trillions of operations per second, or TOPS) has grown dramatically since their introduction, enabling complex on-device ML workloads. Data tracks the Apple Neural Engine from the A11 to the A18 generation." fig-alt="Line chart of mobile neural processing unit throughput in TOPS by release year from 2017 to 2024, rising from under one to about thirty-five with a sharp step at the 2023 generation."}
