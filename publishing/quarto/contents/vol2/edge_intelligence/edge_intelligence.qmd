...
::: {#fig-edge-npu-tops fig-env="figure" fig-pos="htb" fig-cap="**Mobile NPU Performance Scaling**: The computational capacity of dedicated edge accelerators (measured in trillions of operations per second, or TOPS) has grown dramatically since their introduction, enabling complex on-device ML workloads. Data tracks the Apple Neural Engine from the A11 to the A18 generation."}
...
data = pd.read_csv("data/ane_trend.csv")

fig, ax = plt.subplots(figsize=(8, 5))

sns.lineplot(data=data, x="Year", y="TOPS", marker="o", linewidth=2.5, markersize=8, color="#0072B2", ax=ax)

# Annotate points with chip names
for i, row in data.iterrows():
    ax.annotate(row['Chip'], 
                (row['Year'], row['TOPS']),
