...
::: {#fig-compute-scaling fig-env="figure" fig-pos="htb" fig-cap="**Historical training compute scaling**: Training compute for state-of-the-art machine learning models over time. The exponential growth in FLOPs required to train leading models drives the capacity planning constraints and the need for massive GPU clusters."}
