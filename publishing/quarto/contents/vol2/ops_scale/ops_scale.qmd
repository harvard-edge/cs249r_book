...
::: {#fig-compute-scaling fig-env="figure" fig-pos="htb" fig-cap="**Historical training compute scaling**: Training compute for state-of-the-art machine learning models over time. The exponential growth in FLOPs required to train leading models drives the capacity planning constraints and the need for massive GPU clusters." fig-alt="Log-scale scatter of total training compute in FLOPs by year from AlexNet in 2012 to Llama-3-400B in 2024, with a fitted exponential trend line the points track closely."}
