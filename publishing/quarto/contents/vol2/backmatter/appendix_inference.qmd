...
::: {#fig-queuing-hockey-stick fig-env="figure" fig-pos="htb" fig-cap="**The queuing hockey stick**: The M/M/1 relation $\rho_{\text{serv}}/(1-\rho_{\text{serv}})$ shows queue length rising sharply as utilization approaches one. The shaded safe, caution, and danger regions emphasize why production systems retain utilization headroom rather than operating near saturation." fig-alt="Plot of queue length in requests versus serving utilization rho_serv from 0 to 1. The curve is flat until rho_serv around 0.7, bends upward through a caution band from 0.7 to 0.85, then rises sharply in a danger zone toward saturation at rho_serv equals 1."}
