...
::: {#fig-ai-compute-growth fig-env="figure" fig-pos="htb" fig-cap="**Historical AI compute growth**: The computational requirements for training landmark machine learning models have scaled exponentially, far outpacing the doubling rates associated with hardware improvements." fig-alt="Log-scale scatter of total training compute in FLOPs against release date for landmark models from AlexNet in 2012 to Llama-3 in 2024, spanning about eight orders of magnitude along a near-straight line."}
