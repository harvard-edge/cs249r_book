...
python quizzes.py --mode generate -f vol1/introduction/introduction.qmd
...
python quizzes.py --mode generate -d vol1/ --parallel
...
def extract_all_chapter_concepts(base_path="quarto/vol1", verbose=False):
    ...
    if os.path.exists(QUARTO_YML_PATH):
        try:
            ...
            for qmd_file in ordered_files:
                # Extract chapter name from path like 'vol1/introduction/introduction.qmd'
