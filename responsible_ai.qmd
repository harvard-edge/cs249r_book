...
![Various fairness metrics and accuracy may result in different optimal classifiers.](images/responsible_ai/fairness_cartoon.png){width="3.821385608048994in" height="2.5558081802274715in"}{#fig-fairness-example}
*Figure @fig-fairness-example: Various fairness metrics and accuracy may result in different optimal classifiers.*
...
![Diffusion models may memorize samples from their training data. Courtesy of Carlini et al. 2023.](images/responsible_ai/diffusion_memorization.png){width="3.821385608048994in" height="2.5558081802274715in"}{#fig-diffusion-model-example}
...
![Example of a small perturbation changing a model prediction.](images/responsible_ai/adversarial_robustness.png){#fig-adversarial-example}
...
![A diagram of human-centered AI.](images/responsible_ai/human_centered_ai.png){#fig-human-centered-ai}

*Figure @fig-human-centered-ai: A diagram of how various groups impact human-centered AI.*
...
![Example of a small perturbation changing a model prediction.](images/responsible_ai/human_compatible_ai.png){#fig-human-compatible-ai}
*Figure @fig-human-compatible-ai: **"The formal problem F to be solved by the machine in this case is a game-theoretic one: to maximize human future-life preferences subject to its initial uncertainty as to what they are, in an environment that includes human participants. Furthermore, although the future-life preferences are hidden variables, they’re grounded in a voluminous source of evidence, namely, all of the human choices ever made.”** [Human-Compatible Artificial Intelligence](https://people.eecs.berkeley.edu/~russell/papers/mi19book-hcai.pdf), pg. 8.*
