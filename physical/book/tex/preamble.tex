...
\setkomafont{pagenumber}{\normalfont\sffamily\bfseries\fontsize{8.5pt}{10.5pt}\selectfont\color{accentcolor}}

% Verso (even / left) header: Left is Chapter mark, Right is page number (matching MLSysBook)
\lehead{\small\leftmark}
\rehead{\pagemark}

% Recto (odd / right) header: Left is page number, Right is Section mark (matching MLSysBook)
\lohead{\pagemark}
...
\setkomafont{chapter}{\normalfont\sffamily\bfseries\fontsize{18pt}{22pt}\selectfont\color{ink}}
\setkomafont{section}{\normalfont\sffamily\bfseries\fontsize{12pt}{15pt}\selectfont\color{structural}}
\setkomafont{subsection}{\normalfont\sffamily\bfseries\fontsize{10.5pt}{13pt}\selectfont\color{structural}}
\setkomafont{subsubsection}{\normalfont\sffamily\bfseries\fontsize{9.5pt}{12pt}\selectfont\color{structural}}
\setkomafont{paragraph}{\normalfont\sffamily\bfseries\fontsize{9pt}{11.5pt}\selectfont\color{structural}}
...
\renewcommand*{\chapterlinesformat}[3]{%
  \vspace*{0.05in}%
  #2%
  {\normalfont\sffamily\bfseries\fontsize{18pt}{22pt}\selectfont\color{ink}\raggedright #3}\par\nobreak
...
\setkomafont{part}{\normalfont\sffamily\bfseries\fontsize{22pt}{26pt}\selectfont\color{ink}\raggedright}
...
\renewcommand*{\l@chapter}[2]{%
  \ifnum \c@tocdepth >\m@ne
    ...
    {%
      ...
      \leavevmode
      \begingroup
        \renewcommand{\numberline}[1]{{\normalfont\sffamily\bfseries\fontsize{8.8pt}{11.5pt}\selectfont\color{accentcolor}\format@toc@number{##1}\hspace{0.55em}}}%
        {\normalfont\sffamily\bfseries\fontsize{8.8pt}{11.5pt}\selectfont\color{accentcolor}#1}\nobreak
      \endgroup
      \TOCLineLeaderFill
      \nobreak
      {\normalfont\sffamily\bfseries\fontsize{8.8pt}{11.5pt}\selectfont\color{accentcolor}#2}%
      \par
    }%
  \fi
}
