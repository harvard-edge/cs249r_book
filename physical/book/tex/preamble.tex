...
\lehead{\pagemark\hspace{1.2em}{\color{paleink!70}\rule[-0.2ex]{0.4pt}{1.2ex}}\hspace{1.2em}\headmark}
\rehead{}

% Recto (odd / right) header: Inner section title, Outer page number
\lohead{}
\rohead{\headmark\hspace{1.2em}{\color{paleink!70}\rule[-0.2ex]{0.4pt}{1.2ex}}\hspace{1.2em}\pagemark}
