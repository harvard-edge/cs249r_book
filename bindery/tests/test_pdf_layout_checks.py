...
from bindery.cli.commands._pdf_checks import (
    PdfCheckItem,
    PdfIssue,
    PdfValidationResult,
    format_checklist,
...
from bindery.cli.commands.layout import LayoutCommand
from bindery.cli.commands.layout import PageReport
from bindery.cli.commands.layout import CollisionFinding
from bindery.cli.checks.margin_geometry import MarginGeometryFinding, MarginGeometrySummary
from bindery.cli.checks.margin_geometry import scan_page as scan_margin_geometry_page
...
def test_scan_margin_overflow_missing_file_returns_none():
    from bindery.cli.commands.layout import scan_margin_overflow
...
def test_default_log_path_discovers_sibling_log(tmp_path):
    ...
    from bindery.cli.commands._pdf_checks import default_log_path
...
def test_stale_log_is_not_auto_discovered(tmp_path):
    ...
    import os
    from bindery.cli.commands._pdf_checks import default_log_path, default_pdf_path
