...
### Core Files
- `bindery/docker/linux/Dockerfile` - Linux build container definition
- `bindery/docker/linux/README.md` - Linux container documentation
- `bindery/docker/linux/.dockerignore` - Linux build exclusions
- `bindery/docker/windows/Dockerfile` - Windows build container definition
- `bindery/docker/windows/README.md` - Windows container documentation
- `bindery/docker/windows/.dockerignore` - Windows build exclusions
...
- **Linux**:
  ```bash
  docker build -f bindery/docker/linux/Dockerfile -t mlsysbook-linux .
  ```
- **Windows**:
  ```powershell
  docker build -f bindery/docker/windows/Dockerfile -t mlsysbook-windows .
  ```
