...
- **Inline Python (LEGO cells)**: Quantitative examples use `{python}` cells with small scenario classes. See [LEGO cell contract](LEGO_CELLS.md) for placement, naming, and fmt conventions. Fmt/notation audits use [bindery/tools/audit/fmt/README.md](../tools/audit/fmt/README.md).
