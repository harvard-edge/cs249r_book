...
LLM/editor notes:
    ...
    * A margin figure must serve the paragraph beside it. The chapter placement
      ...
      ``bindery/tools/audit/margin_figure_opportunities.yml`` and
...
Usage:
    MPLCONFIGDIR=/tmp/mplconfig python3 bindery/tools/scripts/margin_figures/generate_margin_figures.py
"""
...
from bindery.tools.figures.margin.devices import (  # noqa: E402
    C,
    COMP,
    DATA,
    GRID,
...
CONTENTS = ROOT / "books"
AUDIT_DIR = ROOT / "bindery/tools/audit"
