...
plus the Book Tools modules under `bindery/tools/figures/`. Do not delete, move, or
...
`bindery/tools/figures/style.py`, and stable margin drawing devices live in
`bindery/tools/figures/margin/devices.py`. This directory retains script
...
- `bindery/tools/audit/margin_figure_opportunities.yml`
- `bindery/tools/audit/margin_figure_decisions.yml`
- `bindery/tools/audit/margin_figure_style_audit.md`
...
4. If the same label-placement or geometry issue affects a whole device family,
   change `bindery/tools/figures/margin/devices.py` instead.
...
`bindery/tools/audit/margin_figure_reader_link_audit.md`. Each entry embeds the SVG,
...
`bindery/tools/audit/margin_figure_reader_alignment_verdicts.md`. It summarizes the
...
```bash
python3 bindery/tools/scripts/margin_figures/render_margin_reader_alignment_html.py
```

The default output is
`bindery/tools/audit/margin_figure_reader_alignment.html`. Open this file directly
