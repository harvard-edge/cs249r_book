...
DOIs, and URLs stay byte-identical to what was reviewed there.
    ...
    python3 bindery/tools/scripts/structure/build_volume_bib.py vol3
    python3 bindery/tools/scripts/structure/build_volume_bib.py vol3 --check
"""
...
def render(vol: str) -> tuple[str, list[str]]:
    ...
    header = (
        ...
        f"% Generated by bindery/tools/scripts/structure/build_volume_bib.py.\n"
    ...
    for vol in volumes:
        ...
        if args.check:
            ...
            if extra or absent:
                ...
                print(
                    f"  Regenerate with: python3 bindery/tools/scripts/structure/build_volume_bib.py {vol}",
                    file=sys.stderr,
                )
            else:
