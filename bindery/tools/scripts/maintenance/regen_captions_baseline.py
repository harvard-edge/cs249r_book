#!/usr/bin/env python3
"""Regenerate bindery/tools/audit/baselines/captions_baseline.json.
...
Run from the repo root:
    python3 bindery/tools/scripts/maintenance/regen_captions_baseline.py
"""
...
def main() -> int:
    ...
    baseline = {
        "description": (
            ...
            "bindery/tools/scripts/maintenance/regen_captions_baseline.py."
        ),
