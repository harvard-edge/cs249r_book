...
python3 bindery/tools/scripts/quizzes/generate_quizzes.py \
...
2. `bindery/tools/scripts/quizzes/_reviews/{chapter}_memo.md` —
...
`bindery/tools/scripts/quizzes/_legacy/quizzes_reference.py` is a
...
- Write a lean runner in `bindery/tools/scripts/{artifact}/generate.py`.
