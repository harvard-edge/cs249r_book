...
in ``bindery/cli/checks/bib_lint.py`` and adds a small MIT Press production layer for
...
def main() -> int:
    ...
    parser.add_argument("--json", action="store_true", help="Write a JSON report under bindery/tools/audit/out")
