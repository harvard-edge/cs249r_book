...
See [`bindery/tools/README.md`](../README.md) for the production-tool policy. Do
...
Command reference and pre-commit mapping: **[`bindery/docs/BINDER.md`](../../docs/BINDER.md)**. Implementation details: **[`bindery/cli/README.md`](../../cli/README.md)**.

Direct `python3 bindery/tools/scripts/...` use is for maintenance, generation, or
...
```bash
./bindery/tools/scripts/publish/mit-press-release.sh --vol1
./bindery/tools/scripts/publish/publish.sh
./bindery/tools/scripts/maintenance/run_maintenance.sh
```
...
```bash
python3 bindery/tools/scripts/publish/extract_figures.py --help
```
