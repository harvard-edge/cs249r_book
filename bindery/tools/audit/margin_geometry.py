...
Core implementation lives in ``bindery/cli/checks/margin_geometry.py``. Keep this
script so older notes and shell history that call ``bindery/tools/audit`` still
...
from bindery.cli.checks.margin_geometry import scan_pdf
