...
4. Run both before push:
   ```bash
   python3 bindery/tools/audit/book_check_lego_prose_units.py
   python3 bindery/tools/audit/fmt/fmt_prose_contract.py --root books
   pytest bindery/tests/test_lego_prose_units.py bindery/tests/test_fmt_prose_contract.py -q
   ```
