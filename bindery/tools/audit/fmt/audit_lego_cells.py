...
Usage (repo root)::
    ...
    PYTHONPATH=mlsysim python3 bindery/tools/audit/fmt/audit_lego_cells.py
    PYTHONPATH=mlsysim python3 bindery/tools/audit/fmt/audit_lego_cells.py \\
        --report bindery/tools/audit/artifacts/lego_cells_verify_report.json
    PYTHONPATH=mlsysim python3 bindery/tools/audit/fmt/audit_lego_cells.py \\
...
def main() -> int:
    ...
    out_path = args.report or (
        root / "bindery/tools/audit/artifacts/lego_cells_verify_report.json"
    )
