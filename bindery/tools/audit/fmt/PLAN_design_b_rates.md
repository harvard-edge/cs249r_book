...
python3 bindery/tools/audit/fmt/audit_lego_html.py --report /tmp/lego_html.json
```
...
```bash
python3 bindery/tools/audit/fmt/inventory_design_b_rates.py \
  --root books \
  --json bindery/tools/audit/artifacts/fmt_design_b_inventory.json
```
...
python3 bindery/tools/audit/fmt/audit_lego_html.py --report /tmp/lego_html_all.json
