...
Usage (repo root, after HTML archive exists)::
    ...
    PYTHONPATH=mlsysim python3 bindery/tools/audit/fmt/audit_lego_rendered_prose.py
    PYTHONPATH=mlsysim python3 bindery/tools/audit/fmt/audit_lego_rendered_prose.py \\
        --markdown bindery/tools/audit/artifacts/lego_rendered_prose_audit.md
"""
...
def main() -> int:
    ...
    json_path = args.json or root / "bindery/tools/audit/artifacts/lego_rendered_prose_audit.json"
    json_path.parent.mkdir(parents=True, exist_ok=True)
    json_path.write_text(json.dumps(report, indent=2), encoding="utf-8")

    md_path = args.markdown or root / "bindery/tools/audit/artifacts/lego_rendered_prose_audit.md"
    _write_markdown(md_path, report)
    reports_dir = root / "bindery/tools/audit/artifacts/lego_chapter_reports"
