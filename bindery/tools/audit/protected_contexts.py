...
- bindery/tools/scripts/content/fix_capitalization.py (proven implementation)
- bindery/tools/scripts/content/fix_emdash.py (proven implementation)
- bindery/tools/scripts/content/fix_percent.py (proven implementation)
"""
