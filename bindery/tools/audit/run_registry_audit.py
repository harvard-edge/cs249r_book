...
def main() -> int:
    steps: list[tuple[str, list[str], Path | None]] = [
        ("book registry sources", [sys.executable, "bindery/tools/audit/book_check_registry_sources.py"], REPO),
        ("appendix LEGO cells", [sys.executable, "bindery/tools/audit/generate_appendix_constants.py", "--verify"], REPO),
        (
            "mlsysim provenance",
        ...
        (
            ...
            [
                ...
                str(REPO / "bindery" / "tests" / "test_appendix_constants.py"),
                str(REPO / "bindery" / "tests" / "test_appendix_lineage.py"),
                str(REPO / "bindery" / "tests" / "test_no_legacy_constant_refs.py"),
                str(REPO / "bindery" / "tests" / "test_registry.py"),
                str(REPO / "bindery" / "tests" / "test_mlsysim_registry_coverage.py"),
                "--no-cov",
                "-q",
            ],
            MLSYSIM,
