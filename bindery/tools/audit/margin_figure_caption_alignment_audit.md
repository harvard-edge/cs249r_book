...
```bash
python3 bindery/tools/scripts/margin_figures/inventory_margin_figures.py \
  --format csv \
  --output /tmp/mlsysbook-margin-inventory.csv
python3 bindery/tools/scripts/margin_figures/audit_margin_caption_alignment.py \
...
python3 bindery/tools/scripts/margin_figures/render_margin_reader_link_audit.py
```
...
`bindery/tools/audit/margin_figure_reader_link_audit.md`. It is the artifact to open
...
`bindery/tools/audit/margin_figure_reader_alignment_verdicts.md`. It records the
