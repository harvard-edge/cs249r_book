...
runtime by `bindery/tools/figures/style.py`.

License: GUST Font License (GFL) — freely redistributable. Source: TeX Gyre
project (GUST), also shipped with TeX Live / TinyTeX.
