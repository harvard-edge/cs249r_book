...
Production scripts under `bindery/tools/scripts/margin_figures/` import this module
...
- Per-figure data, labels, captions, and asset names:
  `bindery/tools/scripts/margin_figures/generate_margin_figures.py`
- Shared device geometry, fonts, colors, label placement, and SVG export:
  `bindery/tools/figures/margin/devices.py`
...
```bash
python3 bindery/tools/scripts/margin_figures/render_margin_contact_sheet.py \
