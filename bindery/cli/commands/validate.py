...
Some checks still delegate to scripts under bindery/tools/scripts/ (tables,
spelling, epub, sources, grid-tables, images) and to standalone audit
scripts under bindery/tools/audit/index/. Prefer new logic in cli/checks/
with normal imports; see bindery/cli/README.md "Check implementation layout".
...
class ValidateCommand:
    ...
    GROUPS: Dict[str, List[Scope]] = {
        ...
        "index": [
            ...
            # Migrated 2026-05-06: was bindery/tools/audit/index/check_anti_patterns.py
            Scope("anti-patterns", "_run_index_anti_patterns",
                  note="anti-patterns from the project index rules §9"),
            # Migrated 2026-05-06: was bindery/tools/audit/index/check_tag_placement.py
            Scope("tag-placement", "_run_index_tag_placement",
                  note='\\index{} not inside **bold**, *italic*, `code`, or headings'),
            # Migrated 2026-05-06: was bindery/tools/audit/index/check_xref_resolves.py
    ...
    def _print_epub_help(self) -> None:
        ...
        console.print()
        console.print("[dim]Deep dive: bindery/cli/README.md → \"EPUB Checks — Two Layers, One CLI Surface\"[/dim]")
        console.print()
    ...
    def _run_inline_refs(self, root: Path, check_patterns: bool,
        ...
        for file in files:
            ...
            if check_scope:
                from bindery.tools.scripts.maintenance.validate_inline_refs import check_scope as _check_scope, BOOK_ROOT
                try:
    ...
    # at bindery/tools/audit/baselines/captions_baseline.json grandfathers
    ...
    def _run_inline_ref_order(self, root: Path) -> ValidationRunResult:
        ...
        try:
            ...
            from bindery.cli.checks.inline_ref_order import check_inline_order
    ...
    def _run_concept_maps(self, root: Path) -> ValidationRunResult:
        ...
        try:
            ...
            from bindery.cli.checks.concept_maps import check_concept_maps
    ...
    # bindery/tools/scripts/mit_press/footnote_caps_allowlist.txt.
    ...
    def _run_footnote_capitalization(self, root: Path) -> ValidationRunResult:
        ...
        try:
            ...
            from bindery.cli.checks.footnote_caps import DEFAULT_ALLOWLIST, load_allowlist, scan_file
    ...
    def _run_footnote_slug_taxonomy(self, root: Path) -> ValidationRunResult:
        ...
        try:
            ...
            from bindery.cli.checks.footnote_caps import DEFAULT_ALLOWLIST, load_allowlist
    ...
    def _run_table_content(self, root: Path) -> ValidationRunResult:
        ...
        try:
            ...
            from bindery.cli.checks.table_content import validate_file
    ...
    def _run_spelling_prose(self, root: Path) -> ValidationRunResult:
        ...
        try:
            ...
            from bindery.cli.checks.spelling_prose import check_file
    ...
    def _run_spelling_tikz(self, root: Path) -> ValidationRunResult:
        ...
        try:
            ...
            from bindery.cli.checks.spelling_tikz import check_file
    ...
    # the EPUB build pipeline. See bindery/cli/commands/_epub_checks.py for
    ...
    def _run_grid_tables(self, root: Path) -> ValidationRunResult:
        ...
        try:
            ...
            from bindery.cli.checks.grid_tables import check_grid_tables
    ...
    def _run_bib_hygiene(self, root: Path) -> ValidationRunResult:
        ...
        only NEW errors (not in bindery/tools/bib_lint_baseline.json) block;
                ...
                for v in bib_lint.validate_entry(entry):
                    ...
                    issues.append(ValidationIssue(
                        ...
                        message=(
                            ...
                            "bindery/tools/bib_lint_style_baseline.json; new issues must be fixed "
    ...
    # ──────────────────────────────────────────────────────────────────────
    # Native audit-check adapters (bindery/tools/audit/checks/*).
    #
    ...
    def _run_audit_check(
        ...
        The audit package lives at `bindery/tools/audit/`. It uses relative
        imports against its own `audit.*` top-level package, so the parent
        directory (`bindery/tools`) must be on sys.path for the import to
        resolve. This method does the path-prepend once per call.
        """
        import importlib
        import sys as _sys
        # Prefer native bindery/cli/audit, fallback to bindery/tools
    ...
    def _run_mitpress_abbreviation_first_use(self, root: Path) -> ValidationRunResult:
        ...
        `bindery/cli/data/abbreviations.yaml`. Terms under
    ...
    def _run_notation_consistency(self, root: Path) -> ValidationRunResult:
        ...
        accept-list at bindery/tools/audit/accepted_fps_notation.json is
        ...
        subprocess. Replaces the standalone bindery/tools/audit/run_notation_consistency.py.
        """
        import importlib
        import sys as _sys
    ...
    def _run_image_formats(self, root: Path) -> ValidationRunResult:
        ...
        try:
            ...
            from bindery.cli.checks.image_formats import check_file
    ...
    def _run_external_images(self, root: Path) -> ValidationRunResult:
        ...
        try:
            ...
            from bindery.cli.checks.external_images import ImageDownloader
    ...
    def _run_unit_tests(self, root: Path) -> ValidationRunResult:
        ...
        Native import of bindery/tests/test_units.py via importlib — no
    ...
    def _run_index_placement_contexts(self, root: Path) -> ValidationRunResult:
        ...
        Wraps the native audit check at bindery/tools/audit/checks/index_placement.py.
        """
        return self._run_audit_check(
