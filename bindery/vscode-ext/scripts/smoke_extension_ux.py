...
def build_cases(repo_root: Path) -> list[Case]:
    ...
    cases: list[Case] = [
        ...
        Case("publish script help vol1", "bash bindery/tools/scripts/publish/mit-press-release.sh --help", 30, allow_nonzero_exit=True),
        Case("extract figures help", "python3 bindery/tools/scripts/publish/extract_figures.py --help", 30),
    ]
