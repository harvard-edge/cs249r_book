...
2. **Computation on Ciphertext:** The ML algorithm processes the encrypted data directly. For instance, multiplying the ciphertexts E(x) and E(y) generates E(x\*y). More complex model training can also be done on ciphertexts.
