...
This is a test of footnote formatting\footnote{\textbf{Foundation
  Models}: This should be bold text in the footnote to test if our LaTeX
  fix works properly.}.
