...
% --- Full-width diagram ---
\centering
\safeimg[width=0.92\textwidth,height=4.8cm,keepaspectratio]{cpu-vs-gpu-die.pdf}
...
\begin{columns}[T]
  \begin{column}{0.45\textwidth}
    \centering
    \textcolor{computestroke}{\textbf{CPU}}: ~5\% compute area\\
    {\footnotesize Optimized for \emph{single-thread latency}}
  \end{column}
  \begin{column}{0.45\textwidth}
    \centering
    \textcolor{datastroke}{\textbf{GPU}}: ~80\% compute area\\
    {\footnotesize Optimized for \emph{parallel throughput}}
  \end{column}
\end{columns}
