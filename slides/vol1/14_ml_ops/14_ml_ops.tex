...
\note{[3 min] Give students 90 seconds. Answer: $T^* = \sqrt{2 \times 500 / (10{,
PEER INSTRUCTION PROTOCOL:
1. Present problem (30s). 2. Individual vote (60s).
3. If 30-70\% correct: pair discussion (90s), then re-vote.
4. Reveal and explain.}000 \times 0.50 \times 0.92 \times 0.003)} \approx \sqrt{1000/13.8} \approx 8.5$ days.
