...
\begin{columns}[T]
  \begin{column}{0.50\textwidth}
    \safeimg{five-percent-problem.pdf}
  \end{column}
...
\begin{columns}[T]
  \begin{column}{0.48\textwidth}
    \safeimg{monitoring-dashboard.pdf}
  \end{column}
  \begin{column}{0.48\textwidth}
...
\begin{columns}[T]
  \begin{column}{0.48\textwidth}
    \safeimg{deployment-spectrum.pdf}
  \end{column}
  \begin{column}{0.48\textwidth}
