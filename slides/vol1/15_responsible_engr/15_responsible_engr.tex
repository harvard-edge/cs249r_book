...
\begin{columns}[T]
  ...
  \begin{column}{0.42\textwidth}
    ...
    \begin{tabular}{@{}ll@{}}
      ...
      \midrule
      Amazon   & \textcolor{datastroke}{\textbf{Data}} (biased history) \\
      COMPAS   & \textcolor{computestroke}{\textbf{Algorithm}} (wrong objective) \\
      Optum    & \textcolor{datastroke}{\textbf{Data}} (proxy variable) \\
      \bottomrule
    \end{tabular}
    }

    \vspace{0.1cm}
    {\scriptsize Engineers must choose \emph{which} fairness constraint to enforce for the domain.}
  \end{column}
\end{columns}
...
\vspace{0.1cm}
\mlsysconcept{Quantization saves:}{20\% latency reduction $\to$ \$304K + 8.9t CO2 over 3 years.}

\vspace{0.05cm}
\mlsysalert{Hidden cost:}{Inference-to-training ratio = \textbf{40:1}. Per-query optimization has highest ROI.}
