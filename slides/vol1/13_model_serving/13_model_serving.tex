...
\begin{columns}[T]
  ...
  \begin{column}{0.45\textwidth}
    \begin{mlsyscard}{routingstroke}
    {\footnotesize\textbf{Mitigation Strategies}}\\[0.05cm]
    \textbf{Model caching:} Keep weights in memory.\\[0.02cm]
    \textbf{Pre-warming:} Run dummy inferences.\\[0.02cm]
    \textbf{Serialized engines:} Pre-compiled plans skip JIT.\\[0.02cm]
    \textbf{Keep-alive:} Never scale to zero.
    \end{mlsyscard}
  \end{column}
\end{columns}
