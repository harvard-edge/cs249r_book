...
\begin{columns}[T]
  \begin{column}{0.55\textwidth}
    {\normalsize\bfseries Calculate the Robustness Tax}
  ...
  \begin{column}{0.42\textwidth}
    ...
    = \textcolor{errorstroke}{\textbf{44.7\%}}\\[0.1cm]
    2. With defense: $(76-62)/76$\\
    = \textcolor{routingstroke}{\textbf{18.4\%}} (attack)\\[0.1cm]
    3. Clean tax: $(76-50)/76$\\
    = \textcolor{errorstroke}{\textbf{34.2\%}} (always paid)\\[0.1cm]
