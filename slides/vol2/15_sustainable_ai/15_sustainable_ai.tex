...
\note{
% -- LINK: What prior concept connects to this slide
The 4 Ms provided the framework. These guidelines provide step-by-step
implementation for engineering teams.

% -- NARRATE: What to SAY while showing this slide
[2 min] Walk through the numbered list. Emphasize step 1: ``Measure first ---
you cannot optimize what you do not measure. CodeCarbon wraps training in 3
lines of code.'' Highlight step 4: ``Transfer learning is 20--100x more
energy-efficient than training from scratch.''

% -- FLEX: [OPTIONAL] + contingency
[OPTIONAL] Concrete implementation guidance.
IF SHORT: Highlight steps 1 (measure) and 2 (choose region) only.
}
