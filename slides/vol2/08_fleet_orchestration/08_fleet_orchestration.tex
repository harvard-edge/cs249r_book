...
\note{
% -- NARRATE: Four ML-specific schedulers compared on key metrics.
...
\note{
% -- NARRATE: When to use spot vs on-demand for ML workloads.
...
\vspace{0.1cm}
{\footnotesize\textbf{Net savings formula:} $\text{Savings} = \text{Discount} - \text{Preemption overhead} - \text{Checkpoint cost}$.\\
Typical: 65\% discount $-$ 25\% overhead $-$ 12\% checkpoint = \textbf{28\% net savings}.}
