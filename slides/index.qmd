...
.vol-card:last-of-type { border-bottom: 1px solid #e2e8f0; }
.vol-card:hover h3 { color: #BE185D; }
.vol-card .tag {
  font-size: 0.68rem;
  font-weight: 700;
  text-transform: uppercase;
...
.inv-table tr:hover { background: transparent; }

/* Inventory tables stack on narrow screens: the fixed 150px/100px columns
   plus nowrap overflow a phone otherwise. */
@media (max-width: 600px) {
  .inv-table, .inv-table tbody, .inv-table tr, .inv-table td { display: block; width: auto; }
  .inv-table tr { border-bottom: 1px solid #f1f5f9; padding: 0.75rem 0; }
  .inv-table td { border: none; padding: 0.1rem 0; }
  .inv-table td:first-child { width: auto; white-space: normal; }
  .inv-table td:last-child { width: auto; text-align: left; padding-top: 0.35rem; }
}
