...
def load_config() -> dict:
    ...
    defaults = {
        "paths": {
            ...
            "paper_dir": "paper",
            "staffml_export": "app/src/data/corpus.json",
        },
        "models": {
...
def cmd_taxonomy_sync(args):
    """Export enriched taxonomy to app/src/data/taxonomy.json."""
    taxonomy = json.loads(TAXONOMY_PATH.read_text())
    corpus = load_corpus()
    ...
    # Write to staffml
    out_path = BASE / "app" / "src" / "data" / "taxonomy.json"
...
# ─── GRAPH (deprecated) ────────────────────────────────────────
# NOTE: cmd_graph removed — replaced by app/src/app/taxonomy/ (Phase 2+4)
def cmd_graph(args):
