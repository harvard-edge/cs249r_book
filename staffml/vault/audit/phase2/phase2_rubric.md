...
Background: `staffml/vault/questions/<track>/<id>.yaml`. Classification is four orthogonal axes: `track`, `level`, `zone`, `topic`. Paper at `staffml/paper/paper.tex` §3 defines the model.
