...
def build_repair_backlog(
    ...
    if coverage["taxonomy"]["missing_from_taxonomy_data"]:
        add(
            ...
            "staffml/vault/schema/taxonomy_data.yaml",
        )
...
def validation_gates() -> list[dict[str, Any]]:
    return [
        {"gate": "schema", "command": "python3 staffml/vault/scripts/validate_generation_gates.py", "blocks": True},
        ...
        {"gate": "napkin-math", "command": "python3 staffml/vault/scripts/verify_math.py", "blocks": True},
