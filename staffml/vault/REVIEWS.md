...
15. **New files**:
    - `staffml/vault/schema/EVOLUTION.md` (Phase 0)
    - `staffml/vault-cli/README.md` (Phase 0)
    - `staffml/CONTRIBUTING.md` or section in root README (Phase 0)
    - `staffml/vault-cli/docs/JSON_OUTPUT.md`, `EXIT_CODES.md`, `CUTOVER_QA.md` (Phase 0–2)
