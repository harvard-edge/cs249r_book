...
> I have read the StaffML CLA at [staffml/app/CLA.md](CLA.md) and agree
  ...
  cla-check:
    ...
    steps:
      - name: CLA Assistant
        ...
        with:
          path-to-signatures: 'staffml/app/.cla-signatures.json'
          path-to-document: 'https://github.com/harvard-edge/cs249r_book/blob/dev/staffml/app/CLA.md'
          branch: 'main'
...
4. The bot will create `staffml/app/.cla-signatures.json` on first signature.
