...
```
staffml/vault/_pipeline/runs/full-corpus-20260503-merged/
...
python3 -c "
import json
d = json.loads(open('staffml/vault/_pipeline/runs/full-corpus-20260503-merged/03_math_verification.json').read())
for v in d['verdicts']:
    if v['verdict'] == 'no':
...
python3 -c "
import json
d = json.loads(open('staffml/vault/_pipeline/runs/full-corpus-20260503-merged/02_mass_apply.json').read())
...
vault audit review \
    --input staffml/vault/_pipeline/runs/full-corpus-20260503-merged/01_audit.json \
