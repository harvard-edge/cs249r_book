...
```bash
python3 staffml/vault-cli/scripts/promote_drafts.py \
...
```bash
python3 staffml/vault-cli/scripts/promote_drafts.py --qids edge-2536
```
...
```bash
git rm staffml/vault/questions/edge/latency/edge-2535.yaml.draft
```
...
python3 staffml/vault-cli/scripts/validate_drafts.py \
  --scope staffml/vault/questions/edge/latency/ \
...
Open `staffml/vault/draft-validation-scorecard.json` for the full
