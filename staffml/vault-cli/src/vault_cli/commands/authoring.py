...
REGISTRY_PATH = Path("staffml/vault/id-registry.yaml")
...
def _id_hash(title: str, topic: str) -> str:
    ...
    Matches the recipe documented in staffml/vault/docs/ID_SCHEMES.md.
...
def register(app: typer.Typer) -> None:
    ...
    def new_cmd(
        ...
        # staffml/vault/AUTHORING.md "Markup conventions" for the
