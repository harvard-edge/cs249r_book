...
def register(app: typer.Typer) -> None:
    ...
    def build_cmd(
        vault_dir: Path = typer.Option(
            Path("staffml/vault"),
            "--vault-dir",
            help="Path to vault/ directory (default: staffml/vault).",
        ),
        output: Path = typer.Option(
            Path("staffml/vault/vault.db"),
            "--output",
            "-o",
        ...
        local_json: bool = typer.Option(
            ...
            help="Materialize the local-dev artifacts so the StaffML frontend "
                 ...
                 "staffml/app/src/data/corpus.json AND mirrors it to "
                 "staffml/app/public/data/corpus.json (the path the "
        ...
        if local_json:
            local_out = Path("staffml/app/src/data/corpus.json")
            ...
            public_out = Path("staffml/app/public/data/corpus.json")
            ...
            visuals_out = Path("staffml/app/public")
            ...
            summary_out = Path("staffml/app/src/data/corpus-summary.json")
        ...
        manifest_out = Path("staffml/app/src/data/vault-manifest.json")
