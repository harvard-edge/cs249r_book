...
``staffml/vault/schema/enums.py``. See also the LinkML schema at
``staffml/vault/schema/question_schema.yaml``.
...
_REPO_ROOT_CANDIDATES = [
    _HERE.parents[3] / "vault" / "schema",                # staffml/vault/schema/
    _HERE.parents[4] / "staffml" / "vault" / "schema", # worktree root
]
