...
Usage:
    python3 staffml/vault-cli/scripts/suggest_exemplars.py \
        --vault-dir staffml/vault \
        --top 3 \
        [--emit-script]
"""
...
def main() -> None:
    ...
    parser.add_argument("--vault-dir", type=Path, default=Path("staffml/vault"))
    ...
    print(
        ...
        "\n  2. Run: vault mark-exemplar <id> --vault-dir staffml/vault"
        "\n  3. Run: vault build --local-json --vault-dir staffml/vault"
    )
