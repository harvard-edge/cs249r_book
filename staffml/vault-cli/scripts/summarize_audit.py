...
Output is markdown intended to live at:
    ...
    staffml/vault-cli/docs/AUDIT_FINDINGS_<YYYY-MM-DD>.md

Usage:

    python3 staffml/vault-cli/scripts/summarize_audit.py \\
        --input staffml/vault/_pipeline/runs/full-corpus-20260503/01_audit.json \\
        --output staffml/vault-cli/docs/AUDIT_FINDINGS_2026-05-03.md
"""
...
def main() -> int:
    ...
    if args.output:
        ...
        outpath = (REPO_ROOT / "staffml" / "vault-cli" / "docs"
