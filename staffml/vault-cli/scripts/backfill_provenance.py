...
Usage:
    ...
    python3 staffml/vault-cli/scripts/backfill_provenance.py --dry-run

    # Apply:
    python3 staffml/vault-cli/scripts/backfill_provenance.py

    # Apply but cap to N files (smoke testing):
    python3 staffml/vault-cli/scripts/backfill_provenance.py --limit 5
"""
