...
Usage:
    ...
    python3 staffml/vault-cli/scripts/merge_audit_runs.py \\
        --inputs staffml/vault/_pipeline/runs/full-corpus-20260503 \\
                 staffml/vault/_pipeline/runs/full-corpus-20260503-mobile \\
                 staffml/vault/_pipeline/runs/full-corpus-20260503-tinyml \\
        --output staffml/vault/_pipeline/runs/full-corpus-20260503-merged
"""
