...
Usage:
    ...
    python3 staffml/vault-cli/scripts/apply_format_skip_level.py \\
        --audit staffml/vault/_pipeline/runs/full-corpus-20260503-merged/01_audit.json
