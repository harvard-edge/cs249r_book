 ...
 *
 * Aligned with staffml/vault/schema/question_schema.yaml (LinkML, the
 * authoritative schema) and staffml/vault/schema/enums.py.
 *
 * Both the worker (staffml/vault-worker/) and the site
 * (staffml/app/) import from this package via pnpm workspace
...
export interface Visual {
  kind: VisualKind;
  /** Bare filename under staffml/vault/visuals/<track>/. */
  path: string;
