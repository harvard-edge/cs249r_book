...
from source on every release (see [`packages/mlsysim/tutorial/slides/`]({{< var github_repo >}}/tree/dev/packages/mlsysim/tutorial/slides))
...
The decks live in the `packages/mlsysim/tutorial/slides/` directory of the [MLSysBook
repository]({{< var github_repo >}}). To rebuild locally:

```bash
cd packages/mlsysim/tutorial
make
```
