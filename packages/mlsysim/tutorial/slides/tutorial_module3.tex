...
\begin{frame}[fragile]{Cross-Domain Carbon Accounting}
\small
...
\begin{enumerate}
  ...
  \item \textbf{Composition:} Output from performance solvers (latency) pipes directly into sustainability and economics solvers.
