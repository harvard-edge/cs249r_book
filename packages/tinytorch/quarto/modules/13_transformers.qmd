...
<a href="https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?labpath=packages%2Ftinytorch%2Fmodules%2F13_transformers%2Ftransformers.ipynb" class="action-btn btn-orange">Open in Binder →</a>
</div>
<div class="action-card">
...
<a href="../assets/slides/13_transformers.pdf" download><i class="fa-solid fa-download"></i> Download</a>
<a href="#" onclick="slideFullscreen('13_transformers'); return false;" class="secondary"><i class="fa-solid fa-expand"></i> Fullscreen</a>
</div>
</div>
...
@fig-gpt-architecture shows the full GPT stack you will assemble, from token IDs at the bottom to logits at the top.
...
: **Listing 13.3 — Position-wise MLP**. Expands to 4x hidden width, applies GELU, and projects back. Holds most of the block's parameters. {#lst-13-mlp}
...
- **[Launch Binder](https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?urlpath=lab/tree/packages/tinytorch/modules/13_transformers/transformers.ipynb)** - Run interactively in browser, no setup required
