...
<a href="https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?labpath=packages%2Ftinytorch%2Fmodules%2F06_autograd%2Fautograd.ipynb" class="action-btn btn-orange">Open in Binder →</a>
</div>
<div class="action-card">
...
@tbl-06-autograd-function-classes lists the backward `Function` classes and the gradient rule each one applies.
...
: **Backward Function classes and their gradient rules.** {#tbl-06-autograd-function-classes}
...
@tbl-06-autograd-global-helpers lists the global helpers that toggle gradient tracking.

| Function | Signature | Description |
|----------|-----------|-------------|
| `enable_autograd` | `enable_autograd(quiet=False) -> None` | Activate gradient tracking globally |

: **Global helper functions for enabling autograd.** {#tbl-06-autograd-global-helpers}
...
- **[Launch Binder](https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?urlpath=lab/tree/packages/tinytorch/modules/06_autograd/autograd.ipynb)** - Run interactively in browser, no setup required
