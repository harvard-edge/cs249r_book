...
<a href="https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?labpath=packages%2Ftinytorch%2Fmodules%2F03_layers%2Flayers.ipynb" class="action-btn btn-orange">Open in Binder →</a>
</div>
<div class="action-card">
...
<a href="../assets/slides/03_layers.pdf" download><i class="fa-solid fa-download"></i> Download</a>
<a href="#" onclick="slideFullscreen('03_layers'); return false;" class="secondary"><i class="fa-solid fa-expand"></i> Fullscreen</a>
</div>
</div>
...
@tbl-03-layers-implementation-roadmap lays out the implementation in order, one part at a time.
...
- **[Launch Binder](https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?urlpath=lab/tree/packages/tinytorch/modules/03_layers/layers.ipynb)** - Run interactively in browser, no setup required
