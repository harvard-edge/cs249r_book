...
<a href="https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?labpath=packages%2Ftinytorch%2Fmodules%2F07_optimizers%2Foptimizers.ipynb" class="action-btn btn-orange">Open in Binder →</a>
</div>
<div class="action-card">
...
<a href="../assets/slides/07_optimizers.pdf" download><i class="fa-solid fa-download"></i> Download</a>
<a href="#" onclick="slideFullscreen('07_optimizers'); return false;" class="secondary"><i class="fa-solid fa-expand"></i> Fullscreen</a>
</div>
</div>
...
- **[Launch Binder](https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?urlpath=lab/tree/packages/tinytorch/modules/07_optimizers/optimizers.ipynb)** - Run interactively in browser, no setup required
