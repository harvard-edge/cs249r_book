...
<a href="https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?labpath=packages%2Ftinytorch%2Fmodules%2F15_quantization%2Fquantization.ipynb" class="action-btn btn-orange">Open in Binder →</a>
</div>
<div class="action-card">
...
<a href="../assets/slides/15_quantization.pdf" download><i class="fa-solid fa-download"></i> Download</a>
<a href="#" onclick="slideFullscreen('15_quantization'); return false;" class="secondary"><i class="fa-solid fa-expand"></i> Fullscreen</a>
</div>
</div>
...
::: {#fig-15_quantization-diag-1 fig-env="figure" fig-pos="htb" fig-cap="**TinyTorch Quantization System**: Methods for converting models to lower precision." fig-alt="Pipeline diagram: FP32 weights feed into a quantizer block producing INT8 weights with scale and zero-point. A parallel calibration path runs sample activations through an observer to produce input scale and zero-point. Both feed the QuantizedLinear layer."}
...
: **Core methods on the Quantizer convenience class.** {#tbl-15-quantization-quantizer-api}
...
:::{.callout-note title="Systems Implication: Escaping the Memory Wall via Reduced Precision"}
...
- **[Launch Binder](https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?urlpath=lab/tree/packages/tinytorch/modules/15_quantization/quantization.ipynb)** - Run interactively in browser, no setup required
