...
<a href="https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?labpath=packages%2Ftinytorch%2Fmodules%2F19_benchmarking%2Fbenchmarking.ipynb" class="action-btn btn-orange">Open in Binder →</a>
</div>
<div class="action-card">
...
<a href="../assets/slides/19_benchmarking.pdf" download><i class="fa-solid fa-download"></i> Download</a>
<a href="#" onclick="slideFullscreen('19_benchmarking'); return false;" class="secondary"><i class="fa-solid fa-expand"></i> Fullscreen</a>
</div>
</div>
...
::: {#fig-19_benchmarking-diag-1 fig-env="figure" fig-pos="htb" fig-cap="**TinyTorch Benchmarking System**: Statistical measurement of performance and accuracy." fig-alt="Block diagram of the TinyTorch benchmarking system: models and datasets feed a Benchmark harness that runs warmup iterations, collects latency, accuracy, and memory measurements, and produces BenchmarkResult objects with mean, standard deviation, and 95% confidence intervals for a BenchmarkSuite comparison engine."}
...
: **Serialization methods on the BenchmarkResult dataclass.** {#tbl-19-benchmarking-result-methods}
...
@tbl-19-benchmarking-core-methods lists the methods in this group.
...
: **Core measurement methods on the Benchmark class.** {#tbl-19-benchmarking-core-methods}
...
@tbl-19-benchmarking-suite-methods lists the methods on the benchmark suite.
...
- **[Launch Binder](https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?urlpath=lab/tree/packages/tinytorch/modules/19_benchmarking/benchmarking.ipynb)** - Run interactively in browser, no setup required
