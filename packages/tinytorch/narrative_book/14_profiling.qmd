...
| Operation Sub-Layer | FLOP Count Formula | Total FLOPs | DRAM Traffic Formula | Total Memory Traffic | Arithmetic Intensity $I$ | Hardware Regime ($I_{\text{ridge}}=156$) |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **LayerNorm 1** | $4 \cdot S \cdot D$ | $2,048$ | $2 \cdot S \cdot D \cdot 4\text{B}$ | $4,096\text{ B}$ | **$0.50\text{ FLOPs/B}$** | **Memory-Bound (99.7% stalled)** |
| **QKV Projection** | $2 \cdot S \cdot D \cdot 3D$ | $393,216$ | $3 D^2 \cdot 4\text{B} + \dots$ | $196,608\text{ B}$ | **$2.00\text{ FLOPs/B}$** | **Memory-Bound (98.7% stalled)** |
| **Attention $QK^T$** | $2 \cdot S^2 \cdot D$ | $4,096$ | $2 S D \cdot 4\text{B} + S^2 \cdot 4\text{B}$| $4,160\text{ B}$ | **$0.98\text{ FLOPs/B}$** | **Memory-Bound (99.4% stalled)** |
| **Softmax Reduction**| $3 \cdot S^2$ | $48$ | $2 S^2 \cdot 4\text{B}$ | $128\text{ B}$ | **$0.38\text{ FLOPs/B}$** | **Memory-Bound (99.8% stalled)** |
| **MLP Expand ($1\times \to 4\times$)**| $2 \cdot S \cdot D \cdot 4D$ | $524,288$ | $4 D^2 \cdot 4\text{B} + \dots$ | $262,144\text{ B}$ | **$2.00\text{ FLOPs/B}$** | **Memory-Bound (98.7% stalled)** |
| **GELU Activation** | $10 \cdot S \cdot 4D$ | $5,120$ | $2 \cdot S \cdot 4D \cdot 4\text{B}$ | $4,096\text{ B}$ | **$1.25\text{ FLOPs/B}$** | **Memory-Bound (99.2% stalled)** |
| **Total Block** | Cumulative | **$928,816$** | Cumulative | **$471,232\text{ B}$** | **$1.97\text{ FLOPs/B}$** | **Severely Memory-Bound!** |
