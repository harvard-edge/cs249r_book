...
| Parameter | Raw Gradient Vector $\mathbf{g}_i$ | Squared Sum $\sum g_{ij}^2$ | Global Norm $\|\mathbf{g}\|_{\text{global}}$ | Clipping Ratio $\frac{\gamma_{\max}}{\|\mathbf{g}\|}$ | Rescaled Gradient $\mathbf{g}_{\text{clipped}}$ |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
| **Total Model** | Norm Clamped | $\|\mathbf{g}_{\text{raw}}\| = 5.00$ | $\gamma_{\max} = 2.50$ | Scale factor: $0.50$ | $\|\mathbf{g}_{\text{clipped}}\| = \sqrt{1.5^2 + 2.0^2} = \mathbf{2.50}$ |
