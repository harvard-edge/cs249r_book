...
```python
# packages/tinytorch/src/tinytorch/generation.py
import numpy as np
...
| :--- | :--- | :--- |
| **DRAM Memory Fragmentation** | **PagedAttention (vLLM)** | Manages KV cache memory in virtual memory pages like an OS. |
