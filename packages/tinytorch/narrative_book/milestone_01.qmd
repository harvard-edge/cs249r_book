...
| Input Coordinate $(x_1, x_2)$ | Target Label $y$ | Hidden Pre-Activation $\mathbf{z}_1$ | Hidden Post-ReLU $\mathbf{h}$ | Output Logit $\hat{y}$ | Prediction Rounded | Memory Reality |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
