...
-   [MLPerf Inference](https://github.com/mlcommons/inference): An industry-standard set of benchmarks for measuring the performance of machine learning software and hardware. MLPerf has a dedicated benchmark for TinyML, called MLPerf Tiny, which focuses on microcontrollers and other resource-constrained devices.
...
-   [AI-Benchmark](https://ai-benchmark.com/): A benchmarking tool designed for Android devices, it valuates the performance of AI tasks on mobile devices, encompassing various real-world scenarios like image recognition, face parsing, and optical character recognition.
...
[Google Speech Commands](https://www.tensorflow.org/datasets/catalog/speech_commands) was selected as the best dataset to represent the task. The dataset is well established in the research community and has permissive licensing which allows it to be easily used in a benchmark.
