...
::: callout-tip
### Let's try out a Keyword Spotting exercise with TensorFlow Lite Micro!
...
::: callout-tip
### Let's try out a Web Scraping exercise!
...
::: callout-tip
### Let's try out an exercise on Synthetic Data!
...
![A breakdown of tasks that data scientists allocate their time to, highlighting the significant portion spent on data cleaning and organizing.](images/png/data_engineering_features.png){#fig-data-engineering}
...
::: callout-tip
### Let's try out an exercise on Data Processing !
...
![Data card describing a CV dataset. Source: (@Pushkarna_Zaldivar_Kjartansson_2022)](images/png/data_card.png){#fig-data-card}
...
Now would be an excellent time to try some data engineering techniques!

::: callout-tip
### Data Engineering Basic Models

-   **Data Sourcing -- Web Scraping**
    -   NBA Players [![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Andy-Pham-72/Web-Scraping-with-BeautifulSoup-and-Pandas/blob/master/Web_scraping_with_beautiful_soup_and_pandas_complete.ipynb)
-   **KeyWord Spotting with TensorFlow Lite Micro**
    -   Voice Commands [![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/17I7GL8WTieGzXYKRtQM2FrFi3eLQIrOM)
-   **Data Processing**
    - Multilingual Spoken Words Corpus [![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/harvard-edge/multilingual_kws/blob/main/multilingual_kws_intro_tutorial.ipynb#scrollTo=ApnPyIlYNFYD)
-   **Synthetic Data - Generative Adversarial Networks**
    - Healthcare domain [![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1nwbvkg32sOUC69zATCfXOygFUBeo0dsx?usp=sharing#scrollTo=TkwYknr44eFn)
:::