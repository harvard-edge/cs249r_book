...
![Various fairness metrics and accuracy may result in different optimal classifiers.](images/png/fairness_cartoon.png){#fig-fairness-example}
...
![Diffusion models may memorize samples from their training data. Source: [@carlini2023extracting].](images/png/diffusion_memorization.png){#fig-diffusion-model-example}
...
![Example of a small perturbation changing a model prediction.](images/png/adversarial_robustness.png){#fig-adversarial-example}
...
![How various groups impact human-centered AI.](images/png/human_centered_ai.png){#fig-human-centered-ai}
