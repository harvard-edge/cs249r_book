...
![The performance of the language model improves smoothly with model size, dataset size and the amount of compute used for training [@scaling_laws_NLM].](images/model_scaling.png){#fig-scaling-laws}
...
![At both the data centers and the edge, demand for training and inference hardware is growing.](images/mckinsey_analysis.png ""){#fig-mckinsey}
...
![Infrastructure and the servers consume the most energy in a datacenter.](images/energy_datacenter.png){#fig-energydemand}
...
![The carbon footprint of large-scale ML tasks. It includes various models running at Meta. The emissions are categorized by offline training, online training, and inference [@wu2022sustainable].](images/model_carbonfootprint.png){#fig-model_carbonfootprint}
...
![Carbon footprint of NLP model in lbs of $\textrm{CO}_2$ equivalent. Source: [@dayarathna2015data]](images/carbon_benchmarks.png){#fig-carboncars}
...
![Energy is supplied by various sources which vary throughout the day. Renewable energy production shows high variability with time. Source: [Energy Charts](https://www.energy-charts.info/?l=en&c=DE).](images/europe_energy_grid.png){#fig-energyprod}
...
![A chart depicting the stages of the AI lifecycle, broken into 3 parts including Design, Develop, and Deploy.](images/ai_lifecycle.jpeg){#fig-lifecycle}
...
![Microsoft Azure now provides [dashboards](https://techcommunity.microsoft.com/t5/green-tech-blog/charting-the-path-towards-sustainable-ai-with-azure-machine/ba-p/2866923) to describe energy consumption for a job that is run](images/azure_dashboard.png){#fig-azuredashboard}
...
![Number of Internet of Things (IoT) connected devices worldwide from 2019 to 2023, with forecasts from 2022 to 2030 from [Statista](https://www.statista.com/statistics/1183457/iot-connected-devices-worldwide/).](images/statista_chip_growth.png){#fig-iot-devices}
