...
This book, inspired by the [TinyML edX course](https://www.edx.org/certificates/professional-certificate/harvardx-tiny-machine-learning) and CS294r at Harvard University, is the result of years of hard work and collaboration with many students, researchers and practitioners. We are deeply indebted to the folks whose groundbreaking work laid its foundation.
...
## Funding Agencies and Companies {#sec-acknowledgements-funding-agencies-companies-2469}

### Academic Support {#sec-acknowledgements-academic-support-dfb1}
...
### Non-Profit and Institutional Support {#sec-acknowledgements-non-profit-institutional-support-613b}
...
### Corporate Support {#sec-acknowledgements-corporate-support-2cd3}
...
![](images/jpg/seeedstudio.jpg)

:::

## Contributors {#sec-acknowledgements-contributors-0900}
...
A comprehensive list of all GitHub contributors, automatically updated with each new contribution, is available below. For those interested in contributing further, please consult our [GitHub](https://github.com/harvard-edge/cs249r_book) page for more information.
