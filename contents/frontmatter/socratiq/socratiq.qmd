...
## AI Learning Companion {#sec-ai-learning-companion-f927}
...
## Quick Start Guide {#sec-quick-start-guide-856a}
...
## Button Overview {#sec-button-overview-2a46}

The top nav bar provides quick access to the following features:

1. Adjust your [settings](#sec-socratiq-personalize-your-learning-e1d9) at any time.
2. Track your [progress](#sec-socratiq-tracking-your-progress-b2c0) by viewing the dashboard.
...
## Personalize Your Learning {#sec-socratiq-personalize-your-learning-e1d9}
...
## Learning with SocratiQ {#sec-socratiq-learning-with-socratiq-9046-with-socratiq-9046}

### Quizzes {#sec-quizzes-5ac1}
...
### Example Learning Flow {#sec-example-learning-flow-50d6}
...
### Getting Help with Concepts {#sec-getting-help-with-concepts-48bc}
...
## Tracking Your Progress {#sec-socratiq-tracking-your-progress-b2c0}

### Performance Dashboard {#sec-performance-dashboard-4982}
...
### ![🏅](images/png/medal.png){width=20px} Achievement Badges {width=20px} {#sec-images-png-medal-png-width-20px-achievement-badges-e96f}
...
## Data Storage {#sec-data-storage-39e6}
...
## Technical Requirements {#sec-technical-requirements-5921}
...
## Common Issues and Troubleshooting {#sec-common-issues-and-troubleshooting-ce65}
...
## Providing Feedback {#sec-providing-feedback-a904}
