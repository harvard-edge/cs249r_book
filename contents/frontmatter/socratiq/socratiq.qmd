...
::: {.content-visible when-format="pdf"}
![**AI-Personalized Learning Preferences**: The image displays a user interface for configuring SocratiQ, an AI-based learning tool, to personalize interactions according to the learner's academic level and background knowledge. The settings panel on the right side of the screen allows learners to adjust preferences in relation to quiz questions and explanations. This customization ensures that relevant information is provided according to the learner's proficiency level, ultimately enhancing understanding of ML systems concepts. By adapting to individual needs, AI educational tools optimize the learning experience for university-level computer science students.](images/png/settings.png){#fig-settings-panel width=45%}
:::
...
::: {.content-visible when-format="html"}
![**AI-Assisted Learning Tool: SocratiQ**: SocratiQ is a powerful AI tool designed to assist university-level computer science students in deepening their understanding of challenging Machine Learning (ML) concepts. By selecting any portion of the textbook and asking for a detailed explanation, students can access personalized, interactive assistance tailored to their learning objectives. This innovative tool enhances critical thinking skills by providing suggestions for related content from the textbook and guides users through complex ML topics with ease.](images/gif/reference.gif){#fig-reference-sections}
:::
