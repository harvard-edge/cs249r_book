...
The lineage of embedded systems traces back to the 1960s, with the Apollo Guidance Computer (AGC) as a pioneering example. Developed for the Apollo spacecraft's navigational system, the AGC utilized integrated circuits, a significant advancement in electronics at the time. However, the introduction of the first commercially available microprocessor, the Intel 4004, in 1971 (@fig-Intel4004) marked a groundbreaking milestone for embedded systems. 

While not directly related to the AGC's technology, the Intel 4004 paved the way for developing increasingly sophisticated and compact embedded systems. Over the subsequent years, microprocessor-based embedded systems have expanded remarkably, finding utility in diverse sectors such as automotive electronics, consumer devices, telecommunications, and healthcare. The advent of the microprocessor enabled embedded systems to become more powerful, flexible, and cost-effective, leading to their widespread adoption across industries.
