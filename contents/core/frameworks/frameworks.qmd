...
\end{tikzpicture}
```
Depiction of "3D parallelism," where models can be parallized over dimensions of devices corresponding to data replicas, sequential pipeline stages, and sharded model stages.
:::
