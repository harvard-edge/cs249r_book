...
::: {#lst-auto_diff_intro .callout-important title="**Automatic Differentiation**: Enables efficient computation of gradients for complex functions, crucial for optimizing neural network parameters. *Source: IEEE Spectrum*"}
```{.python}
def f(x):
    a = x * x      # Square
    b = sin(x)     # Sine
...
#| lst-cap: "**Automatic Differentiation**: Enables efficient computation of gradients for complex functions, crucial for optimizing neural network parameters. *Source: IEEE Spectrum*"
#| eval: false
...
::: {.content-visible when-format="html"}
::: {#lst-forward_structure .callout-important title="**Forward Mode AD Structure**: Each operation tracks values and derivatives simultaneously, highlighting how computations are structured in forward mode automatic differentiation. *Source: IEEE Spectrum*"}
```{.python}
def f(x):
    a = x * x
    b = sin(x)
...
#| lst-cap: "**Forward Mode AD Structure**: Each operation tracks values and derivatives simultaneously, highlighting how computations are structured in forward mode automatic differentiation. *Source: IEEE Spectrum*"
#| eval: false
...
#| lst-cap: "**Forward Pass**: Computes intermediate states using linear and non-linear transformations to produce the final output. **Training Pipeline**: Partitions datasets into distinct sets for training, validation, and testing to ensure model robustness and unbiased evaluation."
#| eval: false
...
::: {.content-visible when-format="html"}
::: {#lst-reverse_nn_backward .callout-important title="**Backward Pass**: This code calculates gradients for weights in a neural network, highlighting how changes propagate backward through layers to update parameters. Note: The original "Illustrates" has been replaced with more direct and active language, focusing on the learning outcome."}
```{.python}
...
#| lst-cap: "**Backward Pass**: This code calculates gradients for weights in a neural network, highlighting how changes propagate backward through layers to update parameters. Note: The original "Illustrates" has been replaced with more direct and active language, focusing on the learning outcome."
#| eval: false
...
::: {.content-visible when-format="html"}
::: {#lst-deep_forward .callout-important title="**Forward Pass**: Neural networks process input through sequential layers of transformations to produce an output, highlighting the hierarchical nature of deep learning architectures. *Source: IEEE Spectrum*"}
```{.python}
...
#| lst-cap: "**Forward Pass**: Neural networks process input through sequential layers of transformations to produce an output, highlighting the hierarchical nature of deep learning architectures. *Source: IEEE Spectrum*"
#| eval: false
def deep_network(input_tensor):
    # A typical deep network computation
    layer1 = large_dense_layer(input_tensor)
...
::: {.content-visible when-format="html"}
::: {#lst-higher_order .callout-important title="**Higher-Order Gradients**: Second-order gradients reveal how changes in model parameters affect first-order gradients, essential for advanced optimization techniques. *Source: IEEE Spectrum*'s autograd"}
```{.python}
...
#| lst-cap: "**Higher-Order Gradients**: Second-order gradients reveal how changes in model parameters affect first-order gradients, essential for advanced optimization techniques. *Source: IEEE Spectrum*"
#| eval: false
# Computing higher-order gradients
with torch.set_grad_enabled(True):
  # First-order gradient computation
