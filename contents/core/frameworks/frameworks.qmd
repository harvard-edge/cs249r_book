...
::: {#fig-mlfm-timeline}
```{.tikz}
\begin{tikzpicture}[font=\small\sf,node distance=1mm,outer sep=0pt]
...
\tikzset{
  Box/.style={inner xsep=2pt,
    ...
    minimum width=13mm, minimum height=10mm
  },
}
\tikzset{
  BoxR/.style={inner xsep=2pt,
    anchor=west,
...
\definecolor{col1}{RGB}{180, 156, 222}
\definecolor{col2}{RGB}{230, 230, 255}
\definecolor{col3}{RGB}{255, 0, 0}
\definecolor{col4}{RGB}{255, 192, 203}
\definecolor{col5}{RGB}{224, 224, 224}
\definecolor{col6}{RGB}{255, 255, 224}
\definecolor{col7}{RGB}{183, 183, 82}

\node[Box,fill={col2},draw=col1](B1){Start};
\node[BoxR,fill={col4!},draw=col3,right=of B1](B2){Operation 1};
\node[BoxV,fill={col2},draw=col1,right=of B2](B3){Operation 1\\ Executed};

\node[BoxR,fill={col4!},draw=col3,right=of B3](B4){Operation 2};
\node[BoxV,fill={col2},draw=col1,right=of B4](B5){Operation 2\\ Executed};
\node[Box,fill={col2},draw=col1,right=of B5](B6){End};

\draw[thick,-latex](B1)--(B2);
\draw[thick,-latex](B2)--(B3);
\draw[thick,-latex](B3)--(B4);
\draw[thick,-latex](B4)--(B5);
\draw[thick,-latex](B5)--(B6);
\def\vi{15mm}
\draw[thick]($(B1.east)!0.5!(B2.west)$)--++(90:\vi)
node[align=center,fill=black!15,font=\footnotesize\sf]{Define\\ Operation};
\draw[thick]($(B2.east)!0.5!(B3.west)$)--++(90:\vi)
node[align=center,fill=black!15,font=\footnotesize\sf]{Execute\\ Operation};
\draw[thick]($(B3.east)!0.5!(B4.west)$)--++(90:\vi)
node[align=center,fill=black!15,font=\footnotesize\sf]{Define Next\\ Operation};
\draw[thick]($(B4.east)!0.5!(B5.west)$)--++(90:\vi)
node[align=center,fill=black!15,font=\footnotesize\sf]{Execute\\ Operation};
\draw[thick]($(B5.east)!0.5!(B6.west)$)--++(90:\vi)
node[align=center,fill=black!15,font=\footnotesize\sf](BB6){Repeat\\ Until Done};
\scoped[on background layer]
\node[inner xsep=3mm,inner ysep=11mm,fill=yellow!10,
yshift=3mm,
draw=col7, thick, fit=(B1) (BB6)(B6)] (BB) {};
\node[below=2mm of BB.north]{Runtime Execution};
\end{tikzpicture}
```
...
![Visualization of a tensor data structure.](images/png/tensors.png){#fig-tensor-data-structure-a width="90%"}
