...
This hierarchy allows each tier to handle tasks appropriate to its ca&shy;pa&shy;bil&shy;ities---Tiny ML devices handle immediate, simple decisions; edge devices manage local coordination; and cloud systems tackle complex analytics and learning tasks. Smart city installations often use this pattern, with street-level sensors feeding data to neighborhood-level edge processors, which in turn connect to city-wide cloud analytics.
...
\node[draw=col5,inner xsep=4mm,inner ysep=6mm,
anchor= west,yshift=1mm,fill=col2!20,fit=(G1)(B2),line width=0.75pt](BB2){};
\node[below=3pt of  BB2.north,anchor=north]{TinyML};
%
\scoped[on background layer]
\node[draw=col5,inner xsep=4mm,inner ysep=6mm,
anchor= west,yshift=1mm,fill=col2!20,fit=(G2)(1DB2),line width=0.75pt](BB2){};
\node[below=3pt of  BB2.north,anchor=north]{Cloud ML};
%
\draw[-latex](G1.west)--++(180:0.9)|-node[Text,pos=0.1]{Data}(B2);
\draw[-latex](G2)--++(270:0.9)-|node[Text,pos=0.66]{Deploy}(B1);
\draw[-latex](G2)--++(270:0.9)-|node[Text,pos=0.66]{Deploy}(B2);
\draw[-latex](G2)--++(270:0.9)-|node[Text,pos=0.66]{Deploy}(B3);
%
\draw[-latex](B1)--node[Text,pos=0.5]{Results}(1DB1);
\draw[-latex](B2)|-node[Text,pos=0.75]{Results}(1DB1.10);
%
\draw[-latex](B1.330)--++(270:0.9)-|node[Text,pos=0.2]{Assist}(B3.220);
\draw[-latex](B2.east)--node[Text,pos=0.5]{Sync}++(0:4.8)|-(1DB3.170);
%
\draw[-latex](1DB1.350)--node[Text,pos=0.75]{Results}(1DB2.190);
\draw[-latex](1DB3.190)--node[Text,pos=0.50]{Data}(1DB2.350);
\draw[-latex](B3.290)--node[Text,pos=0.5]{Results}(1DB3.70);
%
\scoped[on background layer]
\node[draw=col5,inner xsep=4mm,inner ysep=6mm,
anchor= west,yshift=-1mm,fill=col2!20,fit=(B1)(1DB1),line width=0.75pt](BB2){};
\node[above=3pt of  BB2.south,anchor=south]{Cloud ML};
%
\scoped[on background layer]
\node[draw=col5,inner xsep=4mm,inner ysep=6mm,
anchor= west,yshift=-1mm,fill=col2!20,fit=(B3)(1DB3),line width=0.75pt](BB2){};
...
minimum width=165mm,
anchor=west,
yshift=2mm,fill=col2!20,fit=(B1)(B2)(B3)(B4),line width=0.75pt](BB){};
\node[below=11pt of  BB.north east,
anchor=east]{ML System Implementations};
\end{scope}
...
minimum width=165mm,
anchor= west,
yshift=-1mm,fill=col2!20,fit=(2B1)(2B2)(2B3),line width=0.75pt](BB2){};
\node[above=8pt of  BB2.south east,
anchor=east]{Core System Principles};
\end{scope}

\begin{scope}[shift={(0.4,-6.0)}, anchor=west]
\node[Box1](3B1){Optimization \& Efficiency Model -- Hardware -- Energy};
\node[Box1,right=of 3B1](3B2){Operational Aspects Deployment -- Monitoring -- Updates};
\node[Box1,right=of 3B2](3B3){Trustworthy AI Security -- Privacy -- Reliability};
%
\scoped[on background layer]
\node[draw=col5,inner xsep=5mm,inner ysep=5mm,
minimum width=165mm,
anchor= west,
yshift=-1mm,fill=col2!20,fit=(3B1)(3B2)(3B3),line width=0.75pt](BB3){};
\node[above=8pt of  BB3.south east,
anchor=east]{System Considerations};
\end{scope}
%
\draw[-latex,line width=1.5pt,black!50](B1.south)--++(270:0.75)-|(2B1);
\draw[-latex,line width=1.5pt,black!50](B2.south)--++(270:0.75)-|(2B1);
\draw[-latex,line width=1.5pt,black!50](B3.south)--++(270:0.75)-|(2B1);
\draw[-latex,line width=1.5pt,black!50](B4.south)--++(270:0.75)-|(2B1);
\draw[-latex,line width=1.5pt,black!50](B2.south)--++(270:0.75)-|(2B2);
\draw[-latex,line width=1.5pt,black!50](B3.south)--++(270:0.75)-|(2B3);
%
\draw[-latex,line width=1.5pt,black!50](2B1.south)--++(270:0.95)-|(3B1);
\draw[-latex,line width=1.5pt,black!50](2B2.south)--++(270:0.95)-|(3B1);
\draw[-latex,line width=1.5pt,black!50](2B3.south)--++(270:0.95)-|(3B1);
\draw[-latex,line width=1.5pt,black!50](2B2.south)--++(270:0.95)-|(3B2);
\draw[-latex,line width=1.5pt,black!50](2B3.south)--++(270:0.95)-|(3B3);
\end{tikzpicture}
```
...
::: {.column-margin}
<div class="offset">
![Performance characteristics.](images/png/op_char.png){#fig-perf_char width='0%' fig-pos='H'}
</div>
:::
\vspace{8ex}
...
::: {.column-margin}
<div class="offset">
![Operational characteristics.](images/png/op_char.png){#fig-op_char width='0%' fig-pos='H'}
</div>
:::

::: {layout="[45,-10,45]" fig-pos='H'}
![](images/png/perf_char.png)

![](images/png/op_char.png)
:::
:::
...
\scoped[on background layer]
\node[draw=col5,inner xsep=5mm,inner ysep=4mm,
yshift=0mm,fill=col2!20,fit=(B1)(B3)(B4),line width=0.75pt](BB){};
\node[below=11pt of  BB.north east,
anchor=east]{Layer: Privacy};
\end{scope}

\begin{scope}[shift={(0,-5.0)}]
\node[Box1](2B1){Is low latency required ($<$10 ms)?};
\node[Box,below left=of 2B1](2B2){Latency Tolerant};
\node[Box,below right=of 2B1](2B3){Tiny or Edge ML};
\draw[-latex](2B1)-|node[Text,pos=0.2]{No}(2B2);
\draw[-latex](2B1)-|node[Text,pos=0.2]{Yes}(2B3);
\scoped[on background layer]
\node[draw=col5,inner xsep=5mm,inner ysep=4mm,
yshift=0mm,fill=col2!20,fit=(2B1)(2B2)(2B3),line width=0.75pt](BB1){};
\node[below=11pt of  BB1.north east,anchor=east]{Layer: Performance};
\end{scope}
\draw[-latex](B3)--++(270:1.15)-|(2B1.110);
\draw[-latex](B4)--++(270:1.15)-|(2B1.70);

\begin{scope}[shift={(0,-8.8)}]
\node[Box1](3B1){Does the model require significant compute?};
\node[Box,below left=of 3B1](3B2){Heavy Compute};
\node[Box,below right=of 3B1](3B3){Lightweight Processing};
\draw[-latex](3B1)-|node[Text,pos=0.2]{Yes}(3B2);
\draw[-latex](3B1)-|node[Text,pos=0.2]{No}(3B3);
\scoped[on background layer]
\node[draw=col5,inner xsep=5mm,inner ysep=5mm,
yshift=1mm,fill=col2!20,fit=(3B1)(3B2)(3B3),line width=0.75pt](BB2){};
\node[below=11pt of  BB2.north east,
anchor=east]{Layer: Compute Needs};
\end{scope}
\draw[-latex](2B2)--++(270:1.15)-|(3B1.110);
\draw[-latex](2B3)--++(270:1.15)-|(3B1.70);

%4
\begin{scope}[shift={(0,-12.6)}]
\node[Box1](4B1){Are there strict cost constraints?};
\node[Box,below left=of 4B1](4B2){Flexible Budget};
\node[Box,below right=of 4B1](4B3){Low-Cost Options};
\draw[-latex](4B1)-|node[Text,pos=0.2]{No}(4B2);
\draw[-latex](4B1)-|node[Text,pos=0.2]{Yes}(4B3);
\scoped[on background layer]
\node[draw=col5,inner xsep=5mm,inner ysep=5mm,
yshift=1mm,fill=col2!20,fit=(4B1)(4B2)(4B3),line width=0.75pt](BB3){};
\node[below=11pt of  BB3.north east,
anchor=east]{Layer: Cost};
\end{scope}
\draw[-latex](3B2)--++(270:1.15)-|(4B1.110);
\draw[-latex](3B3)--++(270:1.15)-|(4B1.70);
%5
\begin{scope}[shift={(-0.3,-15.8)},anchor=north east]
\node[Box,fill=magenta!20,
rounded corners=12pt,
 text width=18mm,
minimum width=17mm](5B1){Cloud ML};
\node[Box,fill=magenta!20,
rounded corners=12pt,left=of 5B1,
 text width=18mm,
minimum width=17mm](5B2){Edge ML};
\node[Box,fill=magenta!20, rounded corners=12pt,right=of 5B1,
 text width=18mm,
minimum width=17mm](5B3){Mobile ML};
\node[Box,fill=magenta!20, rounded corners=12pt,right=of 5B3,
 text width=18mm,
minimum width=17mm](5B4){Tiny ML};
%
\scoped[on background layer]
\node[draw=magenta!20,inner xsep=5mm,inner ysep=5mm,
yshift=-1mm,fill=col2!20,fit=(5B1)(5B2)(5B4),line width=0.75pt](BB4){};
\node[above=8pt of  BB4.south east,
anchor=east]{Layer: Deployment Options};
\end{scope}
\draw[-latex](4B3)--++(270:1.1)-|(5B3);
\draw[-latex](4B3)--++(270:1.1)-|(5B4);
\draw[-latex](4B2)--++(270:1.1)-|(5B1);
\draw[-latex](3B2.west)--++(180:0.3)|-(5B2);
\end{tikzpicture}}
```
