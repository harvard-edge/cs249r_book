...
[^defn-edge-node]: An edge node is a computing that acts as a bridge between a local device and the cloud.
...
[^defn-indust-iot]: Industrial Iot refers to the ecosystem of physical devices in an industrial environment that use the internet to collect and analyze data.
