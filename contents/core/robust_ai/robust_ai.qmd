...
![Data Poisoning Attack.](./images/png/poisoning_attack_example.png){#fig-poisoning-attack-example}
...
![The curly brackets enclose the distribution shift between the environments. Here, z stands for the spurious feature, and y stands for label class.](./images/png/distribution_shift.png){#fig-distribution-shift}
...
![Concept drift refers to a change in data patterns and relationships over time.](./images/png/drift_over_time.png){#fig-drift-over-time}
