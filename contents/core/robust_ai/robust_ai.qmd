...
\node[Box,above=of B2](B1){Decommpress file size calculation};
...
%
\path[red](DS)-|coordinate(TE)($(B2.south)!0.5!(B3.south)$);
\node[text=black](DS)at(TE){b) Correlation Shift};
\end{scope}
...
\node[above=0.1 of LSRED3]{Intput};
%%
%dashed line
%up
