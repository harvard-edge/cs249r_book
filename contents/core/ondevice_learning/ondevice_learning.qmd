...
## Deployment Drivers {#sec-deployment-drivers-2680}
...
### On-Device Learning Benefits {#sec-on-device-learning-benefits-db8a}
...
### Application Domains {#sec-application-domains-12d5}
...
### Training Paradigms {#sec-training-paradigms-57b7}
...
## Design Constraints {#sec-design-constraints-5743}
...
### Model Constraints {#sec-model-constraints-6e13}
...
### Data Constraints {#sec-data-constraints-4442}
...
### Compute Constraints {#sec-compute-constraints-0b08}
...
## Model Adaptation {#sec-model-adaptation-7511}
...
### Weight Freezing {#sec-weight-freezing-cdac}
...
### Residual and Low-Rank Updates {#sec-residual-and-low-rank-updates-5965}
...
#### Adapter-Based Adaptation {#sec-adapter-based-adaptation-20ca}
...
#### Low-Rank Techniques {#sec-low-rank-techniques-056f}
...
#### Edge Personalization {#sec-edge-personalization-676e}
...
### Sparse Updates {#sec-sparse-updates-ef9a}
...
#### Sparse Update Design {#sec-sparse-update-design-a91e}
...
#### Layer Selection {#sec-layer-selection-2819}
...
#### Code Fragment: Selective Layer Updating (PyTorch) {#sec-code-fragment-selective-layer-updating-pytorch-6db2}
...
#### TinyTrain Personalization {#sec-tinytrain-personalization-0539}
...
#### Adaptation Strategy Comparison {#sec-adaptation-strategy-comparison-1587}
...
## Data Efficiency {#sec-data-efficiency-7361}
...
### Few-Shot and Streaming {#sec-few-shot-and-streaming-176d}
...
### Experience Replay {#sec-experience-replay-0856}
...
### Data Compression {#sec-data-compression-3d77}
...
### Tradeoffs Summary {#sec-tradeoffs-summary-f3dc}
...
## Federated Learning {#sec-federated-learning-f946}
...
### Federated Learning Motivation {#sec-federated-learning-motivation-8562}
...
### Learning Protocols {#sec-learning-protocols-87cc}
...
#### Local Training {#sec-local-training-ecad}
...
#### Protocols Overview {#sec-protocols-overview-4191}
...
#### Client Scheduling {#sec-client-scheduling-5b05}
...
#### Efficient Communication {#sec-efficient-communication-5595}
...
#### Federated Personalization {#sec-federated-personalization-cc76}
...
#### Federated Privacy {#sec-federated-privacy-6def}
...
## Practical System Design {#sec-practical-system-design-52c6}
...
## Challenges {#sec-challenges-7251}
...
#### Heterogeneity {#sec-heterogeneity-d73e}
...
#### Data Fragmentation {#sec-data-fragmentation-148b}
...
#### Monitoring and Validation {#sec-monitoring-and-validation-6eec}
...
#### Resource Management {#sec-resource-management-5cdd}
...
#### Deployment Risks {#sec-deployment-risks-29d3}
...
#### Challenges Summary {#sec-challenges-summary-f0ee}
...
## Conclusion {#sec-conclusion-0928}
