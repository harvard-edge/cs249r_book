...
## Self-Check Answers {#sec-ai-training-selfcheck-answers-0dc6}
...
4. **In a training pipeline, prefetching helps to maintain a consistent supply of ready data by loading data into memory before its scheduled ____ time.**
   ...
   *Answer*: The answer is "computation". Prefetching loads data into memory ahead of its computation time, ensuring that the GPU has immediate access to data, thus reducing idle time and improving efficiency.
...
4. **In ML training systems, _______ strategies conserve memory and computational resources by freezing certain model layers during training.**
   ...
   *Answer*: The answer is "layer-freezing". Layer-freezing strategies conserve resources by preventing updates to certain model layers, focusing efforts on fine-tuning the most critical parts of the model.
