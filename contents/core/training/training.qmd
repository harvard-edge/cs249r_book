...
graph LR
  ...
  -->|Processed<br> Batches| B["⚙️ Training Loop<br><small>Forward Pass, Loss Calculation, Backward Pass</small>"]
  B -->|Evaluation<br> Metrics| C["📊 Evaluation Pipeline<br><small>Validation and Metrics Computation</small>"]
  C -->|Feedback| B
```
...
\draw[thick,name path=V0](0,0)node[below]{00:00}--++(90:\hi);
%\draw[thick,name path=V01](1,0)node[below]{00:05}--++(90:\hi);
%\draw[thick,name path=V02](2,0)node[below]{00:10}--++(90:\hi);
%
\draw[thick,name path=V1](2,0)node[below]{00:05}--++(90:\hi);
%\draw[thick,name path=V11](4,0)node[below]{00:20}--++(90:\hi);
%\draw[thick,name path=V12](5,0)node[below]{00:25}--++(90:\hi);
%
\draw[thick,name path=V2](4,0)node[below]{00:10}--++(90:\hi);
\draw[thick,name path=V3](6,0)node[below]{00:15}--++(90:\hi);
\draw[thick,name path=V4](8,0)node[below]{00:20}--++(90:\hi);
\draw[thick,name path=V5](10,0)node[below]{00:25}--++(90:\hi);
\draw[thick,name path=V6](12,0)node[below]{00:30}--++(90:\hi);
\draw[thick,name path=V7](14,0)node[below]{00:35}--++(90:\hi);
\draw[thick,name path=V8](16,0)node[below]{00:40}--++(90:\hi);
\draw[thick,name path=V9](18.2,0)node[below]{01:30}--++(90:\hi);
%
\path [name intersections={of=V0 and G1,by={A1,B1}}];
\node[Box, anchor=west,
    minimum width=8mm]at($(B1)!0.5!(A1)$){Open 1}; 
 \path [name intersections={of=V0 and G4,by={A3,B3}}];
\node[Box, anchor=west,fill=orange!30, 
minimum width=170]at($(B3)!0.5!(A3)$){Epoch 1}; 
%
\path [name intersections={of=V0 and G2,by={C1,D1}}];
\node[Box, anchor=west, minimum width=34,
fill=cyan!20]at([xshift=22]$(C1)!0.5!(D1)$){Read 1}; 
%
\path [name intersections={of=V1 and G2,by={E1,F1}}];
\node[Box, anchor=west, minimum width=22.5,
fill=cyan!20]at([xshift=0]$(E1)!0.5!(F1)$)(R2){Read 2}; 
\node[Box, anchor=west, minimum width=33,
right=of R2,fill=cyan!20]{Read 3}; 
%
\path [name intersections={of=V2 and G3,by={G1,H1}}];
\node[Box, anchor=west,fill=magenta!20,
minimum width=22.5]at([xshift=0]$(G1)!0.5!(H1)$)(T1){Train 1}; 
\node[Box, anchor=west,fill=magenta!20,
right=of T1,minimum width=33](T2){Train 2}; 
\node[Box, anchor=west,fill=magenta!20,
right=of T2,minimum width=22.5](T3){Train 3}; 
%%
\path [name intersections={of=V5 and G1,by={I1,J1}}];
\node[Box, anchor=west,
    minimum width=8mm]at($(I1)!0.5!(J1)$){Open 2}; 
%
%
\path [name intersections={of=V5 and G2,by={K1,L1}}];
\node[Box, anchor=west, minimum width=34,
fill=cyan!20]at([xshift=22]$(K1)!0.5!(L1)$){Read 4}; 
%
\path [name intersections={of=V6 and G2,by={M1,N1}}];
\node[Box, anchor=west, minimum width=22.5,
fill=cyan!20]at([xshift=0]$(M1)!0.5!(N1)$)(R5){Read 5}; 
\node[Box, anchor=west, minimum width=33,
right=of R5,fill=cyan!20]{Read 6}; 
%
%
\path [name intersections={of=V6 and G3,by={O1,P1}}];
\node[Box, anchor=west,fill=magenta!20,
minimum width=22.5]at([xshift=0]$(O1)!0.5!(P1)$)(T4){Train 4}; 
\node[Box, anchor=west,fill=magenta!20,
right=of T4,minimum width=33](T5){Train 5}; 
\node[Box, anchor=west,fill=magenta!20,
right=of T5,minimum width=22.5](T6){Train 6}; 
%
 \path [name intersections={of=V5 and G4,by={R3,S3}}];
\node[Box, anchor=west,fill=orange!30, 
minimum width=170]at($(R3)!0.5!(S3)$){Epoch 2}; 
%
 \path [name intersections={of=V8 and G3,by={X1,X2}}];
  \path [name intersections={of=V9 and G3,by={Y1,Y2}}];
  
 \path[]($(X1)!0.5!(X2)$)--node[font=\tiny]{$\bullet\bullet\bullet$}($(Y1)!0.5!(Y2)$);
\end{tikzpicture}
```
...
%
\draw[-latex](B1)
|-node[Text,pos=0.2]{Compute\\ Gradients}(DB1);
\draw[-latex](B2)
|-node[Text,pos=0.2]{Compute\\ Gradients}(DB1);
\draw[-latex](B3)
|-node[Text,pos=0.2]{Compute\\ Gradients}(DB1);
...
|-node[Text,pos=0.8]{Next Mini-Batch}(DB3.east);
\end{tikzpicture}
```
...
```
TDecision flowchart for selecting parallelism strategies in distributed training.
:::
