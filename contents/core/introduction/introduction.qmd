...
::: {.callout-tip title="AI and ML: Key Definitions" title=""}
...
::: {.callout-note title="Example: STUDENT (1964)" title=""}
...
::: {.callout-note title="Example: MYCIN (1976)" title=""}
...
::: {.callout-note title="Example: Early Spam Detection Systems" title=""}
...
::: {.callout-note title="Example: Traditional Computer Vision Pipeline" title=""}
...
:::{#vid-tl .callout-important title="Convolutional Network Demo from 1989" title=""}
...
:::{.callout-tip title="Definition of Machine Learning Systems Engineering" title=""}
...
:::{.callout-tip title="Definition of a Machine Learning System" title=""}
...
```{.tikz}
\begin{tikzpicture}[font=\small\sf]
...
\tikzset{
  ...
  Text/.style={inner sep=4pt,
    ...
    fill=colorB,
    font=\fontsize{8pt}{9}\selectfont\sf,
    align=flush center,
...
\draw[-latex,line width=0.5pt](B2)--++(270:1.2)-|node[Text,pos=0.25]{Needs\\ Improvement}(B1);
\draw[-latex,line width=0.5pt](DB2)--++(270:1.1)-|node[Text,pos=0.25]{Performance\\Degrades}(DB1);
...
### FarmBeats: Edge and Embedded ML for Agriculture
...
### AlphaFold: Large-Scale Scientific ML
...
### Autonomous Vehicles: Spanning the ML Spectrum
