...
→ Ch \ref{sec-introduction-ai-evolution-0dd8}: coming soon.
:::
...
\end{tikzpicture}
```
Milestones in AI from 1950 to 2020. Source: IEEE Spectrum
:::
...
\end{tikzpicture}
```
Deep neural network architecture for Alexnet. Source: @krizhevsky2012imagenet
:::
...
\end{tikzpicture}}
```
Machine learning systems involve algorithms, data, and computation, all intertwined together.
:::
...
::: {.content-visible when-format="html"}
![Examples of protein targets within the free modeling category. Source: Google DeepMind](images/gif/alphafold.gif){#fig-alphafold-overview}
:::
