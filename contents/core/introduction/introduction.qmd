...
@tbl-ai-evolution-strengths encapsulates the evolutionary journey of AI approaches we've discussed so far, highlighting the key strengths and capabilities that emerged with each new paradigm. As we move from left to right across the table, we can observe several important trends:
...
![Milestones in AI from 1950 to 2020. Source: IEEE Spectrum](images/png/triangle.png){#fig-ai-triangle}
...
FarmBeats, a project developed by Microsoft Research, shown in @fig-farmbeats represents a significant advancement in the application of machine learning to agriculture. This system aims to increase farm productivity and reduce costs by leveraging AI and IoT technologies. FarmBeats exemplifies how edge and embedded ML systems can be deployed in challenging, real-world environments to solve practical problems. By bringing ML capabilities directly to the farm, FarmBeats demonstrates the potential of distributed AI systems in transforming traditional industries.

![Microsoft Farmbeats: AI, Edge & IoT for Agriculture.](./images/png/farmbeats.png){#fig-farmbeats}
...
As shown in Figure @fig-pillars, the five pillars are:

1. Fundamentals: Covering the basic concepts of ML systems and deep learning.
2. Workflow: Focusing on data engineering and AI frameworks.
3. Training: Exploring AI training methodologies, efficiency, optimizations, and acceleration.
4. Deployment: Addressing benchmarking, on-device learning, and ML operations.
5. Ethics & Governance: Examining crucial aspects like security, privacy, responsible AI, and the societal impact of AI.
...
For more detailed information about the book's overview, contents, learning outcomes, target audience, prerequisites, and navigation guide, please refer to the [About the Book](../../about.qmd) section. There, you'll also find valuable details about our learning community and how to maximize your learning experience with this resource.