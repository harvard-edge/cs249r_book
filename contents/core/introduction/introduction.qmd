...
This represents a profound shift in how we approach engineering. The steam engine amplified human physical power through mechanical systems we could see and understand. Computers amplified our calculation abilities through programs we explicitly wrote. Now, we must learn to engineer systems that can acquire capabilities through learning—systems that can, in some cases, exceed human performance in their specialized domains. This isn't just a new technology to master; it's a fundamentally new way of building technology itself.

The stakes could not be higher. As with previous technological revolutions, success depends not just on understanding the theoretical possibilities, but on our ability to build reliable, scalable, and safe systems. The engineers of the Industrial Revolution had to ensure steam engines wouldn't explode; the pioneers of the Digital Revolution had to make computers trustworthy enough to run critical infrastructure. Today, we face the challenge of engineering systems that can learn and adapt while remaining reliable and aligned with human interests.

This textbook examines how we can meet this engineering challenge. By understanding how to build robust and effective AI systems, we can help shape this transformative technology to benefit humanity while responsibly navigating its unique challenges. The journey begins with understanding the fundamental principles that make these learning systems possible. This begins with exploring the relationship between AI and Machine Learning (ML), the driving forces behind modern intelligent systems.
...
![Milestones in AI from 1950 to 2020. Source: IEEE Spectrum](https://spectrum.ieee.org/media-library/a-chart-of-milestones-in-ai-from-1950-to-2020.png?id=27547255){#fig-ai-timeline}
...
## The Rise of ML Systems Engineering
...
Today, we're witnessing a similar transition in the field of AI. While Computer Science continues to push the boundaries of ML algorithms and Electrical Engineering advances specialized AI hardware, neither discipline fully addresses the engineering principles needed to deploy, optimize, and sustain ML systems at scale. 

This gap highlights the need for a new discipline: Machine Learning Systems Engineering. There is no explicit definition of what this field is as such today, but it can be broadly defined as such:
...
![Machine learning systems involve algorithms, data, and computation, all intertwined together.](images/png/triangle.png){#fig-ai-triangle}
...
Understanding the lifecycle of ML systems reveals the intricate interplay of algorithms, data, and infrastructure. However, ML systems do not exist in a single, uniform form. From cloud-based systems serving millions of users to embedded systems in IoT devices, the spectrum of ML systems showcases the diversity and complexity of their applications.
