...
3. **The introduction of ________ in the 1990s marked a shift from rule-based AI to learning from data, enabling more robust and adaptable systems.**
   ...
   *Answer*: The answer is "statistical learning". This shift allowed AI systems to learn patterns from data, overcoming the limitations of rule-based approaches and enhancing adaptability.
...
5. **Order the following AI paradigms chronologically: Statistical Learning, Symbolic AI, Expert Systems, Deep Learning.**
   ...
   *Answer*: The order is as follows: 1. Symbolic AI, 2. Expert Systems, 3. Statistical Learning, 4. Deep Learning. This sequence reflects the historical development of AI paradigms, each building on the limitations and successes of its predecessors.
...
4. **Machine Learning Systems Engineering emphasizes ________, which involves optimizing AI systems for resource efficiency and scalability.**
   ...
   *Answer*: The answer is "system-level optimization". This involves optimizing AI systems for resource efficiency and scalability, ensuring they perform well across different computational platforms.
...
1. **A machine learning system is an integrated computing system comprising three core components: data, algorithms, and ________.**
   ...
   *Answer*: The answer is "computing infrastructure". This component enables both the learning process and the application of learned knowledge, making it a critical part of ML systems.
...
4. **Enterprise ML systems often operate within specific business constraints, focusing on particular tasks while integrating with existing ________.**
   ...
   *Answer*: The answer is "infrastructure". Enterprise ML systems must align with existing business processes and technologies, requiring careful integration.
...
4. **The continuous cycle of ML systems becomes particularly challenging in ________ architectures, where updating models and maintaining system health requires careful orchestration across multiple tiers.**
   ...
   *Answer*: The answer is "distributed". Distributed architectures involve multiple interconnected components, making it challenging to ensure consistent updates and system health across all tiers.
...
4. **In ML systems, the gap between training performance and real-world performance is known as the ________.**
   ...
   *Answer*: The answer is "performance gap". This gap occurs when models perform well on training data but struggle in real-world conditions due to differences in data distribution or other factors.
