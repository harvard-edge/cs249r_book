...
1. What is the primary methodological approach used in machine learning to create systems that demonstrate intelligent behavior?
   a) Implementing intelligence through predetermined rules
   b) Utilizing gradient descent and optimization techniques
   c) Simulating human cognitive processes directly
   d) Programming explicit decision trees

2. Explain how the relationship between AI and ML is similar to the relationship between theoretical physics and mechanical engineering.

3. True or False: Machine learning systems implement intelligence through predetermined rules.
...
1. Explain why the emergence of Machine Learning Systems Engineering is necessary in the context of modern AI development.
...
2. Explain why continuous monitoring is crucial in the lifecycle of a machine learning system.
...
4. In ML system design, balancing the pursuit of more powerful models against growing sustainability concerns is driving innovation in ________ and efficient training techniques.
...
4. In the context of IoT applications, bringing intelligence closer to the data source can lead to more ________, efficient, and scalable solutions.

5. Discuss the potential future implications of deploying ML systems like FarmBeats in addressing global challenges in agriculture.
...
1. What is the primary methodological approach used in machine learning to create systems that demonstrate intelligent behavior?
   ...
   The correct answer is B. Machine learning primarily uses gradient descent and other optimization techniques to identify patterns and relationships, rather than relying on predetermined rules.
...
2. Explain why continuous monitoring is crucial in the lifecycle of a machine learning system.
   ...
   Continuous monitoring is crucial because ML systems rely on data that can change over time, affecting model performance. Monitoring ensures that the system adapts to these changes, maintaining accuracy and relevance as data distributions evolve.
...
4. In ML system design, balancing the pursuit of more powerful models against growing sustainability concerns is driving innovation in ________ and efficient training techniques.
   ...
   model compression. Model compression techniques reduce the size and computational requirements of models, addressing sustainability concerns by lowering energy consumption and resource usage.
:::
...
4. In the context of IoT applications, bringing intelligence closer to the data source can lead to more ________, efficient, and scalable solutions.
   ...
   responsive. Bringing intelligence closer to the data source reduces latency and bandwidth requirements, allowing for faster decision-making and more efficient use of resources.
...
2. Explain why ethical considerations, such as fairness and transparency, are important in the deployment of ML systems.
   ...
   Ethical considerations are crucial because ML systems can inadvertently learn biases present in their training data, leading to unfair decisions. Transparency is important to understand how decisions are made, especially in critical areas like healthcare. Ensuring fairness and transparency helps build trust and ensures responsible AI deployment.
:::
...
1. True or False: The development of more autonomous ML systems will eliminate the need for human oversight in maintaining AI models.
   ...
   False. While autonomous ML systems can handle certain maintenance tasks, human oversight remains crucial to address complex issues such as bias, transparency, and ethical considerations.
