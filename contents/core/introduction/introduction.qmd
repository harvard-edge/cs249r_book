...
3. **The introduction of deep learning marked a shift from manually engineered features to ________ features directly from raw data.**
   ...
   automatically learning. Deep learning networks can automatically learn useful features from raw data, which allows them to handle complex, real-world data without manual feature engineering.
...
1. **A machine learning system is an integrated computing system comprising three core components: data, learning algorithms, and ________.**
   ...
   computing infrastructure. This component enables both the learning process (training) and the application of learned knowledge (inference/serving).
...
4. **Mobile ML systems must balance sophisticated capabilities with ________ and processor limitations on smartphones and tablets.**
   ...
   battery life. Mobile ML systems need to ensure that they provide advanced functionalities while maintaining efficient use of battery power and processing capacity.
...
2. **The trend of making ML systems more efficient is driven by concerns about computational costs and ________ impact.**
   ...
   environmental. The environmental impact of ML systems is a growing concern, prompting efforts to develop more energy-efficient models and hardware.
