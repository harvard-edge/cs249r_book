...
::: {.callout-caution title="Quiz" collapse="true"}

1. What is overfitting?  
2. Why is it a problem in machine learning?  
3. How does it affect performance on unseen data?

See @answer-abc
:::

::: {.callout-tip #answer-abc title="Quiz Answers" collapse="true"}

1. What is overfitting?  
Overfitting occurs when a model learns the training data too precisely, including noise or outliers, rather than the underlying patterns.

1. Why is it a problem in machine learning?  
It causes the model to perform poorly on new, unseen data because it fails to generalize beyond the training set.

1. How does it affect performance on unseen data?  
Predictions on test or real-world data may be inaccurate, as the model is overly specialized to the training examples.
