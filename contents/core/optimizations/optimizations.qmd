...
![Block sparse matrix multiplication implemented in cuSPARSE, showing compressed internal representation while maintaining compatibility with dense matrices via block indices.](images/png/block-sparse-gemm.png){#fig-block-sparse-gemm width=80%}
