...
:::{#exr-p .callout-caution collapse="true" title="Pruning"}
...
:::{#exr-mc .callout-caution collapse="true" title="Scalable Model Compression with TensorFlow"}
...
:::{#exr-md .callout-caution collapse="true" title="Edge-Aware Model Design"}
...
:::{#vid-quant .callout-important title="Quantization" title=""}
