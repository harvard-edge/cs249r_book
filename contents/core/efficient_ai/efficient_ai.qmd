...
\end{tikzpicture}
```
An example in the autonomous vehicle (AV) setting, where both effciency and latency both matter. One cannot easily increase compute to drive down latency, but latency cannot be sacrified as it might impact safety, where increase processing time might impact reation time and braking distance.
:::
