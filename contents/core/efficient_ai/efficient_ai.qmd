...
## Self-Check Answers {#sec-efficient-ai-selfcheck-answers-3bff}
...
4. **Order the following stages in the evolution of compute efficiency: Accelerated Computing Era, Sustainable Computing Era, General-Purpose Computing Era.**
   ...
   *Answer*: The order is as follows: 1. General-Purpose Computing Era, 2. Accelerated Computing Era, 3. Sustainable Computing Era. The evolution began with general-purpose CPUs, advanced with specialized hardware like GPUs, and now focuses on sustainability.
...
4. **In a Tiny ML deployment, achieving efficiency often involves trade-offs such as reducing model size to fit within ____ constraints.**
   ...
   *Answer*: The answer is "memory". In Tiny ML deployments, models must be compact enough to operate within the limited memory available on low-power devices, requiring careful trade-offs to maintain functionality.
...
3. **In a production system, transitioning from a research prototype often involves optimizations such as model pruning, quantization, or retraining on targeted datasets to balance performance and ____.**
   ...
   *Answer*: The answer is "efficiency". These optimizations help adapt the system to practical constraints like compute power, memory, and energy consumption, ensuring it operates effectively in real-world environments.
