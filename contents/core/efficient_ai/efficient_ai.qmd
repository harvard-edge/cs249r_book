...
\draw[-{Triangle[width=18pt,length=8pt]}, line width=10pt,violet!60,
name path=arc1] (340:0.5*\ra)
arc[radius=0.5*\ra, start angle=-20, end angle= 70];

\draw[-{Triangle[width=18pt,length=8pt]}, line width=10pt,cyan!80!black!90,
name path=arc1] (110:0.5*\ra)
arc[radius=0.5*\ra, start angle=110, end angle= 200];

\draw[-{Triangle[width=18pt,length=8pt]}, line width=10pt,orange!70,
name path=arc1] (220:0.5*\ra)
