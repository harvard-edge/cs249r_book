...
## Overview {#sec-security-privacy-overview-787b}
...
## Definitions and Distinctions {#sec-security-privacy-definitions-distinctions-83c0}
...
### Security Defined {#sec-security-privacy-security-defined-8981}
...
### Privacy Defined {#sec-security-privacy-privacy-defined-10e3}
...
### Security versus Privacy {#sec-security-privacy-security-versus-privacy-121a}
...
### Interactions and Trade-offs {#sec-security-privacy-interactions-tradeoffs-1b13}
...
::: {.callout-quiz-question #quiz-question-sec-security-privacy-definitions-distinctions-83c0}
...
1. Which of the following best describes the primary goal of security in machine learning systems?
   ...
   c) Enhance model utility
   d) Improve system transparency

2. True or False: Privacy concerns in machine learning systems only arise in the presence of adversarial attacks.

3. Explain how differential privacy can impact the utility of a machine learning model.

4. In machine learning systems, ________ focuses on safeguarding sensitive information from exposure, even in benign operational contexts.

5. Order the following steps to ensure both security and privacy in an ML system: 1) Implement access controls, 2) Apply differential privacy techniques, 3) Conduct adversarial training.

See Answer \ref{quiz-answer-sec-security-privacy-definitions-distinctions-83c0}.

:::

## Historical Incidents {#sec-security-privacy-historical-incidents-ef21}
...
### Stuxnet {#sec-security-privacy-stuxnet-1449}
...
### Jeep Cherokee Hack {#sec-security-privacy-jeep-cherokee-hack-4058}
...
### Mirai Botnet {#sec-security-privacy-mirai-botnet-ffb4}
...
::: {.callout-quiz-question #quiz-question-sec-security-privacy-historical-incidents-ef21}

1. Explain how the Stuxnet incident highlights the importance of securing software that interacts with physical processes in ML systems.

2. What key lesson from the Jeep Cherokee hack is most applicable to securing machine learning systems?
   a) Ensuring high-speed internet connectivity
   b) Prioritizing cybersecurity in system design
   c) Developing advanced driver-assistance systems
   d) Focusing on infotainment system enhancements

3. True or False: The Mirai botnet incident is irrelevant to machine learning systems as it did not involve ML components.

4. The ________ incident demonstrated how vulnerabilities in connected systems could be exploited to manipulate safety-critical functions remotely.

5. Order the following security measures that should be prioritized to protect ML systems in connected environments: 1) Secure software updates, 2) Network access control, 3) Vulnerability management.

See Answer \ref{quiz-answer-sec-security-privacy-historical-incidents-ef21}.

:::

## Secure Design Priorities {#sec-security-privacy-secure-design-priorities-5f95}
...
### Device-Level Security {#sec-security-privacy-devicelevel-security-1614}
...
### System-Level Isolation {#sec-security-privacy-systemlevel-isolation-a44b}
...
### Large-Scale Network Exploitation {#sec-security-privacy-largescale-network-exploitation-0997}
...
### Toward Secure Design {#sec-security-privacy-toward-secure-design-3264}
...
::: {.callout-quiz-question #quiz-question-sec-security-privacy-secure-design-priorities-5f95}

1. Which of the following is a critical component of device-level security for edge ML devices?
   a) Unencrypted communications
   b) Authenticated firmware updates
   c) Default usernames and passwords
   d) Open network access

2. Explain why system-level isolation is important for machine learning systems operating in safety-critical environments.

3. True or False: Large-scale network exploitation only poses a threat to ML systems if they are directly connected to the internet.

4. The ________ attack demonstrated the potential for cyber operations to cause physical damage by exploiting software vulnerabilities in industrial control systems.

See Answer \ref{quiz-answer-sec-security-privacy-secure-design-priorities-5f95}.

:::

## Threats to ML Models {#sec-security-privacy-threats-ml-models-0d87}
...
### Model Theft {#sec-security-privacy-model-theft-c844}
...
#### Exact Model Theft {#sec-security-privacy-exact-model-theft-a271}
...
#### Approximate Model Theft {#sec-security-privacy-approximate-model-theft-9514}
...
#### Case Study: Tesla IP Theft {#sec-security-privacy-case-study-tesla-ip-theft-587a}
...
### Data Poisoning {#sec-security-privacy-data-poisoning-e3d8}
...
### Adversarial Attacks {#sec-security-privacy-adversarial-attacks-7700}
...
### Case Study: Traffic Sign Detection Model Trickery {#sec-security-privacy-case-study-traffic-sign-detection-model-trickery-31f6}
...
::: {.callout-quiz-question #quiz-question-sec-security-privacy-threats-ml-models-0d87}

1. Which of the following threats primarily targets the deployment stage of the machine learning lifecycle?
   a) Data Poisoning
   b) Adversarial Attacks
   c) Model Theft
   d) Backdoor Attacks

2. Explain why approximate model theft is particularly challenging to defend against in open-access deployment settings.

3. ________ attacks involve manipulating inputs at test time to induce incorrect predictions, often without requiring access to the training data or model internals.

4. Order the following defense strategies for protecting against model theft: 1) Encrypt Artifacts, 2) Monitor for Behavioral Clones, 3) Secure Model Access.

See Answer \ref{quiz-answer-sec-security-privacy-threats-ml-models-0d87}.

:::

## Threats to ML Hardware {#sec-security-privacy-threats-ml-hardware-e4d4}
...
### Hardware Bugs {#sec-security-privacy-hardware-bugs-e746}
...
### Physical Attacks {#sec-security-privacy-physical-attacks-0527}
...
### Fault Injection Attacks {#sec-security-privacy-fault-injection-attacks-b9fe}
...
### Side-Channel Attacks {#sec-security-privacy-sidechannel-attacks-e9db}
...
### Leaky Interfaces {#sec-security-privacy-leaky-interfaces-151a}
...
### Counterfeit Hardware {#sec-security-privacy-counterfeit-hardware-039a}
...
### Supply Chain Risks {#sec-security-privacy-supply-chain-risks-8456}
...
### Case Study: The Supermicro Hardware Security Controversy {#sec-security-privacy-case-study-supermicro-hardware-security-controversy-60cc}
...
::: {.callout-quiz-question #quiz-question-sec-security-privacy-threats-ml-hardware-e4d4}

1. Which of the following best describes a fault injection attack in the context of ML hardware security?
   a) Exploiting software bugs to access sensitive data
   b) Deliberately inducing errors in hardware to disrupt operations
   c) Manipulating network traffic to intercept data
   d) Embedding malicious code in software updates

2. Explain why side-channel attacks are particularly concerning for machine learning systems deployed on edge devices.

3. ________ attacks exploit leaked information from hardware operations to extract sensitive data, posing a risk to ML systems.

4. True or False: Hardware bugs only pose a threat to machine learning systems when they are physically accessible to attackers.

See Answer \ref{quiz-answer-sec-security-privacy-threats-ml-hardware-e4d4}.

:::

## Defensive Strategies {#sec-security-privacy-defensive-strategies-90f1}
...
### Data Privacy Techniques {#sec-security-privacy-data-privacy-techniques-7546}
...
#### Differential Privacy {#sec-security-privacy-differential-privacy-e635}
...
#### Federated Learning {#sec-security-privacy-federated-learning-a713}
...
#### Synthetic Data Generation {#sec-security-privacy-synthetic-data-generation-3d34}
...
#### Comparative Properties {#sec-security-privacy-comparative-properties-8963}
...
### Secure Model Design {#sec-security-privacy-secure-model-design-5ef2}
...
### Secure Model Deployment {#sec-security-privacy-secure-model-deployment-e035}
...
### System-level Monitoring {#sec-security-privacy-systemlevel-monitoring-3422}
...
#### Input Validation {#sec-security-privacy-input-validation-81cc}
...
#### Output Monitoring {#sec-security-privacy-output-monitoring-49a2}
...
#### Integrity Checks {#sec-security-privacy-integrity-checks-b68b}
...
#### Response and Rollback {#sec-security-privacy-response-rollback-c4cd}
...
### Hardware-based Security {#sec-security-privacy-hardwarebased-security-45c5}
...
#### Trusted Execution Environments {#sec-security-privacy-trusted-execution-environments-5b55}
...
#### Secure Boot {#sec-security-privacy-secure-boot-499f}
...
#### Hardware Security Modules {#sec-security-privacy-hardware-security-modules-9258}
...
#### Physical Unclonable Functions {#sec-security-privacy-physical-unclonable-functions-eeb7}
...
#### Mechanisms Comparison {#sec-security-privacy-mechanisms-comparison-e3be}
...
### Toward Trustworthy Systems {#sec-security-privacy-toward-trustworthy-systems-7215}
...
::: {.callout-quiz-question #quiz-question-sec-security-privacy-defensive-strategies-90f1}

1. Which of the following best describes the role of Trusted Execution Environments (TEEs) in machine learning systems?
   a) To enhance model accuracy by optimizing computation
   b) To provide isolated runtime environments for secure computation
   c) To increase the speed of data processing
   d) To simplify the deployment of machine learning models

2. Explain why a layered defense strategy is crucial for securing machine learning systems.

3. True or False: Secure Boot ensures that only verified software components are executed during the boot process, protecting ML models from unauthorized modifications.

4. In machine learning systems, ________ provides cryptographic assurance that a deployed model is authentic and untampered.

5. Describe a real-world scenario where input validation would be critical in a machine learning system.

See Answer \ref{quiz-answer-sec-security-privacy-defensive-strategies-90f1}.

:::

## Offensive Capabilities {#sec-security-privacy-offensive-capabilities-f59a}
...
### Case Study: Deep Learning for SCA {#sec-security-privacy-case-study-deep-learning-sca-d739}
...
::: {.callout-quiz-question #quiz-question-sec-security-privacy-offensive-capabilities-f59a}

1. Which of the following best describes the advantage of using machine learning for phishing and social engineering attacks?
   a) Automated detection of phishing attempts
   b) Personalized, context-aware message crafting
   c) Increased difficulty in crafting messages
   d) Reduced need for human intervention in message creation

2. Explain how the dual-use nature of machine learning models impacts system-level threat models.

3. True or False: Offensive machine learning models require significant manual intervention to adapt to new vulnerabilities.

4. In the context of offensive machine learning, ________ attacks involve crafting minimally perturbed inputs to evade detection systems.

See Answer \ref{quiz-answer-sec-security-privacy-offensive-capabilities-f59a}.

:::

## Conclusion {#sec-security-privacy-conclusion-6417}
...
## Resources {#sec-security-privacy-resources-b51a}
...
## Self-Check Answers {#sec-security-privacy-selfcheck-answers-0164}

:::{.callout-quiz-answer #quiz-answer-sec-security-privacy-definitions-distinctions-83c0}
...
2. **True or False: Privacy concerns in machine learning systems only arise in the presence of adversarial attacks.**
   ...
   *Learning Objective*: Recognize that privacy issues can occur without explicit attacks.
...
3. **Explain how differential privacy can impact the utility of a machine learning model.**
   ...
   *Learning Objective*: Analyze the trade-off between privacy and model utility.

4. **In machine learning systems, ________ focuses on safeguarding sensitive information from exposure, even in benign operational contexts.**

   *Answer*: The answer is "privacy". Privacy in ML systems aims to protect sensitive information from unauthorized disclosure, inference, or misuse, even without explicit attacks.

   *Learning Objective*: Recall the definition of privacy in ML systems.

5. **Order the following steps to ensure both security and privacy in an ML system: 1) Implement access controls, 2) Apply differential privacy techniques, 3) Conduct adversarial training.**

   *Answer*: The order is as follows: 1) Implement access controls, 3) Conduct adversarial training, 2) Apply differential privacy techniques. Access controls and adversarial training address security by preventing unauthorized access and defending against adversarial inputs, while differential privacy focuses on protecting sensitive information.

   *Learning Objective*: Understand the sequential approach to implementing security and privacy measures in ML systems.

:::

:::{.callout-quiz-answer #quiz-answer-sec-security-privacy-historical-incidents-ef21}
...
1. **Explain how the Stuxnet incident highlights the importance of securing software that interacts with physical processes in ML systems.**
   ...
   *Learning Objective*: Understand the implications of software vulnerabilities in ML systems interacting with physical processes.
...
2. **What key lesson from the Jeep Cherokee hack is most applicable to securing machine learning systems?**
   ...
   *Learning Objective*: Recognize the importance of cybersecurity in the design of ML systems.
...
3. **True or False: The Mirai botnet incident is irrelevant to machine learning systems as it did not involve ML components.**
   ...
   *Learning Objective*: Identify the relevance of non-ML security incidents to ML system vulnerabilities.

4. **The ________ incident demonstrated how vulnerabilities in connected systems could be exploited to manipulate safety-critical functions remotely.**

   *Answer*: The answer is "Jeep Cherokee hack". This incident showed how remote access to connected systems could lead to manipulation of critical vehicle functions, emphasizing the need for secure ML system design.

   *Learning Objective*: Recall specific incidents that highlight vulnerabilities in connected systems relevant to ML security.

5. **Order the following security measures that should be prioritized to protect ML systems in connected environments: 1) Secure software updates, 2) Network access control, 3) Vulnerability management.**

   *Answer*: The order is as follows: 1) Network access control, 2) Secure software updates, 3) Vulnerability management. Network access control prevents unauthorized access, secure updates ensure integrity, and vulnerability management addresses potential exploits.

   *Learning Objective*: Sequence security measures to effectively protect ML systems in connected environments.

:::

:::{.callout-quiz-answer #quiz-answer-sec-security-privacy-secure-design-priorities-5f95}
...
1. **Which of the following is a critical component of device-level security for edge ML devices?**
   ...
   *Learning Objective*: Understand the importance of authenticated firmware updates in securing edge ML devices.
...
2. **Explain why system-level isolation is important for machine learning systems operating in safety-critical environments.**
   ...
   *Learning Objective*: Analyze the role of system-level isolation in protecting safety-critical ML systems.
...
3. **True or False: Large-scale network exploitation only poses a threat to ML systems if they are directly connected to the internet.**
   ...
   *Learning Objective*: Challenge the misconception that only internet-connected ML systems are vulnerable to large-scale network exploitation.

4. **The ________ attack demonstrated the potential for cyber operations to cause physical damage by exploiting software vulnerabilities in industrial control systems.**

   *Answer*: The answer is "Stuxnet". The Stuxnet attack showed how targeted cyber operations could cross into the physical world, highlighting the importance of securing ML-driven systems that influence physical processes.

   *Learning Objective*: Recall the significance of the Stuxnet attack in understanding the risks to ML systems.

:::

:::{.callout-quiz-answer #quiz-answer-sec-security-privacy-threats-ml-models-0d87}
...
2. **Explain why approximate model theft is particularly challenging to defend against in open-access deployment settings.**
   ...
   *Learning Objective*: Understand the challenges of defending against approximate model theft in open-access environments.

3. **________ attacks involve manipulating inputs at test time to induce incorrect predictions, often without requiring access to the training data or model internals.**

   *Answer*: The answer is "Adversarial attacks". These attacks exploit vulnerabilities in the model's decision surface during inference, posing critical safety and security risks.

   *Learning Objective*: Recall the definition and implications of adversarial attacks.

4. **Order the following defense strategies for protecting against model theft: 1) Encrypt Artifacts, 2) Monitor for Behavioral Clones, 3) Secure Model Access.**

   *Answer*: The order is as follows: 1) Secure Model Access, 2) Encrypt Artifacts, 3) Monitor for Behavioral Clones. Securing model access is the first step to prevent unauthorized extraction, followed by encrypting artifacts to protect model data, and monitoring for clones to detect replication attempts.

   *Learning Objective*: Understand the sequence of defense strategies against model theft.

:::

:::{.callout-quiz-answer #quiz-answer-sec-security-privacy-threats-ml-hardware-e4d4}
...
1. **Which of the following best describes a fault injection attack in the context of ML hardware security?**
   ...
   *Learning Objective*: Understand the nature of fault injection attacks and their impact on ML hardware security.
...
2. **Explain why side-channel attacks are particularly concerning for machine learning systems deployed on edge devices.**
   ...
   *Learning Objective*: Analyze the vulnerabilities of ML systems to side-channel attacks, especially in resource-constrained environments.

3. **________ attacks exploit leaked information from hardware operations to extract sensitive data, posing a risk to ML systems.**

   *Answer*: The answer is "Side-channel". Side-channel attacks exploit leaked information from hardware operations, such as power consumption or timing, to extract sensitive data, which is a significant risk for ML systems processing confidential information.

   *Learning Objective*: Recall the definition and implications of side-channel attacks in the context of ML hardware security.
...
4. **True or False: Hardware bugs only pose a threat to machine learning systems when they are physically accessible to attackers.**
   ...
   *Learning Objective*: Understand the scope of threats posed by hardware bugs in ML systems, beyond physical access.

:::

:::{.callout-quiz-answer #quiz-answer-sec-security-privacy-defensive-strategies-90f1}
...
1. **Which of the following best describes the role of Trusted Execution Environments (TEEs) in machine learning systems?**
   ...
   *Learning Objective*: Understand the role of TEEs in securing ML systems.
...
2. **Explain why a layered defense strategy is crucial for securing machine learning systems.**
   ...
   *Learning Objective*: Analyze the importance of a layered defense strategy in ML systems.
...
3. **True or False: Secure Boot ensures that only verified software components are executed during the boot process, protecting ML models from unauthorized modifications.**
   ...
   *Learning Objective*: Understand the function and importance of Secure Boot in ML systems.

4. **In machine learning systems, ________ provides cryptographic assurance that a deployed model is authentic and untampered.**

   *Answer*: The answer is "Hardware Security Module (HSM)". HSMs securely store and manage cryptographic keys used for signing models, ensuring that only authenticated versions are deployed.

   *Learning Objective*: Identify the role of HSMs in ensuring model integrity.
...
5. **Describe a real-world scenario where input validation would be critical in a machine learning system.**
   ...
   *Learning Objective*: Apply the concept of input validation to a practical ML system scenario.

:::

:::{.callout-quiz-answer #quiz-answer-sec-security-privacy-offensive-capabilities-f59a}
...
1. **Which of the following best describes the advantage of using machine learning for phishing and social engineering attacks?**
   ...
   *Learning Objective*: Understand the specific advantages that machine learning provides in offensive use cases such as phishing.
...
2. **Explain how the dual-use nature of machine learning models impacts system-level threat models.**
   ...
   *Learning Objective*: Analyze the implications of the dual-use nature of machine learning on system-level threat models.
...
3. **True or False: Offensive machine learning models require significant manual intervention to adapt to new vulnerabilities.**
   ...
   *Learning Objective*: Challenge misconceptions about the adaptability and automation capabilities of offensive machine learning models.

4. **In the context of offensive machine learning, ________ attacks involve crafting minimally perturbed inputs to evade detection systems.**

   *Answer*: The answer is "evasion". Evasion attacks use adversarial input generators to create inputs that bypass detection systems, exploiting weaknesses in detection boundaries.

   *Learning Objective*: Recall specific offensive techniques used in machine learning to bypass detection systems.
