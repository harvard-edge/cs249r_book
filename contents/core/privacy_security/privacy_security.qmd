...
#| lst-cap: "**Secure API Key Loading**: Retrieves the OpenAI API key from an environment variable to prevent hardcoding sensitive information in source code, enhancing security during model inference."
#| eval: false
import openai
import os
