...
## Hardware Evolution {#sec-hardware-evolution-f723}
...
### Specialized Computing {#sec-specialized-computing-864d}
...
### Specialized Computing Expansion {#sec-specialized-computing-expansion-6c2f}
...
### Domain-Specific Architectures {#sec-domain-specific-architectures-a9a0}
...
### ML in Computational Domains {#sec-ml-in-computational-domains-4938}
...
### Application-Specific Accelerators {#sec-application-specific-accelerators-c938}
...
## AI Compute Primitives {#sec-ai-compute-primitives-9e6d}
...
### Vector Operations {#sec-vector-operations-6d54}
...
#### Framework-Hardware Execution {#sec-framework-hardware-execution-d760}
...
#### Sequential Scalar Execution {#sec-sequential-scalar-execution-ae3e}
...
#### Parallel Vector Execution {#sec-parallel-vector-execution-8eff}
...
#### Vector Processing History {#sec-vector-processing-history-5394}
...
### Matrix Operations {#sec-matrix-operations-a9ce}
...
#### Matrix Operations in NNs {#sec-matrix-operations-in-nns-1ead}
...
#### Matrix Computation Types in NNs {#sec-matrix-computation-types-in-nns-aef0}
...
#### Matrix Operations Hardware Acceleration {#sec-matrix-operations-hardware-acceleration-9283}
...
#### Historical Foundations of Matrix Computation {#sec-historical-foundations-of-matrix-computation-8509}
...
### Special Function Units {#sec-special-function-units-2b06}
...
#### Non-Linear Functions {#sec-non-linear-functions-6fab}
...
#### Non-Linear Functions Implementation {#sec-non-linear-functions-implementation-622b}
...
#### Hardware Acceleration {#sec-hardware-acceleration-5957}
...
#### SFUs History {#sec-sfus-history-cf72}
...
### Compute Units and Execution Models {#sec-compute-units-and-execution-models-1932}
...
#### Primitive-Execution Unit Mapping {#sec-primitive-execution-unit-mapping-61f3}
...
#### SIMD to SIMT Transition {#sec-simd-to-simt-transition-bba7}
...
#### Tensor Cores {#sec-tensor-cores-94c3}
...
#### Processing Elements {#sec-processing-elements-ca06}
...
#### Systolic Arrays {#sec-systolic-arrays-44f3}
...
#### Numerics in AI Acceleration {#sec-numerics-in-ai-acceleration-21d7}
...
##### Precision Trade-offs {#sec-precision-trade-offs-5c3e}
...
##### Mixed-Precision Computing {#sec-mixed-precision-computing-139e}
...
#### Architectural Integration {#sec-architectural-integration-0488}
...
## AI Memory Systems {#sec-ai-memory-systems-2e09}
...
### AI Memory Wall {#sec-ai-memory-wall-1a10}
...
#### Compute-Memory Imbalance {#sec-compute-memory-imbalance-f0cb}
...
#### Memory-Intensive ML Workloads {#sec-memory-intensive-ml-workloads-1744}
...
#### Irregular Memory Access {#sec-irregular-memory-access-4496}
...
### Memory Hierarchy {#sec-memory-hierarchy-10a6}
...
#### On-Chip Memory {#sec-on-chip-memory-0d0a}
...
#### Off-Chip Memory {#sec-off-chip-memory-5b71}
...
### Host-Accelerator Communication {#sec-host-accelerator-communication-0609}
...
#### Data Transfer Patterns {#sec-data-transfer-patterns-7066}
...
#### Data Transfer Mechanisms {#sec-data-transfer-mechanisms-793e}
...
##### PCIe Interface {#sec-pcie-interface-88cf}
...
##### NVLink Interface {#sec-nvlink-interface-abaa}
...
##### DMA for Data Transfers {#sec-dma-for-data-transfers-69c8}
...
##### Unified Memory {#sec-unified-memory-82b3}
...
#### Data Transfer Overheads {#sec-data-transfer-overheads-2f40}
...
### Model Memory Pressure {#sec-model-memory-pressure-4303}
...
#### Multilayer Perceptrons {#sec-multilayer-perceptrons-83ad}
...
#### Convolutional Neural Networks {#sec-convolutional-neural-networks-6d6e}
...
#### Transformer Networks {#sec-transformer-networks-e492}
...
### ML Accelerators Implications {#sec-ml-accelerators-implications-9cd0}
...
## Neural Networks Mapping {#sec-neural-networks-mapping-da4d}
...
### Computation Placement {#sec-computation-placement-8e2e}
...
#### Computation Placement Definition {#sec-computation-placement-definition-8d2f}
...
#### Computation Placement Importance {#sec-computation-placement-importance-b28b}
...
#### Effective Computation Placement {#sec-effective-computation-placement-4a04}
...
### Memory Allocation {#sec-memory-allocation-e85a}
...
#### Memory Allocation Definition {#sec-memory-allocation-definition-b48b}
...
#### Memory Allocation Importance {#sec-memory-allocation-importance-0e64}
...
#### Effective Memory Allocation {#sec-effective-memory-allocation-4a95}
...
### Combinatorial Complexity {#sec-combinatorial-complexity-eb25}
...
#### Configuration Space Mapping {#sec-configuration-space-mapping-cc1d}
...
#### Computation and Execution Ordering {#sec-computation-and-execution-ordering-cf43}
...
#### Processing Elements Parallelization {#sec-processing-elements-parallelization-34ab}
...
#### Memory Placement and Data Movement {#sec-memory-placement-and-data-movement-ae78}
...
#### Mapping Search Space {#sec-mapping-search-space-5be1}
...
## Optimization Strategies {#sec-optimization-strategies-3c75}
...
### Mapping Strategies Building Blocks {#sec-mapping-strategies-building-blocks-1456}
...
#### Data Movement Patterns {#sec-data-movement-patterns-8701}
...
##### Weight Stationary {#sec-weight-stationary-004f}
...
##### Output Stationary {#sec-output-stationary-c910}
...
##### Input Stationary {#sec-input-stationary-b3b6}
...
#### Memory-Aware Tensor Layouts {#sec-memory-aware-tensor-layouts-58de}
...
##### Row-Major Layout {#sec-row-major-layout-1410}
...
##### Channel-Major Layout {#sec-channel-major-layout-6700}
...
##### Row-Major vs Channel-Major Layouts {#sec-row-major-vs-channel-major-layouts-652a}
...
#### Kernel Fusion {#sec-kernel-fusion-b5f6}

##### Intermediate Memory Write {#sec-intermediate-memory-write-dd16}
...
##### Kernel Fusion for Memory Efficiency {#sec-kernel-fusion-for-memory-efficiency-c5a2}
...
##### Performance Benefits and Constraints {#sec-performance-benefits-and-constraints-4485}
...
#### Tiling for Memory Efficiency {#sec-tiling-for-memory-efficiency-56c1}
...
##### Tiling Fundamentals {#sec-tiling-fundamentals-3002}
...
##### Tiling Performance Improvement {#sec-tiling-performance-improvement-86fa}
...
##### Tiling Methods {#sec-tiling-methods-d49e}
...
###### Spatial Tiling {#sec-spatial-tiling-211c}
...
###### Temporal Tiling {#sec-temporal-tiling-d077}
...
##### Tiling Challenges and Trade-offs {#sec-tiling-challenges-and-trade-offs-2729}
...
### Mapping Strategies Application {#sec-mapping-strategies-application-5ec4}
...
#### Convolutional Neural Networks {#sec-convolutional-neural-networks-5a4b}
...
#### Transformer Architectures {#sec-transformer-architectures-28b2}
...
#### Multi-Layer Perceptrons {#sec-multi-layer-perceptrons-b9c0}
...
### Hybrid Mapping Strategies {#sec-hybrid-mapping-strategies-fa06}
...
#### Layer-Specific Mapping {#sec-layer-specific-mapping-833b}
...
### Hybrid Strategies Hardware Implementations {#sec-hybrid-strategies-hardware-implementations-fa20}
...
## Compiler Support {#sec-compiler-support-2c8e}
...
### ML vs Traditional Compilers {#sec-ml-vs-traditional-compilers-805b}
...
### ML Compilation Pipeline {#sec-ml-compilation-pipeline-d6af}
...
### Graph Optimization {#sec-graph-optimization-8ae5}
...
#### Computation Graph Optimization {#sec-computation-graph-optimization-00a5}
...
#### AI Compilers Implementation {#sec-ai-compilers-implementation-52d6}
...
#### Graph Optimization Importance {#sec-graph-optimization-importance-f5d0}
...
### Kernel Selection {#sec-kernel-selection-8035}
...
#### Kernel Selection in AI Compilers {#sec-kernel-selection-in-ai-compilers-7095}
...
#### Kernel Selection Importance {#sec-kernel-selection-importance-a17d}
...
### Memory Planning {#sec-memory-planning-c4d5}
...
#### Memory Planning in AI Compilers {#sec-memory-planning-in-ai-compilers-df62}
...
#### Memory Planning Importance {#sec-memory-planning-importance-0c05}
...
### Computation Scheduling {#sec-computation-scheduling-dc86}
...
#### Computation Scheduling in AI Compilers {#sec-computation-scheduling-in-ai-compilers-c693}
...
#### Computation Scheduling Importance {#sec-computation-scheduling-importance-b515}
...
#### Code Generation {#sec-code-generation-479c}
...
### Compilation-Runtime Support {#sec-compilation-runtime-support-dd3a}
...
## Runtime Support {#sec-runtime-support-5dc5}
...
### ML vs Traditional Runtimes {#sec-ml-vs-traditional-runtimes-aa4c}
...
### Dynamic Kernel Execution {#sec-dynamic-kernel-execution-849f}
...
### Runtime Kernel Selection {#sec-runtime-kernel-selection-20ff}
...
### Kernel Scheduling and Utilization {#sec-kernel-scheduling-and-utilization-55ca}
...
## Multi-Chip AI Acceleration {#sec-multi-chip-ai-acceleration-005c}
...
#### Chiplet-Based Architectures {#sec-chiplet-based-architectures-9f9d}
...
#### Multi-GPU Systems {#sec-multi-gpu-systems-14b9}
...
#### Wafer-Scale AI {#sec-wafer-scale-ai-0061}
...
#### AI Systems Scaling Trajectory {#sec-ai-systems-scaling-trajectory-385b}
...
### Computation and Memory Scaling Changes {#sec-computation-and-memory-scaling-changes-da5b}
...
#### Multi-chip Execution Mapping {#sec-multi-chip-execution-mapping-cc00}
...
#### Distributed Access Memory Allocation {#sec-distributed-access-memory-allocation-89c7}
...
#### Data Movement Constraints {#sec-data-movement-constraints-b6e0}
...
#### Compilers and Runtimes Adaptation {#sec-compilers-and-runtimes-adaptation-2374}
...
### Execution Models Adaptation {#sec-execution-models-adaptation-304a}
...
#### Cross-Accelerator Scheduling {#sec-cross-accelerator-scheduling-17e4}
...
#### Cross-Accelerator Coordination {#sec-cross-accelerator-coordination-d770}
...
#### Cross-Accelerator Execution Management {#sec-cross-accelerator-execution-management-e92f}
...
#### Computation Placement Adaptation {#sec-computation-placement-adaptation-5990}
...
### Navigating Multi-Chip AI Complexities {#sec-navigating-multi-chip-ai-complexities-f411}
...
## Conclusion {#sec-conclusion-f55f}
