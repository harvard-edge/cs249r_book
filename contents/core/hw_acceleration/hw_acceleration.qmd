...
library(ggplot2)
library(ggrepel)  # Fixes label collisions

# Data for processors, now extended beyond 2025
processors <- data.frame(
  year = c(1971, 1974, 1978, 1982, 1985, 1989, 1993, 1997, 1999, 2000,
           2006, 2008, 2012, 2016, 2017, 2018, 2019, 2020, 2021, 2021, 2022, 2023, 2024, 2025, 2028),
  processor = c("Intel 4004", "Intel 8080", "Intel 8086", "Intel 80286", "Intel 80386",
                ...
                "Cerebras WSE-4", "Future AI Accelerator"),  # Placeholder for 2028
  transistors = c(0.0023, 0.006, 0.029, 0.134, 0.275, 1.2, 3.1, 7.5, 9.5, 42,
                  ...
                  8000000, 16000000),  # Hypothetical future processor in 2028
  category = c("CPU", "CPU", "CPU", "CPU", "CPU", "CPU", "CPU", "CPU", "CPU", "CPU",
               "CPU", "CPU", "GPU", "GPU", "TPU", "GPU", "WSE", "GPU",
               "WSE", "TPU", "GPU", "CPU", "WSE", "WSE", "Future")  # Placeholder category
)
...
category_colors <- c("CPU" = "#8da0cb",  # Muted blue
                     ...
                     "Future" = "#999999")  # Gray for future processors
...
key_processors <- c("Intel 4004", "Intel Pentium", "Intel Core i7",
                    ...
                    "Cerebras WSE-1", "Cerebras WSE-3", "Cerebras WSE-4", "Future AI Accelerator")

# Plot with extended x-axis, improved labels, and overlap fix
ggplot(processors, aes(x = year, y = transistors, label = processor, color = category)) +
  ...
  geom_text_repel(data = subset(processors, processor %in% key_processors),
                  aes(label = processor),
                  size = 3, color = "black", max.overlaps = 10) +  # Fix overlapping labels
  ...
  theme(
    ...
    legend.position = c(0.1, 0.9),  # Move legend inside (top-left)
  ...
  labs(title = "Processor Transistor Count Over Time (Extended to 2030)",
       x = "Year",
...
The effectiveness of this architecture is demonstrated in its performance scaling capabilities. As illustrated in @fig-tpu-pod-pef, TPU Pod performance exhibits near-linear scaling when running ResNet-50, from quarter-pod to full-pod configurations. The system achieves a remarkable 33.0x speedup when scaled to 1024 chips compared to a 16-TPU baseline. This scaling efficiency is particularly noteworthy in larger configurations, where performance continues to scale strongly even as the system expands from 128 to 1024 chips.
