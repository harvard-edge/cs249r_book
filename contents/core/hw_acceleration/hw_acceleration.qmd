...
ggplot(data_melted, aes(x = Year, y = Performance, color = Metric, shape = Metric)) +
  ...
  annotate("text", x = 2016, y = 1e6, label = "AI Memory Wall", angle = 0, vjust = -0.5, size = 5) +
  labs(
