...
+--------------+----------------------------------------+----------------------------------+
| Architecture | Supported Tensor Core Precisions       | Supported CUDA Core Precisions   |
+:=============+:=======================================+:=================================+
| Volta        | FP16                                   | FP64, FP32, FP16                 |
+--------------+----------------------------------------+----------------------------------+
| Turing       | FP16, INT8                             | FP64, FP32, FP16, INT8           |
+--------------+----------------------------------------+----------------------------------+
| Ampere       | FP64, TF32, bfloat16, FP16, INT8, INT4 | FP64, FP32, FP16, bfloat16, INT8 |
+--------------+----------------------------------------+----------------------------------+

: {#tbl-numeric-evolution .striped .hover}

@tbl-numeric-evolution highlights how newer architectures incorporate a growing diversity of numerical formats, reflecting the need for greater flexibility across different AI workloads. This trend suggests that future AI accelerators will continue expanding support for adaptive precision, optimizing both computational efficiency and model accuracy.
