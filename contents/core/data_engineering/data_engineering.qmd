...
\end{scope}
%
\begin{scope}[shift={($(scope1.south)+(-2.84,-2.2)$)},anchor=center, scope anchor]
...
\node[Box, fill=magenta!20,  node distance=1.3,below right=1 and 0.2of 3B1](4B2){Data Validation \& Quality Checks};
...
\node[Box, fill=magenta!20,  node distance=0.6,below =of 5B2](6B1){Feature Creation / Engineering};
...
\node[draw=col5,inner xsep=5mm,inner ysep=5mm,yshift=1mm,
           fill=col2!20,minimum width=113mm,fit=(B1)(B2)(B3),line width=0.75pt](BB1){};
\node[below=7pt of  BB1.north east,anchor=east,helvetica]{Sources};
\scoped[on background layer]
\node[draw=col5,inner xsep=5mm,inner ysep=5mm,yshift=1mm,
           fill=col2!20,minimum width=113mm,fit=(2B1)(2B2),line width=0.75pt](BB2){};
\node[below=7pt of  BB2.north east,anchor=east,helvetica]{Data Ingestion};
\scoped[on background layer]
\node[draw=col5,inner xsep=9mm,inner ysep=5mm,yshift=-2mm,
           fill=col2!20,fit=(4B1)(5B1),line width=0.75pt](BB3){};
\node[above=7pt of  BB3.south east,anchor=east,helvetica]{ML Training};
%
\scoped[on background layer]
\node[draw=col5,inner xsep=9mm,inner ysep=5mm,yshift=-2mm,
           fill=col2!20,fit=(4B2)(7B1),line width=0.75pt](BB4){};
\node[above=7pt of  BB4.south east,anchor=east,helvetica]{Processing Layer};
%
\scoped[on background layer]
\node[draw=orange!90,inner xsep=3mm,inner ysep=6mm,yshift=3mm,
           fill=none,fit=(BB1)(BB4),line width=0.75pt](BB4){};
\node[below=4pt of  BB4.north,
anchor=north,helvetica]{Data Governance};
%
\draw[-latex,line width=1.5pt,black!50](B1)--++(270:1.2)-|(2B1);
\draw[-latex,line width=1.5pt,black!50](B2)--++(270:1.2)-|(2B1);
\draw[-latex,line width=1.5pt,black!50](B3)--++(270:1.2)-|(2B2);
%
\draw[-latex,line width=1.5pt,black!50](2B1)|-(3B1);
\draw[-latex,line width=1.5pt,black!50](2B2)|-(3B1);
%
\draw[-latex,line width=1.5pt,black!50](3B1)--++(270:0.9)-|(4B1);
\draw[-latex,line width=1.5pt,black!50](3B1)--++(270:0.9)-|(4B2);
%
\draw[-latex,line width=1.5pt,black!50](4B1)--(5B1);
\draw[-latex,line width=1.5pt,black!50](4B2)--(5B2);
\draw[-latex,line width=1.5pt,black!50](5B2)--(6B1);
\draw[-latex,line width=1.5pt,black!50](6B1)--(7B1);
\draw[-latex,line width=1.5pt,black!50](7B1.east)--++(0:0.6)|-(3B1);
\end{tikzpicture}}
```
