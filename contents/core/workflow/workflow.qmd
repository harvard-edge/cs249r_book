...
\draw[Line,-latex,](B3)--++(270:2.6)-|node[Text,pos=0.25]{Performance Insights}(DB1);
\draw[Line,-latex](B2)-|(GB2);
\draw[Line,-latex](GB2)-|(B3.130);
\draw[Line,-latex](B3)--++(90:3.4)-|node[Text,pos=0.25]{Model Updates}(GB1);
\draw[Line,-latex](B3.50)--++(90:4.0)-|node[Text,pos=0.25]{Data Quality Issues}(B1.120);
