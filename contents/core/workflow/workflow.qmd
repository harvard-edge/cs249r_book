...
:::{.callout-note title="Definition of the ML Lifecycle"}
...
\draw[-latex,line width=1.5pt,black!50](B3)--++(270:2.6)-|node[Text,pos=0.25]{Performance Insights}(DB1);
...
\draw[-latex,line width=1.5pt,black!50](B3.50)--++(90:4.0)-|node[Text,pos=0.25]{Data Quality Issues}(B1.120);
\draw[-latex,line width=1.5pt,black!50](GB1.340)-|(B2);
\draw[-latex,line width=1.5pt,black!50](GB2.160)--node[Text,pos=0.5]{Deployment Constraints}(GB1.20);
\end{tikzpicture}
```
