...
3. In the Diabetic Retinopathy project, which stage of the ML lifecycle likely posed the most significant challenge when deploying the system in rural clinics?
...
1. In defining an ML problem for the diabetic retinopathy project, which factor is important to ensure the system's effectiveness in rural clinics?
...
3. In ML data collection, ________ ensures that data handling complies with legal and ethical standards.
...
3. True or False: In ML systems, achieving state-of-the-art accuracy is always the primary goal during model development.
...
3. **In ML data collection, ________ ensures that data handling complies with legal and ethical standards.**
   ...
   The answer is "patient privacy compliance". Ensuring data handling complies with legal and ethical standards is important, particularly in sensitive domains like healthcare, where regulations dictate secure data management practices.
...
4. **In ML model development, techniques like ________ and quantization are used to optimize models for resource-limited environments.**
   ...
   The answer is "pruning". Pruning reduces the size and complexity of models, making them more efficient for deployment on devices with limited computational power.
...
2. **In ML systems, monitoring insights drive updates to models and workflows, while user feedback informs ________ priorities.**
   ...
   The answer is "maintenance". User feedback helps prioritize maintenance activities, ensuring the system remains responsive to both technical and clinical needs.
...
4. **In AI projects, ________ engineers are responsible for integrating models into production settings and ensuring they are scalable and efficient.**
   ...
   The answer is "Machine Learning". Machine Learning engineers take models developed by data scientists and ensure they are integrated into production environments, optimized for scalability and efficiency.
