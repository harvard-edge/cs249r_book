...
1. In the context of the Oura Ring case study, which of the following is a key challenge when deploying ML models on embedded devices?
...
4. **In MLOps, ________ is a critical function that enables teams to maintain operational visibility over machine learning systems deployed in production.**
   ...
   monitoring. Monitoring is essential for detecting performance degradation, data quality issues, and system failures, ensuring the reliability and trustworthiness of ML systems.
...
3. **In ML systems, ________ debt arises from the complexity and fragility of ad hoc workflows and pipelines.**
   ...
   pipeline. Pipeline debt arises from the complexity and fragility of ad hoc workflows and pipelines, leading to difficulties in modification and experimentation.
...
4. **In the MLOps lifecycle, the ________ Engineer is responsible for provisioning and managing the infrastructure that supports ML systems.**
   ...
   DevOps. The DevOps Engineer manages the infrastructure, ensuring it supports the development, deployment, and monitoring of ML systems.
...
4. **In mature ML environments, __________ is a practice that supports reproducibility and scalability by decoupling feature engineering from model logic.**
   ...
   modular abstraction. Modular abstraction helps in separating concerns within the system, allowing for better maintainability and scalability by decoupling feature engineering from model logic.
...
3. **In the ClinAIOps framework, the ________ loop ensures that AI-generated recommendations are reviewed and refined under professional supervision.**
   ...
   Clinician-AI. The Clinician-AI loop ensures that AI-generated recommendations are reviewed and refined under professional supervision, maintaining clinical accountability and patient safety.
