...
:::{#vid-mlops .callout-important title="MLOps"}
...
MLOps teams heavily leverage [infrastructure as code (IaC)](https://aws.amazon.com/what-is/iac/) tools and robust cloud architectures to actively manage the resources needed for development, training, and deployment of ML systems.
