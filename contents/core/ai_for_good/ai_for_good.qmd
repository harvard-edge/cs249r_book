...
## Overview {#sec-ai-good-overview-e11c}
...
## Global Challenges {#sec-ai-good-global-challenges-1bec}
...
::: {.callout-quiz-question #quiz-question-sec-ai-good-global-challenges-1bec}

1. Which of the following is a common characteristic of global challenges such as healthcare access, agricultural productivity, and educational inequity?
   a) They primarily affect developed countries.
   b) They are easily solved with existing resources.
   c) They disproportionately affect vulnerable populations.
   d) They are unrelated to environmental issues.

2. Explain how machine learning systems can help address the systemic barriers faced by smallholder farmers in agriculture.

3. True or False: Addressing global challenges with technology requires no trade-offs between competing priorities.

4. In the context of global challenges, machine learning systems can help uncover patterns and generate insights to inform action, even in ______ environments.

See Answer \ref{quiz-answer-sec-ai-good-global-challenges-1bec}.

:::

## Key AI Applications {#sec-ai-good-key-ai-applications-06cf}
...
### Agriculture {#sec-ai-good-agriculture-2b19}
...
### Healthcare {#sec-ai-good-healthcare-505f}
...
### Disaster Response {#sec-ai-good-disaster-response-4980}
...
### Environmental Conservation {#sec-ai-good-environmental-conservation-f0b5}
...
### AI's Holistic Impact {#sec-ai-good-ais-holistic-impact-eb85}
...
::: {.callout-quiz-question #quiz-question-sec-ai-good-key-ai-applications-06cf}

1. Which AI technology is primarily used for processing data locally to optimize water usage in agriculture?
   a) Cloud ML
   b) Mobile ML
   c) Edge ML
   d) Tiny ML

2. True or False: Cloud ML is essential for enabling real-time monitoring of mosquito species in remote areas.

3. Explain how AI technologies can enhance disaster response efforts in remote areas.

4. In environmental conservation, Edge ML-powered collars are used to track animal behavior by processing data ______.

See Answer \ref{quiz-answer-sec-ai-good-key-ai-applications-06cf}.

:::

## Global Development Perspective {#sec-ai-good-global-development-perspective-0da2}
...
::: {.callout-quiz-question #quiz-question-sec-ai-good-global-development-perspective-0da2}

1. Explain why it is necessary to consider local resource constraints when designing ML systems for advancing the SDGs.

2. True or False: Deploying ML systems in regions lacking reliable infrastructure can deepen existing inequalities if not carefully managed.

See Answer \ref{quiz-answer-sec-ai-good-global-development-perspective-0da2}.

:::

## Engineering Challenges {#sec-ai-good-engineering-challenges-16aa}
...
### Resource Paradox {#sec-ai-good-resource-paradox-7bff}
...
### Data Dilemma {#sec-ai-good-data-dilemma-1012}
...
### Scale Challenge {#sec-ai-good-scale-challenge-3efe}
...
### Sustainability Challenge {#sec-ai-good-sustainability-challenge-a83b}
...
::: {.callout-quiz-question #quiz-question-sec-ai-good-engineering-challenges-16aa}

1. Which of the following best describes the primary challenge when deploying ML systems in rural environments?
   a) High bandwidth requirements
   b) Limited computational and power resources
   c) Abundant standardized data
   d) Stable grid power availability

2. Explain how scaling machine learning systems from development to production in resource-constrained environments impacts model architecture.

3. True or False: In resource-constrained environments, maintaining ML systems is solely about optimizing computational efficiency.

See Answer \ref{quiz-answer-sec-ai-good-engineering-challenges-16aa}.

:::

## Design Patterns {#sec-ai-good-design-patterns-e9ac}
...
### Hierarchical Processing {#sec-ai-good-hierarchical-processing-614d}
...
#### Google's Flood Forecasting {#sec-ai-good-googles-flood-forecasting-bafa}
...
#### Structure {#sec-ai-good-structure-9637}
...
#### Modern Adaptations {#sec-ai-good-modern-adaptations-1efd}
...
#### System Implications {#sec-ai-good-system-implications-7e93}
...
#### Limitations {#sec-ai-good-limitations-bfb9}
...
### Progressive Enhancement {#sec-ai-good-progressive-enhancement-5194}
...
#### PlantVillage Nuru {#sec-ai-good-plantvillage-nuru-c13a}
...
#### Structure {#sec-ai-good-structure-8e5c}
...
#### Modern Adaptations {#sec-ai-good-modern-adaptations-519b}
...
#### System Implications {#sec-ai-good-system-implications-fedc}
...
#### Limitations {#sec-ai-good-limitations-7e6a}
...
### Distributed Knowledge {#sec-ai-good-distributed-knowledge-f817}
...
#### Wildlife Insights {#sec-ai-good-wildlife-insights-ffc3}
...
#### Structure {#sec-ai-good-structure-e36f}
...
#### Modern Adaptations {#sec-ai-good-modern-adaptations-bb7b}
...
#### System Implications {#sec-ai-good-system-implications-137c}
...
#### Limitations {#sec-ai-good-limitations-b6ed}
...
### Adaptive Resource {#sec-ai-good-adaptive-resource-9464}
...
#### Case Studies {#sec-ai-good-case-studies-fc53}
...
#### Structure {#sec-ai-good-structure-fa2c}
...
#### Modern Adaptations {#sec-ai-good-modern-adaptations-144f}
...
#### System Implications {#sec-ai-good-system-implications-3b57}
...
#### Limitations {#sec-ai-good-limitations-1004}
...
::: {.callout-quiz-question #quiz-question-sec-ai-good-design-patterns-e9ac}

1. Which of the following best describes the primary advantage of using the Hierarchical Processing Pattern in machine learning systems?
   a) It minimizes the need for cloud infrastructure.
   b) It allows for efficient resource allocation across different tiers.
   c) It eliminates the need for edge processing.
   d) It ensures all data is processed in real-time.

2. Explain how the Hierarchical Processing Pattern supports system resilience in environments with varying infrastructure quality.

3. In the Hierarchical Processing Pattern, the ______ tier is responsible for advanced analytics and model training.

4. True or False: The Hierarchical Processing Pattern eliminates the need for model updates at the edge tier.

See Answer \ref{quiz-answer-sec-ai-good-design-patterns-e9ac}.

:::

## Selection Framework {#sec-ai-good-selection-framework-a4ae}
...
### Selection Dimensions {#sec-ai-good-selection-dimensions-6244}
...
### Implementation Guidance {#sec-ai-good-implementation-guidance-a2cd}
...
### Comparison Analysis {#sec-ai-good-comparison-analysis-98d9}
...
::: {.callout-quiz-question #quiz-question-sec-ai-good-selection-framework-a4ae}

1. Which design pattern is most suitable for environments with low resource availability and high adaptability needs?
...
2. Explain how the quadrant analysis framework assists in selecting a design pattern for ML systems in social impact contexts.

3. In environments with high resource availability and significant scalability demands, the ______ pattern is commonly used.

4. True or False: The Distributed Knowledge Pattern is ideal for environments where centralized coordination is essential.

See Answer \ref{quiz-answer-sec-ai-good-selection-framework-a4ae}.

:::

## Conclusion {#sec-ai-good-conclusion-7dfb}
...
2. True or False: The core principles of accessibility, reliability, and scalability in ML systems for social impact will remain constant despite advancements in technology.

3. Which of the following factors is most critical when selecting a design pattern for ML systems in resource-constrained environments?
   a) Historical performance data
   b) Resource availability and adaptability requirements
   c) User interface design
   d) Marketing strategy

See Answer \ref{quiz-answer-sec-ai-good-conclusion-7dfb}.
...
## Self-Check Answers {#sec-ai-good-selfcheck-answers-bc14}

:::{.callout-quiz-answer #quiz-answer-sec-ai-good-global-challenges-1bec}
...
1. **Which of the following is a common characteristic of global challenges such as healthcare access, agricultural productivity, and educational inequity?**
   ...
   *Answer*: The correct answer is C. These challenges disproportionately affect vulnerable populations, exacerbating existing inequalities and highlighting the need for targeted solutions.

   *Learning Objective*: Understand the common characteristics of global challenges and their impact on vulnerable populations.

2. **Explain how machine learning systems can help address the systemic barriers faced by smallholder farmers in agriculture.**

   *Answer*: Machine learning systems can process vast amounts of data to provide smallholder farmers with insights on weather patterns, pest outbreaks, and soil conditions, enabling better decision-making and improving yields. This helps overcome information constraints and enhances food security.

   *Learning Objective*: Analyze the role of ML systems in overcoming systemic barriers in agriculture.

3. **True or False: Addressing global challenges with technology requires no trade-offs between competing priorities.**

   *Answer*: False. Addressing global challenges with technology often requires navigating trade-offs between competing priorities and limited resources, especially in resource-constrained environments.

   *Learning Objective*: Recognize the trade-offs involved in deploying technology to address global challenges.

4. **In the context of global challenges, machine learning systems can help uncover patterns and generate insights to inform action, even in ______ environments.**

   *Answer*: The answer is "resource-constrained". Machine learning systems can process large data sets and provide actionable insights, which is particularly valuable in environments with limited resources.

   *Learning Objective*: Recall how ML systems can be applied in resource-constrained environments to address global challenges.

:::

:::{.callout-quiz-answer #quiz-answer-sec-ai-good-key-ai-applications-06cf}
...
1. **Which AI technology is primarily used for processing data locally to optimize water usage in agriculture?**
   ...
   *Answer*: The correct answer is D. Tiny ML is used for processing data locally to optimize water usage in agriculture, as it allows for low-power, localized data processing, which is crucial in areas with minimal infrastructure.

   *Learning Objective*: Understand the specific applications and advantages of Tiny ML in agriculture.

2. **True or False: Cloud ML is essential for enabling real-time monitoring of mosquito species in remote areas.**

   *Answer*: False. Tiny ML is essential for enabling real-time monitoring of mosquito species in remote areas, as it allows for low-cost, localized processing without the need for internet connectivity.

   *Learning Objective*: Differentiate between the roles of Tiny ML and Cloud ML in healthcare and environmental monitoring.

3. **Explain how AI technologies can enhance disaster response efforts in remote areas.**

   *Answer*: AI technologies enhance disaster response by using Tiny ML for autonomous drones to navigate and detect signs of life locally, and Cloud ML for processing satellite imagery to predict flood zones. These technologies provide real-time insights and enable faster, more efficient resource allocation.

   *Learning Objective*: Analyze how AI technologies improve operational efficiency and effectiveness in disaster response.

4. **In environmental conservation, Edge ML-powered collars are used to track animal behavior by processing data ______.**

   *Answer*: The answer is "locally". Edge ML-powered collars process data locally, minimizing power consumption and reducing the need for frequent battery changes, which is crucial for long-term wildlife monitoring.

   *Learning Objective*: Understand the operational benefits of Edge ML in environmental conservation.

:::

:::{.callout-quiz-answer #quiz-answer-sec-ai-good-global-development-perspective-0da2}

1. **Explain why it is necessary to consider local resource constraints when designing ML systems for advancing the SDGs.**

   *Answer*: Considering local resource constraints is essential because many regions that could benefit from ML applications lack reliable electricity and internet infrastructure. Designing systems that operate within these constraints ensures they are sustainable and effective in advancing the SDGs without creating new dependencies or inequalities.

   *Learning Objective*: Analyze the importance of adapting ML system designs to local resource constraints for sustainable development.

2. **True or False: Deploying ML systems in regions lacking reliable infrastructure can deepen existing inequalities if not carefully managed.**

   *Answer*: True. If ML systems are deployed without considering local infrastructure limitations, they can exacerbate inequalities by creating dependencies on technologies that are not accessible to all, thereby widening the gap between those with and without access.

   *Learning Objective*: Evaluate the potential risks of deploying ML systems in resource-constrained environments.

:::

:::{.callout-quiz-answer #quiz-answer-sec-ai-good-engineering-challenges-16aa}
...
1. **Which of the following best describes the primary challenge when deploying ML systems in rural environments?**
   ...
   *Answer*: The correct answer is B. Limited computational and power resources. Rural environments often lack the infrastructure needed for traditional ML deployments, requiring systems to operate on minimal resources.

   *Learning Objective*: Understand the primary resource constraints faced in rural ML system deployments.

2. **Explain how scaling machine learning systems from development to production in resource-constrained environments impacts model architecture.**

   *Answer*: Scaling ML systems requires significant changes in model architecture due to reduced computational and power resources. Models must be quantized and pruned to fit within the constraints of microcontrollers, often requiring a reduction from 50 MB to 500 KB while maintaining performance.

   *Learning Objective*: Analyze the impact of scaling on model architecture and system design in resource-constrained environments.

3. **True or False: In resource-constrained environments, maintaining ML systems is solely about optimizing computational efficiency.**

   *Answer*: False. While computational efficiency is crucial, maintaining ML systems also involves addressing environmental sustainability, community capacity building, and financial viability.

   *Learning Objective*: Recognize the multifaceted nature of maintaining ML systems in resource-constrained environments.

:::

:::{.callout-quiz-answer #quiz-answer-sec-ai-good-design-patterns-e9ac}
...
1. **Which of the following best describes the primary advantage of using the Hierarchical Processing Pattern in machine learning systems?**
   ...
   *Answer*: The correct answer is B. The Hierarchical Processing Pattern allows for efficient resource allocation across different tiers, optimizing resource usage by distributing tasks based on the capabilities of edge, regional, and cloud tiers.

   *Learning Objective*: Understand the primary advantage of the Hierarchical Processing Pattern in ML systems.

2. **Explain how the Hierarchical Processing Pattern supports system resilience in environments with varying infrastructure quality.**

   *Answer*: The Hierarchical Processing Pattern supports system resilience by organizing operations across edge, regional, and cloud tiers. Edge devices handle local processing and maintain critical functions during network disruptions, while regional nodes aggregate data and the cloud tier performs advanced analytics. This distribution ensures that essential operations can continue even under varying infrastructure conditions.

   *Learning Objective*: Analyze how hierarchical processing contributes to system resilience in resource-constrained environments.

3. **In the Hierarchical Processing Pattern, the ______ tier is responsible for advanced analytics and model training.**

   *Answer*: The answer is "cloud". The cloud tier provides the computational power needed for comprehensive analytics and model retraining, supporting the overall hierarchical structure.

   *Learning Objective*: Recall the specific responsibilities of each tier in the Hierarchical Processing Pattern.

4. **True or False: The Hierarchical Processing Pattern eliminates the need for model updates at the edge tier.**

   *Answer*: False. The Hierarchical Processing Pattern includes bidirectional feedback loops where model updates flow back to the edge tier, ensuring continuous improvement and adaptation to new data.

   *Learning Objective*: Understand the role of model updates in maintaining system performance within the Hierarchical Processing Pattern.

:::

:::{.callout-quiz-answer #quiz-answer-sec-ai-good-selection-framework-a4ae}
...
1. **Which design pattern is most suitable for environments with low resource availability and high adaptability needs?**
   ...
   *Answer*: The correct answer is B. The Progressive Enhancement Pattern is designed to provide baseline functionality in resource-constrained environments while allowing for dynamic scaling as resources become available.

   *Learning Objective*: Understand which design patterns align with specific resource and adaptability requirements.

2. **Explain how the quadrant analysis framework assists in selecting a design pattern for ML systems in social impact contexts.**

   *Answer*: The quadrant analysis framework helps by mapping design patterns based on resource availability and scalability/adaptability needs, allowing system architects to visualize and select patterns that best fit the operational constraints and requirements of their deployment scenarios.

   *Learning Objective*: Analyze how the quadrant analysis framework aids in making informed design pattern selections.

3. **In environments with high resource availability and significant scalability demands, the ______ pattern is commonly used.**

   *Answer*: The answer is "Hierarchical Processing Pattern". This pattern is effective in environments where robust infrastructure supports scalability and resilience, such as Google's Flood Forecasting Initiative.

   *Learning Objective*: Recall the design pattern best suited for high-resource, high-scalability environments.

4. **True or False: The Distributed Knowledge Pattern is ideal for environments where centralized coordination is essential.**

   *Answer*: False. The Distributed Knowledge Pattern is suited for environments where centralized coordination is not feasible, emphasizing peer-to-peer operations and decentralized data processing.

   *Learning Objective*: Challenge the misconception about the suitability of the Distributed Knowledge Pattern for centralized operations.

:::

:::{.callout-quiz-answer #quiz-answer-sec-ai-good-conclusion-7dfb}

1. **Explain why the implementation of design patterns in ML systems for social good requires a comprehensive understanding of the operational environment.**

   *Answer*: Implementing design patterns in ML systems for social good requires understanding the operational environment to tailor solutions to constraints like power, connectivity, and data availability. This ensures the systems are effective and sustainable, addressing local needs while maintaining performance.

   *Learning Objective*: Understand the importance of adapting ML system design to specific operational environments for social impact.

2. **True or False: The core principles of accessibility, reliability, and scalability in ML systems for social impact will remain constant despite advancements in technology.**

   *Answer*: True. While technological advancements will expand the potential applications of design patterns, the core principles of accessibility, reliability, and scalability remain fundamental to developing ML systems that generate meaningful social impact.

   *Learning Objective*: Recognize the enduring principles of ML system design for social impact despite technological changes.
...
3. **Which of the following factors is most critical when selecting a design pattern for ML systems in resource-constrained environments?**
   ...
   *Answer*: The correct answer is B. Resource availability and adaptability requirements are critical for selecting a design pattern, as they dictate how the system can be effectively implemented and sustained in resource-constrained environments.

   *Learning Objective*: Identify critical factors in selecting design patterns for ML systems in constrained environments.
