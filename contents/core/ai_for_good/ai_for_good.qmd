...
1. Explain how systemic barriers in healthcare and agriculture contribute to global challenges, and how they are interconnected with education.

2. True or False: Machine learning systems can fully address global challenges without any need for systematic approaches or consideration of local contexts.

3. In the context of global challenges, technology, including machine learning systems, offers hope by providing innovative tools to enhance decision-making, increase efficiency, and deliver solutions at ____.

See Answer \ref{quiz-answer-sec-ai-good-global-challenges-1bec}.

:::

## Key AI Applications {#sec-ai-good-key-ai-applications-834c}
...
::: {.callout-quiz-question #quiz-question-sec-ai-good-key-ai-applications-834c}

1. True or False: Cloud ML is essential for real-time mosquito species identification in remote areas.

2. Explain why Edge ML-powered collars are beneficial for wildlife conservation efforts.

See Answer \ref{quiz-answer-sec-ai-good-key-ai-applications-834c}.

:::

## Global Development Perspective {#sec-ai-good-global-development-perspective-9215}
...
::: {.callout-quiz-question #quiz-question-sec-ai-good-global-development-perspective-9215}

1. Explain how global frameworks like the United Nations Sustainable Development Goals (SDGs) guide the design and deployment of machine learning systems for social impact.

2. True or False: Achieving the SDGs with machine learning systems requires only technical solutions without considering local resource constraints or cultural contexts.

See Answer \ref{quiz-answer-sec-ai-good-global-development-perspective-9215}.

:::

## Engineering Challenges {#sec-ai-good-engineering-challenges-90d8}
...
::: {.callout-quiz-question #quiz-question-sec-ai-good-engineering-challenges-90d8}

1. Which of the following is a key challenge when deploying ML systems in rural areas compared to urban areas?
   a) Access to high-bandwidth networks
   b) Availability of standardized datasets
   c) Stable power infrastructure
   d) Limited computational resources

2. True or False: Scaling ML systems from development to production typically requires no changes to the model architecture.

3. Explain why sustainability is a critical consideration in the deployment of ML systems in resource-constrained environments.

4. In resource-constrained environments, ML systems often rely on ____ to transmit small data packets over long distances with minimal energy consumption.

See Answer \ref{quiz-answer-sec-ai-good-engineering-challenges-90d8}.

:::

## Design Patterns {#sec-ai-good-design-patterns-1bef}
...
### Progressive Enhancement {#sec-ai-good-progressive-enhancement-7b70}
...
#### Structure {#sec-ai-good-structure-6061}
...
### Distributed Knowledge {#sec-ai-good-distributed-knowledge-eaff}
...
::: {.callout-quiz-question #quiz-question-sec-ai-good-design-patterns-1bef}

1. Which of the following best describes the Hierarchical Processing Pattern in ML systems?
   a) A single-tier system where all processing is done in the cloud.
   b) A multi-tier system where tasks are distributed across edge, regional, and cloud tiers.
   c) A peer-to-peer system where each node operates independently without any hierarchy.
   d) A system that relies on centralized data processing and storage.

2. Explain how the Progressive Enhancement Pattern benefits ML systems in resource-constrained environments.

3. True or False: The Distributed Knowledge Pattern relies solely on centralized cloud processing for model updates and data analysis.

4. In ML systems, the Adaptive Resource Pattern allows systems to dynamically adjust their operations based on ________ availability.

5. Discuss the challenges of implementing the Hierarchical Processing Pattern in ML systems with respect to model updates and data flows.

See Answer \ref{quiz-answer-sec-ai-good-design-patterns-1bef}.

:::

## Selection Framework {#sec-ai-good-selection-framework-ba48}
...
### Implementation Guidance {#sec-ai-good-implementation-guidance-703e}
...
::: {.callout-quiz-question #quiz-question-sec-ai-good-selection-framework-ba48}

1. Which design pattern is most suitable for an ML system operating in a low-resource environment with high adaptability needs?
...
2. True or False: The Adaptive Resource Pattern is primarily focused on spatial distribution and peer-to-peer collaboration.

3. In environments with higher resource availability and significant scalability demands, the ____ pattern is often used.

See Answer \ref{quiz-answer-sec-ai-good-selection-framework-ba48}.
...
1. Which of the following is a key consideration when deploying ML systems for social good in resource-constrained environments?
   a) Maximizing computational power
   b) Ensuring system adaptability and scalability
   c) Focusing solely on urban deployment strategies
   d) Prioritizing high-speed internet connectivity

2. Explain why the selection of design patterns is critical for deploying ML systems in underserved communities.

3. True or False: The implementation of design patterns in ML systems for social impact remains static regardless of technological advancements.
...
1. **Explain how systemic barriers in healthcare and agriculture contribute to global challenges, and how they are interconnected with education.**
   ...
   Systemic barriers in healthcare, such as lack of access to medical expertise, and in agriculture, like limited information for farmers, exacerbate global challenges by increasing vulnerability and reducing resilience. These issues are interconnected with education, as inadequate educational resources perpetuate cycles of poverty and limit opportunities for improvement in other sectors, such as healthcare and agriculture.

   *Learning Objective*: Understand the interconnected nature of systemic barriers in healthcare, agriculture, and education and their contribution to global challenges.

2. **True or False: Machine learning systems can fully address global challenges without any need for systematic approaches or consideration of local contexts.**

   False. While machine learning systems have the potential to address global challenges, their effectiveness depends on deliberate and systematic approaches that consider local contexts and needs to ensure equitable and effective implementation.

   *Learning Objective*: Evaluate the role of machine learning systems in addressing global challenges and the importance of systematic approaches.

3. **In the context of global challenges, technology, including machine learning systems, offers hope by providing innovative tools to enhance decision-making, increase efficiency, and deliver solutions at ____.**

   The answer is "scale". Technology can process large amounts of information and generate insights that inform action, even in resource-constrained environments, thereby addressing global challenges more effectively.

   *Learning Objective*: Recognize the potential of technology and machine learning systems in scaling solutions to global challenges.

:::

:::{.callout-quiz-answer #quiz-answer-sec-ai-good-key-ai-applications-834c}

1. **True or False: Cloud ML is essential for real-time mosquito species identification in remote areas.**

   False. Tiny ML, not Cloud ML, is used for real-time mosquito species identification in remote areas, as it allows for local data processing without the need for internet connectivity.

   *Learning Objective*: Distinguish between the roles of Tiny ML and Cloud ML in remote healthcare applications.

2. **Explain why Edge ML-powered collars are beneficial for wildlife conservation efforts.**

   Edge ML-powered collars are beneficial for wildlife conservation because they process data locally, reducing power consumption and the frequency of battery changes. This allows for continuous monitoring of animal behavior with minimal disturbance, aiding in the protection of biodiversity.

   *Learning Objective*: Analyze the operational benefits of Edge ML in environmental conservation.

:::

:::{.callout-quiz-answer #quiz-answer-sec-ai-good-global-development-perspective-9215}

1. **Explain how global frameworks like the United Nations Sustainable Development Goals (SDGs) guide the design and deployment of machine learning systems for social impact.**

   Global frameworks like the SDGs provide a structured approach to address pressing global challenges by setting priorities and fostering international collaboration. They guide the design and deployment of machine learning systems by aligning efforts towards achieving specific goals, such as reducing poverty or improving health outcomes. This alignment ensures that ML systems contribute to sustainable development by addressing relevant challenges in a coordinated manner.

   *Learning Objective*: Understand the role of global frameworks in guiding the design and deployment of ML systems for social impact.

2. **True or False: Achieving the SDGs with machine learning systems requires only technical solutions without considering local resource constraints or cultural contexts.**

   False. Achieving the SDGs with machine learning systems requires a holistic approach that considers local resource constraints, cultural contexts, and existing infrastructure limitations, in addition to technical solutions.

   *Learning Objective*: Recognize the importance of considering local contexts and constraints in deploying ML systems for sustainable development.

:::

:::{.callout-quiz-answer #quiz-answer-sec-ai-good-engineering-challenges-90d8}
...
1. **Which of the following is a key challenge when deploying ML systems in rural areas compared to urban areas?**
   ...
   The correct answer is D. Limited computational resources are a significant challenge in rural deployments, requiring systems to operate on low-power, low-memory devices like microcontrollers, unlike urban areas where server-grade systems are available.

   *Learning Objective*: Understand the resource constraints specific to rural ML system deployments.

2. **True or False: Scaling ML systems from development to production typically requires no changes to the model architecture.**

   False. Scaling ML systems to production often necessitates architectural redesigns, such as model quantization and pruning, to meet the resource constraints of production environments.

   *Learning Objective*: Recognize the need for architectural changes when scaling ML systems from development to production.

3. **Explain why sustainability is a critical consideration in the deployment of ML systems in resource-constrained environments.**

   Sustainability is critical because it ensures the long-term viability of ML systems by addressing hardware durability, environmental impact, community capacity, and financial viability. These factors determine whether systems can be maintained and adapted over time, especially in regions with limited resources.

   *Learning Objective*: Evaluate the importance of sustainability in ML system design for social impact.

4. **In resource-constrained environments, ML systems often rely on ____ to transmit small data packets over long distances with minimal energy consumption.**

   The answer is "LoRa". LoRa is a low-power wireless communication protocol designed for transmitting small data packets over long distances, making it suitable for environments with limited power resources.

   *Learning Objective*: Identify communication protocols suitable for resource-constrained environments.

:::

:::{.callout-quiz-answer #quiz-answer-sec-ai-good-design-patterns-1bef}
...
1. **Which of the following best describes the Hierarchical Processing Pattern in ML systems?**
   ...
   The correct answer is B. The Hierarchical Processing Pattern organizes systems into multiple tiers, distributing tasks across edge, regional, and cloud tiers to optimize resource usage and ensure system resilience.

   *Learning Objective*: Understand the structure and purpose of the Hierarchical Processing Pattern in ML systems.

2. **Explain how the Progressive Enhancement Pattern benefits ML systems in resource-constrained environments.**

   The Progressive Enhancement Pattern allows ML systems to maintain baseline functionality under minimal resources and progressively add advanced features as more resources become available. This ensures reliability and scalability across varying conditions, enabling systems to operate effectively in diverse environments.

   *Learning Objective*: Analyze the benefits of the Progressive Enhancement Pattern in resource-constrained ML deployments.

3. **True or False: The Distributed Knowledge Pattern relies solely on centralized cloud processing for model updates and data analysis.**

   False. The Distributed Knowledge Pattern emphasizes decentralized processing and peer-to-peer knowledge sharing, allowing each node to operate independently while contributing to the network's collective intelligence.

   *Learning Objective*: Understand the decentralized nature of the Distributed Knowledge Pattern in ML systems.

4. **In ML systems, the Adaptive Resource Pattern allows systems to dynamically adjust their operations based on ________ availability.**

   The answer is "resource". The Adaptive Resource Pattern enables systems to optimize performance and maintain efficiency by scaling operations according to the available computational, network, and storage resources.

   *Learning Objective*: Recognize the role of the Adaptive Resource Pattern in optimizing ML system performance.

5. **Discuss the challenges of implementing the Hierarchical Processing Pattern in ML systems with respect to model updates and data flows.**

   Implementing the Hierarchical Processing Pattern in ML systems poses challenges such as managing dynamic model updates across tiers and ensuring efficient data flows. Edge and regional tiers must handle older model versions during connectivity issues, requiring robust versioning systems. Additionally, optimizing data flows to reduce bandwidth while maintaining inference accuracy is critical for system efficiency.

   *Learning Objective*: Evaluate the challenges and considerations of implementing hierarchical processing in ML systems.

:::

:::{.callout-quiz-answer #quiz-answer-sec-ai-good-selection-framework-ba48}
...
1. **Which design pattern is most suitable for an ML system operating in a low-resource environment with high adaptability needs?**
   ...
   The correct answer is B. The Progressive Enhancement Pattern is most suitable for low-resource environments with high adaptability needs because it provides baseline functionality and scales up dynamically as resources become available.

   *Learning Objective*: Understand which design pattern is appropriate for specific resource and adaptability scenarios.

2. **True or False: The Adaptive Resource Pattern is primarily focused on spatial distribution and peer-to-peer collaboration.**

   False. The Adaptive Resource Pattern is focused on temporal adaptation to changing conditions, dynamically adjusting operations based on resource availability, rather than spatial distribution and peer-to-peer collaboration.

   *Learning Objective*: Differentiate between the focuses of Adaptive Resource and Distributed Knowledge Patterns.

3. **In environments with higher resource availability and significant scalability demands, the ____ pattern is often used.**

   The answer is "Hierarchical Processing". The Hierarchical Processing Pattern is often used in environments with higher resource availability and significant scalability demands because it organizes operations into edge, regional, and cloud tiers, providing scalability and resilience.

   *Learning Objective*: Identify the design pattern suitable for high-resource availability and scalability demands.
...
1. **Which of the following is a key consideration when deploying ML systems for social good in resource-constrained environments?**
   ...
   The correct answer is B. Ensuring system adaptability and scalability is important in resource-constrained environments to maintain system performance and meet local needs.

   *Learning Objective*: Understand the importance of adaptability and scalability in ML systems for social good.

2. **Explain why the selection of design patterns is critical for deploying ML systems in underserved communities.**

   Design patterns are critical because they provide structured approaches to overcome challenges such as limited resources, unreliable connectivity, and sparse data, ensuring that ML systems are effective, sustainable, and tailored to local needs.

   *Learning Objective*: Analyze the role of design patterns in addressing deployment challenges in underserved communities.

3. **True or False: The implementation of design patterns in ML systems for social impact remains static regardless of technological advancements.**

   False. The implementation of design patterns evolves with technological advancements, such as edge computing and federated learning, which expand the potential applications and improve system effectiveness in resource-constrained environments.

   *Learning Objective*: Evaluate the impact of technological advancements on the implementation of design patterns in ML systems.
