...
: Inference benchmark metrics and evaluation dimensions.  
...
The shift toward data-centric AI acknowledges that better data—not just better models—leads to more robust and trustworthy AI. Recent efforts such as [DataPerf](https://www.dataperf.org/) and [DataComp](https://www.datacomp.ai/) evaluate how dataset improvements impact model performance. For instance, DataComp [@gadre2023datacomp] found that models trained on a carefully filtered 30% subset of data outperformed models trained on the full dataset, suggesting that curation matters more than sheer volume.  
