...
This shift is often framed in terms of model-centric AI versus data-centric AI, as illustrated in @fig-model-vs-data. Traditionally, AI development has prioritized enhancing model architectures, refining algorithms, and increasing computational efficiency. However, recent research underscores that systematically improving dataset quality—through better annotations, diversity, and debiasing—can yield superior performance gains compared to solely refining models.

![Comparison of model-centric and data-centric AI approaches. Model-centric AI focuses on improving architectures, while data-centric AI emphasizes enhancing dataset quality. Both approaches are complementary in optimizing AI performance.](images/png/model2data-centricAI.png){#fig-model-vs-data}
