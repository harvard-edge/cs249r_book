...
## Self-Check Answers {#sec-benchmarking-ai-selfcheck-answers-fc2f}
...
3. **Modern machine learning benchmarks must address the sophisticated interplay between algorithmic models, hardware systems, and ____.**
   ...
   *Answer*: The answer is "training data". This interplay is essential as limitations in any one area can fundamentally constrain overall system performance.
...
4. **End-to-end benchmarks assess the entire AI pipeline, including data preprocessing, model performance, and ____ components.**
   ...
   *Answer*: The answer is "infrastructure". End-to-end benchmarks evaluate the complete system, including infrastructure components like storage and network systems, to ensure comprehensive performance assessment.
...
4. **Training benchmarks help identify ____ by measuring system throughput, time-to-accuracy, and hardware utilization.**
   ...
   *Answer*: The answer is "bottlenecks". Training benchmarks help identify bottlenecks by measuring system throughput, time-to-accuracy, and hardware utilization, allowing for optimization of training processes.
...
3. **Inference benchmarks help evaluate the trade-offs between latency, cost, and ____ efficiency.**
   ...
   *Answer*: The answer is "energy". Energy efficiency is a critical factor in inference benchmarks, especially for mobile and edge devices, where power constraints are significant.
...
4. **The phenomenon where models achieve high performance on benchmarks but fail to generalize to real-world conditions is known as the ____ gap.**
   ...
   *Answer*: The answer is "Sim2Real gap". This gap occurs when models perform well on benchmark datasets but struggle to generalize to real-world conditions, highlighting the limitations of traditional benchmarking methods.
