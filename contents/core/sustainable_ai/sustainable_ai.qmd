...
_What principles emerge when we consider machine learning systems through an ecological lens, and how does environmental stewardship reshape system architecture?_
...
:::{#exr-cf .callout-caution collapse="true" title="AI's Carbon Footprint"}
...
:::{#exr-mle .callout-caution collapse="true" title="Tracking ML Emissions"}
