...
![Comparing Traditional Machine Learning and Deep Learning.](contents/workflow/images/png/comparingdlandml.png){#dl-and-ml}

@embedded-ai showcases the uses of embedded ai in various industries.

![Embedded AI applications](contents/workflow/images/png/embeddedai.png){#embedded-ai}
