...
I understand you'd like to combine the bullet points with the references to create a more concise list. Here's a revised version that incorporates the references into the bullet points:
