...
![Hardware errors can occur due to a variety of reasons and at different times and/or locations in a system. This figure illustrates many potential error models which can be explored when studying the impact of hardware-based errors on systems [@ahmadilivani2024systematic]](./images/png/hardware_errors.png){#fig-hardware-errors}
