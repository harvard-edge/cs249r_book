...
![Computational Graph. Credit: TensorFlow.](https://naml.us/paper/tensorflow/graph.svg){#fig-computational-graph height=40%}
...
![Common activation functions. Credit: [AI Wiki.](https://machine-learning.paperspace.com/wiki/activation-function)](https://1394217531-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-LvBP1svpACTB1R1x_U4%2F-LvNWUoWieQqaGmU_gl9%2F-LvO3qs2RImYjpBE8vln%2Factivation-functions3.jpg?alt=media&token=f96a3007-5888-43c3-a256-2dafadd5df7c){width=70% #fig-activation-functions}
...
Using a larger batch size shifts the overall computation from being more memory-bounded to being more compute-bounded. In other words, the computer spends more time doing calculations and less time waiting for data to be moved in and out of memory. This is because with larger batches, the proportion of operations (addition, multiplication, etc.) increases compared to the amount of data that needs to be fetched per time unit. Thus, the process becomes more about how fast the computer can calculate ("compute-bounded") and less about how fast it can fetch the data ("memory-bounded").
