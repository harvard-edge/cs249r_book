...
Resources: [Slides](#sec-ai-training-resource), [Exercises](#sec-ai-training-resource), [Labs](#sec-ai-training-resource)
:::
...
![Neural network diagram. Credit: astroML.](images/png/aitrainingnn.png){#fig-neural-net-diagram}
...
![Gradient descent. Credit: Towards Data Science.](images/png/aitrainingsgd.png){#fig-gradient-descent}
...
:::{#exr-nn .callout-caution collapse="false"}
...
[![](https://colab.research.google.com/assets/exr-badge.png)](https://colab.research.google.com/github/jigsawlabs-student/pytorch-intro-curriculum/blob/main/5-training-mathematically/20-backpropagation-and-gradient-descent.ipynb)
...
![Computational Graph. Credit: TensorFlow.](./images/png/graph.png){#fig-computational-graph height=40%}
...
![Data fitting: overfitting, right fit, and underfitting. Credit: MathWorks.](images/png/fits.png){#fig-over-under-fitting}
...
![Fitting the data overtime. Credit: IBM.](images/png/aitrainingfit.png){#fig-fitting-time}
...
:::{#exr-hpt .callout-caution collapse="false"}
...
[![](https://colab.research.google.com/assets/exr-badge.png)](https://colab.research.google.com/github/pytorch/tutorials/blob/gh-pages/_downloads/30bcc2970bf630097b13789b5cdcea48/hyperparameter_tuning_tutorial.ipynb)
...
:::{#exr-r .callout-caution collapse="false"}
...
[![](https://colab.research.google.com/assets/exr-badge.png)](https://colab.research.google.com/github/dphi-official/Deep_Learning_Bootcamp/blob/master/Optimization_Techniques/Regularization_and_Dropout.ipynb)
...
:::{#exr-wi .callout-caution collapse="false"}
...
[![](https://colab.research.google.com/assets/exr-badge.png)](https://colab.research.google.com/github/csaybar/DLcoursera/blob/master/Improving%20Deep%20Neural%20Networks%20Hyperparameter%20tuning%2C%20Regularization%20and%20Optimization/week5/Initialization/Initialization.ipynb)
...
@fig-activation-functions demonstrates the 3 activation functions we discussed above -Tanh, ReLU, Sigmoid- in addition to the Linear case.

![Common activation functions. Credit: [AI Wiki.](https://machine-learning.paperspace.com/wiki/activation-function)](images/jpeg/activation-functions3.jpg){width=70% #fig-activation-functions}
...
:::{#exr-af .callout-caution collapse="false"}
...
[![](https://colab.research.google.com/assets/exr-badge.png)](https://colab.research.google.com/github/jfogarty/machine-learning-intro-workshop/blob/master/notebooks/nn_activation_functions.ipynb)
