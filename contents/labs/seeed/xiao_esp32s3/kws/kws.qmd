...
## Overview {#sec-keyword-spotting-kws-overview-2863}
...
### How does a voice assistant work? {#sec-keyword-spotting-kws-voice-assistant-work-e700}
...
## Dataset {#sec-keyword-spotting-kws-dataset-c4c4}
...
### Capturing (offline) Audio Data with the XIAO ESP32S3 Sense {#sec-keyword-spotting-kws-capturing-offline-audio-data-xiao-esp32s3-sense-4da0}
...
### Save recorded sound samples (dataset) as .wav audio files to a microSD card {#sec-keyword-spotting-kws-save-recorded-sound-samples-dataset-wav-audio-files-microsd-card-e1d8}
...
### Capturing (offline) Audio Data Apps {#sec-keyword-spotting-kws-capturing-offline-audio-data-apps-cfc8}
...
## Training model with Edge Impulse Studio {#sec-keyword-spotting-kws-training-model-edge-impulse-studio-46cc}

### Uploading the Data {#sec-keyword-spotting-kws-uploading-data-c170}
...
### Creating Impulse (Pre-Process / Model definition) {#sec-keyword-spotting-kws-creating-impulse-pre-process-model-definition-d516}
...
### Pre-Processing (MFCC) {#sec-keyword-spotting-kws-pre-processing-mfcc-a4ed}
...
### Model Design and Training {#sec-keyword-spotting-kws-model-design-training-f814}
...
## Testing {#sec-keyword-spotting-kws-testing-dc0f}
...
## Deploy and Inference {#sec-keyword-spotting-kws-deploy-inference-ac0f}
...
## Conclusion {#sec-keyword-spotting-kws-conclusion-133c}
