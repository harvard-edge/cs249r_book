...
### How does a voice assistant work? {#sec-how-does-a-voice-assistant-work-6320}
...
### The KWS Project {#sec-the-kws-project-fa0c}
...
### The Machine Learning workflow {#sec-the-machine-learning-workflow-51b6}
...
### Capturing (offline) Audio Data with the XIAO ESP32S3 Sense {#sec-capturing-offline-audio-data-with-the-xiao-esp32s3-sense-af49}
...
### Save recorded sound samples (dataset) as .wav audio files to a microSD card {#sec-save-recorded-sound-samples-dataset-as-wav-audio-files-to-a-microsd-card-faba}
...
### Capturing (offline) Audio Data Apps {#sec-capturing-offline-audio-data-apps-6b4e}
...
## Training model with Edge Impulse Studio {#sec-training-model-with-edge-impulse-studio-d58b}

### Uploading the Data {#sec-uploading-the-data-16b1}
...
### Creating Impulse (Pre-Process / Model definition) {#sec-creating-impulse-pre-process-model-definition-e16b}
...
### Pre-Processing (MFCC) {#sec-pre-processing-mfcc-2839}
...
### Model Design and Training {#sec-model-design-and-training-5a16}
...
## Deploy and Inference {#sec-deploy-and-inference-a31c}
...
## Postprocessing {#sec-postprocessing-4f37}
...
## Conclusion {#sec-conclusion-7a86}
