...
## Overview {#sec-keyword-spotting-kws-overview-40bc}
...
### How does a voice assistant work? {#sec-keyword-spotting-kws-voice-assistant-work-4e5a}
...
### The KWS Project {#sec-keyword-spotting-kws-kws-project-78f9}
...
### The Machine Learning workflow {#sec-keyword-spotting-kws-machine-learning-workflow-6741}
...
## Dataset {#sec-keyword-spotting-kws-dataset-c428}
...
### Capturing (offline) Audio Data with the XIAO ESP32S3 Sense {#sec-keyword-spotting-kws-capturing-offline-audio-data-xiao-esp32s3-sense-aecf}
...
### Save recorded sound samples (dataset) as .wav audio files to a microSD card {#sec-keyword-spotting-kws-save-recorded-sound-samples-dataset-wav-audio-files-microsd-card-69f1}
...
### Capturing (offline) Audio Data Apps {#sec-keyword-spotting-kws-capturing-offline-audio-data-apps-d84e}
...
## Training model with Edge Impulse Studio {#sec-keyword-spotting-kws-training-model-edge-impulse-studio-0303}

### Uploading the Data {#sec-keyword-spotting-kws-uploading-data-8dfa}
...
### Creating Impulse (Pre-Process / Model definition) {#sec-keyword-spotting-kws-creating-impulse-preprocess-model-definition-4733}
...
### Pre-Processing (MFCC) {#sec-keyword-spotting-kws-preprocessing-mfcc-d0cb}
...
### Model Design and Training {#sec-keyword-spotting-kws-model-design-training-2ac3}
...
## Testing {#sec-keyword-spotting-kws-testing-4607}
...
## Deploy and Inference {#sec-keyword-spotting-kws-deploy-inference-7b58}
...
## Postprocessing {#sec-keyword-spotting-kws-postprocessing-51c7}
...
## Conclusion {#sec-keyword-spotting-kws-conclusion-0683}
...
## Resources {#sec-keyword-spotting-kws-resources-5e78}
