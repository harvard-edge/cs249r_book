...
## Installing the IMU {#sec-installing-the-imu-3e79}
...
## The TinyML Motion Classification Project {#sec-the-tinyml-motion-classification-project-9dbf}
...
## Connecting the device to Edge Impulse {#sec-connecting-the-device-to-edge-impulse-f2a0}
...
## Data Collection {#sec-data-collection-d082}
...
## Data Pre-Processing {#sec-data-pre-processing-b107}
...
## Model Design {#sec-model-design-2cb3}
...
## Impulse Design {#sec-impulse-design-d5e9}
...
## Generating features {#sec-generating-features-58cc}
...
## Conclusion {#sec-conclusion-7102}
