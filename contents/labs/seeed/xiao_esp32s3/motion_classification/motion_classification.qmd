...
## Overview {#sec-motion-classification-anomaly-detection-overview-75d6}
...
## Installing the IMU {#sec-motion-classification-anomaly-detection-installing-imu-b58d}
...
## The TinyML Motion Classification Project {#sec-motion-classification-anomaly-detection-tinyml-motion-classification-project-6756}
...
## Connecting the device to Edge Impulse {#sec-motion-classification-anomaly-detection-connecting-device-edge-impulse-87e7}
...
## Data Collection {#sec-motion-classification-anomaly-detection-data-collection-c235}
...
## Data Pre-Processing {#sec-motion-classification-anomaly-detection-data-preprocessing-0886}
...
## Model Design {#sec-motion-classification-anomaly-detection-model-design-14fa}
...
## Impulse Design {#sec-motion-classification-anomaly-detection-impulse-design-cae6}
...
## Generating features {#sec-motion-classification-anomaly-detection-generating-features-6df2}
...
## Training {#sec-motion-classification-anomaly-detection-training-d5d0}
...
## Testing {#sec-motion-classification-anomaly-detection-testing-353e}
...
## Deploy {#sec-motion-classification-anomaly-detection-deploy-227f}
...
## Inference {#sec-motion-classification-anomaly-detection-inference-e408}
...
## Conclusion {#sec-motion-classification-anomaly-detection-conclusion-1b5c}
...
## Resources {#sec-motion-classification-anomaly-detection-resources-8b57}
