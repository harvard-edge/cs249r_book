...
## Overview {#sec-motion-classification-anomaly-detection-overview-30dc}
...
## Installing the IMU {#sec-motion-classification-anomaly-detection-installing-imu-f670}
...
## Connecting the device to Edge Impulse {#sec-motion-classification-anomaly-detection-connecting-device-edge-impulse-d53b}
...
## Data Collection {#sec-motion-classification-anomaly-detection-data-collection-145e}
...
## Data Pre-Processing {#sec-motion-classification-anomaly-detection-data-pre-processing-e556}
...
## Impulse Design {#sec-motion-classification-anomaly-detection-impulse-design-7be1}
...
## Generating features {#sec-motion-classification-anomaly-detection-generating-features-3b9e}
...
## Training {#sec-motion-classification-anomaly-detection-training-3759}
...
## Testing {#sec-motion-classification-anomaly-detection-testing-466c}
...
## Deploy {#sec-motion-classification-anomaly-detection-deploy-9015}
...
## Inference {#sec-motion-classification-anomaly-detection-inference-51ef}
...
## Conclusion {#sec-motion-classification-anomaly-detection-conclusion-74c7}
