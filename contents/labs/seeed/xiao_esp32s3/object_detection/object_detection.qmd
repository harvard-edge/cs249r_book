...
## Overview {#sec-object-detection-overview-b53c}
...
### Object Detection versus Image Classification {#sec-object-detection-object-detection-versus-image-classification-196d}
...
### An Innovative Solution for Object Detection: FOMO {#sec-object-detection-innovative-solution-object-detection-fomo-93fd}
...
## The Object Detection Project Goal {#sec-object-detection-object-detection-project-goal-4968}
...
## Data Collection {#sec-object-detection-data-collection-327c}
...
### Collecting Dataset with the XIAO ESP32S3 {#sec-object-detection-collecting-dataset-xiao-esp32s3-5511}
...
## Edge Impulse Studio {#sec-object-detection-edge-impulse-studio-d596}

### Setup the project {#sec-object-detection-setup-project-429b}
...
### Uploading the unlabeled data {#sec-object-detection-uploading-unlabeled-data-b76f}
...
### Labeling the Dataset {#sec-object-detection-labeling-dataset-9527}
...
### Balancing the dataset and split Train/Test {#sec-object-detection-balancing-dataset-split-traintest-f67c}
...
## The Impulse Design {#sec-object-detection-impulse-design-2cb7}
...
### Preprocessing all dataset {#sec-object-detection-preprocessing-dataset-64d5}
...
## Model Design, Training, and Test {#sec-object-detection-model-design-training-test-3aec}
...
### How FOMO works? {#sec-object-detection-fomo-works-18b7}
...
### Test model with "Live Classification" {#sec-object-detection-test-model-live-classification-8cab}
...
## Deploying the Model (Arduino IDE) {#sec-object-detection-deploying-model-arduino-ide-ac81}
...
### Background {#sec-object-detection-background-2284}
...
### Fruits {#sec-object-detection-fruits-729a}
...
### Bugs {#sec-object-detection-bugs-5f4e}
...
## Deploying the Model (SenseCraft-Web-Toolkit) {#sec-object-detection-deploying-model-sensecraftwebtoolkit-5934}
...
## Conclusion {#sec-object-detection-conclusion-ad6a}
...
## Resources {#sec-object-detection-resources-7087}
