...
### Object Detection versus Image Classification {#sec-object-detection-versus-image-classification-ad68}
...
### An Innovative Solution for Object Detection: FOMO {#sec-an-innovative-solution-for-object-detection-fomo-04d5}
...
## The Object Detection Project Goal {#sec-the-object-detection-project-goal-04d9}
...
## Data Collection {#sec-data-collection-abea}
...
### Collecting Dataset with the XIAO ESP32S3 {#sec-collecting-dataset-with-the-xiao-esp32s3-e2b0}
...
## Edge Impulse Studio {#sec-edge-impulse-studio-52c8}

### Setup the project {#sec-setup-the-project-b5e4}
...
### Uploading the unlabeled data {#sec-uploading-the-unlabeled-data-9bf0}
...
### Labeling the Dataset {#sec-labeling-the-dataset-ee28}
...
### Balancing the dataset and split Train/Test {#sec-balancing-the-dataset-and-split-train-test-ad73}
...
## The Impulse Design {#sec-the-impulse-design-1b59}
...
### Preprocessing all dataset {#sec-preprocessing-all-dataset-a25a}
...
## Model Design, Training, and Test {#sec-model-design-training-and-test-694f}
...
### How FOMO works? {#sec-how-fomo-works-c1e3}
...
### Test model with "Live Classification" {#sec-test-model-with-live-classification-d97b}
...
## Deploying the Model (Arduino IDE) {#sec-deploying-the-model-arduino-ide-9ab5}
...
### Background {#sec-background-fce8}
...
## Deploying the Model (SenseCraft-Web-Toolkit) {#sec-deploying-the-model-sensecraft-web-toolkit-cd86}
...
## Conclusion {#sec-conclusion-afd3}
