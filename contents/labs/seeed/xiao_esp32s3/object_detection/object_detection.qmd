...
## Overview {#sec-object-detection-overview-1ddf}
...
### Object Detection versus Image Classification {#sec-object-detection-object-detection-versus-image-classification-6388}
...
## Data Collection {#sec-object-detection-data-collection-465a}
...
## Edge Impulse Studio {#sec-object-detection-edge-impulse-studio-2d9f}
...
### Uploading the unlabeled data {#sec-object-detection-uploading-unlabeled-data-8f20}
...
### Balancing the dataset and split Train/Test {#sec-object-detection-balancing-dataset-split-traintest-7497}
...
## The Impulse Design {#sec-object-detection-impulse-design-83de}
...
### Preprocessing all dataset {#sec-object-detection-preprocessing-dataset-50a9}
...
## Model Design, Training, and Test {#sec-object-detection-model-design-training-test-09eb}
...
### How FOMO works? {#sec-object-detection-fomo-works-d7e9}
...
### Test model with "Live Classification" {#sec-object-detection-test-model-live-classification-7aaa}
...
## Deploying the Model (Arduino IDE) {#sec-object-detection-deploying-model-arduino-ide-2283}
...
### Background {#sec-object-detection-background-3e6b}
...
### Fruits {#sec-object-detection-fruits-9679}
...
### Bugs {#sec-object-detection-bugs-ecd5}
...
## Deploying the Model (SenseCraft-Web-Toolkit) {#sec-object-detection-deploying-model-sensecraftwebtoolkit-1faf}
...
## Conclusion {#sec-object-detection-conclusion-782c}
