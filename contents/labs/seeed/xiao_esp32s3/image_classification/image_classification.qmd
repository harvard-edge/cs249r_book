...
![](./images/png/imgs_classif/vegetables.png)
...
![](./images/png/imgs_classif/train.png)
...
![](./images/png/imgs_classif/depl.png)
...
![](./images/png/imgs_classif/deploy_block.png)

Returning to your project (Tab Image), copy one of the Raw Data Sample:

![](./images/png/imgs_classif/get_test_data.png)
...
![](./images/png/imgs_classif/features.png)
...
![](./images/png/imgs_classif/inference1.png)
...
![](./images/png/imgs_classif/camera_set.png)
...
![](./images/png/imgs_classif/inf_banana.jpg)

Getting a photo with the camera, the classification result will appear on the Serial Monitor:

![](./images/png/imgs_classif/inf_banana.png)

Other tests:

![](./images/png/imgs_classif/inferencia2_apple.png)

![](./images/png/imgs_classif/inferencia3.png)
...
![](./images/png/imgs_classif/train_2.png)
...
![](./images/png/imgs_classif/deploy_2.png)
...
![](./images/png/imgs_classif/inf_2.png)
...
![](./images/jpeg/imgs_classif/senseCraft-1.jpg)

- Select the device/Port and press `[Connect]`: 

    ![](./images/jpeg/imgs_classif/senseCraft-2.jpg)
...
![](./images/jpeg/imgs_classif/senseCraft-4.jpg) 
...
![](./images/jpeg/imgs_classif/senseCraft-3.jpg) 
...
![](./images/jpeg/imgs_classif/senseCraft-apple.jpg)
...
![](./images/jpeg/imgs_classif/senseCraft-apple-2.jpg)

On Device Log, you will get information as: 

![](./images/jpeg/imgs_classif//senseCraft-log.jpg)
...
![](./images/jpeg/imgs_classif//inference.jpg)
