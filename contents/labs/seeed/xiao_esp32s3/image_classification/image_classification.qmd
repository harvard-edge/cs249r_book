...
## Overview {#sec-image-classification-overview-4b5a}
...
## A TinyML Image Classification Project – Fruits versus Veggies {#sec-image-classification-tinyml-image-classification-project-fruits-versus-veggies-698a}
...
## Training the model with Edge Impulse Studio {#sec-image-classification-training-model-edge-impulse-studio-8eba}
...
### Impulse Design {#sec-image-classification-impulse-design-ca11}
...
#### Pre-processing (Feature Generation) {#sec-image-classification-pre-processing-feature-generation-3fa8}
...
### Training {#sec-image-classification-training-17fb}
...
### Deployment {#sec-image-classification-deployment-44d8}
...
## Testing the Model (Inference) {#sec-image-classification-testing-model-inference-ad2b}
...
## Running inference on the SenseCraft-Web-Toolkit {#sec-image-classification-running-inference-sensecraft-web-toolkit-d7c7}
...
## Conclusion {#sec-image-classification-conclusion-f337}
