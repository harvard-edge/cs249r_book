...
## A TinyML Image Classification Project – Fruits versus Veggies {#sec-a-tinyml-image-classification-project-fruits-versus-veggies-12c6}
...
## Training the model with Edge Impulse Studio {#sec-training-the-model-with-edge-impulse-studio-dabb}
...
### Data Acquisition {#sec-data-acquisition-5fbf}
...
### Impulse Design {#sec-impulse-design-cc25}
...
#### Pre-processing (Feature Generation) {#sec-pre-processing-feature-generation-68ca}
...
#### Model Design {#sec-model-design-aa7c}
...
### Deployment {#sec-deployment-a01d}
...
## Testing the Model (Inference) {#sec-testing-the-model-inference-6c7a}
...
## Testing with a Bigger Model {#sec-testing-with-a-bigger-model-91b3}
...
## Running inference on the SenseCraft-Web-Toolkit {#sec-running-inference-on-the-sensecraft-web-toolkit-e9fd}
...
## Conclusion {#sec-conclusion-c34e}
