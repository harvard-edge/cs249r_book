...
## Overview {#sec-image-classification-overview-4755}
...
## A TinyML Image Classification Project – Fruits versus Veggies {#sec-image-classification-tinyml-image-classification-project-fruits-versus-veggies-3ded}
...
## Training the model with Edge Impulse Studio {#sec-image-classification-training-model-edge-impulse-studio-2a1c}
...
### Data Acquisition {#sec-image-classification-data-acquisition-5edf}
...
### Impulse Design {#sec-image-classification-impulse-design-b6ed}
...
#### Pre-processing (Feature Generation) {#sec-image-classification-preprocessing-feature-generation-2ff4}
...
#### Model Design {#sec-image-classification-model-design-c907}
...
### Training {#sec-image-classification-training-b73f}
...
### Deployment {#sec-image-classification-deployment-a158}
...
## Testing the Model (Inference) {#sec-image-classification-testing-model-inference-5488}
...
## Testing with a Bigger Model {#sec-image-classification-testing-bigger-model-48ae}
...
## Running inference on the SenseCraft-Web-Toolkit {#sec-image-classification-running-inference-sensecraftwebtoolkit-cba5}
...
## Conclusion {#sec-image-classification-conclusion-5b58}
...
## Resources {#sec-image-classification-resources-f6a1}
