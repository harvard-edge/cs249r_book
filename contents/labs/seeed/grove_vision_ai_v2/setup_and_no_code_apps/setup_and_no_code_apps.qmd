...
## Introduction {#sec-setup-code-applications-introduction-f302}

### Grove Vision AI Module (V2) Overview {#sec-setup-code-applications-grove-vision-ai-module-v2-overview-c1ee}
...
### Camera Installation {#sec-setup-code-applications-camera-installation-9b67}
...
## The  SenseCraft  AI Studio {#sec-setup-code-applications-sensecraft-ai-studio-8d72}
...
### The  SenseCraft  Web-Toolkit {#sec-setup-code-applications-sensecraft-web-toolkit-7a28}
...
## Exploring CV AI models {#sec-setup-code-applications-exploring-cv-ai-models-3655}

### Object Detection {#sec-setup-code-applications-object-detection-1e3e}
...
### Pose/Keypoint Detection {#sec-setup-code-applications-posekeypoint-detection-e020}
...
### Image Classification {#sec-setup-code-applications-image-classification-93e1}
...
#### Power Consumption {#sec-setup-code-applications-power-consumption-463c}
...
### Exploring Other Models on SenseCraft AI Studio {#sec-setup-code-applications-exploring-models-sensecraft-ai-studio-e471}
...
## An Image Classification Project {#sec-setup-code-applications-image-classification-project-f606}
...
### The Goal {#sec-setup-code-applications-goal-329e}
...
### Data Collection {#sec-setup-code-applications-data-collection-63eb}
...
### Training {#sec-setup-code-applications-training-e154}
...
### Test {#sec-setup-code-applications-test-9021}
...
### Deployment {#sec-setup-code-applications-deployment-e9b5}
...
### Saving the Model {#sec-setup-code-applications-saving-model-2854}
...
## Conclusion {#sec-setup-code-applications-conclusion-cd6b}
...
## Resources {#sec-setup-code-applications-resources-6270}
