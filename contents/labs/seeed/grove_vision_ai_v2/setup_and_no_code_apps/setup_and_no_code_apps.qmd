...
## Introduction {#sec-setup-nocode-applications-introduction-89d2}

### Grove Vision AI Module (V2) Overview {#sec-setup-nocode-applications-grove-vision-ai-module-v2-overview-c1ee}
...
### Camera Installation {#sec-setup-nocode-applications-camera-installation-9b67}
...
## The  SenseCraft  AI Studio {#sec-setup-nocode-applications-sensecraft-ai-studio-b3d3}
...
### The  SenseCraft  Web-Toolkit {#sec-setup-nocode-applications-sensecraft-webtoolkit-7a28}
...
## Exploring CV AI models {#sec-setup-nocode-applications-exploring-cv-ai-models-b65f}

### Object Detection {#sec-setup-nocode-applications-object-detection-1e3e}
...
### Pose/Keypoint Detection {#sec-setup-nocode-applications-posekeypoint-detection-e020}
...
### Image Classification {#sec-setup-nocode-applications-image-classification-ff3a}
...
#### Power Consumption {#sec-setup-nocode-applications-power-consumption-463c}
...
### Exploring Other Models on SenseCraft AI Studio {#sec-setup-nocode-applications-exploring-models-sensecraft-ai-studio-e471}
...
## An Image Classification Project {#sec-setup-nocode-applications-image-classification-project-9fc6}
...
### The Goal {#sec-setup-nocode-applications-goal-329e}
...
### Data Collection {#sec-setup-nocode-applications-data-collection-63eb}
...
### Training {#sec-setup-nocode-applications-training-e154}
...
### Test {#sec-setup-nocode-applications-test-9021}
...
### Deployment {#sec-setup-nocode-applications-deployment-e9b5}
...
### Saving the Model {#sec-setup-nocode-applications-saving-model-2854}
...
## Conclusion {#sec-setup-nocode-applications-conclusion-cd6b}
