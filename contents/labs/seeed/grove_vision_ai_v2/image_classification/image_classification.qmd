...
## Introduction {#sec-introduction-8c16}
...
### Project Goal {#sec-project-goal-3735}
...
### Data Collection {#sec-data-collection-9377}
...
### Collecting Data with the SenseCraft AI Studio {#sec-collecting-data-with-the-sensecraft-ai-studio-73ac}
...
#### Image Collection {#sec-image-collection-52a4}
...
### Uploading the dataset to the Edge Impulse Studio {#sec-uploading-the-dataset-to-the-edge-impulse-studio-cff0}
...
### Impulse Design and Pre-Processing {#sec-impulse-design-and-pre-processing-41b4}
...
### Pre-processing (Feature generation) {#sec-pre-processing-feature-generation-578b}
...
### Model Design, Training, and Test {#sec-model-design-training-and-test-e2c1}
...
### Model Deployment {#sec-model-deployment-c7dc}
...
### Deploy the model on the SenseCraft AI Studio {#sec-deploy-the-model-on-the-sensecraft-ai-studio-8710}
...
### Image Classification (non-official) Benchmark {#sec-image-classification-non-official-benchmark-4a0b}
...
### Postprocessing {#sec-postprocessing-568a}
...
#### Getting the Video Stream {#sec-getting-the-video-stream-5b2d}
...
#### Getting the Inference Result {#sec-getting-the-inference-result-72c4}
...
#### Postprocessing with LED {#sec-postprocessing-with-led-98b9}
...
### Optional: Post-processing on external devices {#sec-optional-post-processing-on-external-devices-019f}
...
## Conclusion {#sec-conclusion-474b}
