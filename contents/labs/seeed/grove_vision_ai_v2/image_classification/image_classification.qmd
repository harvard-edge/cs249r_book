...
## Introduction {#sec-image-classification-introduction-5fde}
...
### Project Goal {#sec-image-classification-project-goal-1129}
...
### Data Collection {#sec-image-classification-data-collection-6a45}
...
### Collecting Data with the SenseCraft AI Studio {#sec-image-classification-collecting-data-sensecraft-ai-studio-d311}
...
#### Image Collection {#sec-image-classification-image-collection-a30c}
...
### Uploading the dataset to the Edge Impulse Studio {#sec-image-classification-uploading-dataset-edge-impulse-studio-baef}
...
### Impulse Design and Pre-Processing {#sec-image-classification-impulse-design-preprocessing-d9d2}
...
### Pre-processing (Feature generation) {#sec-image-classification-preprocessing-feature-generation-3526}
...
### Model Design, Training, and Test {#sec-image-classification-model-design-training-test-4ef3}
...
### Model Deployment {#sec-image-classification-model-deployment-c8f5}
...
### Deploy the model on the SenseCraft AI Studio {#sec-image-classification-deploy-model-sensecraft-ai-studio-2ca9}
...
### Image Classification (non-official) Benchmark {#sec-image-classification-image-classification-nonofficial-benchmark-9e69}
...
### Postprocessing {#sec-image-classification-postprocessing-d946}
...
#### Getting the Video Stream {#sec-image-classification-getting-video-stream-0245}
...
#### Getting the Inference Result {#sec-image-classification-getting-inference-result-f006}
...
#### Postprocessing with LED {#sec-image-classification-postprocessing-led-b1ed}
...
### Optional: Post-processing on external devices {#sec-image-classification-optional-postprocessing-external-devices-db26}
...
## Conclusion {#sec-image-classification-conclusion-9d2c}
...
## Resources {#sec-image-classification-resources-bdff}
