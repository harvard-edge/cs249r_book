...
## Introduction {#sec-image-classification-introduction-389b}
...
### Data Collection {#sec-image-classification-data-collection-309b}
...
### Collecting Data with the SenseCraft AI Studio {#sec-image-classification-collecting-data-sensecraft-ai-studio-cdad}
...
### Impulse Design and Pre-Processing {#sec-image-classification-impulse-design-preprocessing-3584}
...
### Image Classification (non-official) Benchmark {#sec-image-classification-image-classification-nonofficial-benchmark-8924}
...
### Postprocessing {#sec-image-classification-postprocessing-cf9b}
...
### Optional: Post-processing on external devices {#sec-image-classification-optional-postprocessing-external-devices-9916}
