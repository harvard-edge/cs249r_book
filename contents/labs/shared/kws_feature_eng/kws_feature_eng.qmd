...
## Overview {#sec-kws-feature-engineering-overview-9be4}
...
## The KWS {#sec-kws-feature-engineering-kws-84f5}
...
### Applications of KWS {#sec-kws-feature-engineering-applications-kws-5cd7}
...
### Differences from General Speech Recognition {#sec-kws-feature-engineering-differences-general-speech-recognition-3527}
...
## Overview to Audio Signals {#sec-kws-feature-engineering-overview-audio-signals-2c7d}
...
### Why Not Raw Audio? {#sec-kws-feature-engineering-raw-audio-88ba}
...
## Overview to MFCCs {#sec-kws-feature-engineering-overview-mfccs-244f}

### What are MFCCs? {#sec-kws-feature-engineering-mfccs-f791}
...
### Why are MFCCs important? {#sec-kws-feature-engineering-mfccs-important-a618}
...
### Computing MFCCs {#sec-kws-feature-engineering-computing-mfccs-cb14}
...
## Hands-On using Python {#sec-kws-feature-engineering-handson-using-python-d0d9}
...
## Conclusion {#sec-kws-feature-engineering-conclusion-4ca0}
...
### MFCCs are particularly strong for {#sec-kws-feature-engineering-mfccs-particularly-strong-d61a}
...
### Spectrograms or MFEs are often more suitable for {#sec-kws-feature-engineering-spectrograms-mfes-often-suitable-b418}
...
## Resources {#sec-kws-feature-engineering-resources-257e}
