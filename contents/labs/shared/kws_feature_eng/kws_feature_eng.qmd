...
### Applications of KWS {#sec-applications-of-kws-d881}
...
### Differences from General Speech Recognition {#sec-differences-from-general-speech-recognition-d0f0}
...
## Overview to Audio Signals {#sec-overview-to-audio-signals-0a7e}
...
### Why Not Raw Audio? {#sec-why-not-raw-audio-e0cc}
...
## Overview to MFCCs {#sec-overview-to-mfccs-840d}

### What are MFCCs? {#sec-what-are-mfccs-71fe}
...
### Why are MFCCs important? {#sec-why-are-mfccs-important-8794}
...
### Computing MFCCs {#sec-computing-mfccs-5151}
...
## Hands-On using Python {#sec-hands-on-using-python-1cb7}
...
## Conclusion {#sec-conclusion-5c58}
...
### MFCCs are particularly strong for {#sec-mfccs-are-particularly-strong-for-2c39}
...
### Spectrograms or MFEs are often more suitable for {#sec-spectrograms-or-mfes-are-often-more-suitable-for-5d8a}
