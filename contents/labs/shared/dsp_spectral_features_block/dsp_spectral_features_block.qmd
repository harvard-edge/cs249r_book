...
## Extracting Features Review {#sec-extracting-features-review-db01}
...
## A TinyML Motion Classification project {#sec-a-tinyml-motion-classification-project-0c19}
...
## Data Pre-Processing {#sec-data-pre-processing-deb1}
...
### Edge Impulse - Spectral Analysis Block V.2 under the hood {#sec-edge-impulse-spectral-analysis-block-v-2-under-the-hood-2cd5}
...
## Time Domain Statistical features {#sec-time-domain-statistical-features-bfbb}
...
## Spectral features {#sec-spectral-features-e5ae}
...
## Time-frequency domain {#sec-time-frequency-domain-e51c}

### Wavelets {#sec-wavelets-0a35}
...
### Wavelet Analysis {#sec-wavelet-analysis-1df7}
...
### Feature Extraction {#sec-feature-extraction-f8d8}
...
## Conclusion {#sec-conclusion-248d}
