...
## A TinyML Motion Classification project {#sec-dsp-spectral-features-tinyml-motion-classification-project-ccfa}
...
## Data Pre-Processing {#sec-dsp-spectral-features-data-pre-processing-8898}
...
### Edge Impulse - Spectral Analysis Block V.2 under the hood {#sec-dsp-spectral-features-edge-impulse-spectral-analysis-block-v2-hood-a454}
...
## Time Domain Statistical features {#sec-dsp-spectral-features-time-domain-statistical-features-0b3a}
...
## Spectral features {#sec-dsp-spectral-features-spectral-features-4e4a}
...
## Time-frequency domain {#sec-dsp-spectral-features-time-frequency-domain-9fa1}

### Wavelets {#sec-dsp-spectral-features-wavelets-03dd}
...
### Wavelet Analysis {#sec-dsp-spectral-features-wavelet-analysis-8785}
...
### Feature Extraction {#sec-dsp-spectral-features-feature-extraction-019c}
...
## Conclusion {#sec-dsp-spectral-features-conclusion-c34e}
