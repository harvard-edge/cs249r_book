...
## Data Collection {#sec-image-classification-data-collection-c387}
...
## The Impulse Design {#sec-image-classification-impulse-design-64eb}
...
### Image Pre-Processing {#sec-image-classification-image-preprocessing-1b67}
...
## Deploying the model {#sec-image-classification-deploying-model-5dca}
...
### OpenMV {#sec-image-classification-openmv-2bfd}
...
#### Post-Processing with LEDs {#sec-image-classification-postprocessing-leds-59c9}
...
## Image Classification (non-official) Benchmark {#sec-image-classification-image-classification-nonofficial-benchmark-6317}
