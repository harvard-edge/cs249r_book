...
## Computer Vision {#sec-computer-vision-01fe}
...
## Image Classification Project Goal {#sec-image-classification-project-goal-7315}
...
## Data Collection {#sec-data-collection-a365}
...
### Collecting Dataset with OpenMV IDE {#sec-collecting-dataset-with-openmv-ide-7677}
...
## Training the model with Edge Impulse Studio {#sec-training-the-model-with-edge-impulse-studio-af17}
...
## The Impulse Design {#sec-the-impulse-design-b795}
...
### Image Pre-Processing {#sec-image-pre-processing-a804}
...
### Model Design {#sec-model-design-1595}
...
## Model Training {#sec-model-training-790f}
...
## Model Testing {#sec-model-testing-bf50}
...
## Deploying the model {#sec-deploying-the-model-0f20}
...
### Arduino Library {#sec-arduino-library-94a6}
...
#### Changing the Code to add labels {#sec-changing-the-code-to-add-labels-04ad}
...
#### Post-Processing with LEDs {#sec-post-processing-with-leds-4b9f}
...
## Image Classification (non-official) Benchmark {#sec-image-classification-non-official-benchmark-ded6}
...
## Conclusion {#sec-conclusion-2f2b}
