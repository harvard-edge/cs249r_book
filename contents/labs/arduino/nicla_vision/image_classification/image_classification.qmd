...
## Overview {#sec-image-classification-overview-ccad}
...
## Computer Vision {#sec-image-classification-computer-vision-40c8}
...
## Image Classification Project Goal {#sec-image-classification-image-classification-project-goal-016d}
...
## Data Collection {#sec-image-classification-data-collection-7a46}
...
### Collecting Dataset with OpenMV IDE {#sec-image-classification-collecting-dataset-openmv-ide-67e8}
...
## Training the model with Edge Impulse Studio {#sec-image-classification-training-model-edge-impulse-studio-41b1}
...
## Dataset {#sec-image-classification-dataset-e6f4}
...
## The Impulse Design {#sec-image-classification-impulse-design-2be8}
...
### Image Pre-Processing {#sec-image-classification-image-preprocessing-e82c}
...
### Model Design {#sec-image-classification-model-design-b97b}
...
## Model Training {#sec-image-classification-model-training-e064}
...
## Model Testing {#sec-image-classification-model-testing-098b}
...
## Deploying the model {#sec-image-classification-deploying-model-d67e}
...
### Arduino Library {#sec-image-classification-arduino-library-c84d}
...
### OpenMV {#sec-image-classification-openmv-dd1d}
...
#### Changing the Code to add labels {#sec-image-classification-changing-code-add-labels-b3d0}
...
#### Post-Processing with LEDs {#sec-image-classification-postprocessing-leds-7462}
...
## Image Classification (non-official) Benchmark {#sec-image-classification-image-classification-nonofficial-benchmark-955a}
...
## Conclusion {#sec-image-classification-conclusion-6dff}
...
## Resources {#sec-image-classification-resources-399e}
