...
\noindent
![](images/jpg/image2.jpg){width="60%" fig-align="center"}
...
\noindent
![](images/jpg/image36.jpg){width="70%" fig-align="center"}
...
\noindent
![](images/png/image29.png){width="70%" fig-align="center"}
...
\noindent
![](images/png/image20.png){width="80%" fig-align="center"}
...
\noindent
![](images/png/image45.png){width="75%" fig-align="center"}
...
\noindent
![](images/jpg/image41.jpg){width="75%" fig-align="center"}
...
\noindent
![](images/jpg/image7.jpg){width="65%" fig-align="center"}
...
\noindent
![](images/png/image39.png){width="75%" fig-align="center"}
...
\noindent
![](images/png/image30.png){width="75%" fig-align="center"}

Repeat the procedure for all three classes. At the end, you should see your "raw data" in the Studio:

\noindent
![](images/png/image11.png){width="75%" fig-align="center"}
...
\noindent
![](images/png/image44.png){width="75%" fig-align="center"}
...
\noindent
![](images/jpg/image23.jpg){width="70%" fig-align="center"}
...
\noindent
![](images/jpg/image9.jpg){width="80%" fig-align="center"}
...
\noindent
![](images/jpg/image32.jpg){width="80%" fig-align="center"}
...
\noindent
![](images/png/image16.png){width="80%" fig-align="center"}
...
\noindent
![](images/png/image5.png){width="75%" fig-align="center"}
...
\noindent
![](images/png/image24.png){width="80%" fig-align="center"}
...
\noindent
![](images/jpg/image31.jpg){width="80%" fig-align="center"}

The result is excellent, with 77 ms of latency, which should result in 13fps (frames per second) during inference.

## Model Testing

\noindent
![](images/jpg/image10.jpg){width="70%" fig-align="center"}

Now, you should take the data set aside at the start of the project and run the trained model using it as input:

\noindent
![](images/png/image34.png){width="80%" fig-align="center"}

The result is, again, excellent.

\noindent
![](images/png/image12.png){width="80%" fig-align="center"}
...
\noindent
![](images/jpg/image28.jpg){width="70%" fig-align="center"}
...
\noindent
![](images/png/image48.png){width="80%" fig-align="center"}
...
\noindent
![](images/jpg/image25.jpg){width="80%" fig-align="center"}
...
\noindent
![](images/png/image37.png){width="80%" fig-align="center"}
...
sensor.reset()                         # Reset and initialize
                                       # the sensor.
sensor.set_pixformat(sensor.RGB565)    # Set pxl fmt to RGB565
                                       # (or GRAYSCALE)
...
while(True):
  ...
  for obj in net.classify(img,
      ...
      # This combines the labels and confidence values into
      # a list of tuples
...
\noindent
![](images/jpg/image47.jpg){width="80%" fig-align="center"}
...
\noindent
![](images/jpg/image13.jpg){width="80%" fig-align="center"}

The latency will drop to only 71 ms.

\noindent
![](images/jpg/image1.jpg){width="50%" fig-align="center"}
...
sensor.reset()                         # Reset and initialize
                                       # the sensor.
sensor.set_pixformat(sensor.RGB565)    # Set pixl fmt to RGB565
                                       # (or GRAYSCALE)
sensor.set_framesize(sensor.QVGA)      # Set frame size to QVGA
                                       # (320x240)
sensor.set_windowing((240, 240))       # Set 240x240 window.
...
\noindent
![](images/jpg/image18.jpg){width="80%" fig-align="center"}

In more detail

\noindent
![](images/jpg/image21.jpg){width="80%" fig-align="center"}
