...
## Learning Objectives {#sec-learning-objectives-7747}
...
## IMU Installation and testing {#sec-imu-installation-and-testing-6a63}
...
### Defining the Sampling frequency: {#sec-defining-the-sampling-frequency-293a}
...
## The Case Study: Simulated Container Transportation {#sec-the-case-study-simulated-container-transportation-c6f0}
...
## Data Collection {#sec-data-collection-d16a}
...
### Connecting the device to Edge Impulse {#sec-connecting-the-device-to-edge-impulse-1bcc}
...
### Data Collection {#sec-data-collection-ca88}
...
## Impulse Design {#sec-impulse-design-ba9d}
...
### Data Pre-Processing Overview {#sec-data-pre-processing-overview-c270}
...
### EI Studio Spectral Features {#sec-ei-studio-spectral-features-14f4}
...
### Generating features {#sec-generating-features-3115}
...
## Models Training {#sec-models-training-5f42}
...
### Post-processing {#sec-post-processing-a156}
...
## Conclusion {#sec-conclusion-f856}
...
### Case Applications {#sec-case-applications-3be6}

#### Industrial and Manufacturing {#sec-industrial-and-manufacturing-b363}
...
#### Healthcare {#sec-healthcare-0e36}
...
#### Consumer Electronics {#sec-consumer-electronics-74db}
...
#### Transportation and Logistics {#sec-transportation-and-logistics-4c29}
...
#### Smart Cities and Infrastructure {#sec-smart-cities-and-infrastructure-3bc7}
...
#### Security and Surveillance {#sec-security-and-surveillance-8691}
...
#### Agriculture {#sec-agriculture-802e}
...
#### Environmental Monitoring {#sec-environmental-monitoring-8d10}
...
### Nicla 3D case {#sec-nicla-3d-case-cdcc}
