...
## IMU Installation and testing {#sec-motion-classification-anomaly-detection-imu-installation-testing-4b16}
...
### Defining the Sampling frequency: {#sec-motion-classification-anomaly-detection-defining-sampling-frequency-5c6e}
...
## The Case Study: Simulated Container Transportation {#sec-motion-classification-anomaly-detection-case-study-simulated-container-transportation-e854}
...
### Connecting the device to Edge Impulse {#sec-motion-classification-anomaly-detection-connecting-device-edge-impulse-16ef}
...
### Data Collection {#sec-motion-classification-anomaly-detection-data-collection-5672}
...
## Impulse Design {#sec-motion-classification-anomaly-detection-impulse-design-166b}
...
### Data Pre-Processing Overview {#sec-motion-classification-anomaly-detection-data-pre-processing-overview-f204}
...
### Generating features {#sec-motion-classification-anomaly-detection-generating-features-dbdd}
...
## Models Training {#sec-motion-classification-anomaly-detection-models-training-ceda}
...
## Deploy {#sec-motion-classification-anomaly-detection-deploy-4f79}
...
### Inference {#sec-motion-classification-anomaly-detection-inference-a89f}
...
### Post-processing {#sec-motion-classification-anomaly-detection-post-processing-8663}
...
## Conclusion {#sec-motion-classification-anomaly-detection-conclusion-749a}
...
### Case Applications {#sec-motion-classification-anomaly-detection-case-applications-2ef8}
