...
## Overview {#sec-motion-classification-anomaly-detection-overview-d381}
...
## Learning Objectives {#sec-motion-classification-anomaly-detection-learning-objectives-9c10}
...
## IMU Installation and testing {#sec-motion-classification-anomaly-detection-imu-installation-testing-cbf6}
...
### Defining the Sampling frequency: {#sec-motion-classification-anomaly-detection-defining-sampling-frequency-f911}
...
## The Case Study: Simulated Container Transportation {#sec-motion-classification-anomaly-detection-case-study-simulated-container-transportation-92af}
...
## Data Collection {#sec-motion-classification-anomaly-detection-data-collection-0210}
...
### Connecting the device to Edge Impulse {#sec-motion-classification-anomaly-detection-connecting-device-edge-impulse-64be}
...
### Data Collection {#sec-motion-classification-anomaly-detection-data-collection-5970}
...
## Impulse Design {#sec-motion-classification-anomaly-detection-impulse-design-1736}
...
### Data Pre-Processing Overview {#sec-motion-classification-anomaly-detection-data-preprocessing-overview-5c10}
...
### EI Studio Spectral Features {#sec-motion-classification-anomaly-detection-ei-studio-spectral-features-2ec5}
...
### Generating features {#sec-motion-classification-anomaly-detection-generating-features-9bb1}
...
## Models Training {#sec-motion-classification-anomaly-detection-models-training-a19d}
...
## Testing {#sec-motion-classification-anomaly-detection-testing-6589}
...
## Deploy {#sec-motion-classification-anomaly-detection-deploy-a092}
...
### Inference {#sec-motion-classification-anomaly-detection-inference-4047}
...
### Post-processing {#sec-motion-classification-anomaly-detection-postprocessing-9f49}
...
## Conclusion {#sec-motion-classification-anomaly-detection-conclusion-2651}
...
### Case Applications {#sec-motion-classification-anomaly-detection-case-applications-2777}

#### Industrial and Manufacturing {#sec-motion-classification-anomaly-detection-industrial-manufacturing-bec9}
...
#### Healthcare {#sec-motion-classification-anomaly-detection-healthcare-fce0}
...
#### Consumer Electronics {#sec-motion-classification-anomaly-detection-consumer-electronics-2ce7}
...
#### Transportation and Logistics {#sec-motion-classification-anomaly-detection-transportation-logistics-4b29}
...
#### Smart Cities and Infrastructure {#sec-motion-classification-anomaly-detection-smart-cities-infrastructure-c533}
...
#### Security and Surveillance {#sec-motion-classification-anomaly-detection-security-surveillance-7237}
...
#### Agriculture {#sec-motion-classification-anomaly-detection-agriculture-5d5c}
...
#### Environmental Monitoring {#sec-motion-classification-anomaly-detection-environmental-monitoring-e3fa}
...
### Nicla 3D case {#sec-motion-classification-anomaly-detection-nicla-3d-case-a75c}
...
## Resources {#sec-motion-classification-anomaly-detection-resources-55cd}
