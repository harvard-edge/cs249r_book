...
> Before connecting the Nicla to the OpenMV IDE, ensure you have the latest bootloader version. To that, go to your Arduino IDE, select the Nicla board and open the sketch on:
>
> **Examples >** **STM_32H747_System > STM_32H747_updateBootloader**
>
> And follow the instruction on the Serial Monitor

Now, go to the [OpenMV IDE page](https://openmv.io/pages/download), download the correct version for your Operating System, and follow the instructions for its installation on your computer.
