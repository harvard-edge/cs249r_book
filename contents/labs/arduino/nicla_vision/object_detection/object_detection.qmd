...
### Object Detection versus Image Classification {#sec-object-detection-versus-image-classification-8a14}
...
### An innovative solution for Object Detection: FOMO {#sec-an-innovative-solution-for-object-detection-fomo-40e4}
...
## The Object Detection Project Goal {#sec-the-object-detection-project-goal-7eff}
...
## Data Collection {#sec-data-collection-d3c1}
...
### Collecting Dataset with OpenMV IDE {#sec-collecting-dataset-with-openmv-ide-5eae}
...
## Edge Impulse Studio {#sec-edge-impulse-studio-52a2}

### Setup the project {#sec-setup-the-project-319d}
...
### Uploading the unlabeled data {#sec-uploading-the-unlabeled-data-fa1e}
...
### Labeling the Dataset {#sec-labeling-the-dataset-b667}
...
## The Impulse Design {#sec-the-impulse-design-3136}
...
### Preprocessing all dataset {#sec-preprocessing-all-dataset-c267}
...
## Model Design, Training, and Test {#sec-model-design-training-and-test-abbf}
...
### How FOMO works? {#sec-how-fomo-works-be52}
...
### Test model with "Live Classification" {#sec-test-model-with-live-classification-75b8}
...
## Deploying the Model {#sec-deploying-the-model-0cbb}
...
## Conclusion {#sec-conclusion-217e}
