...
## Overview {#sec-object-detection-overview-0ca3}
...
### Object Detection versus Image Classification {#sec-object-detection-object-detection-versus-image-classification-0e07}
...
### An innovative solution for Object Detection: FOMO {#sec-object-detection-innovative-solution-object-detection-fomo-d4fc}
...
## The Object Detection Project Goal {#sec-object-detection-object-detection-project-goal-7401}
...
## Data Collection {#sec-object-detection-data-collection-ced6}
...
### Collecting Dataset with OpenMV IDE {#sec-object-detection-collecting-dataset-openmv-ide-99cf}
...
## Edge Impulse Studio {#sec-object-detection-edge-impulse-studio-6342}

### Setup the project {#sec-object-detection-setup-project-802f}
...
### Uploading the unlabeled data {#sec-object-detection-uploading-unlabeled-data-a260}
...
### Labeling the Dataset {#sec-object-detection-labeling-dataset-bc10}
...
## The Impulse Design {#sec-object-detection-impulse-design-0cd9}
...
### Preprocessing all dataset {#sec-object-detection-preprocessing-dataset-93ba}
...
## Model Design, Training, and Test {#sec-object-detection-model-design-training-test-93b3}
...
### How FOMO works? {#sec-object-detection-fomo-works-b49e}
...
### Test model with "Live Classification" {#sec-object-detection-test-model-live-classification-066b}
...
## Deploying the Model {#sec-object-detection-deploying-model-d844}
...
## Conclusion {#sec-object-detection-conclusion-2dda}
...
## Resources {#sec-object-detection-resources-cf34}
