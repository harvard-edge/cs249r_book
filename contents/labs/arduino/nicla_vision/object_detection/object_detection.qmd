...
## Overview {#sec-object-detection-overview-e9dd}
...
### Object Detection versus Image Classification {#sec-object-detection-object-detection-versus-image-classification-3146}
...
## The Object Detection Project Goal {#sec-object-detection-object-detection-project-goal-5e19}
...
## Data Collection {#sec-object-detection-data-collection-5f48}
...
### Collecting Dataset with OpenMV IDE {#sec-object-detection-collecting-dataset-openmv-ide-355d}
...
## Edge Impulse Studio {#sec-object-detection-edge-impulse-studio-6755}

### Setup the project {#sec-object-detection-setup-project-4ce9}
...
### Uploading the unlabeled data {#sec-object-detection-uploading-unlabeled-data-4d37}
...
## The Impulse Design {#sec-object-detection-impulse-design-d773}
...
## Model Design, Training, and Test {#sec-object-detection-model-design-training-test-9cd8}
...
### How FOMO works? {#sec-object-detection-fomo-works-1807}
...
### Test model with "Live Classification" {#sec-object-detection-test-model-live-classification-6587}
...
## Deploying the Model {#sec-object-detection-deploying-model-d40e}
...
## Conclusion {#sec-object-detection-conclusion-9be3}
