...
## The KWS Hands-On Project {#sec-keyword-spotting-kws-kws-handson-project-48d1}
...
## Dataset {#sec-keyword-spotting-kws-dataset-87dc}
...
### Capturing additional Audio Data {#sec-keyword-spotting-kws-capturing-additional-audio-data-5387}
...
## Creating Impulse (Pre-Process / Model definition) {#sec-keyword-spotting-kws-creating-impulse-preprocess-model-definition-17c3}

*An* **impulse** *takes raw data, uses signal processing to extract features, and then uses a learning block to classify new data.*

### Impulse Design {#sec-keyword-spotting-kws-impulse-design-ac0e}
...
### Pre-Processing (MFCC) {#sec-keyword-spotting-kws-preprocessing-mfcc-b7d0}
...
## Model Design and Training {#sec-keyword-spotting-kws-model-design-training-a175}
...
## Testing {#sec-keyword-spotting-kws-testing-90ea}
...
## Post-processing {#sec-keyword-spotting-kws-postprocessing-a71a}
