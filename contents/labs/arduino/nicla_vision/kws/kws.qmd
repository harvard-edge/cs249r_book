...
## How does a voice assistant work? {#sec-keyword-spotting-kws-voice-assistant-work-3167}
...
## The KWS Hands-On Project {#sec-keyword-spotting-kws-kws-hands-project-d57e}
...
### The Machine Learning workflow {#sec-keyword-spotting-kws-machine-learning-workflow-27c9}
...
## Dataset {#sec-keyword-spotting-kws-dataset-7dd8}
...
### Uploading the dataset to the Edge Impulse Studio {#sec-keyword-spotting-kws-uploading-dataset-edge-impulse-studio-fb0c}
...
### Capturing additional Audio Data {#sec-keyword-spotting-kws-capturing-additional-audio-data-6dd6}
...
#### Using the NiclaV and the Edge Impulse Studio {#sec-keyword-spotting-kws-using-niclav-edge-impulse-studio-1c62}
...
#### Using a smartphone and the EI Studio {#sec-keyword-spotting-kws-using-smartphone-ei-studio-5af0}
...
## Creating Impulse (Pre-Process / Model definition) {#sec-keyword-spotting-kws-creating-impulse-pre-process-model-definition-462a}

*An* **impulse** *takes raw data, uses signal processing to extract features, and then uses a learning block to classify new data.*

### Impulse Design {#sec-keyword-spotting-kws-impulse-design-830d}
...
### Pre-Processing (MFCC) {#sec-keyword-spotting-kws-pre-processing-mfcc-f65a}
...
### Going under the hood {#sec-keyword-spotting-kws-going-hood-9b9c}
...
## Model Design and Training {#sec-keyword-spotting-kws-model-design-training-558f}
...
## Testing {#sec-keyword-spotting-kws-testing-1eec}
...
## Deploy and Inference {#sec-keyword-spotting-kws-deploy-inference-60f6}
...
## Post-processing {#sec-keyword-spotting-kws-post-processing-a71a}
...
## Conclusion {#sec-keyword-spotting-kws-conclusion-7250}
