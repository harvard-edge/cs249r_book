...
## The KWS Hands-On Project {#sec-keyword-spotting-kws-kws-hands-project-1774}
...
## Dataset {#sec-keyword-spotting-kws-dataset-d019}
...
### Capturing additional Audio Data {#sec-keyword-spotting-kws-capturing-additional-audio-data-7b86}
...
## Creating Impulse (Pre-Process / Model definition) {#sec-keyword-spotting-kws-creating-impulse-pre-process-model-definition-757d}
...
## Model Design and Training {#sec-keyword-spotting-kws-model-design-training-24dd}
...
## Testing {#sec-keyword-spotting-kws-testing-f745}
