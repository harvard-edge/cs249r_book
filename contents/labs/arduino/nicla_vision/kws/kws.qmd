...
## How does a voice assistant work? {#sec-how-does-a-voice-assistant-work-a385}
...
## The KWS Hands-On Project {#sec-the-kws-hands-on-project-67df}
...
### The Machine Learning workflow {#sec-the-machine-learning-workflow-874d}
...
### Uploading the dataset to the Edge Impulse Studio {#sec-uploading-the-dataset-to-the-edge-impulse-studio-bc31}
...
### Capturing additional Audio Data {#sec-capturing-additional-audio-data-2151}
...
#### Using the NiclaV and the Edge Impulse Studio {#sec-using-the-niclav-and-the-edge-impulse-studio-6fb5}
...
#### Using a smartphone and the EI Studio {#sec-using-a-smartphone-and-the-ei-studio-9f79}
...
## Creating Impulse (Pre-Process / Model definition) {#sec-creating-impulse-pre-process-model-definition-e172}

*An* **impulse** *takes raw data, uses signal processing to extract features, and then uses a learning block to classify new data.*

### Impulse Design {#sec-impulse-design-beb6}
...
### Pre-Processing (MFCC) {#sec-pre-processing-mfcc-7865}
...
### Going under the hood {#sec-going-under-the-hood-3185}
...
## Model Design and Training {#sec-model-design-and-training-4c8f}
...
### Going under the hood {#sec-going-under-the-hood-cb10}
...
### Live Classification {#sec-live-classification-4f9c}
...
## Deploy and Inference {#sec-deploy-and-inference-7701}
...
## Post-processing {#sec-post-processing-34f8}
...
## Conclusion {#sec-conclusion-ea81}
