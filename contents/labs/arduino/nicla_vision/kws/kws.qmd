...
## Overview {#sec-keyword-spotting-kws-overview-f1a8}
...
## How does a voice assistant work? {#sec-keyword-spotting-kws-voice-assistant-work-a862}
...
## The KWS Hands-On Project {#sec-keyword-spotting-kws-kws-handson-project-66f6}
...
### The Machine Learning workflow {#sec-keyword-spotting-kws-machine-learning-workflow-47f1}
...
## Dataset {#sec-keyword-spotting-kws-dataset-b3fc}
...
### Uploading the dataset to the Edge Impulse Studio {#sec-keyword-spotting-kws-uploading-dataset-edge-impulse-studio-dee0}
...
### Capturing additional Audio Data {#sec-keyword-spotting-kws-capturing-additional-audio-data-b9c7}
...
#### Using the NiclaV and the Edge Impulse Studio {#sec-keyword-spotting-kws-using-niclav-edge-impulse-studio-45dc}
...
#### Using a smartphone and the EI Studio {#sec-keyword-spotting-kws-using-smartphone-ei-studio-1300}
...
## Creating Impulse (Pre-Process / Model definition) {#sec-keyword-spotting-kws-creating-impulse-preprocess-model-definition-70ec}

*An* **impulse** *takes raw data, uses signal processing to extract features, and then uses a learning block to classify new data.*

### Impulse Design {#sec-keyword-spotting-kws-impulse-design-8128}
...
### Pre-Processing (MFCC) {#sec-keyword-spotting-kws-preprocessing-mfcc-2834}
...
### Going under the hood {#sec-keyword-spotting-kws-going-hood-0b07}
...
## Model Design and Training {#sec-keyword-spotting-kws-model-design-training-3e54}
...
### Going under the hood {#sec-keyword-spotting-kws-going-hood-b006}
...
## Testing {#sec-keyword-spotting-kws-testing-fa45}
...
### Live Classification {#sec-keyword-spotting-kws-live-classification-58ba}
...
## Deploy and Inference {#sec-keyword-spotting-kws-deploy-inference-f1b8}
...
## Post-processing {#sec-keyword-spotting-kws-postprocessing-ad79}
...
## Conclusion {#sec-keyword-spotting-kws-conclusion-78ed}
...
## Resources {#sec-keyword-spotting-kws-resources-374d}
