...
## Setting Up the Environment {#sec-image-classification-setting-environment-11d9}

### Updating the Raspberry Pi {#sec-image-classification-updating-raspberry-pi-7862}
...
### Installing Required Libraries {#sec-image-classification-installing-required-libraries-fbd0}
...
### Setting up a Virtual Environment (Optional but Recommended) {#sec-image-classification-setting-virtual-environment-optional-recommended-2567}
...
### Installing TensorFlow Lite {#sec-image-classification-installing-tensorflow-lite-02e1}
...
### Installing Additional Python Libraries {#sec-image-classification-installing-additional-python-libraries-2fdf}
...
### Creating a working directory: {#sec-image-classification-creating-working-directory-8cbe}
...
### Setting up Jupyter Notebook (Optional) {#sec-image-classification-setting-jupyter-notebook-optional-80ca}
...
### Verifying the Setup {#sec-image-classification-verifying-setup-861e}
...
## Making inferences with Mobilenet V2 {#sec-image-classification-making-inferences-mobilenet-v2-906f}
...
### Define a general Image Classification function {#sec-image-classification-define-general-image-classification-function-1ca0}
...
### Installing Picamera2 {#sec-image-classification-installing-picamera2-1b29}
...
## Image Classification Project {#sec-image-classification-image-classification-project-d575}
...
### The Goal {#sec-image-classification-goal-d333}
...
### Data Collection {#sec-image-classification-data-collection-5cf0}
...
#### Usage Flow: {#sec-image-classification-usage-flow-522f}
...
## Training the model with Edge Impulse Studio {#sec-image-classification-training-model-edge-impulse-studio-671f}
...
### Dataset {#sec-image-classification-dataset-bc03}
...
## The Impulse Design {#sec-image-classification-impulse-design-cfb1}
...
### Image Pre-Processing {#sec-image-classification-image-preprocessing-d237}
...
### Model Training {#sec-image-classification-model-training-0aba}
...
### Deploying the model {#sec-image-classification-deploying-model-4db1}
...
## Live Image Classification {#sec-image-classification-live-image-classification-f123}
