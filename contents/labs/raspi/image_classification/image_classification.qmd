...
### Applications in Real-World Scenarios {#sec-applications-in-real-world-scenarios-a0ac}
...
### Advantages of Running Classification on Edge Devices like Raspberry Pi {#sec-advantages-of-running-classification-on-edge-devices-like-raspberry-pi-3ac4}
...
## Setting Up the Environment {#sec-setting-up-the-environment-cdfd}

### Updating the Raspberry Pi {#sec-updating-the-raspberry-pi-fb34}
...
### Installing Required Libraries {#sec-installing-required-libraries-033b}
...
### Setting up a Virtual Environment (Optional but Recommended) {#sec-setting-up-a-virtual-environment-optional-but-recommended-c360}
...
### Installing TensorFlow Lite {#sec-installing-tensorflow-lite-13da}
...
### Installing Additional Python Libraries {#sec-installing-additional-python-libraries-a76a}
...
### Creating a working directory: {#sec-creating-a-working-directory-e358}
...
### Setting up Jupyter Notebook (Optional) {#sec-setting-up-jupyter-notebook-optional-9d7d}
...
### Verifying the Setup {#sec-verifying-the-setup-49d1}
...
## Making inferences with Mobilenet V2 {#sec-making-inferences-with-mobilenet-v2-dc86}
...
### Define a general Image Classification function {#sec-define-a-general-image-classification-function-e5c2}
...
### Testing with a model trained from scratch {#sec-testing-with-a-model-trained-from-scratch-9b93}
...
### Installing Picamera2 {#sec-installing-picamera2-4314}
...
## Image Classification Project {#sec-image-classification-project-4986}
...
### Data Collection {#sec-data-collection-473f}
...
#### Key Features: {#sec-key-features-9352}
...
#### Main Components: {#sec-main-components-81e8}
...
#### Key Functions: {#sec-key-functions-5f2d}
...
#### Usage Flow: {#sec-usage-flow-3808}
...
#### Technical Notes: {#sec-technical-notes-43dc}
...
#### Customization Possibilities: {#sec-customization-possibilities-f381}
...
#### Number of samples on Dataset: {#sec-number-of-samples-on-dataset-131f}
...
## Training the model with Edge Impulse Studio {#sec-training-the-model-with-edge-impulse-studio-1f05}
...
## The Impulse Design {#sec-the-impulse-design-9a89}
...
### Image Pre-Processing {#sec-image-pre-processing-edfc}
...
### Model Design {#sec-model-design-2445}
...
### Model Training {#sec-model-training-38b8}
...
### Trading off: Accuracy versus speed {#sec-trading-off-accuracy-versus-speed-5c74}
...
### Model Testing {#sec-model-testing-fdad}
...
### Deploying the model {#sec-deploying-the-model-57c7}
...
## Live Image Classification {#sec-live-image-classification-3c17}
...
#### Key Components: {#sec-key-components-4819}
...
#### Main Features: {#sec-main-features-6602}
...
#### Code Structure: {#sec-code-structure-b5b7}
...
#### Key Concepts: {#sec-key-concepts-b8d0}
...
## Conclusion: {#sec-conclusion-5928}
