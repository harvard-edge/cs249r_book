...
## Overview {#sec-image-classification-overview-eccb}
...
### Applications in Real-World Scenarios {#sec-image-classification-applications-real-world-scenarios-914f}
...
### Advantages of Running Classification on Edge Devices like Raspberry Pi {#sec-image-classification-advantages-running-classification-edge-devices-like-raspberry-pi-4880}
...
## Setting Up the Environment {#sec-image-classification-setting-environment-5016}

### Updating the Raspberry Pi {#sec-image-classification-updating-raspberry-pi-908c}
...
### Installing Required Libraries {#sec-image-classification-installing-required-libraries-fd75}
...
### Setting up a Virtual Environment (Optional but Recommended) {#sec-image-classification-setting-virtual-environment-optional-recommended-a910}
...
### Installing TensorFlow Lite {#sec-image-classification-installing-tensorflow-lite-c775}
...
### Installing Additional Python Libraries {#sec-image-classification-installing-additional-python-libraries-bf19}
...
### Creating a working directory: {#sec-image-classification-creating-working-directory-a8a0}
...
### Setting up Jupyter Notebook (Optional) {#sec-image-classification-setting-jupyter-notebook-optional-3ba4}
...
### Verifying the Setup {#sec-image-classification-verifying-setup-e45d}
...
## Making inferences with Mobilenet V2 {#sec-image-classification-making-inferences-mobilenet-v2-88d8}
...
### Define a general Image Classification function {#sec-image-classification-define-general-image-classification-function-f189}
...
### Testing with a model trained from scratch {#sec-image-classification-testing-model-trained-scratch-c2f7}
...
### Installing Picamera2 {#sec-image-classification-installing-picamera2-22ba}
...
## Image Classification Project {#sec-image-classification-image-classification-project-782b}
...
### The Goal {#sec-image-classification-goal-a5c7}
...
### Data Collection {#sec-image-classification-data-collection-e068}
...
#### Key Features: {#sec-image-classification-key-features-5fcb}
...
#### Main Components: {#sec-image-classification-main-components-4971}
...
#### Key Functions: {#sec-image-classification-key-functions-e434}
...
#### Usage Flow: {#sec-image-classification-usage-flow-1400}
...
#### Technical Notes: {#sec-image-classification-technical-notes-47e3}
...
#### Customization Possibilities: {#sec-image-classification-customization-possibilities-edd9}
...
#### Number of samples on Dataset: {#sec-image-classification-number-samples-dataset-496d}
...
## Training the model with Edge Impulse Studio {#sec-image-classification-training-model-edge-impulse-studio-6d31}
...
### Dataset {#sec-image-classification-dataset-5b8e}
...
## The Impulse Design {#sec-image-classification-impulse-design-3137}
...
### Image Pre-Processing {#sec-image-classification-image-pre-processing-81a6}
...
### Model Design {#sec-image-classification-model-design-a48a}
...
### Model Training {#sec-image-classification-model-training-f171}
...
### Trading off: Accuracy versus speed {#sec-image-classification-trading-accuracy-versus-speed-8538}
...
### Model Testing {#sec-image-classification-model-testing-0b30}
...
### Deploying the model {#sec-image-classification-deploying-model-9e0b}
...
## Live Image Classification {#sec-image-classification-live-image-classification-b02a}
...
#### Key Components: {#sec-image-classification-key-components-a5d4}
...
#### Main Features: {#sec-image-classification-main-features-8e04}
...
#### Code Structure: {#sec-image-classification-code-structure-7aa0}
...
#### Key Concepts: {#sec-image-classification-key-concepts-e0a5}
...
#### Usage: {#sec-image-classification-usage-d85a}
...
## Conclusion: {#sec-image-classification-conclusion-9796}
...
## Resources {#sec-image-classification-resources-1d0e}
