...
## Overview {#sec-image-classification-overview-c0fc}
...
### Applications in Real-World Scenarios {#sec-image-classification-applications-realworld-scenarios-a7b0}
...
### Advantages of Running Classification on Edge Devices like Raspberry Pi {#sec-image-classification-advantages-running-classification-edge-devices-like-raspberry-pi-7688}
...
## Setting Up the Environment {#sec-image-classification-setting-environment-6e57}

### Updating the Raspberry Pi {#sec-image-classification-updating-raspberry-pi-025e}
...
### Installing Required Libraries {#sec-image-classification-installing-required-libraries-6a11}
...
### Setting up a Virtual Environment (Optional but Recommended) {#sec-image-classification-setting-virtual-environment-optional-recommended-0090}
...
### Installing TensorFlow Lite {#sec-image-classification-installing-tensorflow-lite-ccf3}
...
### Installing Additional Python Libraries {#sec-image-classification-installing-additional-python-libraries-f520}
...
### Creating a working directory: {#sec-image-classification-creating-working-directory-fce7}
...
### Setting up Jupyter Notebook (Optional) {#sec-image-classification-setting-jupyter-notebook-optional-29c4}
...
### Verifying the Setup {#sec-image-classification-verifying-setup-3e85}
...
## Making inferences with Mobilenet V2 {#sec-image-classification-making-inferences-mobilenet-v2-54d0}
...
### Define a general Image Classification function {#sec-image-classification-define-general-image-classification-function-5081}
...
### Testing with a model trained from scratch {#sec-image-classification-testing-model-trained-scratch-0628}
...
### Installing Picamera2 {#sec-image-classification-installing-picamera2-60ad}
...
## Image Classification Project {#sec-image-classification-image-classification-project-a4a6}
...
### The Goal {#sec-image-classification-goal-a7df}
...
### Data Collection {#sec-image-classification-data-collection-17a3}
...
#### Key Features: {#sec-image-classification-key-features-2268}
...
#### Main Components: {#sec-image-classification-main-components-c50a}
...
#### Key Functions: {#sec-image-classification-key-functions-7d91}
...
#### Usage Flow: {#sec-image-classification-usage-flow-8c31}
...
#### Technical Notes: {#sec-image-classification-technical-notes-e1f0}
...
#### Customization Possibilities: {#sec-image-classification-customization-possibilities-680c}
...
#### Number of samples on Dataset: {#sec-image-classification-number-samples-dataset-555a}
...
## Training the model with Edge Impulse Studio {#sec-image-classification-training-model-edge-impulse-studio-5533}
...
### Dataset {#sec-image-classification-dataset-33e5}
...
## The Impulse Design {#sec-image-classification-impulse-design-8149}
...
### Image Pre-Processing {#sec-image-classification-image-preprocessing-fb4f}
...
### Model Design {#sec-image-classification-model-design-f63d}
...
### Model Training {#sec-image-classification-model-training-df0c}
...
### Trading off: Accuracy versus speed {#sec-image-classification-trading-accuracy-versus-speed-24aa}
...
### Model Testing {#sec-image-classification-model-testing-1528}
...
### Deploying the model {#sec-image-classification-deploying-model-87e3}
...
## Live Image Classification {#sec-image-classification-live-image-classification-7a1c}
...
#### Key Components: {#sec-image-classification-key-components-5a7b}
...
#### Main Features: {#sec-image-classification-main-features-0344}
...
#### Code Structure: {#sec-image-classification-code-structure-2481}
...
#### Key Concepts: {#sec-image-classification-key-concepts-c29c}
...
#### Usage: {#sec-image-classification-usage-196e}
...
## Conclusion: {#sec-image-classification-conclusion-bec5}
...
## Resources {#sec-image-classification-resources-1105}
