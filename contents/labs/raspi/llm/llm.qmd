...
## Overview {#sec-small-language-models-slm-overview-78ef}
...
\noindent
![](images/jpeg/slm-example.jpg){width=73% fig-align="center"}

## Setup {#sec-small-language-models-slm-setup-0298}
...
### Raspberry Pi Active Cooler {#sec-small-language-models-slm-raspberry-pi-active-cooler-5548}
...
## Generative AI (GenAI) {#sec-small-language-models-slm-generative-ai-genai-1e3a}
...
### Large Language Models (LLMs) {#sec-small-language-models-slm-large-language-models-llms-e858}
...
### Closed vs Open Models: {#sec-small-language-models-slm-closed-vs-open-models-4441}
...
![Adapted from \
[arXiv](https://arxiv.org/pdf/2304.13712)](images/png/llms-slm.png)
:::
...
### Small Language Models (SLMs) {#sec-small-language-models-slm-small-language-models-slms-5a36}
...
## Ollama {#sec-small-language-models-slm-ollama-90fb}
...
### Installing Ollama {#sec-small-language-models-slm-installing-ollama-61af}
...
### Meta Llama 3.2 1B/3B {#sec-small-language-models-slm-meta-llama-32-1b3b-3231}
...
![](images/png/paris-lat-lon.png){width=85% fig-align="center"}

Both 1B and 3B models gave correct answers.

### Google Gemma 2 2B {#sec-small-language-models-slm-google-gemma-2-2b-72ee}
...
### Microsoft Phi3.5 3.8B {#sec-small-language-models-slm-microsoft-phi35-38b-6d68}
...
### Multimodal Models {#sec-small-language-models-slm-multimodal-models-5ee1}
...
\noindent
![](images/png/image_test-path.png){width=90% fig-align="center"}
...
\noindent
![](images/png/paris-infer-1.png){width=70% fig-align="center"}

### Inspecting local resources {#sec-small-language-models-slm-inspecting-local-resources-dce9}
...
\noindent
![](images/png/resourses-temp.png){width=80% fig-align="center"}
...
## Ollama Python Library {#sec-small-language-models-slm-ollama-python-library-e238}
...
### Function Calling {#sec-small-language-models-slm-function-calling-62fe}
...
#### But what exactly is "function calling"? {#sec-small-language-models-slm-exactly-function-calling-91e7}
...
#### Let's create a project. {#sec-small-language-models-slm-lets-create-project-a81c}
...
### 1.  Importing Libraries {#sec-small-language-models-slm-1-importing-libraries-6774}
...
### 2.  Defining Input and Model {#sec-small-language-models-slm-2-defining-input-model-02ab}
...
### 3.  Defining the Response Data Structure {#sec-small-language-models-slm-3-defining-response-data-structure-ef8c}
...
### 4.  Setting Up the OpenAI Client {#sec-small-language-models-slm-4-setting-openai-client-db5f}
...
### 5.  Generating the Response {#sec-small-language-models-slm-5-generating-response-073d}
...
### 6.  Calculating the Distance {#sec-small-language-models-slm-6-calculating-distance-da9a}
...
### Adding images {#sec-small-language-models-slm-adding-images-f2c2}
...
## SLMs: Optimization Techniques {#sec-small-language-models-slm-slms-optimization-techniques-75f1}
...
## RAG Implementation {#sec-small-language-models-slm-rag-implementation-1834}
...
\noindent
![](images/png/rag-1.png){width=80% fig-align="center"}

### A simple RAG project {#sec-small-language-models-slm-simple-rag-project-b8c7}
...
\noindent
![](images/png/rag-2-2.png){width=80% fig-align="center"}
...
### Going Further {#sec-small-language-models-slm-going-1b8d}
...
## Conclusion {#sec-small-language-models-slm-conclusion-2011}
...
## Resources {#sec-small-language-models-slm-resources-e34d}
