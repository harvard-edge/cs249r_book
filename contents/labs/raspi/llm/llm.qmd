...
### Raspberry Pi Active Cooler {#sec-raspberry-pi-active-cooler-b1df}
...
## Generative AI (GenAI) {#sec-generative-ai-genai-e114}
...
### Large Language Models (LLMs) {#sec-large-language-models-llms-f756}
...
### Closed vs Open Models: {#sec-closed-vs-open-models-178b}
...
### Small Language Models (SLMs) {#sec-small-language-models-slms-1335}
...
### Installing Ollama {#sec-installing-ollama-a1e5}
...
### Meta Llama 3.2 1B/3B {#sec-meta-llama-3-2-1b-3b-042e}
...
### Google Gemma 2 2B {#sec-google-gemma-2-2b-e1e7}
...
### Microsoft Phi3.5 3.8B {#sec-microsoft-phi3-5-3-8b-4f7b}
...
### Multimodal Models {#sec-multimodal-models-46ec}
...
### Inspecting local resources {#sec-inspecting-local-resources-7f3f}
...
## Ollama Python Library {#sec-ollama-python-library-c6a0}
...
### Function Calling {#sec-function-calling-d6fd}
...
#### But what exactly is "function calling"? {#sec-but-what-exactly-is-function-calling-03bc}
...
#### Let's create a project. {#sec-let-s-create-a-project-0ef2}
...
### 1.  Importing Libraries {#sec-1-importing-libraries-3458}
...
### 2.  Defining Input and Model {#sec-2-defining-input-and-model-6874}
...
### 3.  Defining the Response Data Structure {#sec-3-defining-the-response-data-structure-8ffa}
...
### 4.  Setting Up the OpenAI Client {#sec-4-setting-up-the-openai-client-2409}
...
### 5.  Generating the Response {#sec-5-generating-the-response-7128}
...
### 6.  Calculating the Distance {#sec-6-calculating-the-distance-c092}
...
### Adding images {#sec-adding-images-908d}
...
## SLMs: Optimization Techniques {#sec-slms-optimization-techniques-d038}
...
## RAG Implementation {#sec-rag-implementation-9dac}
...
### A simple RAG project {#sec-a-simple-rag-project-b809}
...
### Going Further {#sec-going-further-612b}
...
## Conclusion {#sec-conclusion-9494}
