...
## Overview {#sec-small-language-models-slm-overview-70c6}
...
## Setup {#sec-small-language-models-slm-setup-2989}
...
### Raspberry Pi Active Cooler {#sec-small-language-models-slm-raspberry-pi-active-cooler-a7da}
...
## Generative AI (GenAI) {#sec-small-language-models-slm-generative-ai-genai-1464}
...
### Large Language Models (LLMs) {#sec-small-language-models-slm-large-language-models-llms-f99e}
...
### Closed vs Open Models: {#sec-small-language-models-slm-closed-vs-open-models-81a5}
...
### Small Language Models (SLMs) {#sec-small-language-models-slm-small-language-models-slms-5228}
...
## Ollama {#sec-small-language-models-slm-ollama-305a}
...
### Installing Ollama {#sec-small-language-models-slm-installing-ollama-1ef8}
...
### Meta Llama 3.2 1B/3B {#sec-small-language-models-slm-meta-llama-32-1b3b-ab22}
...
### Google Gemma 2 2B {#sec-small-language-models-slm-google-gemma-2-2b-d3fc}
...
### Microsoft Phi3.5 3.8B {#sec-small-language-models-slm-microsoft-phi35-38b-6e2e}
...
### Multimodal Models {#sec-small-language-models-slm-multimodal-models-42b2}
...
### Inspecting local resources {#sec-small-language-models-slm-inspecting-local-resources-2cb4}
...
## Ollama Python Library {#sec-small-language-models-slm-ollama-python-library-8975}
...
### Function Calling {#sec-small-language-models-slm-function-calling-cce4}
...
#### But what exactly is "function calling"? {#sec-small-language-models-slm-exactly-function-calling-6931}
...
#### Let's create a project. {#sec-small-language-models-slm-lets-create-project-6fd9}
...
### 1.  Importing Libraries {#sec-small-language-models-slm-1-importing-libraries-12cd}
...
### 2.  Defining Input and Model {#sec-small-language-models-slm-2-defining-input-model-5429}
...
### 3.  Defining the Response Data Structure {#sec-small-language-models-slm-3-defining-response-data-structure-01fe}
...
### 4.  Setting Up the OpenAI Client {#sec-small-language-models-slm-4-setting-openai-client-01f7}
...
### 5.  Generating the Response {#sec-small-language-models-slm-5-generating-response-123c}
...
### 6.  Calculating the Distance {#sec-small-language-models-slm-6-calculating-distance-7487}
...
### Adding images {#sec-small-language-models-slm-adding-images-a928}
...
## SLMs: Optimization Techniques {#sec-small-language-models-slm-slms-optimization-techniques-26f3}
...
## RAG Implementation {#sec-small-language-models-slm-rag-implementation-5a9d}
...
### A simple RAG project {#sec-small-language-models-slm-simple-rag-project-e344}
...
### Going Further {#sec-small-language-models-slm-going-3b1a}
...
## Conclusion {#sec-small-language-models-slm-conclusion-8faf}
...
## Resources {#sec-small-language-models-slm-resources-1660}
