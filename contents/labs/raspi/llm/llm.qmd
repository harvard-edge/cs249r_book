...
## Overview {#sec-small-language-models-slm-overview-e808}
...
## Setup {#sec-small-language-models-slm-setup-ee29}
...
### Raspberry Pi Active Cooler {#sec-small-language-models-slm-raspberry-pi-active-cooler-bc83}
...
### Installing Ollama {#sec-small-language-models-slm-installing-ollama-e2b4}
...
### Meta Llama 3.2 1B/3B {#sec-small-language-models-slm-meta-llama-32-1b3b-e0d2}
...
### Google Gemma 2 2B {#sec-small-language-models-slm-google-gemma-2-2b-f9bc}
...
### Microsoft Phi3.5 3.8B {#sec-small-language-models-slm-microsoft-phi35-38b-57bb}
...
### Multimodal Models {#sec-small-language-models-slm-multimodal-models-08a3}
...
### Inspecting local resources {#sec-small-language-models-slm-inspecting-local-resources-041f}
...
## Ollama Python Library {#sec-small-language-models-slm-ollama-python-library-c9f2}
...
### Function Calling {#sec-small-language-models-slm-function-calling-6629}
...
#### But what exactly is "function calling"? {#sec-small-language-models-slm-exactly-function-calling-1f93}
...
#### Let's create a project. {#sec-small-language-models-slm-lets-create-project-da6b}
...
### 1.  Importing Libraries {#sec-small-language-models-slm-1-importing-libraries-c480}
...
### 2.  Defining Input and Model {#sec-small-language-models-slm-2-defining-input-model-e733}
...
### 3.  Defining the Response Data Structure {#sec-small-language-models-slm-3-defining-response-data-structure-41db}
...
### 4.  Setting Up the OpenAI Client {#sec-small-language-models-slm-4-setting-openai-client-9cda}
...
### 5.  Generating the Response {#sec-small-language-models-slm-5-generating-response-7e65}
...
### 6.  Calculating the Distance {#sec-small-language-models-slm-6-calculating-distance-ae2f}
...
### Adding images {#sec-small-language-models-slm-adding-images-3bb1}
...
## RAG Implementation {#sec-small-language-models-slm-rag-implementation-1550}
...
### A simple RAG project {#sec-small-language-models-slm-simple-rag-project-12a3}
