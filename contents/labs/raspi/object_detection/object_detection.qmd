...
## Overview {#sec-object-detection-overview-b2f9}
...
### Object Detection Fundamentals {#sec-object-detection-object-detection-fundamentals-b47f}
...
#### Image Classification vs. Object Detection {#sec-object-detection-image-classification-vs-object-detection-6b6c}
...
## Pre-Trained Object Detection Models Overview {#sec-object-detection-pre-trained-object-detection-models-overview-5861}
...
### Setting Up the TFLite Environment {#sec-object-detection-setting-tflite-environment-899c}
...
### Creating a Working Directory: {#sec-object-detection-creating-working-directory-83fc}
...
### Inference and Post-Processing {#sec-object-detection-inference-post-processing-46a2}
...
### EfficientDet {#sec-object-detection-efficientdet-9d03}
...
## Object Detection Project {#sec-object-detection-object-detection-project-a819}
...
### The Goal {#sec-object-detection-goal-c691}
...
### Raw Data Collection {#sec-object-detection-raw-data-collection-19ce}
...
### Labeling Data {#sec-object-detection-labeling-data-ded3}
...
#### Annotate {#sec-object-detection-annotate-0053}
...
#### Data Pre-Processing {#sec-object-detection-data-pre-processing-0ee6}
...
## Training an SSD MobileNet Model on Edge Impulse Studio {#sec-object-detection-training-ssd-mobilenet-model-edge-impulse-studio-da6b}
...
### Uploading the annotated data {#sec-object-detection-uploading-annotated-data-e04f}
...
### The Impulse Design {#sec-object-detection-impulse-design-78bf}
...
### Preprocessing all dataset {#sec-object-detection-preprocessing-dataset-9abf}
...
### Model Design, Training, and Test {#sec-object-detection-model-design-training-test-4ef2}
...
### Deploying the model {#sec-object-detection-deploying-model-779a}
...
### Inference and Post-Processing {#sec-object-detection-inference-post-processing-8371}
...
## Training a FOMO Model at Edge Impulse Studio {#sec-object-detection-training-fomo-model-edge-impulse-studio-f849}
...
### How FOMO works? {#sec-object-detection-fomo-works-3be1}
...
### Impulse Design, new Training and Testing {#sec-object-detection-impulse-design-new-training-testing-84b9}
...
### Deploying the model {#sec-object-detection-deploying-model-5ccf}
...
### Inference and Post-Processing {#sec-object-detection-inference-post-processing-2dc9}
...
## Exploring a YOLO Model using Ultralitics {#sec-object-detection-exploring-yolo-model-using-ultralitics-d641}
...
### Talking about the YOLO Model {#sec-object-detection-talking-yolo-model-8ef8}
...
#### Key Features: {#sec-object-detection-key-features-9cbf}
...
### Installation {#sec-object-detection-installation-7fa7}
...
### Testing the YOLO {#sec-object-detection-testing-yolo-6227}
...
### Export Model to NCNN format {#sec-object-detection-export-model-ncnn-format-cf38}
...
### Exploring YOLO with Python {#sec-object-detection-exploring-yolo-python-3dc5}
...
### Training YOLOv8 on a Customized Dataset {#sec-object-detection-training-yolov8-customized-dataset-f2c3}
...
#### Critical points on the Notebook: {#sec-object-detection-critical-points-notebook-8cab}
...
### Inference with the trained model, using the Raspi {#sec-object-detection-inference-trained-model-using-raspi-e635}
...
## Object Detection on a live stream {#sec-object-detection-object-detection-live-stream-ebd1}
...
## Conclusion {#sec-object-detection-conclusion-3b24}
