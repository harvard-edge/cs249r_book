...
## Overview {#sec-object-detection-overview-a4db}
...
### Object Detection Fundamentals {#sec-object-detection-object-detection-fundamentals-7397}
...
## Pre-Trained Object Detection Models Overview {#sec-object-detection-pretrained-object-detection-models-overview-f223}
...
### Setting Up the TFLite Environment {#sec-object-detection-setting-tflite-environment-4876}
...
### Creating a Working Directory: {#sec-object-detection-creating-working-directory-7366}
...
### Inference and Post-Processing {#sec-object-detection-inference-postprocessing-5109}
...
## Object Detection Project {#sec-object-detection-object-detection-project-1e21}
...
### Labeling Data {#sec-object-detection-labeling-data-d559}
...
#### Data Pre-Processing {#sec-object-detection-data-preprocessing-0ee6}
...
## Training an SSD MobileNet Model on Edge Impulse Studio {#sec-object-detection-training-ssd-mobilenet-model-edge-impulse-studio-f24f}
...
### Inference and Post-Processing {#sec-object-detection-inference-postprocessing-8371}
...
## Training a FOMO Model at Edge Impulse Studio {#sec-object-detection-training-fomo-model-edge-impulse-studio-34e9}
...
### Inference and Post-Processing {#sec-object-detection-inference-postprocessing-2dc9}
...
## Exploring a YOLO Model using Ultralitics {#sec-object-detection-exploring-yolo-model-using-ultralitics-0f72}
...
### Talking about the YOLO Model {#sec-object-detection-talking-yolo-model-e628}
...
### Training YOLOv8 on a Customized Dataset {#sec-object-detection-training-yolov8-customized-dataset-8a9e}
