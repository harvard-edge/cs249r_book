...
### Object Detection Fundamentals {#sec-object-detection-fundamentals-33ea}
...
#### Image Classification vs. Object Detection {#sec-image-classification-vs-object-detection-50cd}
...
#### Key Components of Object Detection {#sec-key-components-of-object-detection-71a9}
...
#### Challenges in Object Detection {#sec-challenges-in-object-detection-1942}
...
#### Approaches to Object Detection {#sec-approaches-to-object-detection-4121}
...
#### Evaluation Metrics {#sec-evaluation-metrics-a665}
...
## Pre-Trained Object Detection Models Overview {#sec-pre-trained-object-detection-models-overview-771b}
...
### Setting Up the TFLite Environment {#sec-setting-up-the-tflite-environment-18aa}
...
### Creating a Working Directory: {#sec-creating-a-working-directory-eead}
...
### Inference and Post-Processing {#sec-inference-and-post-processing-5ba7}
...
### EfficientDet {#sec-efficientdet-a475}
...
## Object Detection Project {#sec-object-detection-project-5602}
...
### Raw Data Collection {#sec-raw-data-collection-0300}
...
### Labeling Data {#sec-labeling-data-f381}
...
#### Data Pre-Processing {#sec-data-pre-processing-e0c2}
...
## Training an SSD MobileNet Model on Edge Impulse Studio {#sec-training-an-ssd-mobilenet-model-on-edge-impulse-studio-03e7}
...
### Uploading the annotated data {#sec-uploading-the-annotated-data-a846}
...
### The Impulse Design {#sec-the-impulse-design-96cf}
...
### Preprocessing all dataset {#sec-preprocessing-all-dataset-2bc1}
...
### Model Design, Training, and Test {#sec-model-design-training-and-test-4fe2}
...
### Deploying the model {#sec-deploying-the-model-f149}
...
### Inference and Post-Processing {#sec-inference-and-post-processing-3749}
...
## Training a FOMO Model at Edge Impulse Studio {#sec-training-a-fomo-model-at-edge-impulse-studio-9693}
...
### How FOMO works? {#sec-how-fomo-works-5b23}
...
### Impulse Design, new Training and Testing {#sec-impulse-design-new-training-and-testing-dbbe}
...
### Deploying the model {#sec-deploying-the-model-2a90}
...
### Inference and Post-Processing {#sec-inference-and-post-processing-baa8}
...
## Exploring a YOLO Model using Ultralitics {#sec-exploring-a-yolo-model-using-ultralitics-ef9d}
...
### Talking about the YOLO Model {#sec-talking-about-the-yolo-model-8b86}
...
#### Key Features: {#sec-key-features-a433}
...
### Installation {#sec-installation-3763}
...
### Testing the YOLO {#sec-testing-the-yolo-a393}
...
### Export Model to NCNN format {#sec-export-model-to-ncnn-format-be16}
...
### Exploring YOLO with Python {#sec-exploring-yolo-with-python-58c0}
...
### Training YOLOv8 on a Customized Dataset {#sec-training-yolov8-on-a-customized-dataset-aac9}
...
#### Critical points on the Notebook: {#sec-critical-points-on-the-notebook-45af}
...
### Inference with the trained model, using the Raspi {#sec-inference-with-the-trained-model-using-the-raspi-df28}
...
## Object Detection on a live stream {#sec-object-detection-on-a-live-stream-604e}
...
## Conclusion {#sec-conclusion-92ba}
