...
## Overview {#sec-setup-overview-0bd2}
...
### Key Features {#sec-setup-key-features-991e}
...
### Raspberry Pi Models (covered in this book) {#sec-setup-raspberry-pi-models-covered-book-2de4}
...
### Engineering Applications {#sec-setup-engineering-applications-776d}
...
## Hardware Overview {#sec-setup-hardware-overview-f4ae}

### Raspberry Pi Zero 2W {#sec-setup-raspberry-pi-zero-2w-a714}
...
### Raspberry Pi 5 {#sec-setup-raspberry-pi-5-85e9}
...
## Installing the Operating System {#sec-setup-installing-operating-system-218b}

### The Operating System (OS) {#sec-setup-operating-system-os-4555}
...
### Installation {#sec-setup-installation-b8a8}
...
### Initial Configuration {#sec-setup-initial-configuration-4931}
...
## Remote Access {#sec-setup-remote-access-d3cd}

### SSH Access {#sec-setup-ssh-access-54b8}
...
### To shut down the Raspi via terminal: {#sec-setup-shut-raspi-via-terminal-c71e}
...
### Transfer Files between the Raspi and a computer {#sec-setup-transfer-files-raspi-computer-9739}
...
#### Using Secure Copy Protocol (`scp`): {#sec-setup-using-secure-copy-protocol-scp-3bac}

##### Copy files to your Raspberry Pi {#sec-setup-copy-files-raspberry-pi-38b7}
...
##### Copy files from your Raspberry Pi {#sec-setup-copy-files-raspberry-pi-820d}
...
#### Transferring files using FTP {#sec-setup-transferring-files-using-ftp-a51f}
...
## Increasing SWAP Memory {#sec-setup-increasing-swap-memory-e4aa}
...
## Installing a Camera {#sec-setup-installing-camera-28f2}
...
### Installing a USB WebCam {#sec-setup-installing-usb-webcam-00a9}
...
#### Video Streaming {#sec-setup-video-streaming-fdb2}
...
### Installing a Camera Module on the CSI port {#sec-setup-installing-camera-module-csi-port-8521}
...
## Running the Raspi Desktop remotely {#sec-setup-running-raspi-desktop-remotely-f2ac}
...
## Updating and Installing Software {#sec-setup-updating-installing-software-d6b8}
...
## Model-Specific Considerations {#sec-setup-modelspecific-considerations-424c}

### Raspberry Pi Zero (Raspi-Zero) {#sec-setup-raspberry-pi-zero-raspizero-a991}
...
### Raspberry Pi 4 or 5 (Raspi-4 or Raspi-5) {#sec-setup-raspberry-pi-4-5-raspi4-raspi5-8bbd}
