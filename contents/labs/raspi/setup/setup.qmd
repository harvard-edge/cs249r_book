...
## Overview {#sec-setup-overview-5f38}
...
## Hardware Overview {#sec-setup-hardware-overview-dcd2}
...
## Installing the Operating System {#sec-setup-installing-operating-system-8089}
...
## Remote Access {#sec-setup-remote-access-8d1b}
...
### Transfer Files between the Raspi and a computer {#sec-setup-transfer-files-raspi-computer-8505}
...
#### Using Secure Copy Protocol (`scp`): {#sec-setup-using-secure-copy-protocol-scp-d3e5}
...
## Installing a Camera {#sec-setup-installing-camera-9b0c}
...
### Installing a USB WebCam {#sec-setup-installing-usb-webcam-ca71}
...
## Model-Specific Considerations {#sec-setup-modelspecific-considerations-1be0}
