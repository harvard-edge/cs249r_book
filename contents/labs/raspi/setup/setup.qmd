...
## Overview {#sec-setup-overview-09d6}
...
## Hardware Overview {#sec-setup-hardware-overview-1075}
...
## Installing the Operating System {#sec-setup-installing-operating-system-e1f1}
...
## Remote Access {#sec-setup-remote-access-199a}

### SSH Access {#sec-setup-ssh-access-f4e8}
...
### To shut down the Raspi via terminal: {#sec-setup-shut-raspi-via-terminal-79cb}
...
### Transfer Files between the Raspi and a computer {#sec-setup-transfer-files-raspi-computer-9721}
...
#### Using Secure Copy Protocol (`scp`): {#sec-setup-using-secure-copy-protocol-scp-69a7}

##### Copy files to your Raspberry Pi {#sec-setup-copy-files-raspberry-pi-883b}
...
##### Copy files from your Raspberry Pi {#sec-setup-copy-files-raspberry-pi-8967}
...
#### Transferring files using FTP {#sec-setup-transferring-files-using-ftp-40d7}
...
## Increasing SWAP Memory {#sec-setup-increasing-swap-memory-1bdf}
...
## Installing a Camera {#sec-setup-installing-camera-e809}
...
### Installing a USB WebCam {#sec-setup-installing-usb-webcam-0bdf}
...
#### Video Streaming {#sec-setup-video-streaming-b20c}
...
### Installing a Camera Module on the CSI port {#sec-setup-installing-camera-module-csi-port-0215}
...
## Running the Raspi Desktop remotely {#sec-setup-running-raspi-desktop-remotely-f24d}
...
## Updating and Installing Software {#sec-setup-updating-installing-software-e1bb}
...
## Model-Specific Considerations {#sec-setup-model-specific-considerations-6dbc}

### Raspberry Pi Zero (Raspi-Zero) {#sec-setup-raspberry-pi-zero-raspi-zero-d193}
...
### Raspberry Pi 4 or 5 (Raspi-4 or Raspi-5) {#sec-setup-raspberry-pi-4-5-raspi-4-raspi-5-3828}
