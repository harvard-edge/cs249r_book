...
![Figure 1: Time Moore: Exploiting Moore's Law From The Perspective of Time. The Dennard scaling failed around the middle of the 2000s. Figure taken from reference (@xiu2019time)](images/hwai_40yearsmicrotrenddata.png)
...
![Comparing a wafer-scale AI chip with a conventional GPU die](images/aimage1.png)
...
![Figure 1: Chiplet partitioning concept. Figure taken from [@Vivet2021] [Cerebras](https://www.cerebras.net/product-chip/) ](images/aimage2.png)
...
![Comparison of the von Neumann architecture with the neuromorphic architecture. These two architectures have some fundamental differences when it comes to operation, organization, programming, communication, and timing. Figure taken from [@schuman2022]](images/aimage3.png)
...
![Neuromorphic circuits. Credit: @hazan2021neuromorphic](images/aimage5.png)
...
![Flexible electronics and some of their applications in daily life. Figure taken from @farah2005neuroethics. ](images/fimage1.png)
...
![Photonic AI computing platform enables neural networks in the world while reducing environmental impact. ([https://lightmatter.co/](https://lightmatter.co/))](images/aimage7.png)
