...
Resources: [Slides](#sec-ai-acceleration-resource), [Exercises](#sec-ai-acceleration-resource), [Labs](#sec-ai-acceleration-resource)
:::
...
|-|-|-|-|
| ASICs | Custom ICs designed for target workloads like AI inference | Maximizes perf/watt. <br/> Optimized for tensor ops<br/> Low latency on-chip memory | Fixed architecture lacks flexibility<br/>  High NRE cost<br/>  Long design cycles |
...
:::{#exr-tvm .callout-caution collapse="false"}
...
[![](https://colab.research.google.com/assets/exr-badge.png)](https://colab.research.google.com/github/uwsampl/tutorial/blob/master/notebook/04a_TVM_Tutorial_VTA_Mat_Mult.ipynb)
