...
- **Advanced Functionality**: Detachable OV2640 camera sensor for $1600{\times}1200$ resolution, compatible with OV5640 camera sensor, plus integrated digital microphone
...
- **Compact Design**: $21{\times}17.5$ mm, adopting the classic XIAO form factor, suitable for space-limited projects
...
- 0.42" OLED Display
    - Monochrome display ($72{\times}40$ resolution) for real-time data visualization
        - Controller: SSD1306
...
> XIAO ESP32S3 Sense supports microSD cards up to **32 GB**. If you are ready to purchase a microSD card for XIAO, please refer to the specifications below. Format the microSD card to **FAT32 format** before using it.
...
- **Pixel-perfect**: Each of the 2,880 pixels ($72{\times}40$) can be individually controlled
...
- The font used in the code was medium.
    ...
    - `u8g2_font_4x6_tr`: Tiny font ($4{\times}6$ pixels)
    - `u8g2_font_6x10_tr`: Small font ($6{\times}10$ pixels)
