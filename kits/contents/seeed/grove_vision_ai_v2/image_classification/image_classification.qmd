...
> For comparison, we will keep the image size as $96{\times}96$. However, keep in mind that with the Grove Vision AI Module V2 and its internal SRAM of 2.4 MB, larger images can be utilized (for example, $160{\times}160$).
...
Taking advantage of this opportunity, a similarly trained model, MobilenetV2 $96{\times}96$, with an alpha of 0.1, was also deployed on the ESP-CAM, the XIAO, and a Raspberry Pi Zero W2. Here is the result:
