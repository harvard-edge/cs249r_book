...
Go to the Impulse Design Tab and create the *impulse*, defining an image size of $96{\times}96$ and squashing them (squared form, without cropping). Select Image and Transfer Learning blocks. Save the Impulse.
...
We will use **MobileNetV2 $96{\times}96$ 0.1** ( **or 0.05**) for this project, with an estimated memory cost of 265.3 KB in RAM. This model should be OK for the Nicla Vision with 1MB of SRAM. On the Transfer Learning Tab, select this model:
