...
## Overview {#sec-image-classification-overview-3e02}
...
### Applications in Real-World Scenarios {#sec-image-classification-applications-realworld-scenarios-712e}
...
### Advantages of Running Classification on Edge Devices like Raspberry Pi {#sec-image-classification-advantages-running-classification-edge-devices-like-raspberry-pi-fb5f}
...
## Setting Up the Environment {#sec-image-classification-setting-environment-fc34}

### Updating the Raspberry Pi {#sec-image-classification-updating-raspberry-pi-dead}
...
### Installing Required Libraries {#sec-image-classification-installing-required-libraries-a0de}
...
### Setting up a Virtual Environment (Optional but Recommended) {#sec-image-classification-setting-virtual-environment-optional-recommended-e585}
...
### Installing TensorFlow Lite {#sec-image-classification-installing-tensorflow-lite-c6ee}
...
### Installing Additional Python Libraries {#sec-image-classification-installing-additional-python-libraries-7fbd}
...
### Creating a working directory: {#sec-image-classification-creating-working-directory-9584}
...
\noindent
![](images/png/models_dir.png){width=105% fig-align="center"}

> We will only need the `mobilenet_v2_1.0_224_quant.tflite` model and the `labels.txt`. You can delete the other files.

### Setting up Jupyter Notebook (Optional) {#sec-image-classification-setting-jupyter-notebook-optional-7d66}
...
\noindent
![](images/png/notebook_token.png){width=105% fig-align="center"}
...
\noindent
![](images/png/image-20240823145059675.png){width=70% fig-align="center"}

Define your working directory in the Raspi and create a new Python 3 notebook.

### Verifying the Setup {#sec-image-classification-verifying-setup-9103}
...
\noindent
![](images/png/nano.png){width=70% fig-align="center"}
...
## Making inferences with Mobilenet V2 {#sec-image-classification-making-inferences-mobilenet-v2-d635}
...
\noindent
![](images/png/cat_original.png){width=85% fig-align="center"}
...
### Define a general Image Classification function {#sec-image-classification-define-general-image-classification-function-6af6}
...
### Testing with a model trained from scratch {#sec-image-classification-testing-model-trained-scratch-4cb8}
...
### Installing Picamera2 {#sec-image-classification-installing-picamera2-4ac5}
...
\noindent
![](images/png/capture_test.png){width=90% fig-align="center"}
...
\noindent
![](images/png/img_test_result.png){width=65% fig-align="center"}

> If you are working with a Raspi-5 with a whole desktop, you can open the file directly on the device.

## Image Classification Project {#sec-image-classification-image-classification-project-2617}
...
### The Goal {#sec-image-classification-goal-dd93}
...
\noindent
![](images/jpeg/project_goal.jpg){width=65% fig-align="center"}

### Data Collection {#sec-image-classification-data-collection-bdf5}

Once we have defined our Machine Learning project goal, the next and most crucial step is collecting the dataset. We can use a phone for the image capture, but we will use the Raspi here. Let's set up a simple web server on our Raspberry Pi to view the `QVGA ($320{\times}240$)` captured images in a browser.
...
#### Key Features: {#sec-image-classification-key-features-5739}
...
#### Main Components: {#sec-image-classification-main-components-4d92}
...
#### Key Functions: {#sec-image-classification-key-functions-b1b8}
...
#### Usage Flow: {#sec-image-classification-usage-flow-4238}
...
\noindent
![](images/png/stop.png){width=55% fig-align="center"}

#### Technical Notes: {#sec-image-classification-technical-notes-fcc7}
...
#### Customization Possibilities: {#sec-image-classification-customization-possibilities-cc72}
...
#### Number of samples on Dataset: {#sec-image-classification-number-samples-dataset-baa4}
...
## Training the model with Edge Impulse Studio {#sec-image-classification-training-model-edge-impulse-studio-bbff}
...
\noindent
![](images/png/data-aquisition.png){width=70% fig-align="center"}
...
\noindent
![](images/png/data-esplorer.png){width=70% fig-align="center"}

## The Impulse Design {#sec-image-classification-impulse-design-0ca2}
...
\noindent
![](images/jpeg/model_1.jpg){width=103% fig-align="center"}
...
\noindent
![](images/jpeg/model_2.jpg){width=103% fig-align="center"}
...
### Image Pre-Processing {#sec-image-classification-image-preprocessing-e94b}

All the input QVGA/RGB565 images will be converted to 76,800 features $(160\times 160\times 3)$.

![](images/png/preproc.png){width=85% fig-align="center"}

Press `Save parameters` and select `Generate features` in the next tab.

### Model Design {#sec-image-classification-model-design-d81c}
...
In our project, we will do a `Transfer Learning` with the `MobileNetV2 $160{\times}160$ 1.0`,  which means that the images used for training (and future inference) should have an *input Size* of $160{\times}160$ pixels and a *Width Multiplier* of 1.0 (full width, not reduced). This configuration balances between model size, speed, and accuracy.

### Model Training {#sec-image-classification-model-training-4953}
...
### Trading off: Accuracy versus speed {#sec-image-classification-trading-accuracy-versus-speed-a6a5}
...
### Model Testing {#sec-image-classification-model-testing-ce54}
...
### Deploying the model {#sec-image-classification-deploying-model-9858}
...
\noindent
![](images/png/model.png){width=75% fig-align="center"}
...
\noindent
![](images/png/infer_robot.png){width=60% fig-align="center"}
...
\noindent
![](images/png/infer-result.png){width=65% fig-align="center"}
...
And test it with different images and the int8 quantized model (**$160{\times}160$ alpha =1.0**).

\noindent
![](images/png/infer-int8-160.png)

Let's download a smaller model, such as the one trained for the [Nicla Vision Lab](https://studio.edgeimpulse.com/public/353482/live) (int8 quantized model, $96{\times}96$, alpha = 0.1), as a test. We can use the same function:
...
## Live Image Classification {#sec-image-classification-live-image-classification-aa5d}
...
#### Key Components: {#sec-image-classification-key-components-5c7f}
...
#### Main Features: {#sec-image-classification-main-features-d78f}
...
#### Code Structure: {#sec-image-classification-code-structure-cf45}
...
#### Key Concepts: {#sec-image-classification-key-concepts-d688}
...
#### Usage: {#sec-image-classification-usage-6ab4}
...
## Summary: {#sec-image-classification-summary-084d}
...
## Resources {#sec-image-classification-resources-e552}
