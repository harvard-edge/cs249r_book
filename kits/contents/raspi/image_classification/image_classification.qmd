...
The CNN trained model (*cifar10_model.keras*) had a size of 2.0 MB. Using the *TFLite Converter*, the model *cifar10.tflite* became with 674 KB (around 1/3 of the original size).
...
The model will take around 125 ms to perform the inference in the Raspi-Zero, which is 3 to 4 times longer than a Raspi-5.
