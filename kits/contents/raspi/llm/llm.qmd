...
## Overview {#sec-small-language-models-slm-overview-ef83}
...
\noindent
![](images/jpeg/slm_example.jpg){width=73% fig-align="center"}

## Setup {#sec-small-language-models-slm-setup-ceea}
...
\noindent
![](images/png/bench.png){width=78% fig-align="center"}
...
### Raspberry Pi Active Cooler {#sec-small-language-models-slm-raspberry-pi-active-cooler-74bc}
...
\noindent
![](images/png/cooler.png){width=65% fig-align="center"}
...
\noindent
![](images/png/temp_comp.png){width=85% fig-align="center"}
...
## Generative AI (GenAI) {#sec-small-language-models-slm-generative-ai-genai-fc75}
...
### Large Language Models (LLMs) {#sec-small-language-models-slm-large-language-models-llms-3ccf}
...
### Closed vs Open Models: {#sec-small-language-models-slm-closed-vs-open-models-e4f5}
...
![Adapted from [arXiv](images/pdf/auto-98e9ef2a_98e9ef2a.pdf)](images/png/llms-slm.png)
:::

::: {.content-visible when-format="html"}
![Adapted from [arXiv](images/2304.13712)](images/png/llms_slm.png)
:::

### Small Language Models (SLMs) {#sec-small-language-models-slm-small-language-models-slms-38de}
...
## Ollama {#sec-small-language-models-slm-ollama-0b03}
...
### Installing Ollama {#sec-small-language-models-slm-installing-ollama-9cbf}
...
\noindent
![](images/png/install_ollama_rpi5.png)
...
### Meta Llama 3.2 1B/3B {#sec-small-language-models-slm-meta-llama-32-1b3b-4ef3}

![](images/png/small_and_multimodal.png){width=40% fig-align="center"}
...
![](images/png/paris_lat_lon.png){width=85% fig-align="center"}

Both 1B and 3B models gave correct answers.

### Google Gemma 2 2B {#sec-small-language-models-slm-google-gemma-2-2b-350b}
...
\noindent
![](images/png/gemma_2.png){width=60% fig-align="center"}
...
\noindent
![](images/png/gemma.png){width=85% fig-align="center"}
...
### Microsoft Phi3.5 3.8B {#sec-small-language-models-slm-microsoft-phi35-38b-6fd2}
...
### Multimodal Models {#sec-small-language-models-slm-multimodal-models-73f5}
...
Let's download a $640\times 320$ image from the internet, for example (Wikipedia: [Paris, France)](https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/La_Tour_Eiffel_vue_de_la_Tour_Saint-Jacques%2C_Paris_ao%C3%BBt_2014_%282%29.jpg/640px-La_Tour_Eiffel_vue_de_la_Tour_Saint-Jacques%2C_Paris_ao%C3%BBt_2014_%282%29.jpg):

\noindent
![](images/jpeg/paris.jpg){width=90% fig-align="center"}
...
\noindent
![](images/png/image_test_path.png){width=90% fig-align="center"}
...
\noindent
![](images/png/paris_infer_1.png){width=70% fig-align="center"}

### Inspecting local resources {#sec-small-language-models-slm-inspecting-local-resources-cf53}
...
\noindent
![](images/png/htop.png){width=70% fig-align="center"}
...
\noindent
![](images/png/resourses_temp.png){width=80% fig-align="center"}
...
## Ollama Python Library {#sec-small-language-models-slm-ollama-python-library-fea5}
...
\noindent
![](images/png/menu.png){width=85% fig-align="center"}
...
### Function Calling {#sec-small-language-models-slm-function-calling-2084}
...
#### But what exactly is "function calling"? {#sec-small-language-models-slm-exactly-function-calling-6bd4}
...
#### Let's create a project. {#sec-small-language-models-slm-lets-create-project-2bf1}
...
### 1.  Importing Libraries {#sec-small-language-models-slm-1-importing-libraries-40bb}
...
### 2.  Defining Input and Model {#sec-small-language-models-slm-2-defining-input-model-dcc2}
...
### 3.  Defining the Response Data Structure {#sec-small-language-models-slm-3-defining-response-data-structure-c730}
...
### 4.  Setting Up the OpenAI Client {#sec-small-language-models-slm-4-setting-openai-client-c73d}
...
### 5.  Generating the Response {#sec-small-language-models-slm-5-generating-response-93a0}
...
### 6.  Calculating the Distance {#sec-small-language-models-slm-6-calculating-distance-3edf}
...
### Adding images {#sec-small-language-models-slm-adding-images-a52a}
...
\noindent
![](images/png/app_machu_picchu.png)

*How* about Paris?

\noindent
![](images/png/paris_app.png)
...
## SLMs: Optimization Techniques {#sec-small-language-models-slm-slms-optimization-techniques-f595}
...
## RAG Implementation {#sec-small-language-models-slm-rag-implementation-9fda}
...
\noindent
![](images/png/rag_1.png){width=80% fig-align="center"}

### A simple RAG project {#sec-small-language-models-slm-simple-rag-project-0dac}
...
\noindent
![](images/png/rag_2_2.png){width=80% fig-align="center"}
...
### Going Further {#sec-small-language-models-slm-going-e88b}
...
## Summary {#sec-small-language-models-slm-summary-e350}
...
## Resources {#sec-small-language-models-slm-resources-015b}
