...
## Overview {#sec-setup-overview-0ec9}
...
### Key Features {#sec-setup-key-features-7d53}
...
### Raspberry Pi Models (covered in this book) {#sec-setup-raspberry-pi-models-covered-book-24a1}
...
### Engineering Applications {#sec-setup-engineering-applications-dc04}
...
## Hardware Overview {#sec-setup-hardware-overview-ed45}

### Raspberry Pi Zero 2W {#sec-setup-raspberry-pi-zero-2w-fc85}
...
### Raspberry Pi 5 {#sec-setup-raspberry-pi-5-7472}
...
## Installing the Operating System {#sec-setup-installing-operating-system-7325}

### The Operating System (OS) {#sec-setup-operating-system-os-9eac}
...
### Installation {#sec-setup-installation-5420}
...
### Initial Configuration {#sec-setup-initial-configuration-5d28}
...
## Remote Access {#sec-setup-remote-access-edc8}

### SSH Access {#sec-setup-ssh-access-1fb3}
...
### To shut down the Raspi via terminal: {#sec-setup-shut-raspi-via-terminal-46dd}
...
### Transfer Files between the Raspi and a computer {#sec-setup-transfer-files-raspi-computer-d305}
...
#### Using Secure Copy Protocol (`scp`): {#sec-setup-using-secure-copy-protocol-scp-a248}

##### Copy files to your Raspberry Pi {#sec-setup-copy-files-raspberry-pi-2e8b}
...
##### Copy files from your Raspberry Pi {#sec-setup-copy-files-raspberry-pi-da9c}
...
#### Transferring files using FTP {#sec-setup-transferring-files-using-ftp-47cd}
...
## Increasing SWAP Memory {#sec-setup-increasing-swap-memory-1c93}
...
## Installing a Camera {#sec-setup-installing-camera-d427}
...
### Installing a USB WebCam {#sec-setup-installing-usb-webcam-6368}
...
7. If the image quality isn't satisfactory, you can adjust various settings; for example, define a resolution that is suitable for YOLO ($640{\times}640$):
...
#### Video Streaming {#sec-setup-video-streaming-3589}
...
### Installing a Camera Module on the CSI port {#sec-setup-installing-camera-module-csi-port-2e66}
...
## Running the Raspi Desktop remotely {#sec-setup-running-raspi-desktop-remotely-83f4}
...
## Updating and Installing Software {#sec-setup-updating-installing-software-8692}
...
## Model-Specific Considerations {#sec-setup-modelspecific-considerations-45de}

### Raspberry Pi Zero (Raspi-Zero) {#sec-setup-raspberry-pi-zero-raspizero-97cf}
...
### Raspberry Pi 4 or 5 (Raspi-4 or Raspi-5) {#sec-setup-raspberry-pi-4-5-raspi4-raspi5-29d3}
