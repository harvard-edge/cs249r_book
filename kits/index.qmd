---
title: "Hardware Kits"
subtitle: "Deploy machine learning on real embedded hardware. Boards start at $25, and the interactive labs replicate every hardware experience in simulation if you have no budget."
---
...
<div class="carousel-caption-bar">
  ...
  <p>From $25 microcontrollers to powerful edge devices</p>
</div>
```
:::
...
Marcelo has also authored open companion books covering the Nicla Vision, XIAO, and Raspberry Pi platforms. See the [Companion Books section in the Instructor Hub](https://mlsysbook.ai/instructors/#companion-books) for direct links and descriptions.
:::
...
<div class="capability-grid">
  <div class="capability-item">
    <h4><i class="fa-solid fa-eye"></i> Computer Vision</h4>
  ...
  <div class="capability-item">
    <h4><i class="fa-solid fa-microphone"></i> Audio Processing</h4>
  ...
  <div class="capability-item">
    <h4><i class="fa-solid fa-person-running"></i> Motion Classification</h4>
  ...
  <div class="capability-item">
    <h4><i class="fa-solid fa-robot"></i> Large Language Models</h4>
