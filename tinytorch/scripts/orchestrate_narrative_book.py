...
NARRATIVE_BOOK_DIR = REPO_ROOT / "tinytorch" / "narrative_book"
SRC_DIR = REPO_ROOT / "tinytorch" / "tinytorch"
...
TARGET FILE: tinytorch/narrative_book/{info['file']}
...
8. Write the complete file directly to `tinytorch/narrative_book/{info['file']}`.
"""
    return prompt
