...
Tito stages TinyTorch notebooks and normalizes nbgrader metadata. It keeps the source grading policy intact, and solution stripping is marker-driven: only content inside `### BEGIN SOLUTION` / `### END SOLUTION` is handed to nbgrader as removable solution content.
