...
**Purpose**: Benchmark models and generate verified competition submissions for Module 20

| Command | Description | Guide |
|---------|-------------|-------|
| `tito olympics run --event <event>` | Run benchmark for a specific event (latency, memory, throughput, all-around) | [TinyTorch Olympics](../tiers/olympics.qmd) |
| `tito olympics run --all` | Run benchmarks across all four Olympic events | [TinyTorch Olympics](../tiers/olympics.qmd) |
| `tito olympics submit --event <event>` | Generate verified competition submission JSON artifact | [TinyTorch Olympics](../tiers/olympics.qmd) |
| `tito olympics leaderboard` | View local and community competition rankings | [TinyTorch Olympics](../tiers/olympics.qmd) |

**See**: [TinyTorch Olympics Guide](../tiers/olympics.qmd) for scoring rules and eligibility
