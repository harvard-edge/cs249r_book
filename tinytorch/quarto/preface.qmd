...
<strong>📘 TinyTorch: The Textbook</strong>

<p><em>From Tensors to Transformers</em>: the architectural commentary detailing formal systems invariants, memory traces, napkin-math budgets, and complete instructor solutions.</p>
</div>

<div class="who-card" style="border-left: 4px solid #ff8247;">
<strong>🛠️ TinyTorch: The Lab Guide</strong>

<p>Where you actually <em>build</em> the rocket with your own hands—implementing 20 modules and historical milestones from scratch with tests and the <code>tito</code> CLI.</p>
</div>
...
**TinyTorch: The Textbook.** *From Tensors to Transformers* provides the architectural commentary: formal systems invariants, physical memory traces, napkin-math budgets, and complete instructor solutions.

**TinyTorch: The Lab Guide.** This is where you actually *build* the rocket with your own hands—implementing 20 modules and historical milestones from scratch with tests and the `tito` CLI.
