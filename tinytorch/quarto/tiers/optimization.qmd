...
![](../assets/images/svg/tiers-optimization-dependencies.svg){fig-alt="Optimization tier dependency diagram. M14 Profiling at top fans out to four parallel modules (M15 Quantization, M16 Compression, M17 Acceleration, M18 Memoization), all converging on M19 Benchmarking at the bottom. M19 has emphasis styling as the tier terminus."}
