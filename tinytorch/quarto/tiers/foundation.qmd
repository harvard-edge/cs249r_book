...
::: {#fig-foundation-deps}
![](../assets/images/svg/tiers-foundation-dependencies.svg){fig-alt="Foundation tier dependency diagram. Eight modules arranged top-to-bottom: M01 Tensor and M02 Activations in parallel at the top, both feeding M03 Layers, then sequentially M04 Losses, M05 DataLoader, M06 Autograd, M07 Optimizers, M08 Training. M08 has a thicker border marking it as the tier capstone."}
...
::: {#fig-foundation-milestones fig-env="figure" fig-pos="htb" fig-cap="**Foundation tier milestones.** After completing modules 01-08, you unlock three historical checkpoints spanning three decades — Rosenblatt's Perceptron forward pass (1958), the XOR limitation that triggered the AI Winter (1969), and the MLP revival with backpropagation on TinyDigits (1986)." fig-alt="Horizontal timeline with three red year pills (1958, 1969, 1986) dropping to three blue milestone cards: Perceptron with binary classification; XOR Crisis demonstrating the single-layer limitation; MLP Revival training on TinyDigits via backpropagation."}
...
- **[ Torch Olympics](olympics.qmd)** (Module 20): Compete in ML systems challenges


**[← Back to Home](../index.qmd)** | **[Module Workflow](../tito/modules.qmd)**
