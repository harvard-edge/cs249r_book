...
::: {#fig-18_memoization-diag-1 fig-env="figure" fig-pos="htb" fig-cap="**TinyTorch KV Caching**: Reusing previous computations to speed up text generation." fig-alt="Diagram of the TinyTorch KV cache: each transformer layer holds pre-allocated key and value tensors, new token projections append at the current sequence position, and cached K and V are retrieved together for attention computation during autoregressive generation."}
