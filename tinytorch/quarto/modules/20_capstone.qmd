...
::: {#fig-20_capstone-diag-1 fig-env="figure" fig-pos="htb" fig-cap="**TinyTorch Benchmarking System**: Statistical measurement of performance and accuracy." fig-alt="Diagram showing test cases, metrics collection, and comparison engine."}
