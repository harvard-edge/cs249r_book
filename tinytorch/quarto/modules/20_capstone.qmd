...
The trade-off is fundamental: **batching trades latency for throughput.** A user-facing API optimizes the former; a nightly pipeline optimizes the latter. Knowing which one you're building dictates how you measure.
