...
#| lst-cap: "**Embedding forward pass**. NumPy fancy indexing replaces a one-hot matmul, making lookup O(1) per token."
#| eval: false
...
#| lst-cap: "**PositionalEncoding forward pass**. Slices position embeddings to current sequence length and adds them to token embeddings while preserving gradient flow."
#| eval: false
