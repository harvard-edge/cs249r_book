...
#| lst-cap: "**Masked softmax and value-weighted sum**. Adds `-1e9` at masked positions, normalizes via softmax, then weights values to produce the attended output."
#| eval: false
