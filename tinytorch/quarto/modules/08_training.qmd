...
- **Gradient accumulation decouples memory from effective batch size:** 32 samples in memory, serially accumulated 4× gives the mathematically identical update of a 128-batch — trading wall-clock time for an artificially expanded memory horizon.
