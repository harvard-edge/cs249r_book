...
That is why kernel size matters. A 7×7 kernel requires (7×7)/(3×3) = 5.4× more computation than 3×3, so modern architectures stack multiple 3×3 convolutions rather than reach for a single large kernel.
