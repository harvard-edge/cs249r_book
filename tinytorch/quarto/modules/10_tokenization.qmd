...
The attention savings (62,500 → 5,625, an 11× reduction *per layer*) dwarf the embedding cost (200 KB → 97.7 MB, a one-time fixed cost) once you stack twelve, twenty-four, or ninety-six transformer layers. That math is the entire reason production language models pay for big vocabularies.
