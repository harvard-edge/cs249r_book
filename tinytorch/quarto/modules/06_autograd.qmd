...
#| lst-cap: "**`AddBackward` stores inputs and distributes the incoming gradient equally to both addends.**"
#| eval: false
...
#| lst-cap: "**`MulBackward` applies the product rule with NumPy broadcasting instead of explicit loops.**"
#| eval: false
...
#| lst-cap: "**`MatmulBackward` turns one forward matmul into two backward matmuls, the source of the 2x backward-to-forward FLOP ratio.**"
#| eval: false
