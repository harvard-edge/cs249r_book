...
@tbl-04-losses-implementation-roadmap lays out the implementation in order, one part at a time.
...
@tbl-04-losses-function-summary gives the mathematical form, output range, and typical use case of each.
...
: **Constructor, forward signature, and use case for each loss.** {#tbl-04-losses-function-summary}
...
#| lst-cap: "**Mean squared error forward pass: subtract, square, average.**"
#| eval: false
