...
Now there are only two memory operations: read the input, write the output. For the same 4,000,000-element tensor that's 31 MB of traffic in 0.64 ms. The fused version is 7.0x faster on identical math — purely from doing less memory I/O.
