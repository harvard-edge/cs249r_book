...
#| lst-cap: "**Dropout forward pass with inverted scaling `1/(1-p)` to preserve expected magnitude.**"
#| eval: false
...
#| lst-cap: "**Sequential container chaining forward passes and flattening per-layer parameters.**"
#| eval: false
class Sequential:
