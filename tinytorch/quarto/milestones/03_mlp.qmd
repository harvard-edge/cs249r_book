...
MLPs treat images as flat vectors, ignoring spatial structure. A 28×28 image has 784 pixels — the MLP doesn't know that pixel (0,0) is near pixel (0,1). **Milestone 04** (CNN) shows why **convolutional** layers dramatically improve image recognition.
