...
| 17 Acceleration | Runtime optimization improves arithmetic intensity and reduces memory traffic. | `vectorized-matmul`, `fused-gelu`, `tiled-matmul`, `im2col`, `im2col-conv2d` | `unfused-gelu` baseline, analysis helpers, profiler demo | tile tuning, cache behavior, fusion benchmarks, col2im backward |
