...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?labpath=tinytorch%2Fmodules%2F12_attention%2F12_attention.ipynb)
...
| Aspect | Your Tiny🔥Torch Implementation | PyTorch Production |
|--------|-------------------------------|-------------------|
...
**What you just built:**
```python
# Your Tiny🔥Torch attention implementation
...
:link: https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?filepath=modules/12_attention/attention_dev.ipynb
...
:link: https://colab.research.google.com/github/harvard-edge/cs249r_book/blob/main/modules/12_attention/attention_dev.ipynb
:class-header: bg-light
...
:link: https://github.com/harvard-edge/cs249r_book/blob/main/modules/12_attention/attention_dev.ipynb
:class-header: bg-light
