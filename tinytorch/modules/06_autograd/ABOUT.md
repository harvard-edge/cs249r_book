...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?labpath=tinytorch%2Fmodules%2F05_autograd%2F05_autograd.ipynb)
...
**What you just built:**
```python
# Your Tiny🔥Torch autograd implementation
from tinytorch.core.tensor import Tensor
...
:link: https://mybinder.org/v2/gh/harvard-edge/cs249r_book/main?filepath=modules/05_autograd/autograd.ipynb
...
:link: https://colab.research.google.com/github/harvard-edge/cs249r_book/blob/main/modules/05_autograd/autograd.ipynb
:class-header: bg-light
...
:link: https://github.com/harvard-edge/cs249r_book/blob/main/modules/05_autograd/autograd.py
:class-header: bg-light
