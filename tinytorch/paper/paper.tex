...
\usepackage[
  ...
  style=authoryear,
  natbib=true,
  maxbibnames=10,     % Show max 10 authors in bibliography, then "et al."
  maxcitenames=2,     % Show max 2 authors in citations, then "et al."
  minbibnames=1,      % Show at least 1 author before "et al."
  mincitenames=1,
...
\begin{tikzpicture}[
    ...
    foundation/.style={rectangle, draw=blue!70, fill=blue!20, text=black, minimum width=2.0cm, minimum height=0.5cm, anchor=east},
    enhanced/.style={rectangle, draw=orange!80, fill=orange!30, text=black, font=\scriptsize\bfseries, minimum width=2.0cm, minimum height=0.5cm, anchor=west}
]
...
% Module 06 enhancement boundary - thicker and highlighted
\draw[red!60, very thick] (6, 0) -- (6, 5.5);
\node[above, font=\scriptsize\bfseries, red!70] at (6, 5.7) {ENHANCE};
...
\node[enhanced, minimum width=1.2cm, minimum height=0.4cm, anchor=center] at (5.5, -1.2) {Enhanced};
...
\textbf{Intentional Gap.} One cell remains uncovered by design:

\begin{itemize}[leftmargin=*, itemsep=2pt]
\item \textbf{Pipelines-Optimizes} (parallel data loading, GPU prefetch): Requires multi-threaded I/O and GPU memory management beyond CPU-only scope. Students understand concepts through M05 but don't implement production-grade parallel loaders.
\end{itemize}
