...
In accordance with ACM policy on authorship, we disclose that generative AI tools (Claude) were used during the preparation of this manuscript for proofreading, copyediting, and improving clarity of exposition. The authors take full responsibility for all content, including any AI-assisted text. No AI tools were used to generate the core intellectual contributions, research design, curriculum structure, or pedagogical framework presented in this work.
