...
SICP~\citep{fry1985} taught programming through building interpreters and evaluators from scratch, despite real languages already existing. The core philosophy: to understand a system, build one. This principle, validated across five decades of CS education, grounds TinyTorch's design.
...
This section presents TinyTorch's curriculum architecture. The design draws on four learning theories: constructionism~\citep{wooster1982} (learning through building artifacts), cognitive apprenticeship~\citep{collins2018} (making expert thinking visible), productive failure~\citep{kapur2008} (struggling before instruction), and threshold concepts~\citep{meyer2003threshold} (transformative ideas requiring mastery). These principles shaped the competency framework and module progression that follow.
