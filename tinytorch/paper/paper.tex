...
% Essential packages
% For arXiv compatibility, use standard fonts instead of fontspec
...
% Use natbib for arXiv compatibility (biblatex/biber can cause issues)
...
\makeatother
% Note: emoji package removed for arXiv compatibility
% Define empty command to ignore emoji calls
\newcommand{\emoji}[1]{}
\usepackage{tikz}
