...
export function renderLayout() {
    ...
    const googleLoginUrl = `${NETLIFY_URL}/api/auth/google?returnTo=${encodeURIComponent(returnTo)}`;
    const githubLoginUrl = `${NETLIFY_URL}/api/auth/github?returnTo=${encodeURIComponent(returnTo)}`;
        ...
        <div class="auth-overlay" id="authOverlay">
            <div class="auth-modal">
                ...
                <div class="social-login-buttons">
                    ...
                    <a href="${githubLoginUrl}" class="social-btn github-btn">
