...
- Measured honestly against the cost of pure-NumPy execution: the optional
  CIFAR-10 quick run reaches 37% on ten classes where guessing gets 10%
...
<table width="100%" style="width:100%">
  ...
  <tbody>
    ...
    <tr>
      <td>✅ NBGrader classroom autograding (student and instructor tiers; the challenge tier has no annotated regions yet)</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
...
│   ├── 01_tensor/              # Auto-generated by `tito module start 01`
│   │   └── tensor.ipynb        # The notebook you implement in
...
**Legend:** 🪲 Bug Hunter · 🧑‍💻 Code Warrior · ✍️ Documentation · 🎨 Design · 🧠 Ideas · 🔎 Reviewer · 🧪 Testing · 🛠️ Tooling
