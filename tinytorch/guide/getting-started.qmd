...
![Executing Milestone 01 (`tito milestone run perceptron`): validating module prerequisites, executing the forward pass with unlearned weights, and diagnosing the random decision boundary.](assets/images/screenshots/milestone_01_run.png){#fig-milestone-01-terminal fig-alt="Terminal execution screenshot of tito milestone run perceptron showing module prerequisites passing, 2D synthetic data clustering, forward pass predictions with 33.3% accuracy, and the random decision boundary diagnosis."}
