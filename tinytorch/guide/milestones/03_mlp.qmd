...
python milestones/03_1986_mlp/01_rumelhart_tinydigits.py
```
...
|---------------|---------|------------|----------|---------------|
| Part 1 (`02_xor_solved.py`) | 4 examples | small | 100% | <1 min |
| Part 2 (`01_rumelhart_tinydigits.py`) | 1K train, 8×8 | ~2.4K | 85%+ | 3–5 min |
