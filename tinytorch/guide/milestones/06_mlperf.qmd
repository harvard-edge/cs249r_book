...
|:---|---:|:---:|---:|:---:|
| **Baseline FP32** | 9,640 B | 86.5% | 0.023 ± 0.001 ms | ● Dominated |
| **INT8 Quantized** | 2,442 B | 86.5% | 0.023 ± 0.003 ms | ★ **Pareto** |
| **50% Pruned** | 9,640 B | 86.0% | 0.027 ± 0.001 ms | ● Dominated |
...
|:---|---:|:---:|---:|:---:|
| **Baseline FP32** | 2,664 B | 100.0% | 1.416 ± 0.105 ms | ★ **Pareto** |
| **INT8 Quantized** | 714 B | 100.0% | 1.289 ± 0.235 ms | ★ **Pareto** |
| **50% Pruned** | 2,664 B | 95.0% | 1.246 ± 0.087 ms | ● Dominated |
...
|:---|---:|:---:|---:|:---:|
| **Baseline FP32 (Recompute)** | 113,152 B | 100.0% | 4.938 ± 1.333 ms | ● Dominated |
| **INT8 Quantized (Recompute)** | 28,584 B | 100.0% | 4.806 ± 1.350 ms | ★ **Pareto** |
| **KV-Cached (Mod 18)** | 129,536 B | 100.0% | 3.420 ± 0.205 ms | ★ **Pareto** |
| **Full Stack (Quant+Cache)** | 44,968 B | 100.0% | 3.443 ± 0.331 ms | ★ **Pareto (Peak)** |
