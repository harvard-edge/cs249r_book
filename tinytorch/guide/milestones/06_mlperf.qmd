...
tito milestone run 06 --part 1   # optimize the digit MLP: profile, quantize, prune, benchmark
...
|-----------|----------------|----------------------|-------------------|
| Baseline | Dense FP32 | Measured reference (86.5% in our run) | Parameter bytes (9,640) |
| Rounded weights | Dense FP32 | Measured independently (86.5%) | Modeled INT8 code bytes, excluding metadata (2,442, 3.9× smaller) |
| Pruned weights | Dense FP32 | Measured independently (86.0%) | Zero fraction |
...
Small workloads can be slower with caching. Output agreement is required; speedup is an experimental result. On the laptop we measured, the cached replay was 1.62× faster for a two-layer model.
