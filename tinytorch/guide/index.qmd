...
<span class="approach-text"><strong>Recreate history</strong> — Perceptron → CNN → TinyGPT → MLPerf.</span>
</div>
<div class="approach-item">
...
<div class="ml-timeline-desc">Train TinyGPT from scratch on Shakespeare — the foundation of ChatGPT</div>
