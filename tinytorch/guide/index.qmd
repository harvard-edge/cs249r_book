...
<span class="approach-text"><strong>Recreate history</strong> — Perceptron → CNN → Transformers → TinyGPT → MLPerf.</span>
</div>
<div class="approach-item">
...
<div class="ml-timeline-desc">Production optimization (measure compression and speed, do not assume them)</div>
<div class="ml-timeline-tech">Profile → Compress → Accelerate</div>
</div>
</div>
<div class="ml-timeline-item left tinygpt">
<div class="ml-timeline-dot"></div>
<div class="ml-timeline-content">
<div class="ml-timeline-year">2020–2022</div>
<div class="ml-timeline-title">Generative LLM (TinyGPT)</div>
<div class="ml-timeline-desc">Autoregressive next-token prediction and text synthesis (the foundation of ChatGPT)</div>
<div class="ml-timeline-tech">Tokens → Embeddings → Causal MHA + MLP → Sampling</div>
</div>
</div>
</div>
...
Three progressive tiers take you from foundations to production systems, then a standalone capstone:
