...
::: {#fig-foundation-milestones fig-env="figure" fig-pos="htb" fig-cap="**Foundation milestones.** The Perceptron forward pass requires modules 01 through 03. The XOR and MLP training milestones require modules 01 through 08 and use the training components students implement." fig-alt="The Perceptron forward pass requires modules 01 through 03. The XOR and MLP training milestones require modules 01 through 08 and use the training components students implement."}
