...
<li><strong>Vision focus</strong> &mdash; Foundation (01&ndash;08) &rarr; Convolutions (09) &rarr; Optimization (14&ndash;19) <em>(Modules 14 and 18 build on the transformer stack in 10&ndash;13)</em></li>
...
<strong>Type the code the module asks you for</strong>
...
**Next step.** Follow the [Quick Start Guide](getting-started.qmd) to set up your environment (about 5 minutes), complete Module 01: Tensor (4–6 hours), and watch your first tests pass.
