...
::: {#fig-01_tensor-diag-2 fig-env="figure" fig-pos="htb" fig-cap="**Broadcasting reuses a vector across rows.** Adding rows [1, 2, 3] and [4, 5, 6] to vector [10, 20, 30] produces [11, 22, 33] and [14, 25, 36]. Trailing axes must match or have size one; the result has new storage. The vector is reused across rows during arithmetic; the result has newly allocated storage." fig-alt="Adding rows [1, 2, 3] and [4, 5, 6] to vector [10, 20, 30] produces [11, 22, 33] and [14, 25, 36]. Trailing axes must match or have size one; the result has new storage."}
