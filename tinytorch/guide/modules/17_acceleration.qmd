...
- **Lower** a convolution to one matrix multiply with im2col, and measure its speed against Module 09's loops and its memory cost
...
- The backward pass through im2col (col2im); `im2col_conv2d` is inference-only, like the other helpers here
