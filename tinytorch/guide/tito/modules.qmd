...
::: {#fig-tito-module-workflow fig-env="figure" fig-pos="htb" fig-cap="**Module development workflow.** Start or resume a notebook, implement the exercises and run inline checks, validate and export with tito module complete, and inspect module status before continuing." fig-alt="Start or resume a notebook, implement the exercises and run inline checks, validate and export with tito module complete, and inspect module status before continuing."}
...
- Exports code to `tinytorch/core/layers.py`
...
2. Shows a status panel with the module, your progress, and its milestone
3. Provides clean starting point
4. Refuses if the module is already started; use `tito module resume`
...
4. **Makes read-only** exported files (protection)
...
├── perf/ ← modules 14-19 land here
└── olympics.py ← module 20
```
