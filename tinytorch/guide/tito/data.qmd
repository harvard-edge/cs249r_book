...
::: {#fig-tito-progress-tracking fig-env="figure" fig-pos="htb" fig-cap="**Track implementation and milestone progress.** Complete and export modules, run the milestones their prerequisites unlock, and inspect module and milestone status through TITO." fig-alt="Complete and export modules, run the milestones their prerequisites unlock, and inspect module and milestone status through TITO."}
