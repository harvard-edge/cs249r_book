...
::: {#fig-cmd-system-health fig-env="figure" fig-pos="htb" fig-cap="**System health diagnostic.** `tito system health` verifies environment readiness across eleven components, then checks notebook readiness." fig-alt="Terminal output of tito system health."}
...
One environment variable changes how `tito` runs:
