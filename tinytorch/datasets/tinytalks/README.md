...
@dataset{tinytalks2025,
  ...
  year={2025},
  publisher={GitHub},
  url={https://github.com/harvard-edge/cs249r_book/tree/main/tinytorch/tree/main/datasets/tinytalks},
  version={1.0.0}
}
```

**Text citation:**  
TinyTorch Contributors. (2025). TinyTalks: A Conversational Q&A Dataset for Educational Transformers (Version 1.0.0). https://github.com/harvard-edge/cs249r_book/tree/main/tinytorch
...
- **Issues:** [GitHub Issues](https://github.com/harvard-edge/cs249r_book/tree/main/tinytorch/issues)
- **Discussions:** [GitHub Discussions](https://github.com/harvard-edge/cs249r_book/tree/main/tinytorch/discussions)
