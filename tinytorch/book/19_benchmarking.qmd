...
2. **High-resolution monotonic timing**: Measuring with a monotonic clock (`time.perf_counter`) and, on asynchronous hardware, waiting for queued work to finish before reading it.
