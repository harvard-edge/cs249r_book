...
![**Memory Footprint during Training**: While model parameters are relatively small, the forward activations saved for the backward pass dominate memory requirements.](assets/images/generated_plots/06_autograd_memory_footprint.pdf){#fig-autograd-memory-footprint}
