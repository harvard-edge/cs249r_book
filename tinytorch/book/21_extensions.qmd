...
::: {.column-margin}
![](assets/images/diagrams/21_framework-you-are-here.svg){width="100%" fig-alt="TinyTorch execution datapath blueprint highlighting Module 21 Extensions as the active subsystem."}

*Framework Blueprint: Module 21 reaches beyond the educational interpreter to examine graph compilers, custom GPU kernels, and TPU systolic arrays.*
:::
...
::: {.column-margin}
![](assets/images/diagrams/21_ext-margin-source.svg){width="100%" fig-alt="Source code mapping card for Module 21 Extensions showing file path, exported package, and tested primitives."}

*Source Code Mapping: Module 21 presents architectural models of computational graph capture, Triton GPU execution, and 2D systolic array hardware.*
:::
