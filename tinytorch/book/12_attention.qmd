...
![Self-attention complexity scales quadratically with sequence length $O(N^2)$, fundamentally limiting context windows compared to linear scaling models.](assets/images/generated_plots/chapter_12_attention_complexity.pdf){#fig-attn-complexity}
