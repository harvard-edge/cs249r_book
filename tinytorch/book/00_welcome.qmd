...
2. **Part II: Deep Architectures (Chapters 09–13, Milestone II)** constructs spatial and sequential building blocks. Milestone 05 validates the **basic transformer mechanism** on synthetic sequence routing challenges (reversal, copy, mixed tasks). With the core attention primitives proven, we construct **TinyGPT** as our performance-oriented flagship model, establishing its baseline autoregressive decoding loop and highlighting its $O(S^2)$ prefix recomputation bottleneck.
...
: **The Six Milestones of TinyTorch**: Chronological breakthroughs in machine learning history and their alignment with the book's milestone chapters. {#tbl-milestones-curriculum tbl-colwidths="[12,18,16,36,18]"}
