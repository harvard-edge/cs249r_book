...
::: {.column-margin}
**Source Code Mapping**: Every listing in this section is extracted directly from Module 05 (`src/05_dataloader/05_dataloader.py`). `Dataset` abstracts indexed sample access, `DataLoader` manages index shuffling and batching, and `_collate_batch` stacks sample arrays into contiguous tensors.
:::
