...
::: {.column-margin}
**Source Code Mapping**: Every listing in this section is extracted directly from Module 02 (`src/02_activations/02_activations.py`). ReLU, sigmoid, tanh, and GELU are elementwise; Softmax normalizes across a specified tensor reduction axis.
:::
