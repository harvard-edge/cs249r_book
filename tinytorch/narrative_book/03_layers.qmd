...
::: {.column-margin}
**Source Code Mapping**: Every listing in this section is extracted directly from Module 03 (`src/03_layers/03_layers.py`). `Linear` owns parameters, `Dropout` alters behavior via `training`, and `Sequential` composes modules and unifies parameter discovery.
:::
