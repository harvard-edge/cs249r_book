...
@sec-quantization mapped each weight onto an integer grid and calculated the storage a packed INT8 representation would need. TinyTorch still holds those codes in float32 arrays, and the matrices themselves have not changed shape. A $4096 \times 4096$ layer still has 16.8 million cells, and every one of them is read and multiplied on every forward pass, whether or not the value in it matters.
...
::: {.column-margin}
<img src="assets/images/diagrams/16_compression-margin-temperature.svg" width="100%"/>
