...
::: {.column-margin}
**Source Code Mapping**: Every listing in this section is extracted directly from Module 01 (`src/01_tensor/01_tensor.py`). The stride model demonstrates the low-level arithmetic that NumPy executes beneath the `Tensor` wrapper.
:::
