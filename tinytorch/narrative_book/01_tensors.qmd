...
The bias trace is the stride-0 mechanism in the open. After padding, the vector has shape $(1, 3)$ and strides $(0, 1)$; stretching the first dimension from 1 to 2 leaves the zero in place, and NumPy reports the same thing as `(0, 4)`. Every coordinate of the $(2, 3)$ view resolves to one of three slots, as the repeated indices in @tbl-stride0-trace show.
