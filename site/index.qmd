...
<div class="mls-landing-grid">
  <div class="mls-landing-left">
    <p class="mls-hero-eyebrow">FOUR-VOLUME TEXTBOOK SERIES</p>
  ...
  <div class="mls-landing-right">
    <div class="mls-volumes">
      ...
      <div class="mls-vol-card">
        <a href="vol3/" class="mls-vol-card-link" title="Open Volume III">
          <span class="mls-vol-cover-wrap"><img src="covers/cover-hardcover-book-vol3.webp" alt="Volume III cover" class="mls-vol-cover" loading="lazy" /></span>
        ...
        <p class="mls-vol-downloads">
          ...
          <a href="vol3/" target="_blank" rel="noopener">HTML</a>
          <span class="mls-status-badge">In Progress</span>
        </p>
      </div>
      <div class="mls-vol-card">
        <a href="vol4/" class="mls-vol-card-link" title="Open Volume IV">
          <span class="mls-vol-cover-wrap"><img src="covers/cover-hardcover-book-vol4.webp" alt="Volume IV cover" class="mls-vol-cover" loading="lazy" /></span>
          <p class="mls-vol-title">Volume IV</p>
          <p class="mls-vol-subtitle">Physical AI: Machine Learning Systems</p>
        </a>
        <p class="mls-vol-downloads">
          <span class="visually-hidden">Volume IV downloads:</span>
          <a href="vol4/" target="_blank" rel="noopener">HTML</a>
          <a href="vol4/assets/downloads/Machine-Learning-Systems-Vol4.pdf" target="_blank" rel="noopener">PDF</a>
        </p>
      </div>
    </div>
  </div>
