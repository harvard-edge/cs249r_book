...
// Refresh the star count on every page load, exact rather than rounded, so
// the number visibly moves as the repo gains stars. The build injects a
// current value for first paint; this call is what keeps a CDN-cached page
// from showing a stale count for the length of its TTL.
