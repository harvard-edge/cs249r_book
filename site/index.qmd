    ...
    <div class="mls-volumes">
      ...
      <div class="mls-vol-card mls-vol-card-wip">
        ...
        <p class="mls-vol-downloads">
          ...
          <a href="vol3/" target="_blank" rel="noopener">HTML (Draft)</a>
          <a href="vol3/assets/downloads/Machine-Learning-Systems-Vol3.pdf" target="_blank" rel="noopener">PDF (Draft)</a>
          <span class="mls-vol-wip-tag">Work in Progress</span>
        </p>
      </div>
      <div class="mls-vol-card mls-vol-card-wip">
        ...
        <p class="mls-vol-downloads">
          ...
          <a href="vol4/" target="_blank" rel="noopener">HTML (Draft)</a>
          <a href="vol4/assets/downloads/Machine-Learning-Systems-Vol4.pdf" target="_blank" rel="noopener">PDF (Draft)</a>
          <span class="mls-vol-wip-tag">Work in Progress</span>
        </p>
      </div>
    </div>
