...
pagetitle: "Machine Learning Systems: The AI Engineering Textbook (Harvard & MIT Press)"
description: "The definitive four-volume open textbook series on Machine Learning Systems by Prof. Vijay Janapa Reddi (Harvard University & MIT Press). Covering Foundations, Distributed Scale, Agentic AI, and Physical AI."
keywords:
...
<div class="mls-landing-grid">
  <div class="mls-landing-left">
    <p class="mls-hero-eyebrow">FOUR-VOLUME SERIES</p>
    <h1 class="mls-hero-title">Machine Learning<br/>Systems.</h1>
    <p class="mls-hero-tagline">The physics of AI engineering.</p>
    <p class="mls-hero-intro">A rigorous, principles-first treatment of how ML systems are built, optimized, and deployed — from single machines and distributed scale to autonomous agents and physical embodiment.</p>
    <div class="mls-hero-meta">
      ...
      <p class="mls-hero-edition">
        ...
        <span>Last updated <span id="mls-edition-date">{{stats.last_updated}}</span></span>
        <span class="mls-edition-sep" aria-hidden="true">&middot;</span>
  ...
  <div class="mls-landing-right">
    <div class="mls-volumes">
      <div class="mls-vol-card">
        <a href="vol1/" class="mls-vol-card-link" title="Open Volume I: Foundations">
          <span class="mls-vol-cover-wrap"><img src="covers/cover-hardcover-book-vol1.webp" alt="Volume I cover" class="mls-vol-cover" loading="lazy" /></span>
          <p class="mls-vol-title">Volume I</p>
          <p class="mls-vol-subtitle">Introduction to Machine Learning Systems</p>
        </a>
        <div class="mls-vol-downloads">
          <span class="visually-hidden">Volume I downloads:</span>
          <span class="mls-vol-dl-label">Formats</span>
          <div class="mls-vol-format-group">
            <a href="vol1/" class="mls-vol-chip" target="_blank" rel="noopener">HTML</a>
            <a href="vol1/assets/downloads/Machine-Learning-Systems-Vol1.pdf" class="mls-vol-chip" target="_blank" rel="noopener">PDF</a>
            <a href="vol1/assets/downloads/Machine-Learning-Systems-Vol1.epub" class="mls-vol-chip" target="_blank" rel="noopener">EPUB</a>
          </div>
        </div>
      </div>
      <div class="mls-vol-card">
        <a href="vol2/" class="mls-vol-card-link" title="Open Volume II: Scaling">
          <span class="mls-vol-cover-wrap">
            <span class="mls-vol-badge-preview">Preview</span>
            <img src="covers/cover-hardcover-book-vol2.webp" alt="Volume II cover" class="mls-vol-cover" loading="lazy" />
          </span>
          <p class="mls-vol-title">Volume II</p>
          <p class="mls-vol-subtitle">Scaling Machine Learning Systems</p>
        </a>
        <div class="mls-vol-downloads">
          <span class="visually-hidden">Volume II downloads:</span>
          <span class="mls-vol-dl-label">Formats</span>
          <div class="mls-vol-format-group">
            <a href="vol2/" class="mls-vol-chip" target="_blank" rel="noopener">HTML</a>
            <a href="vol2/assets/downloads/Machine-Learning-Systems-Vol2.pdf" class="mls-vol-chip" target="_blank" rel="noopener">PDF</a>
            <a href="vol2/assets/downloads/Machine-Learning-Systems-Vol2.epub" class="mls-vol-chip" target="_blank" rel="noopener">EPUB</a>
          </div>
        </div>
      </div>
      <div class="mls-vol-card mls-vol-card-wip">
        <a href="vol3/" class="mls-vol-card-link" title="Open Volume III: Agentic (Draft)">
          <span class="mls-vol-cover-wrap">
            <span class="mls-vol-badge-wip">Draft</span>
            <img src="covers/cover-hardcover-book-vol3.webp" alt="Volume III cover" class="mls-vol-cover" loading="lazy" />
          </span>
          <p class="mls-vol-title">Volume III</p>
          <p class="mls-vol-subtitle">Agentic Machine Learning Systems</p>
        </a>
        <div class="mls-vol-downloads">
          <span class="visually-hidden">Volume III downloads:</span>
          <span class="mls-vol-dl-label">Formats</span>
          <div class="mls-vol-format-group">
            <a href="vol3/" class="mls-vol-chip" target="_blank" rel="noopener">HTML</a>
            <a href="vol3/assets/downloads/Machine-Learning-Systems-Vol3.pdf" class="mls-vol-chip" target="_blank" rel="noopener">PDF</a>
            <a href="vol3/assets/downloads/Machine-Learning-Systems-Vol3.epub" class="mls-vol-chip" target="_blank" rel="noopener">EPUB</a>
          </div>
        </div>
      </div>
      <div class="mls-vol-card mls-vol-card-wip">
        <a href="vol4/" class="mls-vol-card-link" title="Open Volume IV: Physical AI (Draft)">
          <span class="mls-vol-cover-wrap">
            <span class="mls-vol-badge-wip">Draft</span>
            <img src="covers/cover-hardcover-book-vol4.webp" alt="Volume IV cover" class="mls-vol-cover" loading="lazy" />
          </span>
          <p class="mls-vol-title">Volume IV</p>
          <p class="mls-vol-subtitle">Physical AI Systems</p>
        </a>
        <div class="mls-vol-downloads">
          <span class="visually-hidden">Volume IV downloads:</span>
          <span class="mls-vol-dl-label">Formats</span>
          <div class="mls-vol-format-group">
            <a href="vol4/" class="mls-vol-chip" target="_blank" rel="noopener">HTML</a>
            <a href="vol4/assets/downloads/Machine-Learning-Systems-Vol4.pdf" class="mls-vol-chip" target="_blank" rel="noopener">PDF</a>
            <a href="vol4/assets/downloads/Machine-Learning-Systems-Vol4.epub" class="mls-vol-chip" target="_blank" rel="noopener">EPUB</a>
          </div>
        </div>
      </div>
    </div>
...
<section class="mls-section mls-section-richcards" id="curriculum">
  ...
  <div class="mls-cards-header">
    ...
    <a class="mls-playground-cta" href="games/">Play a short systems game →</a>
  </div>
  ...
  <div class="mls-rich-grid">
    ...
    <a href="labs/" class="mls-rich-card" data-accent="explore">
      ...
      <div class="mls-rich-card-demo">
        <svg viewBox="0 0 300 170" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
          ...
          <text x="10" y="15" font-size="8.5" fill="#2d6da3" font-weight="700" font-family="Inter,Helvetica,sans-serif">{{stats.latest_lab}}</text>
    ...
    <a href="tinytorch/" class="mls-rich-card" data-accent="build">
      <div class="mls-rich-card-info">
        ...
        <p class="mls-cur-desc">Build your own ML framework from scratch across {{stats.tinytorch_modules}} progressive modules. Zero magic.</p>
      </div>
      <div class="mls-rich-card-demo">
    ...
    <a href="instructors/" class="mls-rich-card" data-accent="adopt">
      ...
      <div class="mls-rich-card-demo">
        <svg viewBox="0 0 260 140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
          ...
          <text x="142" y="46" font-size="7" fill="#333" font-weight="700" font-family="Inter,sans-serif">Semester 2: Scaling</text>
    ...
    <a href="slides/" class="mls-rich-card" data-accent="teach">
      <div class="mls-rich-card-info">
        ...
        <p class="mls-cur-desc">{{stats.slide_decks}} Beamer decks with speaker notes and {{stats.slide_svgs}} original SVG diagrams. Drop in and teach.</p>
      </div>
      <div class="mls-rich-card-demo">
        <svg viewBox="0 0 260 140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
    ...
    <a href="newsletter/" class="mls-rich-card" data-accent="follow">
      ...
      <div class="mls-rich-card-demo">
        <svg viewBox="0 0 260 140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
          ...
          <text x="32" y="47" font-size="7.5" fill="#555" font-family="Inter,sans-serif">New: Vol II Ch. {{stats.vol2_ch.fault_tolerance}} — Fault Tolerance</text>
          <circle cx="22" cy="62" r="3.5" fill="#4a90c4"/>
          <text x="32" y="65" font-size="7.5" fill="#555" font-family="Inter,sans-serif">Updated: TinyTorch Module {{stats.tinytorch_modules}}</text>
          <circle cx="22" cy="80" r="3.5" fill="#c87b2a"/>
          <text x="32" y="83" font-size="7.5" fill="#555" font-family="Inter,sans-serif">Community: {{stats.merged_prs}} PRs merged</text>
          <circle cx="22" cy="98" r="3.5" fill="#6a4da8"/>
          <text x="32" y="101" font-size="7.5" fill="#555" font-family="Inter,sans-serif">Milestone: {{stats.stars_rounded}} GitHub stars</text>
          <!-- Footer -->
          <line x1="16" y1="114" x2="248" y2="114" stroke="#e2e8f0" stroke-width="0.8"/>
          <text x="132" y="128" font-size="7" fill="#94a3b8" text-anchor="middle" font-weight="600" font-family="Inter,sans-serif">Join {{stats.subscribers}} subscribers</text>
        </svg>
      </div>
    </a>
...
<section class="mls-section mls-section-impact" id="support">
  ...
  <div class="mls-reader-map">
    ...
    <p class="mls-map-caption">Live readership — {{stats.readers_monthly}} readers a month on average across {{stats.countries}} countries and territories</p>
    <p class="mls-map-countries"><span class="mls-map-countries-label">Top countries:</span> {{stats.top_countries}}</p>
  </div>

  <!-- Taught at: one row of course cards drifting past, each a link to its
       course page, in a fresh random order and from a random starting point
       on each visit. One row, not two: opposing motions compete for the eye
       and the course line needs a steady row to be read.
       Rendered in the browser from adopters.json (embedded at post-render by
       scripts/build_adopters.py, then refreshed from /adopters.json on load),
       so the scheduled refresh updates it without a rebuild. -->
  <div class="mls-taught" id="mls-taught">
    <div class="mls-taught-head">
      <p class="mls-taught-eyebrow">TAUGHT AT</p>
      <button class="mls-taught-toggle" type="button" aria-pressed="false" aria-label="Pause scrolling">
        <svg viewBox="0 0 12 12" width="10" height="10" aria-hidden="true"><rect class="i-pause" x="2" y="1.5" width="2.6" height="9" rx=".6"/><rect class="i-pause" x="7.4" y="1.5" width="2.6" height="9" rx=".6"/><path class="i-play" d="M3 1.6v8.8l7.2-4.4z"/></svg>
      </button>
    </div>
    <div class="mls-taught-viewport">
      <ul class="mls-taught-row" aria-live="off"></ul>
    </div>
    <p class="mls-taught-caption"><a href="community/courses.html">See the courses&nbsp;&rarr;</a><span class="mls-taught-sep" aria-hidden="true">&middot;</span><a href="community/courses.html?view=schools">Is your school here?</a></p>
  </div>
  <!-- adopters:strip -->

  <div class="mls-impact-bottom">

    <!-- Reach as instrument readings: monospace tabular numerals under small
         unit labels, the way a benchmark table in the book itself reads. The
         figures are exact because a measured number carries more authority
         here than a rounded one. -->
    <dl class="mls-reach">
      <div class="mls-reach-item">
        <dd class="mls-reach-value">{{stats.readers}}</dd>
        <dt class="mls-reach-label">readers</dt>
      </div>
      <div class="mls-reach-item">
      ...
      <div class="mls-reach-item">
        ...
        <dt class="mls-reach-label">avg. a month</dt>
      </div>
    </dl>

    <p class="mls-impact-goal">Our goal: <strong>1,000,000 AI engineers by 2030</strong></p>

    <a href="https://github.com/harvard-edge/cs249r_book" target="_blank" rel="noopener"
       class="mls-star-cta" aria-label="Star Machine Learning Systems on GitHub">
      <span class="mls-star-cta-label">
        <svg width="18" height="18" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" focusable="false"><path d="M8 .25a.75.75 0 01.673.418l1.882 3.815 4.21.612a.75.75 0 01.416 1.279l-3.046 2.97.719 4.192a.75.75 0 01-1.088.791L8 12.347l-3.766 1.98a.75.75 0 01-1.088-.79l.72-4.194L.818 6.374a.75.75 0 01.416-1.28l4.21-.611L7.327.668A.75.75 0 018 .25z"/></svg>
        Star on GitHub
      </span>
      <span class="mls-star-cta-count gh-star-count">{{stats.stars}}</span>
    </a>

    <p class="mls-impact-why">
      Every star helps another engineer find this book.<br/>
      <a href="community/partners.html">Our sponsors and partners</a> keep it free for all of them.
    </p>
  </div>
...
// ── Taught at ─────────────────────────────────────────────────────────────
// A ticker of courses, not a logo wall: each card names the school and the
// course that assigns the book, and links to that course's page. A course
// code is what tells a visiting instructor a peer actually teaches from it.
// Acknowledged early adopters without a public course stay on the adopters
// page. Order is shuffled per visit. The track holds the list twice and
// slides by exactly one copy, so the loop has no seam.
//
// Motion is always stoppable: hover, keyboard focus, a touch, or the pause
// button (WCAG 2.2.2 for motion longer than five seconds). Readers who ask
// for reduced motion get a still row they can scroll themselves.
(function () {
  const root = document.getElementById('mls-taught');
  const embedded = document.getElementById('adp-data');
  if (!root || !embedded) return;
  const rows = [...root.querySelectorAll('.mls-taught-row')];
  const toggle = root.querySelector('.mls-taught-toggle');
  const PX_PER_S = 30;   // slow enough to read a course line as it passes
  const esc = s => String(s == null ? '' : s).replace(/[&<>"]/g, c => ({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;'}[c]));
  const shuffle = a => { for (let i = a.length - 1; i > 0; i--) { const j = Math.floor(Math.random() * (i + 1)); [a[i], a[j]] = [a[j], a[i]]; } return a; };

  function card(s, dup) {
    const c = s.courses[0];
    const course = esc(c.title) + (c.term ? ` <span class="mls-tk-term">${esc(c.term)}</span>` : '');
    const href = c.url ? esc(c.url) : 'community/courses.html';
    return `<li${dup ? ' aria-hidden="true"' : ''}><a class="mls-tk" href="${href}" target="_blank" rel="noopener"${dup ? ' tabindex="-1"' : ''}>` +
      `<span class="mls-taught-mark${s.logo ? '' : ' mls-taught-mark--mono'}">${
        s.logo ? `<img src="community/${esc(s.logo)}" alt="" loading="lazy" width="26" height="26">` : esc(s.mono)}</span>` +
      `<span class="mls-tk-text"><b>${esc(s.name)}</b><span class="mls-tk-course">${course}</span>` +
      `<span class="mls-tk-where">${esc(s.city)}, ${esc(s.country)}</span></span></a></li>`;
  }

  function render(data) {
    const pool = shuffle((data.teaching || []).filter(s => s.courses && s.courses.length));
    if (!pool.length) return;
    // The track holds the list twice and slides by one copy, so the loop has
    // no seam. Duration follows the track length for a constant speed; a
    // random negative delay starts each visit at a different school.
    rows.forEach(row => {
      row.innerHTML = pool.map(s => card(s, false)).join('') + pool.map(s => card(s, true)).join('');
    });
    requestAnimationFrame(() => {
      rows.forEach(row => {
        const dur = Math.max(30, row.scrollWidth / 2 / PX_PER_S);
        row.style.setProperty('--mls-taught-dur', dur.toFixed(1) + 's');
        row.style.animationDelay = (-Math.random() * dur).toFixed(1) + 's';
      });
  ...
  function setPaused(on) {
    ...
    toggle.setAttribute('aria-label', on ? 'Resume scrolling' : 'Pause scrolling');
  }
  toggle.addEventListener('click', () => setPaused(!root.classList.contains('is-paused')));
  // A touch holds the ticker still long enough to read and tap a card.
  let touchTimer = null;
  root.addEventListener('touchstart', () => {
    root.classList.add('is-touched');
    clearTimeout(touchTimer);
    touchTimer = setTimeout(() => root.classList.remove('is-touched'), 5000);
  }, {passive: true});

  try { render(JSON.parse(embedded.textContent)); } catch (e) { /* keep the empty row */ }
...
// Stats refresh on every page load from two sources.
//
// stats.json carries readership, counts and everything else that needs a
// credential to compute, so it is produced server-side and refreshed by a
// scheduled job rather than a full site rebuild. The build injects current
// values for first paint; this fetch replaces them, which is what stops a
// CDN-cached page from showing figures frozen at deploy time.
//
// The GitHub call stays separate and direct: the star count is public, needs
// no credential, and should track the repo to the second rather than to the
// last scheduled refresh.
//
// The impact card is treated differently from the rest of the page. Its
// figures are the ones a reader stops on, so they hold their build-time value
// until the card scrolls into view and then count up to the fetched number.
// The reader watches the reach arrive rather than finding it already sitting
// there. Every other figure on the page is replaced quietly on load.

// Both requests start now, in parallel with parsing, so the numbers are
// already in hand by the time the card is scrolled to.
const mlsStats = fetch('stats.json?t=' + Date.now())
  .then(r => r.ok ? r.json() : Promise.reject(r.status))
  .then(d => (d && d.display) || {})
  .catch(err => {
    console.warn('[mlsysbook] stats refresh failed, showing build-time values:', err);
    return {};
  });

const mlsStars = fetch('https://api.github.com/repos/harvard-edge/cs249r_book')
  .then(r => r.ok ? r.json() : Promise.reject(r.status))
  .then(d => (d && d.stargazers_count) || null)
  .catch(err => {
    console.warn('[mlsysbook] star refresh failed, showing build-time value:', err);
    return null;
  });

function mlsReady(fn) {
...
function mlsCacheGet(key) {
  try {
    const raw = window.localStorage.getItem(MLS_CACHE_PREFIX + key);
...
function mlsCacheSet(key, value) {
  try {
...
function mlsRollDuration(from, to) {
  const delta = Math.abs(to - from);
  if (delta === 0) return MLS_ROLL_MIN_MS;
  const span = Math.max(Math.abs(to), 1);
  const ratio = Math.log10(1 + delta) / Math.log10(1 + span);
  return Math.round(MLS_ROLL_MIN_MS
    + (MLS_ROLL_MAX_MS - MLS_ROLL_MIN_MS) * Math.min(1, Math.max(0, ratio)));
}
...
// Increases animate; a decrease is set outright. The reach figures only grow,
// but the monthly average is a windowed rate and legitimately falls, and a
// counter visibly winding backwards reads as decline in a way the same number
// sitting there does not. The figure shown is the current one either way; only
// the motion is reserved for growth.
...
mlsReady(function () {
  const card = document.querySelector('.mls-impact-bottom');

  // Quiet replacement for every figure outside the impact card.
  mlsStats.then(display => {
    document.querySelectorAll('[data-stat]').forEach(el => {
      if (card && card.contains(el)) return;
      const value = display[el.getAttribute('data-stat')];
  ...
  mlsStars.then(stars => {
    if (!stars) return;
    document.querySelectorAll('.gh-star-count, [data-stat="stars"]').forEach(el => {
      if (card && card.contains(el)) return;
  ...
  // Roll one figure from what this reader last saw, then remember the new
  // value for their next visit.
  //
  // Before counting up, reserve the width the finished figure needs. A count
  // from 0 to 314,517 grows from one character to seven, and above the 560px
  // breakpoint the three readings are sized by their content, so without this
  // the row visibly shoves itself outward for the whole animation. Measuring
  // the final string rather than guessing keeps the reservation exact at every
  // clamp() font size, and it can never overflow a narrow column because the
  // width measured is the width that figure occupies at rest anyway.
  function rollFigure(el, key, text) {
    const final = String(text);
    el.textContent = final;
  ...
  function rollCard() {
    Promise.all([mlsStats, mlsStars]).then(([display, stars]) => {
      card.querySelectorAll('[data-stat]').forEach(el => {
        const key = el.getAttribute('data-stat');
        const live = (key === 'stars' && stars) ? stars.toLocaleString() : display[key];
        rollFigure(el, key, live != null ? live : el.textContent);
      });
      // If the build did not wrap the star count in a data-stat span, roll the
      // element that carries it directly.
      const starEl = card.querySelector('.gh-star-count');
      if (starEl && stars && !starEl.querySelector('[data-stat]')) {
        rollFigure(starEl, 'stars', stars.toLocaleString());
      }
    });
  }

  if ('IntersectionObserver' in window) {
    // threshold 0 with the root inset from the bottom, rather than a fraction
    // of the card. A visible-fraction threshold silently never fires when the
    // element is taller than the viewport can ever show that fraction of, which
    // is a real risk on a short landscape phone. Insetting the root instead
    // fires when the card's top reaches the upper three quarters of the
    // viewport, at any card height.
    const observer = new IntersectionObserver((entries, obs) => {
      entries.forEach(entry => {
        if (!entry.isIntersecting) return;
        obs.unobserve(entry.target);   // roll once, not on every scroll past
        rollCard();
      });
    }, { threshold: 0, rootMargin: '0px 0px -25% 0px' });
    observer.observe(card);
  } else {
    rollCard();                        // no observer support: just refresh
  }
});
</script>
```
