...
<section class="mls-section mls-section-cards" id="curriculum">
  ...
  <div class="mls-card-grid">
    ...
    <a href="staffml/" class="mls-cur-card" data-accent="practice">
      <span class="mls-cur-icon" aria-hidden="true">&#x1F4BC;</span>
...
<section class="mls-section mls-section-impact" id="support">
  ...
  <div class="mls-impact-bottom">
    ...
    <div class="mls-goal-block">
      ...
      <p class="mls-impact-goal-sub">Every star signals to universities, foundations, and employers that this resource matters — and helps others discover it.</p>
    </div>
