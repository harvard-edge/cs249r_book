...
<section class="mls-section mls-section-richcards" id="curriculum">
  ...
  <div class="mls-rich-grid">
    ...
    <a href="kits/" class="mls-rich-card" data-accent="deploy">
      ...
      <div class="mls-rich-card-demo">
        <img src="../kits/contents/arduino/nicla_vision/images/jpg/nicla_vision.jpeg" alt="Arduino Nicla Vision — front and back" class="mls-rich-card-img" loading="lazy" />
      </div>
    </a>
    ...
    <a href="community/" class="mls-rich-card" data-accent="follow">
      ...
      <div class="mls-rich-card-demo">
        <svg viewBox="0 0 260 140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
          ...
          <!-- Header -->
          <text x="14" y="20" font-size="9" fill="#333" font-weight="700" font-family="Inter,sans-serif">MLSysBook Weekly</text>
          <line x1="14" y1="27" x2="246" y2="27" stroke="#e0e0e0" stroke-width="0.8"/>
          <!-- Items with colored dots -->
          <circle cx="20" cy="44" r="3.5" fill="#3d9e5a"/>
          <text x="30" y="47" font-size="7.5" fill="#555" font-family="Inter,sans-serif">New: Vol II Ch. 14 — Fault Tolerance</text>
          <circle cx="20" cy="62" r="3.5" fill="#4a90c4"/>
          <text x="30" y="65" font-size="7.5" fill="#555" font-family="Inter,sans-serif">Updated: TinyTorch Module 12</text>
          <circle cx="20" cy="80" r="3.5" fill="#c87b2a"/>
          <text x="30" y="83" font-size="7.5" fill="#555" font-family="Inter,sans-serif">Community: 500+ PRs merged</text>
          <circle cx="20" cy="98" r="3.5" fill="#6a4da8"/>
          <text x="30" y="101" font-size="7.5" fill="#555" font-family="Inter,sans-serif">Milestone: 23,000 GitHub stars</text>
          <!-- Footer -->
          <line x1="14" y1="114" x2="246" y2="114" stroke="#e0e0e0" stroke-width="0.8"/>
          <text x="130" y="128" font-size="7" fill="#999" text-anchor="middle" font-weight="600" font-family="Inter,sans-serif">Join 12,000+ subscribers</text>
        </svg>
      </div>
    </a>
