...
<section class="mls-section mls-section-richcards" id="curriculum">
  ...
  <div class="mls-rich-grid">
    ...
    <a href="mlsysim/" class="mls-rich-card" data-accent="model">
      ...
      <div class="mls-rich-card-demo">
        <svg viewBox="0 0 260 140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
          ...
          <!-- Roofline curve -->
          <path d="M30,114 L120,52 L248,52" fill="none" stroke="#0284C7" stroke-width="2.5" opacity="0.6"/>
          <!-- Shaded region -->
          <path d="M30,114 L120,52 L248,52 L248,126 L30,126 Z" fill="#0284C7" opacity="0.05"/>
          <!-- Ridge line -->
    ...
    <a href="interviews/staffml/" class="mls-rich-card" data-accent="practice">
      ...
      <div class="mls-rich-card-demo">
        <svg viewBox="0 0 260 140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
          <rect width="260" height="140" fill="#eef1f6"/>
          <!-- Back card shadow -->
          <rect x="18" y="8" width="220" height="94" rx="5" fill="#475569" opacity="0.08" transform="rotate(-2,128,55)"/>
          <!-- Mid card -->
          <rect x="14" y="6" width="220" height="94" rx="5" fill="#fff" stroke="#94a3b8" stroke-width="0.8" opacity="0.6" transform="rotate(1,124,53)"/>
          <!-- Front card -->
          <rect x="10" y="4" width="220" height="94" rx="5" fill="#fff" stroke="#64748b" stroke-width="1.2"/>
          <!-- Domain pill -->
    ...
    <a href="community/" class="mls-rich-card" data-accent="follow">
      ...
      <div class="mls-rich-card-demo">
        <svg viewBox="0 0 260 140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
          <rect width="260" height="140" fill="#fff"/>
          <!-- Left accent stripe -->
          <rect width="4" height="140" fill="#475569"/>
          <!-- Header -->
          <rect x="4" width="256" height="26" fill="#f1f5f9"/>
