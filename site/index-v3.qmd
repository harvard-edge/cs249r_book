...
<section class="mls-section mls-section-richcards" id="curriculum">
  ...
  <div class="mls-rich-grid">
    ...
    <a href="tinytorch/" class="mls-rich-card" data-accent="build">
      ...
      <div class="mls-rich-card-demo">
        <svg viewBox="0 0 280 155" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
          <rect width="280" height="155" fill="transparent"/>
          <!-- Terminal window -->
          <rect x="16" y="10" width="248" height="135" rx="8" fill="#1e1e2e" stroke="#333" stroke-width="1"/>
          <!-- Title bar -->
          <rect x="16" y="10" width="248" height="20" rx="8" fill="#2a2a3a"/>
          <rect x="16" y="22" width="248" height="8" fill="#2a2a3a"/>
          <circle cx="30" cy="20" r="4" fill="#ff5f57"/>
          <circle cx="42" cy="20" r="4" fill="#febc2e"/>
          <circle cx="54" cy="20" r="4" fill="#28c840"/>
          <text x="140" y="22" font-size="7" fill="#888" text-anchor="middle" font-family="monospace">tinytorch — tensor.py</text>
          <!-- Code lines -->
          <text x="26" y="46" font-size="9" font-family="monospace"><tspan fill="#c586c0">class</tspan><tspan fill="#ddd"> </tspan><tspan fill="#4ec9b0">Tensor</tspan><tspan fill="#ddd">:</tspan></text>
          <text x="40" y="60" font-size="9" font-family="monospace"><tspan fill="#c586c0">def</tspan><tspan fill="#ddd"> </tspan><tspan fill="#dcdcaa">__init__</tspan><tspan fill="#ddd">(self, data):</tspan></text>
          <text x="54" y="74" font-size="9" font-family="monospace"><tspan fill="#ddd">self.data = data</tspan></text>
          <text x="54" y="88" font-size="9" font-family="monospace"><tspan fill="#ddd">self.grad = </tspan><tspan fill="#b5cea8">0.0</tspan></text>
          <text x="54" y="102" font-size="9" font-family="monospace"><tspan fill="#ddd">self._backward = </tspan><tspan fill="#c586c0">lambda</tspan><tspan fill="#ddd">: </tspan><tspan fill="#569cd6">None</tspan></text>
          <!-- Blinking cursor -->
          <rect x="26" y="110" width="6" height="11" fill="#a56520">
    ...
    <a href="kits/" class="mls-rich-card" data-accent="deploy">
      ...
      <div class="mls-rich-card-demo">
        <img src="assets/nicla-vision-front.jpeg" alt="Nicla Vision board" class="mls-rich-card-img" loading="lazy" />
      </div>
    </a>
    ...
    <a href="mlsysim/" class="mls-rich-card" data-accent="model">
      ...
      <div class="mls-rich-card-demo">
        <svg viewBox="0 0 280 155" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
          <rect width="280" height="155" fill="transparent"/>
          <rect x="10" y="8" width="260" height="140" rx="6" fill="#f8f6fc" stroke="#d4c8e8" stroke-width="0.8"/>
          <!-- CLI bar -->
          <rect x="10" y="8" width="260" height="24" rx="6" fill="#ebe5f5"/>
          <rect x="10" y="24" width="260" height="8" fill="#ebe5f5"/>
          <text x="20" y="24" font-size="8" font-family="monospace"><tspan fill="#6a4da8" font-weight="700">$ mlsysim</tspan><tspan fill="#8b6ec0"> eval</tspan><tspan fill="#6a4da8"> llama-3-70b</tspan><tspan fill="#999"> --batch </tspan><tspan fill="#c87b2a" font-weight="600">1</tspan></text>
          <!-- Axes -->
          <line x1="40" y1="130" x2="255" y2="130" stroke="#6a4da8" stroke-width="1" opacity="0.3"/>
          <line x1="40" y1="130" x2="40" y2="40" stroke="#6a4da8" stroke-width="1" opacity="0.3"/>
          <!-- Roofline curve -->
          <path d="M40,118 L130,52 L255,52" fill="none" stroke="#6a4da8" stroke-width="2.5" opacity="0.6"/>
          <!-- Shaded region -->
          <path d="M40,118 L130,52 L255,52 L255,130 L40,130 Z" fill="#6a4da8" opacity="0.05"/>
          <!-- Ridge line -->
          <line x1="130" y1="52" x2="130" y2="130" stroke="#6a4da8" stroke-width="0.8" stroke-dasharray="4,3" opacity="0.25"/>
          <!-- Animated workload dot -->
          <circle r="6" stroke="#fff" stroke-width="1.5">
            <animate attributeName="cx" values="75;75;130;130;210;210;75" keyTimes="0;0.28;0.33;0.61;0.66;0.95;1" dur="9s" repeatCount="indefinite"/>
            <animate attributeName="cy" values="92;92;52;52;52;52;92" keyTimes="0;0.28;0.33;0.61;0.66;0.95;1" dur="9s" repeatCount="indefinite"/>
          ...
          <!-- Region labels -->
          <text x="62" y="110" font-size="7.5" fill="#6a4da8" font-family="Inter,sans-serif" opacity="0.4">mem-bound</text>
          <text x="180" y="70" font-size="7.5" fill="#6a4da8" font-family="Inter,sans-serif" opacity="0.4">compute-bound</text>
          <!-- Batch labels -->
          <text x="83" y="86" fill="#c87b2a" font-size="8" font-weight="600" font-family="Inter,sans-serif" opacity="0.8">b=1</text>
          <text x="138" y="47" fill="#3d9e5a" font-size="8" font-weight="600" font-family="Inter,sans-serif" opacity="0.8">b=32</text>
          <text x="218" y="47" fill="#e05252" font-size="8" font-weight="600" font-family="Inter,sans-serif" opacity="0.8">b=128</text>
          <!-- Axis labels -->
          <text x="148" y="143" font-size="7" fill="#6a4da8" font-family="Inter,sans-serif" opacity="0.35" text-anchor="middle">Arithmetic Intensity</text>
          <text x="25" y="88" font-size="7" fill="#6a4da8" font-family="Inter,sans-serif" opacity="0.35" transform="rotate(-90,25,88)">FLOP/s</text>
        </svg>
      </div>
    </a>
    ...
    <a href="interviews/staffml/" class="mls-rich-card" data-accent="practice">
      ...
      <div class="mls-rich-card-demo">
        <svg viewBox="0 0 280 155" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
          <rect width="280" height="155" fill="transparent"/>
          <rect x="6" y="4" width="268" height="147" rx="6" fill="#fef8f8" stroke="#e8c8c8" stroke-width="0.6"/>
          <!-- Back card shadow -->
          <rect x="22" y="8" width="220" height="100" rx="6" fill="#b33" opacity="0.06" transform="rotate(-2,132,58)"/>
          <!-- Mid card -->
          <rect x="18" y="6" width="220" height="100" rx="6" fill="#fff" stroke="#b33" stroke-width="0.8" opacity="0.5" transform="rotate(1,128,56)"/>
          <!-- Front card -->
          <rect x="14" y="4" width="220" height="100" rx="6" fill="#fff" stroke="#b33" stroke-width="1.2"/>
          <!-- Domain pill -->
          <rect x="22" y="12" width="44" height="14" rx="7" fill="#e3f2fd"/>
          <text x="44" y="22" font-size="7.5" fill="#4a90c4" text-anchor="middle" font-weight="700" font-family="Inter,sans-serif">Cloud</text>
          <!-- Question text -->
          <text x="22" y="40" font-size="7" fill="#333" font-family="Inter,sans-serif">A 70B model needs 1,000 req/s.</text>
          <text x="22" y="51" font-size="7" fill="#333" font-family="Inter,sans-serif">Walk through your hardware</text>
          <text x="22" y="62" font-size="7" fill="#333" font-family="Inter,sans-serif">selection and parallelism strategy.</text>
          <!-- Rubric bars -->
          <text x="22" y="78" font-size="6" fill="#999" font-family="Inter,sans-serif">Hardware</text>
          <rect x="68" y="72" width="120" height="5" rx="2.5" fill="#eee"/><rect x="68" y="72" width="102" height="5" rx="2.5" fill="#4a90c4" opacity="0.6"/>
          <text x="22" y="90" font-size="6" fill="#999" font-family="Inter,sans-serif">Parallelism</text>
          <rect x="68" y="84" width="120" height="5" rx="2.5" fill="#eee"/><rect x="68" y="84" width="108" height="5" rx="2.5" fill="#3d9e5a" opacity="0.6"/>
          <text x="22" y="102" font-size="6" fill="#999" font-family="Inter,sans-serif">Trade-offs</text>
          <rect x="68" y="96" width="120" height="5" rx="2.5" fill="#eee"/><rect x="68" y="96" width="90" height="5" rx="2.5" fill="#c87b2a" opacity="0.6"/>
          <!-- Domain tags at bottom -->
          <rect x="14" y="114" width="36" height="16" rx="8" fill="#e3f2fd"/>
          <text x="32" y="125" font-size="7" fill="#4a90c4" text-anchor="middle" font-weight="600" font-family="Inter,sans-serif">Cloud</text>
          <rect x="56" y="114" width="30" height="16" rx="8" fill="#e8f5e9"/>
          <text x="71" y="125" font-size="7" fill="#2d7a2d" text-anchor="middle" font-weight="600" font-family="Inter,sans-serif">Edge</text>
          <rect x="92" y="114" width="38" height="16" rx="8" fill="#fff3e0"/>
          <text x="111" y="125" font-size="7" fill="#c87b2a" text-anchor="middle" font-weight="600" font-family="Inter,sans-serif">Mobile</text>
          <rect x="136" y="114" width="42" height="16" rx="8" fill="#fce4ec"/>
          <text x="157" y="125" font-size="7" fill="#c44" text-anchor="middle" font-weight="600" font-family="Inter,sans-serif">TinyML</text>
        </svg>
      </div>
    </a>
    ...
    <a href="instructors/" class="mls-rich-card" data-accent="adopt">
      ...
      <div class="mls-rich-card-demo">
        <svg viewBox="0 0 280 155" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
          <rect width="280" height="155" fill="transparent"/>
          <rect x="6" y="4" width="268" height="147" rx="6" fill="#f4f9f4" stroke="#c8e0c8" stroke-width="0.6"/>
          <!-- Blueprint grid lines -->
          <line x1="0" y1="35" x2="260" y2="35" stroke="#1d6a1d" stroke-width="0.3" opacity="0.1"/>
          <line x1="0" y1="70" x2="260" y2="70" stroke="#1d6a1d" stroke-width="0.3" opacity="0.1"/>
          <line x1="0" y1="105" x2="260" y2="105" stroke="#1d6a1d" stroke-width="0.3" opacity="0.1"/>
          ...
          <text x="130" y="26" font-size="7" fill="#1d6a1d" text-anchor="middle" font-family="Inter,sans-serif" opacity="0.5">ML Systems · Two-Semester Curriculum</text>
          <!-- Module boxes: 2×2 grid -->
          <rect x="10" y="38" width="115" height="28" rx="4" fill="#d4edda" stroke="#1d6a1d" stroke-width="0.8"/>
          <text x="18" y="50" font-size="7" fill="#1d6a1d" font-weight="700" font-family="Inter,sans-serif">Semester 1: Foundations</text>
          <text x="18" y="60" font-size="6" fill="#1d6a1d" font-family="Inter,sans-serif" opacity="0.6">16 wks · Vol I · 8 assignments</text>
          <rect x="135" y="38" width="115" height="28" rx="4" fill="#d4edda" stroke="#1d6a1d" stroke-width="0.8"/>
          <text x="143" y="50" font-size="7" fill="#1d6a1d" font-weight="700" font-family="Inter,sans-serif">Semester 2: At Scale</text>
          <text x="143" y="60" font-size="6" fill="#1d6a1d" font-family="Inter,sans-serif" opacity="0.6">16 wks · Vol II · capstone</text>
          <rect x="10" y="72" width="115" height="28" rx="4" fill="#e8f5e9" stroke="#1d6a1d" stroke-width="0.8"/>
          <text x="18" y="84" font-size="7" fill="#1d6a1d" font-weight="700" font-family="Inter,sans-serif">Assessment</text>
          <text x="18" y="94" font-size="6" fill="#1d6a1d" font-family="Inter,sans-serif" opacity="0.6">Rubrics · Peer review · Grading</text>
          <rect x="135" y="72" width="115" height="28" rx="4" fill="#e8f5e9" stroke="#1d6a1d" stroke-width="0.8"/>
          <text x="143" y="84" font-size="7" fill="#1d6a1d" font-weight="700" font-family="Inter,sans-serif">Teaching Staff</text>
          <text x="143" y="94" font-size="6" fill="#1d6a1d" font-family="Inter,sans-serif" opacity="0.6">Pedagogy · TA handbook</text>
          <!-- Stamp -->
          <rect x="190" y="108" width="60" height="24" rx="4" fill="none" stroke="#1d6a1d" stroke-width="1.5" stroke-dasharray="3,2" opacity="0.4" transform="rotate(-5,220,120)"/>
          <text x="220" y="123" font-size="8" fill="#1d6a1d" text-anchor="middle" font-weight="700" font-family="Inter,sans-serif" opacity="0.4" transform="rotate(-5,220,123)">READY</text>
        </svg>
      </div>
    </a>
    ...
    <a href="slides/" class="mls-rich-card" data-accent="teach">
      ...
      <div class="mls-rich-card-demo">
        <svg viewBox="0 0 280 155" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
          <rect width="280" height="155" fill="transparent"/>
          <!-- Slide frame -->
          <rect x="16" y="12" width="248" height="131" rx="4" fill="#fff" stroke="#ccc" stroke-width="1"/>
          <!-- Top nav bar -->
          <rect x="16" y="12" width="248" height="16" rx="4" fill="#2d3748"/>
          <rect x="16" y="20" width="248" height="8" fill="#2d3748"/>
          <text x="26" y="23" font-size="6" fill="#fff" font-family="Inter,sans-serif" opacity="0.4">Intro</text>
          <text x="50" y="23" font-size="6" fill="#fff" font-family="Inter,sans-serif" opacity="0.4">Systems</text>
          <text x="84" y="23" font-size="6" fill="#fff" font-family="Inter,sans-serif" opacity="0.4">DNN</text>
          <rect x="103" y="14" width="40" height="12" rx="2" fill="#4a90c4" opacity="0.5"/>
          <text x="123" y="23" font-size="6" fill="#fff" font-family="Inter,sans-serif" font-weight="700" text-anchor="middle">Training</text>
          <text x="156" y="23" font-size="6" fill="#fff" font-family="Inter,sans-serif" opacity="0.4">Accel</text>
          <text x="184" y="23" font-size="6" fill="#fff" font-family="Inter,sans-serif" opacity="0.4">Deploy</text>
          <text x="214" y="23" font-size="6" fill="#fff" font-family="Inter,sans-serif" opacity="0.4">Ethics</text>
          <!-- Slide title -->
          <text x="32" y="46" font-size="10" fill="#1a202c" font-weight="700" font-family="Inter,sans-serif">The Iron Law of ML Systems</text>
          <!-- Equation -->
          <rect x="32" y="54" width="200" height="18" rx="3" fill="#edf2f7"/>
          <text x="132" y="67" font-size="10" fill="#2d3748" text-anchor="middle" font-family="monospace" font-weight="600">T = D/BW + O/(R·η) + L</text>
          <!-- Bullet points -->
          <circle cx="36" cy="83" r="2" fill="#4a90c4"/>
          <text x="44" y="86" font-size="7" fill="#4a5568" font-family="Inter,sans-serif"><tspan font-weight="600" fill="#1a202c">Data Term</tspan> — memory bandwidth</text>
          <circle cx="36" cy="97" r="2" fill="#3d9e5a"/>
          <text x="44" y="100" font-size="7" fill="#4a5568" font-family="Inter,sans-serif"><tspan font-weight="600" fill="#1a202c">Compute Term</tspan> — utilization η ≤ 0.7</text>
          <circle cx="36" cy="111" r="2" fill="#c87b2a"/>
          <text x="44" y="114" font-size="7" fill="#4a5568" font-family="Inter,sans-serif"><tspan font-weight="600" fill="#1a202c">Latency Term</tspan> — orchestration overhead</text>
          <!-- Footer -->
          <rect x="16" y="127" width="248" height="16" rx="4" fill="#f7fafc"/>
          <rect x="16" y="127" width="248" height="8" fill="#f7fafc"/>
          <text x="26" y="137" font-size="6" fill="#a0aec0" font-family="Inter,sans-serif">Harvard University · ML Systems</text>
          <text x="252" y="137" font-size="6" fill="#a0aec0" font-family="Inter,sans-serif" text-anchor="end">12 / 38</text>
        </svg>
      </div>
    </a>
    ...
    <a href="community/" class="mls-rich-card" data-accent="follow">
      ...
      <div class="mls-rich-card-demo">
        <svg viewBox="0 0 280 155" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
          <rect width="280" height="155" fill="transparent"/>
          <!-- Card frame -->
          <rect x="20" y="12" width="240" height="131" rx="8" fill="#fff" stroke="#e0e0e0" stroke-width="1"/>
          <!-- Header -->
          <text x="36" y="32" font-size="9" fill="#333" font-weight="700" font-family="Inter,sans-serif">MLSysBook Weekly</text>
          <line x1="36" y1="38" x2="244" y2="38" stroke="#e0e0e0" stroke-width="0.8"/>
          <!-- Items with colored dots -->
          <circle cx="40" cy="54" r="3.5" fill="#3d9e5a"/>
          <text x="50" y="57" font-size="7.5" fill="#555" font-family="Inter,sans-serif">New: Vol II Ch. 14 — Fault Tolerance</text>
          <circle cx="40" cy="72" r="3.5" fill="#4a90c4"/>
          <text x="50" y="75" font-size="7.5" fill="#555" font-family="Inter,sans-serif">Updated: TinyTorch Module 12</text>
          <circle cx="40" cy="90" r="3.5" fill="#c87b2a"/>
          <text x="50" y="93" font-size="7.5" fill="#555" font-family="Inter,sans-serif">Community: 500+ PRs merged</text>
          <circle cx="40" cy="108" r="3.5" fill="#6a4da8"/>
          <text x="50" y="111" font-size="7.5" fill="#555" font-family="Inter,sans-serif">Milestone: 23,000 GitHub stars</text>
          <!-- Footer -->
          <line x1="36" y1="122" x2="244" y2="122" stroke="#e0e0e0" stroke-width="0.8"/>
          <text x="140" y="136" font-size="7" fill="#999" text-anchor="middle" font-weight="600" font-family="Inter,sans-serif">Join 12,000+ subscribers</text>
        </svg>
      </div>
    </a>
