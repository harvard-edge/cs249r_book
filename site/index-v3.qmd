...
<section class="mls-section mls-section-impact" id="support">
  ...
  <div class="mls-impact-top">
    ...
    <p class="mls-impact-mission">Everyone calls AI the new electricity — but electricity is useless without engineers who can build the infrastructure. The world needs people who understand the systems underneath. That knowledge should be accessible to anyone willing to learn — and this entire curriculum is our commitment to making it so.</p>
  </div>
  ...
  <div class="mls-impact-bottom">
    ...
    <div class="mls-goal-block">
      ...
      <p class="mls-impact-goal-sub">Next milestone: 100,000 ★ — we're at <span id="gh-star-num">23,000+</span>.<br/>Every star helps the next student discover this resource.</p>
    </div>
