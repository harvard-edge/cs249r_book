...
<div class="community-opening" style="padding-bottom: 1.5rem;">
  ...
  <p class="opening-body">From hardware kits in Nairobi to the MIT Press hardcover — none of this happens without partners who believe open education is worth investing in.</p>
</div>
```

## Institutional Partners {#institutional}

The academic institutions and organizations that anchor the curriculum and global network.
...
<div class="partner-tier">
  <div class="partner-grid">
    ...
    <a href="https://www.tinyml.org" target="_blank" rel="noopener" class="partner-card">
      ...
      <p>Non-profit advancing TinyML technology and education worldwide.</p>
    </a>
    ...
    <a href="https://www.ictp.it" target="_blank" rel="noopener" class="partner-card">
      ...
      <h3>ICTP</h3>
      <p>Co-host of the TinyML4D Academic Network and SciTinyML workshops in Trieste.</p>
    </a>
...
The companies that provide funding, hardware, and platform access to make this curriculum possible.
...
<div class="partner-tier">
  <div class="partner-grid">
    ...
    <a href="https://google.com" target="_blank" rel="noopener" class="partner-card">
      ...
      <h3>Google</h3>
      <p>Founding sponsor of the edX TinyML series and TensorFlow Lite ecosystem.</p>
    </a>
    ...
    <a href="https://www.arduino.cc" target="_blank" rel="noopener" class="partner-card">
      ...
      <h3>Arduino</h3>
      <p>Hardware partner — every TinyML4D university receives Arduino Tiny ML Kits.</p>
    </a>
...
<div class="sponsor-cta-banner">
  ...
  <h3>Support Open AI Education</h3>
  <p>$500 ships a hardware kit to a university classroom that needs it. Your sponsorship directly funds hardware for 40+ universities across six continents.</p>
