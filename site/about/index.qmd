...
Software engineering brought that rigor to code. Computer engineering brought it to hardware. AI engineering brings it to intelligent systems, sitting at the intersection of ML theory (understanding *why* models work), ML systems (understanding *how* to make them run efficiently), and applied ML (understanding *what* to build and for whom).

```{=html}
<div style="text-align: center; margin: 1.5rem 0;">
  <img src="assets/images/ai-engineering-venn.svg" alt="Venn diagram showing AI Engineering at the intersection of ML Theory, ML Systems, and Applied ML" style="max-width: 420px; width: 100%;" loading="lazy" />
</div>
```
