...
This approach draws on a tradition that goes back decades. Hennessy and Patterson showed that computer architecture could be taught through quantitative reasoning. Andrew Ng showed that ML education could reach millions. We draw on both traditions — quantitative systems pedagogy and the open-education movement — to build something new.
