...
description: "Press Enter to launch. Use Up to thrust and Left or Right to steer toward the green minimum."
page-layout: article
format:
  html:
    include-in-header:
...
*Part of the [MLSysBook Playground](/games/) — try another game.* Found a bug? [Report an issue](https://github.com/harvard-edge/cs249r_book/issues/new?labels=bug&title=Bug+in+Game).
