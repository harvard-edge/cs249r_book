...
![](images/imgs_niclav_sys/image29.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_niclav_sys/image22.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_niclav_sys/image14.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_niclav_sys/image2.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_niclav_sys/image9.png){fig-align="center" width="6.5in"}
...
![](images/imgs_niclav_sys/image19.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_niclav_sys/image28.png){fig-align="center" width="6.5in"}
...
![](images/imgs_niclav_sys/image15.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_niclav_sys/image12.png){fig-align="center" width="6.5in"}

On the Serial Monitor, you will see the distance from the camera to an object in front of it (max of 4m).

![](images/imgs_niclav_sys/image13.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_niclav_sys/image21.png){fig-align="center" width="6.5in"}
...
![](images/imgs_niclav_sys/image7.png){fig-align="center" width="6.5in"}
...
![](images/imgs_niclav_sys/image23.jpg){fig-align="center" width="4.010416666666667in"}
...
![](images/imgs_niclav_sys/image10.png){fig-align="center" width="6.5in"}
...
![](images/imgs_niclav_sys/image5.png){fig-align="center" width="4.854166666666667in"}
...
![](images/imgs_niclav_sys/image1.png){fig-align="center" width="3.875in"}

A green play button appears when the Nicla Vison connects to the Tool Bar.

![](images/imgs_niclav_sys/image18.jpg){fig-align="center" width="4.791666666666667in"}

Also, note that a drive named "NO NAME" will appear on your computer.:

![](images/imgs_niclav_sys/image3.png){fig-align="center" width="6.447916666666667in"}
...
![](images/imgs_niclav_sys/image16.png){fig-align="center" width="4.239583333333333in"}
...
![](images/imgs_niclav_sys/image6.png){fig-align="center" width="6.5in"}
...
![](images/imgs_niclav_sys/image27.png){fig-align="center" width="6.5in"}

In the *Collect Data* section on the `Data Acquisition` tab, you can choose which sensor data to pick.

![](images/imgs_niclav_sys/image25.png){fig-align="center" width="6.5in"}

For example. `IMU data`:

![](images/imgs_niclav_sys/image8.png){fig-align="center" width="6.5in"}

Or Image (`Camera`):

![](images/imgs_niclav_sys/image4.png){fig-align="center" width="6.5in"}
...
![](images/imgs_niclav_sys/image20.jpg){fig-align="center" width="6.5in"}

This shield is MKR compatible and can be used with the Nicla Vision and Portenta.

![](images/imgs_niclav_sys/image26.jpg){fig-align="center" width="4.34375in"}
...
![](images/imgs_niclav_sys/image11.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_niclav_sys/image24.jpg){fig-align="center" width="2.8125in"}
