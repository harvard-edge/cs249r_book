...
![](images/imgs_motion_classif/imu_ide.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/imu_test.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/sampling.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/classes.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/classes_mov_def.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/data-forw.jpg){fig-align="center" width="5.25in"}
...
![](images/imgs_motion_classif/term.jpg){fig-align="center" width="6.5in"}

Go to the `Devices` section on your EI Project and verify if the device is connected (the dot should be green):

![](images/imgs_motion_classif/device.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/collect_data.jpg){fig-align="center" width="5.64in"}
...
![](images/imgs_motion_classif/terrestrial_result.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/maritime_result.jpg){fig-align="center" width="6.5in"}

**Lift** (Palettes being handled vertically by a Forklift). Movement captured only in the Z-axis:

![](images/imgs_motion_classif/lift_result.jpg){fig-align="center" width="6.5in"}

**Idle** (Paletts in a warehouse). No movement detected by the accelerometer:

![](images/imgs_motion_classif/idle_result.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/dataset.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/data_explorer.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/impulse.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/anomaly_detect.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/impulse-block.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/pre-process.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/Parameters_definition.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/feature_generation.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/model.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/train.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/anom_det_train.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/model_testing.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/deploy.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/inference.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/inference_1.jpg){fig-align="center" width="6.5in"}

-   **maritime and terrestrial**:

![](images/imgs_motion_classif/inference_2.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/anomaly-boat.jpg){fig-align="center" width="6.5in"}
...
![](images/imgs_motion_classif/case.jpg){fig-align="center" width="6.5in"}
