...
| **BUILD** | [🔥 TinyTorch](https://mlsysbook.ai/tinytorch) | 프레임워크 구현을 직접 경험 | [packages/tinytorch/](../packages/tinytorch/README.md) |
...
| TinyTorch 모듈 추가·버그 수정 | [packages/tinytorch/CONTRIBUTING.md](../packages/tinytorch/CONTRIBUTING.md) |
...
| **TinyTorch code** | [Apache 2.0](../packages/tinytorch/LICENSE) | 자유 사용·수정·배포·특허 보호 포함 |
