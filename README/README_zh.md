...
| **BUILD** | [🔥 TinyTorch](https://mlsysbook.ai/tinytorch) | 亲手实现框架 | [packages/tinytorch/](../packages/tinytorch/README.md) |
...
| 添加 TinyTorch 模块或修复 bug | [packages/tinytorch/CONTRIBUTING.md](../packages/tinytorch/CONTRIBUTING.md) |
...
| **TinyTorch code** | [Apache 2.0](../packages/tinytorch/LICENSE) | 自由使用、修改、分发并附带专利保护 |
