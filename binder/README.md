...
> **📌 Early release (2026)**
>
> The textbook shipped with the **2026** MLSysBook refresh. Chapters, figures, quizzes, cross-refs, and the Quarto build pipeline are **actively iterated** as we teach from the material.
>
> **Feedback** — [GitHub issues](https://github.com/harvard-edge/cs249r_book/issues) or pull requests (errata especially welcome).
...
This directory holds the textbook's build and quality toolchain: the `binder`
command, its checks, and supporting tools. Run it from the repository root as
`./binder/binder`. The book sources live in `books/`.

### This folder is also Binder's configuration folder

[repo2docker](https://repo2docker.readthedocs.io/), the engine behind
mybinder.org, reads its configuration from a repository's `binder/` folder. That
is what runs when someone presses a TinyTorch "Launch Binder" button. It looks
only for a fixed set of file names, and this repository uses two of them here:
`postBuild` and `requirements.txt`.

Keep the toolchain from colliding with that:

- Do not add a top-level `requirements.txt`, `environment.yml`, `Dockerfile`,
  `apt.txt`, `runtime.txt`, `start`, `Pipfile`, or `install.R` to this folder for
  the toolchain's own use. repo2docker would read it and change the cloud image.
- Do not recreate a `.binder/` folder at the repository root. repo2docker
  refuses to build when both `binder/` and `.binder/` exist.
...
<table width="100%" style="width:100%">
  <thead>
    <tr>
      ...
      <th align="left" width="50%">Systems Engineering</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<table width="100%" style="width:100%">
  <thead>
    <tr>
      ...
      <th align="left" width="50%">You will learn...</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<table width="100%" style="width:100%">
  <thead>
    <tr>
      ...
      <th align="left" width="30%">Theme</th>
      <th align="left" width="50%">Focus</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<table width="100%" style="width:100%">
  <thead>
    <tr>
      ...
      <th align="left" width="25%">Focus</th>
      <th align="left" width="55%">Chapters</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<table width="100%" style="width:100%">
  <thead>
    <tr>
      ...
      <th align="left" width="20%">Focus</th>
      <th align="left" width="55%">Chapters</th>
    </tr>
  </thead>
  <tbody>
...
# Daily workflow
./binder/binder clean              # Clean build artifacts
./binder/binder build              # Build HTML book
./binder/binder preview intro      # Preview chapter with live reload

# Build all formats
./binder/binder build pdf          # Build PDF
./binder/binder build epub         # Build EPUB

# Utilities
./binder/binder help               # Show all commands
./binder/binder list               # List chapters
./binder/binder check all          # Run curated validation checks (same family as pre-commit)
...
2. **Set up** your environment: `./binder/binder setup`
3. **Find an issue** or propose a change
4. **Make your changes** in `books/` (one directory per volume)
5. **Preview** your changes: `./binder/binder preview <chapter>`
...
<table width="100%" style="width:100%">
  <tbody>
    <tr>
      ...
      <td align="center" valign="top" width="14.28%"><a href="https://github.com/hzeljko"><img src="https://avatars.githubusercontent.com/hzeljko?v=4?s=80" width="80px;" alt="Zeljko Hrcek"/><br /><sub><b>Zeljko Hrcek</b></sub></a><br />🪲 🧑‍💻 🎨 ✍️ 🛠️</td>
      ...
      <td align="center" valign="top" width="14.28%"><a href="https://github.com