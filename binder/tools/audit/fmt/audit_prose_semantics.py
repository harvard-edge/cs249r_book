...
Usage::
    ...
    PYTHONPATH=mlsysim python3 binder/tools/audit/fmt/audit_prose_semantics.py --root books
    PYTHONPATH=mlsysim python3 binder/tools/audit/fmt/audit_prose_semantics.py <chapter.qmd> [-v]
"""
