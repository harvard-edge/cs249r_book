...
Usage:
    python3 binder/tools/audit/scan.py --scope vol1
    python3 binder/tools/audit/scan.py --scope vol2 --categories vs-period,percent-symbol
    python3 binder/tools/audit/scan.py --scope vol2 --output my-ledger.json
...
CHECK_REGISTRY: list[tuple[str, str]] = [
    ...
    # Wave 7 — release-gate defect catalog (run via binder/tools/audit/scan.py)
...
def scan(
    ...
    binder/tools/audit/accepted_fps.json) is applied: any issue whose
    ...
    layout exception that justifies it. See binder/tools/audit/accept_list.py.
    """
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "binder/tools/audit/accepted_fps.json). Accept-list entries "
