...
Usage (repo root)::
    ...
    PYTHONPATH=mlsysim python3 binder/tools/audit/lego_prose_coherence.py --chapter vol2/network_fabrics
    PYTHONPATH=mlsysim python3 binder/tools/audit/lego_prose_coherence.py --all
    PYTHONPATH=mlsysim python3 binder/tools/audit/lego_prose_coherence.py --all --workers 4
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("binder/tools/audit/artifacts/lego_prose_coherence_report.json"),
    )
    parser.add_argument(
        "--strict-coverage",
        action="store_true",
