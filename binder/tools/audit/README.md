# binder/tools/audit — Pass 15 Audit-Fix-Verify Loop
...
```bash
python3 binder/tools/audit/fix_script_lane.py \
...
python3 binder/tools/audit/loop.py --scope vol2 --dry-run --verbose

# Apply, verify, but don't commit
python3 binder/tools/audit/loop.py --scope vol2 \
