    ...
    steps: list[tuple[str, list[str], Path | None]] = [
        ...
        (
            ...
            [
                ...
                str(REPO / "binder" / "tests" / "test_appendix_constants.py"),
                str(REPO / "binder" / "tests" / "test_appendix_lineage.py"),
                str(REPO / "binder" / "tests" / "test_no_legacy_constant_refs.py"),
                str(REPO / "binder" / "tests" / "test_registry.py"),
                str(REPO / "binder" / "tests" / "test_mlsysim_registry_coverage.py"),
                "--no-cov",
                "-q",
            ],
            MLSYSIM,
