...
CHAPTER_TO_QMD: dict[str, str | None] = {
    ...
    "Ch4: Data Engineering": "books/vol1/data_engineering/data_engineering.qmd",
    "Ch6: Network Architectures": "books/vol1/nn_architectures/nn_architectures.qmd",
    "Ch7: ML Frameworks": "books/vol1/frameworks/frameworks.qmd",
    "Ch8: Model Training": "books/vol1/training/training.qmd",
    "Ch9: Data Selection": "books/vol1/data_selection/data_selection.qmd",
    "Ch10: Model Compression": "books/vol1/model_compression/model_compression.qmd",
    "Ch11: Hardware Acceleration": "books/vol1/hw_acceleration/hw_acceleration.qmd",
    "Ch12: Benchmarking": "books/vol1/benchmarking/benchmarking.qmd",
    "Ch13: Model Serving": "books/vol1/model_serving/model_serving.qmd",
    "Ch14: ML Operations": "books/vol1/ml_ops/ml_ops.qmd",
    "Ch15: Responsible Engineering": "books/vol1/responsible_engr/responsible_engr.qmd",
    "Conclusion/Backmatter": "books/vol1/conclusion/conclusion.qmd",
    "About This Book": "books/vol1/frontmatter/about.qmd",
    "Acknowledgements": "books/vol1/frontmatter/acknowledgements.qmd",
    "Notation and Conventions": "books/vol1/frontmatter/notation.qmd",
    "Author's Note": "books/vol1/frontmatter/about.qmd",
    "Cover/Title": "books/vol1/frontmatter/about.qmd",
    "Appendices/Glossary/Index": "books/vol1/backmatter",
    "Part I: Foundations": "books/vol1/parts",
    "Part III: Optimize": "books/vol1/parts",
    "Part IV: Deploy": "books/vol1/parts",
}
