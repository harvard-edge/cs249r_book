...
- binder/tools/scripts/content/fix_capitalization.py (proven implementation)
- binder/tools/scripts/content/fix_emdash.py (proven implementation)
- binder/tools/scripts/content/fix_percent.py (proven implementation)
"""
