...
Usage (repo root)::
    ...
    python3 binder/tools/audit/chapter_html_verify.py --list
    python3 binder/tools/audit/chapter_html_verify.py --vol1 introduction
    python3 binder/tools/audit/chapter_html_verify.py --vol1 --all
    python3 binder/tools/audit/chapter_html_verify.py --report

Ledger: binder/tools/audit/artifacts/chapter_html_audit.json
Table:   binder/tools/audit/artifacts/chapter_html_audit.md
"""
...
AUDIT_HTML = REPO_ROOT / "binder/tools/audit/fmt/audit_html.py"
LEDGER_JSON = REPO_ROOT / "binder/tools/audit/artifacts/chapter_html_audit.json"
LEDGER_MD = REPO_ROOT / "binder/tools/audit/artifacts/chapter_html_audit.md"
...
def _build_html(vol: str, ch_path: str) -> tuple[bool, float, str]:
    ...
    t0 = time.monotonic()
    proc = subprocess.run(
        ["./binder/binder", "build", "html", binder_vol, binder_ch,
