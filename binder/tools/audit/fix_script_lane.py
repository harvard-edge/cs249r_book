...
Usage:
    python3 binder/tools/audit/fix_script_lane.py --ledger audit-ledger.json --dry-run
    python3 binder/tools/audit/fix_script_lane.py --ledger audit-ledger.json --apply
    python3 binder/tools/audit/fix_script_lane.py --ledger audit-ledger.json \\
