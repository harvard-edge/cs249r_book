...
![Component speedup rarely survives as end-to-end benchmark speedup.](../../../books/vol1/benchmarking/images/svg/vol1_benchmarking_margin_001.svg)
...
![A 1K test set cannot reliably see a one-point regression.](../../../books/vol1/benchmarking/images/svg/benchmarking_confidence_detectability.svg)
...
![Larger batches push transformer inference from memory-bound to compute-bound.](../../../books/vol1/benchmarking/images/svg/vol1_benchmarking_margin_002.svg)
...
![Burst benchmark FPS collapses once thermal throttling sets in.](../../../books/vol1/benchmarking/images/svg/vol1_benchmarking_margin_003.svg)
...
![Deployment power spans ten orders of magnitude, µW to kW.](../../../books/vol1/benchmarking/images/svg/benchmarking_power_ladder.svg)
...
![A dominated model loses on both axes of the Pareto frontier.](../../../books/vol1/benchmarking/images/svg/vol1_benchmarking_margin_004.svg)
...
![Mean benchmark latency understates the production tail by an order of magnitude.](../../../books/vol1/benchmarking/images/svg/benchmarking_tail_latency_gap.svg)
...
![Architecture choices cascade into compression, serving, drift, and governance.](../../../books/vol1/conclusion/images/svg/vol1_conclusion_margin_001.svg)
...
![Decode stays memory-bound, left of the roofline ridge.](../../../books/vol1/conclusion/images/svg/vol1_conclusion_margin_002.svg)
...
![Mean latency hides the tail; P99 governs user experience.](../../../books/vol1/conclusion/images/svg/vol1_conclusion_margin_003.svg)
...
![Fleet scale turns rare component failures into routine system events.](../../../books/vol1/conclusion/images/svg/vol1_conclusion_fleet_mtbf_ladder.svg)
...
![Selection gain is highest where entropy is high and data gravity low.](../../../books/vol1/data_engineering/images/svg/data_engineering_data_gravity_entropy.svg)
...
![Small per-window false-positive rates compound into operational failure.](../../../books/vol1/data_engineering/images/svg/vol1_data_engineering_margin_001.svg)
...
![Each drift type traces to the distribution component that shifted.](../../../books/vol1/data_engineering/images/svg/vol1_data_engineering_margin_002.svg)
...
![Local aggregation beats gather-all when network latency dominates.](../../../books/vol1/data_engineering/images/svg/vol1_data_engineering_margin_003.svg)
...
![Finer annotation granularity multiplies storage and processing scale.](../../../books/vol1/data_engineering/images/svg/vol1_data_engineering_margin_004.svg)
...
![Full-pool scoring can exceed the label budget before labeling begins.](../../../books/vol1/data_engineering/images/svg/data_engineering_active_learning_budget.svg)
...
![Access latency spans eight orders of magnitude, cache to internet.](../../../books/vol1/data_engineering/images/svg/data_engineering_storage_latency_hierarchy.svg)
...
![Data debt diverges as accumulation rate rises.](../../../books/vol1/data_engineering/images/svg/data_engineering_debt_compounding.svg)
...
![Compute supply can outrun high-quality data supply.](../../../books/vol1/data_selection/images/svg/data_selection_scaling_saturation.svg)
...
![Past the frontier, data becomes a tax: compute climbs, learning stalls.](../../../books/vol1/data_selection/images/svg/data_selection_icr_frontier.svg)
...
![One pretraining corpus defect propagates into many downstream tasks.](../../../books/vol1/data_selection/images/svg/vol1_data_selection_margin_002.svg)
...
![Data echoing helps only until the pipeline ratio threshold; beyond it, diversity falls.](../../../books/vol1/data_selection/images/svg/vol1_data_selection_margin_003.svg)
...
![Recursive synthetic-data training degrades accuracy across generations.](../../../books/vol1/data_selection/images/svg/vol1_data_selection_margin_004.svg)
...
![As work grows, useful compute outpaces fixed dispatch cost; the tax shrinks.](../../../books/vol1/frameworks/images/svg/frameworks_dispatch_tax_divergence.svg)
...
![Training memory dwarfs inference memory.](../../../books/vol1/frameworks/images/svg/vol1_frameworks_margin_001.svg)
...
![Interconnect bandwidth spans ~64$\\times$: HBM far above NVLink, NVLink far above PCIe.](../../../books/vol1/frameworks/images/svg/frameworks_bandwidth_hierarchy.svg)
...
![Overlapping copy and compute costs max(copy, compute), not their sum.](../../../books/vol1/frameworks/images/svg/vol1_frameworks_margin_002.svg)
...
![Each DataLoader knob relieves a specific input bottleneck.](../../../books/vol1/frameworks/images/svg/vol1_frameworks_margin_003.svg)
...
![Each framework optimizes for a different system bottleneck.](../../../books/vol1/frameworks/images/svg/vol1_frameworks_margin_004.svg)
...
![Hardware acceleration turns on the Machine axis.](../../../books/vol1/hw_acceleration/images/svg/hw_acceleration_dam_locator.svg)
...
![A DRAM access costs ~100$\\times$ a MAC; data movement dominates energy.](../../../books/vol1/hw_acceleration/images/svg/hw_acceleration_energy_ladder.svg)
...
![One extra dimension past the tile width tips utilization off a cliff.](../../../books/vol1/hw_acceleration/images/svg/vol1_hw_acceleration_margin_001.svg)
...
![Bandwidth tapers steeply as data moves farther from the accelerator.](../../../books/vol1/hw_acceleration/images/svg/vol1_hw_acceleration_margin_002.svg)
...
![Low arithmetic intensity pins the workload in the memory-bound regime.](../../../books/vol1/hw_acceleration/images/svg/hw_acceleration_roofline_elbow.svg)
...
![Mapping choices explode combinatorially as loop dimensions grow.](../../../books/vol1/hw_acceleration/images/svg/vol1_hw_acceleration_margin_003.svg)
...
![Production ML work is mostly the surrounding system, not the model code alone.](../../../books/vol1/introduction/images/svg/vol1_introduction_margin_001.svg)
...
![Test coverage is a vanishing fraction of the input space.](../../../books/vol1/introduction/images/svg/vol1_introduction_margin_002.svg)
...
![Accuracy decays silently under drift.](../../../books/vol1/introduction/images/svg/vol1_introduction_margin_003.svg)
...
![Moving a byte costs about 145 times an FP16 op, the data-movement tax.](../../../books/vol1/introduction/images/svg/introduction_energy_hierarchy.svg)
...
![GPT-2 decode is bandwidth-bound: the data term dominates.](../../../books/vol1/introduction/images/svg/introduction_iron_law_bars.svg)
...
![Optimizing only inference leaves end-to-end latency mostly intact.](../../../books/vol1/introduction/images/svg/vol1_introduction_margin_004.svg)
...
![Cumulative manual work overtakes the one-time automation investment near week 20.](../../../books/vol1/ml_ops/images/svg/vol1_ml_ops_margin_001.svg)
...
![Stretch retraining too far and staleness cost runs away.](../../../books/vol1/ml_ops/images/svg/vol1_ml_ops_margin_002.svg)
...
![Edge power budgets span sensors, gateways, and vehicles across orders of magnitude.](../../../books/vol1/ml_ops/images/svg/vol1_ml_ops_margin_003.svg)
...
![Drift detection speed is bounded by the sample rate.](../../../books/vol1/ml_ops/images/svg/ml_ops_drift_threshold_knee.svg)
...
![Production debugging starts on the Data axis of D-A-M.](../../../books/vol1/ml_ops/images/svg/vol1_ml_ops_margin_004.svg)
...
![Power spans the paradigms from megawatts (cloud) to milliwatts (TinyML).](../../../books/vol1/ml_systems/images/svg/ml_systems_deployment_span.svg)
...
![Compute capacity outruns memory bandwidth; the widening gap is the memory wall.](../../../books/vol1/ml_systems/images/svg/ml_systems_memory_wall_divergence.svg)
...
![Data, Algorithm, and Machine are coupled; move one and the others shift.](../../../books/vol1/ml_systems/images/svg/ml_systems_dam_locator.svg)
...
![Batch-1 inference sits on the memory-bound side of the roofline.](../../../books/vol1/ml_systems/images/svg/vol1_ml_systems_margin_001.svg)
...
![Raw edge data can be wider than the network pipe.](../../../books/vol1/ml_systems/images/svg/vol1_ml_systems_margin_002.svg)
...
![Sustained thermal performance falls well below burst peaks.](../../../books/vol1/ml_systems/images/svg/vol1_ml_systems_margin_003.svg)
...
![A faster model stage does not linearly speed up a camera pipeline.](../../../books/vol1/ml_systems/images/svg/vol1_ml_systems_margin_004.svg)
...
![Slow iteration loses to fast feedback over time.](../../../books/vol1/ml_workflow/images/svg/vol1_ml_workflow_margin_001.svg)
...
![Edge summaries beat raw medical-image uploads when bandwidth dominates.](../../../books/vol1/ml_workflow/images/svg/vol1_ml_workflow_margin_002.svg)
...
![Production validation is a gate: field sensitivity below the required floor fails deployment.](../../../books/vol1/ml_workflow/images/svg/vol1_ml_workflow_margin_003.svg)
...
![Cloud and edge lifetime costs cross as scale grows.](../../../books/vol1/ml_workflow/images/svg/vol1_ml_workflow_margin_004.svg)
...
![Late-discovered constraints trigger exponential rework.](../../../books/vol1/ml_workflow/images/svg/ml_workflow_constraint_cost_escalation.svg)
...
![Feedback loops span minutes to quarters across five orders of magnitude.](../../../books/vol1/ml_workflow/images/svg/ml_workflow_feedback_timescales.svg)
...
![Frontier weights dwarf phone and microcontroller memory; compression bridges the gap.](../../../books/vol1/model_compression/images/svg/vol1_model_compression_margin_001.svg)
...
![Quantization pays off only when the Machine axis has the right integer units.](../../../books/vol1/model_compression/images/svg/model_compression_dam_locator.svg)
...
![Quantization speedup depends on which side of the ridge you occupy.](../../../books/vol1/model_compression/images/svg/model_compression_quantization_roofline.svg)
...
![Operator fusion cuts memory transfers while arithmetic stays unchanged.](../../../books/vol1/model_compression/images/svg/vol1_model_compression_margin_002.svg)
...
![Unstructured sparsity pays off only past a 90 to 95 percent zero fraction.](../../../books/vol1/model_compression/images/svg/vol1_model_compression_margin_003.svg)
...
![Compression hits an end-to-end ceiling once non-model work dominates the pipeline.](../../../books/vol1/model_compression/images/svg/vol1_model_compression_margin_004.svg)
...
![INT8 quantization: size collapses about 4 times, accuracy holds.](../../../books/vol1/model_compression/images/svg/model_compression_int8_beforeafter.svg)
...
![One noisy neighbor perturbs every workload sharing the node.](../../../books/vol1/model_serving/images/svg/model_serving_blast_radius.svg)
...
![Inference is one slice of the latency budget; preprocessing rivals it.](../../../books/vol1/model_serving/images/svg/model_serving_latency_budget_bar.svg)
...
![Model loading lands far outside a tight serving SLO.](../../../books/vol1/model_serving/images/svg/vol1_model_serving_margin_001.svg)
...
![PagedAttention recovers the KV-cache waste of contiguous allocation.](../../../books/vol1/model_serving/images/svg/vol1_model_serving_margin_002.svg)
...
![As QPS rises, the batching window shrinks while batch size grows.](../../../books/vol1/model_serving/images/svg/vol1_model_serving_margin_003.svg)
...
![TTFT and TPOT live in different bottleneck regimes.](../../../books/vol1/model_serving/images/svg/vol1_model_serving_margin_004.svg)
...
![Inductive bias from strong (CNN) to weak (MLP): stronger prior, less data needed.](../../../books/vol1/nn_architectures/images/svg/nn_architectures_inductive_bias.svg)
...
![Architecture is the Algorithm axis of D·A·M: it sets the operation-count budget.](../../../books/vol1/nn_architectures/images/svg/nn_architectures_algorithm_axis.svg)
...
![Arithmetic intensity spans ~80$\\times$: ResNet saturates compute, GPT-2 starves for bandwidth.](../../../books/vol1/nn_architectures/images/svg/nn_architectures_arithmetic_intensity.svg)
...
![Weight sharing spares convolution the fully-connected parameter explosion.](../../../books/vol1/nn_architectures/images/svg/vol1_nn_architectures_margin_001.svg)
...
![RNNs hold state memory fixed, but latency grows with sequence length.](../../../books/vol1/nn_architectures/images/svg/vol1_nn_architectures_margin_002.svg)
...
![Doubling the context quadruples attention memory: past the knee, the cost wall is unavoidable.](../../../books/vol1/nn_architectures/images/svg/nn_architectures_attention_memory_wall.svg)
...
![DLRM embedding lookups force all-to-all dependence across shards.](../../../books/vol1/nn_architectures/images/svg/vol1_nn_architectures_margin_003.svg)
...
![One embedding table fits an 80 GB A100; a second breaches the capacity wall.](../../../books/vol1/nn_architectures/images/svg/nn_architectures_capacity_wall.svg)
...
![Moving a value from DRAM costs far more energy than a MAC.](../../../books/vol1/nn_architectures/images/svg/vol1_nn_architectures_margin_004.svg)
...
![Learned features buy accuracy by spending far more arithmetic.](../../../books/vol1/nn_computation/images/svg/vol1_nn_computation_margin_001.svg)
...
![Neural-network history is a scale explosion in training energy.](../../../books/vol1/nn_computation/images/svg/vol1_nn_computation_margin_002.svg)
...
![ReLU's comparator logic is far cheaper in silicon than a sigmoid exponential.](../../../books/vol1/nn_computation/images/svg/vol1_nn_computation_margin_003.svg)
...
![MNIST is cache-scale; GPT-2 is VRAM-scale.](../../../books/vol1/nn_computation/images/svg/nn_computation_memory_explosion.svg)
...
![Matrix multiplication is over 90 percent of forward-pass FLOPs.](../../../books/vol1/nn_computation/images/svg/nn_computation_matmul_dominance.svg)
...
![Small neural workloads stay memory-bound even on large GPUs.](../../../books/vol1/nn_computation/images/svg/vol1_nn_computation_margin_004.svg)
...
![The Amazon failure is a Data-axis failure: biased historical signal.](../../../books/vol1/responsible_engr/images/svg/responsible_engr_dam_locator_data.svg)
...
![One upstream change; many silently affected.](../../../books/vol1/responsible_engr/images/svg/responsible_engr_blast_radius_sepsis.svg)
...
![Past the knee, the proxy decouples from the goal.](../../../books/vol1/responsible_engr/images/svg/responsible_engr_scale_anchor_goodhart.svg)
...
![Random sampling barely reaches small subgroups.](../../../books/vol1/responsible_engr/images/svg/vol1_responsible_engr_margin_001.svg)
...
![As automation grows more reliable, human vigilance decays.](../../../books/vol1/responsible_engr/images/svg/vol1_responsible_engr_margin_002.svg)
...
![Inference dominates lifetime cost; training is a rounding error.](../../../books/vol1/responsible_engr/images/svg/responsible_engr_tco_bar.svg)
...
![Training one model can rival a car's annual carbon.](../../../books/vol1/responsible_engr/images/svg/vol1_responsible_engr_margin_003.svg)
...
![Audit logs grow without bound as decisions are retained.](../../../books/vol1/responsible_engr/images/svg/vol1_responsible_engr_margin_004.svg)
...
![Training cost stays flat across scale, then explodes past the frontier knee.](../../../books/vol1/training/images/svg/training_cost_asymmetry.svg)
...
![Training is compute-dominated: data and latency overlap away.](../../../books/vol1/training/images/svg/training_iron_law_bars.svg)
...
![Adam state is the largest piece: 2$\\times$ the weights, half of training memory.](../../../books/vol1/training/images/svg/training_optimizer_memory.svg)
...
![Activation memory spans MNIST toys to GPT-scale training.](../../../books/vol1/training/images/svg/vol1_training_margin_001.svg)
...
![Bandwidth steps up the storage to DRAM to HBM hierarchy.](../../../books/vol1/training/images/svg/vol1_training_margin_002.svg)
...
![FlashAttention swaps the full attention matrix for small SRAM tiles.](../../../books/vol1/training/images/svg/vol1_training_margin_003.svg)
...
![Some models exceed single-GPU memory before anything else matters.](../../../books/vol1/training/images/svg/vol1_training_margin_004.svg)
...
![Gradient synchronization devours 30 to 70 percent of each step at scale.](../../../books/vol2/collective_communication/images/svg/collective_communication_comm_dominance.svg)
...
![Small messages are latency-bound, large ones bandwidth-bound; the cost reverses.](../../../books/vol2/collective_communication/images/svg/collective_communication_alpha_beta_dominance.svg)
...
![All-to-All traffic scales worse than AllReduce.](../../../books/vol2/collective_communication/images/svg/vol2_collective_communication_margin_001.svg)
...
![FSDP trades one step-level collective for two per-layer collectives.](../../../books/vol2/collective_communication/images/svg/vol2_collective_communication_margin_002.svg)
...
![Ring latency grows with N; tree stays logarithmic.](../../../books/vol2/collective_communication/images/svg/collective_communication_ring_tree_divergence.svg)
...
![Hierarchical collectives shrink payload before it crosses slow tiers.](../../../books/vol2/collective_communication/images/svg/vol2_collective_communication_margin_003.svg)
...
![Error feedback carries the residual into the next compressed step.](../../../books/vol2/collective_communication/images/svg/vol2_collective_communication_margin_004.svg)
...
![Decode sits deep in the memory-bound regime, far below the ridge.](../../../books/vol2/compute_infrastructure/images/svg/compute_infrastructure_decode_roofline.svg)
...
![Data movement dwarfs arithmetic in energy cost.](../../../books/vol2/compute_infrastructure/images/svg/vol2_compute_infrastructure_margin_001.svg)
...
![Modern GPU racks cross the air-cooling envelope.](../../../books/vol2/compute_infrastructure/images/svg/vol2_compute_infrastructure_margin_002.svg)
...
![Fleet-level MTBF falls inversely with GPU count.](../../../books/vol2/compute_infrastructure/images/svg/vol2_compute_infrastructure_margin_003.svg)
...
![HBM is 50-fold faster, so CXL is capacity only.](../../../books/vol2/compute_infrastructure/images/svg/compute_infrastructure_cxl_bandwidth_gap.svg)
...
![Decode sits memory-bound, left of the roofline ridge.](../../../books/vol2/conclusion/images/svg/vol2_conclusion_margin_001.svg)
...
![Storage and communication must be co-designed around matching rates.](../../../books/vol2/conclusion/images/svg/vol2_conclusion_margin_002.svg)
...
![Future efficiency needs hardware, algorithm, and orchestration gains together.](../../../books/vol2/conclusion/images/svg/vol2_conclusion_margin_003.svg)
...
![A datacenter draws megawatts; the brain runs on ~20 watts.](../../../books/vol2/conclusion/images/svg/vol2_conclusion_margin_004.svg)
...
![Storage is the Infrastructure axis of the fleet stack.](../../../books/vol2/data_storage/images/svg/data_storage_dai_locator.svg)
...
![Checkpoint writes dwarf training-data reads by about 1,000 times.](../../../books/vol2/data_storage/images/svg/data_storage_checkpoint_dominance.svg)
...
![Bandwidth drops roughly 479$\\times$ across the top three tiers, from HBM to local NVMe.](../../../books/vol2/data_storage/images/svg/data_storage_bandwidth_cliff.svg)
...
![Storage bandwidth demand swings wildly with data modality.](../../../books/vol2/data_storage/images/svg/vol2_data_storage_margin_001.svg)
...
![P99 I/O latency sets the required prefetch depth.](../../../books/vol2/data_storage/images/svg/vol2_data_storage_margin_002.svg)
...
![Repeated egress, not storage, dominates cloud cost.](../../../books/vol2/data_storage/images/svg/vol2_data_storage_margin_003.svg)
...
![Sharding collapses checkpoint-storm write time by two orders of magnitude.](../../../books/vol2/data_storage/images/svg/data_storage_checkpoint_storm_write_time.svg)
...
![Past a communication-to-compute threshold, scaling stops being ideal.](../../../books/vol2/distributed_training/images/svg/vol2_distributed_training_margin_001.svg)
...
![One missing worker stalls the entire AllReduce barrier.](../../../books/vol2/distributed_training/images/svg/vol2_distributed_training_margin_002.svg)
...
![Communication energy climbs from HBM out to the network.](../../../books/vol2/distributed_training/images/svg/vol2_distributed_training_margin_003.svg)
...
![Optimizer state, not weights, dominates the per-replica training budget.](../../../books/vol2/distributed_training/images/svg/distributed_training_memory_budget.svg)
...
![More stages require enough microbatches or the bubble dominates utilization.](../../../books/vol2/distributed_training/images/svg/distributed_training_pipeline_bubble_tax.svg)
...
![Tensor parallelism needs NVLink bandwidth; pipeline parallelism tolerates slower fabric.](../../../books/vol2/distributed_training/images/svg/vol2_distributed_training_margin_004.svg)
...
![The optimal checkpoint cadence balances write overhead against rework risk.](../../../books/vol2/distributed_training/images/svg/distributed_training_young_daly_optimum.svg)
...
![On-device learning hits the memory wall before the compute wall.](../../../books/vol2/edge_intelligence/images/svg/vol2_edge_intelligence_margin_001.svg)
...
![Datacenter HBM outruns mobile memory bandwidth by about 34 times.](../../../books/vol2/edge_intelligence/images/svg/edge_intelligence_bandwidth_ladder.svg)
...
![Device memory spans about 15,000 times, phone to microcontroller.](../../../books/vol2/edge_intelligence/images/svg/edge_intelligence_device_memory_ladder.svg)
...
![Adapters make per-user personalization cheap versus full model copies.](../../../books/vol2/edge_intelligence/images/svg/vol2_edge_intelligence_margin_002.svg)
...
![Learning the new task erodes accuracy on the old one.](../../../books/vol2/edge_intelligence/images/svg/vol2_edge_intelligence_margin_003.svg)
...
![Federated learning ships updates, not raw data, cutting network load.](../../../books/vol2/edge_intelligence/images/svg/vol2_edge_intelligence_margin_004.svg)
...
![Over-selection closes the round on the first K updates.](../../../books/vol2/edge_intelligence/images/svg/edge_intelligence_straggler_cutoff_strip.svg)
...
![System MTBF collapses as the fleet grows: 50,000 h to 5 h.](../../../books/vol2/fault_tolerance/images/svg/fault_tolerance_mtbf_ladder.svg)
...
![One shared dependency fails and takes every node with it.](../../../books/vol2/fault_tolerance/images/svg/fault_tolerance_blast.svg)
...
![Silent data corruption accumulates until it becomes routine.](../../../books/vol2/fault_tolerance/images/svg/vol2_fault_tolerance_margin_001.svg)
...
![Optimizer state, not weights, dominates checkpoint size.](../../../books/vol2/fault_tolerance/images/svg/vol2_fault_tolerance_margin_002.svg)
...
![Detection latency climbs from seconds (crash) to hours (silent corruption).](../../../books/vol2/fault_tolerance/images/svg/fault_tolerance_detection_ladder.svg)
...
![A single straggler idles every healthy accelerator.](../../../books/vol2/fault_tolerance/images/svg/vol2_fault_tolerance_margin_003.svg)
...
![Redundancy turns days of downtime into seconds.](../../../books/vol2/fault_tolerance/images/svg/vol2_fault_tolerance_margin_004.svg)
...
![A long conversation carries tens of GB of live state.](../../../books/vol2/fault_tolerance/images/svg/fault_tolerance_kv_live_state_ladder.svg)
...
![Normal component failure rates guarantee constant fleet failures.](../../../books/vol2/fleet_orchestration/images/svg/vol2_fleet_orchestration_margin_001.svg)
...
![Past about 70 percent utilization, queue wait time explodes.](../../../books/vol2/fleet_orchestration/images/svg/fleet_orchestration_util_knee.svg)
...
![Priority inversion is a wait-for chain, not a root-failure tree.](../../../books/vol2/fleet_orchestration/images/svg/fleet_orchestration_dependency_cascade.svg)
...
![Bandwidth cliffs from NVLink to spine across the fabric.](../../../books/vol2/fleet_orchestration/images/svg/fleet_orchestration_bw_hierarchy.svg)
...
![Elastic scaling's benefit flattens into saturation.](../../../books/vol2/fleet_orchestration/images/svg/vol2_fleet_orchestration_margin_002.svg)
...
![Reactive autoscaling opens an SLO gap during cold start.](../../../books/vol2/fleet_orchestration/images/svg/vol2_fleet_orchestration_margin_003.svg)
...
![Sharing packs two tenants, cutting wasted memory from 67 percent to 35 percent.](../../../books/vol2/fleet_orchestration/images/svg/fleet_orchestration_sharing_fill.svg)
...
![Allocated, active, and productive utilization drift far apart.](../../../books/vol2/fleet_orchestration/images/svg/vol2_fleet_orchestration_margin_004.svg)
...
![One eviction ripples to many: the preemption cascade.](../../../books/vol2/fleet_orchestration/images/svg/fleet_orchestration_preempt_cascade.svg)
...
![Lifetime serving cost dwarfs one-time training.](../../../books/vol2/inference/images/svg/inference_serving_cost_dominance.svg)
...
![Throughput saturates at the batch size where latency hits the SLO.](../../../books/vol2/inference/images/svg/inference_batching_knee.svg)
...
![Reasoning expands latency about 128 times over fast pattern-matching.](../../../books/vol2/inference/images/svg/inference_logic_wall_ladder.svg)
...
![The KV cache fills HBM, capping concurrent requests.](../../../books/vol2/inference/images/svg/inference_kv_cache_ladder.svg)
...
![Decode is memory-bound; parallel verification moves work toward the ridge.](../../../books/vol2/inference/images/svg/inference_decode_roofline.svg)
...
![Speculative decoding's speedup hinges on the acceptance rate.](../../../books/vol2/inference/images/svg/vol2_inference_margin_001.svg)
...
![MoE keeps every expert resident but activates few per token.](../../../books/vol2/inference/images/svg/vol2_inference_margin_002.svg)
...
![Two-choice routing flattens the tail imbalance of random placement.](../../../books/vol2/inference/images/svg/vol2_inference_margin_003.svg)
...
![One tenant's burst eats shared KV cache and starves the rest.](../../../books/vol2/inference/images/svg/vol2_inference_margin_004.svg)
...
![INT4 turns a two-GPU model into a one-GPU candidate.](../../../books/vol2/inference/images/svg/inference_quantization_capacity_ladder.svg)
...
![Fleet reliability collapses as node count climbs.](../../../books/vol2/introduction/images/svg/vol2_introduction_reliability_knee.svg)
...
![Gradient synchronization becomes the defining cost of distributed training.](../../../books/vol2/introduction/images/svg/vol2_introduction_margin_001.svg)
...
![Scaling regimes are compute-scarce, data-scarce, or balanced.](../../../books/vol2/introduction/images/svg/vol2_introduction_margin_002.svg)
...
![Past the communication-intensity cliff, adding GPUs stops helping.](../../../books/vol2/introduction/images/svg/vol2_introduction_ci_knee.svg)
...
![At fleet scale, a technical bug becomes societal risk.](../../../books/vol2/introduction/images/svg/vol2_introduction_margin_003.svg)
...
![At scale only about 4 percent of step time is compute; sync dominates.](../../../books/vol2/introduction/images/svg/vol2_introduction_coordination_tax.svg)
...
![Cutting FLOPs alone leaves latency memory-bound.](../../../books/vol2/introduction/images/svg/vol2_introduction_margin_004.svg)
...
![One slow link stalls every peer that waits on it.](../../../books/vol2/network_fabrics/images/svg/network_fabrics_gpu_fanout.svg)
...
![One paused receiver can freeze unrelated flows.](../../../books/vol2/network_fabrics/images/svg/network_fabrics_pfc_pause_blast.svg)
...
![Each extra meter pushes the fabric from copper toward optics.](../../../books/vol2/network_fabrics/images/svg/network_fabrics_physical_reach_ladder.svg)
...
![One upstream embedding update can degrade every dependent model.](../../../books/vol2/ops_scale/images/svg/ops_scale_cross_model_blast.svg)
...
![Streaming closes the freshness lag that batch leaves open.](../../../books/vol2/ops_scale/images/svg/vol2_ops_scale_margin_001.svg)
...
![Canary rollout cuts initial exposure by 20x.](../../../books/vol2/ops_scale/images/svg/ops_scale_canary_exposure_ladder.svg)
...
![Detecting smaller effects explodes the required sample size.](../../../books/vol2/ops_scale/images/svg/vol2_ops_scale_margin_002.svg)
...
![As tests multiply, false alerts become mathematically inevitable.](../../../books/vol2/ops_scale/images/svg/vol2_ops_scale_margin_003.svg)
...
![At production scale, serving (infer) dominates total cost of ownership.](../../../books/vol2/ops_scale/images/svg/ops_scale_tco_dominance.svg)
...
![Every minute of delayed detection compounds the cost.](../../../books/vol2/ops_scale/images/svg/vol2_ops_scale_margin_004.svg)
...
![Most transformer inference is memory-bound: the data-movement term dominates the iron law.](../../../books/vol2/performance_engineering/images/svg/performance_engineering_iron_law_bars.svg)
...
![Access energy climbs from registers out to HBM.](../../../books/vol2/performance_engineering/images/svg/vol2_performance_engineering_margin_001.svg)
...
![Larger batches raise arithmetic intensity toward the ridge.](../../../books/vol2/performance_engineering/images/svg/vol2_performance_engineering_margin_002.svg)
...
![FlashAttention shrinks attention memory about 65 times.](../../../books/vol2/performance_engineering/images/svg/performance_engineering_flash_ladder.svg)
...
![Lower precision frees memory, enlarging the feasible batch.](../../../books/vol2/performance_engineering/images/svg/vol2_performance_engineering_margin_003.svg)
...
![Speculative decoding shifts decode toward the compute-bound ridge.](../../../books/vol2/performance_engineering/images/svg/performance_engineering_specdec_roofline.svg)
...
![The communication tax erodes local MFU into fleet MFU.](../../../books/vol2/performance_engineering/images/svg/vol2_performance_engineering_margin_004.svg)
...
![Fairness constraints cost a few points of accuracy, the responsibility tax.](../../../books/vol2/responsible_ai/images/svg/responsible_ai_fairness_tax.svg)
...
![Error concentrates at the intersection: dark-skinned women.](../../../books/vol2/responsible_ai/images/svg/responsible_ai_intersectional_quadrant.svg)
...
![SISA unlearning beats full retraining by about 100 times.](../../../books/vol2/responsible_ai/images/svg/responsible_ai_unlearning_cost_ladder.svg)
...
![Exact SHAP cost explodes with feature count.](../../../books/vol2/responsible_ai/images/svg/vol2_responsible_ai_margin_001.svg)
...
![Responsible AI monitoring becomes its own production data system.](../../../books/vol2/responsible_ai/images/svg/responsible_ai_monitoring_scale.svg)
...
![Higher AI accuracy can paradoxically lower human vigilance.](../../../books/vol2/responsible_ai/images/svg/vol2_responsible_ai_margin_002.svg)
...
![Contestability is a production stack, not just a policy word.](../../../books/vol2/responsible_ai/images/svg/vol2_responsible_ai_margin_003.svg)
...
![Representation cost scales with subgroup coverage, not just dataset size.](../../../books/vol2/responsible_ai/images/svg/responsible_ai_representation_tax_ladder.svg)
...
![At fleet scale, rare failures become expected incidents.](../../../books/vol2/responsible_ai/images/svg/vol2_responsible_ai_margin_004.svg)
...
![In sharded inference, one failed stage fails the whole request.](../../../books/vol2/robust_ai/images/svg/vol2_robust_ai_margin_001.svg)
...
![Drift stays benign until the index crosses a threshold; past the knee, reliability degrades fast.](../../../books/vol2/robust_ai/images/svg/robust_ai_psi_drift_knee.svg)
...
![One surrogate-crafted adversarial example transfers across many models.](../../../books/vol2/robust_ai/images/svg/vol2_robust_ai_margin_002.svg)
...
![Data poisoning runs a lifecycle: inject, learn, trigger.](../../../books/vol2/robust_ai/images/svg/vol2_robust_ai_margin_003.svg)
...
![Adversarial robustness costs roughly 26 points of clean accuracy.](../../../books/vol2/robust_ai/images/svg/robust_ai_robustness_tax.svg)
...
![Huber loss caps the outlier influence that squared loss amplifies.](../../../books/vol2/robust_ai/images/svg/vol2_robust_ai_margin_004.svg)
...
![The attack surface spans Data, Algorithm, and Infrastructure.](../../../books/vol2/security_privacy/images/svg/security_privacy_dai_attack_surface.svg)
...
![Full distributions leak far more than top-k outputs.](../../../books/vol2/security_privacy/images/svg/security_privacy_output_leakage_ladder.svg)
...
![Enclave memory caps which models can run securely.](../../../books/vol2/security_privacy/images/svg/vol2_security_privacy_margin_001.svg)
...
![Privacy-preserving computation costs orders more latency than encryption.](../../../books/vol2/security_privacy/images/svg/vol2_security_privacy_margin_002.svg)
...
![Each query spends part of the finite $\\epsilon$ privacy budget.](../../../books/vol2/security_privacy/images/svg/vol2_security_privacy_margin_003.svg)
...
![Small sensitive datasets often cannot absorb DP noise without losing utility.](../../../books/vol2/security_privacy/images/svg/security_privacy_dp_dataset_threshold.svg)
...
![The attack surface grows faster than the node count.](../../../books/vol2/security_privacy/images/svg/vol2_security_privacy_margin_004.svg)
...
![The same job's carbon emissions depend on where it runs.](../../../books/vol2/sustainable_ai/images/svg/vol2_sustainable_ai_margin_001.svg)
...
![PUE is the infrastructure energy tax on top of compute.](../../../books/vol2/sustainable_ai/images/svg/vol2_sustainable_ai_margin_002.svg)
...
![Per-byte move energy spans five orders, register to network.](../../../books/vol2/sustainable_ai/images/svg/sustainable_ai_energy_per_byte_ladder.svg)
...
![Cumulative inference emissions overtake the one-time training cost.](../../../books/vol2/sustainable_ai/images/svg/sustainable_ai_inference_crossover.svg)
...
![Substation lead time can run 4$\\times$ longer than GPU procurement.](../../../books/vol2/sustainable_ai/images/svg/sustainable_ai_grid_interconnection_ladder.svg)
...
![Training power climbs far above steady serving load.](../../../books/vol2/sustainable_ai/images/svg/vol2_sustainable_ai_margin_003.svg)
...
![Below the thermal limit the chip runs safely; cross it and throttling climbs steeply.](../../../books/vol2/sustainable_ai/images/svg/sustainable_ai_thermal_throttle_knee.svg)
...
![One cooling failure can idle the whole training job.](../../../books/vol2/sustainable_ai/images/svg/sustainable_ai_cooling_failure_blast.svg)
...
![Radio transmission dwarfs local arithmetic in energy.](../../../books/vol2/sustainable_ai/images/svg/vol2_sustainable_ai_margin_004.svg)
