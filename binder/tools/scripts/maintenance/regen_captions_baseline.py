#!/usr/bin/env python3
"""Regenerate binder/tools/audit/baselines/captions_baseline.json.
...
Run from the repo root:
    python3 binder/tools/scripts/maintenance/regen_captions_baseline.py
"""
...
def main() -> int:
    ...
    baseline = {
        "description": (
            ...
            "binder/tools/scripts/maintenance/regen_captions_baseline.py."
        ),
