...
#   ./binder/tools/scripts/learning_objectives_bolding_parallel.sh
#
...
#              Adjust with: MAX_PARALLEL=4 ./binder/tools/scripts/learning_objectives_bolding_parallel.sh

set -e

# Repo root (script lives at binder/tools/scripts/)
