...
LLM/editor notes:
    ...
    * A margin figure must serve the paragraph beside it. The chapter placement
      ...
      ``binder/tools/audit/margin_figure_opportunities.yml`` and
...
Usage:
    MPLCONFIGDIR=/tmp/mplconfig python3 binder/tools/scripts/margin_figures/generate_margin_figures.py
"""
...
from binder.tools.figures.margin.devices import (  # noqa: E402
    C,
    COMP,
    DATA,
    GRID,
...
CONTENTS = ROOT / "books"
AUDIT_DIR = ROOT / "binder/tools/audit"
