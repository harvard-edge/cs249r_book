...
def find_qmd_references(svg_path: str, search_root: str = "books") -> List[Tuple[str, int, str]]:
    """
...
def main():
    ...
    parser.add_argument('--search-root', default="books", help="Root directory to search for QMD files")
