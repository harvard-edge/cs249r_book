...
```bash
python3 binder/tools/scripts/audit/math_chapter_workflow.py build \
...
```bash
python3 binder/tools/scripts/audit/math_chapter_workflow.py list --volumes vol1,vol2
```
...
```bash
python3 binder/tools/scripts/audit/math_chapter_workflow.py summarize \
