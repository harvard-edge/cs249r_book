...
Production scripts under `binder/tools/scripts/margin_figures/` import this module
...
- Per-figure data, labels, captions, and asset names:
  `binder/tools/scripts/margin_figures/generate_margin_figures.py`
...
```bash
python3 binder/tools/scripts/margin_figures/render_margin_contact_sheet.py \
