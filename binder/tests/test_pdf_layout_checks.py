...
from binder.cli.commands._pdf_checks import (
    PdfCheckItem,
    PdfIssue,
    PdfValidationResult,
    format_checklist,
...
from binder.cli.commands.layout import PageReport
from binder.cli.commands.layout import CollisionFinding
from binder.cli.checks.margin_geometry import MarginGeometryFinding, MarginGeometrySummary
from binder.cli.checks.margin_geometry import scan_page as scan_margin_geometry_page
...
def test_pdf_text_scan_flags_bare_crossrefs(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "binder.cli.commands._pdf_checks._pdftotext",
        lambda _: (
...
def test_scan_margin_overflow_missing_file_returns_none():
    from binder.cli.commands.layout import scan_margin_overflow
...
def test_default_log_path_discovers_sibling_log(tmp_path):
    ...
    from binder.cli.commands._pdf_checks import default_log_path
...
def test_stale_log_is_not_auto_discovered(tmp_path):
    ...
    import os
    from binder.cli.commands._pdf_checks import default_log_path, default_pdf_path
