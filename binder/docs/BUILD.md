...
# Build complete book
./binder/binder build                          # Complete book (HTML)
./binder/binder build pdf                      # Complete book (PDF)
./binder/binder build epub                     # Complete book (EPUB)
...
#### Build Complete Book
```sh
./binder/binder build                  # Complete website (HTML)
./binder/binder build pdf              # Complete book (PDF)
...
```sh
./binder/binder preview                        # Preview complete book
./binder/binder preview intro                  # Preview specific chapter
./binder/binder preview intro,ml_systems       # Preview multiple chapters
```

#### Management Commands
```sh
./binder/binder clean                  # Clean build artifacts
./binder/binder status                 # Show current status
./binder/binder list                   # List all available chapters
...
./binder/binder build intro    # ✓ correct
./binder/binder build Intro    # ✗ wrong
```
...
1. **Run the health check**: `./binder/binder doctor`
...
- 🚀 **Preview changes locally** with live reload: `./binder/binder preview intro`
- 🔨 **Build individual chapters** for fast iteration: `./binder/binder build intro`
- 📚 **Build complete book** in multiple formats: `./binder/binder build`, `./binder/binder build pdf`, `./binder/binder build epub`
- 🔍 **Validate your setup** anytime: `./binder/binder doctor`
...
Run `./binder/binder help` to see all available commands and their descriptions.
...
4. **Test locally**: `./binder/binder preview <chapter>`
