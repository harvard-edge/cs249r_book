...
### Core Files
- `binder/docker/linux/Dockerfile` - Linux build container definition
- `binder/docker/linux/README.md` - Linux container documentation
- `binder/docker/linux/.dockerignore` - Linux build exclusions
- `binder/docker/windows/Dockerfile` - Windows build container definition
- `binder/docker/windows/README.md` - Windows container documentation
- `binder/docker/windows/.dockerignore` - Windows build exclusions
...
- **Linux**:
  ```bash
  docker build -f binder/docker/linux/Dockerfile -t mlsysbook-linux .
  ```
- **Windows**:
  ```powershell
  docker build -f binder/docker/windows/Dockerfile -t mlsysbook-windows .
  ```
