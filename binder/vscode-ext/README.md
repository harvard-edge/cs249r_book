...
This extension treats `./binder/binder` as the operational backend.
...
See [`binder/docs/BINDER.md`](../docs/BINDER.md) for the check/fix reference and pre-commit mapping.
...
- Build chapter: `./binder/binder build html <chapter>` / `./binder/binder build pdf <chapter>`
- Debug failures: `./binder/binder debug <pdf|html|epub> --vol1|--vol2`
- Validate content: `./binder/binder check all` or `./binder/binder check refs`
- Maintenance: `./binder/binder fix repo-health`
