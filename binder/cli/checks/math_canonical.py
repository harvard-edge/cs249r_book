...
The standalone CLI ``binder/tools/audit/audit_math_canonical.py`` is a thin
...
CANONICAL_STR_CALL = re.compile(
    ...
    r"|fmt_frequency|fmt_acceleration|fmt_velocity|fmt_torque|fmt_torque_rate|fmt_jerk"
