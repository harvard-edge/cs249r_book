...
class ResetCommand:
    ...
    def _print_help(self) -> None:
        ...
        console.print("  [cyan]./binder/binder reset pdf --vol1[/cyan]")
        console.print("  [cyan]./binder/binder reset html --vol2[/cyan]")
        console.print("  [cyan]./binder/binder reset all[/cyan]")
        console.print()
