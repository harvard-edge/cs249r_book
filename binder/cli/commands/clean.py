...
class CleanCommand:
    ...
    def _restore_configs(self) -> bool:
        ...
        try:
            # Remove the generated _quarto.yml; leave a hand-written one alone
            source = self.config_manager.active_config_source()
            if source:
                self.config_manager.active_config.unlink()
                console.print(f"  ✅ Removed generated _quarto.yml (copy of {source})")
            elif self.config_manager.active_config.exists():
                console.print("  📄 Active config was not generated by binder (not removing)")
            else:
    ...
    def print_help(self) -> None:
        ...
        table.add_row("(none)", "Clean HTML/PDF/EPUB build directories, temp files, and the generated _quarto.yml")
