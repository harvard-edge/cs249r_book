...
class FormatCommand:
    ...
    def _print_help(self) -> None:
        ...
        console.print("  [cyan]./binder/binder format blanks[/cyan]                [dim]# fix all files[/dim]")
        console.print("  [cyan]./binder/binder format tables --check[/cyan]        [dim]# check only, no writes[/dim]")
        console.print("  [cyan]./binder/binder format python path/to/ch.qmd[/cyan] [dim]# single file[/dim]")
        console.print("  [cyan]./binder/binder format python --include-display path/to/ch.qmd[/cyan]")
