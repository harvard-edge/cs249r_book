...
class HeadingsCommand:
    ...
    def _print_help(self) -> None:
        ...
        console.print("  [cyan]./binder/binder headings check[/cyan]")
        console.print("  [cyan]./binder/binder headings dry-run[/cyan]")
        console.print("  [cyan]./binder/binder headings apply[/cyan]")
        console.print()
    ...
    def _run_check(self, files: List[str]) -> bool:
        ...
        console.print(f"\n   [cyan]Fix:[/cyan] ./binder/binder headings apply")
