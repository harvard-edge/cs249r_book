...
class NewsletterCommand:
    ...
    def _handle_new(self, args) -> bool:
        ...
        if not args:
            console.print("[red]Usage: ./binder/binder newsletter new \"Your Newsletter Title\"[/red]")
            return False
        ...
        console.print(f"[dim]Edit it, then publish with: ./binder/binder newsletter publish {slug}[/dim]")
        return True
    ...
    def _handle_list(self, args) -> bool:
        ...
        if table.row_count == 0:
            console.print("[dim]No newsletters found. Create one with: ./binder/binder newsletter new \"Title\"[/dim]")
        else:
            console.print(table)
        return True
    ...
    def _handle_preview(self, args) -> bool:
        ...
        if not args:
            console.print("[red]Usage: ./binder/binder newsletter preview <slug>[/red]")
            return False
    ...
    def _handle_publish(self, args) -> bool:
        ...
        if not args:
            console.print("[red]Usage: ./binder/binder newsletter publish <slug>[/red]")
            return False
