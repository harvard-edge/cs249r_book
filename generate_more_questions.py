...
---
{current_content[:4000]}... (truncated)
---
...
targets = {
    "cloud": {
        "02_network_and_distributed.md": 30,
        "03_inference_and_serving.md": 28,
        "04_data_and_mlops.md": 20,
        "06_advanced_systems.md": 5
    },
    "edge": {
        "01_systems_and_real_time.md": 35,
        "03_data_and_deployment.md": 13,
        "05_heterogeneous_and_advanced.md": 14
    },
    "mobile": {
        "01_systems_and_soc.md": 34,
        "03_data_and_deployment.md": 7,
        "05_advanced_systems.md": 34
    },
    "tinyml": {
        "01_micro_architectures.md": 33,
        "03_data_and_deployment.md": 35,
        "05_advanced_systems.md": 14
    }
}
...
for track, files in targets.items():
    for filename, count in files.items():
        ...
        # Since generating 20 questions at once might hit output token limits (8k tokens),
        # we'll split it into batches of 5.
        new_content = ""
        remaining = count
        while remaining > 0:
