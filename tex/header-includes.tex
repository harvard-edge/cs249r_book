...
\definecolor{BrownLL}{rgb}{0.6, 0.4, 0.2}
...
%PART
\node[black!60,align=flush right,inner sep=0,outer sep=0mm,draw=none,anchor=south,
font={\fontsize{38pt}{38}\selectfont\bfseries}]  (BG) at ($(S2)!0.5!(SS2)$){\hphantom{Part}};
%%%
\path[red](D2)-|coordinate(TPD)(BG.south east);
\node[inner sep=0mm,draw=none,anchor=south east,%text width=0.9\textwidth,
align=right,font={\fontsize{40pt}{40}\selectfont}]
(BGG) at (TPD)  {\color{crimson}\MakeUppercase {#1}};
\end{tikzpicture}
}
\renewcommand{\thepart}{}
