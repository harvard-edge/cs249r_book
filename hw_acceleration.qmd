...
The statement "GPUs are less efficient than ASICs" could spark intense debate within the ML/AI field cause this book to explode 🤯. 
...
* P**resence in data centers:** Although we often hear that GPUs dominate the data center marker, CPUs are still well suited for tasks that don’t inherently possess a large amount of parallelism. CPUs often handle serial and small tasks and coordinate the data center as a whole.
...
challenges. The following video will provide additional context.

{{< video https://www.youtube.com/watch?v=Fcob512SJz0&ab_channel=TheLinleyGroup >}}

#### Chiplets for AI

[Chiplets](https://en.wikipedia.org/wiki/Chiplet)
...
![Comparison of the von Neumann architecture with the
...
communication, and timing.](images/hw_acceleration/aimage3.png)
...
![Neurons communicate via spikes. (a) Diagram of a neuron.
...
111, no. 9, pp. 1016-1054, Sept. 2023, doi: 10.1109/JPROC.2023.3308088](images/hw_acceleration/aimage4.png)

{{< video https://upload.wikimedia.org/wikipedia/commons/7/71/Spiking_Neural_Network_Controlled_Virtual_Insect_Navigate_in_an_Random_Terrain.ogv >}}
...
1. Modha, D. S., Akopyan, F., Andreopoulos, A., Appuswamy, R.,
...
1. Shastri, B. J., Tait, A. N., Ferreira de Lima, T., Pernice, W. H.,
...
![Flexible electronics and some of their applications in daily
life. Figure taken from ref 11.](images/hw_acceleration/fimage1.png)
...
confidence](vertopal_3073d5a08180432e89766872a95a47ae/media/image7.png)
...
We encourage you to read [Architecture 2.0](https://www.sigarch.org/architecture-2-0-why-computer-architects-need-a-data-centric-ai-gymnasium/) if ML-aided computer architecture design interests you.
