...
- `████░` **Chapter 1: Introduction**: The introduction chapter now includes benchmarking information.
- `█████` **Chapter 3: DL Primer**: Fixed broken image links in DL Primer.
- `█████` **Chapter 5: AI Workflow**: Updated content
- `█░░░░` **Chapter 7: AI Frameworks**: Updated content
- `█████` **Chapter 8: AI Training**: Simplified the training section and introduced transfer learning concepts.
- `███░░` **Chapter 9: Efficient AI**: Removed details about benchmarking as it was moved to a separate chapter.
- `██░░░` **Chapter 10: Model Optimizations**: Updated content
- `█░░░░` **Chapter 11: AI Acceleration**: Updated content
- `████░` **Chapter 14: On-Device Learning**: Updated content
- `████░` **About**: Updated content
- `██░░░` **Acknowledgements**: Updated content
- `█████` **Embedded Sys**: Adjusted image sizes within embedded_sys.qmd.
- `███░░` **Contributors**: Updated contributors list.
- `████░` **Embedded Ml**: Improved explanations related to machine learning concepts.
- `███░░` **Index**: Updated content
...
- `███░░` **Chapter 1: Introduction**: Improved chapter outline based on content rearrangement.
- `█░░░░` **Chapter 3: DL Primer**: Simplified the video element display based on Quarto's capabilities.
- `███░░` **Chapter 6: Data Engineering**: Updated content
- `██░░░` **Chapter 7: AI Frameworks**: Corrected grammar errors for improved clarity.
- `████░` **Chapter 8: AI Training**: Training section simplified and transfer learning concepts were added.
- `███░░` **Chapter 9: Efficient AI**: Removed details about benchmarking as it now has its own chapter.
- `████░` **Chapter 10: Model Optimizations**: Added first draft of outline for the Model Optimizations chapter.
- `███░░` **Chapter 11: AI Acceleration**: Grammar corrections were made to improve the clarity of existing explanations.
- `████░` **Chapter 12: Benchmarking AI**: Added a benchmarking chapter.
- `███░░` **Chapter 14: On-Device Learning**: Updated content
- `████░` **Chapter 15: Security & Privacy**: Created initial outline covering data security and governance topics.
- `████░` **Chapter 16: Responsible AI**: Added a first draft outline.
- `████░` **Chapter 17: Sustainable AI**: Updated content
- `███░░` **About**: About page updated with the latest information based on changes made to the chapters.
- `█░░░░` **Embedded Ml**: Fixes were made to the Machine Learning chapter.
- `███░░` **Contributors**: Added a file to store contributor information.
- `████░` **Mlops**: Initial draft of Mlops section content was added.
- `███░░` **Generative Ai**: Outlined the structure for the generative AI section.
- `███░░` **Deployment**: Updated content
...
- `███░░` **Chapter 1: Introduction**: The chapter outline was reorganized.
- `███░░` **Chapter 3: DL Primer**: Added a conclusion section to summarize key concepts covered in the chapter.
- `███░░` **Chapter 6: Data Engineering**: Updated content
- `██░░░` **Chapter 7: AI Frameworks**: Introductions to AI frameworks are moved to the beginning of the chapter.
- `████░` **Chapter 8: AI Training**: Updated content
- `████░` **Chapter 9: Efficient AI**: Created an outline for the efficient AI chapter.
- `████░` **Chapter 10: Model Optimizations**: Updated content
- `████░` **Chapter 11: AI Acceleration**: Reorganized chapter content to start with introductory material on hardware acceleration concepts.
- `██░░░` **Chapter 14: On-Device Learning**: Updated content
- `████░` **Chapter 15: Security & Privacy**: Created an initial outline focused on data privacy and governance concepts.
- `████░` **Chapter 16: Responsible AI**: Updated content
- `████░` **Chapter 17: Sustainable AI**: Updated content
- `███░░` **About**: Content within the chapters was updated.
- `████░` **Mlops**: Initial draft of Mlops section created based on course material.
- `███░░` **Generative Ai**: Outlined the structure for generative AI concepts.
- `███░░` **Deployment**: Updated content
- `██░░░` **Embedded Ml**: Added a conclusion section.
...
- `████░` **Chapter 1: Introduction**: Added a brief chapter overview for each section based on feedback.
- `█████` **Chapter 3: DL Primer**: Added a conclusion section to provide closure to the chapter content.
- `████░` **Chapter 6: Data Engineering**: Updated content
- `████░` **Chapter 7: AI Frameworks**: Added introductory text and outlined key topics for the AI Frameworks chapter.
- `████░` **Chapter 8: AI Training**: Updated content
- `████░` **Chapter 9: Efficient AI**: Created initial outline structure for the efficient AI chapter.
- `███░░` **Chapter 10: Model Optimizations**: Removed the hardware acceleration section as it is covered in a dedicated chapter.
- `████░` **Chapter 11: AI Acceleration**: Initial outline was created for the hardware section of the chapter.
- `██░░░` **Chapter 14: On-Device Learning**: Updated content
- `█░░░░` **Chapter 15: Security & Privacy**: Updated content
- `█░░░░` **Chapter 16: Responsible AI**: Updated content
- `█░░░░` **Chapter 17: Sustainable AI**: Updated content
- `████░` **Embedded Ml**: The embedded ML section was updated with a conclusion and timeline based on feedback.
- `███░░` **Learning Resources**: Improved how learning resources are listed
- `████░` **Resources**: Added new resources and an appendix with community pages.
- `███░░` **Zoo Datasets**: Updated content
- `█░░░░` **Zoo Models**: Added resources
- `███░░` **Tools**: Updated content
- `█░░░░` **Front**: Updated content
- `█░░░░` **Generative Ai**: Updated content
- `██░░░` **Deployment**: Updated content
- `█████` **Mlworkflow**: Outlined the structure of an ML workflow.
- `███░░` **Embedded Sys**: Improved clarity of section headers.
- `██░░░` **Mlops**: Updated content
- `██░░░` **Preprocessing**: Integrated preprocessing concepts into the data section.
- `█░░░░` **Index**: The title was changed to better reflect the evolving content.
- `███░░` **Community**: Added an appendix with resources and links to community pages.
...
- `█████` **Chapter 3: DL Primer**: Added a challenges section to encourage deeper understanding of the material.
- `███░░` **About**: Updated structure and content of About.qmd.
- `██░░░` **Acknowledgements**: Updated the acknowledgements section.
- `████░` **Embedded Ml**: Updated content
- `███░░` **Community**: Added an appendix with community resources and pages.
- `███░░` **Resources**: Added an appendix with resources and links to community pages.
- `██░░░` **Dedication**: Added dedication to navigation.
- `██░░░` **Index**: The index structure was improved, and the front text was updated.
- `██░░░` **Copyright**: Updated copyright information.
- `█░░░░` **Embedded Sys**: Revised structure and updated content within Chapter 2.
...
- `██░░░` **Chapter 1: Introduction**: Updated content
- `█████` **Chapter 3: DL Primer**: Added a challenges section to promote deeper understanding of the basic concepts of deep learning neural networks.
- `█░░░░` **Chapter 9: Efficient AI**: Updated content
- `████░` **About**: Clarified the target audience for this material.
- `██░░░` **Acknowledgements**: Updated the acknowledgements section
- `███░░` **Copyright**: Updated copyright information.
- `██░░░` **Dedication**: Updated dedication text.
- `█████` **Embedded Sys**: Added introductory material and reference examples to enhance understanding.
- `█░░░░` **Index**: Updated the index structure and front text.
- `██░░░` **Intro**: Updated content
- `█░░░░` **Credits**: Updated content
