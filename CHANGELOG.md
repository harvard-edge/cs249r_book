...
- **Index**: The frontmatter index of the machine learning systems textbook has been restructured for improved organization and maintainability, with updates to section IDs in accordance with changes to the manager code. Additionally, section headers have been updated using a script, and a new hash considering section content has been implemented. The "Why We Wrote This Book" section has been refined with improved narrative flow, moving the collaborative quote to follow the problem statement for better impact. The language has been made more formal and academic, appropriate for a textbook, and includes the personal story of collaborative development during the Fall 2023 CS249r class. Consistent "AI engineers" terminology has been used throughout, and the global sharing mission has been emphasized.
- **Foreword**: The foreword section of the machine learning systems textbook has been restructured for improved organization and maintainability.
- **About**: The about.qmd file has been restructured for better organization and maintainability, with updates to section generation scripts, section IDs, and headers for consistent linking. A cross-reference to Bloom's figure has been added, along with quizzes for self-assessment. A bug related to the 'repair' function has also been fixed.
- **Changelog**: The repository has been restructured for improved organization and maintainability.
- **Acknowledgements**: The acknowledgements section has been updated with improved section generation and consistent linking through updated section IDs. Additionally, the section headers have been updated using a new script.
- **SocraticAI**: The SocratiQ documentation has been enhanced with added figure references and improved AI-powered figure captions. A new script for section generation has been implemented, leading to updated section IDs for consistent linking and updated section headers. Additionally, PDF part summaries have been implemented.
...
- **PhD Survival Guide**: The resources guide in the backmatter has been updated with restructured anchor links and the quiz answers have been fixed to be inserted before the part block if necessary.
- **PhD Survival Guide**: The "PhD Survival Guide" has been moved from the appendix to the backmatter/resources section.
- **Chapter 1: Introduction**: The introduction chapter of the machine learning systems textbook has been significantly updated with the addition of quizzes, section headers, and anchors for better navigation and self-check answers. The repository has been restructured for improved organization and maintainability. The machine learning systems engineering definition has been introduced and later refined for clarity. Figure captions, particularly for AlphaFold, have been updated and standardized, and a cross-referencing system has been implemented with HTML and PDF support. The inject_crossrefs.lua and quiz insertion logic have been fixed and improved.
- **Chapter 2: ML Systems**: The ML Systems chapter has been restructured for better organization and maintainability. Key concepts have been enhanced and clarified, and figure captions have been updated for clarity and context. The source citation has been standardized, and the "Conclusion" sections have been renamed to "Summary". Quizzes have been added to the chapter, with a new section for self-check answers. The quiz insertion logic and answer extraction have been improved. The chapter no longer includes a resources section.
- **Chapter 3: DL Primer**: The DL Primer chapter in the machine learning systems textbook has been significantly updated with enhanced descriptions and clarified key concepts, improved figure captions, and new Tikz figures added from chapter 3 to 6. The "Conclusion" sections have been renamed to "Summary", and the "Quiz Answers" to "Self-Check Answers". The repository structure has been reorganized for better maintainability, and quizzes have been added to the efficient AI chapter and associated with the DL Primer. The section IDs have been updated for consistent linking, and the first major draft of all quizzes has been generated, integrated, and reviewed.
- **Chapter 4: DNN Architectures**: The machine learning systems textbook has been significantly updated with new Tikz figures added in chapters 3 to 6, 9 and 10. The descriptions have been enhanced and key concepts clarified for better understanding. The "Conclusion" sections have been renamed to "Summary" and the quizzes have been fully inserted with improved logic and answer extraction. The quiz answers have been updated and reformatted, and are now inserted before the part block if needed. The section IDs and quiz JSON files have been updated for consistency, and the resources sections have been removed from chapters. The listings caption has been improved with no truncation, and the figure captions have been updated for clarity and context. The script now automatically injects quizzes from the JSON files and removes unnecessary blank lines and whitespace. The section headers have also been updated using the script.
- **Chapter 5: AI Workflow**: The textbook has been restructured for better organization and maintainability, with updates to section IDs and quiz JSON files. The figure captions have been corrected and updated for clarity and context, with enhancements to descriptions and clarification of key concepts. The "Conclusion" sections have been renamed to "Summary", and quizzes have been added to the Efficient AI chapter. The first major draft of all quizzes has been generated and integrated. The section headers have been updated, and a new hash that considers section content has been implemented.
- **Chapter 6: Data Engineering**: The data engineering section of the textbook has been enhanced with clarified key concepts and additional descriptions. New Tikz figures have been added in chapters 3 to 6, and the "Conclusion" sections have been renamed to "Summary". Quizzes have been added to the efficient AI chapter and the first major draft of all quizzes has been integrated. The quiz answers have been corrected and improved, and the "Quiz Answers" section has been renamed to "Self-Check Answers". The script for section generation has been updated, ensuring consistent file endings and section IDs for consistent linking.
- **Chapter 7: AI Frameworks**: The textbook has been restructured for better organization and maintainability, with new TikZ figures added to Chapters 7, 8, 9, and 10. The descriptions have been enhanced and key concepts clarified. The "Conclusion" sections have been renamed to "Summary" and a new section on framework components has been added. The quizzes have been updated and integrated into the efficient AI chapter, and the quiz answers have been renamed to "Self-Check Answers". The figure and listings captions have been improved for clarity, context, and adherence to the style guide.
- **Chapter 8: AI Training**: The textbook has been restructured for better organization and maintainability, with enhancements to descriptions and clarification of key concepts. New Tikz figures have been added to Chapters 7, 8, 9, and 10. The listings caption has been improved with no truncation. The "Conclusion" sections have been renamed to "Summary", and the "Quiz Answers" sections have been renamed to "Self-Check Answers". Quizzes have been added to the efficient AI chapter, and all quizzes have been generated, integrated, and reviewed. Section anchors for self-check answers have been added, and the section IDs have been updated for consistent linking.
- **Chapter 9: Efficient AI**: The textbook has been restructured for better organization and maintainability, with new Tikz figures added in chapters 9 and 10. Figure captions and descriptions have been updated for clarity and context, and key concepts have been clarified. The "Conclusion" sections have been renamed to "Summary", and the section IDs and quiz JSON files have been updated. Quizzes have been added to the efficient AI chapter, with the first major draft of all quizzes generated and integrated. The script for section generation has been updated, and all section IDs have been cleaned to fix them. The quiz answers have been corrected and their formatting improved. The "Quiz Answers" section has been renamed to "Self-Check Answers".
- **Chapter 10: Model Optimizations**: The machine learning systems textbook has been restructured for better organization and maintainability, with updates to citation styles in the static quantization section. New Tikz figures have been added to chapters 9 and 10, and figure captions have been updated for clarity and context. Descriptions have been enhanced and key concepts clarified, while the "Conclusion" sections have been renamed to "Summary". Quizzes have been added to the efficient AI chapter, and a first major draft of all quizzes has been integrated. Section headers have been updated using a script, and the quiz answers section has been renamed to "Self-Check Answers".
- **Chapter 11: AI Acceleration**: The machine learning systems textbook has been restructured for better organization and maintainability, with enhanced descriptions and clarified key concepts. Figure captions have been updated for clarity and context, and "Conclusion" sections have been renamed to "Summary". Quizzes have been added to the efficient AI chapter, with improved insertion logic and answer extraction. Section IDs have been updated for consistent linking, and a first major draft of all quizzes has been generated and integrated.
- **Chapter 12: Benchmarking AI**: The benchmarking chapter in the machine learning systems textbook has been significantly updated with enhanced descriptions and clarified key concepts. The figure and table captions have been corrected and updated for better clarity and context. The quizzes have been integrated into the chapter with improved insertion logic and answer extraction. The "Conclusion" sections have been renamed to "Summary" and the "Quiz Answers" to "Self-Check Answers". The chapter no longer contains the resources sections, and the section IDs have been updated for consistent linking.
- **Chapter 13: ML Operations**: The textbook has been restructured for better organization and maintainability, with enhancements to descriptions and clarification of key concepts. The "Conclusion" sections have been renamed to "Summary", and quizzes have been added to the efficient AI chapter. The listings and figure captions have been improved for clarity and context, and the section IDs have been updated for consistent linking. The resources sections from chapters have been removed, and a first major draft of all quizzes has been generated and integrated. Additionally, section anchors have been added for self-check answers.
- **Chapter 14: On-Device Learning**: The on-device learning chapter has been restructured for better organization and maintainability, with enhanced descriptions and clarified key concepts. The "Conclusion" sections have been renamed to "Summary", and section headers have been updated. The resources sections from chapters have been removed. Quizzes have been added to the efficient AI chapter, with the first major draft of all quizzes generated and integrated. The quiz insertion logic and answer extraction have been improved, and "Quiz Answers" have been renamed to "Self-Check Answers". The section IDs have been updated for consistent linking, and the script for section generation has been updated.
- **Chapter 18: Robust AI**: The robust AI chapter has been restructured for better organization and maintainability, with enhanced descriptions and clarified key concepts. Figure captions have been updated for clarity and context, and the "Conclusion" sections have been renamed to "Summary". Quizzes have been added to the efficient AI chapter and their insertion logic has been improved. Section IDs have been updated for consistent linking and the "Quiz Answers" have been renamed to "Self-Check Answers". The example Colab notebooks have been removed.
- **Chapter 15: Security & Privacy**: The core privacy and security chapter in the machine learning systems textbook has been restructured for better organization and maintainability. Key concepts have been clarified and descriptions enhanced, while figure captions have been updated for clarity and context, and made to adhere to the style guide. The "Conclusion" sections have been renamed to "Summary" and resources sections from chapters have been removed. Quizzes have been added to the efficient AI chapter, with the first major draft of all quizzes generated, integrated, and scripts working. The quiz insertion logic and answer extraction have been improved, and the formatting for quiz answers has been updated. The section IDs have been updated for consistent linking and the script for section generation has been updated.
- **Chapter 16: Responsible AI**: The textbook has been restructured for better organization and maintainability, with updates to figure captions for clarity and context. Key concepts have been clarified and descriptions enhanced. The "Conclusion" sections have been renamed to "Summary", and quizzes have been added to the efficient AI chapter. The section IDs have been updated for consistent linking, and the quiz answers have been corrected and improved. The first major draft of all quizzes has been generated and integrated.
- **Chapter 17: Sustainable AI**: The sustainable AI chapter has been restructured for better organization and maintainability, with enhanced descriptions and clarified key concepts. The figure IDs and captions have been updated for consistency and clarity, and the source citations have been standardized. The "Conclusion" sections have been renamed to "Summary", and the resources sections have been removed from chapters. Quizzes have been added to the efficient AI chapter, with improved quiz insertion logic and answer extraction. The section IDs have been updated for consistent linking, and a script has been added to automatically inject quizzes from the JSON files. The "Quiz Answers" have been renamed to "Self-Check Answers", and the formatting for quiz answers has been updated. A first major draft of all quizzes has been generated and integrated.
- **Chapter 19: AI for Good**: The AI for Good chapter in the machine learning systems textbook has been restructured for better organization and maintainability, with enhanced descriptions and clarified key concepts. The image and table captions have been improved for clarity and standardization. The "Conclusion" sections have been renamed to "Summary", and quizzes have been added to the efficient AI chapter. The quiz insertion logic and answer extraction have been improved, and the formatting for quiz answers has been updated. The first major draft of all quizzes has been generated, integrated, and reviewed. The section IDs have been updated for consistent linking, and the "Quiz Answers" have been renamed to "Self-Check Answers".
- **Chapter 20: Conclusion**: The "Conclusion" sections have been renamed to "Summary", section IDs and quiz JSON files have been updated, and section anchors for self-check answers have been added. The script for section generation has been updated, which resulted in updates to section headers and content. Additionally, a bug in the repair function has been fixed.
- **Chapter: Generative Ai**: The generative AI chapter in the machine learning systems textbook has been restructured for improved organization and maintainability.
- **Best Practices**: The 'best_practices.qmd' file in the machine learning systems textbook has been restructured for improved organization and maintainability, PDF part summaries have been implemented, and a new book part organization has been added.
- **Design Principles**: The "design_principles.qmd" section of the machine learning systems textbook has been updated with a restructured repository for improved organization and maintainability, the implementation of PDF part summaries, and a new book part organization.
- **Foundations**: The foundations section of the machine learning systems textbook has been restructured for improved organization and maintainability, PDF part summaries have been implemented, and a new book part organization has been added.
- **Impact Outlook**: The 'impact_outlook.qmd' file in the machine learning systems textbook has been updated with a restructured repository for enhanced organization and maintainability, the implementation of PDF part summaries, and a new book part organization.
...
- **Lab: Labs**: The labs.qmd file in the machine learning systems textbook has been restructured for improved organization and maintainability.
- **Lab: Nicla Vision**: The Nicla Vision lab in the Arduino chapter has been restructured for improved organization and maintainability, with updates to the script for section generation. There were corrections made to figure captions, a bug fix in the repair function, and updates to section IDs and headers in accordance with changes to the manager code. The update also includes a new hash that considers section content.
- **Lab: Arduino Setup**: The "Conclusion" sections have been renamed to "Summary", the script for section generation has been updated, and section IDs have been updated for consistent linking and to reflect changes to the manager code. A bug has been fixed in the repair process, and the section headers have been updated using the script.
- **Lab: Arduino Image Classification**: The image_classification.qmd file in the Arduino Nicla Vision lab has been restructured for better organization and maintainability, with the addition of new section headers and updates to section IDs for consistent linking. The "Conclusion" sections have been renamed to "Summary", and a bug has been fixed in the repair function. The script for section generation has been updated, and the section IDs and headers have been updated in accordance with changes to the manager code.
- **Lab: Arduino Object Detection**: The object detection chapter in the Arduino lab of the machine learning systems textbook has been restructured for better organization and maintainability. The "Conclusion" sections have been renamed to "Summary", and the script for section generation has been updated. Furthermore, section IDs have been updated for consistent linking and to accommodate new changes to the manager code. Lastly, section headers have been updated using the script.
- **Lab: Arduino Keyword Spotting**: The "Conclusion" sections have been renamed to "Summary", the script for section generation has been updated, and section IDs have been updated for consistent linking and to accommodate new changes to manager code. Additionally, section headers have been updated using the script.
- **Lab: Arduino Motion Classification**: The "Conclusion" sections have been renamed to "Summary", the script for section generation has been updated, and section IDs have been updated for consistent linking. Additionally, a bug in the repair function has been fixed.
- **Lab: Xiao Esp32S3**: The machine learning systems textbook has been updated with a restructured repository for improved organization and maintainability, corrected figure captions, a bug fix in the repair function, updated scripts for section generation, and new section content considerations. Additionally, section IDs and headers have been updated in line with changes to manager code.
- **Lab: XIAO Setup**: The "Conclusion" sections have been renamed to "Summary", a bug in the repair function has been fixed, and updates have been made to section IDs and headers in accordance with changes to the manager code and a new hashing method that considers section content.
- **Lab: XIAO Image Classification**: The image_classification.qmd file in the machine learning systems textbook has been restructured for improved organization and maintainability, with updates to the script for section generation. The "Conclusion" sections have been renamed to "Summary". There have also been updates to section IDs for consistent linking and a new hash that considers section content has been implemented.
- **Lab: XIAO Object Detection**: The object detection lab in the machine learning systems textbook has been restructured for improved organization and maintainability, with updates to the script for section generation. The "Conclusion" sections have been renamed to "Summary". There have also been updates to section IDs for consistent linking and consideration of section content. A bug has been fixed in the repair process.
- **Lab: XIAO Keyword Spotting**: The "Conclusion" sections have been renamed to "Summary", the script for section generation has been updated, and section IDs have been updated for consistent linking and to consider section content. A bug has been fixed in the repair process, and the section headers have been updated using the script.
- **Lab: XIAO Motion Classification**: The "Conclusion" sections have been renamed to "Summary", the script for section generation has been updated, and section headers have been revised using the updated script. Additionally, a bug in the repair function has been fixed.
- **Lab: Grove Vision Ai V2**: The contents/labs/seeed/grove_vision_ai_v2/grove_vision_ai_v2.qmd file has been updated with a restructured repository for improved organization and maintainability, corrected figure captions, a bug fix in the repair functionality, updated scripts for section generation, and new section ids and headers.
- **Lab: Setup And No Code Apps**: The repository has been restructured for improved organization and maintainability, "Conclusion" sections have been renamed to "Summary", a bug in the repair process has been fixed, the script for section generation has been updated, and section IDs have been updated for consistent linking and consideration of section content.
- **Lab: Arduino Image Classification**: The image classification lab in the Grove Vision AI V2 section has been restructured for better organization and maintainability, with updates to the script for section generation. The "Conclusion" sections have been renamed to "Summary", and section IDs have been updated for consistent linking. A bug in the repair function has been fixed.
- **Lab: Arduino Object Detection**: The object detection lab in the Grove Vision AI V2 section has been restructured for improved organization and maintainability.
- **Lab: Raspi**: The Raspberry Pi lab content has been updated with a restructured repository for improved organization and maintainability, a bug fix in the repair section, and updates to the section generation script. Additionally, section IDs and headers have been updated to reflect changes in the manager code and to consider section content.
- **Lab: Raspberry Pi Setup**: The setup.qmd file in the raspi setup lab has been restructured for improved organization and maintainability, with updates to the script for section generation. Section IDs have been updated for consistent linking, considering the section content. A bug in the repair function has been fixed. The source citation has been standardized.
- **Lab: Pi Image Classification**: The image classification lab in the Raspberry Pi chapter has been restructured for improved organization and maintainability, with updates to the script for section generation. The "Conclusion" sections have been renamed to "Summary". The section IDs have been updated for consistent linking and to align with changes to the manager code. Additionally, a bug has been fixed in the repair function.
- **Lab: Pi Object Detection**: The object detection lab in the Raspberry Pi chapter of the machine learning systems textbook has been restructured for better organization and maintainability, with updates to the script for section generation. The "Conclusion" sections have been renamed to "Summary" for consistency. A bug has been fixed in the repair functionality. The section IDs have been updated for consistent linking and to accommodate new changes to the manager code. Unnecessary blank lines have been removed for improved readability.
- **Lab: Pi Large Language Models**: The "Conclusion" sections have been renamed to "Summary", the script for section generation has been updated, and section IDs have been updated for consistent linking and to align with new changes to manager code. Additionally, section headers have been updated using the script.
- **Lab: Pi Vision Language Models**: The machine learning systems textbook has been restructured for better organization and maintainability, with updates to the script for section generation. The "Conclusion" sections have been renamed to "Summary", and section IDs have been updated for consistent linking. Additionally, a bug in the repair function has been fixed, and the quiz answers are now inserted before the part block if needed.
- **Lab: Shared**: The shared labs section has been updated with a restructured repository for improved organization and maintainability, along with modifications to the shared labs heading.
- **Lab: Kws Feature Eng**: The machine learning systems textbook has undergone significant changes in the "kws_feature_eng" lab, including a restructured repository for improved organization and maintainability, renaming of "Conclusion" sections to "Summary", bug fixes in the repair function, updates to the script for section generation, and adjustments to section IDs for consistent linking. Additionally, the section headers have been updated using a new script.
- **Lab: Dsp Spectral Features Block**: The textbook's "dsp_spectral_features_block.qmd" file has been restructured for improved organization and maintainability, with updates to the script for section generation and consistent section IDs for linking. The "Conclusion" sections have been renamed to "Summary". A bug related to the 'repair' function has been fixed. The quiz answers have been repositioned to be inserted before the part block if necessary.
- **Lab: Lab Setup**: The "Conclusion" sections have been renamed to "Summary", quiz answers have been repositioned to appear before the part block if necessary, and the section headers and IDs have been updated with new changes to manager code and a new hash that considers section content.
- **Lab: Labs Overview**: The labs overview section of the machine learning systems textbook has been updated with a restructured repository for improved organization and maintainability, a new hash that considers section content, changes to section IDs in line with manager code modifications, and updated section headers using a script.
