...
- **About**: The 'About' section of the machine learning systems textbook has been updated with changes to the chapter order, incorporation of feedback from Bravo, and a general reorganization of content.
- **Acknowledgements**: The acknowledgements section has been updated multiple times to include new contributors, and the content has been reorganized.
- **Acknowledgements**: The acknowledgements section has been moved from the core content to the front matter of the book.
...
- **Chapter 4: DNN Architectures**: The machine learning systems textbook has been updated with several content-level changes. These include the addition of new sections on system level implications and transformer architecture and patterns, as well as drafting a conclusion. The DNN architectures section has been reworked, with the transformers section being split into OG attention and transformer self attention. Notes on RNN and CNN have been pasted in, and a pass has been made on the MLP version. The overview has been updated and a section has been renamed. Additionally, tables have been added for other sections, and redundancies and duplicate text have been removed.
- **Chapter 5: AI Workflow**: The workflow chapter in the machine learning systems textbook has been significantly updated with a new figure to clarify feedback loops, a first draft of content for public viewing, an initial pass through the problem definition stage, and an updated overview and purpose. Additionally, the Machine Learning lifecycle draft has been incorporated, along with the rest of the tentative outline.
- **Chapter 6: Data Engineering**: The "Data Engineering" chapter in the machine learning systems textbook has been updated with a revised purpose.
- **Chapter 7: AI Frameworks**: The purpose section in the "Frameworks" chapter of the machine learning systems textbook has been updated.
- **Chapter 8: AI Training**: The purpose section in the 'Training' chapter of the machine learning systems textbook has been updated multiple times.
- **Chapter 9: Efficient AI**: The purpose section in the "Efficient AI" chapter has been updated and revised.
- **Chapter 10: Model Optimizations**: The 'Optimizations' chapter in the machine learning systems textbook has been updated with a revised purpose.
- **Chapter 11: AI Acceleration**: The "Hardware Acceleration" section in the machine learning systems textbook has been updated with a revised purpose.
- **Chapter 12: Benchmarking AI**: The purpose section in the benchmarking chapter has been updated.
- **Chapter 13: ML Operations**: The purpose section in the "ops.qmd" file of the core operations chapter has been updated.
- **Chapter 14: On-Device Learning**: The purpose section in the "on-device learning" chapter has been updated.
- **Chapter 15: Security & Privacy**: The privacy and security chapter in the machine learning systems textbook has been updated to remove duplicate sections from chapter 14 and a duplicate case study from the security chapter. The chapter's purpose has also been revised based on Bravo's feedback.
- **Chapter 16: Responsible AI**: The purpose section in the Responsible AI chapter has been updated.
- **Chapter 17: Sustainable AI**: The "Sustainable AI" chapter in the machine learning systems textbook has been updated with a revised purpose and incorporated feedback from Bravo, potentially including changes to sections, examples, or figures.
...
- **Chapter 5: AI Workflow**: The roles sections have been connected, the labs portion has been removed from the chapters, and new labs/core folders have been created.
- **Chapter 6: Data Engineering**: The "Introduction" section has been renamed to "Overview" for clarity, the labs portion has been removed from the chapters, and new labs/core folders have been created.
- **Chapter 7: AI Frameworks**: The "Introduction" section has been replaced with an "Overview" section, the labs portion has been removed from chapters, a new reference has been added, and labs/core folders have been created.
- **Chapter 8: AI Training**: The Introduction section has been replaced with an Overview, the labs portion has been removed from chapters, and new labs/core folders have been created.
- **Chapter 9: Efficient AI**: The "Introduction" section in the "Efficient AI" chapter has been renamed to "Overview", the labs portion from the chapters has been removed, and new labs/core folders have been created.
- **Chapter 10: Model Optimizations**: The "Introduction" section in the optimizations chapter has been replaced with an "Overview" section, the labs portion from the chapters has been removed, and new labs/core folders have been created.
- **Chapter 11: AI Acceleration**: The "Introduction" section in the "hw_acceleration.qmd" file has been replaced with an "Overview" section, the "labs" portion has been removed from the chapters, and new "labs" and "core" folders have been created.
- **Chapter 12: Benchmarking AI**: The benchmarking chapter has been significantly updated with the introduction replaced by an overview, removal of the labs portion, and reworking of examples. A new trifecta diagram has been drawn and repetitive metrics descriptions and task sections have been reduced. The machine learning training benchmarks purpose section has been rewritten, a reference has been added, and a new section discussing energy in the historical context has been created. Additionally, the measurement section has been moved, and the labs and core folders have been created.
- **Chapter 13: ML Operations**: The core/ops/ops.qmd file has been updated with several changes including the grouping of fragmented topics throughout the chapter, removal of information already discussed in previous chapters, and better connection of roles sections. The data management section has been made less fragmented, the Introduction has been replaced with an Overview, and the style has been changed from abstract to textbook style. The labs portion has been removed from chapters, and labs/core folders have been created based on recommendations by Bravo.
- **Chapter 14: On-Device Learning**: The "Introduction" section has been replaced with an "Overview", the "labs" portion has been removed from chapters, and explanations of figures have been clarified. The definition of pruning has been revised to fit the context of on-device learning, and the explanation of IID has been improved. The section on lifelong learning has been expanded into its own subsection to highlight its advantages. There has also been a correction to avoid confusion between on-device learning and federated learning, and new labs/core folders have been created.
- **Chapter 15: Security & Privacy**: The Introduction section in the Privacy and Security chapter has been replaced with an Overview, the labs portion from chapters has been removed, the Security chapter has undergone a final edit, and new labs and core folders have been created.
- **Chapter 16: Responsible AI**: The "Responsible AI" section of the machine learning systems textbook has been updated with improved definitions, and the "Introduction" has been replaced with an "Overview" for clarity. The labs portion has been removed from the chapters and relocated into separate labs/core folders.
- **Chapter 17: Sustainable AI**: The "Introduction" section in the Sustainable AI chapter has been replaced with an "Overview" section, the labs portion from the chapters has been removed, and new labs/core folders have been created.
...
- **Chapter 6: Data Engineering**: The "Data Engineering" chapter has been moved to the "Core" section and has been updated with new sections, rewrites, additional examples, and figure changes.
...
- **Chapter 14: On-Device Learning**: The "On-Device Learning" chapter has been moved to the "Core" section and updated with new examples and figure changes.
- **Chapter 13: ML Operations**: The ops.qmd file in the core operations section has been updated, including new sections, rewrites, example additions, and figure changes to enhance the understanding of machine learning systems.
- **Chapter 10: Model Optimizations**: The "Optimizations" chapter in the core section has been updated with new sections, rewrites, example additions, and figure changes to enhance the understanding of machine learning system optimizations.
- **Chapter 15: Security & Privacy**: The "Privacy and Security" chapter in the core section of the machine learning systems textbook has been updated with new content, including additional examples and revisions to existing sections for enhanced clarity.
- **Chapter 16: Responsible AI**: The "Responsible AI" chapter has been relocated to the "Core" section and has undergone significant content updates, including the addition of new sections, rewrites, example additions, and figure changes.
- **Chapter 18: Robust AI**: The "Robust AI" chapter in the core section of the machine learning systems textbook has been updated and moved.
- **Chapter 17: Sustainable AI**: The "Sustainable AI" chapter has been moved to the "Core" section and may contain updates related to new sections, rewrites, example additions, or figure changes.
- **Chapter 8: AI Training**: The "Training" chapter in the core section of the machine learning systems textbook has been updated, featuring new sections, rewrites, additional examples, and changes to figures.
- **Chapter 5: AI Workflow**: The workflow chapter in the core section has been updated with new content, including additional examples and modifications to figures.
- **Chapter 19: AI for Good**: The AI for Good section has been updated and new labs and core folders have been created.
- **Chapter 18: Robust AI**: The robust AI section of the machine learning systems textbook has been updated, and new labs and core folders have been created.
- **Chapter 17: Sustainable AI**: The sustainable AI section of the machine learning systems textbook has been updated, and new labs and core folders have been created.
- **Chapter 16: Responsible AI**: The responsibleAI section of the machine learning systems textbook has been updated and labs/core folders have been created.
- **Chapter 15: Security & Privacy**: The privacy and security chapter in the machine learning systems textbook has been significantly updated with enhanced content in the Trusted Execution Environment (TEE) section. The images in this chapter have also been renamed for clarity. Additionally, a few minor errors were identified and corrected.
- **Chapter 13: ML Operations**: The updates include the creation of new labs and core folders, as well as updates to the Machine Learning Operations (MLops) section.
- **Chapter 14: On-Device Learning**: The on-device learning chapter has been updated, with improvements made to the on-device content and betterbib. Additionally, new labs and core folders have been created.
- **Chapter 12: Benchmarking AI**: The benchmarking section in the machine learning systems textbook has been updated, and new labs and core folders have been created.
- **Chapter 11: AI Acceleration**: The AI hardware acceleration section has been updated and new labs and core folders have been created.
- **Chapter 10: Model Optimizations**: The optimizations section of the machine learning systems textbook has been updated with suggested fixes from Bravo and potentially includes new labs and core folders.
- **Chapter 9: Efficient AI**: The "Efficient AI" chapter in the machine learning systems textbook has been updated with improvements to the efficiency section, and new labs and core folders have been created.
- **Chapter 8: AI Training**: The training section of the machine learning systems textbook has been updated, and new labs and core folders have been created.
- **Chapter 7: AI Frameworks**: The frameworks section of the machine learning systems textbook has been updated and labs/core folders have been created.
- **Chapter 6: Data Engineering**: The data engineering chapter has been updated, which may include new sections, rewrites, example additions, or figure changes, and the path has been updated.
- **Chapter 5: AI Workflow**: The workflow section in the machine learning systems textbook has been updated and new labs and core folders have been created.
- **Chapter 3: DL Primer**: The dl_primer.qmd file in the contents/dl_primer directory has been updated, with potential changes including new sections, rewrites, example additions, or figure changes.
- **Chapter 2: ML Systems**: The machine learning systems content has been updated with a broader introduction, revised learning objectives, and potentially new content or revisions in the 'labs' and 'core' folders.
- **Chapter 1: Introduction**: The introduction section of the machine learning systems textbook has been updated with potential content revisions and enhancements.
...
- **Lab: Arduino Setup**: The Introduction section in the contents/labs/arduino/nicla_vision/setup/setup.qmd file has been replaced with an Overview section.
- **Lab: Arduino Image Classification**: The Introduction section in the 'image_classification.qmd' file has been replaced with an Overview section to provide a more accurate representation of the content.
- **Lab: Arduino Object Detection**: The Introduction section in the 'object_detection.qmd' file has been replaced with an Overview section to provide a more accurate representation of the content.
- **Lab: Arduino Keyword Spotting**: The Introduction section in the 'contents/labs/arduino/nicla_vision/kws/kws.qmd' file has been replaced with an Overview section, and improvements have been made based on Bravo's suggestions.
- **Lab: Arduino Motion Classification**: The "Introduction" section in the "motion_classification.qmd" file has been replaced with an "Overview" section to provide a more accurate representation of the content.
- **Lab: XIAO Setup**: The Introduction section in the "seeed/xiao_esp32s3/setup/setup.qmd" lab has been replaced with an Overview, and the content has been updated based on Bravo's suggestions.
- **Lab: XIAO Image Classification**: The Introduction section in the image_classification.qmd file has been replaced with an Overview section.
- **Lab: XIAO Object Detection**: The Introduction section in the 'object_detection.qmd' file has been replaced with an Overview section.
- **Lab: XIAO Keyword Spotting**: The Introduction section in the 'kws.qmd' file has been replaced with an Overview, incorporating various fixes suggested by Bravo.
- **Lab: XIAO Motion Classification**: The Introduction section in the 'motion_classification.qmd' file has been replaced with an Overview section to provide a more accurate description of the content.
- **Lab: Raspberry Pi Setup**: The "Introduction" section in the Raspberry Pi setup lab has been replaced with an "Overview" section, incorporating suggested fixes from Bravo and addressing some notes in the LLM and other generic issues.
- **Lab: Pi Image Classification**: The "Introduction" section in the image_classification.qmd file has been renamed to "Overview", and various content fixes have been implemented as suggested by Bravo. Additionally, some notes have been merged from the pull request #480 and the branch '366-labs-raspi-support'.
- **Lab: Pi Object Detection**: The Introduction section in the 'object_detection.qmd' file has been replaced with an Overview, and various fixes from Bravo have been implemented.
- **Lab: Pi Large Language Models**: The Introduction section in the 'llm.qmd' file has been replaced with an Overview, Bravo's suggested fixes have been implemented, and a new lab on SLMs has been added.
- **Lab: Kws Feature Eng**: The Introduction section in the contents/labs/shared/kws_feature_eng/kws_feature_eng.qmd file has been replaced with an Overview section.
- **Lab: Dsp Spectral Features Block**: The Introduction section in the dsp_spectral_features_block.qmd file has been replaced with an Overview section.
- **Lab: Labs**: The labs section of the machine learning systems textbook has been restructured for clarity, with improved documentation and implementation of Bravo's suggested fixes. The usage of check and regular icons has been adjusted to support PDF build.
- **Lab: Nicla Vision**: The updates to the 'nicla_vision.qmd' file in the Arduino labs section include the implementation of Bravo's suggested fixes. Please note that content-level changes or additions are not specified in the commit messages.
- **Lab: Raspi**: The raspi.qmd file in the labs/raspi section has been updated with Bravo's suggested fixes and potential content modifications.
