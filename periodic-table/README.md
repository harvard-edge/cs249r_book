...
> **📌 Early release (2026)**
>
> This artifact shipped with the **2026** MLSysBook refresh. The table data, build scripts, and HTML outputs are **actively iterated** as the curriculum and tooling evolve.
>
