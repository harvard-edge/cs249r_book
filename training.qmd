...
Therefore, given the imbalanced compute-memory architectures of modern hardware, employing large batch sizes is essential to alleviate bottlenecks and maximize throughput. The subsequent software and algorithms also need to accommodate such batch sizes. Failing to do so leads to suboptimal hardware utilization, ultimately limiting training efficiency.
...
![Data parallelism veresus model parallelism.](images/aitrainingpara.png){#fig-training-parallelism}
