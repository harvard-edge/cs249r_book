...
<p align="center">
  <b>240+ systems design questions across Cloud, Edge, Mobile & TinyML tracks.</b><br>
...
Want the ultimate edge? **[Pre-order the full 240-question Interactive Playbook & PDF Guide ($20 Early Bird)](#)** to unlock Staff-Level scenarios, deep-dive architectural diagrams, and the offline study guide.
:::
...
| **Targeting Senior (L5)** | 🟡 Yellow-tagged questions + 1. Compute & Memory & 3. Inference & Serving |
| **Targeting Staff+ (L6+)** | 🔴 Red-tagged questions + 5. Visual Debugging |
| **Mock interview practice** | The Architect's Rubric — grade your own designs |
