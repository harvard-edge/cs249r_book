...
**Fallback:** a generated monolithic ``corpus.json`` from ``vault build --legacy-json``
...
# Generated by `vault build --legacy-json` (not hand-edited; see vault/scripts/DEPRECATED.md)
