...
| 11:53 | **Exercise 3: Quantization trade-offs** | Hands-on (pair, 7 min) | Run Exercise 3. Compare FP16 vs INT4. Note compression ratio, accuracy delta, and speedup. "The ratio is 4x against FP16 (8x against FP32). Does 4x fewer bytes become a 4x speedup? Why?" |
