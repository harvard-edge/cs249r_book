...
% texgyreheros/texgyrecursor ship with texlive-fonts-extra, so the build
% works identically on macOS and the Ubuntu CI runner without needing
% Helvetica Neue (Apple-only) or Courier New (Microsoft-only).
\usepackage{fontspec}
