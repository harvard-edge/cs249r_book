...
% =============================================================================
% This file is designed to be \input{related_work} into tutorial_module1.tex
% through tutorial_module4.tex. It contains no preamble or document environment.
% =============================================================================
...
\begin{enumerate}
  ...
  \item \textbf{Traceability: Every constant is cited}\\
    \small \texttt{Sourced} + \texttt{Provenance} on registries,\\
...
13 & Fidelity      & Algorithm & Compression--accuracy tradeoff & $r = b_{\text{base}}/b$ ($b_{\text{base}}{=}32$ default) \\
\midrule
