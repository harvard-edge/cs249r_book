...
_SYMBOL_MAP: list[tuple[str, str]] = [
    ...
    ("SCALING_EFF_1024GPU", "Scenarios.TrainingScaleProfiles.Eff1024Gpu"),
    ("SCALING_EFF_8192GPU", "Scenarios.TrainingScaleProfiles.Eff8192Gpu"),
    ("SCALING_EFF_256GPU", "Scenarios.TrainingScaleProfiles.Eff256Gpu"),
    ("SCALING_EFF_32GPU", "Scenarios.TrainingScaleProfiles.Eff32Gpu"),
