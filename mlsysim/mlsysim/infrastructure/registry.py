...
WUE_AIR_COOLED = sourced(0.5, pc.WUE_TIER_ANCHORS, name="WUE (air-cooled)", description="Water usage effectiveness for air-cooled facilities.")
WUE_EVAPORATIVE = sourced(1.8, pc.WUE_TIER_ANCHORS, name="WUE (evaporative)", description="Water usage effectiveness for evaporative cooling.")
WUE_LIQUID = sourced(0.0, pc.WUE_TIER_ANCHORS, name="WUE (liquid-cooled)", description="Closed-loop liquid cooling (near-zero WUE).")

RACK_POWER_TRADITIONAL_KW = sourced(12, pc.RACK_POWER_TIER_ANCHORS, name="Rack power (traditional)", description="Traditional enterprise rack power (kW).")
RACK_POWER_AI_TYPICAL_KW = sourced(70, pc.RACK_POWER_TIER_ANCHORS, name="Rack power (AI typical)", description="Typical AI cluster rack power (kW).")
RACK_POWER_AI_HIGH_KW = sourced(100, pc.RACK_POWER_TIER_ANCHORS, name="Rack power (AI high)", description="High-density AI rack power (kW).")
AIR_COOLING_LIMIT_KW = sourced(30, pc.RACK_POWER_TIER_ANCHORS, name="Air cooling limit (kW)", description="Approximate rack power where air cooling becomes impractical.")
...
class Racks(Registry):
    ...
    Traditional = RackProfile(
        ...
        cooling_type="air",
        metadata=Metadata(provenance=pc.RACK_POWER_TIER_ANCHORS),
    )
