...
RESNET50_A100_TRAIN_BS256 = EmpiricalAnchor(
    ...
    metric="throughput",
    units="1/s",
    configuration="ResNet-50 training on A100, batch_size=256, efficiency=0.13",
...
RESNET50_H100_TRAIN_BS256 = EmpiricalAnchor(
    ...
    metric="throughput",
    units="1/s",
    configuration="ResNet-50 training on H100, batch_size=256, efficiency=0.065",
    ...
    solver_kwargs={"batch_size": 256, "efficiency": 0.065, "is_training": True},
