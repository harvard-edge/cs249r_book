...
\subsection{Ops (Cost, Carbon \& Safety)}
...
\begin{figure*}[t]
\centering
\includegraphics[trim=0 50 0 0, clip, width=\textwidth]{images/pdf/solver-chaining.pdf}
\caption{\textbf{Solver Composition.} Three input layers feed four solvers. Each solver is a pure function: typed inputs in, dimensionally correct outputs out. The scorecard aggregates feasibility, performance, economics, and sustainability.}
