...
In Volume 1, LEGO Cells are heavily used to demystify hardware constraints. For example, when introducing the Roofline model, a LEGO Cell demonstrates how memory bandwidth dictates the maximum batch size for a given latency SLA:
