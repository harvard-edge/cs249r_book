...
MLSys·im is the hands-on companion to the [Machine Learning Systems](https://mlsysbook.ai) textbook. The concepts you model with MLSys·im are taught visually in 35 Beamer slide decks (1,099 slides total) with speaker notes and active learning exercises.
...
::: {.column width="50%"}
**[Volume II: Scaling](https://mlsysbook.ai/slides/vol2.html){target="_blank"}** -- 18 decks, 529 slides
