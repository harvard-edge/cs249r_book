...
<div class="j404-wrap">
  ...
  <div class="j404-actions">
    <a class="j404-btn j404-btn-primary" href="index.html">← MLSys·im home</a>
  ...
  <div class="j404-meta-row">
    ...
    <a class="j404-refresh" href="{{< var github_issues >}}/new?template=404_joke.yml" target="_blank" rel="noopener">✎ contribute one</a>
  </div>
  <nav class="j404-nav" aria-label="Site navigation">
    <a href="tutorials/00_hello_roofline.html">Start tutorial</a>
    <a href="zoo/index.html">Browse the zoo</a>
    ...
    <a href="{{< var github_issues >}}/new">Report broken link</a>
  </nav>
</div>
...
(function() {
  const jokes = [
    ...
    "The route resolved to a 404 with high confidence and low calibration.",
