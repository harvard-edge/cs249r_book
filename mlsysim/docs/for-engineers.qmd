...
See [Extending MLSys·im](models-and-solvers.qmd#extending-mlsysim) for the full guide.
...
- **[Resolver Guide](models-and-solvers.qmd)** — Which solver for which question
...
- **[Sensitivity Analysis](tutorials/09_sensitivity.qmd)** — Identify binding constraints and derive hardware specs from SLA targets
- **[GPU vs. Wafer-Scale](tutorials/10_gpu_vs_wafer.qmd)** — Compare conventional and wafer-scale architectures
