...
The `ServingSolver` models the [two-phase LLM inference lifecycle](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/13_model_serving.pdf){target="_blank"}: compute-bound pre-fill and memory-bound decoding.
...
```python
import mlsysim
from mlsysim import ReliabilitySolver

rel = ReliabilitySolver()
result = rel.solve(
    fleet=mlsysim.Systems.Clusters.H100_256,
...
|:---------------|:---------------|:-----------|
| Engine / SingleNodeSolver | Roofline analysis, compute vs. memory bottleneck | [Hardware Acceleration (Vol I, Ch 11)](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/11_hw_acceleration.pdf){target="_blank"} |
| ServingSolver | TTFT, ITL, KV-cache memory | [Model Serving (Vol I, Ch 13)](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/13_model_serving.pdf){target="_blank"} and [Inference at Scale (Vol II, Ch 9)](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/09_inference.pdf){target="_blank"} |
| DistributedSolver | 3D parallelism, all-reduce, pipeline bubbles | [Distributed Training (Vol II, Ch 5)](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/05_distributed_training.pdf){target="_blank"} and [Collective Communication (Vol II, Ch 6)](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/06_collective_communication.pdf){target="_blank"} |
| EconomicsSolver | CapEx, OpEx, total cost of ownership | [Compute Infrastructure (Vol II, Ch 2)](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/02_compute_infrastructure.pdf){target="_blank"} |
| SustainabilitySolver | Energy, carbon footprint, water usage | [Sustainable AI (Vol II, Ch 15)](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/15_sustainable_ai.pdf){target="_blank"} |
| ReliabilitySolver | MTBF, Young-Daly checkpointing | [Fault Tolerance (Vol II, Ch 7)](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/07_fault_tolerance.pdf){target="_blank"} |
