...
print(f"{'Spec':<20} {'A100':>12} {'H100':>12} {'Ratio':>8}")
print("-" * 56)
...
print(f"{'Peak FP16 (TFLOP/s)':<20} {flops_a:>12.0f} {flops_h:>12.0f} {flops_h/flops_a:>7.1f}×")
print(f"{'HBM BW (TB/s)':<20} {bw_a:>12.1f} {bw_h:>12.1f} {bw_h/bw_a:>7.1f}×")
print(f"{'Ridge (FLOP/byte)':<20} {flops_a*1e12/(bw_a*1e12):>12.0f} {flops_h*1e12/(bw_h*1e12):>12.0f} {'':>8}")
```
...
print(f"{'':>12} {'A100':>12} {'H100':>12} {'Speedup':>10}")
print("-" * 50)
print(f"{'Bottleneck':<12} {prof_a100.bottleneck:>12} {prof_h100.bottleneck:>12}")
print(f"{'Latency':<12} {lat_a:>10.2f}ms {lat_h:>10.2f}ms {speedup:>8.1f}×")
print(f"{'Throughput':<12} {prof_a100.throughput:>10.0f}/s {prof_h100.throughput:>10.0f}/s")
```
...
```{python}
print(f"{'Batch':>6}  {'A100 Bottleneck':<18} {'H100 Bottleneck':<18} {'Speedup':>8}")
print("-" * 56)
...
for batch in [1, 4, 16, 32, 64, 128, 256]:
    ...
    print(f"{batch:>6}  {pa.bottleneck:<18} {ph.bottleneck:<18} {sp:>6.1f}×")
```
...
print(f"{'GPU':<8} {'TFLOP/s':>10} {'BW (TB/s)':>10} {'Ridge':>8} {'Latency':>10} {'Bottleneck':<14}")
print("-" * 66)
...
for name, hw in gpus:
    ...
    print(f"{name:<8} {flops:>10.0f} {bw:>10.1f} {ridge:>8.0f} {lat:>8.2f}ms {p.bottleneck:<14}")
```
