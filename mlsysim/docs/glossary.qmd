...
: A collective communication primitive in which every device contributes a local tensor and
  ...
  *Slides:*
  [Vol II Ch 5 -- Distributed Training]({{< var slides_latest >}}/vol2_05_distributed_training.pdf),
  [Vol II Ch 6 -- Collective Communication]({{< var slides_latest >}}/vol2_06_collective_communication.pdf)
...
: An analytical model for communication cost: $T_\text{comm} = \alpha + n\beta$,
  ...
  and $\beta$ is the inverse bandwidth (seconds/byte). Used throughout MLSys·im to
  estimate collective communication overhead in distributed training.
  *Slides:*
  [Vol II Ch 3 -- Network Fabrics]({{< var slides_latest >}}/vol2_03_network_fabrics.pdf),
  [Vol II Ch 6 -- Collective Communication]({{< var slides_latest >}}/vol2_06_collective_communication.pdf)
...
: The ratio of floating-point operations to bytes of memory accessed: $I = \text{FLOPs} / \text{Bytes}$.
  ...
  *Slides:*
  [Vol I Ch 5 -- Neural Network Computation]({{< var slides_latest >}}/vol1_05_nn_computation.pdf),
  [Vol I Ch 11 -- Hardware Acceleration]({{< var slides_latest >}}/vol1_11_hw_acceleration.pdf)
...
: The rate at which data can be transferred between memory (DRAM/HBM) and compute units.
  ...
  *Slides:*
  [Vol II Ch 2 -- Compute Infrastructure]({{< var slides_latest >}}/vol2_02_compute_infrastructure.pdf),
  [Vol II Ch 3 -- Network Fabrics]({{< var slides_latest >}}/vol2_03_network_fabrics.pdf)
...
: The number of inputs processed simultaneously in one forward pass.
  ...
  *Slides:*
  [Vol I Ch 5 -- Neural Network Computation]({{< var slides_latest >}}/vol1_05_nn_computation.pdf),
  [Vol I Ch 8 -- Model Training]({{< var slides_latest >}}/vol1_08_training.pdf)
...
: The hardware resource that limits performance. For a given workload-hardware pair,
  ...
  *Slides:*
  [Vol I Ch 11 -- Hardware Acceleration]({{< var slides_latest >}}/vol1_11_hw_acceleration.pdf),
  [Vol II Ch 9 -- Performance Engineering]({{< var slides_latest >}}/vol2_09_performance_engineering.pdf)
...
: The upfront cost of purchasing hardware. In *TCO* analysis, CapEx is amortized over
  ...
  *Slides:*
  [Vol II Ch 15 -- Sustainable AI]({{< var slides_latest >}}/vol2_15_sustainable_ai.pdf)
...
: The mass of CO~2~-equivalent emissions per unit of electricity consumed, measured in
  ...
  ~820 gCO~2~e/kWh (Poland coal). MLSys·im uses per-region carbon intensity values
...
: A serving optimization that dynamically inserts and retires requests from a running
  ...
  *Slides:*
  [Vol I Ch 13 -- Model Serving]({{< var slides_latest >}}/vol1_13_model_serving.pdf),
  [Vol II Ch 10 -- Inference at Scale]({{< var slides_latest >}}/vol2_10_inference.pdf)
...
: The constant per-operation overhead of launching a GPU kernel (typically 0.01--0.1 ms
  ...
  *Slides:*
  [Vol I Ch 12 -- Benchmarking]({{< var slides_latest >}}/vol1_12_benchmarking.pdf)
...
: A transformer attention variant where multiple query heads share a single key-value head,
  ...
  *Slides:*
  [Vol I Ch 6 -- Network Architectures]({{< var slides_latest >}}/vol1_06_nn_architectures.pdf),
  [Vol II Ch 10 -- Inference at Scale]({{< var slides_latest >}}/vol2_10_inference.pdf)
...
: A model compression technique where a smaller "student" model is trained to match the
  ...
  *Slides:*
  [Vol I Ch 10 -- Model Compression]({{< var slides_latest >}}/vol1_10_model_compression.pdf)
...
: The average time a component operates before failing. For a fleet of $N$ identical nodes,
  ...
  *Slides:*
  [Vol II Ch 7 -- Fault Tolerance]({{< var slides_latest >}}/vol2_07_fault_tolerance.pdf)
...
: $\text{PUE} = \text{Total Facility Power} / \text{IT Equipment Power}$.
  ...
  Higher PUE means more energy wasted on cooling and facility overhead. Used in MLSys·im's
...
: A visual and analytical tool that plots hardware performance ceilings (the "roofline")
  ...
  Introduced by Williams, Waterman, and Patterson (2009). MLSys·im implements a
...
: The full cost of a system over its lifetime:
  ...
  Includes hardware purchase, electricity, cooling, networking, and labor. MLSys·im's
...
: The maximum sustained power a chip is designed to dissipate under load, in Watts.
  ...
  Used in MLSys·im to compute energy consumption and *TCO*.
  *Slides:*
  [Vol II Ch 2 -- Compute Infrastructure]({{< var slides_latest >}}/vol2_02_compute_infrastructure.pdf)
...
: The fraction of theoretical peak FLOP/s actually achieved in practice. Typical values:
  30--50% for well-optimized training, 10--30% for inference. MLSys·im uses $\eta$ as a
...
: Liters of water consumed per kilowatt-hour of energy. Relevant for datacenters using
  evaporative cooling. MLSys·im estimates water usage as:
...
[open an issue]({{< var github_issues >}}).*
