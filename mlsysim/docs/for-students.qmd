...
|:-----|:---------|:---------------|:-----|:-----------------|
| 1 | [Hello, Roofline](tutorials/00_hello_roofline.qmd) | The roofline model, memory-bound vs. compute-bound, batch size sweeps | 15 min | [Hardware Acceleration (Vol I, Ch 11)](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/11_hw_acceleration.pdf){target="_blank"} |
| 2 | [Geography is a Systems Variable](tutorials/07_geography.qmd) | Energy, carbon footprint, regional grid effects | 20 min | [Sustainable AI (Vol II, Ch 15)](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/15_sustainable_ai.pdf){target="_blank"} |
