...
| Robotics | `Robotics.Quadruped.*`, `Robotics.Humanoid.*`, `Robotics.Manipulator.*`, `Robotics.Drone.*`, `Robotics.AMR.*`, `Robotics.Vehicle.*` | Cyber-physical machine platforms and archetypes across the four Physical AI classes. |
