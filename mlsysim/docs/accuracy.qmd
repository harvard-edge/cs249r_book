...
MLSYSIM uses `efficiency` (η, default 0.5) as a single scalar representing hardware
...
|:---|:---|:---:|:---|
| **MLSYSIM** | First-order analytical | ±10–30% | Bottleneck analysis, HW comparison, education |
...
MLSYSIM is the right tool when you want to **compare options before running experiments** —
