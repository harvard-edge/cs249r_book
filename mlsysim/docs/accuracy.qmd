...
utilization. The table below provides framework-calibrated starting points:
...
on NVIDIA hardware with Megatron-LM. For inference workloads, pass `efficiency=0.30` as
a conservative starting point. For AMD or other accelerators, reduce by 10–15% from the
NVIDIA baseline until framework maturity catches up.
