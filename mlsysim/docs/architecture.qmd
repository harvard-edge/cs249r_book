...
: The 22 ML Systems Walls. Each wall represents a physical or logical constraint resolved by a dedicated solver. Walls 1–2 (Compute and Memory) share the `SingleNodeModel`, yielding 21 distinct solvers across 22 walls. See the [research paper](whitepaper.qmd) for full citations. {#tbl-walls}
...
*See the [Contributing guide](contributing.qmd) for a hands-on walkthrough of adding custom solvers and hardware.*
...
*See the [Resolver Guide](models-and-solvers.qmd) to learn how to apply these solvers, and [Math Foundations](math.qmd) for the equations behind each.*
