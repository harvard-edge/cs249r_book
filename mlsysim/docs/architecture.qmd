...
serving, economics, reliability). Pint units live in **`mlsysim.core.units`**; there is
no constants module — chip, model, scenario, and system specs live only in their
registries. See [Math Foundations](math.qmd).
:::

::: {.callout-note}
## Two views of the same package
The five layers are the *runtime* view: how demand meets supply through solvers.
The registries that populate Layers A--D are organized as **ten zoos**
(Hardware, Models, Datasets, Platforms, Infrastructure, Systems, Ops, Scenarios, Embodied, Agents)
plus support namespaces — that *data* view is documented in
[DATA_MODEL.md](DATA_MODEL.md). Both descriptions are true at different altitudes.
:::
...
*See the [Silicon Zoo](zoo/hardware.qmd) for 30+ vetted hardware specs from cloud GPUs to microcontrollers.*
...
For instructors and students using the companion [lecture slides](https://mlsysbook.ai/slides/), the table below maps every MLSys·im layer to the relevant slide decks.
...
- **[Getting Started](getting-started.qmd)** — Install MLSys·im and run your first analysis in 5 minutes.
...
- **[Zoo Overview](zoo/index.qmd)** — Browse the registries of vetted hardware, embodied systems, agents, models, fleets, and infrastructure.
