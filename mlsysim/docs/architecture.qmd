...
serving, economics, reliability). Pint units live in **`mlsysim.core.units`**; retired
compatibility re-exports in `mlsysim.core.constants` are not a home for chip, model,
scenario, or system specs. See [Math Foundations](math.qmd).
:::
