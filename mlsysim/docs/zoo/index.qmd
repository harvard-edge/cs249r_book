...
| [Embodied Zoo](embodied.qmd) | Cyber-physical machine platforms and robotic embodiments | Mass, payload, speed, control rate, SoC | `mlsysim.Embodied.Quadruped.Spot` |
| [Agents Zoo](agents.qmd) | Agent system profiles, deliberation trees, and execution harnesses | Context window, working memory, sandbox latency | `mlsysim.Agents.Deliberation.TreeSearch` |
...
# Agents & Embodied (Autonomous systems & robotics)
agent_runner = mlsysim.Agents.Coding.SWE_Bench_Runner
agent_platform = mlsysim.Agents.Platforms.Cloud_DGX_H100
robot = mlsysim.Embodied.Quadruped.Spot
