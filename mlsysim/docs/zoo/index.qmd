...
| [Scenarios Zoo](scenarios.qmd) | Workload statistics, comparison anchors, scale profiles, reusable problem settings | Training scale, storage corpus, clinical-imaging, energy and emissions anchors | `mlsysim.Scenarios.StorageTrainingCorpus.TrainingTokens` |
