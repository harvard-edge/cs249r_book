...
~820 gCO₂/kWh) can differ by **~41×** in carbon footprint. Use the [Sustainability Tutorial](../tutorials/sustainability.qmd)
...
Infrastructure specifications feed directly into both the `SustainabilitySolver` (carbon and water footprint) and the `EconomicsSolver` (electricity costs in TCO). Regional electricity prices vary as much as carbon intensity — a factor the TCO model accounts for.
