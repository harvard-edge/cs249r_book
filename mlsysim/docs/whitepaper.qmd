...
### 3.3 DistributedSolver: 4D Parallelism {#sec-distributed}
...
The EconomicsSolver computes TCO, grounding the cost models presented in the [Compute Infrastructure slides](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/02_compute_infrastructure.pdf):
...
The SustainabilitySolver chains three calculations, implementing the carbon accounting framework from the [Sustainable AI slides](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/15_sustainable_ai.pdf):
...
Each persona wraps a solver configuration and produces a `SystemLedger` result. This narrative layer transforms abstract solver outputs into relatable deployment stories for lab exercises: students do not just "run the DistributedSolver"; they "plan a CloudTitan training run" and see how cost, carbon, and reliability interact at 8,192-GPU scale.
...
|:-------|:-------------------|:------------|
| **SingleNodeSolver** | Training, Hardware Acceleration, Benchmarking | [Training](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/08_training.pdf), [HW Acceleration](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/11_hw_acceleration.pdf), [Benchmarking](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/12_benchmarking.pdf) |
| **ServingSolver** | Model Serving, Inference at Scale | [Model Serving](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/13_model_serving.pdf), [Inference at Scale](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/09_inference.pdf) |
...
| **EconomicsSolver** | Compute Infrastructure | [Compute Infrastructure](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/02_compute_infrastructure.pdf) |
| **SustainabilitySolver** | Sustainable AI | [Sustainable AI](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/15_sustainable_ai.pdf) |
| **ReliabilitySolver** | Fault Tolerance | [Fault Tolerance](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/07_fault_tolerance.pdf) |
...
- The [Distributed Training slides](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/05_distributed_training.pdf) present the "3D parallelism cube"; students sweep parallelism configurations with the DistributedSolver.
...
- The [Sustainable AI slides](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/15_sustainable_ai.pdf) present the geography of carbon; students compare Quebec vs. Poland using the SustainabilitySolver.
