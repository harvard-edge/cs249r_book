...
*Implemented in [`mlsysim.core.solver.TrainingMemoryModel`](api/core.solver.TrainingMemoryModel.qmd).*
...
**Slide Decks:** [Model Serving (Vol I, Ch 13)](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/vol1_13_model_serving.pdf){target="_blank"} | [Inference at Scale (Vol II, Ch 10)](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/vol2_10_inference.pdf){target="_blank"}
...
*Implemented in [`mlsysim.core.solver.ServingCapacityModel`](api/core.solver.ServingCapacityModel.qmd).*
...
**Slide Deck:** [Performance Engineering (Vol II, Ch 9)](https://github.com/harvard-edge/cs249r_book/releases/download/slides-latest/vol2_09_performance_engineering.pdf){target="_blank"}
