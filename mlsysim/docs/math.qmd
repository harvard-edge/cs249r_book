...
*Used by [`mlsysim.core.formulas.calc_transformer_training_flops`](api/core.formulas.qmd).*
...
*Implemented in [`mlsysim.core.formulas.calc_failure_probability`](api/core.formulas.qmd).*
...
*Implemented in [`mlsysim.core.formulas.calc_effective_flops`](api/core.formulas.qmd).*
