...
| [ContinuousBatchingSolver](core.solver.ContinuousBatchingSolver.qmd) | Analyzes production LLM serving with Continuous Batching and PagedAttention. |
| [WeightStreamingSolver](core.solver.WeightStreamingSolver.qmd) | Analyzes Wafer-Scale inference (e.g., Cerebras CS-3) using Weight Streaming. |
| [TailLatencySolver](core.solver.TailLatencySolver.qmd) | Analyzes queueing delays and P99 tail latency for deployed inference (M/M/c). |
...
| [CheckpointSolver](core.solver.CheckpointSolver.qmd) | Analyzes checkpoint I/O burst penalties and MFU impact. |
