# core.solver.OrchestrationSolver { #mlsysim.core.solver.OrchestrationSolver }

```python
core.solver.OrchestrationSolver()
```
...
| Name | Description |
| --- | --- |
| [solve](#mlsysim.core.solver.OrchestrationSolver.solve) | Solves for cluster wait times and utilization. |

### solve { #mlsysim.core.solver.OrchestrationSolver.solve }

```python
core.solver.OrchestrationSolver.solve(
    fleet,
