# core.solver.TailLatencySolver { #mlsysim.core.solver.TailLatencySolver }

```python
core.solver.TailLatencySolver()
```
...
| Name | Description |
| --- | --- |
| [solve](#mlsysim.core.solver.TailLatencySolver.solve) | Solves for P50 and P99 tail latencies under variable load. |

### solve { #mlsysim.core.solver.TailLatencySolver.solve }

```python
core.solver.TailLatencySolver.solve(
    arrival_rate_qps,
    service_latency_ms,
    num_replicas=1,
)
