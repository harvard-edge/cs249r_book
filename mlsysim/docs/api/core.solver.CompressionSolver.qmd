# core.solver.CompressionSolver { #mlsysim.core.solver.CompressionSolver }

```python
core.solver.CompressionSolver()
```
...
| Name | Description |
| --- | --- |
| [solve](#mlsysim.core.solver.CompressionSolver.solve) | Solves for compression gains and estimated accuracy impact. |

### solve { #mlsysim.core.solver.CompressionSolver.solve }

```python
core.solver.CompressionSolver.solve(
    model,
    hardware,
    method='quantization',
    target_bitwidth=8,
