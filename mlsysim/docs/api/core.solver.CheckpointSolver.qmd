# core.solver.CheckpointSolver { #mlsysim.core.solver.CheckpointSolver }

```python
core.solver.CheckpointSolver()
```
...
| Name | Description |
| --- | --- |
| [solve](#mlsysim.core.solver.CheckpointSolver.solve) | Solves for checkpoint size, write time, and resulting MFU penalty. |

### solve { #mlsysim.core.solver.CheckpointSolver.solve }

```python
core.solver.CheckpointSolver.solve(
    model,
    hardware,
    optimizer='adam',
