# core.solver.ContinuousBatchingSolver { #mlsysim.core.solver.ContinuousBatchingSolver }

```python
core.solver.ContinuousBatchingSolver()
```
...
| Name | Description |
| --- | --- |
| [solve](#mlsysim.core.solver.ContinuousBatchingSolver.solve) | Solves for continuous batching throughput and PagedAttention memory. |

### solve { #mlsysim.core.solver.ContinuousBatchingSolver.solve }

```python
core.solver.ContinuousBatchingSolver.solve(
    model,
    hardware,
    seq_len,
    max_batch_size=1,
