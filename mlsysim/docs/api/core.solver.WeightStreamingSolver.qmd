# core.solver.WeightStreamingSolver { #mlsysim.core.solver.WeightStreamingSolver }

```python
core.solver.WeightStreamingSolver()
```
...
| Name | Description |
| --- | --- |
| [solve](#mlsysim.core.solver.WeightStreamingSolver.solve) | Solves for throughput under Weight Streaming physics. |

### solve { #mlsysim.core.solver.WeightStreamingSolver.solve }

```python
core.solver.WeightStreamingSolver.solve(
    model,
    hardware,
    seq_len,
    batch_size=1,
