...
Advanced students can write custom solvers (see [Extending MLSys·im](extending-the-engine.qmd)) or compose multiple solvers to answer research-style questions.
...
- **[Research Paper](whitepaper.qmd)** — The academic paper describing MLSys·im's design and provenance
