...
|:-----|:-----------------|:-------------------|
| 3 | Hardware Acceleration | [Hello World](tutorials/hello_world.qmd) + [Design Space Explorer](tutorials/design_space.qmd) |
| 4 | Data Engineering | [Data Pipeline](tutorials/data_pipeline.qmd) — CPU preprocessing bottleneck |
...
| 8 | Scaling Physics | [CoT Economics](tutorials/cot_economics.qmd) — Inference compute scaling |
| 9 | Sustainable AI | [Sustainability Lab](tutorials/sustainability.qmd) — Carbon footprint |
| 11 | Compute Infrastructure | [Sensitivity Analysis](tutorials/sensitivity.qmd) — Binding constraints + procurement |
