...
| **MLSYSIM** | Six primary workflows backed by typed resolver classes, a hardware registry, and deterministic assignments | [Getting Started](getting-started.qmd) |
...
|:-----|:---------------|:---------------|:-------------------|
| 2 | [Introduction]({{< var slides_latest >}}/vol1_01_introduction.pdf) | The Iron Law of ML Systems | Read [Hello, Roofline](tutorials/00_hello_roofline.qmd) warmup — identify bottleneck equation |
| 5 | [NN Computation]({{< var slides_latest >}}/vol1_05_nn_computation.pdf) | FLOPs, memory footprint | [Hello, Roofline](tutorials/00_hello_roofline.qmd) — roofline analysis, batch size sweep |
| 8 | [Model Training]({{< var slides_latest >}}/vol1_08_training.pdf) | Training memory budget | [Solver Guide](solver-guide.qmd) — `TrainingMemoryModel`, ZeRO stages |
| 11 | [HW Acceleration]({{< var slides_latest >}}/vol1_11_hw_acceleration.pdf) | Roofline model, accelerator comparison | Hardware comparison assignment (see below) |
| 13 | [Model Serving]({{< var slides_latest >}}/vol1_13_model_serving.pdf) | TTFT, ITL, KV-cache | [Two Phases of Inference](tutorials/02_two_phases.qmd) — serving latency analysis |

For a **Volume II** course on distributed systems:

| Week | Lecture Slides | Textbook Topic | MLSYSIM Assignment |
|:-----|:---------------|:---------------|:-------------------|
| 3 | [Compute Infrastructure]({{< var slides_latest >}}/vol2_02_compute_infrastructure.pdf) | GPU clusters, interconnects | TCO analysis with EconomicsModel |
| 5 | [Distributed Training]({{< var slides_latest >}}/vol2_05_distributed_training.pdf) | 3D parallelism, scaling | [Scaling to 1000 GPUs](tutorials/06_scaling_1000_gpus.qmd) — parallelism strategies |
| 7 | [Fault Tolerance]({{< var slides_latest >}}/vol2_07_fault_tolerance.pdf) | Checkpointing, MTBF | ReliabilityModel — Young-Daly checkpoint interval |
| 10 | [Performance Engineering]({{< var slides_latest >}}/vol2_09_performance_engineering.pdf) | Profiling, optimization | Multi-solver composition (see capstone ideas below) |
| 15 | [Sustainable AI]({{< var slides_latest >}}/vol2_15_sustainable_ai.pdf) | Energy, carbon, water | [Geography is a Systems Variable](tutorials/07_geography.qmd) — carbon footprint |
...
|:---------|:---------|:-------------|:------------------|
| [Hello, Roofline](tutorials/00_hello_roofline.qmd) | 15 min | Roofline model, memory vs. compute bound | [HW Acceleration]({{< var slides_latest >}}/vol1_11_hw_acceleration.pdf) |
| [Geography is a Systems Variable](tutorials/07_geography.qmd) | 20 min | Energy, carbon footprint, regional grids | [Sustainable AI]({{< var slides_latest >}}/vol2_15_sustainable_ai.pdf) |
| [Two Phases of Inference](tutorials/02_two_phases.qmd) | 25 min | TTFT vs. ITL, KV-cache pressure | [Model Serving]({{< var slides_latest >}}/vol1_13_model_serving.pdf) |
| [Scaling to 1000 GPUs](tutorials/06_scaling_1000_gpus.qmd) | 30 min | Data/tensor/pipeline parallelism | [Distributed Training]({{< var slides_latest >}}/vol2_05_distributed_training.pdf) |
...
**Pairs with**: [HW Acceleration slides]({{< var slides_latest >}}/vol1_11_hw_acceleration.pdf) (roofline model, ridge point) and [Benchmarking slides]({{< var slides_latest >}}/vol1_12_benchmarking.pdf) (measurement methodology).
...
**Pairs with**: [Model Training slides]({{< var slides_latest >}}/vol1_08_training.pdf) and [Distributed Training slides]({{< var slides_latest >}}/vol2_05_distributed_training.pdf).
...
**Pairs with**: [Sustainable AI slides]({{< var slides_latest >}}/vol2_15_sustainable_ai.pdf) (grid carbon intensity, PUE).
...
**Pairs with**: [Model Serving slides]({{< var slides_latest >}}/vol1_13_model_serving.pdf) and [Inference at Scale slides]({{< var slides_latest >}}/vol2_10_inference.pdf).
...
**Pairs with**: [HW Acceleration slides]({{< var slides_latest >}}/vol1_11_hw_acceleration.pdf) (roofline model, ridge point derivation).
