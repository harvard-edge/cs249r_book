...
|:-----|:-----------------|:-------------------|
| 3 | Hardware Acceleration | [Hello, Roofline](tutorials/00_hello_roofline.qmd) + [The Memory Wall](tutorials/01_memory_wall.qmd) |
| 4 | Data Engineering | [Starving the GPU](tutorials/04_starving_the_gpu.qmd) — CPU preprocessing bottleneck |
| 5 | Model Serving | [Two Phases, One Request](tutorials/02_two_phases.qmd) — TTFT/ITL analysis |
| 7 | Distributed Training | [Scaling to 1000 GPUs](tutorials/06_scaling_1000_gpus.qmd) — 3D parallelism |
| 8 | Scaling Physics | [The $9M Question](tutorials/08_nine_million_dollar.qmd) — Inference compute scaling |
| 9 | Sustainable AI | [Geography is a Systems Variable](tutorials/07_geography.qmd) — Carbon footprint |
| 11 | Compute Infrastructure | [Sensitivity Analysis](tutorials/09_sensitivity.qmd) — Binding constraints + procurement |
...
Advanced students can write custom solvers (see [Extending MLSys·im](models-and-solvers.qmd#extending-mlsysim)) or compose multiple solvers to answer research-style questions.
...
3. Use the [Resolver Guide](models-and-solvers.qmd) to select solvers for your course topics
...
- **[Resolver Guide](models-and-solvers.qmd)** — Which solver maps to which topic
