...
## Training State Solver

**"How much memory do I need to train this model?"**
: Use . Unlike inference, training requires memory for gradients, optimizer states (Adam/SGD), and activations. This solver applies the **ZeRO Redundancy** equations to show you the true footprint across different optimization stages.




## Automated Research Sweeps

**"How does latency scale across 10 different hardware targets?"**
: Use . This method performs a combinatorial sweep across models, hardware, and batch sizes, returning a  that can be instantly converted to a DataFrame for analysis.
