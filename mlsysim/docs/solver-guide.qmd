...
| **DataSolver** | workload_data_rate, hardware | utilization, is_stalled, margin | "Is my storage/IO the bottleneck?" |
| **ScalingSolver** | compute_budget | optimal_params, optimal_tokens | "What is my optimal model size?" |
| **OrchestrationSolver** | fleet, arrival_rate, avg_duration | avg_wait_time, utilization | "How busy is my cluster?" |
| **CompressionSolver** | model, hardware, method | accuracy_delta, compression_ratio | "Is quantization/pruning worth it?" |
...
| **DataSolver** | Data Engineering | — |
| **ScalingSolver** | — | Scaling Physics |
| **OrchestrationSolver** | — | Compute Infrastructure |
| **CompressionSolver** | Model Compression | — |
