...
`tests/test_registry_no_duplicate_specs.py`. If you move a symbol out of
`core/constants.py`, `tests/test_constants_allowlist.py` enforces that it does
not come back.
...
MLSYSIM ships 32 analytical solvers (see `mlsysim.solvers`), each grounded in
