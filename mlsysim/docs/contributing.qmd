...
| Add or improve a solver | Advanced | High -- new analysis capabilities | `engine/solver.py` |
...
(that file is physics/units only). Add one YAML file under the right tier, for
...
mlsysim/
  ...
  scenarios/        # Book-facing Scenarios.* anchors
