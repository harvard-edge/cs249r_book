...
Follow the pattern established in [Hello World](tutorials/hello_world.qmd),
[Sustainability](tutorials/sustainability.qmd),
[LLM Serving](tutorials/llm_serving.qmd), and
...
|:---|:---|:---|
| `SingleNodeSolver` | Roofline bounds, MFU/HFU | Williams et al. (2009) |
| `DistributedSolver` | 3D/4D parallelism, all-reduce, pipeline bubbles | Shoeybi et al. (2019), Narayanan et al. (2019) |
| `ReliabilitySolver` | MTBF, failure probability, Young-Daly checkpointing | Young (1974), Daly (2006) |
| `SustainabilitySolver` | Energy, carbon, water (PUE, WUE) | Patterson et al. (2021) |
| `EconomicsSolver` | CapEx, OpEx, TCO | Barroso et al. (2018) |
| `ServingSolver` | TTFT, ITL, KV-cache pressure | Pope et al. (2023), Aminabadi et al. (2022) |
