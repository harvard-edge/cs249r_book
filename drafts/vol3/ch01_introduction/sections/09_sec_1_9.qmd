...
![The functional architecture of the Stochastic Computer. The live execution loop coordinates an unprivileged stochastic processor core, dual-tier context and serving memory, peripheral tool drivers, and an agent operating system supervisor. Across tasks, lifecycle infrastructure refines policies and scales fleet operations.](books/vol3/01_introduction/images/svg/stochastic_computer_architecture.svg){#fig-stochastic-computer-architecture}
