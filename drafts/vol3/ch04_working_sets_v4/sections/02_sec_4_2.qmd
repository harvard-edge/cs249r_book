...
::: {.column-margin}
![Evidence recall versus relative context depth across varying nominal sequence lengths, illustrating the characteristic U-shaped degradation curve identified by Liu et al. (2024). Models exhibit high fidelity at the extreme boundaries (primacy and recency) but suffer severe retrieval degradation in the intermediate 20%–80% depth.](images/svg/fig-vol3-lost-in-middle.svg){#fig-vol3-lost-in-middle}
:::
