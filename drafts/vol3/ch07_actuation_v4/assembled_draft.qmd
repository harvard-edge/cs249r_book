...
The transfer of observation data between the isolated child process and the host runtime supervisor is mediated by an inter-process communication (IPC) channel: the standard UNIX unidirectional data channel created via `pipe(2)`.
