...
%
% Add description support for unnumbered parts
\ifhaspartsummary
\coordinate(DESC_POS) at ([yshift=-20mm,xshift=-30mm]BGG.south east);
\node[inner sep=6pt,text width=0.65\textwidth,draw=none,fill=BlueDD!20,
align=justify,font={\fontsize{9pt}{12}\selectfont},anchor=north east]
at (DESC_POS) {\partsummary};
\fi
\end{tikzpicture}
}
