...
% ==========================================
% PREVIOUS NEURAL NETWORK DESIGN (SAVED)
% ==========================================
% \titleformat{name=\part,numberless}[display]
% {\thispagestyle{empty}}{}{20pt}{%
% \begin{tikzpicture}[remember picture,overlay]
% % Simple neural network inspired design with gradient colors
...
% % Connection lines
% \foreach \i in {2,4,6} {\foreach \j in {2,4} {\draw[NeuralTeal,opacity=0.3,line width=0.2pt] ([xshift=1.1cm,yshift=-\i*1.5cm-3cm]current page.north west) -- ([xshift=3.9cm,yshift=-\j*2cm-4cm]current page.north west);}}
% % Title
% \node[anchor=center,font={\fontsize{36pt}{40}\selectfont\bfseries}] at ([xshift=12cm,yshift=-8cm]current page.north west) {\color{crimson}\MakeUppercase{#1}};
% % Description
% \ifhaspartsummary\node[inner sep=6pt,text width=0.6\textwidth,fill=white,fill opacity=0.9,rounded corners=2pt,align=justify,font={\fontsize{9pt}{11}\selectfont},anchor=north] at ([xshift=12cm,yshift=-11cm]current page.north west) {\partsummary};\fi
% \end{tikzpicture}%
% }

% ==========================================
% NEW CLEANER NEURAL NETWORK DESIGN  
% ==========================================
\titleformat{name=\part,numberless}[display]
{\thispagestyle{empty}}{}{20pt}{%
\begin{tikzpicture}[remember picture,overlay]
