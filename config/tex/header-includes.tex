...
{\thispagestyle{empty}}{}{20pt}{%
\begin{tikzpicture}[remember picture,overlay]
% Simple MLPerf-inspired flowing wave background
% Top wave - blue dots flowing across
\fill[NeuralBlue,opacity=0.6] ([xshift=1cm,yshift=-2cm]current page.north west) circle (1mm);
\fill[NeuralBlue,opacity=0.5] ([xshift=3cm,yshift=-1.5cm]current page.north west) circle (0.8mm);
\fill[NeuralBlue,opacity=0.4] ([xshift=5cm,yshift=-2.5cm]current page.north west) circle (1.2mm);
\fill[NeuralBlue,opacity=0.3] ([xshift=7cm,yshift=-2cm]current page.north west) circle (0.9mm);
\fill[NeuralBlue,opacity=0.2] ([xshift=9cm,yshift=-1.8cm]current page.north west) circle (1.1mm);
\fill[NeuralTeal,opacity=0.5] ([xshift=11cm,yshift=-2.2cm]current page.north west) circle (0.7mm);
\fill[NeuralTeal,opacity=0.4] ([xshift=13cm,yshift=-1.7cm]current page.north west) circle (1mm);
\fill[NeuralTeal,opacity=0.3] ([xshift=15cm,yshift=-2.3cm]current page.north west) circle (0.8mm);
\fill[NeuralTeal,opacity=0.2] ([xshift=17cm,yshift=-2cm]current page.north west) circle (0.9mm);
% Middle wave - teal to purple
\fill[NeuralTeal,opacity=0.5] ([xshift=2cm,yshift=-4.5cm]current page.north west) circle (0.9mm);
\fill[NeuralTeal,opacity=0.4] ([xshift=4cm,yshift=-4cm]current page.north west) circle (1.1mm);
\fill[NeuralPurple,opacity=0.5] ([xshift=6cm,yshift=-5cm]current page.north west) circle (0.8mm);
\fill[NeuralPurple,opacity=0.4] ([xshift=8cm,yshift=-4.2cm]current page.north west) circle (1.2mm);
\fill[NeuralPurple,opacity=0.3] ([xshift=10cm,yshift=-4.8cm]current page.north west) circle (0.7mm);
\fill[NeuralPurple,opacity=0.3] ([xshift=12cm,yshift=-4.3cm]current page.north west) circle (1mm);
\fill[NeuralPurple,opacity=0.2] ([xshift=14cm,yshift=-4.7cm]current page.north west) circle (0.9mm);
\fill[NeuralMagenta,opacity=0.4] ([xshift=16cm,yshift=-4.5cm]current page.north west) circle (0.8mm);
% Lower wave - purple to magenta
\fill[NeuralPurple,opacity=0.4] ([xshift=1.5cm,yshift=-7cm]current page.north west) circle (0.8mm);
\fill[NeuralPurple,opacity=0.3] ([xshift=3.5cm,yshift=-6.5cm]current page.north west) circle (1mm);
\fill[NeuralMagenta,opacity=0.5] ([xshift=5.5cm,yshift=-7.2cm]current page.north west) circle (0.7mm);
\fill[NeuralMagenta,opacity=0.4] ([xshift=7.5cm,yshift=-6.8cm]current page.north west) circle (1.1mm);
\fill[NeuralMagenta,opacity=0.3] ([xshift=9.5cm,yshift=-7.3cm]current page.north west) circle (0.9mm);
\fill[NeuralMagenta,opacity=0.3] ([xshift=11.5cm,yshift=-6.7cm]current page.north west) circle (0.8mm);
\fill[crimson,opacity=0.5] ([xshift=13.5cm,yshift=-7.1cm]current page.north west) circle (1mm);
\fill[crimson,opacity=0.4] ([xshift=15.5cm,yshift=-6.9cm]current page.north west) circle (0.7mm);
% Bottom accent wave - magenta to crimson
\fill[NeuralMagenta,opacity=0.3] ([xshift=2.5cm,yshift=-9.5cm]current page.north west) circle (0.6mm);
\fill[crimson,opacity=0.4] ([xshift=5cm,yshift=-9cm]current page.north west) circle (0.8mm);
\fill[crimson,opacity=0.3] ([xshift=7.5cm,yshift=-9.7cm]current page.north west) circle (0.7mm);
\fill[crimson,opacity=0.3] ([xshift=10cm,yshift=-9.2cm]current page.north west) circle (0.9mm);
\fill[crimson,opacity=0.2] ([xshift=12.5cm,yshift=-9.5cm]current page.north west) circle (0.6mm);
\fill[crimson,opacity=0.2] ([xshift=15cm,yshift=-9.3cm]current page.north west) circle (0.8mm);
% Scattered accent dots for texture
\fill[crimson,opacity=0.3] ([xshift=4cm,yshift=-3cm]current page.north west) circle (0.4mm);
\fill[crimson,opacity=0.2] ([xshift=8cm,yshift=-5.5cm]current page.north west) circle (0.5mm);
\fill[crimson,opacity=0.3] ([xshift=12cm,yshift=-3.5cm]current page.north west) circle (0.3mm);
\fill[crimson,opacity=0.2] ([xshift=6cm,yshift=-8cm]current page.north west) circle (0.4mm);
\fill[crimson,opacity=0.3] ([xshift=14cm,yshift=-8.5cm]current page.north west) circle (0.3mm);
% Clean title positioned below the flowing waves
\node[anchor=center,font={\fontsize{36pt}{40}\selectfont\bfseries}] at ([xshift=12cm,yshift=-15cm]current page.north west) {\color{crimson}\MakeUppercase{#1}};
\end{tikzpicture}%
}
