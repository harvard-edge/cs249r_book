...
\renewcommand{\cftchapfont}{\bfseries} % Makes TOC chapters bold but black
\renewcommand{\cftchappresnum}{Chapter~} % Adds "Chapter" prefix (black)
...
\makeatletter
% Center part entries in TOC without page numbers
\renewcommand{\cftpartfont}{\bfseries\color{crimson}}
\renewcommand{\cftpartpresnum}{Part~\thepart~}
\renewcommand{\cftpartaftersnum}{}

% Simple centered part formatting
\renewcommand{\l@part}[2]{%
  \ifnum \c@tocdepth >-2\relax
    \addpenalty{-\@highpenalty}%
    \addvspace{12pt}% More space before part
    \begingroup
      \parindent \z@ \rightskip \@pnumwidth
      \parfillskip -\@pnumwidth
      \leavevmode
      % Center the complete part title
      \noindent\hfil\cftpartfont\cftpartpresnum #1\hfil\null\par
      \penalty\@highpenalty
    \endgroup
    \addvspace{6pt}% More space after part
  \fi}
\makeatother
