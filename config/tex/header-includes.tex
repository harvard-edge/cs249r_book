...
% Title adjusted for better positioning and size - margin aware
\node[anchor=center,font={\fontsize{40pt}{44}\selectfont\bfseries}] at ([xshift=0.5\textwidth,yshift=-15cm]current page text area.north west) {\color{crimson}\MakeUppercase{#1}};
% Right-aligned gradient line with variable thickness - respecting text area
\draw[NeuralBlue,opacity=0.3,line width=0.8pt] ([xshift=0.1\textwidth,yshift=-17cm]current page text area.north west) -- ([xshift=0.3\textwidth,yshift=-17cm]current page text area.north west);
\draw[NeuralTeal,opacity=0.4,line width=1pt] ([xshift=0.3\textwidth,yshift=-17cm]current page text area.north west) -- ([xshift=0.5\textwidth,yshift=-17cm]current page text area.north west);
\draw[NeuralPurple,opacity=0.5,line width=1.2pt] ([xshift=0.5\textwidth,yshift=-17cm]current page text area.north west) -- ([xshift=0.7\textwidth,yshift=-17cm]current page text area.north west);
\draw[crimson,opacity=0.6,line width=1.5pt] ([xshift=0.7\textwidth,yshift=-17cm]current page text area.north west) -- ([xshift=0.9\textwidth,yshift=-17cm]current page text area.north west);
