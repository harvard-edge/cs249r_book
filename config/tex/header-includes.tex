...
% Utility commands for testing different spacing options
\newcommand{\tighterchapterspacing}{%
  \titleformat{name=\chapter,numberless}
    {\normalfont\huge\bfseries\color{crimson}}
    {}
    {5pt} % Very tight spacing for frontmatter
    {\Huge #1}
    []
}
...
\newcommand{\tightersectionspacing}{%
  \titleformat{\section}
    {\normalfont\Large\bfseries\color{crimson}\raggedright}
    {\thesection}
    {0.2em} % Tighter spacing
    {#1}
}
...
\titleformat{name=\chapter,numberless}%[display]
  {\normalfont\huge\bfseries\color{crimson}} % Apply the crimson color
  {} % Prefix "Chapter X"
  {10pt} % Reduced spacing for frontmatter chapters
