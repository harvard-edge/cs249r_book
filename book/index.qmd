...
## Printed Edition {.unnumbered}

::: {.content-visible when-format="html"}
```{=html}
<div style="float: right; margin: 20px 0 20px 30px; text-align: center; max-width: 300px;">
  <img src="../assets/images/covers/cover-hardcover-book.png" 
       alt="Machine Learning Systems - Hardcover Book" 
       style="width: 250px; height: auto; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
  
  <div style="margin-top: 15px; padding: 10px; background-color: #f8f9fa; border-radius: 6px; border-left: 4px solid #dc3545;">
    <h4 style="margin: 0 0 8px 0; color: #dc3545; font-size: 1.1em;">📖 Coming Soon!</h4>
    <p style="margin: 0; font-size: 0.9em; color: #6c757d;">Physical hardcover edition<br>will be available soon</p>
  </div>
  
  <div style="margin-top: 15px;">
    <p style="font-size: 0.85em; margin-bottom: 10px; color: #495057;">📢 <strong>Show your support!</strong></p>
    <iframe src="https://ghbtns.com/github-btn.html?user=harvard-edge&repo=cs249r_book&type=star&count=true&size=large" 
