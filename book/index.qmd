...
<div style="padding: 30px; background: #f8f9fa; border-radius: 12px; border-left: 4px solid #8B1538; margin: 30px 0;">
  <h3 style="margin: 0 0 15px 0; color: #8B1538;">🎓 Support Our Mission</h3>
    <p style="line-height: 1.6; color: #424242;">
      Your GitHub ⭐ <strong>expands educational access and create new opportunities</strong>. Sponsors like the <a href="https://edgeaifoundation.org/" target="_blank" rel="noopener noreferrer">
      <strong>EDGE AI Foundation</strong></a> match every star with funding that supports global learning initiatives.
    </p>
