...
![](assets/images/covers/cover-hardcover-book.png){style="float: right;" fig-align="right" width="300" height="auto"}

Machine Learning Systems provides a systematic framework for understanding and engineering machine learning (ML) systems. This textbook is designed to bridge the gap between theoretical foundations and practical engineering, with a particular emphasis on the systems perspective required to build effective AI solutions. Unlike resources that focus primarily on algorithms and model architectures, this book highlights the broader context in which ML systems operate, including the integration of data engineering, model optimization, hardware-aware training, and inference acceleration. The book's chapters are organized to guide readers from foundational principles through to advanced system design, addressing essential topics such as security, privacy, and reliability. By working through this text, readers will develop the ability to reason about ML system architectures and apply enduring engineering principles, even as tools and applications continue to evolve. The goal is to equip students and practitioners with the knowledge needed to design, implement, and maintain flexible, efficient, and robust machine learning systems.
:::
