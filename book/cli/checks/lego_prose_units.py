...
_SUFFIX_UNITS: dict[str, frozenset[str]] = {
    ...
    "mm2": frozenset({"mm²", "mm^2", "square millimeter", "square millimeters"}),
    "cm2": frozenset({"cm²", "cm^2", "square centimeter", "square centimeters"}),
    "m2": frozenset({"m²", "m^2", "square meter", "square meters"}),
    "w_per_cm2": frozenset({"w/cm²", "w/cm^2", "w per square centimeter"}),
}
...
_FMT_UNITS: dict[str, frozenset[str]] = {
    ...
    "fmt_energy_per_byte": frozenset({"pj/byte"}),
    "fmt_energy_per_bit": frozenset({"pj/bit"}),
    "fmt_energy_per_flop": frozenset({"pj/flop", "pj/flops", "pj"}),
    "fmt_energy_per_op": frozenset({"pj/op", "pj/operation", "pj"}),
    ...
    "fmt_area": frozenset({"mm²", "mm^2", "cm²", "cm^2", "m²", "m^2", "square millimeter",
                           "square millimeters", "square centimeter", "square centimeters",
