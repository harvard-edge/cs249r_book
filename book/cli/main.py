...
class MLSysBookCLI:
    ...
    def _parse_build_args(self, args):
        ...
        return format_type, volume, build_all, chapters_arg, skip_hygiene
    ...
    def handle_build_command(self, args):
        ...
        if "-h" in args or "--help" in args:
            console.print("Usage: ./binder build [html|pdf|epub] [chapters] [--vol1|--vol2|--all] [--skip-hygiene]", markup=False)
            ...
            console.print("[dim]  ./binder build epub --vol1 --skip-hygiene  # emergency bypass for EPUB preflight[/dim]")
            return True

        self.config_manager.show_symlink_status()
        format_type, volume, build_all, chapters_arg, skip_hygiene = self._parse_build_args(args)
        ...
        if build_all:
            ...
            return self.build_command.build_full(format_type, skip_hygiene=skip_hygiene)
        ...
        if volume and not chapters_arg:
            ...
            return self.build_command.build_volume(volume, format_type, skip_hygiene=skip_hygiene)
        ...
        if volume and chapters_arg:
            ...
            return self.build_command.build_chapters_with_volume(chapter_list, format_type, volume, skip_hygiene=skip_hygiene)
        ...
        if chapters_arg:
            ...
            return self.build_command.build_chapters(chapter_list, format_type, skip_hygiene=skip_hygiene)
