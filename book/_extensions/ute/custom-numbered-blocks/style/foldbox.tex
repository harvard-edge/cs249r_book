...
\begin{tcolorbox}[
  ...
  sharp corners=south,
  top=6pt,          % increased title top padding
  bottom=5pt,       % increased title bottom padding
  overlay={
  ...
  title=\hspace{2.5em}\textbf{#2}\hspace{0.2em}{#3}, % adjusted icon spacing
...
\newenvironment{fbxSimple}[3]{\begin{tcolorbox}[
  ...
  overlay={
      \node [left,outer sep=0em, black,draw=none,anchor=west,
        rectangle,fill=none,inner sep=0pt]
        at ([xshift=3mm]frame.west) {\includegraphics[width=4.2mm]{_extensions/ute/custom-numbered-blocks/style/icons/icon_#1.pdf}};
    },
  },
  colframe=#1-color2,
  colbacktitle=#1-color1,
  ...
  bottomtitle=1.5mm, % increased title bottom margin
  toptitle=1.5mm,    % increased title top margin
  title=\hspace{2.5em}\textbf{#2}\hspace{0.2em}{#3}, % increased space before title text
  extras middle and last={top=4pt} % increased continuation spacing
]}
{\end{tcolorbox}}
