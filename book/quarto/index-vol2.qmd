...
This volume is the scale and governance spine for the broader AI engineering curriculum. Pair the chapters with [Co-Labs](https://mlsysbook.ai/labs/) for fleet-scale trade-off exercises, [MLSys·im](https://mlsysbook.ai/mlsysim/) for first-principles infrastructure modeling, and [StaffML](https://mlsysbook.ai/staffml/) for physics-grounded systems design practice. Instructors can adopt the full scale sequence through [The AI Engineering Blueprint](https://mlsysbook.ai/instructors/).
