...
<div class="mls-landing-grid">
  <div class="mls-landing-left">
    ...
    <div class="mls-meta">
      <p class="mls-links"><a href="https://mlsysbook.ai/tinytorch/">TinyTorch</a> · <a href="https://mlsysbook.ai/mlsysim/">MLSysim</a> · <a href="https://mlsysbook.ai/kits/">Hardware Kits</a> · <a href="https://mlsysbook.ai/labs/">Labs</a></p>
...
<div class="mls-landing-grid">
  <div class="mls-landing-left">
    <p class="mls-hero-eyebrow">MLSYSIM</p>
    <h1 class="mls-hero-title">Model the<br/>trade-offs.</h1>
    <p class="mls-hero-tagline">One command.<br/>Every bottleneck.</p>
    <p class="mls-hero-intro">A first-principles simulation engine for reasoning about ML system performance. Evaluate training, serving, and distributed configurations before committing hardware or code.</p>

    <div class="mls-meta">
      <p class="mls-links"><a href="https://mlsysbook.ai/mlsysim/">Explore MLSysim &rarr;</a></p>
    </div>
  </div>
    ...
    <div class="mls-feature-card">
      <div class="css-terminal-wrapper">
        <div class="css-terminal">
          ...
          <div class="css-terminal-body">
            <div class="term-line"><span class="term-comment">$</span> mlsysim eval Llama-3-70B H100</div>
            <div class="term-line">&nbsp;</div>
            <div class="term-line"><span class="term-kw">Model</span>    Llama-3-70B  (<span class="term-num">70B</span> params)</div>
            <div class="term-line"><span class="term-kw">Hardware</span> NVIDIA H100  (<span class="term-num">3,958</span> TFLOPS)</div>
            <div class="term-line"><span class="term-kw">Memory</span>   <span class="term-num">130.4</span> GB  &rarr;  <span class="term-def">HBM-bound</span></div>
            <div class="term-line"><span class="term-kw">Arith.I</span>  <span class="term-num">62.5</span> FLOP/B  &rarr;  <span class="term-def">compute-bound</span></div>
            <div class="term-line"><span class="term-kw">MFU</span>      <span class="term-num">48.2</span>%</div>
            <div class="term-line"><span class="term-kw">TTFT</span>     <span class="term-num">112</span> ms  |  <span class="term-kw">ITL</span> <span class="term-num">18.4</span> ms</div>
            <div class="term-line"><span class="term-cursor"></span></div>
          </div>
        </div>
        <div class="term-shadow"></div>
      </div>
      <p class="mls-feature-desc">Roofline analysis, memory profiling, and what-if exploration for any model-hardware pair.</p>
    </div>
  </div>
</div>
</section>

<!-- Section 4: Hardware Kits -->
<section class="mls-section">
<div class="mls-landing-grid">
  <div class="mls-landing-left">
    ...
    <div class="mls-feature-card">
      <div class="hex-wrapper">
        <svg class="hex-lines" viewBox="0 0 320 240" xmlns="http://www.w3.org/2000/svg">
          ...
          <line x1="160" y1="40" x2="160" y2="120" stroke="currentColor" stroke-width="1.5" class="hex-line" style="opacity: 0.8;" />
          <line x1="91" y1="160" x2="160" y2="120" stroke="currentColor" stroke-width="1.5" class="hex-line" style="opacity: 0.8;" />
          <line x1="229" y1="160" x2="160" y2="120" stroke="currentColor" stroke-width="1.5" class="hex-line" style="opacity: 0.8;" />
