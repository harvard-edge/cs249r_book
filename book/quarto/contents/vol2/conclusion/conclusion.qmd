...
- Synthesize the **six principles** of distributed ML systems engineering that emerged from this textbook: **communication dominance**\index{Communication Dominance}, **routine failure**\index{Routine Failure}, **infrastructure determination**\index{Infrastructure Determination}, **responsible engineering**\index{Responsible Engineering}, **sustainability constraints**\index{Sustainability!constraints}, and **qualitative scale effects**
...
- Apply **systems thinking**\index{Systems Thinking} to design ML systems that scale horizontally, fail gracefully, and operate sustainably within resource and governance constraints
...
[^fn-gradient-compression]: @sec-collective-communication explores gradient compression\index{Gradient Compression} techniques that reduce communication volume 10$\times$--100$\times$ through sparsification, quantization, and error feedback, enabling bandwidth-limited distributed and federated training.
...
[^fn-lifecycle-assessment]: @sec-sustainable-ai introduces lifecycle assessment\index{Lifecycle Assessment}, which evaluates environmental impact across a system's entire lifespan, including embodied carbon in hardware manufacturing (often 20--50 percent of total impact).
