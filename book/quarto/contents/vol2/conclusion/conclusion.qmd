...
[^fn-gradient-compression]: **Gradient compression**: Techniques that reduce gradient communication volume by 10-100x, including sparsification (sending only large gradients), quantization (reducing precision), and error feedback to preserve convergence despite lossy compression.
