...
::: {.callout-note title="Figure: The Fleet Stack"}
...
*   **Ops/sec**: $25,000 \times 1,000 \text{ TFLOPS} = \mathbf{`{python} FermiEstimate.machine_ops_sci` \text{ FLOPs}}$.
*   **Power**: $25,000 \times 700\text{W} \approx \mathbf{`{python} FermiEstimate.machine_power_mw_str` \text{ MW}}$.

**The Brain**:

*   **Synapses**: $10^{14}$ synapses (connections).
*   **Firing Rate**: $\approx 100 \text{ Hz}$ (average spike rate).
*   **Ops/sec**: $10^{14} \times 100 = \mathbf{`{python} FermiEstimate.brain_ops_sci` \text{ Synaptic Ops/sec}}$.
...
*   **Efficiency**: The brain is **`{python} FermiEstimate.efficiency_gap_str`$\times$ more efficient** ($20\text{W}$ vs $`{python} FermiEstimate.machine_power_mw_str`\text{MW}$).
