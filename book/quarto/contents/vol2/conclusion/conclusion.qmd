...
[^fn-gradient-compression]: @sec-communication-collective-operations explores gradient compression techniques that reduce communication volume 10-100 $\times$ through sparsification, quantization, and error feedback, enabling bandwidth-limited distributed and federated training.
