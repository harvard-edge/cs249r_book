...
The intelligent systems that will define this century need engineers who understand these principles and can apply them at scale. The agenda is therefore threefold: build systems that scale, build systems that endure, and build systems that serve humanity well.
