...
\begin{tikzpicture}[
  ...
  \node[step box, minimum height=2cm] (l1) at (2,0) {Level 1\\Per-Model CI/CD};
  \node[step box, minimum height=3cm] (l2) at (4,0) {Level 2\\Platform Ops};
  \node[step box, minimum height=4cm] (l3) at (6,0) {Level 3\\Enterprise Gov};

  % Annotations
  \node[annotation] at (1, -0.2) {1-2 Models};
  \node[annotation] at (3, -0.2) {10-20 Models};
  \node[annotation] at (5, -0.2) {50-200 Models};
  \node[annotation] at (7, -0.2) {500+ Models};
...
\begin{tikzpicture}[
  ...
  % Alert Overlay
  \draw[RedLine, line width=1.0pt, rounded corners]
    ([xshift=-0.5cm, yshift=-0.5cm]Retrieval.south west) rectangle
    ([xshift=0.5cm, yshift=0.5cm]Ensemble.north east);
...
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}]
  ...
  % Async Comparison
  \node[draw, dashed, inner sep=5pt, line width=0.75pt, right=1.5cm of Router] (Compare) {Compare};
...
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}]
  ...
  \begin{scope}[local bounding box=interleave, xshift=7cm]
    ...
    \node[draw, fill=black!5, minimum width=2.2cm, minimum height=2cm, below=1.5cm of AnyUser, line width=0.75pt] (MixedBox) {};
...
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}]
  ...
  % Annotations
  \node[anchor=west, text=RedLine!80, font=\scriptsize] at (5.5, 4) {Alert Execs};
...
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}]
  ...
  \node[font=\footnotesize, below=0.1cm of {(1,0)}] {00:00};
  \node[font=\footnotesize, below=0.1cm of {(5,0)}] {12:00 (Noon)};
  \node[font=\footnotesize, below=0.1cm of {(9,0)}] {24:00 (Midnight)};
