...
\noindent
![](images/png/cover_ops_scale_blueprint_print.png){fig-alt="Fleet operations platform blueprint where many model-service lanes share observability, deployment, policy, and capacity control layers."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_ops_scale_blueprint.webp){fig-alt="Fleet operations platform blueprint where many model-service lanes share observability, deployment, policy, and capacity control layers."}
:::
