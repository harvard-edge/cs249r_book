...
2. **Lost Clicks**: `{python} SilentFailure.sf_total_requests_str` $\times$ 0.005 = `{python} SilentFailure.sf_lost_clicks_str`.
...
| **Model size**       | 2$\times$  | +150 percent |  +120 percent | +30 percent  |   +55 percent    |
