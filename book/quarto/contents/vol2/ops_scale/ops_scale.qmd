...
- **Operational Load Testing**: Prove the new model can handle full production traffic volume without crashing, leaking memory, or violating latency SLOs. This catches performance regressions (e.g., unoptimized kernels) safely.
