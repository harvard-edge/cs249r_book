...
4.  **Daily False Alarms**: \(`{python} FalseAlarmTax.n_monitors_str` \times `{python} FalseAlarmTax.checks_per_day_str` \times `{python} FalseAlarmTax.fpr_str` \approx \mathbf{`{python} FalseAlarmTax.daily_alerts_str` \text{ alerts/day}}\).
