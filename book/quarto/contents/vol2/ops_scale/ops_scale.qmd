...
The separation enables configuration-driven training: running identical code with different data versions, systematic hyperparameter exploration, clear reproducibility from configuration alone, and environment-specific overrides that allow different resources for development versus production.
...
1.  **Domain *Language* is Specialized**: The model needs to learn a new syntax (e.g., medical coding, proprietary SQL dialect), beyond factual knowledge alone.
