...
# │ Exports: TrainingCostExample.c_train_eq_math, .annual_str and setup inputs.
from mlsysim import day
from mlsysim.fmt import fmt, fmt_count, fmt_math, fmt_percent, fmt_time, fmt_usd, check

class TrainingCostExample:
    # ┌── 1. LOAD ──────────────────────────────────────────
    n_gpus = 256
    days = 14
    gpu_hour_rate = 3.50  # scenario assumption: illustrative H100 cloud rate
    pue = 1.15
...
- Hourly rate: `{python} TrainingCostExample.gpu_hour_rate_str` (illustrative H100 cloud-pricing scenario)
- PUE: `{python} TrainingCostExample.pue_str` (efficient hyperscale data center)
