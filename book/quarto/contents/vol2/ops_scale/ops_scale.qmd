...
::: {.column-margin}
![](images/png/ops_scale_tco_dominance.png){width="100%" fig-alt="Stacked bar of the four TCO terms train, infer, data, iter; the infer segment is the widest and shaded orange, the others gray."}
