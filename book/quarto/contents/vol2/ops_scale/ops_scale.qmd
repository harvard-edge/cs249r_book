...
# ML Operations at Scale {#sec-ml-operations-scale}
...
This chapter's position in the book's organizing framework, *the Systems Sandwich*, clarifies why operational management is not overhead but the control plane that keeps the physical and logical layers functioning as a coherent system.
...
@sec-inference-scale established the distributed serving architectures that enable individual models to handle massive request volumes through replication, sharding, and geographic distribution. This chapter examines what happens when organizations deploy not one but hundreds of such systems. The transition from managing individual models to operating enterprise-scale ML platforms represents a fundamental shift in operational complexity.
...
This pattern is essential for recommendation systems where detecting small engagement changes quickly enables rapid iteration. The following figure illustrates how *interleaving vs. A/B testing* differ in their experimental design.
...
### Meta ML Platform {#sec-ml-operations-scale-meta-ml-platform-71cf}
...
### Netflix ML Infrastructure {#sec-ml-operations-scale-netflix-ml-infrastructure-a353}
...
### Google Vertex AI {#sec-ml-operations-scale-google-vertex-ai-3674}
...
### Spotify ML Platform {#sec-ml-operations-scale-spotify-ml-platform-4360}
...
The essential insights from this chapter can be summarized as follows:
