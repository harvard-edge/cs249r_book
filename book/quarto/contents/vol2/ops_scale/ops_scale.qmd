...
The platform-dividend calculation above gives the general rule; the worked example below turns it into an operating decision. The question is not whether shared tooling is aesthetically cleaner, but whether the fixed platform cost is smaller than the manual toil it removes across the model fleet.
