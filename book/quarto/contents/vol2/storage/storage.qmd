...
Applying the Young-Daly formula to a real-world large-scale training scenario illustrates how these reliability constraints translate into practical checkpoint policies.

::: {.callout-example title="Checkpoint Interval at Scale"}
