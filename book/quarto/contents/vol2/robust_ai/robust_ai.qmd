...
::: {#fig-distribution-shift-detector fig-env="figure" fig-pos="htb" fig-cap="**The Distribution Shift Detector**: Monitoring Population Stability Index (PSI) over a year. The model remains stable in the green zone until around week 28, drifts into the orange warning zone due to evolving user behavior, and breaches the red critical threshold at week 35. Automated retraining at week 40 restores model stability." fig-alt="Line plot of weekly PSI over 52 weeks with green, orange, and red zones. Drift detected at week 35, retraining at week 40 restores stability."}
...
**Systems conclusion**: Gaining robustness against rare adversarial attacks sacrifices **`{python} RobustnessTaxAnalysis.acc_drop_str` percent accuracy** on normal inputs.
