...
class SilentErrorProbability:
    ...
    p_total_large_str = fmt(p_at_least_one_val * 100, precision=1, suffix=' percent')
...
class AdversarialPayback:
    ...
    ap_cert_acc_str = fmt(robust_acc*100, precision=0, commas=False, suffix="%")
    ap_gap_pct_str = fmt(accuracy_gap_pct, precision=0, commas=False)
    ap_std_acc_str = fmt(std_acc * 100, precision=0, commas=False, suffix="%")
```
...
class RobustnessTaxAnalysis:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    from mlsysim.fmt import fmt
    clean_acc_str = fmt(clean_acc, precision=0, commas=False, suffix=' percent')
    robust_acc_str = fmt(robust_acc, precision=0, commas=False, suffix=' percent')
    acc_drop_str = fmt(acc_drop, precision=0, commas=False, suffix=' percent')
```
