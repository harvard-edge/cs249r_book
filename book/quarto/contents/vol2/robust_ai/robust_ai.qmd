...
**Math**: Gaining robustness against rare adversarial attacks sacrifices `{python} RobustnessTaxAnalysis.acc_drop_pp_str` of clean accuracy on normal inputs.

The model must learn to ignore "nonrobust features" (like high-frequency textures) that are predictive but brittle.
