...
[^fn-bayesian-nn-dist]: As described in @sec-robust-ai-detection-techniques-0e7e, Bayesian neural networks treat weights as probability distributions rather than fixed values, providing principled uncertainty estimates for distribution shift detection.
