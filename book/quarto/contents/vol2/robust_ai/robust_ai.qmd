...
class AdversarialPayback:
    ...
    ap_slowdown_str = fmt_multiple(slowdown, precision=0, commas=False)
...
class HuberOutlierScaling:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    from mlsysim.fmt import fmt
    normal_error_multiple_str = fmt_multiple(normal_error_multiple, precision=0, commas=False)
    squared_loss_multiple_str = fmt_multiple(squared_loss_multiple, precision=0, commas=True)
    residual_gradient_multiple_str = fmt_multiple(residual_gradient_multiple, precision=0, commas=False)
```
