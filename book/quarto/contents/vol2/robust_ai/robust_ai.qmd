...
::: {.column-margin}
![](images/png/robust_ai_psi_drift_knee.png){width="100%" fig-alt="A line curve that stays nearly flat across the left and rises sharply into a hockey-stick on the right, with a dot marking the knee and the region to the right of the knee shaded to mark a danger zone."}
