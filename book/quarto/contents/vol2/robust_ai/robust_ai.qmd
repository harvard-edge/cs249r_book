...
A common fallacy is this: *Adversarial examples are an academic curiosity with no real-world impact.*
...
A recurring pitfall is this: *Treating test-set success as robustness proof.*
...
A common fallacy is this: *Distribution shift monitoring is optional after deployment.*
...
A recurring pitfall is this: *Ignoring poisoning defenses unless the attacker controls the training pipeline.*
...
A common fallacy is this: *Average accuracy is sufficient for robustness measurement.*
...
A recurring pitfall is this: *Treating adversarial training as a complete robustness solution.*
...
A common fallacy is this: *Software faults do not matter when the model is correct.*
...
A recurring pitfall is this: *Hardening the model while leaving pipeline checks untested.*
