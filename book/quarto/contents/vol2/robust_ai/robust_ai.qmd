...
\noindent
![](images/png/cover_robust_ai_blueprint_print.png){fig-alt="Robust AI test chamber where a model service is exposed to drift, adversarial perturbation, and faults while monitors route adaptation and recovery."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_robust_ai_blueprint.webp){fig-alt="Robust AI test chamber where a model service is exposed to drift, adversarial perturbation, and faults while monitors route adaptation and recovery."}
:::
