...
#### The Reliability Challenge of Advanced Process Nodes {#sec-robust-ai-reliability-challenge-advanced-process-nodes-e4b6}

The "Physics" of the Machine Learning Fleet established in @sec-compute is facing a growing reliability crisis. As we scale to sub-5nm process nodes to achieve higher TFLOPS, the underlying transistors become increasingly susceptible to environmental noise and aging.
...
#### Quantitative Reliability Analysis {#sec-robust-ai-quantitative-reliability-analysis-b121}
...
##### MTBF and FIT Rate Calculations {#sec-robust-ai-mtbf-fit-rate-calculations-e62a}

We begin with two foundational metrics that quantify component and system reliability. Building on the reliability concepts introduced in @sec-fault-tolerance-reliability, Mean Time Between Failures (MTBF) quantifies the expected operational time between successive failures. For a system experiencing $N$ failures over total operational time $T$, MTBF is defined as:
...
##### System Reliability Composition {#sec-robust-ai-system-reliability-composition-da0d-da0d}
...
##### GPU Cluster Reliability Example {#sec-robust-ai-gpu-cluster-reliability-example-f6c4}
...
#### Optimal Checkpoint Frequency {#sec-robust-ai-optimal-checkpoint-frequency-c099}
...
### Foundational Misconceptions {#sec-robust-ai-foundational-misconceptions-d38f}
...
### Hardware and Infrastructure {#sec-robust-ai-hardware-infrastructure-64a1}
...
### Adversarial Defense {#sec-robust-ai-adversarial-defense-3269}
...
### Distribution Shift and Adaptation {#sec-robust-ai-distribution-shift-adaptation-6cf6}
...
### Cross-Domain Interactions {#sec-robust-ai-crossdomain-interactions-2adf}
