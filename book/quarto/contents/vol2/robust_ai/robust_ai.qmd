...
**Conclusion**: Achieving competitive robustness requires **8-10$\times$ more compute** per epoch. For a large model like **Llama-3 (Lighthouse)**, this penalty is often prohibitive, forcing teams to rely on post-hoc defenses (e.g., input filtering) instead of intrinsic robustness.
:::
