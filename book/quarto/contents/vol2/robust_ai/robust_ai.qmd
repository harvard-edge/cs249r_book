...
**Problem**: A team is training a robust classifier for an autonomous vehicle, using adversarial training with PGD-7, a seven-step projected-gradient attack that searches for a worst-case perturbation for every training batch. How much does this "robustness tax" slow down the training run?
