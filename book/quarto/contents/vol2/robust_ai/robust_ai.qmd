...
The attacker's available information and perturbation budget determine which category of adversarial attack applies. Each category tells the defender what the attacker can measure and which cost the defense must raise.
