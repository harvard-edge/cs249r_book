...
This chapter's position in the book's organizing framework, *the Systems Sandwich*, clarifies why robustness is an infrastructure concern: silent failures propagate through every layer of the system, from hardware faults at the physical level to degraded predictions at the service level.
...
The following figure illustrates how race conditions manifest in distributed training when multiple workers interact with a shared parameter server.
