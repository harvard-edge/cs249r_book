...
*Shows sharded inference as a dependency chain where one failed stage can fail the request.*
:::
...
*Shows one surrogate-crafted adversarial example transferring to multiple target models.*
:::
...
*Shows data poisoning as a lifecycle: inject, learn, trigger.*
:::
...
*Shows Huber loss limiting outlier influence compared with squared loss.*
:::
