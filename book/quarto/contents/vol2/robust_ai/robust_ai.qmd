...
|:------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------|
| **Retrain immediately** | • $\text{PSI} > 0.25$ on critical features and performance degraded by more than 5%<br>• Concept drift confirmed ($p(y \mid x)$ changed)<br>• Regulatory or compliance requirements mandate fresh models | The learned mapping, compliance baseline, or production population is no longer valid enough for monitoring alone |
