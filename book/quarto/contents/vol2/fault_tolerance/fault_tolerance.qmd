...
* **Recovery is a contract**: RPO bounds lost progress, RTO bounds recovery delay, a manifest identifies committed state, and fencing prevents an expired worker epoch from writing after replacement.
