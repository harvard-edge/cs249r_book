...
# │
# │ Imports: mlsysim public API (Models, units, fmt helpers), math
# │ Exports: CheckpointOverheadCalc.{archA,dense20b,bert,archB,resnet,vision_transformer}_*_str
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim import Models
from mlsysim.core.units import BYTES_FP32, GB, MB, TB, hour, second
from mlsysim.fmt import MarkdownStr, check, fmt_memory, fmt_percent, fmt_time
import math
...
class CheckpointOverheadCalc:
    ...
    archA_size = 2100 * GB     # 175B dense LLM: ~12 bytes/param (mixed precision + optimizer)
