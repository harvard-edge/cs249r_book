...
::: {.callout-note title="Figure Placeholder: Young-Daly Trade-off" collapse="true"}
```{.tikz}
% TODO: Graph showing Total Waste vs Checkpoint Interval.
% U-shaped curve. Minimum point is optimal interval.
\node[draw, align=center] {Young-Daly Cost Curve};
```
