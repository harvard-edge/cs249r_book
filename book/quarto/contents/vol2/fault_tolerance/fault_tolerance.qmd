...
class CheckpointOverheadCalc:
    ...
    check(590 * second < archB_interval < 610 * second, "Archetype B interval should be 10 minutes")
    check(5 * second < resnet_interval < 8 * second, "ResNet-50 interval should be ~6 seconds")
    check(50 * second < vision_transformer_interval < 60 * second, "Vision transformer interval should be ~56 seconds")
