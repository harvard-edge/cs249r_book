...
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}]
  ...
  \draw[BlueLine, thick, decorate, decoration={brace, amplitude=4pt, mirror}]
    (0, -0.7) -- (2.5, -0.7) node[midway, below=5pt, font=\tiny, text=BlueLine] {$\tau_{\text{opt}}$};
  \draw[BlueLine, thick, decorate, decoration={brace, amplitude=4pt, mirror}]
    (3.0, -0.7) -- (5.5, -0.7) node[midway, below=5pt, font=\tiny, text=BlueLine] {$\tau_{\text{opt}}$};
  ...
  \node[font=\tiny, anchor=west] at (3.5, -1.35) {Checkpoint write ($T_{\text{save}}$)};
