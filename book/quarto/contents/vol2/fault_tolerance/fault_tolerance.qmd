...
class HbmSerBudget:
    ...
    hbm_per_gpu_gb_str = fmt_qty(hbm_per_gpu, GB, precision=0, commas=False)
```
...
class OomAdamwFootprint:
    ...
    node_mem_cap_gb_str = fmt_qty(node_mem_cap, GB, precision=0, commas=False)
```
...
class SDCCollective:
    ...
    hours_between_str = fmt_time(expected_hours, "hour", precision=0, style="word")
