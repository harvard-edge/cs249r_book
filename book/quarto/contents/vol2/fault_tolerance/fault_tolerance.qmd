...
::: {#fig-parity fig-env="figure" fig-pos="htb" fig-cap="**Parity Bit Error Detection**: Parity check scheme using an eighth even or odd parity bit to detect single bit flips during transmission or storage. Source: computer hope." fig-alt="Two 7-bit data sequences with an eighth even-parity bit. The top sequence is valid. The bottom shows a bit flip that causes a parity mismatch, detecting the error."}
