...
# │ How: Systems.Reliability.Gpu.mttf_hours/N; Kokolis/Llama data; viz.setup_plot().
# │
# │ Imports: numpy (np), matplotlib.pyplot (plt), mlsysim.core.viz (viz),
...
::: {.column-margin}
![](images/svg/vol2_fault_tolerance_margin_001.svg){width="100%" fig-alt="Margin illustration showing Cumulative silent-data-corruption risk over training steps."}
...
# │ How: tau_opt = sqrt(2*T_write*MTBF_system); viz.set_book_style().
# │
# │ Imports: numpy (np), matplotlib.pyplot (plt), mlsysim.core.viz (viz)
# │ Exports: (figure only, no prose variables)
# └─────────────────────────────────────────────────────────────────────────────
...
::: {.column-margin}
![](images/svg/vol2_fault_tolerance_margin_003.svg){width="100%" fig-alt="Margin illustration showing One slow rank blocking healthy ranks at synchronization barrier."}
