...
- **Memory bit flips**\index{Memory!bit flips}: Corrupt individual bits through cosmic ray induced single-event upsets.[^fn-seu-rate]
...
- **Shared power domain**\index{Correlated Failure!shared power domain}: UPS failure takes down an entire rack.
