...
- [ ] **Silent corruption**: Explain why silent corruption sits apart from the other manifestations in @tbl-fault_types even when its underlying fault is an ordinary transient bit flip.
