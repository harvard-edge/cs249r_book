...
# │
# │ Imports: mlsysim public API (Systems, fmt, fmt_int, fmt_time, fmt_text, check)
...
def _mtbf_h(v):
    ...
    return fmt_time(v * hour, hour, precision=0 if float(v).is_integer() else 1, commas=False, style="word")
...
class ClusterMtbfScaling:
    ...
    # ┌── 4. OUTPUT (Formatting) ───────────────────
    gpu_mttf_hrs_str = fmt_time(gpu_mttf_h * hour, hour, precision=0, commas=True, style="word")
...
# │       minutes for display.
# │
# │ Imports: mlsysim public API (fmt_int, fmt_display_math, fmt_time, check)
