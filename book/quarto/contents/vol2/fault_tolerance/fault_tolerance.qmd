...
::: {.column-margin}
![](images/png/fault_tolerance_mtbf_ladder.png){width="100%" fig-alt="Ladder of three blue bars showing system mean time between failures collapsing as fleet size grows: 1 GPU at 50,000 hours, 1,000 GPUs at 50 hours, 10,000 GPUs at 5 hours."}
:::
...
::: {.column-margin}
![](images/png/fault_tolerance_blast.png){width="100%" fig-alt="A single red fault source on the left with arrows fanning out to five blue nodes on the right, showing one shared dependency taking down all the components that depend on it."}
:::
