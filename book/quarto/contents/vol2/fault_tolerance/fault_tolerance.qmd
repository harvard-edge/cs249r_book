...
class CheckpointDebug:
    ...
    params_b_str = fmt(m.parameters.m_as(param) / BILLION, precision=0, commas=False) + "B"
...
class StragglerTax:
    ...
    gpu_cost_per_hour = Infrastructure.Pricing.Cloud.GpuTrainingUtilityScenarioPerHour.rate.m_as(USD / hour)
