...
<!-- TODO(bib-pass): Case-study operational claims below need source
     attribution: OPT-175B failure counts and 50 percent MFU figure
     (cite the OPT-175B logbook), Google TPU pod
     recovery targets, Netflix MTTR reduction, DeepSpeed overhead
     figures. Add citations or recast as illustrative scenarios in a
     focused bib-audit pass. -->
Production deployments illustrate how leading organizations implement fault tolerance in ML systems, illustrating the principles developed throughout this chapter. Meta's OPT-175B training run on a 992-node GPU cluster provides a definitive study in handling dozens of hardware failures per week without aborting the run.
