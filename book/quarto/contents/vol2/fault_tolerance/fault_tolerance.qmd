...
class RecoveryBudget:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    t_total_str = fmt_time(t_total, unit=minute, precision=1, commas=False)
...
**Total**: $T_{\text{recovery}} = T_{\text{detect}} + T_{\text{restart}} + T_{\text{load}} + T_{\text{warmup}} \approx$ `{python} RecoveryBudget.t_total_str` per failure event.
