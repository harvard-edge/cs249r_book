...
The Archetype A row below uses the mixed-precision optimizer checkpoint footprint (12 bytes per parameter), distinct from the full FP32 training-state total (`{python} FaultToleranceIntroRecap.gpt3_ckpt_tb_str`) cited in the introduction.
