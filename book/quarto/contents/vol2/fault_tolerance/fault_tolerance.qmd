...
class NinesReliability:
    ...
    hourly_survival = availability_pct / 100
    ...
    survival_str = f"{hourly_survival:.4f}"
...
1.  **Single GPU Success Probability ($P_{\text{1h}}$)**: A GPU with `{python} NinesReliability.availability_str` percent annual availability has hourly survival probability `{python} NinesReliability.survival_str` ($P_{\text{1h}}$).
