...
\noindent
![](images/png/cover_fault_tolerance_blueprint_print.png){fig-alt="Fleet recovery blueprint showing a training path interrupted by a failed node, checkpoint state preserved, and work resumed through replacement workers."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_fault_tolerance_blueprint.webp){fig-alt="Fleet recovery blueprint showing a training path interrupted by a failed node, checkpoint state preserved, and work resumed through replacement workers."}
:::
