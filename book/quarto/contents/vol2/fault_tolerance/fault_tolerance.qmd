...
**Impact at scale**\index{Impact at Scale}: With a 1,000-GPU cluster MTBF of 50 hours (from @tbl-cluster-mtbf-scaling), we experience about 0.48 failures per day, losing about 3 minutes daily—a modest 0.2 percent overhead. But at 10,000 GPUs with MTBF of 5 hours, we experience about 4.8 failures per day, losing about 31 minutes daily—a 2.1 percent overhead equivalent to wasting roughly 5,000 GPU-hours every day (31 min $\times$ 10,000 GPUs ÷ 60). This is why recovery time optimization matters more as clusters grow.
