...
class YoungDalyOptimal:
    ...
    mtbf_h_str = fmt_time(mtbf_h, 'hour', precision=2, commas=False, style='word')
    mtbf_s_str = fmt(mtbf_s, precision=0)
    tau_opt_s_str = fmt(tau_opt_s, precision=1)
    tau_opt_min_str = fmt_time(tau_opt_min, 'minute', precision=1, commas=False)
...
class CheckpointOverheadCalc:
    ...
    # -- Write times
    archA_write_str = fmt_time(archA_write_s, 'second', precision=0, commas=False)
    gpt35_write_str = fmt_time(gpt35_write_s, 'second', precision=1, commas=False)
    bert_write_str = fmt_time(bert_write_s, 'second', precision=3, commas=False)
    archB_write_str = fmt_time(archB_write_s, 'second', precision=0, commas=False)
    resnet_write_str = fmt_time(resnet_write_s, 'second', precision=3, commas=False)
    vit_write_str = fmt_time(vit_write_s, 'second', precision=3, commas=False)

    # -- Optimal intervals (min for >= 60s, s for < 60s)
    archA_interval_str = fmt_time(archA_interval_s / 60, 'minute', precision=1, commas=False)
    gpt35_interval_str = fmt_time(gpt35_interval_s / 60, 'minute', precision=1, commas=False)
    bert_interval_str = fmt_time(round(bert_interval_s), 'second', precision=0, commas=False)
    archB_interval_str = fmt_time(round(archB_interval_s / 60), 'minute', precision=0, commas=False)
    resnet_interval_str = fmt_time(round(resnet_interval_s), 'second', precision=0, commas=False)
    vit_interval_str = fmt_time(round(vit_interval_s), 'second', precision=0, commas=False)
...
```{python}
#| echo: false
from mlsysim.fmt import fmt_int, fmt_count, fmt_time
...
class CheckpointDebug:
    ...
    min_write_min_str = fmt_time(min_write_min_val, 'minute', precision=1, commas=False)
    ...
    per_node_write_min_str = fmt_time(min_write_min_val, 'minute', precision=1, commas=False) # Aggregated BW bottleneck
    ...
    params_b_str = fmt_count(m.parameters.m_as(param), scale='B', precision=0, commas=False)
...
from mlsysim.fmt import fmt, check, fmt_int, fmt_time
...
class RecoveryBudget:
    ...
    t_restart_min_str = fmt_time(t_restart_min, 'minute', precision=0, commas=False)
    t_load_s_str = fmt_int(round(t_load_s), commas=False)
    t_warmup_min_str = fmt_time(t_warmup_min, 'minute', precision=0, commas=False)
    ...
    mtbf_1k_hrs_str = fmt_time(mtbf_1k_hrs, 'hour', precision=0, commas=False, style='word')
    mtbf_10k_hrs_str = fmt_time(mtbf_10k_hrs, 'hour', precision=0, commas=False, style='word')
    ...
    daily_loss_min_1k_str = fmt_time(round(daily_loss_min_1k), 'minute', precision=0, commas=False, style='word')
    daily_loss_min_10k_str = fmt_time(round(daily_loss_min_10k), 'minute', precision=0, commas=False, style='word')
