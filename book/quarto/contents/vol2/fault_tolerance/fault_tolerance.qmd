...
```{.tikz}
\scalebox{0.8}{%
\begin{tikzpicture}[line join=round,font=\sffamily\large]
\tikzset{%
helvetica/.style={align=flush center,font=\small\sffamily},
...
font=\sffamily\small](SS){sequence of\\ seven bits};
\node[above=0.5 of $(B1M2)!0.5!(B8M2)$,align=center,text depth=0.7,
font=\sffamily\small](WE){with eighth\\ even parity bit};
\node[above=0.5 of $(B1M3)!0.5!(B8M3)$,align=center,text depth=0.7,
font=\sffamily\small](WO){with eighth\\ odd parity bit};
\node[above=0.6 of $(SS)!0.5!(WO)$,align=center,text depth=0.7,
font=\sffamily\small,bluegraph](PBE){Parity bit examples};
%
...
\node[above=2pt of  BB1.south east,anchor=south east,
            font=\sffamily\footnotesize,black!30]{ComputerHope.com};
%
\end{tikzpicture}}
```
