...
2. **Deterministic checkpoint time**\index{Deterministic Checkpoint Time}: Assumes $T_{\text{save}}$ is constant. In practice, checkpoint time varies 2--3$\times$ due to storage contention, network congestion, and memory pressure.
