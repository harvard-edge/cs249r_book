...
class CheckpointOverheadCalc:
    ...
    def young_daly_interval(write_time, _mtbf=mtbf):
        # Bind the class-level MTBF at definition time: a bare `mtbf` inside this
        # function resolves to the module namespace, where an earlier figure cell
        # defines a dimensionless `mtbf = 2.0`, breaking the unit math.
        interval_s = math.sqrt((2 * write_time * _mtbf).to(second**2).magnitude)
