...
A routing mechanism (learned gating function) determines which experts process each input, as illustrated in @fig-moe-routing-frontiers.
...
The final conclusion (@sec-vol2-conclusion) distills these lessons into the enduring principles that will guide your engineering decisions, regardless of which technologies emerge on the horizon.
