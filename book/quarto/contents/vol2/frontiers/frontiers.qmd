...
::: {.callout-fallacy title="Scaling solves all capability limitations."}
:::
...
::: {.callout-fallacy title="Compound systems are temporary workarounds."}
:::
...
::: {.callout-fallacy title="Frontier systems require entirely new engineering principles."}
:::
...
::: {.callout-pitfall title="Treating biological efficiency as achievable target."}
:::
...
::: {.callout-fallacy title="Inference-time compute makes training efficiency irrelevant."}
:::
...
::: {.callout-pitfall title="Planning based on extrapolated scaling laws."}
:::
