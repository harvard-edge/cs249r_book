...
The next chapter, @sec-fault-tolerance-reliability, examines the reliability mechanisms—checkpointing and elastic training—that allow these massive distributed jobs to survive the inevitable hardware failures that occur in any fleet.
