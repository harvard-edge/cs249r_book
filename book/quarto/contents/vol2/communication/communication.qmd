...
@sec-distributed-training applies these communication primitives to the high-level logic of **Data, Model, and Pipeline Parallelism**, enabling the training of models that exceed the memory of any single node.
