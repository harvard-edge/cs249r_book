...
3.  **Common Pitfall:** A frequent misconception is that the roofline is "static." In reality, it is **Precision-Dependent**: using lower precision (for example, INT8) raises the compute ceiling ($R_{\text{peak}}$) while the memory ceiling ($BW$) remains constant, shifting the ridge point significantly.
