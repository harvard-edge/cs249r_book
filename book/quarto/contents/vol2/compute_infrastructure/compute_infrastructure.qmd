...
class RooflineInferenceMath:
    ...
    inf_peak_pct_str = fmt(inf_peak_pct, precision=2, commas=False, suffix=" percent")
...
class NodeReliabilityScenario:
    ...
    restart_overhead_low_str = fmt(restart_overhead_low_pct, precision=1, commas=False, suffix=" percent")
    restart_overhead_high_str = fmt(restart_overhead_high_pct, precision=1, commas=False, suffix=" percent")
```
