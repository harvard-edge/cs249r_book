...
::: {.column-margin}
![](images/png/compute_infrastructure_decode_roofline.png){width="100%" fig-alt="A roofline: a blue memory-bound slope rising to an orange compute-bound ceiling at the ridge point. A workload dot sits low on the blue slope, far left of the ridge, marking LLM decode as deeply memory-bound."}
:::
