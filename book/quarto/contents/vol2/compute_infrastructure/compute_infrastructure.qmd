...
::: {.column-margin}
![](images/svg/vol2_compute_infrastructure_margin_001.svg){width="100%" fig-alt="Margin illustration showing MAC, HBM read, and DRAM read energy costs."}
...
::: {.column-margin}
![](images/svg/vol2_compute_infrastructure_margin_004.svg){width="100%" fig-alt="Margin illustration showing One slow GPU at an all-reduce barrier delays peers."}
