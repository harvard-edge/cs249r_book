...
class BandwidthStaircase:
    # ┌── 1. LOAD ──────────────────────────────────────────
    hbm_bw_gbs = 3350 # H100 HBM3
    nvlink_bw_gbs = 900 # H100 NVLink
    ib_bw_gbs = 50 # 400G NDR InfiniBand
    # ┌── 2. EXECUTE ───────────────────────────────────────
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    bs_hbm_bw_str = f"{hbm_bw_gbs:,}"
    bs_nvlink_bw_str = f"{nvlink_bw_gbs}"
    bs_ib_bw_str = f"{ib_bw_gbs}"
