...
class H200Comparison:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    bw_gain_str = fmt((h200.memory.bandwidth/h_h100.memory.bandwidth).to_base_units().magnitude, precision=1)
    cap_gain_str = fmt((h200.memory.capacity/h_h100.memory.capacity).to_base_units().magnitude, precision=1)
