...
::: {.column-margin}
![](images/svg/compute_infrastructure_precision_dotcells.svg){width="100%" fig-alt="A 2-by-2 grid of cells. Columns are Ampere and Hopper; rows are FP8 and INT8. Three cells hold gray status dots; the FP8 by Hopper cell holds a crimson dot, marking FP8 support added only in the Hopper generation."}

*FP8 is the new Hopper capability; earlier generations lack it.*
:::
...
::: {.column-margin}
![](images/svg/vol2_compute_infrastructure_margin_002.svg){width="100%" fig-alt="Margin illustration showing Legacy air-cooled rack envelope versus DGX H100 rack power."}
...
::: {.column-margin}
![](images/svg/vol2_compute_infrastructure_margin_003.svg){width="100%" fig-alt="Margin illustration showing Fleet MTBF falls from one GPU to 10,000 GPUs."}

*Fleet reliability collapses as component count grows.*
:::
