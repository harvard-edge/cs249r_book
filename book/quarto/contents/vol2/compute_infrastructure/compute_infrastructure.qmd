...
- [ ] **Peak-throughput upgrade**: Predict whether upgrading to a B200 with 2.3$\times$ the peak TFLOP/s will achieve the expected 2.3$\times$ speedup.
- [ ] **Binding constraint**: Identify the alternative upgrade that would be more effective.
