...
**System**: Profiling showed that over 90 percent of inference cycles were spent on matrix multiplications in neural network models. This observation led directly to the TPU v1, a purpose-built inference accelerator with a $256{\times}256$ systolic array that could deliver 92 TOPS (INT8) within a 75 W power envelope. The first TPUs were deployed in 2015 and served production inference workloads including RankBrain, portions of Google Neural Machine Translation, and AlphaGo match play [@silver2017; @jouppi2017].
