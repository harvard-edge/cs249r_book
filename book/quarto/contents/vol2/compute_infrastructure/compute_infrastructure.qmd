...
\node[circle, draw=black!10, fill=black!2, line width=1.5pt, minimum size=8.4cm, inner sep=0] (wafer) at (0,0) {};
\node[circle, draw=black!20, line width=0.8pt, minimum size=8.3cm, inner sep=0] at (0,0) {};
...
\begin{scope}[shift={(zoomcenter)}, yshift=1.5cm, scale=1.2]
  \node[draw=black!20, fill=white, rounded corners=3pt, minimum size=2.4cm, line width=0.75pt] (zoombox) at (0,0) {};
  \foreach \x in {-1,0,1} {
    \foreach \y in {-1,0,1} {
...
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}, node distance=1.2cm]
  ...
  % Annotations
  \node[right=0.5cm of UPS, text=BlueLine, anchor=west] {\textbf{Facility Level}};
  \node[right=0.5cm of PSU, text=OrangeLine, anchor=west] {\textbf{Rack Level}};
  \node[right=0.5cm of Die, text=RedLine, anchor=west] {\textbf{Silicon Level}};
