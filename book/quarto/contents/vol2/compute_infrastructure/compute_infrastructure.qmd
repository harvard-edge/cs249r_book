...
# │          InfraSetup.ib_bw_str, t_comp_math, t_mem_math
# └─────────────────────────────────────────────────────────────────────────────
...
# Token latency math blocks (used in @nb-token-latency, line ~712)
t_comp_math = md_math(f"T_{{\\text{{comp}}}} \\approx \\mathbf{{{InfraSetup.t_comp_ms:.2f} \\text{{ ms}}}}")
t_mem_math = md_math(f"T_{{\\text{{mem}}}} \\approx \\mathbf{{{InfraSetup.t_mem_ms:.1f} \\text{{ ms}}}}")
```
...
# │ Exports: inf_flops_math, inf_throughput_math, train_intensity_math
# └─────────────────────────────────────────────────────────────────────────────
...
# │ Exports: t_intra_math, t_inter_math
# └─────────────────────────────────────────────────────────────────────────────
...
# │
# │ Imports: mlsys.formatting (md_math)
# │ Exports: pod_flops_math, total_flops_math, n_params_math,
# │          cluster_throughput_math
# └─────────────────────────────────────────────────────────────────────────────
...
3. **Idealized Training Time** (the "physics limit"):
   `{python} total_flops_math` / `{python} cluster_throughput_math` $\times 10^{18}$ $\approx$ **`{python} TrainingTime175B.t_physics_hr_str` hours**
...
# │
# │ Imports: mlsys.formatting (md_math)
# │ Exports: comm_time_formula_math, comm_approx_math, compute_per_step_math,
# │          t_compute_math, t_comm_math
# └─────────────────────────────────────────────────────────────────────────────
