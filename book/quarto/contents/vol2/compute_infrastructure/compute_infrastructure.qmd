...
class NodeReliabilityScenario:
    ...
    node_mtbf_str = fmt(composite_node_mtbf_hours, precision=0, suffix=" hours")
    ...
    recovery_low_str = fmt(recovery_low_min, precision=0, commas=False, suffix=" minutes")
    recovery_high_str = fmt(recovery_high_min, precision=0, commas=False, suffix=" minutes")
...
class TrainingTime175B:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    t_physics_hr_str = fmt(t_physics_hr, precision=1, suffix=" hours")
    t_comm_hr_str = fmt(t_comm_hr, precision=1, suffix=" hours")
    t_bubble_hr_str = fmt(t_bubble_hr, precision=1, suffix=" hours")
    t_ckpt_hr_str = fmt(t_ckpt_hr, precision=1, suffix=" hours")
    t_fail_hr_str = fmt(t_fail_hr, precision=1, suffix=" hours")
    t_maint_hr_str = fmt(t_maint_hr, precision=1, suffix=" hours")
    t_total_week_str = fmt(t_total_weeks, precision=1, suffix=" weeks")
```
...
class CheckpointComputeTradeoff:
    ...
    tau_opt_min_str = fmt_int(tau_opt_s / SECONDS_PER_MINUTE, commas=False, suffix=" minutes")
