...
\noindent
![](images/png/cover_compute_infrastructure_blueprint_print.png){fig-alt="Layered compute infrastructure cutaway from accelerator chip and HBM to server nodes, racks, power delivery, and cooling loops."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_compute_infrastructure_blueprint.webp){fig-alt="Layered compute infrastructure cutaway from accelerator chip and HBM to server nodes, racks, power delivery, and cooling loops."}
:::
