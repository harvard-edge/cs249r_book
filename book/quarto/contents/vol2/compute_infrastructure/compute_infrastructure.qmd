...
class A100HbmQuantRecap:
    ...
    weights_gb_str = fmt_int(weights_gb, commas=False, suffix=" GB")
...
class InfraFrontierNodeBudgetRecap:
    ...
    optimizer_gb_str = fmt(optimizer_gb, precision=0, suffix=" GB")
    gradients_gb_str = fmt(gradients_gb, precision=0, suffix=" GB")
    total_static_tb_str = fmt(total_static_gb / THOUSAND, precision=1, commas=False, suffix=" TB")
...
class InfraFrontierNodeTpRecap:
    ...
    activation_mb_str = fmt_int(activation_mb, commas=False, suffix=" MB")
    gradient_allreduce_gb_str = fmt(gradient_allreduce_gb, precision=0, commas=False, suffix=" GB")
```
...
class NodeCapacityTrainMemRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    node_hbm_cap_str = fmt(node_hbm_gb, precision=0, commas=False, suffix=" GB")
    host_dram_tb_str = fmt(host_dram_tb, precision=0, commas=False, suffix=" TB")
    weights_gb_str = fmt(weights_gb, precision=0, suffix=" GB")
    gradients_gb_str = fmt(gradients_gb, precision=0, suffix=" GB")
    optimizer_gb_str = fmt(optimizer_gb, precision=0, suffix=" GB")
    total_dp_gb_str = fmt(total_dp_gb, precision=0, suffix=" GB")
    gpu_hbm_gb_str = fmt(gpu_hbm_gb, precision=0, commas=False, suffix=" GB")
    zero3_per_gpu_gb_str = fmt(zero3_per_gpu_gb, precision=1, commas=False, suffix=" GB")
    tp_weight_shard_gb_str = fmt(tp_weight_shard_gb, precision=2, commas=False, suffix=" GB")
    optimizer_per_gpu_gb_str = fmt(optimizer_per_gpu_gb, precision=1, commas=False, suffix=" GB")
    optimizer_per_tp_group_gb_str = fmt(optimizer_per_tp_group_gb, precision=1, commas=False, suffix=" GB")
    weight_plus_optimizer_gb_str = fmt(weight_plus_optimizer_gb, precision=1, commas=False, suffix=" GB")
...
class InfraFrontierNodeModelRecap:
    ...
    h100_mem_gb_str = fmt(h100_mem_gb, precision=0, commas=False, suffix=" GB")
    total_hbm_gb_str = fmt(h100_mem_gb * node_gpus, precision=0, commas=False, suffix=" GB")
    host_ddr_tb_str = fmt(host_ddr_tb, precision=0, commas=False, suffix=" TB")
    weight_per_gpu_gb_str = fmt(weight_per_gpu_gb, precision=2, commas=False, suffix=" GB")
    opt_state_gb_str = fmt(opt_state_gb, precision=0, commas=False, suffix=" GB")
    act_gb_str = fmt(act_gb, precision=0, commas=False, suffix=" GB")
    grad_gb_str = fmt(grad_gb, precision=2, commas=False, suffix=" GB")
    buf_gb_str = fmt(buf_gb, precision=0, commas=False, suffix=" GB")
    total_per_gpu_gb_str = fmt_int(total_per_gpu_gb, commas=False, suffix=" GB")
    optimizer_pool_gb_str = fmt(optimizer_pool_gb, precision=0, commas=True, suffix=" GB")
```
...
class CheckpointOverheadBudget:
    ...
    ckpt_run_total_tb_str              = fmt(run_total_tb, precision=0, suffix=" TB")
...
class CheckpointComputeTradeoff:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    frontier_params_b_str = fmt(params / BILLION, precision=0, commas=False)
    training_state_tb_str = fmt_int(training_state_tb, commas=False, suffix=" TB")
