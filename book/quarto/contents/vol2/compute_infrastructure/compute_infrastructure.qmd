...
|:--------------|:----------------------------|:---------------------------|
| **GPU utilization**\index{GPU Utilization} | Large batch sizes push workloads into the compute-bound regime, so clusters commonly achieve 30--50 percent MFU. | Low-batch serving is deeply memory bound and can achieve less than 5 percent MFU, so batching improves utilization at the cost of latency. |
