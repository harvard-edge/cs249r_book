...
from mlsys.constants import (
    TFLOPs, second, GB, TB, byte, flop, BYTES_FP16,
...
class InfraSetup:
    ...
    # Models
    m_gpt3 = Models.GPT3
    m_llama70b = Models.Llama2_70B
    m_frontier = Models.Llama3_405B # Representative Frontier model
    ...
    # 2. Parameters
    gpt3_params_b_val = m_gpt3.parameters.m_as('billion')
    frontier_params_b_val = m_frontier.parameters.m_as('billion')
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsys.constants import CLOUD_ELECTRICITY_PER_KWH, H100_TDP, GPUS_PER_HOST, SEC_PER_YEAR, kilowatt, hour, USD
...
class TcoScenario:
    ...
    # ┌── 2. EXECUTE (The Compute) ────────────────────────────────────────
    hours_per_year = SEC_PER_YEAR.m_as(hour)
