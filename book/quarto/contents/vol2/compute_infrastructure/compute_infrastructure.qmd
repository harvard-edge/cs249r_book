...
# │ How: Reference mlsys.Hardware and mlsys.Models registry.
# │
# │ Imports: mlsys.Hardware, mlsys.Models, mlsys.constants, mlsys.formatting
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsys import Hardware, Models, Tiers
from mlsys.constants import (
...
# │
# │ Imports: mlsys.constants (H100_FLOPS_FP8_TENSOR, TFLOPs, second)
# │ Exports: InfraSetup.h100_tflops
# └─────────────────────────────────────────────────────────────────────────────
from mlsys.constants import H100_FLOPS_FP8_TENSOR, TFLOPs, second
...
# │ How: pulling constants from mlsys.constants.
# │
# │ Imports: mlsys.constants (H100_FLOPS_FP8_TENSOR, H100_MEM_BW, GPT3_PARAMS,
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsys.constants import H100_FLOPS_FP8_TENSOR, H100_MEM_BW, GPT3_PARAMS, TFLOPs, TB, second, param, BILLION, flop, byte
...
# │
# │ Imports: mlsys.formatting (md_math)
...
# │
# │ Imports: mlsys.constants (H100_TDP, GPUS_PER_HOST, kilowatt)
# │ Exports: rack_power_str
# └─────────────────────────────────────────────────────────────────────────────
from mlsys.constants import H100_TDP, GPUS_PER_HOST, kilowatt
...
# │ How: pulling constants from mlsys.constants.
# │
# │ Imports: mlsys.constants (NVLINK_H100_BW, PCIE_GEN5_BW, INFINIBAND_NDR_BW,
# │          GB, second)
# │ Exports: InfraSetup.nvlink_bw_str, pcie_bw_str, InfraSetup.ib_bw_gbs
# └─────────────────────────────────────────────────────────────────────────────
from mlsys.constants import NVLINK_H100_BW, PCIE_GEN5_BW, INFINIBAND_NDR_BW, GB, second
...
# │
# │ Imports: mlsys.constants (H100_MEM_CAPACITY, H100_FLOPS_FP8_TENSOR,
# │          GPUS_PER_HOST, GB, TFLOPs, second)
# │ Exports: node_hbm_cap, RooflineScenario.h100_tflops
# └─────────────────────────────────────────────────────────────────────────────
from mlsys.constants import H100_MEM_CAPACITY, H100_FLOPS_FP8_TENSOR, GPUS_PER_HOST, GB, TFLOPs, second
...
# │
# │ Imports: mlsys.constants (GPT3_PARAMS, H100_FLOPS_FP8_TENSOR, ...)
# │ Exports: t_physics_hr_str, t_comm_hr_str, t_bubble_hr_str, t_ckpt_hr_str,
# │          t_fail_hr_str, t_maint_hr_str, t_total_week_str
# └─────────────────────────────────────────────────────────────────────────────
from mlsys.constants import GPT3_PARAMS, H100_FLOPS_FP8_TENSOR, BILLION, flop, second, param
...
# │
# │ Imports: mlsys.constants (CLOUD_ELECTRICITY_PER_KWH, H100_TDP,
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsys.constants import CLOUD_ELECTRICITY_PER_KWH, H100_TDP, GPUS_PER_HOST, HOURS_PER_YEAR, kilowatt, hour, USD
...
# │ How: pulling constants from mlsys.constants.
# │
# │ Imports: mlsys.constants (GPT3_PARAMS, H100_FLOPS_FP8_TENSOR, H100_MEM_BW,
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsys.constants import GPT3_PARAMS, H100_FLOPS_FP8_TENSOR, H100_MEM_BW, H100_TDP, GPUS_PER_HOST, param, BILLION, TFLOPs, second, TB, kilowatt
...
end_chapter("vol2:compute_infrastructure")
```
