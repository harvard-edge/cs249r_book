...
\noindent
![](images/png/cover_compute_infrastructure_blueprint.png){fig-alt="Layered compute infrastructure cutaway from accelerator chip and HBM to server nodes, racks, power delivery, and cooling loops."}
