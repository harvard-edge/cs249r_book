...
class MemoryBandwidthCacheRecap:
    ...
    h100_mem_gb_str = fmt_qty(Hardware.Cloud.H100.memory.capacity, GiB, precision=0, commas=False, unit_label="GB")
    h100_bw_tb_s_str = fmt_qty(Hardware.Cloud.H100.memory.bandwidth, TB/second, precision=2, commas=False)
```
...
class RackPowerTdpRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    rack_power_kw_str = fmt_qty(Hardware.Cloud.H100.tdp * Systems.Nodes.DGX_H100.accelerators_per_node * 4 + 10.3 * kilowatt, kilowatt, precision=1, commas=False)
```
...
class GpuEfficiencyTrajectoryRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    v100_ef_tflops_per_w_str = fmt_qty(Hardware.Cloud.V100.compute.peak_flops / Hardware.Cloud.V100.tdp, TFLOPs / second / watt, precision=2, commas=False, unit_label="TFLOP/s")
    a100_ef_tflops_per_w_str = fmt_qty(Hardware.Cloud.A100.compute.peak_flops / Hardware.Cloud.A100.tdp, TFLOPs / second / watt, precision=2, commas=False, unit_label="TFLOP/s")
    h100_ef_tflops_per_w_str = fmt_qty(Hardware.Cloud.H100.compute.precision_flops["fp8"] / Hardware.Cloud.H100.tdp, TFLOPs / second / watt, precision=2, commas=False, unit_label="TFLOP/s")
    b200_ef_tflops_per_w_str = fmt_qty(Hardware.Cloud.B200.compute.precision_flops["fp8"] / Hardware.Cloud.B200.tdp, TFLOPs / second / watt, precision=2, commas=False, unit_label="TFLOP/s")
```
...
class InfraFrontierNodeBudgetRecap:
    ...
    gpu_hbm_gb_str = fmt_qty(gpu_hbm, GiB, precision=0, commas=False, unit_label="GB")
    node_hbm_gb_str = fmt_qty(node_hbm, GiB, precision=0, commas=False, unit_label="GB")
```
...
class NodeCapacityDenseRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    node_hbm_cap_gb_str = fmt_qty(Hardware.Cloud.H100.memory.capacity * Systems.Nodes.DGX_H100.accelerators_per_node, GiB, precision=0, commas=False, unit_label="GB")
...
class NodeCapacityTrainMemRecap:
    ...
    host_dram = 2 * TB  # scenario assumption: DGX H100 host DDR5 capacity
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    node_hbm_cap_gb_str = fmt_qty(node_hbm, GiB, precision=0, commas=False, unit_label="GB")
...
class InfraFrontierNodeModelRecap:
    ...
    h100_mem_gb_str = fmt_qty(h100_mem, GiB, precision=0, commas=False, unit_label="GB")
    total_hbm_gb_str = fmt_qty(h100_mem * node_gpus, GiB, precision=0, commas=False, unit_label="GB")
...
class InfraIbBwRackRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    ib_bw_gbps_str = fmt_qty(Systems.Fabrics.InfiniBand_NDR.bandwidth, Gbps, precision=0, commas=False, unit_label="Gb/s")
```
...
class A100FallaciesRecap:
    ...
    option_b_hbm_gb_str = fmt_qty(option_b_hbm, GiB, precision=0, commas=False, unit_label="GB")
