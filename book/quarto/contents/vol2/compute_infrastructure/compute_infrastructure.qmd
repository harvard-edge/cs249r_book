...
The roofline diagnostic becomes most valuable when a proposed upgrade changes the wrong ceiling. A team is serving a 13B-parameter model at batch size 1 on an H100 and observing 25 ms per token. The profile shows low tensor-core utilization during decode.
