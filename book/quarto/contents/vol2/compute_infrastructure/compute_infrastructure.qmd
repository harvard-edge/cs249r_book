...
This thermal ceiling is what forces the rack from air to liquid: above the air-cooling threshold the only way to remove the heat is to put a far denser coolant in direct contact with the silicon, which is why high-density AI racks are liquid-cooled by physical necessity rather than by choice. The cooling architectures that meet this requirement, the air-versus-liquid efficiency comparison, and the facility-power overhead the choice carries every hour the cluster runs are the subject of @sec-sustainable-ai-cooling.
