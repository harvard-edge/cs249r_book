...
class BuildBuyTcoThreshold:
    ...
    cloud_h100_hourly_usd_str = fmt_usd(cloud_h100_hourly, precision=2, commas=False, per="GPU-hour")
...
class EmergingInfrastructureRecap:
    ...
    cxl_vs_hbm_gap_mult_str = fmt_multiple(cxl_vs_hbm_gap.to_base_units().magnitude, precision=0, commas=False)
...
A common fallacy is this: *More GPUs always means faster training.*
...
A recurring pitfall is this: *Planning training throughput from peak FLOP/s alone.*
...
A common fallacy is this: *Power and cooling constraints can be handled after accelerator purchase.*
...
A recurring pitfall is this: *Buying a newer accelerator without checking the workload's arithmetic intensity.*
...
A common fallacy is this: *Air cooling is sufficient for AI workloads.*
...
A recurring pitfall is this: *Rejecting liquid cooling on budget grounds without modeling operating cost.*
...
A common fallacy is this: *All GPU-hours are equivalent in TCO analysis.*
...
A recurring pitfall is this: *Upgrading the network before identifying the training bottleneck.*
...
A common fallacy is this: *Average power draw is sufficient for cooling design.*
...
A recurring pitfall is this: *Selecting models by HBM capacity without checking bandwidth.*
...
A common fallacy is this: *Data loading can be fixed after deployment.*
...
A recurring pitfall is this: *Buying homogeneous clusters without modeling workload diversity.*
...
A common fallacy is this: *The last mile is a minor installation detail.*
...
A recurring pitfall is this: *Treating commissioning and burn-in as schedule slack.*
