...
The serving tax quantified above consumes a fraction of the latency budget per request. But the true economic impact of inference emerges when we consider cost over a model's entire operational lifetime.
...
To make this cost dominance concrete, consider a worked example that reveals the *serving cost multiplier* in practice.
