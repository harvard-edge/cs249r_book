...
The 6.9x speedup (vs theoretical 8x) reflects communication overhead. With `{python} nvlink_h100_gbs` GB/s NVLink bandwidth, each 8MB activation all-reduce takes ~0.3ms.
