...
A common fallacy is this: *Inference at scale is synonymous with LLM serving.*
...
A recurring pitfall is this: *Using training infrastructure for production serving.*
...
A common fallacy is this: *Continuous batching solves the whole LLM serving problem.*
...
A recurring pitfall is this: *Sizing the fleet by average throughput.*
...
A common fallacy is this: *Load balancing does not matter much for inference.*
...
A recurring pitfall is this: *Ignoring the serving tax.*
...
A common fallacy is this: *More GPU memory always means larger batch size and higher throughput.*
...
A recurring pitfall is this: *Neglecting multi-tenancy isolation until production.*
