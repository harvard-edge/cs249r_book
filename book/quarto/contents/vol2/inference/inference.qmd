...
# │ Exports: lifetime_queries_str, serving_cost_total_str, training_cost_total_str,
# │          leverage_ratio_str, qps_str, serve_duration_days_str,
# │          cost_per_million_str
# └─────────────────────────────────────────────────────────────────────────────
...
class InferenceEconomics:
    ...
    lifetime_queries_val = qps * SEC_PER_DAY.m_as('second') * serve_duration_days
...
$$ Q_{total} = `{python} qps_str` \text{/s} \times 86,400 \text{ s/day} \times `{python} serve_duration_days_str` \text{ days} \approx \mathbf{`{python} lifetime_queries_str` \text{ queries}} $$

**Total Serving Cost**
$$ C_{serve\_total} = `{python} lifetime_queries_str` \times \$10^{-5} = \mathbf{`{python} serving_cost_total_str`} $$
