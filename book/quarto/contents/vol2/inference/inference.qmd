...
- [ ] For a 7B model serving 2,048-token contexts, estimate the KV-cache memory per request and roughly how many concurrent requests fit in 40 GB of free HBM, and why that capacity, not compute, usually caps the achievable batch size.
