...
Single-machine model serving establishes foundational principles that this chapter extends to distributed systems. Volume I covered single-machine inference optimization—batching, caching, model optimization, and hardware acceleration (@sec-serving). This chapter addresses when those techniques reach their limits and distributed approaches become necessary.
