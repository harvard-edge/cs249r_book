...
::: {.callout-example title="Worked Example: Dynamic Batching for ResNet-50 at Scale"}
...
::: {.callout-example title="Worked Example: Recommendation System Batching at Meta Scale"}
...
::: {.callout-example title="Worked Example: Tensor Parallelism for Llama-70B"}
...
::: {.callout-example title="Worked Example: Heterogeneous GPU Cluster"}
