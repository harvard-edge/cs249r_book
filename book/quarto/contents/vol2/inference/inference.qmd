...
class InferenceSetup:
    ...
    h100_mem_gb_val = mem_h100.m_as(GB)
...
class FinalSummaryHardware:
    ...
    # ┌── 2. EXECUTE (The Compute) ────────────────────────────────────────
    h100_mem_gb_val = h100_mem.m_as(GB)
    h100_bw_tbs_val = h100_bw.m_as(TB / second)

    # ┌── 3. GUARD (Invariants) ──────────────────────────────────────────
    from mlsysim.fmt import check
    check(h100_mem_gb_val > 80, "H100 memory capacity should be > 80GB")
