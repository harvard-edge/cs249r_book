...
*Shows speculative decoding speedup depending on acceptance rate.*
:::
...
*Shows MoE's capacity-versus-bandwidth trade-off: all experts resident, few active per token.*
:::
...
*Shows two-choice routing collapsing tail imbalance relative to random placement.*
:::
...
*Shows one tenant's burst consuming shared KV capacity and degrading others.*
:::
