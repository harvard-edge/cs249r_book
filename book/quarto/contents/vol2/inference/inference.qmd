...
\noindent
![](images/png/cover_inference_blueprint.png){fig-alt="Global inference blueprint where requests route through regional gateways, batching systems, cache pages, model shards, and fleet serving workers."}
...
1. **Output lengths are unpredictable**: User queries span short completions through long, document-grounded responses
