...
::: {.column-margin}
![](images/svg/vol2_inference_margin_003.svg){width="100%" fig-alt="Random-assignment tail curve versus two-choices curve."}
...
::: {.column-margin}
![](images/svg/vol2_inference_margin_004.svg){width="100%" fig-alt="One bursting tenant propagates SLO impact through a shared pool."}
