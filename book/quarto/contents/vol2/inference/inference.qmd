...
Benefit formula Let $\text{CV} = \sigma / \mu$ be the coefficient of variation of output lengths. The throughput improvement from continuous batching over traditional batching is:
