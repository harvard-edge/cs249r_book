...
**Batch accumulation window**\index{Batching!batch, accumulation window}: `{python} RecsysLatencyBreakdown.accumulation_window_ms_str`
**Batch size**: `{python} RecsysLatencyBreakdown.requests_per_batch_str` (at `{python} RecsysLatencyBreakdown.platform_qps_str`)
**Lookups per shard per batch**: `{python} RecsysLatencyBreakdown.lookups_per_shard_per_batch_k_str`
