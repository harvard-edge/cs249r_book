...
::: {.column-margin}
![](images/png/inference_kv_cache_ladder.png){width="100%" fig-alt="Three stacked blue bars on a log scale spanning six orders of magnitude, with a red ceiling line at the top. Bottom bar: token 0.33 MB. Middle bar: 128K request 43 GB. Top bar: HBM 480 GB, the available memory budget marked by the red limit line."}
:::
