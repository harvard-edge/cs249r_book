...
class Mixtral8x7BSpec:
    ...
    total_params_b_str = fmt_params(_model.parameters, scale="B", precision=0, commas=False)
    active_params_b_str = fmt_params(_model.active_parameters, scale="B", precision=0, commas=False)
