...
# │
# │ Imports: MLSysIM Hardware registry and fmt helpers
...
from mlsysim.fmt import MarkdownStr, check, fmt_int, fmt_percent, fmt_rate
...
class HeterogeneousGpuCluster:
    ...
    n_h100 = 10
    n_a100 = 20
    h100_cap_qps = 1000   # scenario assumption: workload-specific QPS per H100 server
    a100_cap_qps = 600    # scenario assumption: workload-specific QPS per A100 server
    target_qps = 15000    # scenario assumption: total incoming traffic
...
**Scenario**: A serving cluster mixes `{python} HeterogeneousGpuCluster.n_h100_str` `{python} HeterogeneousGpuCluster.h100_name_str` GPUs at `{python} HeterogeneousGpuCluster.h100_cap_qps_str` each and `{python} HeterogeneousGpuCluster.n_a100_str` `{python} HeterogeneousGpuCluster.a100_name_str` GPUs at `{python} HeterogeneousGpuCluster.a100_cap_qps_str` each, for total capacity of `{python} HeterogeneousGpuCluster.total_cap_qps_str`.\index{Target Traffic}
