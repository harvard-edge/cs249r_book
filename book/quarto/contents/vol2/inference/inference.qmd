...
\begin{tikzpicture}[font=\small\sffamily, scale=0.9, transform shape]
  ...
  % Isolation Barrier
  \draw[dashed, ultra thick, black!50] (-0.5, 2.0) -- (5.5, 2.0);
  \node[fill=white, inner sep=2pt, font=\scriptsize\sffamily, align=center] at (8.0, 2.0) {\textbf{Complete Isolation}\\No Shared Resources};
