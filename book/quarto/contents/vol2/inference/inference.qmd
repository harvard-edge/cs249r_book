...
\noindent
![](images/png/cover_inference_blueprint_print.png){fig-alt="Global inference blueprint where requests route through regional gateways, batching systems, cache pages, model shards, and fleet serving workers."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_inference_blueprint.webp){fig-alt="Global inference blueprint where requests route through regional gateways, batching systems, cache pages, model shards, and fleet serving workers."}
:::
