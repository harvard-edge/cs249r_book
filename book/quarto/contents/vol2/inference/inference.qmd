...
**Systems conclusion**: Serving costs **9$\times$** more than training in just the first year. A 10 percent optimization in inference latency saves **\$1.8M**—paying for the entire training run almost immediately.
