...
Tenant 3 bursts to `{python} NoisyNeighborQuotaScenario.tenant_burst_qps_str` (5$\times$ baseline). @Tbl-inference-noisy-neighbor-no-isolation records how the burst cascades into SLO violations for all ten tenants on the shared pool:
