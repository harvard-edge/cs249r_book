...
**The Invariant**: Achieving intrinsic adversarial robustness requires training on perturbations, which demands approximately 8$\times$--10$\times$ more compute per epoch than standard optimization.
