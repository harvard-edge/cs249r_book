...
**The invariant**: Achieving intrinsic adversarial robustness requires training on perturbations, which demands approximately 8--10$\times$ more compute per epoch than standard optimization.
...
**The implication**: Making models 10$\times$ more efficient will likely lead to 100$\times$ more usage, not 10$\times$ energy savings. Sustainability strategies must focus on **absolute limits** (carbon budgets, renewable sourcing) rather than just rate efficiency (FLOPS per watt).
:::
