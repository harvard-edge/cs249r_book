...
::: {#nte-fairness-impossibility .callout-note icon=false title="The Fairness Impossibility Law"}
...
::: {#nte-sociotechnical-feedback .callout-note icon=false title="The Sociotechnical Feedback Invariant"}
...
::: {#nte-offline-first .callout-note icon=false title="The Offline-First Design Invariant"}
**The Principle**: In resource-constrained deployments (AI for Good), connectivity is an intermittent enhancement, not a reliable dependency.
