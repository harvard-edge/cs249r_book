...
**Invariant**: Irreversible computation and data movement dissipate electrical energy as heat; at datacenter scale, the practical limit is the rate at which that heat can be removed.
...
These invariants establish the Fleet as a first-class engineering object. Part I builds this machine from the ground up: from the silicon of the accelerators, through the fabrics that connect them, to the storage systems that feed them. Together, they form the foundation for the **Lighthouse Archetypes** (@sec-vol2-introduction-archetypes) that we will track throughout this volume.
