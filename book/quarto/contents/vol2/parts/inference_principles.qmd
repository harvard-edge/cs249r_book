...
::: {#nte-autoregressive-bottleneck .callout-note icon=false title="The Autoregressive Bottleneck"}
...
::: {#nte-serving-cost-dominance .callout-note icon=false title="The Serving Cost Dominance Law"}
...
::: {#nte-power-two-choices .callout-note icon=false title="The Power of Two Choices (P2C)"}
