...
::: {#nte-thermodynamic-limit .callout-note icon=false title="The Thermodynamic Limit"}
...
::: {#nte-power-density-wall .callout-note icon=false title="The Power Density Wall"}
...
::: {#nte-memory-capacity-gap .callout-note icon=false title="The Memory Capacity Gap"}
...
::: {#nte-bisection-bandwidth .callout-note icon=false title="The Bisection Bandwidth Theorem"}
