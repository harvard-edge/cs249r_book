...
2.  **Communication (@sec-communication)**: The "Gradient Bus" (InfiniBand, RoCE) that connects the fleet.
3.  **Storage (@sec-storage)**: The data hierarchy (NVMe to Object Store) that feeds the beast.
4.  **Orchestration (@sec-orchestration)**: The "Brain" that manages resources and scheduling.
