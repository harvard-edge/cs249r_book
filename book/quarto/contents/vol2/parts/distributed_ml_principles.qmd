...
**The Implication**: Small messages — for example, mixture-of-experts (MoE) routing and pipeline bubbles — are **latency-bound**; large messages (e.g., gradients) are **bandwidth-bound**. Optimization strategies must match the regime: fuse small messages to amortize $\alpha$, compress large messages to improve $\beta$.
:::
