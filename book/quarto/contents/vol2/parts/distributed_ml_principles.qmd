...
**The Implication**: Scaling is a race between parallelizable compute (which shrinks with $N$) and communication overhead (which grows or stays constant). To scale efficiently, algorithms must minimize $T_{comm}$ or maximize $T_{overlap}$ (e.g., through **Gradient Accumulation** or **Communication Hiding**).
:::
