...
Coordinating the **Fleet** requires solving problems the single machine does not. These principles govern the physics of distributed learning—why adding more GPUs does not always yield linear speedups, and why communication is often the hidden bottleneck.
...
Part I built the physical fleet. Part II establishes how we make it compute:
