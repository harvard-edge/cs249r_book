...
**Invariant**: The time to complete one training step across $N$ workers or accelerators is the sum of parallelizable computation, communication, synchronization, and the overlapped portion that can be hidden, with $0 \le T_{\text{overlap}} \le T_{\text{comm}}(N) + T_{\text{sync}}(N)$.
