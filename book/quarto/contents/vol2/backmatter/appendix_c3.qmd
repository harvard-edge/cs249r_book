...
| **Communication ($C_2$)** | Network bandwidth ($BW_{net}$)                        | High AllReduce time, low scaling efficiency, communication > 30 percent of step      | Scaling efficiency ($\eta$), communication fraction ($T_{\text{comm}}/T_{\text{step}}$) | Gradient compression, overlap compute/communication, topology optimization (@sec-collective-communication) |
