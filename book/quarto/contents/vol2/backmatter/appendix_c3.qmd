...
class C3CaseStudies:
    ...
    case3_failure_interval_hours_str = fmt(case3_failure_interval_hours, precision=0, commas=False, suffix=" hours")
...
class C3SummaryRecap:
    ...
    mfu_high_str = fmt(Literature.Training.MfuHigh * 100, precision=0, commas=False, suffix="%")
    eff_256_str = fmt(Literature.Scaling.Eff256Gpu * 100, precision=0, commas=False, suffix="%")
    fleet_gpu_count_str = fmt(fleet_gpu_count, precision=0, commas=True, suffix=" GPUs")
```
