...
class C3EffectiveFlops:
    h100_tflops = Hardware.Cloud.H100.compute.peak_flops.to(TFLOPs/second).magnitude
    n_gpus_eff = 100_000
    ...
    # ┌── 4. OUTPUT (Formatting) ───────────────────────────
    peak_pflops_str = fmt_qty(n_gpus_eff * Hardware.Cloud.H100.compute.peak_flops, PFLOPs/second, precision=0, commas=True, unit_label="PFLOP/s")
