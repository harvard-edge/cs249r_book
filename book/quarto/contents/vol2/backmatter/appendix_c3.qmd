...
class C3CaseStudies:
    ...
    case1_mfu_pct_str = fmt_percent(case1_mfu, precision=0, commas=False, style='symbol')
    case1_target_mfu_pct_str = fmt_percent(Literature.Training.MfuHigh, precision=0, commas=False, style='symbol')
    case1_target_gain_str = fmt(Literature.Training.MfuHigh / case1_mfu, precision=1, commas=False)
    case1_wasted_pct_str = fmt_percent(case1_wasted_pct/100, precision=0, commas=False, style='symbol')
    ...
    case2_scaling_efficiency_pct_str = fmt_percent(case2_scaling_efficiency, precision=0, commas=False, style='symbol')
    case2_mfu_pct_str = fmt_percent(case2_mfu, precision=0, commas=False, style='symbol')
    case2_comm_pct_str = fmt_percent(case2_comm_fraction, precision=0, commas=False, style='symbol')
    case2_compute_pct_str = fmt_percent(case2_compute_fraction, precision=0, commas=False, style='symbol')
    ...
    case3_mfu_pct_str = fmt_percent(case3_mfu, precision=0, commas=False, style='symbol')
    case3_comm_pct_str = fmt_percent(case3_comm_fraction, precision=0, commas=False, style='symbol')
    case3_goodput_pct_str = fmt_percent(case3_goodput_ratio, precision=0, commas=False, style='symbol')
    case3_coord_pct_str = fmt_percent(case3_coord_fraction, precision=0, commas=False, style='symbol')
    case3_oh_scheduler_pct_str = fmt_percent(case3_oh_scheduler_pct, precision=0, commas=False, style='symbol')
    oh_pipeline_str = fmt_percent(Ops.TrainingRunOverheads.PipelineBubble, precision=0, commas=False, style='symbol')
    oh_checkpoint_str = fmt_percent(Ops.TrainingRunOverheads.Checkpoint, precision=0, commas=False, style='symbol')
    oh_failure_str = fmt_percent(Ops.TrainingRunOverheads.FailureRecovery, precision=0, commas=False, style='symbol')
    oh_maintenance_str = fmt_percent(Ops.TrainingRunOverheads.Maintenance, precision=0, commas=False, style='symbol')
```
...
class C3Scorecard:
    ...
    mfu_low_str = fmt_percent(Literature.Training.MfuLow, precision=0, commas=False, style='symbol')
    mfu_high_str = fmt_percent(Literature.Training.MfuHigh, precision=0, commas=False, style='symbol')
    eff_256_str = fmt_percent(Scenarios.TrainingScaleProfiles.Eff256Gpu, precision=0, commas=False, style='symbol')
    eff_8192_str = fmt_percent(Scenarios.TrainingScaleProfiles.Eff8192Gpu, precision=0, commas=False, style='symbol')
```
...
class C3EffectiveFlops:
    ...
    goodput_all = 1.0 - (
        Ops.TrainingRunOverheads.PipelineBubble + Ops.TrainingRunOverheads.Checkpoint
        + Ops.TrainingRunOverheads.FailureRecovery + Ops.TrainingRunOverheads.Maintenance + 0.17
    )
    effective_flops = calc_effective_flops(
        peak_flops, Literature.Training.MfuHigh, Scenarios.TrainingScaleProfiles.Eff8192Gpu, goodput_all
    )
    c3_tax = (peak_flops / effective_flops).to("").magnitude
    eff_fraction = (effective_flops / peak_flops).to("").magnitude

    # ┌── 4. OUTPUT (Formatting) ───────────────────────────
    peak_pflops_str = fmt_flop_rate(peak_flops, unit=PFLOPs/second, precision=0, commas=True)
    effective_pflops_str = fmt_flop_rate(effective_flops, unit=PFLOPs/second, precision=1, commas=False)
    eff_fraction_pct_str = fmt_percent(eff_fraction, precision=1, commas=False, style='symbol')
    ...
    scaling_pct_str = fmt_percent(Scenarios.TrainingScaleProfiles.Eff8192Gpu, precision=0, commas=False, style='symbol')
    goodput_pct_str = fmt_percent(goodput_all, precision=0, commas=False, style='symbol')
    ...
    _scaling_fmt = fmt(Scenarios.TrainingScaleProfiles.Eff8192Gpu, precision=2, commas=False)
