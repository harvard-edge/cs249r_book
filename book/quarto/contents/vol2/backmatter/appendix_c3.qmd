...
class C3CaseStudies:
    ...
    case1_target_gain_str = fmt_multiple(Literature.Training.MfuHigh / case1_mfu, precision=1, commas=False)
    ...
    case2_observed_speedup_str = fmt_multiple(case2_observed_speedup, precision=0, commas=False)
    case2_ideal_speedup_str = fmt_multiple(case2_ideal_speedup, precision=0, commas=False)
    ...
    case2_speedup_str = fmt_multiple(case2_speedup_if_fixed, precision=1, commas=False)
...
class C3EffectiveFlops:
    ...
    effective_flops = calc_effective_flops(
        peak_flops, Literature.Training.MfuHigh, ReferenceStats.TrainingScaleProfiles.Eff8192Gpu, goodput_all
    )
    ...
    c3_tax_str = fmt_multiple(c3_tax, precision=1, commas=False)
    mfu_pct_str = fmt_percent(Literature.Training.MfuHigh, precision=0, commas=False, style='symbol')
    scaling_pct_str = fmt_percent(ReferenceStats.TrainingScaleProfiles.Eff8192Gpu, precision=0, commas=False, style='symbol')
    ...
    _scaling_fmt = fmt(ReferenceStats.TrainingScaleProfiles.Eff8192Gpu, precision=2, commas=False)
