...
class C3CaseStudies:
    ...
    oh_pipeline_str = fmt_percent(Literature.Overheads.PipelineBubble, precision=0, commas=False, style='symbol')
    oh_checkpoint_str = fmt_percent(Literature.Overheads.Checkpoint, precision=0, commas=False, style='symbol')
    oh_failure_str = fmt_percent(Literature.Overheads.FailureRecovery, precision=0, commas=False, style='symbol')
    oh_maintenance_str = fmt_percent(Literature.Overheads.Maintenance, precision=0, commas=False, style='symbol')
```
...
class C3Scorecard:
    ...
    mfu_low_str = fmt_percent(Literature.Training.MfuLow, precision=0, commas=False, style='symbol')
    mfu_high_str = fmt_percent(Literature.Training.MfuHigh, precision=0, commas=False, style='symbol')
    eff_256_str = fmt_percent(Literature.Scaling.Eff256Gpu, precision=0, commas=False, style='symbol')
    eff_8192_str = fmt_percent(Literature.Scaling.Eff8192Gpu, precision=0, commas=False, style='symbol')
```
...
class C3EffectiveFlops:
    ...
    scaling_pct_str = fmt_percent(Literature.Scaling.Eff8192Gpu, precision=0, commas=False, style='symbol')
