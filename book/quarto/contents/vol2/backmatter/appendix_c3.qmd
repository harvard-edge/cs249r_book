...
class C3CaseStudies:
    ...
    case1_wasted_pct_str = fmt_percent(case1_wasted_pct / 100, precision=0, commas=False, style='prose')
    ...
    case2_mfu_pct_str = fmt_percent(case2_compute_phase_mfu, precision=0, commas=False, style='prose')
...
class C3EffectiveFlops:
    ...
    scaling_pct_str = fmt_percent(ReferenceStats.TrainingScaleProfiles.Eff8192Gpu, precision=0, commas=False, style='prose')
    goodput_pct_str = fmt_percent(goodput_all, precision=0, commas=False, style='prose')
