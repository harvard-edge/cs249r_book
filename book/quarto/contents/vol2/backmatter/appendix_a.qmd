# Appendix A: Foundations of ML Systems {#sec-appendix-foundations-ml-systems}

This appendix provides a primer on the single-node machine learning systems concepts that form the building blocks for the distributed systems discussed in this volume. For a comprehensive treatment of these foundations, readers should refer to foundational ML systems literature.

## The Machine Learning Lifecycle {#sec-appendix-foundations-ml-systems-machine-learning-lifecycle-b728}
...
## Hardware Foundations {#sec-appendix-foundations-ml-systems-hardware-foundations-6892}

### The Unit of Compute {#sec-appendix-foundations-ml-systems-unit-compute-a7a8}
...
### The Memory Hierarchy {#sec-appendix-foundations-ml-systems-memory-hierarchy-eb8d}
...
## Optimization Fundamentals {#sec-appendix-foundations-ml-systems-optimization-fundamentals-ae89}

### The Latency-Throughput Tradeoff {#sec-appendix-foundations-ml-systems-latencythroughput-tradeoff-e18c}
...
### Numerical Precision {#sec-appendix-foundations-ml-systems-numerical-precision-caf6}
...
### Model Compression {#sec-appendix-foundations-ml-systems-model-compression-21b5}
