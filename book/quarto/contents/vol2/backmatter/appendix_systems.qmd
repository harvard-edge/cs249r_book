...
This appendix provides a compact reference for the three paradigms used throughout Volume II—HPC, WSC, and the ML Fleet—and a short recap of Volume I foundations that Volume II builds on.
...
Conventions used here follow the book-wide notation established earlier in the text (see “Notation and Conventions” in Volume I).
