...
: **Intra-Node Interconnect Bandwidth and Latency**: NVLink provides 14--28$\times$ higher bandwidth than PCIe within the same node, which is why tensor parallelism is typically confined to the NVLink domain. These values are defined in the preceding book (@sec-system-assumptions) and reused throughout this book's communication cost models. {#tbl-fleet-intra-node}
