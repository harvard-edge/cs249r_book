...
: **Communication Bandwidth Hierarchy**: Bandwidth drops by `{python} FleetCommNumbers.nvlink_to_ib`$\times$ crossing from intra-node (NVLink) to inter-node (InfiniBand). This ratio determines parallelism placement. {#tbl-fleet-bandwidth-hierarchy}
