...
- **Little's Law** ($N_{req} = \lambda T_{lat}$): Sizes inference infrastructure. At fleet scale, it determines how many serving replicas are needed behind a load balancer.
