...
- **"How often will my cluster fail?"**: Check the scaling physics in @sec-fleet-foundations-scaling-physics for MTBF tables and failure probability calculations.
