...
from mlsysim.core.constants import (
    ...
    GB, second, NS, BILLION, MILLION, THOUSAND,
...
class CommFoundations:
    ...
    ib_ndr_alpha_s = ib_ndr_alpha_us * 1e-6
    ib_ndr_beta_bs = ib_ndr_beta_gbs * 1e9
    crossover_kb_val = (ib_ndr_alpha_s * ib_ndr_beta_bs) / 1e3
    ...
    ring_time_ms = ring_time_s.m_as(ureg.second) * 1000
    tree_time_ms = tree_time_s.m_as(ureg.second) * 1000
    ...
    ring_msg_gb_str = f"{ring_msg_bytes/BILLION:.0f}"
