...
|:--------------------------|:------------------------------|:------------------------------|:------------------------------|:------------------------------|
| **$P$ = 4**               | `{python} CF.bubble_std_pct`% | `{python} CF.bubble_std_pct`% | ---                           | ---                           |
| **$P$ = 8**               | ---                           | `{python} CF.bubble_std_pct`% | `{python} CF.bubble_std_pct`% | `{python} CF.bubble_std_pct`% |

: **Pipeline Bubble Fraction**: Percentage of GPU-time lost to pipeline bubbles for various stage counts and microbatch counts. Values below 20 percent (the typical target) require $M \geq 4P$. Dashes indicate configurations where the ratio is impractical. {#tbl-pipeline-bubble}
