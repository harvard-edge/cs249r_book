...
class LittlesLawVerify:
    ...
    batch_size = 16
    expected_total_latency = GPT3ServingResults.b16_total_ms * ms
    ...
    expected_total_str = fmt_time(expected_total_latency, 'millisecond', precision=1, commas=False)
    expected_total_s_str = fmt(expected_total_latency.to(second).magnitude, precision=4, commas=False)
