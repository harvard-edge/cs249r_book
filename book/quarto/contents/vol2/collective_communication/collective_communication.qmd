...
<!--
  ...
  \draw[ib_link] (g00.east) -- node[midway, above, font=\tiny\usefont{T1}{phv}{m}{n}, text=IBColor] {IB} (g10.west);
  ...
  \node[font=\tiny\usefont{T1}{phv}{m}{n}, text=NVColor] at (0, -2.4) {900 GB/s};
  \node[font=\tiny\usefont{T1}{phv}{m}{n}, text=IBColor] at (3.5, 0.4) {50 GB/s};
  \node[font=\tiny\usefont{T1}{phv}{m}{n}, text=NVColor] at (7, -2.4) {900 GB/s};
