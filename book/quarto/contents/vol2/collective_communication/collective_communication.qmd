...
::: {.column-margin}
![](images/svg/vol2_collective_communication_margin_002.svg){width="100%" fig-alt="Margin illustration showing FSDP per-layer loop: AllGather, layer compute, ReduceScatter."}

*FSDP repeats per layer: gather, compute, reduce-scatter.*
:::
...
::: {.column-margin}
![](images/svg/vol2_collective_communication_margin_003.svg){width="100%" fig-alt="Margin illustration showing Payload shrink across hierarchy levels."}
