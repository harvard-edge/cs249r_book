...
# │
# │ Imports: mlsysim.core.constants (MS_PER_SEC)
...
#| echo: false
from mlsysim.fmt import check
from mlsysim.core.constants import microsecond, second, GB, MB
import math
...
class RingVsTree:
    ...
    crossover_mb = (N * (alpha_us * microsecond) * (beta_gbs * GB / second) / log2N).m_as(MB)
    # ┌── 3. GUARD ─────────────────────────────────────────
...
# │
# │ Imports: mlsysim.core.constants (MB, GB, second, ms)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.core.constants import MB, GB, second, ms
