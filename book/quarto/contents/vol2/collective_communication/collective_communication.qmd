...
::: {.column-margin}
![](images/svg/vol2_collective_communication_margin_001.svg){width="100%" fig-alt="Margin illustration showing AllToAll quadratic connection growth versus AllReduce curve."}

*AllToAll traffic scales worse than AllReduce.*
:::
...
::: {.column-margin}
![](images/svg/vol2_collective_communication_margin_004.svg){width="100%" fig-alt="Margin illustration showing Error-feedback loop with residual carried into next step."}
