...
*   **Archetype B (DLRM at Scale)**[^fn-dlrm-embedding]: Our gradient (or activation) is sparse and targeted. It does not need to meet everyone; it needs to find one specific "Expert" GPU across the datacenter. Its vehicle is the **AlltoAll**.
