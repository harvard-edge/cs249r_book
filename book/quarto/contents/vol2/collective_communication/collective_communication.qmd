...
class CriticalMsgSize:
    ...
    beta_str = fmt(beta_gbs, precision=0, commas=False, suffix=" GB/s")
    n_star_kb_str = fmt(n_star_kb, precision=0, commas=False, suffix=" KB")
```
...
class MoeAllToAll:
    ...
    kb_per_token_str = fmt(kb_per_token, precision=3, commas=False, suffix=" KB")
    tokens_per_expert_str = fmt(tokens_per_expert, precision=0, commas=False)
    data_per_transfer_kb_str = fmt(data_per_transfer_kb, precision=3, commas=False, suffix=" KB")
    total_sent_mb_str = fmt(total_sent_mb, precision=2, commas=False, suffix=" MB")
...
class RingVsTree:
    ...
    crossover_str = fmt(crossover_mb, precision=1, commas=False, suffix=" MB")
    M_mb_str = fmt(M_mb, precision=0, commas=False, suffix=" MB")
