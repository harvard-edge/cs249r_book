...
\noindent
![](images/png/cover_collective_communication_blueprint_print.png){fig-alt="Collective communication topology map where gradient fragments circulate through ring and tree reduction paths before broadcasting synchronized state."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_collective_communication_blueprint.webp){fig-alt="Collective communication topology map where gradient fragments circulate through ring and tree reduction paths before broadcasting synchronized state."}
:::
