...
* **AllToAll exposes the fabric**: Unlike uniform reductions, AllToAll creates destination-specific traffic. Injection bandwidth, bisection capacity, oversubscription, message granularity, and routing skew determine whether expert parallelism and recommendation workloads scale.
