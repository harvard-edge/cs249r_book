...
*Shows AllToAll scaling pressure compared with AllReduce.*
:::
...
*Shows the FSDP per-layer loop: gather, compute, reduce-scatter.*
:::
...
*Shows hierarchical collectives shrinking payload before traffic crosses slower tiers.*
:::
...
*Shows error feedback as residual memory carried into the next compressed gradient step.*
:::
