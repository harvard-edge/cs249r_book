...
Orchestration decisions span multiple layers of the system stack, from physical hardware topology to high-level scheduling policy. Understanding where orchestration fits in this stack clarifies both its responsibilities and its constraints.
