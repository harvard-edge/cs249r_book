...
*   **The Fairness Impossibility Law**: Except in special cases such as perfect prediction or equal base rates, calibrated risk scores generally cannot also equalize error rates across groups. Demographic parity is a separate selection-rate constraint that can introduce additional trade-offs.
...
The Infrastructure Path focuses on the physical fleet and orchestration. Readers should focus on Part I (Compute Infrastructure, Network Fabrics, Data Storage) and Fleet Orchestration. This path builds a deep understanding of the physical and operational substrate.
...
The Production Path covers deployment and operations. After the introduction, readers should move to Inference at Scale, ML Operations at Scale, Edge Intelligence, and the Responsible Fleet chapters. This path covers everything from serving architecture to governance.
...
Whichever path readers choose, this book is one component of a broader learning ecosystem. The complete text, interactive Marimo notebooks, lecture slides, exercises, hands-on labs, and supplementary materials for every chapter are freely available at [mlsysbook.ai](https://mlsysbook.ai).
...
Whichever path readers choose, this book is part of a broader learning ecosystem. The complete text, interactive Marimo notebooks, lecture slides, exercises, hands-on labs, and supplementary materials for every chapter are available online at **mlsysbook.ai**.
