...
To bridge these fields, we adopt notation conventions where standard machine learning conventions take precedence for single-letter symbols, and systems concepts receive subscripts or multi-letter names. The foundational performance equation used in this book is the **Iron Law of ML Systems**:
...
We adopt standard deep learning conventions with explicit disambiguation for systems and distributed variables.
