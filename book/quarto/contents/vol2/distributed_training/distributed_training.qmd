...
class A100CapacityContext:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    a100_mem_gb_str = fmt_memory_capacity(mem_capacity, unit=GB, precision=0, commas=False)
...
class DistTrainNvlinkHybridRecap:
    ...
    hbm_a100_gb_str = fmt_memory_capacity(Hardware.Cloud.A100.memory.capacity, unit=GB, precision=0, commas=False)
    hbm_h100_gb_str = fmt_memory_capacity(Hardware.Cloud.H100.memory.capacity, unit=GB, precision=0, commas=False)
...
class HybridMemoryAccounting:
    ...
    hbm_gb_str = fmt_memory_capacity(Hardware.Cloud.H100.memory.capacity, unit=GB, precision=0, commas=False)
...
class A100CapacityFallacies:
    ...
    a100_mem_gb_str = fmt_memory_capacity(mem, unit=GB, precision=0, commas=False)
    frontier_params_b_str = fmt_params(Models.Language.GPT3.parameters, scale="B", precision=0, commas=False)
```
