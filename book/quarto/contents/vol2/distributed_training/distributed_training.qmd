...
::: {.callout-lighthouse title="Distributed Logic Across the Archetype Spectrum"}
...
::: {#fig-3d-parallelism-cube-summary}
```{.tikz}
...
In **Communication** (@sec-communication-collective-operations), we open the black box of the collective operations (AllReduce, AllToAll) that make this consistency possible. We move from the logic of *what* to send to the mechanics of *how* to route it through rings, trees, and rails.
