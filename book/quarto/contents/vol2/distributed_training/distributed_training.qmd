...
::: {#cs-distributed-training-imagenet-one-hour .callout-case-study title="The one-hour ImageNet run (2017)"}
...
Ultimately, the choice of parallelism is a loop transformation applied by the cluster-level compiler. Matching logical communication patterns to physical hardware hierarchies moves the system from the "linear scaling regime" of small clusters to the "communication-bound" reality of very large accelerator fleets.
