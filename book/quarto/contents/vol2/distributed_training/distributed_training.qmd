...
# Distributed Training Systems {#sec-distributed-training-systems-systems}
...
## Multi-Machine Scaling Fundamentals {#sec-distributed-training-systems-systems-multimachine-scaling-fundamentals-ff96}
...
## Distributed Training Fundamentals {#sec-distributed-training-systems-systems-distributed-training-fundamentals-97da}
...
::: {.callout-perspective title="Distributed Training as Loop Transformations"}
...
[^nvlink]: NVLink provides 600 GB/s bidirectional bandwidth, enabling efficient gradient synchronization within nodes. @sec-compute provides detailed coverage of GPU interconnect architectures, including NVLink topology design and bandwidth optimization strategies.
...
## Distributed Training Efficiency Metrics {#sec-distributed-training-systems-systems-distributed-training-efficiency-metrics-9488}
...
#### Device Forward Pass {#sec-distributed-training-systems-systems-device-forward-pass-d81e}
...
#### Backward Pass and Calculation {#sec-distributed-training-systems-systems-backward-pass-calculation-48b7}
...
The specific algorithms for gradient synchronization—including **Ring AllReduce**, **Tree AllReduce**, and **Hierarchical AllReduce**—are analyzed in depth in @sec-communication-collective-operations. That chapter derives the bandwidth and latency bounds ($2N(D-1)/D$), explains how topology-aware algorithms exploit NVLink vs. InfiniBand, and details the gradient compression techniques used to reduce this overhead.
:::
...
### Data Parallelism Advantages {#sec-distributed-training-systems-systems-data-parallelism-advantages-c48e}
...
### Data Parallelism Limitations {#sec-distributed-training-systems-systems-data-parallelism-limitations-e03a}
...
[^fn-infiniband]: InfiniBand provides 200 Gb/s per port with sub-microsecond latency, enabling efficient gradient synchronization across nodes via RDMA. @sec-compute explores network topology design, including fat-tree and dragonfly architectures that optimize bisection bandwidth for AllReduce communication patterns.
...
::: {.callout-perspective title="Napkin Math: The Memory Wall of Scale"}
...
#### Model Partitioning {#sec-distributed-training-systems-systems-model-partitioning-6fe9}
...
#### Model Forward Pass {#sec-distributed-training-systems-systems-model-forward-pass-5258}
...
#### Backward Pass and Calculation {#sec-distributed-training-systems-systems-backward-pass-calculation-3851}
...
#### Parameter Updates {#sec-distributed-training-systems-systems-parameter-updates-e4db}
...
#### Iterative Process {#sec-distributed-training-systems-systems-iterative-process-028a}
...
### Model Parallelism Advantages {#sec-distributed-training-systems-systems-model-parallelism-advantages-a5ce}
...
### Model Parallelism Limitations {#sec-distributed-training-systems-systems-model-parallelism-limitations-62e2}
...
::: {.callout-perspective title="Optimizing Pipeline Bubble Overhead"}
...
### Hybrid Parallelism Implementation {#sec-distributed-training-systems-systems-hybrid-parallelism-implementation-87cb}
...
#### Model and Data Partitioning {#sec-distributed-training-systems-systems-model-data-partitioning-1967}
...
#### Forward Pass {#sec-distributed-training-systems-systems-forward-pass-e8ae}
...
#### Backward Pass and Gradient Calculation {#sec-distributed-training-systems-systems-backward-pass-gradient-calculation-aaba}
...
#### Parameter Updates {#sec-distributed-training-systems-systems-parameter-updates-51d2}
...
#### Iterative Process {#sec-distributed-training-systems-systems-iterative-process-05df}
...
### Parallelism Variations {#sec-distributed-training-systems-systems-parallelism-variations-ba38}
...
#### Hierarchical Parallelism {#sec-distributed-training-systems-systems-hierarchical-parallelism-9f1b}
...
#### Intra-layer Parallelism {#sec-distributed-training-systems-systems-intralayer-parallelism-4a15}
...
#### Inter-layer Parallelism {#sec-distributed-training-systems-systems-interlayer-parallelism-b646}
...
### Hybrid Parallelism Advantages {#sec-distributed-training-systems-systems-hybrid-parallelism-advantages-9e05}
...
### Hybrid Parallelism Limitations {#sec-distributed-training-systems-systems-hybrid-parallelism-limitations-4827}
...
## Hardware Constraints on Parallelism {#sec-distributed-training-systems-systems-hardware-constraints-parallelism-2a95}
...
Engineers tune hyperparameters on 8-GPU workstations then deploy to 256-GPU clusters expecting identical behavior. In production, convergence patterns change fundamentally with scale. The most critical hyperparameter is learning rate: as @sec-distributed-training-systems-data-parallelism explains, batch size increases proportionally with GPU count in data parallelism, requiring learning rate adjustments. The "linear scaling rule"[^fn-linear-scaling] [@goyal2017accurate] suggests $\eta_{large} = \eta_{base} \times (B_{large}/B_{base})$, but this relationship holds only within bounds.
...
## Summary {#sec-distributed-training-systems-systems-summary-6140}
...
The next chapter, @sec-communication-collective-operations, examines the logical communication patterns and collective operations (AllReduce, AllGather) that coordinate these distributed shards and explores how to optimize the "Communication-Computation Ratio" that governs scaling efficiency.
