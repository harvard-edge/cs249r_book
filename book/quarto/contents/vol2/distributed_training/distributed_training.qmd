...
With $S=2048$, $H=4096$, $B=4$, and FP16: $2 \times 4 \times 2048 \times 4096 \times 2 = 134$ MB per AllReduce per layer. For a 96-layer model with two AllReduce operations per layer, this totals approximately 25.7 GB per training step, requiring NVLink bandwidth to avoid becoming the bottleneck.
