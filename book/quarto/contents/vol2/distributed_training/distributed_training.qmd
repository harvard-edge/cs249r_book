...
class CommScalingMath:
    ...
    exposed_step_s_str = fmt(exposed_step.to(second).magnitude, precision=1, commas=False)
...
class HybridMemoryAccounting:
    ...
    params_b_str = fmt(params.to(param).magnitude / BILLION, precision=0, commas=False)
