...
\noindent
![](images/png/cover_distributed_training_blueprint.png){fig-alt="Isometric distributed training map showing a large workload partitioned across accelerators along data, tensor, and pipeline axes with synchronization paths."}
