...
```{python}
#| echo: false
from mlsysim.fmt import fmt, check, fmt_int, fmt_usd, MarkdownStr
...
class GradAccumScenario:
    ...
    compute_8gpu_ms_str = fmt(compute_8gpu_ms, precision=0, commas=False, suffix=" ms")
    hourly_rate_str = fmt_usd(hourly_rate, precision=0, commas=False, suffix="/hr")
...
class DistTrainA100Memory:
    ...
    n_gpus_zero_str = fmt(n_gpus_zero, precision=0, commas=False, suffix=" GPUs")
...
class CommScalingMath:
    ...
    raw_comm_s_str = fmt(raw_comm_s, precision=0, commas=False, suffix=" seconds")
...
# └─────────────────────────────────────────────────────────────────────────────
import math
from mlsysim.fmt import fmt_int,  check, fmt, MarkdownStr, fmt_percent, fmt_count
...
class ScalingWorkers:
    ...
    n_nodes_64_str = fmt(n_nodes_64, precision=0, commas=False, suffix=" nodes")
