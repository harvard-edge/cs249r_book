...
Before examining the mechanisms of distributed training, we formalize the empirical relationships that justify the investment in scale, known as *scaling laws*.
...
When synchronization performance deviates from theoretical expectations, the Systems Sandwich framework provides a structured approach to isolating the bottleneck.
...
::: {.callout-notebook title="GPT-2 Data Parallel Scaling (1→8→32 GPUs)" collapse="true"}
