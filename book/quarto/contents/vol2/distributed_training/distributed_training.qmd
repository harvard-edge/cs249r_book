...
\noindent
![](images/png/cover_distributed_training_blueprint_print.png){fig-alt="Isometric distributed training map showing a large workload partitioned across accelerators along data, tensor, and pipeline axes with synchronization paths."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_distributed_training_blueprint.webp){fig-alt="Isometric distributed training map showing a large workload partitioned across accelerators along data, tensor, and pipeline axes with synchronization paths."}
:::
