...
: **Convergence Properties by Synchronization Model**: The synchronization protocol determines the delay model; the convergence rate follows only after the objective, gradient, delay, and step-size assumptions are fixed. {#tbl-convergence-comparison tbl-colwidths="[12,11,19,21,37]"}
