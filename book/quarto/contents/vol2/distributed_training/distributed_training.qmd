...
*Shows the communication-computation ratio threshold where scaling stops behaving ideally.*
:::
...
*Shows an AllReduce barrier turning one missing worker into a job-wide stall.*
:::
...
*Shows communication energy rising with physical distance from HBM to network.*
:::
...
*Shows why tensor parallelism wants NVLink-class bandwidth while pipeline parallelism can tolerate slower fabric.*
:::
