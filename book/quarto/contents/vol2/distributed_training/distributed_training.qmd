...
# │ Exports: (none)
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt_percent, fmt, fmt_qty, fmt_qty_int, check
```
...
::: {.column-margin}
![](images/svg/vol2_distributed_training_margin_001.svg){width="100%" fig-alt="Margin illustration showing Communication-computation ratio threshold at rho = 1."}
...
::: {.column-margin}
![](images/svg/vol2_distributed_training_margin_002.svg){width="100%" fig-alt="Margin illustration showing Missing worker blocks peers at all-reduce barrier."}
...
from mlsysim.fmt import fmt, check, fmt_int, fmt_qty_int
...
::: {.column-margin}
![](images/svg/vol2_distributed_training_margin_003.svg){width="100%" fig-alt="Margin illustration showing HBM, NVLink, and InfiniBand energy per bit."}
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, check, MarkdownStr, fmt_memory
from mlsysim.physics import memory_from_params
class A100CapacityContext:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    a100_mem_gb_str = fmt_qty(mem_capacity, GiB, precision=0, commas=False, unit_label="GB")
...
::: {.column-margin}
![](images/svg/vol2_distributed_training_margin_004.svg){width="100%" fig-alt="Margin illustration showing NVLink bandwidth versus NDR InfiniBand bandwidth."}
...
class DistTrainNvlinkHybridRecap:
    ...
    hbm_a100_gb_str = fmt_qty(Hardware.Cloud.A100.memory.capacity, GiB, precision=0, commas=False, unit_label="GB")
    hbm_h100_gb_str = fmt_qty(Hardware.Cloud.H100.memory.capacity, GiB, precision=0, commas=False, unit_label="GB")
...
class HybridMemoryAccounting:
    ...
    hbm_gb_str = fmt_qty(Hardware.Cloud.H100.memory.capacity, GiB, precision=0, commas=False, unit_label="GB")
...
from mlsysim.fmt import fmt_percent, fmt, check, MarkdownStr, fmt_qty
...
class A100CapacityFallacies:
    ...
    a100_mem_gb_str = fmt_qty(mem, GiB, precision=0, commas=False, unit_label="GB")
    frontier_params_b_str = fmt(params_b, precision=0)
```
