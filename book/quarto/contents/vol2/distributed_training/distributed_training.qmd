...
class DistTrainReliabilityFacts:
    ...
    gpt4_mem_tb_str = fmt_qty((Models.Language.GPT4.parameters.m_as('param') * 2 / TRILLION) * TB, TB, precision=1, commas=False)
...
class HierarchicalAllReduceDebug:
    ...
    flat_single_link_ms_str = fmt_time((tensor_bytes.m_as(GB) / ib_hdr_bw.m_as(GB/second)) * THOUSAND, 'millisecond', precision=0, commas=False)
