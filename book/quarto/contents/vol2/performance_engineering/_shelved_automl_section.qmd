...
[^fn-bayesian-optimization]: **Bayesian Optimization**: Achieves 10$\times$--50$\times$ sample efficiency vs. random search using Gaussian processes to model objective uncertainty. Optuna and Ray Tune provide production-ready implementations.

Modern platforms (Google AutoML, Amazon SageMaker Autopilot, Microsoft Azure AutoML) integrate these capabilities into end-to-end pipelines [@he2021automl].
