...
$$
I = \frac{`{python} RooflineDiagnostic.flops_B_str` \times 10^9 \text{ FLOP}}{`{python} RooflineDiagnostic.weight_gb_str` \times 10^9 \text{ bytes}} = `{python} RooflineDiagnostic.ai_str` \text{ FLOP/byte}
$$
...
$$
t_{\text{decode}} = \frac{`{python} RooflineDiagnostic.weight_gb_str` \text{ GB}}{3.35 \text{ TB/s}} \approx `{python} RooflineDiagnostic.decode_ms_str` \text{ ms per token}
$$
...
# │
# │ Imports: (none — uses inline constants), mlsysim.book (check)
...
# │
# │ Imports: mlsysim.core.constants (BILLION, TRILLION, H100_FLOPS_FP16_TENSOR)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.core.constants import BILLION, TRILLION, H100_FLOPS_FP16_TENSOR, second, TFLOPs
from mlsysim.fmt import fmt, check
