...
::: {.column-margin}
![](images/png/performance_engineering_iron_law_bars.png){width="100%" fig-alt="Iron-law bar split into three segments, Data, Compute, and Latency. The Data segment is the widest and shaded; Compute and Latency are narrow and gray."}
