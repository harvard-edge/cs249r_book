...
# │          TFLOPs, TB, GiB, second, flop, byte)
...
class FleetEfficiencyCalc:
    ...
    local_mfu = local_flops_per_step / (8 * r_peak_per_gpu * (t_local_step_ms / 1000))
    global_mfu = fleet_flops_per_step / (n_gpus * r_peak_per_gpu * (t_fleet_step_ms / 1000))
