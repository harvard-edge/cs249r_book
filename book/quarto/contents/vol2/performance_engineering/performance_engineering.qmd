...
class KVCacheAnalysis:
    ...
    # FP16 case: 45 GB available for KV
    ...
    # Wait, the callout text says "available for KV cache: 80 - 35 = 45 GB/GPU"
    # and "KV cache per request: 1.1 GB / 4 GPUs = 0.27 GB/GPU".
    # Max batch = 45 / 0.27 = 166.
