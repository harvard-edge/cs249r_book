...
class MemoryWallScenario:
    ...
    # ┌── 3. GUARD (Invariants) ──────────────────────────────────────────
    from mlsysim.fmt import check, fmt_time, fmt_qty, fmt_qty_int, fmt_multiple
    ...
    energy_ratio_str = fmt_multiple(energy_ratio, precision=0, commas=False)
...
class RooflineDiagnostic:
    ...
    ai_str = fmt_arithmetic_intensity(arith_intensity, unit=flop/byte, precision=0, commas=False)
