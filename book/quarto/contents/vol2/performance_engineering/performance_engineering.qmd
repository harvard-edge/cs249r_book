...
A critical enabler for large batch sizes is **paged KV cache management**[^fn-paged-attention-os], introduced by vLLM [@kwon2023]. Traditional KV cache implementations pre-allocate contiguous memory for each request's maximum possible sequence length.
