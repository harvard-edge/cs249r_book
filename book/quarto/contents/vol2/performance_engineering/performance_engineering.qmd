...
::: {.column-margin}
![](images/svg/vol2_performance_engineering_margin_001.svg){width="100%" fig-alt="Margin illustration showing Register, SRAM, and HBM access energy."}
...
::: {.column-margin}
![](images/svg/vol2_performance_engineering_margin_002.svg){width="100%" fig-alt="Margin illustration showing Batch-size curve moving from memory-bound side toward ridge."}
...
::: {.column-margin}
![](images/svg/vol2_performance_engineering_margin_003.svg){width="100%" fig-alt="Margin illustration showing Max batch size rises after INT4 weights and INT8 KV cache."}
...
::: {.column-margin}
![](images/svg/vol2_performance_engineering_margin_004.svg){width="100%" fig-alt="Margin illustration showing Local MFU to fleet MFU drop with scaling-tax gap."}
