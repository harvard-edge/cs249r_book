...
\noindent
![](images/png/cover_performance_engineering_blueprint_print.png){fig-alt="Performance engineering workbench where a fleet workload is measured, bottlenecks are diagnosed, and tiling, fusion, memory, and scheduling rewrites improve the path."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_performance_engineering_blueprint.webp){fig-alt="Performance engineering workbench where a fleet workload is measured, bottlenecks are diagnosed, and tiling, fusion, memory, and scheduling rewrites improve the path."}
:::
