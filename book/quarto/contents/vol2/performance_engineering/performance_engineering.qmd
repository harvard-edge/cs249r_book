...
*Shows memory-access energy rising with distance from registers to HBM.*
:::
...
*Shows batch size increasing arithmetic intensity toward the ridge.*
:::
...
*Shows precision engineering increasing feasible batch size through memory savings.*
:::
...
*Shows local MFU eroding into fleet MFU once communication tax appears.*
:::
