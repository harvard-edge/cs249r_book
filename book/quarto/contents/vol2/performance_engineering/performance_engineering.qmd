...
# KV cache size = 2 (K+V) * layers * kv_heads * head_dim * seq_len * bytes
num_layers = 80
...
kv_fp16_gb = kv_cache_bytes / 1e9        # ~1.07 GB per request in FP16
kv_fp16_gb_str = f"{kv_fp16_gb:.1f}"

# Pre-compute batch size results for prose
max_batch_fp16 = int(45 / (kv_fp16_gb / 4))
max_batch_fp16_str = str(max_batch_fp16)
max_batch_int8 = int(71.25 / (kv_fp16_gb / 2 / 4))
max_batch_int8_str = str(max_batch_int8)
batch_ratio_str = str(int(max_batch_int8 / max_batch_fp16))
```
