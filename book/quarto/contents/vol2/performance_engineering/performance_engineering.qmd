...
A common fallacy is this: *More FLOP/s means faster inference.*
...
A recurring pitfall is this: *Planning FP8 adoption as an automatic training-time halving.*
...
A common fallacy is this: *The largest kernel is the whole performance problem.*
...
A recurring pitfall is this: *Applying speculative decoding without considering batch dynamics.*
...
A common fallacy is this: *MoE expert count is a free scaling knob.*
...
A recurring pitfall is this: *Using graph compilers as a substitute for kernel analysis.*
...
A common fallacy is this: *The lowest supported precision is always the best precision.*
...
A recurring pitfall is this: *Measuring throughput without measuring quality.*
...
A common fallacy is this: *A single profiling run is sufficient to characterize performance.*
...
A recurring pitfall is this: *Optimizing for average case while ignoring tail latency.*
