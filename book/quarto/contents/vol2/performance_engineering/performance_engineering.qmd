...
As @fig-fusion-before-after makes concrete, fusion reduces HBM transfers from five to two per layer, eliminating 32 MB of redundant intermediate traffic that the unfused path forces through off-chip memory.
