...
\noindent
![](images/png/cover_performance_engineering_blueprint.png){fig-alt="Performance engineering workbench where a fleet workload is measured, bottlenecks are diagnosed, and tiling, fusion, memory, and scheduling rewrites improve the path."}
