...
class AllReduceBottleneck:
    ...
    grad_small_gb_str = fmt_qty(grad_small, GB, precision=1, commas=False)
...
A common fallacy is this: *More bandwidth always means faster training.*
...
A recurring pitfall is this: *Treating InfiniBand as just fast Ethernet.*
...
A common fallacy is this: *Lossless Ethernet is as reliable as InfiniBand.*
...
A recurring pitfall is this: *Accepting oversubscription because most traffic is local.*
...
A common fallacy is this: *TCP bandwidth tests are sufficient for ML fabric validation.*
...
A recurring pitfall is this: *Relying on adaptive routing instead of topology-aware placement.*
...
A common fallacy is this: *Network fabric problems always appear as hard failures.*
...
A recurring pitfall is this: *Treating PFC and ECN counters as optional production details.*
