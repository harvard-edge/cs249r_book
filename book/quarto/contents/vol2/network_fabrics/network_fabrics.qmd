...
- [ ] **Rail beneficiary**: identify the dimension of 3D parallelism (tensor parallelism [TP], pipeline parallelism [PP], or data parallelism [DP]) that benefits most from a rail-optimized design.
