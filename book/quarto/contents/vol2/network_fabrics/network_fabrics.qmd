...
1. **Small Message (4 KB)**:
   - InfiniBand: $1.5\mu s + 4KB/50GB/s = 1.5 + 0.08 = \mathbf{1.58 \mu s}$
   - Ethernet: $5.0\mu s + 4KB/12.5GB/s = 5.0 + 0.32 = \mathbf{5.32 \mu s}$
   - *Verdict*: InfiniBand is $3.4\times$ faster purely due to lower $\alpha$.

2. **Large Message (100 MB)**:
   - InfiniBand: $1.5\mu s + 100MB/50GB/s = 0.0015 + 2.0 = \mathbf{2.00 ms}$
   - Ethernet: $5.0\mu s + 100MB/12.5GB/s = 0.005 + 8.0 = \mathbf{8.01 ms}$
