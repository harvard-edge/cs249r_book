...
class NetworkFabricsClusterRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    nvlink_to_ib_ratio_mult_str = fmt_multiple((nvlink / ib_ndr).to_base_units().magnitude, precision=0, commas=False)
