...
class FatTreeScaling:
    ...
    infra_cost_low_m_str = fmt_usd(50, precision=0, commas=False, suffix="M")
    infra_cost_high_m_str = fmt_usd(250, precision=0, commas=False, suffix="M")
```
...
class BisectionWasteRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    waste_m_str = fmt_usd(waste_val, precision=1, commas=False, suffix="M")
```
