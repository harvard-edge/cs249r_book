...
\noindent
![](images/png/cover_network_fabrics_blueprint.png){fig-alt="Isometric network fabric map connecting accelerator racks through elevated fabric layers with synchronization paths and a congestion constraint."}
...
The topology diagram in @fig-fat-tree-detail shows how that capacity guarantee is created: leaf, spine, and core tiers provide multiple equal-cost paths instead of a single oversubscribed root.
