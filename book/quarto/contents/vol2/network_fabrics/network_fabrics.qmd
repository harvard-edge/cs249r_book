...
As bandwidth demands grew, high-speed links moved from binary NRZ signaling to four-level PAM4, doubling throughput per wire at the cost of reduced noise margins (@fig-pam4-vs-nrz).
...
**Fallacy**: *PFC and ECN counters are optional production details.*
