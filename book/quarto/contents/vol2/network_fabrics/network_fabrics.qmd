...
class AllReduceBottleneck:
    ...
    t_comp_display_math = fmt_display_math(f" T_{{\\text{{compute}}}} = {t_comp_display} \\text{{ ms}} ")
    t_ring_small_math = fmt_math(f"T_{{\\text{{ring}}}} \\approx {t_comm_small_display} \\text{{ ms}}")
    comm_frac_display_math = fmt_display_math(f" \\text{{Comm. fraction}} = {comm_frac_small_pct} \\% ")
    t_ring_70b_display_math = fmt_display_math(f" T_{{\\text{{ring}}}} \\approx {t_comm_70b_display} \\text{{ ms}} ")
