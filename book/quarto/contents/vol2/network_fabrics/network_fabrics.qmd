...
class NextGenLinkDensity:
    ...
    eth_1_6t_port_tbps_s_str = fmt_qty(ETHERNET_1P6T_BW, terabit / second, precision=1, commas=False, unit_label="Tb/s")
    switch_capacity_tbps_s_str = fmt_qty(SWITCH_ASIC_102T4_BW, terabit / second, precision=1, commas=False, unit_label="Tb/s")
...
class IbBandwidthFallaciesRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    ib_hdr_gbps_str = fmt_qty(hdr_bw, Gbps, precision=0, commas=False, unit_label="Gb/s")
    ib_ndr_gbps_str = fmt_qty(ndr_bw, Gbps, precision=0, commas=False, unit_label="Gb/s")
```
...
class BandwidthFallacy:
    ...
    hdr_bw_gbps_str = fmt_qty(ib_hdr.bandwidth, Gbps, precision=0, commas=False, unit_label="Gb/s")
    ndr_bw_gbps_str = fmt_qty(ib_ndr.bandwidth, Gbps, precision=0, commas=False, unit_label="Gb/s")
