...
class NetworkFabricsContextScenario:
    ...
    nvlink_to_ib_ratio_str = fmt_multiple(nvlink_to_ib_ratio_val, precision=0, commas=False)
...
class BisectionScaling:
    ...
    bbs_slowdown_str = fmt_multiple(slowdown, commas=False, precision=0)
...
class RailLatency:
    ...
    rol_speedup_str = fmt_multiple(speedup, precision=0, commas=False)
...
class NetworkFabricsClusterRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    nvlink_to_ib_ratio_str = fmt_multiple((nvlink / ib_ndr).to_base_units().magnitude, precision=0, commas=False)
