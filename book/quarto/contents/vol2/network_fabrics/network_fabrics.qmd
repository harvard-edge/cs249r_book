...
::: {.column-margin}
![](images/png/network_fabrics_gpu_fanout.png){width="100%" fig-alt="A schematic fan: one red source node on the left connects by six gray arrows to six blue nodes on the right, showing one node reaching many peers."}
