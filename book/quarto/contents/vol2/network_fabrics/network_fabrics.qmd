...
# ┌─────────────────────────────────────────────────────────────────────────────
# │ NETWORK ALPHA-BETA MODEL (P.I.C.O.)
# ├─────────────────────────────────────────────────────────────────────────────
# │ Context: @sec-network-fabrics-performance-model
# │
# │ Goal: Quantify the latency-bandwidth crossover for InfiniBand vs Ethernet.
# │ Show: Crossover points (~75KB for IB); impact on small vs large messages.
# │ How: T = alpha + n/beta. Small msg: 4KB; Large msg: 350MB.
# │
...
class NetworkAlphaBeta:
    ...
    # ┌── 3. INVARIANTS (Guardrails) ───────────────────────────────────────────
    check(n_cross_ib < 100000, f"Crossover ({n_cross_ib:.0f}) should be < 100KB for IB")
