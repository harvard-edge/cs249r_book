...
<!-- TODO(numerical-audit): Fat-tree host and switch counts in this chapter
     (lines 859, 861, 907, 978, 980, 1078) need a numerical-audit pass to
     reconcile claims for a specific k-ary topology. Distinguish two-tier
     leaf-spine from three-tier Clos and use one set of consistent
     assumptions. Current numbers are illustrative; some pairs cannot all
     be true under one topology model. -->
