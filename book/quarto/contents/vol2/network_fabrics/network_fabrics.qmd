...
2. **Large message** (`{python} NetworkAlphaBeta.n_demo_large_mb_str`):
   - InfiniBand: $1.5\,\mu\text{s} + 100\,\text{MB}/50\,\text{GB/s} = 0.0015 + 2.0 = \mathbf{2.00\,\text{ms}}$
   - Ethernet: $5.0\,\mu\text{s} + 100\,\text{MB}/12.5\,\text{GB/s} = 0.005 + 8.0 = \mathbf{8.01\,\text{ms}}$
