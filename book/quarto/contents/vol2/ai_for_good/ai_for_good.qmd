...
Experience with agricultural apps deployed in Sub-Saharan Africa reveals that many become effectively unusable within months due to connectivity assumptions that held during urban pilots but failed in rural deployments. Successful systems assume zero connectivity as the baseline and treat network access as an enhancement.
...
Analysis of AI for Good project outcomes reveals a consistent pattern: initial deployment reports frequently claim success, yet follow-up assessments at 12 to 24 months show significantly lower sustained adoption rates. This gap represents systems that achieved technical deployment without achieving lasting impact. Success metrics should track 12-month and 24-month adoption, not launch statistics.
