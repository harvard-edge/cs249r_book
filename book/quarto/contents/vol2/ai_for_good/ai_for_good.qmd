...
Achieving ultra-low model sizes for social good applications requires systematic optimization pipelines that balance accuracy with resource constraints. Model optimization techniques including quantization [@gholami2021survey], pruning [@han2015learning], and knowledge distillation[^fn-knowledge-distillation] [@hinton2015distilling] must be adapted and intensified for extreme resource limitations encountered in underserved environments.
