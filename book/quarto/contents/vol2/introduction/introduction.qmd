...
**The Systems Sandwich** organizes the complexity of Volume II into three distinct layers.
...
This textbook is structured to walk you up this stack, from the datacenter floor to the policy boardroom.
...
+:===============================+:================================+:=======================================+
| **I: Foundations of Scale**    | **Scale**: Algorithmic and      | Distributed Training, Communication,   |
|                                | software foundations            | Fault Tolerance                        |
+--------------------------------+---------------------------------+----------------------------------------+
| **II: Building the Machine Learning Fleet**| **Build**: Physical infrastructure | Compute Infrastructure,                |
|                                | and storage systems             | Networking & Orchestration, Storage    |
+--------------------------------+---------------------------------+----------------------------------------+
