...
Abstract frameworks become concrete through specific workloads. Three lighthouse archetypes at scale\index{Lighthouse Archetypes!at scale} recur where they illuminate a chapter's central constraint; no chapter must force all three into its argument. Together they sample distinct C$^3$ regimes by stressing communication, coordination, or compute in different ways.
