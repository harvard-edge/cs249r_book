...
Managing heterogeneity is one of many challenges that emerge from scale. But scale alone does not capture all the difficulties. Distribution itself introduces fundamental constraints that exist even at modest scales, arising from the physics of information transfer rather than the quantity of computation.
