...
Optimal compute allocation follows from the scaling relationship $D \propto N^{0.74}$ [@hoffmann2022chinchilla], which shows that dataset size $D$ and model size $N$ must grow in coordinated proportions for a fixed budget. As model size increases, the dataset should grow at roughly three-quarters the rate to maintain compute-optimal efficiency.
