...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_sci, MarkdownStr, check, fmt_qty
...
class Gpt3TrainingScenario:
    ...
    gradient_gb = gradient_q.m_as(GB)
...
class Gpt3StatsScenario:
    ...
    a100_throughput = a100_throughput_q.m_as(TFLOPs/second)
