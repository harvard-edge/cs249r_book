...
class Gpt4TrainingScenario:
    ...
    gpu_mtbf_str = fmt_time(gpu_mtbf_hours, 'hour', precision=0, commas=True, style='word')
...
class InfiniBandScenario:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    ib_hdr_gbps_str = fmt_qty(hdr, Gbps, precision=0, commas=False, unit_label="Gb")
    ib_hdr_gbs_str = fmt_qty(hdr, GB/second, precision=0, commas=False, unit_label="GB")
    ib_ndr_gbs_str = fmt_qty(ndr, GB/second, precision=0, commas=False, unit_label="GB")
```
...
class InfiniBandStackRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    nvlink_h100_gbs_str = fmt_qty(nvlink_h100, GB/second, precision=0, commas=False, unit_label="GB")
    ib_ndr_gbps_str = fmt_qty(ndr, Gbps, precision=0, commas=False, unit_label="Gb")
```
