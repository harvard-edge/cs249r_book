...
**Problem**: What scaling efficiency and energy cost result when training GPT-3 (`{python} GPT3SyncTax.model_params_b_str` params) on a cluster connected by `{python} GPT3SyncTax.eth_bw_gbit_per_s_str` Ethernet versus `{python} GPT3SyncTax.ib_bw_gbit_per_s_str` InfiniBand?
