...
### Part I: The Fleet
*What* is the physical substrate? We build the Machine Learning Fleet from the ground up: **Compute Infrastructure** (silicon, power, cooling), **Network Fabrics** (the gradient bus connecting thousands of accelerators), and **Scalable Data Systems** (the storage hierarchy that feeds training pipelines).
