...
# │          gpt4_gpus_str, gpt4_days_str, cluster_fail_day_str, mtbf_hours_str, hours_per_day_str
# └─────────────────────────────────────────────────────────────────────────────
...
2. **Daily failure rate**\index{Failure Rate!daily}: `{python} Gpt4TrainingScenario.hours_per_day_str` hours / `{python} Gpt4TrainingScenario.mtbf_hours_str` $\approx$ `{python} Gpt4TrainingScenario.cluster_fail_day_str` failures per day.
