...
\noindent
![](images/png/cover_introduction_blueprint_print.png){fig-alt="Isometric fleet-scale blueprint showing a single ML system expanding into racks, network fabric, coordination layers, scaling constraints, and failure domains."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_introduction_blueprint.webp){fig-alt="Isometric fleet-scale blueprint showing a single ML system expanding into racks, network fabric, coordination layers, scaling constraints, and failure domains."}
:::
