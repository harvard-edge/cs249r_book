...
The **CAP Theorem**\index{CAP Theorem}[^fn-cap-theorem-ml] establishes that distributed systems can provide at most two of three properties: **Consistency**\index{CAP Theorem!consistency}, **Availability**, and **Partition Tolerance**. The ML fleet encounters all three constraints, forcing explicit trade-offs.
