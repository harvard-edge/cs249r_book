...
The ML fleet demands the **Warehouse-Scale Computer (WSC)**\index{Warehouse-Scale Computer!definition}[^fn-wsc-barroso-datacenter] perspective. In traditional computing, the data center is a building that houses many computers. In the ML fleet, the data center is the computer.
