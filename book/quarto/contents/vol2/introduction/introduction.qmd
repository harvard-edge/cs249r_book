...
[^fn-sextillion]: **Sextillion**: A number with 21 zeros ($10^{21}$), representing an almost incomprehensible scale. To put this in perspective, there are estimated $10^{22}$ to $10^{24}$ stars in the observable universe, making GPT-3's training computation roughly 1/22nd of counting every star in the cosmos.
