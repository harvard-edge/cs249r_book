...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_sci_qty, check, fmt_memory
...
class Gpt3TrainingScenario:
    ...
    gpt3_training_ops_str = fmt_sci_qty(ops * flop, flop, unit_label="FLOPs")
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_sci_qty, check, fmt_qty
...
class Gpt3StatsScenario:
    ...
    gpt3_params_b_str = fmt(params_b, precision=0, commas=False)
    gpt3_training_ops_str = fmt_sci_qty(ops * flop, flop, unit_label="FLOPs")
    a100_fp16_tflops_str = fmt_qty(a100_throughput_q, TFLOPs/second, precision=0, commas=False, unit_label="TFLOP/s")
```
