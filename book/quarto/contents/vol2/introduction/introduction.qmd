...
*   **Archetype B (DLRM at Scale)**—the Deep Learning Recommendation Model workload: We move from fitting embedding tables in memory to **Embedding Sharding** across hundreds of nodes, creating massive all-to-all communication bottlenecks.
