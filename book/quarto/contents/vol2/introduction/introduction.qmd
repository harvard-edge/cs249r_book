...
2.  **Algorithm**\index{D·A·M Taxonomy!algorithm}: The mathematical logic being executed. Performance is compute-bound when the processor's arithmetic units are the limiting factor.
