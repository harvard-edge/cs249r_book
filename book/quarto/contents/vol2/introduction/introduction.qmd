...
As systems scale beyond a single node, a fundamental physical constraint emerges: the *bisection bandwidth wall*, which limits how fast data can cross the network midpoint. The following worked example quantifies this constraint for a realistic training scenario.

::: {.callout-notebook title="The Bisection Bandwidth Wall"}
