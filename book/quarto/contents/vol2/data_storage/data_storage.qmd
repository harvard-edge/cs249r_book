...
class StorageFuelLineContext:
    ...
    ckpt_total = memory_from_params(gpt3_params * param, bytes_per_param_ckpt * byte / param)
...
class HbmModelBudget:
    ...
    weights_fp16 = memory_from_params(params, bytes_fp16 * byte / param)
    adam = memory_from_params(params, adam_bytes * byte / param)
...
class CheckpointStormDefinition:
    ...
    # ┌── 2. EXECUTE ───────────────────────────────────────────────────────
    weights = memory_from_params(params, bytes_fp16 * byte / param)
    gradients = memory_from_params(params, bytes_fp16 * byte / param)
    master_weights = memory_from_params(params, bytes_fp32 * byte / param)
    adam_moments = memory_from_params(params, 2 * bytes_fp32 * byte / param)
