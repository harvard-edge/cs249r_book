...
class ObjectStorageCost:
    ...
    # ┌── 4. OUTPUT ───────────────────────────────────────
    s3_annual_str   = fmt_usd(s3_annual_val, precision=0)
    nvme_annual_str = fmt_usd(nvme_annual_val, precision=0)
```
...
class EconRatios:
    ...
    egress_100tb_str    = fmt_usd(egress_100tb_val, precision=0)
```
...
class BuildVsBuyStorageEconomics:
    ...
    # ┌── 4. OUTPUT ───────────────────────────────────────
    cloud_storage_annual_str = fmt_usd(cloud_storage_annual, precision=0)
    cloud_egress_annual_str = fmt_usd(cloud_egress_annual, precision=0)
    cloud_total_annual_str = fmt_usd(cloud_total_annual, precision=0)
    annual_ops_str = fmt_usd(annual_ops, precision=0)
