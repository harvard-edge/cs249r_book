...
from mlsys.constants import (
    ...
    GPUS_PER_NODE, SEC_PER_MONTH, SEC_PER_YEAR,
    H100_MEM_CAPACITY, BYTES_PER_FP16, BYTES_PER_FP32,
    MICROSECOND, GiB, Mparam, RESNET50_PARAMS,
    NVLINK_H100_BW, PCIE_GEN5_BW
)
...
# GPU Specs for setup
a100_mem = f"{A100_MEM_CAPACITY.m_as(GiB):.0f}"
h100_mem = f"{H100_MEM_CAPACITY.m_as(GiB):.0f}"
