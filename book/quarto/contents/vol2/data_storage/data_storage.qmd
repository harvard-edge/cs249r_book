...
**Diagnosis**: The file system delivers less than 1% of rated throughput. Millions of per-second `stat()` and `open()` calls overwhelm the metadata servers (MDS), choking data loaders despite abundant network and storage bandwidth.
