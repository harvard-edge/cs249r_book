...
\noindent
![](images/png/cover_data_storage_blueprint_print.png){fig-alt="Fleet storage fuel-line hierarchy where data moves from object storage through NVMe, DRAM, and HBM tiers into accelerator workers."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_data_storage_blueprint.webp){fig-alt="Fleet storage fuel-line hierarchy where data moves from object storage through NVMe, DRAM, and HBM tiers into accelerator workers."}
:::
