...
from mlsysim.fmt import fmt, check, fmt_qty, fmt_int, fmt_time
...
class StorageAccessPatternFacts:
    ...
    checkpoint_interval_min_str = fmt_time(checkpoint_interval_min, 'minute', precision=0, commas=False, style='word')
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import MarkdownStr, fmt, check, fmt_time
...
class TextImageBandwidth:
    ...
    step_ms_str = fmt_time(step_s * THOUSAND, 'millisecond', precision=0, commas=False)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, fmt_count, fmt_time
...
class NVMeTierCalcs:
    ...
    ckpt_nvme_s_str        = fmt_time(ckpt_nvme_s_val, 'second', precision=1, commas=False, style='word')
    ckpt_pfs_s_str         = fmt_time(ckpt_pfs_s_val, 'second', precision=1, commas=False, style='word')
```
...
class NvmeTierContext:
    ...
    tokenized_text_tb_str = fmt_int(round(tokenized_text_tb_val), commas=False, suffix=' TB')
    tokenized_local_stream_min_str = fmt_time(tokenized_local_stream_min_val, 'minute', precision=1, commas=False, style='word')
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import MarkdownStr, check, fmt, fmt_time
import math
...
class PipelineCalcs:
    ...
    t_comp_stall_str    = fmt_time(t_comp_val, 'millisecond', precision=0, commas=False)
    t_io_stall_str      = fmt_time(t_io_val, 'millisecond', precision=0, commas=False)
...
class NodeStagingContext:
    ...
    node_stage_uncontended_s_str = fmt_time(node_stage_uncontended_s_val, 'second', precision=1, commas=False, style='word')
    node_stage_contended_s_str = fmt_time(node_stage_contended_s_val, 'second', precision=1, commas=False, style='word')
```
...
class GDSLatency:
    ...
    gds_bypass_us_str = fmt_time(gds_bypass_us, 'microsecond', precision=0, commas=False)
...
class BuildVsBuyStorageEconomics:
    # ┌── 1. LOAD ─────────────────────────────────────────
    from mlsysim.fmt import check, fmt, fmt_usd, MarkdownStr, fmt_time
    capex_low = 3_000_000
    ...
    breakeven_low_years_str = fmt_time(breakeven_low_years, 'year', precision=1, commas=False, style='word')
    breakeven_high_years_str = fmt_time(breakeven_high_years, 'year', precision=1, commas=False, style='word')
...
class CheckpointStormDefinition:
    ...
    zero3_write_s_str = fmt_time(zero3_write_s, 'second', precision=1, commas=False, style='word')
    naive_total_tb_str = fmt(naive_total_tb, precision=1, commas=False, suffix=" TB")
    naive_write_s_str = fmt_time(naive_write_s, 'second', precision=1, commas=True, style='word')
...
class CheckpointStormCalc:
    ...
    local_write_s_str = fmt_time(local_write_s, 'second', precision=2, commas=False, style='word')
    total_pfs_tb_str = fmt(total_pfs_tb, precision=1, commas=False, suffix=" TB")
    pfs_copy_s_str = fmt_time(pfs_copy_s, 'second', precision=1, commas=False, style='word')
    ...
    checkpoint_interval_min_str = fmt_time(checkpoint_interval_min, 'minute', precision=0, commas=False, style='word')
    checkpoint_interval_s_str = fmt_time(checkpoint_interval_s, 'second', precision=0, commas=False, style='word')
