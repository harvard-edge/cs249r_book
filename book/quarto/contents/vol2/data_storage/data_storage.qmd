...
::: {.column-margin}
![](images/png/data_storage_bandwidth_cliff.png){width="100%" fig-alt="Three stacked horizontal bars on a log scale, longest at top: HBM at 3.35 TB/s, host DRAM at 200 GB/s, and NVMe at 7 GB/s, showing bandwidth dropping sharply across the top three storage tiers."}

*Bandwidth drops roughly 479× across the top three tiers, from HBM to local NVMe.*
:::
