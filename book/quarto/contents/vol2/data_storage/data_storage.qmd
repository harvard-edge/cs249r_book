...
class StorageFuelLineContext:
    ...
    bw_ratio_str = fmt_multiple(bw_ratio_val, precision=1, commas=True)
...
class TextImageBandwidth:
    ...
    ratio_rounded_str = fmt_multiple(ratio_rounded_val, precision=0, commas=True)
...
class EconRatios:
    ...
    # ┌── 4. OUTPUT ───────────────────────────────────────
    tier_cost_ratio_str = fmt_multiple(tier_cost_ratio_val, precision=0, commas=False)
...
class SyntheticStorage:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────
    amplification_factor_str = fmt_multiple(amplification, precision=1, commas=False)
...
class GDSLatencyRecap:
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    gds_speedup_str = fmt_multiple(4, precision=0, commas=False)
```
