...
[^fn-phishing-ai]: **AI-Generated Phishing**: LLMs generate phishing emails with 99 percent+ grammatical accuracy versus 19 percent for traditional phishing, achieving 30 percent+ click-through rates in some campaigns. This dual-use threat illustrates why ML security must treat models as both assets to defend and potential weapons: the same language fluency that powers customer-facing chatbots can be fine-tuned for social engineering at scale. \index{Phishing!AI-generated}
