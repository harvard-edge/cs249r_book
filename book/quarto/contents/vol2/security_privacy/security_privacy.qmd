...
*Shows enclave memory capacity constraining which models can fit securely.*
:::
...
*Shows the latency gulf between ordinary encryption and privacy-preserving computation.*
:::
...
*Shows privacy budget composition as repeated access burning down epsilon.*
:::
...
*Shows distributed attack surface growing faster than node count.*
:::
