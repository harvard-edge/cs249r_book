...
\pic[shift={(0,0)}] at  (0,0){laptop={scalefac=1.5,picname=1,drawcolor=GreenLine,Dual=0,Smile=0,
...
\pic[shift={(0,0)},rotate=320] at  (0,0){usb={scalefac=0.6,picname=1,drawcolor=OrangeLine,filllcirclecolor=white,filllcolor=VioletLine!GrayLine!,Linewidth=1.0pt,}};
\end{scope}
%
...
\pic[shift={(0,0)}] at  (0,0){laptop={scalefac=1.0,picname=2,drawcolor=RedLine,Dual=0,Smile=1,
...
\pic[shift={(0,0)}] at  (0,0){laptop={scalefac=1.0,picname=3,drawcolor=RedLine,Dual=0,Smile=1,
...
\pic[shift={(0,0)}] at  (0,0){laptop={scalefac=1.0,picname=4,drawcolor=RedLine,Dual=0,Smile=1,
...
\pic[shift={(0,0)}] at  (0,0){plc={scalefac=1.2,picname=1,drawcolor=OrangeLine,filllcirclecolor=BlueLine, Smile=1,
...
\pic[shift={(0,0)}] at  (0,0){laptop={scalefac=1.0,picname=5,drawcolor=RedLine,Dual=0,Smile=1,
filllcolor=GreenL,Linewidth=1.0pt, filllcirclecolor=OrangeLine}};
\end{scope}
%
\begin{scope}[local bounding box=COPIER1,shift={($(LAPTOP5)+(2.9,0)$)},scale=1, every node/.append style={transform shape}]
\pic[shift={(0,0)}] at  (0,0){copier={scalefac=0.8,picname=1,drawcolor=BlueLine,
...
\pic[shift={(0,0)}] at  (0,0){plc={scalefac=1.2,picname=2,drawcolor=OrangeLine,filllcirclecolor=BlueLine, Smile=0,
filllcolor=OrangeLine,Linewidth=1.0pt,Level=0.42}};
\end{scope}
%%%%%%%%%%%%%%%
\begin{scope}[local bounding box=LAPTOP6,shift={($(LAPTOP1)+(9.6,-7.5)$)},scale=1, every node/.append style={transform shape}]
\pic[shift={(0,0)}] at  (0,0){laptop={scalefac=1.0,picname=6,drawcolor=RedLine,Dual=1,Smile=1,
...
\pic[shift={(0,0)}] at  (0,0){plc={scalefac=1.2,picname=3,drawcolor=OrangeLine,filllcirclecolor=RedLine, Smile=0,
filllcolor=OrangeLine,Linewidth=1.0pt,Level=0.42}};
\end{scope}
...
\pic[shift={(0,0)}] at  (0,0){laptop={scalefac=1.0,picname=7,drawcolor=RedLine,Dual=1,Smile=1,
...
\pic[shift={(0,0)}] at  (0,0){plc={scalefac=1.2,picname=4,drawcolor=OrangeLine,filllcirclecolor=RedLine, Smile=0,
...
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}]
  ...
  % Labels
  \node[text=RedLine, font=\bfseries] at (6, 6) {CRITICAL};
  \node[text=OrangeLine, font=\bfseries] at (6, 2) {COMMON};
  \node[text=OrangeLine, font=\bfseries] at (2, 6) {SPECIALIZED};
  \node[text=GrayLine, font=\bfseries] at (2, 2) {ROUTINE};
...
\node[draw=GrayLine,inner xsep=10mm,inner ysep=4mm,
yshift=2.5mm,fill=GrayL!60,fit=(B1)(B4),line width=0.75pt](BB2){};
...
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}, node distance=1.5cm]
  ...
  % Outer Loop (Attacker)
  \node[block, fill=OrangeL] (Attacker) {\textbf{Outer Loop: Attacker}\\Optimize Poisoning Data $D_p$};

  % Inner Loop (System)
  \node[block, fill=BlueL, below=of Attacker] (System) {\textbf{Inner Loop: System}\\Train Model $f$ on $D \cup D_p$};

  % Evaluation
  \node[block, fill=GrayL, below=of System] (Eval) {Compute Validation Loss\\$\mathcal{L}(f, D_{test})$};
...
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}]
  ...
  \draw[line width=1.0pt, BlueLine!60] plot [smooth, tension=1] coordinates {(-1,4) (2,2) (5,0)};
  ...
  % Perturbation Vector
  \draw[arrow, RedLine] (X) -- (Xadv) node[midway, sloped, above, font=\tiny] {Perturbation $\delta$};

  % Distance constraint
  \draw[dashed, GrayLine, line width=0.75pt] (X) circle (2.2);
  \node[GrayLine, font=\tiny] at (1, -0.8) {Constraint $\|\delta\| \leq \epsilon$};
...
\addplot+[] {7*exp(-x^2/2)};
\node[line width=0.75pt,draw=BrownLine,rectangle,minimum size=14mm](B1)at(S){};
\end{axis}
\end{scope}
%right graph
...
%
\draw[BlueLine,-latex](T1)--++(0:9.5mm)node[right]{0000};
\draw[GreenLine,-latex](T2)--++(0:9.9mm)node[right]{1111};
\draw[VioletLine,-latex](T3)--++(0:10.4 mm)node[right]{0101};
\end{axis}
\node[line width=0.75pt,draw=BrownLine,rectangle,
...
Box3/.style={Box,  node distance=0.7, draw=VioletLine,fill=VioletL},
...
\scoped[on background layer]
\node[draw=GrayLine,inner xsep=6mm,inner ysep=6mm,
yshift=2.5mm,fill=GrayL!60,fit=(B1)(B4),line width=0.75pt](BB1){};
...
\scoped[on background layer]
\node[draw=BlueLine,inner xsep=6mm,inner ysep=6mm,
yshift=2.5mm,fill=BlueL,fit=(2B1)(2B4),line width=0.75pt](BB2){};
\node[below=6pt of  BB2.north,inner sep=0pt,
...
\scoped[on background layer]
\node[draw=GreenLine,inner xsep=6mm,inner ysep=6mm,
yshift=2.5mm,fill=GreenL,fit=(3B1)(3B3),line width=0.75pt](BB3){};
...
yshift=2.3mm,fill=VioletL,fit=(4B1)(5B2),line width=0.75pt](BB4){};
...
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}, scale=0.8]
  ...
  \draw[BlueLine, line width=1.0pt, domain=-4:4, samples=100] plot (\x, {3*exp(-(\x)^2/2)}); % Distribution for D
  \draw[RedLine, line width=1.0pt, domain=-4:4, samples=100] plot (\x, {2.5*exp(-((\x-0.5)^2)/2)}); % Distribution for D'

  % Shading overlap
  \begin{scope}
    \clip plot[domain=-4:4] (\x, {3*exp(-(\x)^2/2)}) -- (4,0) -- (-4,0) -- cycle;
    \fill[GrayL, opacity=0.5] plot[domain=-4:4] (\x, {2.5*exp(-((\x-0.5)^2)/2)}) -- (4,0) -- (-4,0) -- cycle;
  \end{scope}
  ...
  \node[anchor=north, font=\scriptsize, text=GrayLine] at (0,-0.5) {Distributions must be within $e^\epsilon$ factor everywhere.};
