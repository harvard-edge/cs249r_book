...
class TEEMemoryFootprint:
    ...
    resnet50_params_m = resnet50_params.m_as(Mparam)
    fp32_bytes_q = BYTES_FP32
    int8_bytes_q = BYTES_INT8
    fp32_bytes = fp32_bytes_q.m_as(byte)
    int8_bytes = int8_bytes_q.m_as(byte)
    sgx_epc_q = Hardware.Cloud.IntelSGX.memory.capacity
    sgx_epc_mb = sgx_epc_q.m_as(MB)
    ...
    small_model_limit_mb = small_model_limit_q.m_as(MB)
    ...
    resnet18_fp32_mb = resnet18_fp32_q.m_as(MB)
    resnet18_int8_mb = resnet18_int8_q.m_as(MB)
    resnet50_fp32_mb = resnet50_fp32_q.m_as(MB)
    resnet50_int8_mb = resnet50_int8_q.m_as(MB)
