...
<!-- TODO(focused-followup): Items deferred from the codex deep-review
     ...
     - Health-monitoring Problem callout second-person (line ~2446):
       convert similarly to line 228 (already fixed).
     - Tesla/Zoox case-study legal framing (line ~1386): the lawsuit
       was settled with denial of wrongdoing; the prose currently
       presents allegations as established fact. Recast as "alleged
       in the lawsuit" or cite an adjudicated source.
     - Knowledge-check second-person opener (line ~1875): recast as
       neutral framing or move to a permitted checkpoint callout.
     - Hardware-security mechanisms table split rows (line ~2382):
       mechanism names like "Hardware Security Modules" split across
       two rows ("...Modules (HSMs)") break semantic table structure;
       keep each mechanism in a single first-column cell.
     - Salary example second-person narration (line ~2813): convert
       imagine-you-want, you-could-ask, when-you-average, and
       you-cannot-know to neutral or third-person framing.

     Heading-case hook conflict items (Slurm/Cherokee/Grand Teton/
     Renyi proper-noun slugs) tracked separately as a lockstep
     slug-rename pass. -->
...
[^fn-fips-140]: **FIPS 140-2** (Federal Information Processing Standard): Defines four security levels for cryptographic modules. Level 4 requires survival of physical attacks at -40 to +85 degrees Celsius with tamper detection that zeroizes keys within seconds. For ML systems handling classified or medical data, FIPS 140-2 Level 3+ compliance is non-negotiable, restricting HSM access to authorized personnel and slowing the rapid iteration cycles that ML development typically demands. \index{FIPS 140-2!security levels}
