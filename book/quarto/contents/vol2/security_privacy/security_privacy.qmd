...
class DefenseOverheadAnalysis:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    from mlsysim.fmt import fmt, fmt_count, fmt_percent, fmt_time
    ...
    training_cost_k_str = fmt_count(training_cost_usd, scale='K', commas=False)
    ...
    extraction_cost_k_str = fmt_count(extraction_cost_usd, scale='K', commas=False)
