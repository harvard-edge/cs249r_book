...
class TEEMemoryFootprint:
    ...
    resnet50_params_m_str = fmt(resnet50_params.to(Mparam).magnitude, precision=1, commas=False)
    fp32_bytes_str = fmt(fp32_bytes_q.to(byte).magnitude, precision=0, commas=False)
