...
A common fallacy is this: *Security through obscurity provides adequate protection for machine learning models.*
...
A recurring pitfall is this: *Assuming that differential privacy automatically ensures privacy without considering implementation details.*
...
A common fallacy is this: *Federated learning inherently provides privacy protection without additional safeguards.*
...
A recurring pitfall is this: *Planning poisoning defenses only for large training-data compromise.*
...
A common fallacy is this: *Security can be isolated from the rest of the ML system.*
...
A recurring pitfall is this: *Underestimating the attack surface expansion in distributed ML systems.*
