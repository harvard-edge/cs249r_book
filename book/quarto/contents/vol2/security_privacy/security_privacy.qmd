...
::: {.column-margin}
![](images/svg/vol2_security_privacy_margin_002.svg){width="100%" fig-alt="Margin illustration showing Plaintext, AES, and FHE latency ladder."}
...
::: {.column-margin}
![](images/svg/vol2_security_privacy_margin_003.svg){width="100%" fig-alt="Margin illustration showing Segmented differential-privacy epsilon budget burn-down."}

*Each query burns down the finite privacy budget, epsilon.*
:::
...
::: {.column-margin}
![](images/svg/vol2_security_privacy_margin_004.svg){width="100%" fig-alt="Margin illustration showing Quadratic channel curve rising above linear node baseline."}
