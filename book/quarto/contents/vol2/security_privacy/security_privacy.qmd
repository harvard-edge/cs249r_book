...
class DPCostAnalysis:
    ...
    sensitivity_str = fmt_usd(sensitivity, precision=0)
    noise_scale_str = fmt_usd(noise_scale, precision=0)
    error_per_person_str = fmt_usd(error_per_person, precision=0)
    error_small_str = fmt_usd(error_small, precision=0)
