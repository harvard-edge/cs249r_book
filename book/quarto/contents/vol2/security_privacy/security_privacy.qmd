...
class DefenseOverheadAnalysis:
    ...
    output_accuracy_no_defense_pct_str = fmt(output_accuracy_no_defense_pct, precision=0, commas=False, suffix=" percent")
    output_accuracy_with_defense_pct_str = fmt(output_accuracy_with_defense_pct, precision=0, commas=False, suffix=" percent")
    fidelity_drop_pct_str = fmt(fidelity_drop_pct, precision=0, commas=False)
    top5_accuracy_pct_str = fmt(top5_accuracy_pct, precision=1, commas=False, suffix=" percent")
    baseline_top5_accuracy_pct_str = fmt(baseline_top5_accuracy_pct, precision=1, commas=False, suffix=" percent")
    false_positive_pct_str = fmt(false_positive_pct, precision=1, commas=False, suffix=" percent")
