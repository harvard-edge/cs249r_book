...
The *moments accountant\index{Moments Accountant}* technique, introduced for DP-SGD by @abadi2016, tracks higher-order moments of the privacy loss distribution. Rather than computing worst-case composition, it analyzes the actual privacy loss distribution across training iterations. For mechanism $\mathcal{M}$ with privacy loss $L$, the moments accountant computes:
$$
