...
\noindent
![](images/png/cover_security_privacy_blueprint.png){fig-alt="Security and privacy boundary chamber separating data, model weights, runtime, users, and audit logs into protected and untrusted zones."}
