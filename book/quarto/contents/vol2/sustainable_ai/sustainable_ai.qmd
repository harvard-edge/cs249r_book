...
# Training emissions worked example
n_gpus_emissions = 64
training_days = 14
training_hours = training_days * 24

# GPU energy
gpu_power_w = A100_TDP.to(watt).magnitude  # 400
gpu_energy_wh = n_gpus_emissions * gpu_power_w * training_hours
