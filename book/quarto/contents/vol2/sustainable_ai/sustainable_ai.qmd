...
**Problem**: Compare the deployment timeline for `{python} GridQueue.cluster_gpus_str` vs. the electrical substation required to power their IT load (`{python} GridQueue.cluster_power_mw_str`, after the `{python} GridQueue.cluster_gpu_power_mw_str` GPU subtotal is expanded for rack support power).
...
# │ Exports: cluster_gpus_str, gpu_tdp_w_str, accelerator_power_mw_str,
# │          it_power_mw_str, facility_power_mw_str
# └─────────────────────────────────────────────────────────────────────────────
