...
$$E_{\text{total}} = (E_{\text{CPU}} + E_{\text{GPU}} + E_{\text{memory}} + E_{\text{network}}) \times PUE$$ {#eq-total-energy}
...
$$P_{\text{facility}} = P_{\text{IT}} \times PUE = (P_{\text{servers}} + P_{\text{network}} + P_{\text{storage}}) \times PUE$$ {#eq-facility-power}
