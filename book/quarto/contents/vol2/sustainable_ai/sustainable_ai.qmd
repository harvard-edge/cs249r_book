...
$$P_{\text{total}} = P_{\text{dynamic}} + P_{\text{static}} = \alpha_{\text{sw}} C V^2 f@Eq-wue formalizes water usage effectiveness (WUE)\index{Water Usage Effectiveness}, capturing the water consumption that evaporative cooling and other processes require:
