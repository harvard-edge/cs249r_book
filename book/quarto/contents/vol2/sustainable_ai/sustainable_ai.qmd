...
class EmbodiedCarbonAmort:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    h_h100_tdp_kw_str = fmt_qty(h_h100_tdp_kw * kilowatt, kilowatt, precision=1, commas=False)
    op_energy_kwh_str = fmt_qty(op_energy_kwh * ureg.kilowatt_hour, ureg.kilowatt_hour, precision=0, commas=False)
    ...
    total_lifetime_hr_str = fmt_time(total_lifetime_hr, 'hour', precision=0, commas=False, style='word')
    ...
    t_job_hr_str = fmt_time(t_job_hr, 'hour', precision=0, commas=False, style='word')
    n_gpus_str = fmt(n_gpus, precision=0, commas=False)
```
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, fmt_count, fmt_int, fmt_qty
...
class InferenceLifecycleExample:
    ...
    kwh_per_query_str = fmt_qty(kwh_per_query * ureg.kilowatt_hour, ureg.kilowatt_hour, precision=3, commas=False)
    daily_energy_kwh_str = fmt_qty(daily_energy_kwh * ureg.kilowatt_hour, ureg.kilowatt_hour, precision=0, commas=True)
    annual_energy_kwh_str = fmt_qty(annual_energy_kwh * ureg.kilowatt_hour, ureg.kilowatt_hour, precision=0, commas=True)
...
```{python}
#| echo: false
from mlsysim.fmt import fmt_count, fmt_qty, fmt_qty_int
# ┌── LEGO ───────────────────────────────────────────────
...
class H100TdpRackRecap:
    ...
    power_delta_kw_str = fmt_qty_int(power_delta_kw * kilowatt, kilowatt, commas=False)
