...
**Problem**: A team trains a large model (GPT-3 size) consuming **`{python} CarbonCostGPT3.training_mwh_str` MWh**. How much CO2 is emitted, and how does that compare to a trans-Atlantic flight?
