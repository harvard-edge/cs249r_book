...
class CarbonCostGPT3:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    training_mwh_str = fmt_qty(energy_mwh * ureg.megawatt_hour, ureg.megawatt_hour, precision=0, commas=True)
    energy_kwh_str = fmt_qty(energy_kwh * ureg.kilowatt_hour, ureg.kilowatt_hour, precision=0, commas=True)
