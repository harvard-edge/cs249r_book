...
#| echo: false
# ┌─────────────────────────────────────────────────────────────────────────────
# │ SUSTAINABLE AI: CHAPTER-WIDE CONSTANTS (P.I.C.O.)
# ├─────────────────────────────────────────────────────────────────────────────
# │ Context: @sec-sustainable-ai — chapter-wide energy and carbon reference values
# │
# │ Goal: Establish GPU TDP, grid carbon intensities, and scaling mismatches.
# │ Show: ~700W H100; ~195,000x energy wall gap; US vs Quebec grid intensity.
# │ How: Compound growth (1 + r)^12; Gap = compute_growth / battery_gain.
# │
# │ Imports: mlsys.constants (H100_TDP, GPT3_PARAMS, GPT3_TRAINING_OPS, ...)
# │ Exports: h100_tdp_w, h100_tdp_kw, a100_tdp_w, gpt3_params_b,
# │          energy_wall_gap_str, battery_gain_pct, grid_gain_pct,
# │          grid_us_avg_str, grid_quebec_str, compute_growth_factor_str
# └─────────────────────────────────────────────────────────────────────────────
from mlsys.constants import (
    H100_TDP, A100_TDP, GPT3_PARAMS, GPT3_TRAINING_OPS,
    watt, BILLION, param, second, hour, TFLOPs, MILLION,
    THOUSAND, SEC_PER_YEAR, MICROSECOND
)
from mlsys.formatting import fmt, sci, check
...
class SustainableAISetup:
    ...
    n_years = 12
    battery_12yr_gain = (1 + battery_density_growth_annual) ** n_years
    grid_12yr_gain = (1 + grid_efficiency_growth_annual) ** n_years
    ...
    grid_us_avg_str = f"{grid_us_avg_g_kwh}"
    grid_quebec_str = f"{grid_quebec_g_kwh}"
...
grid_us_avg_str = SustainableAISetup.grid_us_avg_str
grid_quebec_str = SustainableAISetup.grid_quebec_str
compute_growth_factor_str = SustainableAISetup.compute_growth_factor_str
```
```
...
#| echo: false
# ┌─────────────────────────────────────────────────────────────────────────────
# │ CARBON COST OF TRAINING (P.I.C.O.)
# ├─────────────────────────────────────────────────────────────────────────────
...
#| echo: false
# ┌─────────────────────────────────────────────────────────────────────────────
# │ TRAINING EMISSIONS CALCULATION (P.I.C.O.)
# ├─────────────────────────────────────────────────────────────────────────────
# │ Context: @sec-sustainable-ai-scale-environmental-impact-ac9a
# │
...
class TrainingEmissions:
    ...
    # ┌── 3. INVARIANTS (Guardrails) ──────────────────────────────────────────
    check(gpu_power_w == 400, f"Expected 400W for A100, got {gpu_power_w}")
...
#| echo: false
# ┌─────────────────────────────────────────────────────────────────────────────
# │ EMBODIED CARBON AMORTIZATION (P.I.C.O.)
# ├─────────────────────────────────────────────────────────────────────────────
