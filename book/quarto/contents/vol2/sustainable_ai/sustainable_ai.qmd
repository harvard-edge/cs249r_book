...
# ┌── LEGO ───────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt, fmt_power, fmt_energy, check
...
|:------------------------------------------------------------------------------------------------------------|:--------------------------------------------:|:---------------------------------------------:|
| **GPU compute ($`{python} RackPowerBudget.num_gpus_str` \times `{python} RackPowerBudget.gpu_tdp_w_str`$)** |    `{python} RackPowerBudget.gpu_kw_str`     |     `{python} RackPowerBudget.gpu_pct_str`    |
