...
The environmental impact of AI workloads has emerged as a concern, with carbon emissions approaching levels comparable to familiar carbon-intensive activities. Strubell et al. report that neural architecture search for an NLP model can emit hundreds of thousands of pounds of CO~2~e, comparable to the lifetime emissions of several passenger vehicles [@strubell2019]. To contextualize AI's environmental footprint\index{Carbon Footprint!benchmarks}, @fig-carbonfootprint plots CO~2~ per inference against task accuracy for several BERT-family models, illustrating how larger and more accurate models carry meaningfully higher per-query carbon. The scatter shows that the highest-accuracy variants sit near the top-right of the plot and that the carbon cost rises faster than the accuracy gain. The same trade-off underscores the need for more sustainable AI practices.[^fn-nas-carbon-cost]
