...
class SustainableMobilePowerEnvelope:
    ...
    # ┌── 1. LOAD (Constants) ──────────────────────────────────────────────
    sustained_low_w = ReferenceStats.MobilePower.MobileMlSustainedLow.m_as(watt)
    sustained_high_w = ReferenceStats.MobilePower.MobileMlSustainedHigh.m_as(watt)
    burst_low_w = ReferenceStats.MobilePower.MobileMlBurstLow.m_as(watt)
    burst_high_w = ReferenceStats.MobilePower.MobileMlBurstHigh.m_as(watt)
...
class OnDeviceLearningEnergy:
    ...
    # ┌── 1. LOAD (Constants) ──────────────────────────────────────────────
    phone_battery_wh = ReferenceStats.PhoneBattery.EnergyWh.m_as('Wh')
    joules_per_wh = 3600
