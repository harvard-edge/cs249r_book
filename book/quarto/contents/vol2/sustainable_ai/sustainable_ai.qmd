...
: **Energy Efficiency by Architecture**: Hardware specialization provides up to three orders of magnitude improvement in energy per operation. These values represent typical operations under high utilization. {#tbl-energy-per-op}
...
print(f"Training energy: {energy_joules:.2f} J, Average power: {avg_power_watts:.2f} W")
```
:::
...
def calculate_carbon_footprint(
    ...
    operational_kg = facility_energy_kwh * grid_intensity_gco2_kwh / 1000
    ...
    return {
        ...
        'embodied_fraction': embodied_kg / (operational_kg + embodied_kg)
    }
...
print(f"Total carbon footprint: {result['total_carbon_kg']:.0f} kg CO2")
