...
*Shows site selection changing carbon emissions for the same job.*
:::
...
*Shows PUE as infrastructure overhead added to compute energy.*
:::
...
*Shows training power as sharp synchronized transients unlike smoother serving load.*
:::
...
*Shows radio transmission energy dwarfing local arithmetic.*
:::
