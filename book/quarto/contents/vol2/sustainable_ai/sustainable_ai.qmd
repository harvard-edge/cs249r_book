...
from mlsysim.fmt import fmt, fmt_usd, check, MarkdownStr
...
class AutoPlacement:
    ...
    total_tco_str = fmt_usd(res.objective_value / MILLION, precision=2, suffix="M")
    carbon_tax_str = fmt_usd(carbon_tax, precision=0, commas=False, suffix="/tonne")
...
class PueEfficiency:
    ...
    elec_price_per_mwh_str = fmt_usd(elec_price * THOUSAND, precision=0, commas=False, suffix="/MWh")
...
class GridQueue:
    ...
    queue_str = fmt(grid_queue_size_gw, precision=0, commas=False, suffix=" GW")
    gpu_lead_time_months_str = fmt(gpu_lead_time_months, precision=0, commas=False, suffix=" months")
    substation_lead_time_months_str = fmt(substation_lead_time_months, precision=0, commas=False, suffix=" months")
    cluster_gpus_str = fmt(cluster_gpus, precision=0, commas=True, suffix=" GPUs")
    cluster_power_mw_str = fmt(cluster_power_mw, precision=0, commas=False, suffix=" MW")
```
...
class H100TdpRackRecap:
    ...
    power_delta_kw_str = fmt_int(power_delta_kw, commas=False, suffix=" kW")
    ...
    node_power_budget_kw_str = fmt(7.0, precision=0, commas=False, suffix=" kW")
    node_gpus_str = fmt(Systems.Nodes.DGX_H100.accelerators_per_node, precision=0, commas=False, suffix=" GPUs")
    node_gpu_only_kw_str = fmt(Hardware.Cloud.H100.tdp.m_as(watt) * Systems.Nodes.DGX_H100.accelerators_per_node / THOUSAND, precision=1, commas=False, suffix=" kW")
```
...
class SustainableCoolingRackPowerRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    rack_power_str = fmt(rack_power_kw, precision=1, commas=False, suffix=" kW")
```
...
class PueSavings:
    ...
    # ┌── 4. OUTPUT ────────────────────────────────────────────────────────
    diff_15_to_11_mw_str = fmt(diff_15_to_11_mw, precision=1, commas=False, suffix=" MW")
    diff_158_to_110_mw_str = fmt(diff_158_to_110_mw, precision=1, commas=False, suffix=" MW")
    savings_15_to_11_musd_str = fmt_usd(savings_15_to_11_usd / MILLION, precision=1, suffix="M")
    savings_158_to_110_musd_str = fmt_usd(savings_158_to_110_usd / MILLION, precision=1, suffix="M")
...
class H100TdpCoolingRecap:
    ...
    electricity_rate_str = fmt_usd(electricity_rate, precision=2, commas=False, suffix="/kWh")
...
class SustainableMobilePowerEnvelope:
    ...
    sustained_range_str = MarkdownStr(
        ...
        f"{fmt(sustained_high_w, precision=0, commas=False, suffix=' W')}"
    )
    burst_range_str = MarkdownStr(
        f"{fmt(burst_low_w, precision=0, commas=False)}–"
        f"{fmt(burst_high_w, precision=0, commas=False, suffix=' W')}"
    )
```
...
class OnDeviceLearningEnergy:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    phone_battery_wh_str = fmt(phone_battery_wh, precision=0, commas=False, suffix=' Wh')
