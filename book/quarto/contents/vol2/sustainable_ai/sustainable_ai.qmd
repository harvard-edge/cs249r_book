...
For an accelerator with `{python} TrainingEmbodiedRecap.embodied_kg_per_accelerator_str` embodied carbon (per NVIDIA's product carbon footprint) and a `{python} TrainingEmbodiedRecap.embodied_lifetime_years_attr_str` data center lifetime, the daily amortized embodied carbon is `{python} TrainingEmbodiedRecap.embodied_kg_per_accelerator_str` / (`{python} TrainingEmbodiedRecap.embodied_lifetime_years_str` $\times$ `{python} TrainingEmbodiedRecap.days_per_year_str`) $\approx$ `{python} TrainingEmbodiedRecap.embodied_daily_kg_str`/day. Over a training run lasting `{python} TrainingEmbodiedRecap.training_days_str` using `{python} TrainingEmbodiedRecap.n_gpus_str` accelerators, the job's amortized embodied carbon is `{python} TrainingEmbodiedRecap.n_gpus_str` $\times$ `{python} TrainingEmbodiedRecap.training_days_str` $\times$ `{python} TrainingEmbodiedRecap.embodied_daily_kg_str` $\approx$ `{python} TrainingEmbodiedRecap.embodied_training_kg_str` CO~2~.
