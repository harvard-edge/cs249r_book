...
from mlsysim.fmt import check, fmt, fmt_count, fmt_qty, fmt_qty_int, fmt_time
...
class GridQueue:
    ...
    queue_str = fmt_qty(grid_queue_size_gw * ureg.gigawatt, ureg.gigawatt, precision=0, commas=False)
    ...
    cluster_power_mw_str = fmt_qty(cluster_power_mw * ureg.megawatt, ureg.megawatt, precision=0, commas=False)
```
