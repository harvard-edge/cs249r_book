...
class CarbonFrontier:
    ...
    cf_quebec_tonnes_str = fmt_emissions(quebec_carbon.to(metric_ton), unit=metric_ton, precision=0)
    cf_poland_tonnes_str = fmt_emissions(poland_carbon.to(metric_ton), unit=metric_ton, precision=0)
