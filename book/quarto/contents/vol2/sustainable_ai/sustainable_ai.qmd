...
\noindent
![](images/png/cover_sustainable_ai_blueprint_print.png){fig-alt="Sustainable fleet cutaway connecting compute racks to power delivery, cooling loops, grid sources, carbon accounting, efficiency controls, and lifecycle management."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_sustainable_ai_blueprint.webp){fig-alt="Sustainable fleet cutaway connecting compute racks to power delivery, cooling loops, grid sources, carbon accounting, efficiency controls, and lifecycle management."}
:::
