...
::: {.column-margin}
![](images/svg/vol2_sustainable_ai_margin_003.svg){width="100%" fig-alt="Margin illustration showing Smooth web-serving load versus microsecond training power shock."}
