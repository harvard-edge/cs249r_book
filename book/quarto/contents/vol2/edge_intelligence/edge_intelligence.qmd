...
class EdgeNpuSpeedup:
    ...
    npu_cpu_energy_mj_str = fmt_qty(e_cpu, ureg.millijoule, precision=1, commas=False)
    npu_energy_mj_str = fmt_qty(e_npu, ureg.millijoule, precision=3, commas=False)
...
class EdgeBattery:
    ...
    battery_energy_wh_str = fmt_qty(energy, ureg.watt_hour, precision=2, commas=False, unit_label="Wh")
    battery_drain_pct_str = fmt_percent(round(drain_pct)/100, precision=0, commas=False, style='prose')
    battery_total_wh_str = fmt_qty_int(battery, ureg.watt_hour, commas=False, unit_label="Wh")
```
