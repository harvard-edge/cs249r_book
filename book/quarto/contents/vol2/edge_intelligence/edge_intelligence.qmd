...
As a worked example, consider a production federated deployment with 100 clients: $K = 100$ total clients in the population, $C = 10$ clients selected per round, $E = 5$ local epochs per round, target optimality gap $\epsilon = 0.01$, and two scenarios comparing IID data $(\beta = 0)$ versus moderately non-IID data $(\beta = 1.5)$.
