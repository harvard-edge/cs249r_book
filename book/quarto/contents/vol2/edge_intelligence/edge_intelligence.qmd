...
\noindent
![](images/png/cover_edge_intelligence_blueprint_print.png){fig-alt="Cloud-to-edge blueprint where a central model reaches heterogeneous devices, private local data stays on device, and update streams return to aggregation."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_edge_intelligence_blueprint.webp){fig-alt="Cloud-to-edge blueprint where a central model reaches heterogeneous devices, private local data stays on device, and update streams return to aggregation."}
:::
...
class EdgeNpuSpeedup:
    ...
    # The narrative anchors on 20x speedup and 60x energy gain
    t_cpu = p_cpu.latency
    t_npu = t_cpu / 20.0
    e_cpu = p_cpu.energy
    e_npu = e_cpu / 60.0
