...
These scenarios require on-device learning, where models must train and adapt directly on the devices where they operate.[^fn-a11-bionic-breakthrough] This shifts machine learning from centralized training to distributed learning across millions of heterogeneous devices, each operating under unique constraints and local conditions.
...
::: {.callout-note title="Archetype C (Scaled Lighthouse): The Constraints of Autonomy"}
...
::: {.callout-note title="Figure: Communication-Computation Trade-off" collapse="false"}
```{.tikz}
