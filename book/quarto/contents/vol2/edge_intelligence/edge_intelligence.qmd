...
from mlsysim.fmt import check, fmt, fmt_percent, fmt_power, fmt_qty, fmt_qty_int, fmt_time
from mlsysim import Scenarios
...
class StorageWall:
    ...
    ls_adapter_mb_str = fmt(size_adapter.to(MB).magnitude, precision=1, commas=False)
