...
mobile_npu_tops = EdgeIntelligenceSetup.mobile_npu_tops
h100_mem_bw_gbs = EdgeIntelligenceSetup.h100_mem_bw_gbs
phone_battery_wh = EdgeIntelligenceSetup.phone_battery_wh
phone_battery_j = EdgeIntelligenceSetup.phone_battery_j
dram_energy_pj = EdgeIntelligenceSetup.dram_energy_pj
```
...
```{.tikz}
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}, line join=round, node distance=1.5cm, every node/.style={transform shape}]
...
- **Datacenter (H100)**: HBM3 provides `{python} h100_mem_bw_gbs` GB/s bandwidth.
...
\begin{scope}[local bounding box=above]
  % cuboid smaller 1
  \pic at (0,0.25) {square={scalefac=1, picname=B1, channelcolor=BlueLine, Depth=0.5, Height=0.4, Width=1.0}};
  ...
  % trapez 1
  \pic at (2.2,0.35) {trapez={scalefac=0.6, picname=B2, channelcolor=OrangeLine!80, drawchannelcolor=OrangeLine!40, Linewidth=0pt}};

  % rectangle 1
  \pic at ($(B2-DL)+(0,-0.8)$) {square={picname=P1, drawchannelcolor=OrangeLine!60, channelcolor=OrangeLine!80, Linewidth=0pt, Depth=0, Height=0.07, Width=1.2}};

  % cuboid 1
  \pic at ($(B2-DD)!0.5!(B2-GD)+(1.5,-0.375)$) {square={scalefac=1, picname=B3, channelcolor=BlueLine}};
  \node at ($(B3-GL)!0.5!(B3-DD)$) {6C};
  \node[below=1pt of $(B3-DL)!0.5!(B3-DD)$] {R};

  % areas 1
  \foreach \i [count=\c] in {0.5, 1, 1.5, 2} {
    \pic at ($(B3-DD)!0.5!(B3-GD)+(1.75,-0.7+0.8*\i)$) {square={picname=\c B4, drawchannelcolor=OrangeLine!60, channelcolor=OrangeLine!60, Linewidth=0pt, Depth=0.7, Height=0.03, Width=1.5}};
  }

  % rectangle 2
  \pic at ($(1B4-DL)+(0,-0.52)$) {square={picname=P2, drawchannelcolor=OrangeLine!60, channelcolor=OrangeLine!80, Linewidth=0pt, Depth=0, Height=0.07, Width=1.75}};

  % cuboid 2
  \pic at ($(4B4-ZGD)!0.5!(1B4-GD)+(1.65,-0.55)$) {square={scalefac=1, picname=B5, channelcolor=BlueLine}};
  \node at ($(B5-GL)!0.5!(B5-DD)$) {6C};
  \node[below=1pt of $(B5-DL)!0.5!(B5-DD)$] {R};

  % trapez 2
  \pic at ($(B5-DD)!0.5!(B5-GD)+(1.4,0)$) {trapez={scalefac=0.6, picname=B6, channelcolor=OrangeLine!80, drawchannelcolor=OrangeLine!40, Linewidth=0pt}};

  % rectangle 3
  \pic at ($(B6-DL)+(0,-0.8)$) {square={picname=P3, drawchannelcolor=OrangeLine!60, channelcolor=OrangeLine!80, Linewidth=0pt, Depth=0, Height=0.07, Width=1.2}};

  % cuboid smaller 2
  \pic at ($(B6-DD)!0.5!(B6-GD)+(1.45,-0.11)$) {square={scalefac=1, picname=B7, channelcolor=BlueLine, Depth=0.5, Height=0.4, Width=1.0}};
...
\begin{scope}[local bounding box=below, shift={(0,-4.2)}]
  % cuboid smaller 1
  \pic at (0,0.25) {square={scalefac=1, picname=B1_b, channelcolor=white, drawchannelcolor=BlueLine, Depth=0.5, Height=0.4, Width=1.0}};
  \node[anchor=east] (PO_b) at ($($(B1_b-GL)!0.5!(B1_b-DL)$)+(-0.05,0)$) {\tiny $\bullet$ $\bullet$ $\bullet$};

  % trapez 1
  \pic at (2.2,0.35) {trapez={scalefac=0.6, picname=B2_b, channelcolor=white, drawchannelcolor=OrangeLine, Linewidth=0pt}};

  % rectangle 1
  \pic at ($(B2_b-DL)+(0,-0.8)$) {square={picname=P1_b, drawchannelcolor=OrangeLine!60, channelcolor=OrangeLine!80, Linewidth=0pt, Depth=0, Height=0.07, Width=1.2}};

  % cuboid 1
  \pic at ($(B2_b-DD)!0.5!(B2_b-GD)+(1.5,-0.375)$) {square={scalefac=1, picname=B3_b, drawchannelcolor=BlueLine, channelcolor=white}};

  % areas 1
  \foreach \i [count=\c] in {0.5, 1, 1.5, 2} {
    \pic at ($(B3_b-DD)!0.5!(B3_b-GD)+(1.75,-0.7+0.8*\i)$) {square={picname=\c B4_b, drawchannelcolor=OrangeLine, channelcolor=white, Linewidth=0pt, Depth=0.7, Height=0.03, Width=1.5}};
  }

  % rectangle 2
  \pic at ($(1B4_b-DL)+(0,-0.52)$) {square={picname=P2_b, drawchannelcolor=OrangeLine!60, channelcolor=OrangeLine!80, Linewidth=0pt, Depth=0, Height=0.07, Width=1.75}};

  % cuboid 2
  \pic at ($(4B4_b-ZGD)!0.5!(1B4_b-GD)+(1.65,-0.55)$) {square={scalefac=1, picname=B5_b, channelcolor=white, drawchannelcolor=BlueLine}};

  % trapez 2
  \pic at ($(B5_b-DD)!0.5!(B5_b-GD)+(1.4,0)$) {trapez={scalefac=0.6, picname=B6_b, channelcolor=white, drawchannelcolor=OrangeLine, Linewidth=0pt}};

  % rectangle 3
  \pic at ($(B6_b-DL)+(0,-0.8)$) {square={picname=P3_b, drawchannelcolor=OrangeLine!60, channelcolor=OrangeLine!80, Linewidth=0pt, Depth=0, Height=0.07, Width=1.2}};

  % cuboid smaller 2
  \pic at ($(B6_b-DD)!0.5!(B6_b-GD)+(1.45,-0.11)$) {square={scalefac=1, picname=B7_b, channelcolor=white, drawchannelcolor=BlueLine, Depth=0.5, Height=0.4, Width=1.0}};

  %%%%%%%%%%%%%%%%%%%%%
  % The second row
  %%%%%%%%%%%%%%%%%%%%%
  % cuboid smaller 11
  \pic at ($(B1_b-DL)+(0.32,-3.3)$) {square={scalefac=1, picname=B11, channelcolor=BlueLine!80, drawchannelcolor=BlueLine, Depth=0.5, Height=0.4, Width=0.5}};
  \node[left=1pt of $(B11-GL)!0.5!(B11-DL)$] {C};
  \node[below=1pt of $(B11-DL)!0.5!(B11-DD)$] {0.5 R};

  % cuboid smaller 77
  \pic at ($(B7_b-DL)+(0.32,-3.3)$) {square={scalefac=1, picname=B77, channelcolor=white, drawchannelcolor=BlueLine, Depth=0.5, Height=0.4, Width=0.5}};

  % cuboid smaller 33
  \pic at ($(B11-ZDD)!0.5!(B77-ZDD)$) {square={scalefac=1, picname=B33, channelcolor=BlueLine!80, drawchannelcolor=BlueLine, Depth=0.5, Height=0.4, Width=0.5}};
  \node[below=1pt of $(B33-DL)!0.5!(B33-DD)$] {0.5 R};

  % cuboid Group Conv
  \pic at ($(B11-ZDD)!0.45!(B33-ZDD)+(0,-0.4)$) {square={scalefac=1, picname=B22D, channelcolor=OrangeLine!80, drawchannelcolor=OrangeLine, Depth=0.5, Height=0.4, Width=1.5}};
  \pic at ($(B11-ZDD)!0.45!(B33-ZDD)+(0,0.4)$) {square={scalefac=1, picname=B22G, channelcolor=OrangeLine!80, drawchannelcolor=OrangeLine, Depth=0.5, Height=0.4, Width=1.5}};

  % rectangle 11
  \pic at ($(B22D-DL)+(0,-0.4)$) {square={picname=P11, drawchannelcolor=OrangeLine!60, channelcolor=OrangeLine!80, Linewidth=0pt, Depth=0, Height=0.07, Width=1.55}};

  % 1x1Conv
  \node[draw=OrangeLine, fill=OrangeLine!30, line width=0.75pt, minimum size=9mm, yshift=1mm] (RE) at ($(B33-ZDD)!0.4!(B77-ZDD)$) {};
  \pic at ($(P11-DD)!0.5!(P11-GD) -| RE.south west$) {square={picname=P22, drawchannelcolor=OrangeLine!60, channelcolor=OrangeLine!80, Linewidth=0pt, Depth=0, Height=0.07, Width=0.9}};
...
\tikzset{
   Circ/.style={circle,minimum size=27mm,align=center},
   ...
   server/.style={draw=RedLine, line width=1.25pt, fill=VioletL2, minimum width=1.1cm, minimum height=1.0cm, inner sep=0pt},
   man/.style={scale=1, every node/.append style={transform shape}}
}
...
::: {.callout-note title="Communication-Computation Tradeoff" collapse="false"}
```{.tikz}
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}, scale=0.85]
  ...
  \node[Label, below=2pt of origin, xshift=2cm] {Sweet spot};
  \node[Label, align=center] at (4,2.2) {Client drift\\dominates};

  % Axis labels
  \node[Label, below=2pt of origin, xshift=1cm] {1};
  \node[Label, below=2pt of origin, xshift=4cm] {5};
  \node[Label, below=2pt of origin, xshift=7cm] {10};
  \node[Label, left=2pt of origin, yshift=1cm] {100};
  \node[Label, left=2pt of origin, yshift=2.5cm] {500};
  \node[Label, left=2pt of origin, yshift=4cm] {1000};
\end{tikzpicture}
```
...
::: {.callout-note title="Figure: Gradient Compression Techniques" collapse="false"}
```{.tikz}
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}]
  ...
  \begin{scope}[local bounding box=std]
    \node[Box] (s1) {0.5};
    \node[Box, right=0pt of s1] (s2) {-0.2};
    \node[Box, right=0pt of s2] (s3) {0.01};
    \node[Box, right=0pt of s3] (s4) {0.8};
  ...
  \begin{scope}[local bounding box=quant, right=1.5cm of std]
    \node[BoxOrange] (q1) {+1};
    \node[BoxOrange, right=0pt of q1] (q2) {0};
    \node[BoxOrange, right=0pt of q2] (q3) {0};
    \node[BoxOrange, right=0pt of q3] (q4) {+2};
  ...
  \begin{scope}[local bounding box=sparse, right=1.5cm of quant]
    ...
    \node[BoxGreen, right=0pt of sp1] (sp2) {-};
    \node[BoxGreen, right=0pt of sp2] (sp3) {-};
    \node[BoxGreen, right=0pt of sp3] (sp4) {0.8};
...
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}, scale=0.9, transform shape]
  ...
  \node[Box, right=of clientA, xshift=4cm] (clientB) {Client B\\$W_B$};

  % Secret Exchange
  \draw[SecretLine] (clientA) -- node[above, font=\scriptsize, align=center, text=black] {Shared Secret Mask\\$M_{AB}$} (clientB);

  % Mask Application
  \node[MaskBox, below=of clientA, yshift=-0.5cm] (masA) {$W_A + M_{AB}$};
  \node[MaskBox, below=of clientB, yshift=-0.5cm] (masB) {$W_B - M_{AB}$};

  \draw[Line] (clientA) -- (masA);
  \draw[Line] (clientB) -- (masB);

  % Server
  \node[ServerBox, below=of masA, xshift=2cm, yshift=-1.5cm] (server) {Aggregation Server};
  ...
  % Calculation
  \node[below=of server, yshift=-0.2cm, align=center, font=\scriptsize] {Summing cancels mask:\\$(W_A + M_{AB}) + (W_B - M_{AB})$\\$= W_A + W_B$};
...
::: {.callout-note title="Figure: Shadow Mode Validation" collapse="false"}
```{.tikz}
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}, node distance=1.2cm]
  ...
  \node[ArbiterBlock, below=2.5cm of Input] (Arbiter) {\textbf{Arbiter / Comparator}\\Drift Detection};
...
::: {.callout-note title="Figure: Tiered Adaptation Strategy" collapse="false"}
```{.tikz}
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}, node distance=0.5cm]
  \tikzset{
    tier/.style={line width=0.75pt, draw=black!70, fill opacity=0.5},
    ...
    BlueL/.style={fill=blue!30, draw=blue!70},
    GreenL/.style={fill=green!30, draw=green!70},
    OrangeL/.style={fill=orange!30, draw=orange!70}
  }

  % Pyramid tiers using nodes
  \node[tier, BlueL, anchor=south] (tier1) at (0, 3) [minimum width=2cm, minimum height=1cm] {};
  \node[tier, GreenL, anchor=north, below=of tier1] (tier2) [minimum width=3cm, minimum height=1cm] {};
  \node[tier, OrangeL, anchor=north, below=of tier2] (tier3) [minimum width=5cm, minimum height=1cm] {};
