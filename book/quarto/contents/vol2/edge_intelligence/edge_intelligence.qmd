...
- Contrast **centralized cloud training**\index{Training!centralized cloud}, **on-device learning**, and **federated learning** by analyzing their data flow, privacy properties, and operational trade-offs.
...
- Integrate on-device learning into production MLOps by implementing **device-aware deployment**\index{Deployment!device-aware}, **distributed validation**\index{Distributed Validation}, and **privacy-preserving monitoring** across heterogeneous populations.
...
[^fn-tensor-soc-federated]: **Google Tensor SoC (2021)**: Features a custom Edge Tensor Processing Unit (TPU) derived from Google's datacenter TPU v1, optimized for 8-bit integer ML operations at 2 W. Unlike general-purpose NPUs, Tensor is co-designed with TensorFlow Lite and federated learning infrastructure, reducing the software overhead of local training. This tight hardware-software coupling demonstrates the trend toward ML-specific SoC design for on-device adaptation. \index{Tensor!google, federated learning}
