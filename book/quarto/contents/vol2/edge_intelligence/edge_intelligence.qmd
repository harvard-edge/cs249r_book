...
1.  **Phone Battery**: Typical capacity is 15 Wh (Watt-hours) $\approx$ 54,000 Joules.
2.  **Budget**: 5% of 54,000 J = **2,700 Joules**.
3.  **Training Cost**:
...
::: {.callout-fallacy title="On-device learning provides the same adaptation capabilities as cloud-based training."}
:::
...
::: {.callout-pitfall title="Assuming that federated learning automatically preserves privacy without additional safeguards."}
:::
...
::: {.callout-fallacy title="Resource-constrained adaptation always produces better personalized models than generic models."}
:::
...
::: {.callout-pitfall title="Ignoring the heterogeneity challenges across different device types and capabilities."}
:::
...
::: {.callout-pitfall title="Underestimating the complexity of orchestrating learning across distributed edge systems."}
:::
