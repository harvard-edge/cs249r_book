...
class EdgeNpuSpeedup:
    ...
    npu_cpu_energy_mj_str = fmt(e_cpu_j * THOUSAND, precision=1, commas=False, suffix=' mJ')
    npu_energy_mj_str = fmt(e_npu_j * THOUSAND, precision=3, commas=False, suffix=' mJ')
...
class EdgeFedPowerEnvelopeRecap:
    ...
    sustained_low_w = Scenarios.MobilePower.MobileMlSustainedLow.m_as(watt)
    sustained_high_w = Scenarios.MobilePower.MobileMlSustainedHigh.m_as(watt)
    background_low_mw = Scenarios.MobilePower.BackgroundAdaptationLow.m_as(milliwatt)
    background_high_mw = Scenarios.MobilePower.BackgroundAdaptationHigh.m_as(milliwatt)
    ...
    background_range_str = MarkdownStr(
        ...
        f"{fmt(background_high_mw, precision=0, commas=False, suffix=' mW')}"
    )
```
