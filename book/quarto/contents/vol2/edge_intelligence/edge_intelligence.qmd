...
\noindent
![](images/png/cover_edge_intelligence_blueprint.png){fig-alt="Cloud-to-edge blueprint where a central model reaches heterogeneous devices, private local data stays on device, and update streams return to aggregation."}
