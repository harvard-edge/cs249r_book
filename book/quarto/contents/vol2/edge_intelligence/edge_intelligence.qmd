...
***On-Device Learning***\index{On-Device Learning!definition} is the local training or adaptation of machine learning models directly on deployed hardware without server connectivity, enabling _personalization_, _privacy preservation_, and _autonomous operation_ under severe resource constraints.
...
***Federated Learning***\index{Federated Learning!definition} is a decentralized training approach in which distributed devices collaboratively train a _shared model_ using _local data_ while exchanging only _model updates_, preserving _privacy_ through data localization.
