...
3.  **Common Pitfall:** A frequent misconception is that on-device learning requires training from scratch. In reality, it is almost always **On-Device Adaptation**: fine-tuning a small subset of a pretrained "Teacher" model to fit the specific data distribution of a local environment.
