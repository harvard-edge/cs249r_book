...
These failure modes connect individual drift, population bias, and data-quality degradation. Successful deployments bound adaptation, stratify sampling to address participation bias, distinguish corrections from reliable labels, and use shadow comparisons to detect change that warrants validated evaluation. The research literature identifies these patterns as critical deployment risks even though production incidents are rarely disclosed [@li2020; @kairouz2021].
