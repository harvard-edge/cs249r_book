...
*Shows why on-device learning is constrained by memory, not only compute.*
:::
...
*Shows adapters making personalization storage-dense compared with full model copies.*
:::
...
*Shows catastrophic forgetting as new-task gain paired with old-task decay.*
:::
...
*Shows federated learning reducing network load by sending updates instead of raw data.*
:::
