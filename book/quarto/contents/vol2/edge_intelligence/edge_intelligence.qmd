...
class EdgeBattery:
    ...
    battery_wh = ReferenceStats.PhoneBattery.EnergyWh.m_as(watt * hour)  # Modern flagship smartphone battery
    # ┌── 2. EXECUTE ───────────────────────────────────────
...
class EdgeFedPowerEnvelopeRecap:
    ...
    sustained_low_w = ReferenceStats.MobilePower.MobileMlSustainedLow.m_as(watt)
    sustained_high_w = ReferenceStats.MobilePower.MobileMlSustainedHigh.m_as(watt)
    background_low_mw = ReferenceStats.MobilePower.BackgroundAdaptationLow.m_as(milliwatt)
    background_high_mw = ReferenceStats.MobilePower.BackgroundAdaptationHigh.m_as(milliwatt)
