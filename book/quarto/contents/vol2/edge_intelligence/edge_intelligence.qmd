...
Attempting to fine-tune a neural network on a smartphone is a thermodynamic battle. A typical GPU training cluster consumes megawatts of power, while a smartphone must execute backpropagation on a 10 W thermal budget without burning the user's hand. At a sustained 10 W draw, an idealized 15 Wh battery would be exhausted in about 1.5 hours, while thermal discomfort or throttling may constrain the workload much sooner. These severe constraints force us to radically redesign our learning algorithms to be hyper-efficient in compute, memory, and data.
