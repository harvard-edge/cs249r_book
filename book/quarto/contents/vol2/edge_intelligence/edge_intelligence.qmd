...
from mlsysim.fmt import check, fmt, fmt_int, fmt_percent, fmt_qty, fmt_qty_int
...
class EdgeH100BwRecap:
    ...
    from mlsysim.fmt import fmt_qty_int
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    h100_mem_bw_gbs_str = fmt_qty_int(h100_mem_bw, GB/second)
```
...
1. **Total Energy**: `{python} EdgeBattery.battery_power_w_str` $\times$ `{python} EdgeBattery.battery_duration_h_str` h = `{python} EdgeBattery.battery_energy_wh_str`.
