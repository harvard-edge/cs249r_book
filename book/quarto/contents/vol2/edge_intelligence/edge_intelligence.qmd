...
The operational patterns examined above are attempts to make continual learning fit an extreme efficiency target. The human brain operates at approximately 20 watts while continuously learning from limited supervision without catastrophic forgetting[^fn-brain-power-efficiency]. This comparison does not make biology a deployment recipe; it explains why edge systems keep returning to sparsity, replay, and opportunistic updates.
