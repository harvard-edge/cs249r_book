...
**Problem**: A team is designing a federated health monitor that learns from `{python} FederatedSavings.fs_raw_data_mb_str` MB of user sensor data per week. Should the system upload the raw data to the cloud for training, or use **Federated Learning** to send model updates instead?
