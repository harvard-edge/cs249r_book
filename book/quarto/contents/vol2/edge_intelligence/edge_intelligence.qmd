...
- [ ] **Backward-pass OOM**: Explain why a 100M parameter model can still trigger out-of-memory errors during the backward pass on a smartphone with `{python} EdgeAdaptationTierProfile.smartphone_ram_gb_str` of RAM.
...
2.  **Privacy**: Estimate the noise required under a strict privacy budget of $\varepsilon < 5$ and explain its convergence-time cost.
