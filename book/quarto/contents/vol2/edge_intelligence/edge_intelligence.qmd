...
* **The Mobile memory wall**\index{Mobile Memory Wall}: While NPUs provide raw compute (TOPS), on-device LLMs are strictly bandwidth-bound. The 30--50$\times$ gap between mobile RAM and datacenter HBM makes quantization a mandatory "bandwidth survival strategy" for interactive decode speeds.
