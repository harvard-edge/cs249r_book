...
# │ Exports: EdgeFedNpuRecap.mobile_npu_tops_str, compute_ratio_mult_str
class EdgeFedNpuRecap:
    from mlsysim.fmt import check, fmt_int, fmt_ops_rate
    mobile_npu_rate = Hardware.Mobile.iPhone15Pro.compute.peak_flops
