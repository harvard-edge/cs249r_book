...
2.  **Distinction**: Unlike Centralized Training\index{Training!centralized}, where data is moved to the compute, federated learning moves the Compute to the Data\index{Compute to the Data}, ensuring that raw information never leaves the device.
