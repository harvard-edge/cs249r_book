...
class RealTimeFairnessMonitor:
    ...
    def _compute_metrics(self):
        # Bucket predictions (and labels, when present) by protected
        # group.
        by_group = {}
        ...
        # Demographic parity: spread in positive-prediction rate
        # across groups.
        rates = [
            np.mean(d["preds"])
    ...
    def _equalized_odds_gap(self, by_group):
        # Largest TPR/FPR gap across groups meeting
        # min_labeled_per_group;
        # per-group rate computation omitted for brevity.
        ...
