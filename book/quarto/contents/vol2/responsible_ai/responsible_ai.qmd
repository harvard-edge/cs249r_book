...
class RepresentationTax:
    ...
    acquisition_total_usd_m_str = fmt_usd(acquisition_total_m, precision=0, commas=False, suffix="M")
    harmonized_low_usd_m_str = fmt_usd(harmonized_low_m, precision=1, commas=False, suffix="M")
    harmonized_high_usd_m_str = fmt_usd(harmonized_high_m, precision=1, commas=False, suffix="M")
...
class ExplainabilityRetrofitCost:
    ...
    shap_overhead_low_ms_str = fmt(overhead_low_ms, precision=0, commas=False, suffix=' ms')
    shap_overhead_high_ms_str = fmt(overhead_high_ms, precision=0, commas=False, suffix=' ms')
    shap_total_low_ms_str = fmt(total_low_ms, precision=0, commas=False, suffix=' ms')
