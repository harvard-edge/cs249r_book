...
::: {.column-margin}
![](images/svg/vol2_responsible_ai_margin_002.svg){width="100%" fig-alt="Margin illustration showing AI accuracy rises while human override rate falls."}
...
::: {.column-margin}
![](images/svg/vol2_responsible_ai_margin_003.svg){width="100%" fig-alt="Margin illustration showing Contestability stack: provenance, explain, appeal, track."}
...
::: {.column-margin}
![](images/svg/vol2_responsible_ai_margin_004.svg){width="100%" fig-alt="Margin illustration showing Rare failures become guaranteed incidents at fleet scale."}
