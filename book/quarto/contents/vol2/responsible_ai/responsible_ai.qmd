...
class UnlearningCostAnalysis:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    from mlsysim.fmt import fmt, fmt_time, fmt_usd
    ...
    acc_drop_high_pct_str = fmt_percent(acc_drop_high_pct/100, precision=0, commas=False, style='prose')
...
::: {.column-margin}
![](images/svg/vol2_responsible_ai_margin_001.svg){width="100%" fig-alt="Margin illustration showing Exact SHAP subset evaluations explode from 3 to 20 features."}
