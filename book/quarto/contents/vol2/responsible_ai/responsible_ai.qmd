...
::: {.callout-notebook title="Napkin Math: The Fairness Tax"}
...
::: {.callout-notebook title="Napkin Math: The Price of Privacy"}
...
::: {.callout-notebook title="Napkin Math: The Cost of Forgetting"}
...
::: {.callout-notebook title="Napkin Math: The Representation Tax"}
...
The next chapter, @sec-responsible-engineering, examines how we can point this massive fleet toward solving the world's most urgent social challenges, from healthcare in resource-poor regions to climate adaptation. We move from *preventing harm* to *proactively doing good*.
