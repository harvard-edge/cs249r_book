...
**Key Insight:** This model violates all three fairness criteria. Addressing one criterion does not automatically satisfy others. In fact, they can conflict, as we will see next.
