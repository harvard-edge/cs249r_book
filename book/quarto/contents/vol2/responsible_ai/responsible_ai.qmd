...
: **Performance Impact of Responsible AI Techniques**\index{Performance Impact of Responsible AI Techniques}: Quantitative analysis reveals that responsible AI techniques impose measurable computational overhead across training and inference phases. Differential privacy and fairness constraints add modest overhead while explainability methods (TreeSHAP and other approximate variants; exact SHAP imposes 50--1000$\times$ overhead, as discussed in @sec-responsible-ai-resource-requirements-equity-implications-b967) can significantly increase inference costs. These metrics help engineers optimize responsible AI implementations for production constraints. {#tbl-responsible-ai-overhead}
...
With responsible governance now joined to performance, security, robustness, and sustainability, every dimension of production ML systems has been addressed. Together, these chapters form a complete engineering framework for building systems that are not only powerful but trustworthy.
