...
\noindent
![](images/png/cover_responsible_ai_blueprint_print.png){fig-alt="Fleet governance overlay wrapping data, training, serving, monitoring, policy, fairness, privacy, audit, accountability, and incident response."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_responsible_ai_blueprint.webp){fig-alt="Fleet governance overlay wrapping data, training, serving, monitoring, policy, fairness, privacy, audit, accountability, and incident response."}
:::
