...
::: {#cs-responsible-ai-apple-card-cost-missing-explanations .callout-case-study title="Apple Card: The cost of missing explanations"}

**Context**: In 2019, Apple and Goldman Sachs faced intense public scrutiny when prominent tech leaders, including Steve Wozniak, reported receiving credit limits 10$\times$ higher than their spouses despite shared finances and comparable credit profiles [@nydfs2021applecard].
...
::: {#cs-responsible-ai-algorithmic-grading-failure .callout-case-study title="The algorithmic grading failure"}
