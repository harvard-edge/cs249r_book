...
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}]
  \definecolor{JobAColor}{RGB}{0,99,149}    % BlueLine
  \definecolor{JobBColor}{RGB}{204,85,0}  % OrangeLine

  \tikzset{
    bar/.style={draw=black!60, thick, minimum height=0.6cm, align=center},
    deadlock/.style={fill=red!20, draw=red, thick, inner sep=2pt}
  }
