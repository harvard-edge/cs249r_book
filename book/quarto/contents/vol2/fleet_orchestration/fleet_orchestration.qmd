...
class ClusterEconomicsContext:
    ...
    gpu_hour_cost_usd = Infrastructure.Pricing.Fleet.GpuHourRef.rate.m_as("dollar / hour")
    idle_fraction = 0.30
    util_low = 0.50
    util_high = 0.80
...
class GangSchedulingDeadlock:
    ...
    gpu_hour_cost = Infrastructure.Pricing.Fleet.GpuHourRef.rate.m_as("dollar / hour")
...
# ┌── 2. ARRAYS ────────────────────────────────────────────────────────────────
gpu_cost_per_hour = Infrastructure.Pricing.Fleet.GpuHourRef.rate.m_as("dollar / hour")
...
class FleetSpotPricing:
    hourly_rate = Infrastructure.Pricing.Fleet.GpuHourRef.rate.m_as("dollar / hour")
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
...
class SpotTrainingEconomics:
    ...
    on_demand_rate = Infrastructure.Pricing.Fleet.GpuHourRef.rate.m_as("dollar / hour")
    spot_rate = Infrastructure.Pricing.Fleet.SpotGpuHourRef.rate.m_as("dollar / hour")
...
class GpuSharingRoi:
    ...
    gpu_rate = Infrastructure.Pricing.Fleet.GpuHourRef.rate.m_as("dollar / hour")
    # ┌── 2. EXECUTE ───────────────────────────────────────
...
class ChargebackExample:
    ...
    gpus = 64
    days = 34
    gpu_hour_rate = Infrastructure.Pricing.Fleet.InternalChargebackPerHour.rate.m_as("dollar / hour")
    # ┌── 2. EXECUTE ───────────────────────────────────────
...
class PreemptionTax:
    ...
    reload_minutes = 20
    warmup_minutes = 10
    gpu_hour_rate = Infrastructure.Pricing.Fleet.GpuHourRef.rate.m_as("dollar / hour")
...
class DebugValueCalc:
    ...
    _gpu_rate          = Infrastructure.Pricing.Fleet.GpuHourRef.rate.m_as("dollar / hour")
