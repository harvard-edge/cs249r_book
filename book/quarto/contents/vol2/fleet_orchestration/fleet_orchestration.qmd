...
\noindent
![](images/png/cover_fleet_orchestration_blueprint_print.png){fig-alt="Scheduler control-plane blueprint where queued jobs are placed onto topology-aware accelerator capacity with preemption, recovery, and policy constraints."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_fleet_orchestration_blueprint.webp){fig-alt="Scheduler control-plane blueprint where queued jobs are placed onto topology-aware accelerator capacity with preemption, recovery, and policy constraints."}
:::
