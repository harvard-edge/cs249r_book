...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, check, fmt_qty, fmt_usd, fmt_percent
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, check, MarkdownStr, fmt_count, fmt_params, fmt_time, fmt_usd
...
class SpotTrainingEconomics:
    ...
    spot_base_cost_str = fmt_usd(spot_base_cost, precision=1)
    ...
    spot_total_cost_str = fmt_usd(spot_total_cost, precision=1)
    savings_str = fmt_usd(savings, precision=1)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt_qty, fmt_qty_int, fmt, check, fmt_count, fmt_params, fmt_usd
...
class GpuSharingRoi:
    ...
    gs_annual_str = fmt_usd(annual_savings, precision=0)
...
Sharing reduces the fleet size by `{python} GpuSharingRoi.gs_saved_pct_str` (`{python} GpuSharingRoi.gs_saved_gpus_str` fewer GPUs). At `{python} GpuSharingRoi.gs_gpu_hour_rate_str`, this saves approximately `{python} GpuSharingRoi.gs_annual_str` annually in compute costs, purely through scheduling policy.
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, MarkdownStr, check, fmt_usd
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int,  fmt, check, fmt_usd
...
class DebugValueCalc:
    ...
    debug_annual_str    = fmt_usd(debug_annual, scale="M", precision=0, commas=False)
