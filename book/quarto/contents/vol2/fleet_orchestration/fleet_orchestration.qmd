...
class ClusterEconomicsMigRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    a100_mem_gb_str = fmt_memory_capacity(Hardware.Cloud.A100.memory.capacity, unit=GB, precision=0, commas=False)
    ...
    mig_1g_mem_str = fmt_memory_capacity(_mig["1g.10gb"].gpu_memory, unit=GB, precision=0, commas=False)
    mig_1g_sm_str = fmt(_mig["1g.10gb"].sm_count, precision=0, commas=False)
    mig_2g_mem_str = fmt_memory_capacity(_mig["2g.20gb"].gpu_memory, unit=GB, precision=0, commas=False)
    mig_2g_sm_str = fmt(_mig["2g.20gb"].sm_count, precision=0, commas=False)
    mig_3g_mem_str = fmt_memory_capacity(_mig["3g.40gb"].gpu_memory, unit=GB, precision=0, commas=False)
    mig_3g_sm_str = fmt(_mig["3g.40gb"].sm_count, precision=0, commas=False)
    mig_7g_mem_str = fmt_memory_capacity(_mig["7g.80gb"].gpu_memory, unit=GB, precision=0, commas=False)
...
class GpuSharingRoi:
    ...
    gs_excl_total_mem_gb_str = fmt_memory_capacity(excl_total_mem, unit=GB, precision=0)
...
class DebugValueCalc:
    ...
    a100_80_memory_str = fmt_memory_capacity(a100_80_memory, unit=GB, precision=0, commas=False)
    a100_40_memory_str = fmt_memory(a100_40_memory, unit=GB, precision=0, commas=False)
    v100_memory_str = fmt_memory_capacity(v100_memory, unit=GB, precision=0, commas=False)
