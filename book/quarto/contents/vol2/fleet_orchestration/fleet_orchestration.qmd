...
# │          nvlink_h100_gb_per_s_str, ib_ndr_gb_per_s_str
...
class FleetFragmentation:
    ...
    nvlink_h100_gb_per_s_str = fmt_qty(h_h100.nvlink.bandwidth, GB/second, precision=0)
...
# │ Exports: FleetTopologyInterconnect.nvlink_a100_gb_per_s_str, nvlink_h100_gb_per_s_str,
# │          ib_ndr_gbit_per_s_str, ib_ndr_gb_per_s_str
...
# │ Exports: FleetDebugNvlinkRecap.nvlink_a100_gb_per_s_str
from mlsysim.fmt import fmt_qty
...
|:---------------|:---------:|:-----------:|:------------------------------------------------------------------:|:------------------------:|
| **A100-80 GB** |    400    | 80 GB HBM2e | NVLink (`{python} FleetDebugNvlinkRecap.nvlink_a100_gb_per_s_str`) | 50 nodes $\times$ 8 GPUs |
| **A100-40 GB** |    400    | 40 GB HBM2e | NVLink (`{python} FleetDebugNvlinkRecap.nvlink_a100_gb_per_s_str`) | 50 nodes $\times$ 8 GPUs |
