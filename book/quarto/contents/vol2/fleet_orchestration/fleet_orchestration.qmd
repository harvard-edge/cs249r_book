...
# │
# │ Imports: mlsysim (Hardware, Systems, units), mlsysim.fmt (fmt_count, fmt_percent, fmt_qty)
...
# │
# │ Imports: mlsysim (Systems, Infrastructure, units), mlsysim.fmt (fmt, fmt_usd, fmt_percent)
# │ Exports: ClusterEconomicsIdleRecap.cluster_size_str, daily_cost_str, annual_cost_str,
# │          util_*_pct_str, productive_*_str, idle_*_str, waste_*_str, savings_*_str
# └─────────────────────────────────────────────────────────────────────────────
...
# │
# │ Imports: mlsysim (Hardware), mlsysim.core.units (GiB, GB), mlsysim.fmt (fmt_memory_capacity)
# │ Exports: ClusterEconomicsMigRecap.a100_mem_gb_str, h100_mem_gb_str,
# │          and per-MIG-profile mig_<slice>_mem_str / mig_<slice>_sm_str (table cells)
# └─────────────────────────────────────────────────────────────────────────────
...
# │
# │ Imports: mlsysim (Hardware, Systems, units), mlsysim.fmt (fmt, check, fmt_bandwidth, fmt_time, fmt_qty, fmt_multiple)
# │ Exports: FleetTopologyInterconnect.nvlink_a100_gb_per_s_str, nvlink_h100_gb_per_s_str,
# │          nvlink_h100_perdir_gb_per_s_str, ib_ndr_gbit_per_s_str, ib_ndr_gb_per_s_str,
# │          activation_gb_str, nvlink_xfer_ms_str, ib_xfer_ms_str, xfer_slowdown_mult_str
# └─────────────────────────────────────────────────────────────────────────────
...
# │
# │ Imports: mlsysim.book (fmt, check)
# │ Exports: es_s3p1_str, es_s3p2_str, es_s3_str,
# │          es_s1_math, es_s2_math, es_s3p1_math, es_s3p2_math,
...
# │
# │ Imports: mlsysim (Infrastructure, units), mlsysim.fmt (fmt_usd)
