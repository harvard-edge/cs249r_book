...
::: {.column-margin}
![](images/svg/vol2_fleet_orchestration_margin_001.svg){width="100%" fig-alt="Margin illustration showing Fleet failure rate rises from single GPU to 10,000 GPUs."}

*Shows fleet failures emerging from normal component failure rates.*
:::
...
::: {.column-margin}
![](images/svg/fleet_orchestration_dependency_cascade.svg){width="100%" fig-alt="A tree rooted at one red square fanning out to three middle nodes, each splitting into two leaf nodes, showing one fault cascading through a dependency chain from one to a few to many."}

*One root failure cascades through the dependency tree.*
:::
...
::: {.column-margin}
![](images/svg/vol2_fleet_orchestration_margin_002.svg){width="100%" fig-alt="Margin illustration showing Elastic scaling curve with linear, sublinear, and saturation phases."}

*Shows elastic scaling moving from linear benefit to saturation.*
:::
...
::: {.column-margin}
![](images/svg/vol2_fleet_orchestration_margin_003.svg){width="100%" fig-alt="Margin illustration showing Demand exceeds capacity until delayed scale-up closes the gap."}

*Shows reactive autoscaling leaving an SLO gap during cold-start delay.*
:::
...
::: {.column-margin}
![](images/svg/vol2_fleet_orchestration_margin_004.svg){width="100%" fig-alt="Margin illustration showing Allocated, compute-active, and productive GPUs."}

*Shows the gap between allocated, compute-active, and productive utilization.*
:::
