...
***Priority Inversion**\index{*priority Inversion!definition}*\index{Priority Inversion!definition} is an ML cluster scheduling pathology in which a high-priority task is forced to wait for a lower-priority task to release a shared resource.
