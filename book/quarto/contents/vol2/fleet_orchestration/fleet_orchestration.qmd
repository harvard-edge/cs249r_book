...
class FleetTopologyInterconnect:
    ...
    # ┌── 2. EXECUTE ───────────────────────────────────────
    nvlink_xfer = (activation / h_h100.nvlink.bandwidth).to(ms)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, check, MarkdownStr, fmt_count, fmt_params, fmt_time
...
class SpotTrainingEconomics:
    ...
    model_params_b_str = fmt_params(70 * BILLION, precision=0, commas=False)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt_qty, fmt_qty_int, fmt, check, fmt_count, fmt_params
...
class GpuSharingRoi:
    ...
    gs_shared_mem_str = fmt_qty(shared_mem_per_gpu_q, GiB, precision=0, unit_label="GB")
    ...
    gs_small_footprint_str = fmt_qty(small_footprint, GiB, precision=0, commas=False, unit_label="GB")
