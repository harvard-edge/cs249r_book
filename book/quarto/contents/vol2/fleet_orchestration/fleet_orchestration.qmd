...
The first diagnostic step is infrastructure-layer analysis\index{Infrastructure Layer!analysis}. @Tbl-fleet-orchestration-debug-inventory shows the cluster's heterogeneous hardware across three procurement cycles:
...
**Impact**: @Tbl-fleet-orchestration-debug-results reports the two-week validation result after implementing tiered matching and backfill scheduling:
