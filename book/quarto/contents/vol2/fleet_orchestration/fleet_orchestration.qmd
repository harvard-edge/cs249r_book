...
::: {.column-margin}
![](images/png/fleet_orchestration_util_knee.png){width="100%" fig-alt="A wait-time curve that stays flat at low utilization then turns sharply upward toward the right, with a marked knee and a shaded danger zone past it."}
:::
...
::: {.column-margin}
![](images/png/fleet_orchestration_preempt_cascade.png){width="100%" fig-alt="One red source node on the left with arrows fanning out to five separate downstream nodes on the right, showing one event displacing many."}
