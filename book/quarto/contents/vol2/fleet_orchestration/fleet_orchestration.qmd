...
::: {.callout-notebook title="Napkin Math: The Queuing Theory of GPU Clusters"}
...
**Priority inversion** occurs when a high-priority task is forced to wait for a lower-priority task to release a shared resource, effectively lowering the high-priority task's execution speed to that of the low-priority one. In distributed systems, this often manifests when a low-priority job holding a critical lock or hardware resource is starved of auxiliary resources (like CPU or bandwidth) by medium-priority jobs, preventing it from releasing the resource needed by the high-priority job.
:::
...
::: {.callout-notebook title="Napkin Math: The Elastic Scaling Decision"}
...
::: {.callout-notebook title="Napkin Math: The Autoscaling Lag"}
...
::: {.callout-notebook title="Napkin Math: GPU Sharing ROI"}
...
::: {.callout-notebook title="Napkin Math: The Diurnal GPU Shift"}
