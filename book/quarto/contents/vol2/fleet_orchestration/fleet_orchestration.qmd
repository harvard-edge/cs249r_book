...
class ElasticScaling:
    ...
    es_vs_wait_pct_str = fmt_percent(elastic_vs_wait_pct/100, precision=1, commas=False, style='prose')
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, check, MarkdownStr, fmt_count
...
class SpotTrainingEconomics:
    ...
    model_params_b_str = fmt_count(70 * BILLION, scale='B', precision=0, commas=False)
...
class GpuSharingRoi:
    ...
    gs_small_model_b_str = fmt_count(small_model_params_b * BILLION, scale='B', precision=0, commas=False)
    gs_large_model_b_str = fmt_count(
        Models.Language.GPT3.parameters.m_as(param),
        scale='B',
        precision=0,
        commas=False,
    )
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_int, check, MarkdownStr, fmt_percent
...
class DebugValueCalc:
    ...
    debug_target_util_pct_str = fmt_percent(80/100, precision=0, commas=False, style='prose')
```
