...
A common fallacy is this: *More sophisticated scheduling algorithms always improve utilization.*
...
A recurring pitfall is this: *Treating all GPU-hours as equal when measuring utilization.*
...
A common fallacy is this: *Gang scheduling is always necessary for distributed training.*
...
A recurring pitfall is this: *Setting static quotas based on peak demand.*
...
A common fallacy is this: *Spot instances are always cheaper for training.*
...
A recurring pitfall is this: *Ignoring topology when scheduling distributed training.*
...
A common fallacy is this: *GPU utilization alone is a sufficient autoscaling signal.*
...
A recurring pitfall is this: *Using elastic training to avoid gang-scheduling decisions.*
...
A common fallacy is this: *The scheduler needs no workload-specific validation.*
...
A recurring pitfall is this: *Treating high utilization as proof of cluster health.*
