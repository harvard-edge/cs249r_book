...
[^fn-hyperscale]: **Hyperscale Data Centers**: Massive facilities (5,000+ servers, 10,000+ sq ft) achieving economies of scale in compute, cooling, and power. Microsoft operates 200+ locations; Google's newest consume 200+ MW (equivalent to 80,000 homes). AI workloads drive specialized designs with liquid cooling, direct DC power, and accelerator-optimized networking.
...
[^fn-npu]: **Neural Processing Unit (NPU)**: Domain-specific accelerators optimized for tensor operations with high parallelism and energy efficiency. Apple's Neural Engine (16-core, 35 TOPS) handles Face ID and computational photography; Qualcomm's Hexagon delivers 75 TOPS at <1W. NPUs achieve 10-100× better efficiency than GPUs for fixed-precision inference through quantization and systolic arrays.
