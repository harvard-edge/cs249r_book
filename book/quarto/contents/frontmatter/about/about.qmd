...
- **Machine Learning Basics**: Prior exposure to supervised learning concepts (classification, regression), neural network fundamentals, and common architectures (CNNs, RNNs) is helpful but not strictly required. @Sec-neural-computation provides essential background for those new to these topics.
...
1. **Part V: The Fleet**
   *Build the physical computer.* Master the physical layer of ML systems: data center architecture, specialized accelerators (TPUs, H100s), high-bandwidth networking (NVLink, InfiniBand), and massive-scale storage.
