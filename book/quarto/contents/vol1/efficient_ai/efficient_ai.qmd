...
NAS-discovered architectures demonstrate remarkable efficiency. EfficientNet achieves 5-10x better accuracy/FLOPs ratios than manually designed counterparts, matching ResNet-50's accuracy with 8.4x fewer parameters [@tan2019mnasnet]. These gains emerge from systematic exploration of design spaces that human designers might overlook.
...
![**Dataset Growth**: Foundation models are increasingly trained on vast datasets, reflecting the growing stock of human-generated text. This trend underscores the challenge of data scarcity in maintaining model performance as scale increases. [@villalobos_ho_sevilla_besiroglu_heim_hobbhahn_2024].](images/png/running_out_of_data.png){#fig-running-out-of-human-data}
