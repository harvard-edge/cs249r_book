...
[^fn-amdahls-law]: Recall from @sec-ml-system-architecture that Amdahl's Law limits speedup based on the serial fraction of computation. For distributed training, this serial fraction includes gradient synchronization, which at 5% overhead caps maximum speedup at 20x regardless of GPU count. This explains why scaling efficiency degrades at large cluster sizes and motivates algorithmic innovations like gradient compression and communication-computation overlap.
