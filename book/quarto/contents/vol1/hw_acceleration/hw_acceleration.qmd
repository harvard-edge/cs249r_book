...
for _x, _y, _n in zip(_years, compute_index, _labels):
    ax.annotate(_n, xy=(_x, _y), xytext=(0, 7), textcoords='offset points', ha='center', fontsize=8, color=COLORS['primary'])
...
ax.text(
    _years[-1] - 0.35,
    np.sqrt(compute_index[-1] * bandwidth_index[-1]),
    f'Reuse burden {_gap:.1f}x',
    rotation=90,
    va='center',
    ha='right',
    fontsize=9,
