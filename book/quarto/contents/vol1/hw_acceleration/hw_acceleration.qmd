...
- Bytes: (input + weights + output) $= (32 \times 512 \times 768 + 3 \times 768 \times 768 + 32 \times 512 \times 768 \times 3) \times 2$ ≈ `{python} qkv_mb_str` MB
...
- FLOPs: $32 \times 12 \times 512 \times 512 \times 3$ ≈ `{python} softmax_flops_m_str`M FLOPs (exp, sum, div)
