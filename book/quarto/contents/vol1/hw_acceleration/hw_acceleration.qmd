...
Modern ML accelerators—GPUs with tensor cores, Google's TPUs[^fn-hwacc-tpu], Apple's Neural Engine—emerged from these established architectural principles. Understanding this history reveals why accelerators are designed the way they are and what trade-offs they embody.
...
::: {.callout-perspective title="Back-of-the-Napkin: The Speed of Light Limit"}
...
::: {.callout-perspective title="Back-of-the-Napkin: Calculating the Ridge Point"}
