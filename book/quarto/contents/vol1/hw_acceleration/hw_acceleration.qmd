...
# │ Exports: SystolicEnergy.energy_ratio_mult_str, SystolicEnergy.vector_energy_pj_per_op_str,
# │          SystolicEnergy.systolic_energy_pj_per_op_str
# └─────────────────────────────────────────────────────────────────────────────
...
# ┌── LEGO ───────────────────────────────────────────────
# │ Exports: SpeedOfLightLimitCalc.h100_die_area_mm2_str
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_int, fmt_count, fmt_arithmetic_intensity, MarkdownStr
...
# │          DenseLayerAnalysisCalc.dense_ai_flops_per_byte_str,
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_flops, fmt_int, fmt_arithmetic_intensity, MarkdownStr
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt, fmt_flops, fmt_count, check, MarkdownStr
...
# │ Exports: FpSmallBatchCalc.fp_ai_b1_flops_per_byte_str,
