...
class SystolicOpsCalc:
    ...
    tpuv4_bw_str     = fmt_bandwidth(tpuv4_bw, unit=GB / second, precision=0, commas=True)
```
...
class InterconnectBandwidth:
    ...
    hbm_bw_str = fmt_bandwidth(hbm_bw, unit=TB/second, precision=1, commas=False)
    ...
    net_bw_str = fmt_bandwidth(net_bw, unit=GB / second, precision=0, commas=False)
...
class AcceleratorEconomics:
    ...
    v100_bw_str     = fmt_qty(h_v100.memory.bandwidth, GB/second, precision=0, commas=False)
    ...
    a100_bw_str          = fmt_qty(h_a100.memory.bandwidth, GB/second, precision=0, commas=True)
    ...
    tpuv4_bw_str     = fmt_qty(h_tpu.memory.bandwidth, GB/second, precision=0, commas=True)
    ...
    gaudi_bw_str     = fmt_bandwidth(gaudi_bw, unit=GB / second, precision=0, commas=True)
...
|:-----------------------------------|:-----------------------------------------------:|:-----------------------------------------------------------:|:--------------------------------------------:|:------------------------------------------------:|
| **NVIDIA V100**\index{NVIDIA!V100} |  `{python} AcceleratorEconomics.v100_price_str` |       `{python} AcceleratorEconomics.v100_tflops_str`       | `{python} AcceleratorEconomics.v100_bw_str`  | `{python} AcceleratorEconomics.v100_pp_usd_str`  |
| **NVIDIA A100**\index{NVIDIA!A100} |  `{python} AcceleratorEconomics.a100_price_str` |     `{python} AcceleratorEconomics.a100_tflops_fp16_str`    | `{python} AcceleratorEconomics.a100_bw_str`  | `{python} AcceleratorEconomics.a100_pp_usd_str`  |
| **NVIDIA H100**                    |  `{python} AcceleratorEconomics.h100_price_str` | `{python} AcceleratorEconomics.h100_tflops_tf32_str` (TF32) | `{python} AcceleratorEconomics.h100_bw_str`  | `{python} AcceleratorEconomics.h100_pp_usd_str`  |
| **Google TPUv4**                   |  `{python} AcceleratorEconomics.tpu_price_str`  |   `{python} AcceleratorEconomics.tpuv4_tflops_str` (BF16)   | `{python} AcceleratorEconomics.tpuv4_bw_str` |  `{python} AcceleratorEconomics.tpu_pp_usd_str`  |
| **Intel Gaudi 2**                  | `{python} AcceleratorEconomics.gaudi_price_str` |    `{python} AcceleratorEconomics.gaudi_tflops_str` (FP8)   | `{python} AcceleratorEconomics.gaudi_bw_str` | `{python} AcceleratorEconomics.gaudi_pp_usd_str` |
...
class TensorLifecycleCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    kws_tensor_str         = fmt_memory(kws_tensor, unit=KB, precision=0, commas=False)
    ...
    latency_hbm_str        = fmt_time(Hardware.Tech.Memory.DRAM.latency, unit=nanosecond, precision=0, commas=False)
    latency_l2_str         = fmt_time(Hardware.Tech.Memory.L2.latency, unit=nanosecond, precision=0, commas=False)
    latency_l1_str         = fmt_time(Hardware.Tech.Memory.L1.latency, unit=nanosecond, precision=0, commas=False)
...
class InterconnectHierarchy:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    nvlink_a100_str = fmt_bandwidth(nvlink_a100, unit=GB / second, precision=0, commas=False)
    nvlink_h100_str = fmt_bandwidth(nvlink_h100, unit=GB / second, precision=0, commas=False)
    ib_hdr_str = fmt_qty(ib_hdr_bw, Gbps, precision=0, commas=False, unit_label="Gb/s")
    ib_ndr_str = fmt_qty(Systems.Fabrics.InfiniBand_NDR.bandwidth, Gbps, precision=0, commas=False, unit_label="Gb/s")
...
class DenseLayerAnalysisCalc:
    ...
    dense_attainable_str   = fmt_flop_rate(dense_attainable, unit=TFLOP / second, precision=1, commas=False)
    dense_util_pct_str     = fmt_percent(dense_util_pct/100, precision=1, commas=False, style='symbol')
    a100_bw_str            = fmt_bandwidth(a100_bandwidth, unit=GB / second, precision=0, commas=True)
    a100_ridge_str         = fmt_int(round(a100_ridge_value), commas=False)
```
...
class LayernormAnalysisCalc:
    ...
    ln_attainable_str   = fmt_flop_rate(ln_attainable, unit=TFLOP / second, precision=1, commas=False)
    a100_bw_str         = fmt_bandwidth(a100_bandwidth, unit=GB / second, precision=0, commas=False)
...
class RuntimeProductionTdp:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    a100_tdp_str = fmt_power(Hardware.Cloud.A100.tdp, unit=watt, precision=0, commas=False)
```
...
class FpMultigpuScalingCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    fp_nvlink_bw_str     = fmt_bandwidth(nvlink_bw, unit=GB / second, precision=0, commas=False)
    fp_sync_time_str     = fmt_time(sync_time, 'millisecond', precision=2, commas=False)
...
class FpSmallBatchCalc:
    ...
    fp_t4_flops_str = fmt_flop_rate(t4_flops, unit=TFLOP / second, precision=0, commas=False)
    fp_t4_bw_str    = fmt_bandwidth(t4_bw, unit=GB / second, precision=0, commas=False)
    fp_a100_roof_b1_str = fmt_flop_rate(a100_roof_b1, unit=TFLOP / second, precision=1, commas=False)
    fp_t4_roof_b1_str = fmt_flop_rate(t4_roof_b1, unit=TFLOP / second, precision=1, commas=False)
```
...
class FeasibilityAssessment:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    headroom_str = fmt_memory(headroom, unit=GB, precision=0, commas=False)
    ...
    frame_budget_str = fmt_time(frame_budget, 'millisecond', precision=1, commas=False)
...
class CarbonRoiCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    cpu_power_str      = fmt_power(cpu_power, unit=watt, precision=0, commas=True)
    npu_power_str      = fmt_power(npu_power, unit=watt, precision=0, commas=True)
    ...
    cpu_energy_day_str = fmt_energy(cpu_energy_day, unit=kWh, precision=0, commas=True)
    npu_energy_day_str = fmt_energy(npu_energy_day, unit=kWh, precision=0, commas=True)
