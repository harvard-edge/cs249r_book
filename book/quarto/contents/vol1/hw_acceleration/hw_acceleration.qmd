...
[^fn-systolic-origin]: **Systolic Array Renaissance**: H.T. Kung and Charles Leiserson introduced systolic arrays at CMU in 1979 for VLSI signal processing, but the concept languished for decades due to programming complexity. Google's 2016 TPU resurrection proved these "heartbeat" architectures could deliver massive efficiency gains for neural networks. The TPUv1's $256\times 256$ systolic array contains 65,536 8-bit multiply-accumulate units operating at 700 MHz, yielding a peak throughput of 92 TOPS for INT8 operations (65,536 MACs $\times$ 2 ops/MAC $\times$ 700 MHz = 91.75 TOPS) while consuming just 40 watts. This theoretical peak assumes 100% utilization; actual performance depends on how well workloads map to the systolic dataflow, with typical utilization ranging from 30-70% depending on layer dimensions. This efficiency made systolic arrays the dominant AI architecture today.
...
+:==================+:===============+:============+:====================+
| NVIDIA V100       | 125 TFLOPS     | 900 GB/s    | 139 FLOP/byte       |
+-------------------+----------------+-------------+---------------------+
| NVIDIA A100       | 312 TFLOPS     | 2.0 TB/s    | 156 FLOP/byte       |
+-------------------+----------------+-------------+---------------------+
| NVIDIA H100       | 990 TFLOPS     | 3.4 TB/s    | 291 FLOP/byte       |
+-------------------+----------------+-------------+---------------------+
| Google TPU v4     | 275 TFLOPS     | 1.2 TB/s    | 229 FLOP/byte       |
+-------------------+----------------+-------------+---------------------+

: **Hardware Ridge Points**: Different accelerators have different ridge points determined by their compute-to-bandwidth ratios. Higher ridge points require more operations per byte to achieve peak utilization. {#tbl-ridge-points}
