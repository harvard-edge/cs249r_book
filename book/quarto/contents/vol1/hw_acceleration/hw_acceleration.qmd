...
::: {.column-margin}
![](images/svg/vol1_hw_acceleration_margin_001.svg){width="100%" fig-alt="Margin illustration showing Tile-width threshold where 128 fits and 129 creates a fringe tile."}

*Shows the tiling cliff where one extra dimension creates fringe work.*
:::
...
::: {.column-margin}
![](images/svg/vol1_hw_acceleration_margin_002.svg){width="100%" fig-alt="Margin illustration showing HBM, NVLink, PCIe, and network bandwidth taper."}

*Shows bandwidth tapering as data moves farther from the accelerator.*
:::
...
::: {.column-margin}
![](images/svg/vol1_hw_acceleration_margin_003.svg){width="100%" fig-alt="Margin illustration showing Mapping-choice explosion from small loop choices to billion-scale search."}

*Shows mapping choices exploding combinatorially as loop dimensions grow.*
:::
...
::: {.column-margin}
![](images/svg/vol1_hw_acceleration_margin_004.svg){width="100%" fig-alt="Margin illustration showing Stationary choices: weights, outputs, and inputs."}

*Distinguishes weight-stationary, output-stationary, and input-stationary dataflow choices.*
:::
