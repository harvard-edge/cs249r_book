...
\index{Von Neumann, John!stored-program architecture}The underlying cause of this wall is physical: the Von Neumann Bottleneck[^fn-von-neumann-bottleneck], which has constrained computing since 1945, means that moving data costs orders of magnitude more energy than processing it.
