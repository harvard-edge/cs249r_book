...
__global__ void matrix_multiply(float* C, float* A, float*
                                B, int N) {  // CUDA kernel[^fn-cuda]\index{CUDA!kernel launch}
...
# │
# │ Imports: physx.constants (SYSTOLIC_ARRAY_DIM), physx.formatting (fmt)
# │ Exports: systolic_dim_str, systolic_ops_str
# └─────────────────────────────────────────────────────────────────────────────
from physx.formatting import fmt
from physx.constants import SYSTOLIC_ARRAY_DIM
...
# │
# │ Imports: physx.constants (BYTES_FP16, ENERGY_DRAM_PJ_PER_BYTE,
...
bandwidth_ratio_value = (H100_MEM_BW / A100_MEM_BW).to("dimensionless").magnitude
...
# │
# │ Imports: physx.constants (BYTES_FP16, byte, MB, flop, GFLOPs),
# │          physx.formatting (fmt)
...
# └─────────────────────────────────────────────────────────────────────────────
from physx.formatting import fmt
from physx.constants import BYTES_FP16, byte, MB, flop, GFLOPs
...
conv_out_m = conv_out_elements / 1e6
...
# │
# │ Imports: physx.constants (BYTES_FP16, byte, MB, KiB, flop, MFLOPs, GFLOPs,
...
# Memory traffic (FP16)
dense_input_kb = dense_batch * dense_in * 2 / 1024
dense_weights_mb = (dense_in * dense_out * 2 * byte).to(MB).magnitude
dense_output_kb = dense_batch * dense_out * 2 / 1024
...
# │
# │ Imports: physx.constants (byte, MB, A100_MEM_BW, GB, GFLOPs, TFLOPs,
...
# └─────────────────────────────────────────────────────────────────────────────
from physx.formatting import fmt
from physx.constants import byte, MB, A100_MEM_BW, GB, GFLOPs, TFLOPs, second
...
ln_params_kb = ln_hidden * 2 * 2 / 1024
ln_output_mb = (ln_elements * 2 * byte).to(MB).magnitude
ln_total_mb = ln_input_mb + ln_output_mb + ln_params_kb / 1024
...
# │
# │ Imports: physx.constants (BYTES_FP32)
...
tensor_mb = tensor_dim * tensor_dim * bytes_per_float / (1024 * 1024)
...
# │
# │ Imports: physx.constants (ENERGY_DRAM_ACCESS_PJ, ENERGY_SRAM_L1_PJ),
# │          physx.formatting (fmt)
# │ Exports: fp_ridge_example_str, fp_layernorm_tflops_str,
# │          fp_layernorm_util_str
# └─────────────────────────────────────────────────────────────────────────────
from physx.formatting import fmt
from physx.constants import ENERGY_DRAM_ACCESS_PJ, ENERGY_SRAM_L1_PJ
...
# │
# │ Imports: physx.constants (NVLINK_A100_BW, GB, second),
# │          physx.formatting (fmt)
# │ Exports: fp_nvlink_bw_str, fp_sync_time_str, fp_sync_overhead_str
# └─────────────────────────────────────────────────────────────────────────────
from physx.formatting import fmt
from physx.constants import NVLINK_A100_BW, GB, second
...
# │
# │ Imports: physx.constants (T4_FLOPS_FP16_TENSOR, T4_MEM_BW, TFLOPs,
# │          second, GB), physx.formatting (fmt)
# │ Exports: fp_ai_b1_str, fp_ai_b256_str, fp_t4_ridge_str,
# │          fp_t4_flops_str, fp_t4_bw_str
# └─────────────────────────────────────────────────────────────────────────────
from physx.formatting import fmt
from physx.constants import T4_FLOPS_FP16_TENSOR, T4_MEM_BW, TFLOPs, second, GB
