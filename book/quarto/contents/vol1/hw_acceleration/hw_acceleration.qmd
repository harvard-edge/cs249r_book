...
**Systems insight**: The `{python} InterconnectBandwidth.gap_ratio_str` gap between HBM and PCIe means that any data transfer from the CPU is a catastrophic performance event. **NVLink**\index{NVLink!PCIe wall} is the only way to scale computation across multiple GPUs without hitting the "PCIe Wall."
