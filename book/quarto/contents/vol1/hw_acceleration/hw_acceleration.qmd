...
::: {.column-margin}
![](images/png/hw_acceleration_dam_locator.png){width="100%" fig-alt="D·A·M taxonomy triangle with three vertices labeled D, A, and M connected by edges. The M (Machine) vertex is filled in solid color; the D and A vertices are gray, marking this chapter as the Machine axis."}
