...
\noindent
![](images/png/cover_hw_acceleration_blueprint.png){fig-alt="Layered isometric hardware blueprint where a tensor operation lowers into tiles, local SRAM, and an execution array while avoiding an off-chip memory wall."}
