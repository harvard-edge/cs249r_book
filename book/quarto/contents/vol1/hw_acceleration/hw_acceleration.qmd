...
3. **Tolerance for Reduced Precision**\index{Quantization!reduced precision tolerance}: Neural networks often remain robust when selected operations use 8-bit or 4-bit integers instead of 32- or 64-bit floating-point numbers. This flexibility allows architects to fit substantially more low-precision compute into the same silicon area and to reduce memory traffic per value [@dally2021; @dally2023].
