...
class CarbonRoiCalc:
    ...
    cpu_energy_day_str = fmt_qty(cpu_energy_kwh_day * kWh, kWh, precision=0, commas=True)
    npu_energy_day_str = fmt_qty(npu_energy_kwh_day * kWh, kWh, precision=0, commas=True)
    carbon_intensity_str = fmt_qty(carbon_kg_per_kwh * kg / kWh, kg / kWh, precision=3)
