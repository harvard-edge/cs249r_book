...
[^fn-roofline-etymology]: **Roofline Model**\index{Williams, Samuel!roofline model author}: Named for its visual appearance when plotted: a flat horizontal line (the compute ceiling) meets a sloped line (the memory ceiling) forming a shape resembling a building roofline. The metaphor captures how workloads hit different "ceilings" depending on their arithmetic intensity, making performance bounds intuitive at a glance [@williams2009roofline].
