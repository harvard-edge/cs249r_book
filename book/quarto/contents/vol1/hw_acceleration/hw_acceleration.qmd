...
- Apply hardware mapping principles to design computation placement, memory allocation, and execution scheduling strategies that maximize data reuse and minimize energy-intensive data movement across the memory hierarchy
