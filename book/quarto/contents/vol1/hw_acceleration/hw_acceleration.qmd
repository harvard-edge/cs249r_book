...
class AcceleratorEconomics:
    ...
    v100_pp_str    = fmt_usd(v100_ratio, precision=0, commas=False, suffix="/(TFLOP/s)")
    ...
    a100_pp_str      = fmt_usd(a100_ratio, precision=1, commas=False, suffix="/(TFLOP/s)")
    ...
    h100_price_str   = fmt_usd(price_h100, precision=0, approx=True, suffix="-30,000")
    h100_pp_str      = fmt_usd(h100_ratio, precision=1, commas=False, approx=True, suffix="/(TFLOP/s)")
    ...
    tpu_price_str = fmt_usd(price_tpu, precision=0, approx=True, suffix="*")
    tpu_pp_str    = fmt_usd(tpu_ratio, precision=1, commas=False, approx=True, suffix="/(TFLOP/s)")
    ...
    gaudi_pp_str    = fmt_usd(gaudi_ratio, precision=1, commas=False, suffix="/(TFLOP/s)")
```
