...
class AcceleratorEconomics:
    ...
    v100_pp_str    = fmt_usd(v100_ratio, precision=0, commas=False, per="(TFLOP/s)")
    ...
    a100_pp_str      = fmt_usd(a100_ratio, precision=1, commas=False, per="(TFLOP/s)")
    ...
    h100_pp_str      = fmt_usd(h100_ratio, precision=1, commas=False, approx=True, per="(TFLOP/s)")
    ...
    tpu_pp_str    = fmt_usd(tpu_ratio, precision=1, commas=False, approx=True, per="(TFLOP/s)")
    ...
    gaudi_pp_str    = fmt_usd(gaudi_ratio, precision=1, commas=False, per="(TFLOP/s)")
```
