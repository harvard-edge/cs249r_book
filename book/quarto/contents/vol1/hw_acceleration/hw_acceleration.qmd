...
# INPUT
# =============================================================================
dram_access_pj_value = 640  # pJ per DRAM access
vector_accesses_value = 4   # 3 loads + 1 write
systolic_size_value = SYSTOLIC_ARRAY_DIM
compute_energy_pj_value = 1 # pJ per MAC operation
...
vector_energy_str = f"{vector_energy_pj_value:,}"
systolic_access_str = fmt(systolic_accesses_per_op_value, precision=3, commas=False)
systolic_energy_str = fmt(systolic_energy_pj_value, precision=0, commas=False)
...
1.  **DRAM (HBM)**: The tensor starts here.
    *   **Size**: 16,000 samples × 2 bytes (FP16) = **`{python} kws_tensor_str` KB**.
