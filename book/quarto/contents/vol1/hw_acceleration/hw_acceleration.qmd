...
class RooflineGap:
    ...
    v100_ridge_str = fmt_arithmetic_intensity(h_v100.ridge_point(), unit=flop / byte, precision=0, commas=False)
    a100_ridge_str = fmt_arithmetic_intensity(h_a100.ridge_point(), unit=flop / byte, precision=0, commas=False)
    h100_ridge_str = fmt_arithmetic_intensity(h_h100.ridge_point(), unit=flop / byte, precision=0, commas=False)
    a100_ridge_fp32_str = fmt_arithmetic_intensity(
        h_a100.compute.precision_flops['fp32'] / h_a100.memory.bandwidth, unit=flop / byte, precision=0, commas=False
    )
...
class Gpt2ThroughputCalc:
    ...
    a100_ridge_str = fmt_arithmetic_intensity(Hardware.Cloud.A100.ridge_point(), unit=flop / byte, precision=0, commas=False)
    a100_ridge_fp32_str = fmt_arithmetic_intensity(
        Hardware.Cloud.A100.compute.precision_flops['fp32'] / Hardware.Cloud.A100.memory.bandwidth, unit=flop / byte, precision=0, commas=False
    )
...
class FpSmallBatchCalc:
    ...
    fp_t4_ridge_str = fmt_arithmetic_intensity(Hardware.Cloud.T4.ridge_point(), unit=flop / byte, precision=0, commas=False)
