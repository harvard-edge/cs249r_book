...
## AI Acceleration Fundamentals {#sec-ai-acceleration-ai-hardware-acceleration-fundamentals-9b28}
...
[^fn-von-neumann]The underlying cause of this wall—the Von Neumann Bottleneck that has constrained computing since 1945—is physical: moving data costs orders of magnitude more energy than processing it.

[^fn-von-neumann]: **John von Neumann**: Hungarian-American mathematician at Princeton's Institute for Advanced Study who described the stored-program computer architecture in his 1945 "First Draft of a Report on the EDVAC." The Von Neumann architecture---where instructions and data share the same memory and bus---enabled programmable computing but created a fundamental throughput constraint. John Backus named this the "Von Neumann Bottleneck" in his 1977 Turing Award lecture; it is precisely the constraint that modern AI accelerators fight against with on-chip SRAM, systolic arrays, and near-memory computing. To grasp the severity, study the bar chart in @fig-energy-hierarchy — the "Horowitz Numbers"\index{Horowitz Numbers!energy hierarchy}\index{Energy Hierarchy!silicon costs} lay bare the fundamental energy constants of silicon, and the gap between a simple arithmetic operation and a DRAM fetch is staggering.
...
## Hardware Mapping Fundamentals {#sec-ai-acceleration-hardware-mapping-fundamentals-neural-networks-f9a9}
...
## Multi-Accelerator Scaling {#sec-ai-acceleration-scaling-beyond-single}
...
## Heterogeneous SoC Acceleration {#sec-ai-acceleration-heterogeneous-soc-ai-acceleration-b1bb}
