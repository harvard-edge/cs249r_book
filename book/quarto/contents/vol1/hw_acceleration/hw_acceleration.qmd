...
class CompilerSpeedupCalc:
    ...
    naive_inference_ms_str     = fmt_time(naive_inference_ms, "ms", precision=0, commas=False)
    optimized_inference_ms_str = fmt_time(optimized_inference_ms, "ms", precision=0, commas=False)
...
class FpMultigpuScalingCalc:
    ...
    fp_sync_time_str     = fmt_time(sync_time_ms, "ms", precision=2, commas=False)
...
class FeasibilityAssessment:
    ...
    latency_target_ms_str = fmt_time(latency_target_ms, "ms", precision=0, commas=False)
    token_latency_ms_str = fmt_time(token_latency_ms, "ms", precision=0, commas=False)
    frame_budget_str = fmt_time(frame_budget_ms, "ms", precision=1, commas=False)
