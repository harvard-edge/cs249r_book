...
Speedup = 1 / ((1-`{python} p_resnet_str`) + `{python} p_resnet_str` / `{python} hw_speedup_str`) = 1 / (`{python} serial_resnet_str` + 0.0019) ≈ `{python} amdahl_resnet_str`×
...
Speedup = 1 / ((1-`{python} p_gpt2_str`) + `{python} p_gpt2_str` / `{python} hw_speedup_str`) = 1 / (`{python} serial_gpt2_str` + 0.0016) ≈ `{python} amdahl_gpt2_str`×
