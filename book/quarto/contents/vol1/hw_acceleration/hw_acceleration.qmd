...
# OUTPUT
# =============================================================================
hw_speedup_str = str(hw_speedup_value)
p_resnet_str = f"{p_resnet_value:.2f}"
p_gpt2_str = f"{p_gpt2_value:.2f}"
serial_resnet_str = f"{serial_resnet_value:.2f}"
serial_gpt2_str = f"{serial_gpt2_value:.2f}"
amdahl_resnet_str = f"{amdahl_resnet_value:.1f}"
amdahl_gpt2_str = f"{amdahl_gpt2_value:.1f}"
amdahl_gpt2_ceil_str = f"{amdahl_gpt2_ceiling_value:.0f}"
p_resnet_pct_str = f"{p_resnet_value*100:.0f}"
serial_resnet_pct_str = f"{serial_resnet_value*100:.0f}"
amdahl_resnet_round_str = f"{amdahl_resnet_value:.0f}"
serial_gpt2_pct_str = f"{(1 - p_gpt2_value)*100:.0f}"
```
...
# OUTPUT
# =============================================================================
dram_access_str = str(dram_access_pj_value)
systolic_size_str = str(systolic_size_value)
vector_accesses_str = str(vector_accesses_value)
compute_energy_str = str(compute_energy_pj_value)
vector_energy_str = f"{vector_energy_pj_value:,}"
systolic_access_str = f"{systolic_accesses_per_op_value:.3f}"
systolic_energy_str = f"{systolic_energy_pj_value:.0f}"
energy_ratio_str = f"{energy_ratio_value:.0f}"
```
...
kws_tensor_str = f"{kws_tensor_kb_value:.0f}"
```
...
# OUTPUT
# =============================================================================
t_hidden_str = str(t_hidden_value)
t_batch_str = str(t_batch_value)
t_seq_str = str(t_seq_value)
t_heads_str = str(t_heads_value)
qkv_flops_b_str = f"{qkv_flops_b_value:.0f}"
qkv_mb_str = f"{qkv_mb_value:.0f}"
qkv_ai_str = f"{qkv_ai_value:.0f}"
softmax_flops_m_str = f"{softmax_flops_m_value:.0f}"
softmax_mb_str = f"{softmax_mb_value:.0f}"
softmax_ai_str = f"{softmax_ai_value:.2f}"
```
...
dense_util_pct_str = f"{dense_util_pct:.0f}"
