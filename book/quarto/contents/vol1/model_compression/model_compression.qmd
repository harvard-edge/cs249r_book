...
# │ Show: FP32 footprint (800 KB), INT8 footprint (200 KB), 512 KiB budget.
# │ How: Models.Tiny.DS_CNN.size_in_bytes at 4 B and 1 B per parameter,
# │      compared against Platforms.Tiny.ram.
# │
# │ Imports: mlsysim registries (Models.Tiny, Platforms.Tiny) + fmt helpers
# │ Exports: KwsQuantImperative.fp32_kb_str, .int8_kb_str, .budget_kib_str
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_qty, check
from mlsysim.core.units import byte, KB, KiB
