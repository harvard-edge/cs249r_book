...
\end{scope}
\end{scope}
\node[below=0.2 of BL2,align=center](NZ){Nonzero\\ data values};
...
\end{scope}
\node[below=0.7 of DM1,align=center](NZ){Nonzero data\\ values};
\draw[|-|,thick]([yshift=-5.5]cell-1-8DM1.south west)--node[below=0pt,
