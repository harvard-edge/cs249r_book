...
::: {.column-margin}
![](images/svg/model_compression_dam_locator.svg){width="100%" fig-alt="Stacked D, A, and M locator boxes with the Machine axis highlighted, marking quantization hardware support as the binding axis for this section."}
