...
from mlsysim.fmt import fmt, check, fmt_energy_per_byte, fmt_energy_per_op, fmt_qty, fmt_time
...
2.  **Compute work $(O \times E_{\text{compute}})$**: A 32-bit multiply-add costs ≈ `{python} QuantizationEnergyPhysics.energy_flop_fp32_pj_per_op_str`. An INT8 multiply-add costs ≈ `{python} QuantizationEnergyPhysics.energy_op_int8_pj_per_op_str`.
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim import Models, Platforms
from mlsysim.fmt import fmt, fmt_int, MarkdownStr, fmt_multiple, fmt_qty, fmt_qty_int, fmt_memory
...
# │ Exports: EnergyCosts.energy_add_fp32_pj_per_op_str, .energy_add_fp16_pj_per_op_str,
# │          .energy_add_int32_pj_per_op_str, .energy_add_int8_pj_per_op_str
# └─────────────────────────────────────────────────────────────────────────────
...
*   **FP32 Addition**: Requires `{python} EnergyDividend.energy_add_fp32_pj_per_op_str`.
*   **INT8 Addition**: Requires `{python} EnergyDividend.energy_add_int8_pj_per_op_str`.
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt, fmt_math, check, MarkdownStr
