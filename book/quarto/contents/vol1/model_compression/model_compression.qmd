...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim import Models, Platforms
from mlsysim.fmt import fmt, fmt_int, MarkdownStr, fmt_qty, fmt_qty_int
...
class ModelDeviceComparison:
    ...
    cloud_cap_str = fmt_qty_int(cloud_mem, GB, commas=False, approx=True)
    mobile_cap_str = fmt_qty_int(mobile_mem, GB, commas=False, approx=True)
    tiny_cap_str = fmt_qty(tiny_mem, KB, precision=1, commas=False, approx=True)
