...
```{.tikz}
\begin{tikzpicture}[line join=round,font=\small\usefont{T1}{phv}{m}{n},scale=0.9, every node/.append style={transform shape}]
\tikzset{
Line/.style={line width=0.5pt,black!50,text=black},
...
\end{scope}
\end{scope}
\path[red](2BB3.north east)--++(0:3.7)coordinate(GO)|-coordinate(DO)(6BB3.south east);
...
```{.tikz}
\scalebox{0.65}{\begin{tikzpicture}[line join=round,font=\usefont{T1}{phv}{m}{n}]
\tikzset{%
helvetica/.style={align=flush center,font=\small\usefont{T1}{phv}{m}{n}},
Line/.style={line width=1.0pt,black!50,text=black},
}
