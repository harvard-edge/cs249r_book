...
# │
# │ Imports: mlsysim.core.units (MB), mlsysim.fmt
...
class FallaciesAnalysis:
    ...
    resnet_fp32_acc_str = fmt_percent(0.762, precision=1, commas=False, style='prose')
    resnet_int8_acc_str = fmt_percent(0.761, precision=1, commas=False, style='prose')
    resnet_binary_acc_str = fmt_percent(0.51, precision=0, commas=False, style='prose')
```
