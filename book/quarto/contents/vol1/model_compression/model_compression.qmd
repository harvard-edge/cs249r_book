...
\noindent
![](images/png/cover_model_compression_blueprint_print.png){fig-alt="Isometric compression workshop where a large model passes through pruning, distillation, and quantization stations before fitting into a constrained device envelope."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_model_compression_blueprint.webp){fig-alt="Isometric compression workshop where a large model passes through pruning, distillation, and quantization stations before fitting into a constrained device envelope."}
:::
