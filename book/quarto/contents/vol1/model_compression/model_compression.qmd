...
**Mechanism**: SIMD. A CPU or GPU core processes data in fixed-width vector registers (for example, AVX-512 is 512 bits wide).
...
**Problem**: A compute-bound matrix multiplication (for example, in a transformer MLP block) switches from FP16 to INT8. What is the expected speedup?
