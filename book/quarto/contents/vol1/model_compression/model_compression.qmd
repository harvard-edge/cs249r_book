...
class CompressionDeploymentScale:
    ...
    llm_7b_mem_str = fmt_qty(llm_7b_mem_fp16, GB, precision=0, commas=False)
    llm_175b_str = fmt(llm_175b_params, precision=0, commas=False)
    llm_175b_mem_str = fmt_qty(llm_175b_mem_fp16, GB, precision=0, commas=False)
    smartphone_ram_str = fmt_qty_int(smartphone_ram, GB, commas=False)
    mcu_ram_str = fmt_qty(mcu_ram, KB, precision=1, commas=False)
```
...
class CompressionIronLawQuant:
    ...
    llm_175b_str = fmt(llm_175b_params, precision=0, commas=False)
    llm_175b_mem_str = fmt_qty(llm_175b_mem_fp16, GB, precision=0, commas=False)
    llm_175b_mem_int8_str = fmt_qty(llm_175b_mem_int8, GB, precision=0, commas=False)
...
class QuantizationSpeedup:
    ...
    fp16_size_str = fmt_qty_int(fp16_size, GB, commas=False)
    fp16_total_str = fmt_qty_int(fp16_total, GB, commas=False)
    ...
    int4_size_str = fmt_qty(int4_size, GB, precision=1, commas=False)
...
class MobileNetCompressionAnchor:
    ...
    original_size_str = fmt_qty(original_size, MB, precision=0, commas=False)
    pruned_size_str = fmt_qty(pruned_size, MB, precision=0, commas=False)
```
...
class QuantizationMemoryAnchor:
    ...
    llm_7b_mem_fp16 = llm_7b_mem_fp16_gb * GB
    smartphone_ram = smartphone_ram_gb * GB
    ...
    llm_7b_mem_str = fmt_qty(llm_7b_mem_fp16, GB, precision=0, commas=False)
    smartphone_ram_str = fmt_qty(smartphone_ram, GB, precision=0, commas=False)
```
...
class QuantizationSavings:
    ...
    fp16_size = fp16_size_gb * GB
    int4_size = int4_size_gb * GB
    gpu_mem_fp16 = gpu_mem_fp16_gb * GB
    gpu_mem_int4 = gpu_mem_int4_gb * GB
