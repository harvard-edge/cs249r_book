...
class QuantizationEnergyPhysics:
    ...
    baseline_battery_hours_str = fmt(1, precision=0, commas=False, suffix=" hour")
    int8_battery_hours_str = fmt(int8_energy_reduction, precision=0, commas=False, suffix=" hours")
```
...
class QuantizationSpeedup:
    ...
    fp16_latency_str = fmt_int(fp16_latency_ms, commas=False, suffix=" ms")
    fp16_toks_str = fmt(fp16_toks, precision=1, commas=False, suffix=' tokens/s')

    int4_size_str = fmt(int4_size_gb, precision=1, commas=False, suffix=" GB")
    int4_latency_str = fmt_int(int4_latency_ms, commas=False, suffix=" ms")
    int4_toks_str = fmt_int(int4_toks, commas=False, suffix=' tokens/s')
...
class ModelDeviceComparison:
    ...
    dlrm_str = fmt(dlrm_mem.m_as(GB), precision=0, commas=False, suffix=" GB")
    gpt2_str = fmt(gpt2_mem.m_as(GB), precision=0, commas=False, suffix=" GB")
    resnet_str = fmt(resnet_mem.m_as(MB), precision=0, commas=False, suffix=" MB")
    mobilenet_str = fmt(mobilenet_mem.m_as(MB), precision=0, commas=False, suffix=" MB")
    mobilenet_int8_str = fmt(mobilenet_int8_mem.m_as(MB), precision=1, commas=False, suffix=" MB")
    dscnn_str = fmt(dscnn_mem.m_as(KB), precision=0, commas=False, suffix=" KB")
    cloud_cap_str = fmt_int(round(cloud_mem.m_as(GB)), commas=False, prefix="~", suffix=" GB")
    mobile_cap_str = fmt_int(round(mobile_mem.m_as(GB)), commas=False, prefix="~", suffix=" GB")
    tiny_cap_str = fmt(tiny_mem.m_as(KB), precision=1, commas=False, prefix="~", suffix=" KB")
...
class MobileNetCompressionAnchor:
    ...
    pruning_pct_str = fmt(pruning_pct, precision=1, commas=False, suffix="%")
...
class TheoryPracticeSpeedup:
    ...
    realized_fraction_pct_str = fmt(realized_fraction_pct, precision=0, commas=False, suffix=" percent")
```
...
class FusionCalc:
    ...
    bandwidth_reduction_pct_str = fmt(bandwidth_reduction_pct, precision=1, commas=False, suffix=" percent")
    ...
    saved_latency_ms_str = fmt(saved_latency_ms, precision=1, commas=False, suffix=" ms")
...
class AmdahlCompression:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────
    model_fraction_pct_str = fmt(model_fraction * 100, precision=0, commas=False, suffix=" percent")
    non_model_pct_str = fmt(non_model_fraction * 100, precision=0, commas=False, suffix=" percent")
...
class ResNet50Int8Metrics:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────
    fp32_top1_str = fmt(fp32_top1, precision=1, commas=False, suffix=' percent')
    int8_top1_str = fmt(int8_top1, precision=1, commas=False, suffix=' percent')
    fp32_latency_ms_str = fmt_int(fp32_latency_ms, commas=False, suffix=" ms")
    int8_latency_ms_str = fmt(int8_latency_ms, precision=1, commas=False, suffix=" ms")
    ...
    calibration_error_fp32_str = fmt(calibration_error_fp32, precision=1, commas=False, suffix=' percent')
    calibration_error_int8_str = fmt(calibration_error_int8, precision=1, commas=False, suffix=' percent')
...
class FallaciesAnalysis:
    ...
    actual_speedup_str = fmt(actual_combined_pct, precision=0, commas=False, suffix=" percent")
