...
\noindent
![](images/png/cover_model_compression_blueprint.png){fig-alt="Isometric compression workshop where a large model passes through pruning, distillation, and quantization stations before fitting into a constrained device envelope."}
