...
::: {#principle-verification-gap .callout-principle title="The Verification Gap" icon="false"}
...
::: {#principle-statistical-drift .callout-principle title="The Statistical Drift Invariant" icon="false"}
...
::: {#principle-training-serving-skew .callout-principle title="The Training-Serving Skew Law" icon="false"}
...
::: {#principle-latency-budget .callout-principle title="The Latency Budget Invariant" icon="false"}
...
2. **Machine Learning Operations (MLOps) (@sec-machine-learning-operations-mlops)**: The MLOps lifecycle—automated retraining, monitoring, versioning, and the continuous validation that catches drift before users do.
