...
**Invariant**: Moving a 32-bit value from DRAM can cost roughly 100–1,000$\times$ more energy than a 32-bit arithmetic operation, depending on operation type and process technology [@horowitz2014].
