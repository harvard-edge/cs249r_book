...
$$ \text{Time} = \underbrace{ \frac{\text{Data} (D)}{\text{Bandwidth} (B)} }_{\text{Reduce D}} + \underbrace{ \frac{\text{Ops} (O)}{\text{Peak} (P) \times \text{Efficiency} (\eta)} }_{\text{Reduce O, Maximize } \eta} + L $$
