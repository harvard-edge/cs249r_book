...
::: {#nte-pareto-frontier .callout-principle title="The Pareto Frontier" icon="false"}
...
::: {#nte-arithmetic-intensity .callout-principle title="Arithmetic Intensity Law" icon="false"}
...
::: {#nte-energy-movement .callout-principle title="The Energy-Movement Invariant" icon="false"}
...
::: {#nte-amdahls-law .callout-principle title="Amdahl's Law" icon="false"}
