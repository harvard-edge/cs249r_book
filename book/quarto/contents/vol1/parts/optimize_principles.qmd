...
::: {#nte-pareto-frontier .callout-note title="The Pareto Frontier" icon="false"}
...
::: {#nte-arithmetic-intensity .callout-note title="Arithmetic Intensity Law" icon="false"}
...
::: {#nte-energy-movement .callout-note title="The Energy-Movement Invariant" icon="false"}
...
::: {#nte-amdahls-law .callout-note title="Amdahl's Law" icon="false"}
