...
**Invariant**: Moving 1 bit of data from DRAM costs 100--1,000$\times$ more energy than performing an arithmetic operation on it.
$$ E_{\text{move}} \gg E_{\text{compute}} $$

**Implication**: **Data Locality** is the primary driver of efficiency. Optimization strategies must prioritize **kernel fusion** (keeping data in registers) and **quantization** (reducing data size) over reducing raw operation counts.
:::
