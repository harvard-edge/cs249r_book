...
**Principle**: As data volume ($D_{\text{vol}}$) grows, transferring the dataset can cost more than sending a much smaller query or code payload over the same constrained link [@mccrory2010datagravity].
