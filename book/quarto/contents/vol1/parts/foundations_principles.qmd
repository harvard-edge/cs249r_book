...
**Principle**: As data volume ($D_{\text{vol}}$) increases, moving data can cost more in latency or bandwidth than moving compute when the network is constrained [@mccrory2010datagravity].
