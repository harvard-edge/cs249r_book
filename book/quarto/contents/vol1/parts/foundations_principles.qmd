...
**Principle**: As data volume ($D_{\text{vol}}$) increases, moving data can cost more in latency, bandwidth, or energy than moving compute when the network is constrained.
