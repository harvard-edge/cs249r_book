...
**The Invariant**: Every model architecture and workload regime makes an implicit commitment to the hardware—a wager on which resource it will saturate first.
