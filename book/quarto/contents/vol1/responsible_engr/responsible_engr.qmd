...
: Fairness risks vary by archetype's data source and deployment context. {#tbl-fairness-archetype}
...
As we transition to the final chapter, consider how these responsibility practices connect to broader engineering philosophy.
