...
::: {.column-margin}
![](images/png/responsible_engr_dam_locator_data.png){width="100%" fig-alt="D-A-M locator triangle with three nodes: D (Data) at top filled solid green, A (Algorithm) and M (Machine) at the lower corners shown gray, connected by violet edges. The Data node is highlighted."}
:::
...
::: {.column-margin}
![](images/png/responsible_engr_blast_radius_sepsis.png){width="100%" fig-alt="A red square source on the left with five arrows fanning out to five identical blue circles on the right, representing one upstream fault propagating to many downstream consumers."}
...
::: {.column-margin}
![](images/png/responsible_engr_scale_anchor_goodhart.png){width="100%" fig-alt="A curve that stays flat then bends sharply upward at a red knee dot, with the region to the right of the knee shaded red to mark the danger zone."}
