...
# │          TCOCalc.t_subtotal_usd_str, TCOCalc.t_subtotal_carbon_str,
# │          TCOCalc.t_cycles_calc_str, TCOCalc.t_cycles_str,
# │          TCOCalc.t_total_usd_str, TCOCalc.t_total_carbon_str,
...
# │          TCOCalc.i_total_usd_str, TCOCalc.i_carbon_str,
...
# │          TCOCalc.t_total_carbon_tons_str, TCOCalc.t_total_k_usd_str,
...
| **Subtotal per training cycle** |                                      | **`{python} TCOCalc.t_subtotal_usd_str`** |       **`{python} TCOCalc.t_subtotal_carbon_str`**       |
...
| **Total training cost**         |       subtotal $\times$ cycles       |   **`{python} TCOCalc.t_total_usd_str`**  |        **`{python} TCOCalc.t_total_carbon_str`**         |
...
| **3-year inference cost** | annual $\times$ 3                | **`{python} TCOCalc.i_total_usd_str`** |  **`{python} TCOCalc.i_carbon_str`**   |
...
|:---------------|:------------------------------------:|:------------------------------:|:--------------------------------------------:|
| **Training**   | `{python} TCOCalc.t_total_k_usd_str` | `{python} TCOCalc.p_train_str` |  `{python} TCOCalc.t_total_carbon_tons_str`  |
| **Inference**  |  `{python} TCOCalc.i_total_usd_str`  |  `{python} TCOCalc.p_inf_str`  |     `{python} TCOCalc.i_carbon_tons_str`     |
