...
class GenderShadesDisparity:
    ...
    # ┌── 1. LOAD (Constants) ───────────────────────────────────────────────
    err_light_male = Literature.Fairness.GenderShadesErrLightMale.value
    err_light_female = Literature.Fairness.GenderShadesErrLightFemale.value
    err_dark_male = Literature.Fairness.GenderShadesErrDarkMale.value
    err_dark_female = Literature.Fairness.GenderShadesErrDarkFemale.value
...
A loan approval model\index{Fairness Metrics!loan approval case study} reports 85 percent accuracy on the majority group and 82.5 percent overall accuracy across the evaluated applicants---numbers that may satisfy a coarse aggregate dashboard. @Tbl-confusion-group-a and @tbl-confusion-group-b reveal what the aggregate conceals: loan approval outcomes for the same model evaluated separately on two demographic groups.
