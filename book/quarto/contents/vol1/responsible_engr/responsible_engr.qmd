...
We begin with concrete examples of the responsibility gap in action—cases where technically correct systems produced harmful outcomes. These examples establish why engineers must lead on responsibility, a topic we address after examining the evidence.
...
@sec-conclusion synthesizes the principles established throughout this volume into a coherent engineering philosophy. The question is not whether to build responsible systems but how to do so effectively given the technical foundations now established.
