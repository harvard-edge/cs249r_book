...
@lst-fairness-metrics-code demonstrates how to compute these fairness metrics programmatically using confusion matrix values, automating the calculations that production fairness monitoring systems perform continuously.
...
Volume II provides comprehensive treatment of carbon accounting methodologies, lifecycle analysis, and grid selection strategies (@sec-sustainable-ai). For now, engineers should recognize that efficient systems are inherently more sustainable systems. The alignment between efficiency and sustainability means responsible practice and self-interest point in the same direction.
...
This volume establishes the engineering foundations for understanding why responsibility matters and how to think about it systematically. Volume II provides the technical depth required to implement comprehensive responsible systems at scale, extending the concepts introduced here into specialized domains requiring dedicated treatment.
