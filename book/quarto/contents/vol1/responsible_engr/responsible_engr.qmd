...
**Problem**: To make carbon a first-class engineering metric, the TCO ledgers must convert "compute hours" into "kg CO~2~eq". What carbon factor does one GPU-hour carry under the scenario baseline?
