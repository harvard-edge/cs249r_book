...
- Identify model documentation and data governance requirements (**model cards**\index{Model Cards!definition}, **datasheets**, **data lineage**, **audit infrastructure**) for regulatory compliance and accountability
...
**The Physics**: You can equalize TPRs by adjusting the classification threshold\index{Classification Threshold!fairness adjustment} ($\tau$) for the disadvantaged group.
