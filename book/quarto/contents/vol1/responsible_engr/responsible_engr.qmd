...
- [ ] **Inference dominance**: Can you explain why a `{python} TCOSummary.quant_reduction_pct_str` inference latency reduction delivers more savings than a 50 percent training time reduction for a production system serving millions of users? <!-- lego-ok: conceptual comparison target in checkpoint prompt -->
