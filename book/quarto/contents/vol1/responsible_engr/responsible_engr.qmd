...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_int, fmt_display_math, fmt_percent, fmt_count, fmt_pp
...
class RepresentationStats:
    ...
    repr_equation_math = fmt_display_math(f" D_{{\\text{{eval,target}}}} = {target_imgs:,} \\text{{ images}} ")
```
...
from mlsysim.fmt import fmt, check, MarkdownStr, fmt_int, fmt_latency, fmt_params, fmt_power, fmt_time
...
class EdgeEfficiencyCalc:
    ...
    cam_fps_str = fmt_int(round(cam_fps), commas=False)
...
# │          carbon_train_ratio_str, inf_train_ratio_str,
# │          quant_reduction_pct_str, quant_savings_str,
# │          quant_carbon_tonnes_str
from mlsysim import Infrastructure
