...
When harm occurs, engineers need a diagnostic framework to identify the root cause. The AI Triad introduced in @sec-introduction provides exactly this structure through the **DAM Taxonomy** (defined in @sec-appendix-dam).
