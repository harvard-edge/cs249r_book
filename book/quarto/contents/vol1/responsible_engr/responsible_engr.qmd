...
# TCO summary derived values (from tables above)
training_3yr_k = 38
inference_3yr_m = 1.52
operations_3yr_k = 510
total_tco_m = training_3yr_k / 1000 + inference_3yr_m + operations_3yr_k / 1000

inf_train_ratio = (inference_3yr_m * 1000) / training_3yr_k
carbon_inference_tons = 97.4
quant_reduction_pct = 0.20
quant_savings_k = inference_3yr_m * 1000 * quant_reduction_pct
