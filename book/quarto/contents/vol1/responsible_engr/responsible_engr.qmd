...
class TCOCalc:
    ...
    t_data_prep_carbon_kg_str = fmt_emissions(t_data_prep_time * carbon_per_gpu_hour, unit=kg, precision=0, commas=False)
    t_hparam_carbon_kg_str = fmt_emissions(hparam_gpu_time * carbon_per_gpu_hour, unit=kg, precision=0, commas=False)
    t_final_carbon_kg_str = fmt_emissions(t_final_time * carbon_per_gpu_hour, unit=kg, precision=0, commas=False)
    t_subtotal_carbon_kg_str = fmt_emissions(train_carbon_cycle, unit=kg, precision=0, commas=False)
    t_total_carbon_kg_str = fmt_emissions(train_carbon_3yr, unit=kg, precision=0, commas=True)
