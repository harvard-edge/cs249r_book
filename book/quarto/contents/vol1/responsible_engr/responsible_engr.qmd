...
A loan approval model reports 85 percent accuracy on the majority group and 82.5 percent accuracy across these evaluated applicants---numbers that may satisfy a coarse aggregate dashboard.\index{Fairness Metrics!loan approval case study} @tbl-confusion-group-a and @tbl-confusion-group-b reveal what the aggregate conceals: loan approval outcomes for the same model evaluated separately on two demographic groups.
