...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_int, MarkdownStr, fmt_percent, fmt_count
...
class FairnessPrice:
    ...
    fp_increase_str     = fmt_pp(fp_increase_pp, precision=0, attributive=True)  # absolute FPR change
...
from mlsysim.fmt import check, fmt_carbon_intensity, fmt_emissions, fmt_power
...
*   **Conversion factor**: (`{python} CarbonFactor.gpu_power_kw_str` $\times$ 1 hour) $\times$ `{python} CarbonFactor.carbon_intensity_str` = `{python} CarbonFactor.carbon_per_gpu_hr_kg_str` CO~2~eq per GPU-hour.
