...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_int, MarkdownStr, fmt_percent
...
from mlsysim.fmt import fmt, check, MarkdownStr, fmt_qty, fmt_count
...
class InferenceCostCalc:
    ...
    lifecycle_inf_str   = fmt_usd(lifecycle_inf_cost_value/MILLION, precision=1, commas=False, suffix="M")
    ratio_str           = fmt_int(round(inf_train_ratio_value), commas=False)
    gpu_rate_input_str  = fmt_usd(gpu_rate_value, precision=0, commas=False, suffix="/hour")
    ...
    gpu_inf_rate_str    = fmt_usd(gpu_inf_rate_value, precision=2, commas=False, suffix="/GPU-hour")
```
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_int, fmt_usd, check, MarkdownStr, fmt_percent, fmt_qty
from mlsysim import Infrastructure
from mlsysim.core.constants import (
    THOUSAND,
    MILLION,
...
class TCOCalc:
    ...
    t_total_k_str = fmt_usd(round(train_tco_3yr/THOUSAND), commas=False, suffix="K")
    ...
    i_total_str = fmt_usd(inf_tco_3yr/MILLION, precision=2, commas=False, suffix="M")
    ...
    i_annual_cost_k_str = fmt_usd(round(inf_cost_day * DAYS_PER_YEAR / THOUSAND), commas=False, suffix="K")
    i_total_m_str = fmt_usd(inf_tco_3yr / MILLION, precision=2, commas=False, suffix="M")

    # Operations table strings — currency values use fmt() prefixes/suffixes.
    o_monitor_annual_str = fmt_usd(o_monitor_yr/THOUSAND, precision=0, commas=False, suffix="K")
    o_monitor_str = fmt_usd(o_monitor_yr*3/THOUSAND, precision=0, commas=False, suffix="K")
    o_oncall_annual_str = fmt_usd(o_oncall_yr/THOUSAND, precision=0, commas=False, suffix="K")
    o_oncall_str = fmt_usd(o_oncall_yr*3/THOUSAND, precision=0, commas=False, suffix="K")
    o_incident_annual_str = fmt_usd(o_incident_yr/THOUSAND, precision=0, commas=False, suffix="K")
    o_incident_str = fmt_usd(o_incident_yr*3/THOUSAND, precision=0, commas=False, suffix="K")
    o_total_str = fmt_usd(o_total_3yr/THOUSAND, precision=0, commas=False, suffix="K")
    o_monitor_annual_k_str = fmt_usd(o_monitor_yr / THOUSAND, precision=0, commas=False, suffix="K/year")
    o_oncall_annual_k_str = fmt_usd(o_oncall_yr / THOUSAND, precision=0, commas=False, suffix="K/year")
    o_incident_annual_k_str = fmt_usd(o_incident_yr / THOUSAND, precision=0, commas=False, suffix="K/year")
    o_total_k_str = fmt_usd(o_total_3yr / THOUSAND, precision=0, commas=False, suffix="K")

    # Summary strings — currency and unit values use fmt() prefixes/suffixes.
    total_tco_str = fmt_usd(total_tco/MILLION, precision=2, commas=False, suffix="M")
    ...
    train_gpu_rate_str = fmt_usd(train_gpu_rate, precision=0, commas=False, suffix="/hour")
...
class TCOSummary:
    ...
    quant_savings_str = fmt_usd(round(savings_dollars / THOUSAND), commas=False, suffix="K")
