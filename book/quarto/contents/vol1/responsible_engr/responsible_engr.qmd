...
**Context**: COMPAS\index{COMPAS!recidivism algorithm audit} is a risk assessment tool\index{Risk Assessment!criminal justice} used in US courtrooms to predict re-offending. Judges use these scores to inform bail and sentencing decisions [@angwin2016].

**Failure mode**: The ProPublica investigation revealed that the system's error rates were skewed:
...
::: {#exmp-responsible-engr-hospital-shortcut .callout-example title="The hospital shortcut (2018)"}
