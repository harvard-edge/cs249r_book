...
US sectoral regulations are less unified than the EU AI Act, but they force the same engineering posture. ECOA and Regulation B require creditors to provide specific reasons for adverse credit decisions, including when complex algorithms contribute to the decision [@cfpb2022adverseactionalgorithms]. The Fair Credit Reporting Act adds notice obligations when consumer-report information or credit scores are used, while the Fair Housing Act supplies a broader discrimination-prohibition constraint for housing-related decisions. Financial ML systems therefore need decision-specific explanations rather than only aggregate fairness reports. Healthcare regulations, including the Health Insurance Portability and Accountability Act (HIPAA)[^fn-hipaa-ml-constraints] and FDA guidance, layer data protection, validation, audit logging, and incident response requirements onto medical AI systems. Employment law prohibits discriminatory hiring practices regardless of whether discrimination results from human judgment or algorithmic scoring. The cumulative effect is that a system operating across domains must map each regulatory obligation to a concrete capability: explanation, human review, lineage, access control, deletion, monitoring, or incident response.
