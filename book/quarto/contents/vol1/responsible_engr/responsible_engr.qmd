...
error_light_female_value = 7.1  # %
error_dark_male_value = 12.0    # %
...
error_light_female_str = fmt(error_light_female_value, precision=1, commas=False)
error_dark_male_str = fmt(error_dark_male_value, precision=1, commas=False)
...
# OUTPUT
# =============================================================================
repr_target_images_str = f"{repr_target_images_value:,}"
repr_group_fraction_pct_str = f"{repr_group_fraction_value * 100:.0f}"
repr_group_fraction_str = f"{repr_group_fraction_value}"
repr_random_total_str = f"{repr_random_total_value:,}"
repr_multiplier_str = f"{repr_multiplier_value}"

# Markdown objects for LaTeX
...
a_tp_str = f"{a_tp_value:,}"
a_fn_str = f"{a_fn_value:,}"
a_fp_str = f"{a_fp_value:,}"
a_tn_str = f"{a_tn_value:,}"
b_tp_str = f"{b_tp_value:,}"
b_fn_str = f"{b_fn_value:,}"
b_fp_str = f"{b_fp_value:,}"
b_tn_str = f"{b_tn_value:,}"
a_total_str = f"{a_total_value:,}"
b_total_str = f"{b_total_value:,}"
```
...
# PURPOSE
# =============================================================================
# Purpose: Calculate utility loss for fairness tradeoff example
# Used in: "The Price of Fairness" callout

# =============================================================================
# INPUT
# =============================================================================
hire_value = 100_000
bad_hire_cost = 50_000
fp_increase_pp = 5
utility_loss_pct = 3
...
# OUTPUT
# =============================================================================
hire_value_k_str = f"${hire_value/1000:.0f}k"
bad_hire_cost_k_str = f"${bad_hire_cost/1000:.0f}k"
fp_increase_str = f"{fp_increase_pp}%"
utility_loss_str = f"{utility_loss_pct}%"
```
...
# PURPOSE
# =============================================================================
# Purpose: Define constraints and model specs for efficiency tables
# Used in: Edge Deployment Constraints and Model Efficiency Comparison tables

# =============================================================================
# INPUT
# =============================================================================
# Edge Constraints
smart_power = MOBILE_TDP_W
smart_latency = 100 * ms
iot_power = 100 * milliwatt
iot_latency = 1 * second
cam_power = 1 * watt
cam_latency = 33 * ms
wear_power = 500 * milliwatt
wear_latency = 500 * ms

# Model Efficiency
# MobileNetV2
mv2_params = MOBILENETV2_PARAMS
mv2_power = 1.2 * watt
mv2_latency = 40 * ms

# EfficientNet-B0
eff_params = 5.3 * Mparam
eff_power = 1.8 * watt
eff_latency = 65 * ms

# ResNet-50
rn50_params = RESNET50_PARAMS
rn50_power = 4.5 * watt
rn50_latency = 180 * ms

# TinyML
tiny_params = 50 * Kparam
...
users_daily_m_str = f"{users_daily_value / 1e6:.0f}"
...
# =============================================================================
gpu_rate_value = CLOUD_GPU_TRAINING_PER_HOUR.to(USD / hour).magnitude
inf_gpu_rate_value = CLOUD_GPU_INFERENCE_PER_HOUR.to(USD / hour).magnitude
carbon_per_gpu_hr_value = CARBON_PER_GPU_HR_KG.magnitude
...
quant_reduction_pct_str = f"{quant_reduction_pct_value * 100:.0f}"
```
...
# PURPOSE
# =============================================================================
# Purpose: Calculate carbon footprint of training a large model
# Used in: "The Carbon Cost of Scale" callout

# =============================================================================
# INPUT
# =============================================================================
train_energy_mwh = 1300
carbon_intensity = 0.4 # kg/kWh
car_annual_tons = 4.6
