...
\draw[LineA](0,-1.5)coordinate(B1)node[left]{Subgroup B}--(12.5,-1.5)coordinate(B2);
\coordinate(D7G)at($(A1)!0.3!(A2)$);
\coordinate(D8G)at($(A1)!0.63!(A2)$);
\coordinate(D7D)at($(B1)!0.3!(B2)$);
\coordinate(D8D)at($(B1)!0.63!(B2)$);
\draw[LineD]($(D7G)+(0,1)$)node[above](SE){75\%}--($(D7D)+(0,-0.57)$);
\draw[LineD]($(D8G)+(0,1)$)node[above]{81.25\%}--($(D8D)+(0,-0.57)$)coordinate(DO);
...
*Training one model can emit more carbon than 100 cars in a year.*
:::
