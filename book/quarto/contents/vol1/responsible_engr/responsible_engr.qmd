...
\noindent
![](images/png/cover_responsible_engr_blueprint_print.png){fig-alt="Isometric governed ML system chamber with fairness checks, safety rails, audit records, privacy boundaries, and incident response paths around a deployed pipeline."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_responsible_engr_blueprint.webp){fig-alt="Isometric governed ML system chamber with fairness checks, safety rails, audit records, privacy boundaries, and incident response paths around a deployed pipeline."}
:::
