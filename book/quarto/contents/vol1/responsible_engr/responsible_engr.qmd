...
# OUTPUT
# =============================================================================
error_light_male_str = f"{error_light_male_value:.1f}"
error_dark_female_str = f"{error_dark_female_value:.1f}"
disparity_str = f"{disparity_fold_value:.1f}"
acc_light_str = f"{accuracy_light_male_value:.1f}"
acc_dark_str = f"{accuracy_dark_female_value:.1f}"
```
...
# OUTPUT
# =============================================================================
a_approval_str = f"{a_approval_pct_value:.0f}"
b_approval_str = f"{b_approval_pct_value:.0f}"
dp_disparity_str = f"{dp_disparity_pp_value:.0f}"
a_tpr_str = f"{a_tpr_pct_value:.0f}"
b_tpr_str = f"{b_tpr_pct_value:.0f}"
tpr_disparity_str = f"{tpr_disparity_pp_value:.0f}"
a_fpr_str = f"{a_fpr_pct_value:.0f}"
b_fpr_str = f"{b_fpr_pct_value:.0f}"
a_fnr_str = f"{a_fnr_pct_value:.0f}"
b_fnr_str = f"{b_fnr_pct_value:.0f}"
```
...
# OUTPUT
# =============================================================================
data_prep_str = f"{data_prep_cost_value:,.0f}"
hyperparam_str = f"{hyperparam_cost_value:,.0f}"
train_cost_str = f"{train_cost_value:,.0f}"
total_train_str = f"{total_train_cost_value:,.0f}"
inferences_m = f"{inferences_daily_value / 1e6:.0f}"
gpus_str = f"{gpus_needed_value:.0f}"
annual_inf_str = f"{annual_inf_cost_value:,.0f}"
lifecycle_inf_str = f"{lifecycle_inf_cost_value / 1e6:.1f}"
ratio_str = f"{inf_train_ratio_value:.0f}"
```
...
p_train_str = f"{p_train_value:.0f}"
p_inf_str = f"{p_inf_value:.0f}"
p_ops_str = f"{p_ops_value:.0f}"
i_daily_q_m_str = f"{i_daily_q_value/1e6:.0f}"
i_latency_ms_str = f"{i_latency_value*1000:.0f}"
i_annual_k_str = f"${i_annual_cost_value/1e3:.0f}K"
i_users_m_str = f"{i_users_value/1e6:.0f}"
```
...
# OUTPUT
# =============================================================================
inf_train_ratio_str = f"{inf_train_ratio_value:.0f}"
quant_savings_str = f"{quant_savings_k_value:.0f}"
quant_carbon_str = f"{quant_carbon_tons_value:.0f}"
```
