...
::: {.callout-perspective title="Diagnosing Responsibility with the DAM Taxonomy"}
...
Responsibility in ML systems cannot be delegated exclusively to ethics boards or legal departments. These groups provide essential oversight but lack the technical access required to identify problems early in the development process.
...
::: {.callout-lighthouse title="Fairness Concerns by Archetype" collapse="true"}
