...
Because that GitHub work continues, this book benefits from a continuously evolving community of contributors. The online version at [mlsysbook.ai](https://mlsysbook.ai/vol1/contents/vol1/frontmatter/acknowledgements.html) provides the complete, current list of GitHub contributors. The collaborative nature of this open-source project means new contributors join regularly. Contribution guidelines appear in the GitHub repository at <https://github.com/harvard-edge/cs249r_book>.
:::
