...
This is the first of two volumes. Volume I covers the single compute node: one machine, one to eight accelerators, a shared memory space. A companion volume, *Machine Learning Systems, Volume II: Advanced ML Systems*, extends these foundations to the distributed scale.
