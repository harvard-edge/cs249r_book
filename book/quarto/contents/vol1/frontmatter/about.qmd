...
This book covers the single compute node described earlier. Topics such as distributed training strategies, fleet-scale infrastructure, production deployment at global scale, and governance challenges that arise when ML systems operate in the real world extend beyond this scope; they are the subject of Volume II, *Machine Learning Systems at Scale*.

Completing this book therefore gives readers the prerequisite knowledge for that volume and for the broader practice of ML systems engineering at scale.
