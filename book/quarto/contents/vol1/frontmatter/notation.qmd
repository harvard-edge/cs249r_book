# Notation and Conventions {#sec-notation-conventions .unnumbered}
...
The silent failure mode of ML systems is captured by the Degradation Equation (@sec-introduction-degradation-equation-e87e):
...
| **$D(P_t \              | P_0)$**                   | **Statistical Divergence** | Scalar $\ge 0$                                                                       | Measures how far $P_t$ has drifted from $P_0$. Common choices: KL divergence, total variation, Wasserstein. |
| **$\tau$**              | **Drift Threshold**       | Scalar $> 0$               | Retraining is triggered when $D(P_t \                                                | P_0) > \tau$.                                                                                               |

## The Energy Corollary

The energy cost of ML workloads (@sec-silicon-contract) decomposes as:
