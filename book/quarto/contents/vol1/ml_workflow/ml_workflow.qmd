...
* **Iteration velocity compounds**: A model starting 5 percent behind but iterating 10$\times$ faster overtakes the leader, because each cycle improves data, architecture, and hyperparameters simultaneously (the iteration tax).
