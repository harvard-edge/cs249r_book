...
::: {.column-margin}
![](images/svg/vol1_ml_workflow_margin_001.svg){width="100%" fig-alt="Margin illustration showing Weekly and hourly iteration curves crossing over 26 weeks."}

*Shows slow iteration losing to fast feedback over time.*
:::
...
::: {.column-margin}
![](images/svg/vol1_ml_workflow_margin_002.svg){width="100%" fig-alt="Margin illustration showing Raw retinal uploads versus edge detection summaries."}

*Shows why edge summaries beat raw medical-image uploads when bandwidth dominates.*
:::
...
::: {.column-margin}
![](images/svg/vol1_ml_workflow_margin_003.svg){width="100%" fig-alt="Margin illustration showing 90 percent sensitivity floor with 78 percent field result below it."}

*Shows production validation as a gate: field sensitivity below the required floor fails deployment.*
:::
...
::: {.column-margin}
![](images/svg/vol1_ml_workflow_margin_004.svg){width="100%" fig-alt="Margin illustration showing Cloud and edge cumulative cost curves with payback crossing."}

*Shows the lifecycle cost crossover between cloud and edge deployment.*
:::
