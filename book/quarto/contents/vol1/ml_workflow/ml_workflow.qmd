...
1. **Large model**: `{python} IterationTax.weeks_str` experiments at `{python} IterationTax.large_time_weeks_str` each. Each experiment improves accuracy by ~`{python} IterationTax.large_gain_str` (diminishing returns).
...
# │ Exports: MobilenetSpecs.mobilenet_size_mb_str, MobilenetSpecs.mobilenet_flops_str
# └─────────────────────────────────────────────────────────────────────────────
...
# │          BandwidthCompute.bw_daily_gb_str, BandwidthCompute.bw_upload_mbps_s_str,
...
class BandwidthCompute:
    ...
    bw_upload_mbps_s_str = fmt_qty(uplink_q, megabit / second, precision=0, commas=False, unit_label="Mb/s")
...
2.  **Upload time**: The uplink is `{python} BandwidthCompute.bw_upload_mbps_s_str`, or `{python} BandwidthCompute.bw_upload_mbs_str`. Thus `{python} BandwidthCompute.bw_daily_mb_str` / `{python} BandwidthCompute.bw_upload_mbs_str` = `{python} BandwidthCompute.bw_upload_sec_str` ≈ `{python} BandwidthCompute.bw_upload_hours_str`.
