...
::: {.column-margin}
![](images/png/ml_workflow_feedback_timescales.png){width="100%" fig-alt="Vertical ladder of six feedback-loop cadences as nested blue bars, longest at top to shortest at bottom: quarter, month, week, day, hour, minute. The bar lengths span roughly five orders of magnitude in duration."}
