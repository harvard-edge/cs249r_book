...
-   **Model Development and Training**: Defines the **Operations ($O$)** term. Architectural choices (e.g., transformers vs. convolutional neural networks (CNNs)) set the computational floor.
