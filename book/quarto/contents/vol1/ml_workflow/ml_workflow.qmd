...
- Annual cost: `{python} DeploymentEconomics.n_clinics_str` clinics $\times$ `{python} DeploymentEconomics.patients_per_day_str` patients/day $\times$ `{python} DeploymentEconomics.billable_images_per_patient_str` billable image/patient $\times$ `{python} DeploymentEconomics.days_per_year_str` days $\times$ `{python} DeploymentEconomics.cloud_cost_per_image_str` = `{python} DeploymentEconomics.cloud_annual_usd_str`
