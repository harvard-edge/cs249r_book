...
from mlsysim.fmt import check, fmt, fmt_bandwidth, fmt_multiple, fmt_percent, fmt_qty, fmt_time
...
class BandwidthCompute:
    ...
    mb_per_photo_q = Scenarios.ClinicalImaging.RetinalPhotoSize
    ...
    bw_upload_mbps_s_str = fmt_bandwidth(uplink_q, unit=megabit / second, precision=0, commas=False)
...
class DeploymentEconomics:
    ...
    image_size_q = Scenarios.ClinicalImaging.RetinalPhotoSize
