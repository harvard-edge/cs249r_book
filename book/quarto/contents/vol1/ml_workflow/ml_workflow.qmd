...
class ConstraintPropagation:
    ...
    stage5_latency_ms_str = fmt_time(stage5_latency_ms, "ms", precision=0, commas=False)
    stage5_memory_mb_str = fmt(stage5_memory_mb, precision=0, commas=False, suffix=" MB")
    jetson_latency_ms_str = fmt_time(jetson_latency_ms, "ms", precision=0, commas=False)
...
class BandwidthCompute:
    ...
    bw_upload_sec_str = fmt_time(upload_seconds, "s", precision=0, commas=True)
    bw_upload_hours_str = fmt_time(round(upload_hours), "h", precision=0, commas=False)
    bw_clinic_hours_str = fmt_time(clinic_hours, "h", precision=0, commas=False)
...
class DeploymentEconomics:
    ...
    edge_latency_benefit_str = fmt_time(edge_latency_ms, "ms", precision=0, commas=False)
...
class MonitoringThresholds:
    ...
    latency_p95_target_str = fmt_time(latency_p95_target, "ms", precision=0, commas=False)
    latency_alert_str = fmt_time(latency_alert, "ms", precision=0, commas=False)
```
