...
class DataScientistTime:
    ...
    # ┌── 1. LOAD (Constants) ──────────────────────────────────────────────
    cleaning_pct = Literature.Surveys.DataScientistCleaning.value
    collection_pct = Literature.Surveys.DataScientistCollecting.value
    mining_pct = Literature.Surveys.DataScientistMining.value
    training_set_pct = Literature.Surveys.DataScientistBuildingTrainingSets.value
    algorithm_refinement_pct = Literature.Surveys.DataScientistRefiningAlgorithms.value
    other_pct = Literature.Surveys.DataScientistOther.value
