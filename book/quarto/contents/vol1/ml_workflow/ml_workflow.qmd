...
|:-------------|:----------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------------|
| **Data Eng** | Keep image batches available fast enough to sustain >80 percent GPU utilization.                          | Keep online feature-store lookups (model-input reads) below 2 ms; embedding tables dominate storage and freshness. | Curate short audio clips for a 256 KB SRAM-class device.                                |
