...
2. **Small Model**: 26 × 168 = `{python} small_exp_str` experiments at 1 hour each. Even with smaller gains per iteration, the compound effect is substantial.
...
edge_maintenance = 25000
edge_maintenance_str = f"{edge_maintenance:,}"
edge_total_str = f"{edge_capex:,}"
...
- Annual cost: 500 clinics × 50 patients × 365 days × $0.01 = **$`{python} cloud_annual_str`/year**
...
- One-time hardware: 500 × $500 = **$`{python} edge_capex_str`** capital expense
