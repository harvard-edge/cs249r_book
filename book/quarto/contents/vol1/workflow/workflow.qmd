...
# OUTPUT
# =============================================================================
weeks_in_6mo_str = str(weeks_in_6mo_value)
hours_per_week_str = str(hours_per_week_value)
small_model_experiments_str = f"{small_model_experiments_value:,}"

large_accuracy_str = str(large_accuracy_value)
small_accuracy_str = str(small_accuracy_value)
large_gain_str = str(large_gain_per_iter_value)
small_gain_str = str(small_gain_per_iter_value)
small_potential_iters_str = str(small_potential_iters_value)

large_final_str = f"{large_final_value:.0f}"
small_final_str = f"{small_final_value:.0f}"
```
...
# OUTPUT
# =============================================================================
bw_patients_str = str(bw_patients_per_day_value)
bw_photos_str = str(bw_photos_per_patient_value)
bw_mb_per_photo_str = str(bw_mb_per_photo_value)
bw_daily_mb_str = f"{bw_daily_data_mb_value:,}"
bw_daily_gb_str = f"{bw_daily_data_gb_value:.0f}"
bw_upload_mbps_str = str(bw_upload_mbps_value)
bw_upload_mbs_str = f"{bw_upload_mbs_value}"
bw_upload_sec_str = f"{bw_upload_time_sec_value:,.0f}"
bw_upload_hours_str = f"{bw_upload_time_hours_value:.1f}"
bw_clinic_hours_str = str(bw_clinic_hours_value)
bw_bandwidth_pct_str = f"{bw_bandwidth_pct_value:.0f}"
bw_summary_kb_str = str(bw_summary_kb_per_patient_value)
...
patients_per_day_str = str(patients_per_day_value)
days_per_year_str = str(days_per_year_value)
cloud_cost_per_image_str = f"{cloud_cost_per_image_value:.2f}"
cloud_network_str = f"{cloud_network_value:,}"
edge_cost_per_unit_str = f"{edge_cost_per_unit_value:,}"
image_size_mb_str = str(image_size_mb_value)
edge_inference_cost_str = f"{edge_inference_cost_value}"
cloud_latency_risk_str = str(cloud_latency_risk_ms_value)
edge_latency_benefit_str = str(edge_latency_benefit_ms_value)

cloud_annual_str = f"{cloud_annual_value:,.0f}"
cloud_total_str = f"{cloud_total_value:,.0f}"
edge_capex_str = f"{edge_capex_value:,.0f}"
edge_maintenance_str = f"{edge_annual_maint_value:,}"
payback_str = f"{payback_years_value:.0f}"
```
