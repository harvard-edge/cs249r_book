...
large_gain_str = fmt(large_gain_per_iter_value, precision=0, commas=False)
small_gain_str = fmt(small_gain_per_iter_value, precision=0, commas=False)
