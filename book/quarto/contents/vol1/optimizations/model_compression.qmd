...
<!-- TODO(bib-pass): Several specific accuracy/latency numbers in this section
     (e.g., 99.1 percent BERT INT8 GLUE, 96.8 percent PTQ vs. 99.1 percent QAT, 97 percent distill-during-training
     vs. 92--94 percent post-hoc, 8--12 percent INT4 attention drop) read as literature results but
     are not cited. A dedicated bib-audit pass should attribute each empirical
     claim or qualify it as illustrative. Python-computed values via FallaciesAnalysis
     are chapter-derived and do not need citation. -->
