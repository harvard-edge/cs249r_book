...
# │
# │ Goal: Demonstrate the bandwidth benefits of fusing element-wise operations.
# │ Show: A 2.67× memory traffic reduction (8 MB to 3 MB) for fused ops.
# │ How: Model memory transfers for four element-wise operations on V100 hardware.
# │
# │ Imports: mlsys.formatting (fmt, md_math)
