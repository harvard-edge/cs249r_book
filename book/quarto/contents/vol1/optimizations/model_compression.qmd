...
a100_int8_speedup_str = str(a100_int8_speedup_value)

energy_dram_str = f"{energy_dram_value:.0f}"
energy_dram_per_byte_str = f"{energy_dram_per_byte_value:.0f}"
...
int8_fp32_energy_ratio_str = f"{int8_fp32_energy_ratio_value:.1f}"

v100_bw_gbs_str = f"{v100_bw_gbs_value:.0f}"
v100_tflops_fp32_str = f"{v100_tflops_fp32_value:.1f}"

resnet_params_m_str = f"{resnet_params_m_value:.1f}"
resnet_gflops_str = f"{resnet_gflops_value:.1f}"
mobilenetv2_mflops_str = f"{mobilenetv2_mflops_value:.0f}"

llm_7b_str = f"{llm_7b_params_value}"
llm_7b_mem_str = f"{llm_7b_mem_fp16_gb_value:.0f}"
llm_175b_str = f"{llm_175b_params_value:.0f}"
llm_175b_mem_str = f"{llm_175b_mem_fp16_gb_value:.0f}"
...
# OUTPUT
# =============================================================================
params_b_str = str(params_b_value)
billion_exp_str = "10^9"
bytes_fp16_str = str(bytes_fp16_value)
bytes_int4_str = str(bytes_int4_value)
device_ram_gb_str = str(device_ram_gb_value)
mem_bw_gbs_str = str(mem_bw_gbs_value)
kv_cache_gb_str = str(kv_cache_gb_value)

fp16_size_str = f"{fp16_size_gb_value:.0f}"
fp16_total_str = f"{fp16_total_gb_value:.0f}"
fp16_latency_str = f"{fp16_latency_ms_value:.0f}"
fp16_toks_str = f"{fp16_toks_per_sec_value:.1f}"
int4_size_str = f"{int4_size_gb_value:.1f}"
int4_latency_str = f"{int4_latency_ms_value:.0f}"
int4_toks_str = f"{int4_toks_per_sec_value:.0f}"
speedup_str = f"{speedup_value:.0f}"
```
...
# OUTPUT
# =============================================================================
full_mb_str = f"{full_mb_value:.0f}"
factored_mb_str = f"{factored_mb_value:.0f}"
data_reduction_str = f"{data_reduction_value:.0f}"
mat_dim_str = str(mat_dim_value)
rank_k_str = str(rank_k_value)
```
...
# OUTPUT
# =============================================================================
llm_params_b_str = str(llm_params_b_value)
billion_exp_llm_str = "10^9"
fp16_bytes_str = str(fp16_bytes_value)
int4_bytes_str = str(int4_bytes_value)
fp16_size_gb_str = f"{fp16_size_gb_value:.0f}"
int4_size_gb_str = f"{int4_size_gb_value:.0f}"
compression_ratio_str = f"{compression_ratio_value:.0f}"
```
...
simd_register_bits_str = str(simd_register_bits_value)
simd_fp32_bits_str = str(simd_fp32_bits_value)
simd_int8_bits_str = str(simd_int8_bits_value)
```
...
# OUTPUT
# =============================================================================
transfer_reduction_str = f"{transfer_reduction_value:.0f}"
```
...
# OUTPUT
# =============================================================================
ew_reduction_str = f"{ew_reduction_value:.2f}"
saved_us_str = f"{saved_us_value:.0f}"
```
