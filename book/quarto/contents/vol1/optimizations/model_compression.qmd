...
::: {#lst-quantization_example lst-cap="**Uniform Quantization**\index{Uniform Quantization!definition}: Converts FP32 weights to INT8 format, achieving 4$\times$ memory reduction while measuring quantization error."}
...
::: { .quiz-end }
:::
ompressed models at maximum throughput.
