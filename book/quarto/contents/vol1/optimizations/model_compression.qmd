...
*   **Region 3: The Steep Drop**. Aggressive pruning (e.g., removing 90 percent of weights) might drop accuracy by 10 percent to gain another 20 percent speedup. This is the **danger zone** where the model becomes useless.
...
- [ ] **Accuracy vs. Cost**: Do you understand why removing 50 percent of weights (Pruning) might drop accuracy by one percent, but reducing precision (Quantization) to INT8 might drop it by 0.5 percent while saving 4$\times$ memory?
