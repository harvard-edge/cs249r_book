...
class MobileNetCompressionAnchor:
    ...
    original_size_mb_str = f"{original_size_mb}MB"
    pruned_size_mb_str = f"{pruned_size_mb}MB"

# ┌── EXPORTS (Bridge to Text) ─────────────────────────────────────────────────
mobilenet_pruning_pct_str = MobileNetCompressionAnchor.pruning_pct_str
mobilenet_original_size_str = MobileNetCompressionAnchor.original_size_mb_str
mobilenet_pruned_size_str = MobileNetCompressionAnchor.pruned_size_mb_str
