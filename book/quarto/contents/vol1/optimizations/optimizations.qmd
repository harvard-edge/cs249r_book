...
[^fn-overparameterization]: **Overparameterization**: Networks with 10-100× more parameters than theoretically necessary. GPT-3's 175B parameters could compress to 1-10B maintaining 95% performance, yet overparameterization enables faster convergence through smoother loss landscapes (lottery ticket hypothesis) and implicit regularization from SGD. This paradox drives compression research while explaining training dynamics.
...
FlashAttention represents an advanced fusion pattern that reorganizes attention computation to minimize memory traffic:
