...
\begin{scope}
    ...
    \foreach \x/\y in {0.5/1.5, 1.0/2.0, 0.3/2.5, 1.5/2.5, 2.0/3.0,
        ...
        \fill[red!60] (\x, \y) ++(90:2.6pt) -- ++(210:5.2pt) -- ++(330:5.2pt) -- cycle;
    }
...
\node[font=\scriptsize\sffamily, text=BrownLine!90, anchor=north]
  at ([yshift=-1mm]W0.north |- B0.south) {local\_scores $\uparrow$};
\node[font=\scriptsize\sffamily, text=BlueLine!80, anchor=south west]
  at ([xshift=2mm]W2.north |- B0.south) {$\downarrow$ coreset\_indices};
...
\vspace*{-20mm}
```
![](images/svg/vol1_data_selection_margin_004.svg){width="100%" fig-alt="A single red line falls from 95 percent accuracy at generation 1 to 78 percent at generation 5, a 17-percentage-point decline."}
