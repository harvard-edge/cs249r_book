...
### Generative Synthesis: Creating New Samples {#sec-data-selection-generative-synthesis-creating-new-samples-3873}
...
### Augmented Pipeline Parallelism {#sec-data-selection-augmented-pipeline-parallelism-ee1b}
...
### The Total Cost of Training Data {#sec-data-selection-total-cost-training-data-92b9}
...
### ROI Framework for Data Selection Techniques {#sec-data-selection-roi-framework-data-selection-techniques-03cd}
...
### The Distributed Selection Problem {#sec-data-selection-distributed-selection-problem-24b5}
...
### Data Selection × Model Compression {#sec-data-selection-data-selection-model-compression-3d6d}
...
### Data Selection × Hardware Acceleration {#sec-data-selection-data-selection-hardware-acceleration-be6d}
...
### Data Selection × Distributed Training {#sec-data-selection-data-selection-distributed-training-b34a}

The hardware bottleneck analysis above assumes single-machine training, but the interactions become more complex when scaling to multiple machines. Data selection affects different parallelism strategies in distinct ways.
...
For a comprehensive treatment of data selection metrics and benchmarking methodologies, including how initiatives like DataPerf are standardizing evaluation protocols, see @sec-benchmarking-ai. That chapter provides the measurement framework needed to quantify the ROI of the techniques introduced here.
