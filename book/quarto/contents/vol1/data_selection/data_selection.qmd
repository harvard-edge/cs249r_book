...
|:-----------------|:-------------------------------------------------:|:---------------------------------------------:|:----------------------------------------------------:|:-------------------------------------------------------:|
| **HDD (7.2k)**   |  ~`{python} RandomAccessPenalty.hdd_seq_mb_s_str` |  ~`{python} RandomAccessPenalty.hdd_iops_str` | ~`{python} RandomAccessPenalty.hdd_random_mb_s_str`  |  `{python} RandomAccessPenalty.hdd_penalty_str`$\times$ |
| **SATA SSD**     | ~`{python} RandomAccessPenalty.sata_seq_mb_s_str` | ~`{python} RandomAccessPenalty.sata_iops_str` | ~`{python} RandomAccessPenalty.sata_random_mb_s_str` | `{python} RandomAccessPenalty.sata_penalty_str`$\times$ |
| **NVMe SSD**     | ~`{python} RandomAccessPenalty.nvme_seq_mb_s_str` | ~`{python} RandomAccessPenalty.nvme_iops_str` | ~`{python} RandomAccessPenalty.nvme_random_mb_s_str` | `{python} RandomAccessPenalty.nvme_penalty_str`$\times$ |
...
from mlsysim.fmt import fmt_percent, fmt, check, fmt_time, fmt_rate
...
from mlsysim.fmt import fmt_percent, fmt, check, MarkdownStr, fmt_count, fmt_usd
...
class FpFallacyCalc:
    ...
    synthetic_acc_drop_str = fmt(synthetic_acc_drop_pp, precision=0, commas=False)
    optimal_synthetic_mix_str = MarkdownStr(f"{optimal_synthetic_mix_min_pct}–{optimal_synthetic_mix_max_pct} percent")
