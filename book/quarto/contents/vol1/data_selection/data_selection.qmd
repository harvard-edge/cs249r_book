...
class ActiveLearningRoi:
    ...
    baseline_calc_math = fmt_math(f"{budget_str} \\div {cost_per_label_math_str} = {n_random_str}")

    cost_active_calc_math = fmt_math(f"{n_active_str} \\times {cost_per_label_math_str} = {cost_active_str}")
