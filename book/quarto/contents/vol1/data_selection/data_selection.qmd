...
class IcrCoresetComparison:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    resnet50_fwd_gflops_str = fmt(resnet50_fwd_flops, precision=1)
    resnet50_fwdbwd_gflops_str = fmt(resnet50_fwdbwd_flops, precision=1)
    full_epoch_flops_str = fmt_sci_qty(full_epoch_flops, flop, precision=2, unit_label="FLOPs")
    ...
    coreset_flops_str = fmt_sci_qty(coreset_flops, flop, precision=1, unit_label="FLOPs")
...
class SelectionBottleneckAnchor:
    ...
    scoring_time_str = fmt_time(scoring_time, 'hour', precision=1, commas=False, style='word')
...
class SelectionInequalityCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    score_a_str = fmt_time(score_a_time, 'second', precision=0, commas=True)
    score_a_hrs_str = fmt_time(score_a_time, 'hour', precision=1, commas=False)
    train_a_str = fmt_time(train_a_time, 'second', precision=0, commas=True)
    ...
    score_b_str = fmt_time(score_b_time, 'second', precision=0, commas=True)
    ...
    baseline_str = fmt_time(baseline_time, 'second', precision=0, commas=True)
    baseline_hrs_str = fmt_time(round(baseline_time.to(hour).magnitude), 'hour', precision=0, commas=False)
    savings_a_str = fmt_time(round(savings_a_time.to(hour).magnitude), 'hour', precision=0, commas=False)
    savings_a_pct_str = fmt_percent(savings_a_fraction, precision=0, commas=False, style='symbol')
    savings_b_str = fmt_time(round(savings_b_time.to(hour).magnitude), 'hour', precision=0, commas=False)
    savings_b_pct_str = fmt_percent(savings_b_fraction, precision=1, commas=False, style='symbol')
    b_beats_a_str = fmt_time(round(b_beats_a_time.to(hour).magnitude), 'hour', precision=0, commas=False)
    trap_total_str = fmt_time(round(trap_total_time.to(hour).magnitude), 'hour', precision=0, commas=False)
    ...
    coreset_pct_str = fmt_percent(coreset_fraction_value, precision=0, commas=False, style='prose')
    resnet50_time_per_image_str = fmt_time(resnet50_time_per_image, 'second', precision=2, commas=False, per='image')
    resnet18_time_per_image_str = fmt_time(resnet18_time_per_image, 'second', precision=3, commas=False, per='image')
...
class CostBreakdown:
    ...
    c_raw_str = fmt_usd(raw_data_cost, precision=0)
    c_label_str = fmt_usd(label_cost, precision=0)
    c_store_str = fmt_usd(storage_cost, precision=0, commas=False)
    c_train_str = fmt_usd(train_compute_cost, precision=0)
    c_total_str = fmt_usd(total_cost, precision=0)
...
class DistributedOverheadCalc:
    ...
    t_embed_str = fmt_time(t_embed, 'minute', precision=0, commas=False, style='word')
    t_dedup_str = fmt_time(t_dedup, 'minute', precision=0, commas=False, style='word')
    t_score_str = fmt_time(t_score, 'minute', precision=0, commas=False, style='word')
    t_select_str = fmt_time(t_select, 'minute', precision=0, commas=False, style='word')
    t_total_overhead_str = fmt_time(t_total_overhead, 'minute', precision=0, commas=False, style='word')
```
...
class FpPitfallCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    selection_time_bad_str = fmt_time(selection_time_bad, 'hour', precision=0, commas=False, style='word')
    ...
    full_training_time_str = fmt_time(full_training_time, 'hour', precision=0, commas=False, style='word')
    selection_overhead_ratio_str = fmt(selection_overhead_ratio_value, precision=0, commas=False)
    selection_time_good_str = fmt_time(selection_time_good, 'minute', precision=0, commas=False, style='word')
