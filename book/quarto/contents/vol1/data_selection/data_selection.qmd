...
llama_params_str = fmt(llama_params_value / 1e9, precision=0) + "B"   # e.g. "70B"
h100_count_str = fmt(h100_count_value, precision=0, commas=True)    # e.g. "10,000"
tokens_capacity_str = fmt(tokens_capacity_value / 1e12, precision=0) + "T"    # e.g. "10T"
tokens_available_str = fmt(tokens_available_value / 1e12, precision=0) + "T"  # e.g. "5T"
...
imagenet_size_str = fmt(imagenet_size_value / 1e6, precision=2) + "M"           # e.g. "1.28M"
...
# --- Outputs (formatted strings for prose) ---
n_train_images_str = fmt(n_train_images_value / 1e6, precision=0) + " million"  # e.g. "1 million"
...
# --- Outputs (formatted strings for prose) ---
n_unlabeled_str = fmt(n_unlabeled_value / 1e6, precision=0) + " Million"    # e.g. "1 Million"
...
cost_saving_str = fmt(cost_saving_value / 1e6, precision=2) + " Million"    # e.g. "4.75 Million"
```
...
n_labels_str = fmt(n_labels_value / 1e6, precision=1) + "M" # e.g. "1.2M"
...
# Fallacy 1
data_1m_str = fmt(data_1m_value / 1e6, precision=0) + "M"
data_10m_str = fmt(data_10m_value / 1e6, precision=0) + "M"
...
raw_size_str = fmt(raw_size_value / 1e6, precision=0) + "M"
...
# Fallacy 4
training_run_cost_str = fmt(training_run_cost_value / 1e6, precision=0) + "M"
efficiency_gain_pct_str = fmt(efficiency_gain_pct_value, precision=0, commas=False)
savings_str = fmt(savings_value / 1e6, precision=0) + "M"
...
# Pitfall 2
total_samples_str = fmt(total_samples_value / 1e6, precision=0) + "M"
