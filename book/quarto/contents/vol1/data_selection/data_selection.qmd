...
from mlsysim.fmt import check, fmt, fmt_usd, fmt_percent, fmt_count
...
class ComputeDataGap:
    ...
    filtered_corpus_tokens_str = fmt_count(filtered_corpus_tokens, scale='T', precision=0, commas=False)
    public_text_stock_str = fmt_count(public_text_stock, scale='T', precision=0, commas=False)
...
from mlsysim.fmt import fmt_percent, fmt, check, fmt_sci, MarkdownStr, fmt_count
...
class IcrCoresetComparison:
    ...
    imagenet_size_str = fmt_count(imagenet_size_value, scale='M', precision=2)
    # Custom "K" suffix on a divided count uses fmt() suffix discipline.
    coreset_size_str = fmt_count(coreset_size_value, scale='K', precision=1, commas=False)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_percent, fmt_int, fmt, check, fmt_count
...
class SelectionInequalityCalc:
    ...
    n_images_str = fmt_count(n_images_value, scale='M', precision=0, commas=False)
...
class DataEchoingRoi:
    ...
    gpu_util_str = fmt_percent(round(gpu_util_no_echo_value)/100, precision=0, commas=False, style='symbol')
...
class CostBreakdown:
    ...
    n_labels_str = fmt_count(n_labels_value, scale='M', precision=1)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_percent, fmt, check, MarkdownStr, fmt_count
...
class FpFallacyCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    data_1m_str = fmt_count(data_1m_value, scale='M', precision=0)
    data_10m_str = fmt_count(data_10m_value, scale='M', precision=0)
    acc_gain_10x_str = fmt(acc_gain_10x_value, precision=0, commas=False, suffix=" percentage points")
    curated_size_str = fmt_count(curated_size_value, scale='K', precision=0)
    raw_size_str = fmt_count(raw_size_value, scale='M', precision=0)
    ...
    training_run_cost_str = fmt_count(training_run_cost_value, scale='M', precision=0)
    efficiency_gain_pct_str = fmt_percent(efficiency_gain_pct_value/100, precision=0, commas=False, style='prose')
    savings_str = fmt_count(savings_value, scale='M', precision=0)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, check, fmt_percent, fmt_count
...
class FpPitfallCalc:
    ...
    total_samples_str = fmt_count(total_samples_value, scale='M', precision=0)
