...
**Systems insight**: This workflow concentrates training on the illustrated decision boundary rather than redundant easy examples; whether it outperforms random sampling depends on proxy transfer, noise, coverage, and the target metric.
...
\vspace*{-1ex}
```
**Systems insight**: Under these illustrative assumptions, FixMatch reduces total cost by `{python} FixmatchLabelEfficiency.cost_reduction_mult_str`.
