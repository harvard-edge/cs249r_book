...
fig, ax, COLORS, plt = book_style.setup_plot(figsize=(10, 4.85))
...
ROI = (`{python} BreakevenCalc.cost_random_total_str` − `{python} BreakevenCalc.cost_active_total_str`) / `{python} BreakevenCalc.cost_active_total_str` $\times$ 100 = `{python} BreakevenCalc.roi_pct_math`
