...
% Left
\node[Decision, below left= 16mm and 31mm of D1] (D2) {Labeling\\cost};
\node[Decision, below = 7mm of D2] (D3) {Oracle\\available?};
...
%right
\node[Decision, below right=16mm and 31mm  of D1] (D4) {Data\\scarcity};
\node[Decision, below = 7mm of D4] (D5) {Simulator\\available?};
...
%center
\node[Decision, below = 6mm of D1] (D6) {Compute\\cost};
\node[Decision, below = 7mm of D6] (D7) {Redundant\\data?};
