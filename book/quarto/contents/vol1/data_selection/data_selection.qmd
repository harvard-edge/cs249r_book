...
# │          .hdd_random_mb_s_str, .hdd_penalty_factor_mult_str,
# │          .sata_seq_mb_s_str, .sata_iops_str, .sata_random_mb_s_str,
# │          .sata_penalty_factor_mult_str, .nvme_seq_mb_s_str, .nvme_iops_str,
# │          .nvme_random_mb_s_str, .nvme_penalty_factor_mult_str
# └─────────────────────────────────────────────────────────────────────────────
...
|:-----------------|:-------------------------------------------------:|:---------------------------------------------:|:----------------------------------------------------:|:-----------------------------------------------------------:|
| **HDD (7.2k)**   |  ~`{python} RandomAccessPenalty.hdd_seq_mb_s_str` |  ~`{python} RandomAccessPenalty.hdd_iops_str` | ~`{python} RandomAccessPenalty.hdd_random_mb_s_str`  |  `{python} RandomAccessPenalty.hdd_penalty_factor_mult_str` |
| **SATA SSD**     | ~`{python} RandomAccessPenalty.sata_seq_mb_s_str` | ~`{python} RandomAccessPenalty.sata_iops_str` | ~`{python} RandomAccessPenalty.sata_random_mb_s_str` | `{python} RandomAccessPenalty.sata_penalty_factor_mult_str` |
| **NVMe SSD**     | ~`{python} RandomAccessPenalty.nvme_seq_mb_s_str` | ~`{python} RandomAccessPenalty.nvme_iops_str` | ~`{python} RandomAccessPenalty.nvme_random_mb_s_str` | `{python} RandomAccessPenalty.nvme_penalty_factor_mult_str` |
