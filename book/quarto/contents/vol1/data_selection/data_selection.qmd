...
**The systems lesson**: Data leakage\index{Data Leakage!test set contamination} is the silent killer of generalization. A test set that is not rigorously deduplicated against the training set produces accuracy metrics that measure memorization, not intelligence [@recht2019imagenet].
