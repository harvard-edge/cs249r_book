...
3.  **Subset Training**: `{python} n_epochs_full_str` epochs on `{python} subset_fraction_pct_str`% data = `{python} n_epochs_full_str` $\times$ `{python} subset_fraction` $\times$ C_epoch = `{python} n_epochs_subset_str` $\times$ C_epoch.
