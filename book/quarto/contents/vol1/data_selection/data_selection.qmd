...
::: {.column-margin}
![](images/svg/vol1_data_selection_margin_001.svg){width="100%" fig-alt="Margin illustration showing Clean sample requirement versus noisy sample requirement."}

*Shows why clean labels can be worth many noisy labels.*
:::
...
::: {.column-margin}
![](images/svg/vol1_data_selection_margin_002.svg){width="100%" fig-alt="Margin illustration showing One pretraining corpus defect fanning into downstream tasks."}

*Shows one pretraining corpus defect propagating into many downstream tasks.*
:::
...
::: {.column-margin}
![](images/svg/vol1_data_selection_margin_003.svg){width="100%" fig-alt="Margin illustration showing Echo factor threshold at e=R with over-echo region."}

*Shows data echoing as useful only until the pipeline ratio threshold is reached.*
:::
...
::: {.column-margin}
![](images/svg/vol1_data_selection_margin_004.svg){width="100%" fig-alt="Margin illustration showing Recursive synthetic training accuracy drops across generations."}

*Shows recursive synthetic-data training degrading across generations.*
:::
