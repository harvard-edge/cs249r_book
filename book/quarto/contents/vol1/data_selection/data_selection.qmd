...
class IcrCoresetComparison:
    ...
    acc_perf_pct_str = fmt_percent(acc_gain_coreset_value / acc_gain_random_value, precision=0, commas=False, style='prose')
```
...
class ActiveLearningRoi:
    ...
    n_random_pct_str = fmt_percent(n_random_pct_value/100, precision=0, commas=False, style='prose')
...
# │          .seed_cost_pct_str
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, MarkdownStr, fmt_percent
...
class SelectionInequalityCalc:
    ...
    savings_a_pct_str = fmt_percent(savings_a_pct_value/100, precision=0, commas=False, style='symbol')
    savings_b_str = fmt_int(round(savings_b_hrs_value), commas=False, suffix=" h")
    savings_b_pct_str = fmt_percent(savings_b_pct_value/100, precision=1, commas=False, style='symbol')
    ...
    trap_pct_str = fmt_percent(trap_overhead_pct_value/100, precision=0, commas=False, style='symbol')
...
class DataEchoingRoi:
    ...
    idle_pct_str = fmt_percent(gpu_idle_pct_value/100, precision=1, commas=False, style='prose')
...
class CostBreakdown:
    ...
    p_data_str = fmt_percent(p_data_value/100, precision=1, commas=False, style='symbol')
    p_compute_str = fmt_percent(p_compute_value/100, precision=1, commas=False, style='symbol')
...
class DeduplicationAmortization:
    ...
    roi_10_str = fmt_percent(rois[2]/100, precision=1, commas=False, style='symbol')
...
class FpFallacyCalc:
    ...
    curated_accuracy_str = fmt_percent(curated_accuracy_value/100, precision=0, commas=False, style='prose')
    raw_accuracy_str = fmt_percent(raw_accuracy_value/100, precision=0, commas=False, style='prose')
    curated_cost_ratio_str = fmt(curated_cost_ratio_value, precision=0, commas=False)
    synthetic_gen1_acc_str = fmt_percent(synthetic_gen1_acc_value/100, precision=0, commas=False, style='prose')
    synthetic_gen5_acc_str = fmt_percent(synthetic_gen5_acc_value/100, precision=0, commas=False, style='prose')
    ...
    cifar10_acc_retained_str = fmt_percent(cifar10_acc_retained_value/100, precision=0, commas=False, style='prose')
    imagenet_acc_retained_str = fmt_percent(imagenet_acc_retained_value/100, precision=0, commas=False, style='prose')
    medical_acc_retained_str = fmt_percent(medical_acc_retained_value/100, precision=0, commas=False, style='prose')
```
...
class FpPitfallCalc:
    ...
    selection_overhead_good_pct_str = fmt_percent(selection_overhead_good_pct_value/100, precision=1, commas=False, style='prose')
    ...
    rare_class_acc_str = fmt_percent(rare_class_acc_value/100, precision=0, commas=False, style='prose')
    majority_class_acc_str = fmt_percent(majority_class_acc_value/100, precision=0, commas=False, style='prose')
```
