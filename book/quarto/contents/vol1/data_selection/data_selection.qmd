...
Collective communication, fault tolerance, and elastic scheduling determine whether distributed selection remains faithful to the global dataset or collapses into local shard heuristics. The selection problem therefore has to be evaluated at the boundary where statistical value meets sharding and locality.
