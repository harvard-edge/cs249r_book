...
* **The selection inequality gates every technique**: $T_{\text{selection}} + T_{\text{train}}(\text{subset}) < T_{\text{train}}(\text{full})$. Selection overhead should stay below ten percent of training time. Proxy models and cached embeddings keep $T_{\text{selection}}$ low; expensive selection algorithms can consume all the savings they promise.
