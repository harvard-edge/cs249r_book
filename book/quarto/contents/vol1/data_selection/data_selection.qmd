...
# │
# │ Imports: mlsysim.book (fmt)
# │ Exports: formatted cost, storage, training, and ratio values for the table below.
# └─────────────────────────────────────────────────────────────────────────────
...
| **Storage (`{python} CostBreakdown.storage_size_str` $\times$ `{python} CostBreakdown.storage_duration_str`)**                                                           | Cloud storage    |                         `{python} CostBreakdown.c_store_usd_str`                         |
| **Training (`{python} CostBreakdown.train_epoch_count_str` $\times$ `{python} CostBreakdown.train_gpu_count_str` $\times$ `{python} CostBreakdown.train_duration_str`)** | GPU compute      |                         `{python} CostBreakdown.c_train_usd_str`                         |
