...
The stacked bars in @fig-selection-inequality demonstrate this trade-off: efficient selection (center) saves `{python} savings_b_pct_str`% of total compute, while expensive selection (right) consumes all the savings in overhead.
