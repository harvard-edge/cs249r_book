...
**Data Selection** refers to the ratio of *model capability gained* to *data resources consumed*, encompassing acquisition, labeling, storage, and compute costs. A data-efficient system maximizes learning per sample, per byte stored, per label acquired, and per FLOP expended on data processing. Formally:
