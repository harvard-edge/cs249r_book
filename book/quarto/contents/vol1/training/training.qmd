...
[^fn-nccl]: **NVIDIA NCCL (Collective Communications Library)**: Optimized for multi-GPU communication, NCCL can approach a large fraction of theoretical interconnect bandwidth on well-tuned systems. It implements optimized AllReduce algorithms and other collectives that reduce synchronization overhead in distributed training.
