...
Micro-frameworks like **TensorFlow Lite Micro (TFLM)**\index{TensorFlow Lite Micro!extreme AOT} and **PyTorch ExecuTorch**\index{PyTorch ExecuTorch!microcontroller deployment} solve this through **Extreme AOT Compilation**:
