...
*   **Conclusion**: The system spends `{python} DispatchTaxSmallLarge.dispatch_overhead_pct_str`% of time waiting for Python. Compilation yields **`{python} DispatchTaxSmallLarge.dispatch_compilation_speedup_str`$\times$ speedup**.
