...
| `reduce-overhead` | Moderate                              | CUDA graphs replay captured command sequences, cutting launch overhead; 20--40% throughput gain over default | Inference serving with fixed input shapes                                  |
| `max-autotune`    | Minutes to hours for large models     | Benchmarks implementation variants per operation; 10--30% gain over default                                  | Production training that runs for days                                     |
