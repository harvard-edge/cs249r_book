...
class Model7BMemory:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    model_7b_fp16_gib_str = fmt_memory(fp16, binary=True, precision=1, commas=False)                 # e.g. "13.0 GiB"
    a100_remaining_7b_gib_str = fmt_memory(remaining, binary=True, precision=1, commas=False)         # e.g. "67.0 GiB"
