...
**Systems lesson**: Framework abstractions are valuable because they carry contracts: shape, dtype, device placement, and units. If those contracts are implicit, two pieces of correct code can still compose into a wrong system.
