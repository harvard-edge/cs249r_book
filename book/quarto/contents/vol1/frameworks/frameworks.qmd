...
::: {.column-margin}
![](images/svg/vol1_frameworks_margin_003.svg){width="100%" fig-alt="Margin illustration showing DataLoader knobs mapped to CPU parallelism, prefetch depth, and DMA."}
...
::: {.column-margin}
![](images/svg/vol1_frameworks_margin_004.svg){width="100%" fig-alt="Margin illustration showing TensorFlow, PyTorch, and JAX mapped to their strongest design emphasis."}
