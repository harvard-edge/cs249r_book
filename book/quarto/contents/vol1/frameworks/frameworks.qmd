...
\noindent
![](images/png/cover_frameworks_blueprint_print.png){fig-alt="Layered blueprint showing high-level model intent lowering through graph capture, autograd, fusion, and kernel dispatch into executable work."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_frameworks_blueprint.webp){fig-alt="Layered blueprint showing high-level model intent lowering through graph capture, autograd, fusion, and kernel dispatch into executable work."}
:::
