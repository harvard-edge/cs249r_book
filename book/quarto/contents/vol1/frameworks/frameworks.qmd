...
gpt3_params_b_value = GPT3_PARAMS.to(Bparam).magnitude
...
resnet_training_min_gb_value = 10
resnet_training_max_gb_value = 15
resnet_training_ratio_min_value = (
    resnet_training_min_gb_value * 1024 / resnet_fp32_mb_value
)
...
img_res = 224
img_channels = 3
dataloader_mbs_value = (img_per_sec * img_res * img_res * img_channels * byte).to(MB).magnitude
# Batch of 64 images at 224x224x3 in FP32
batch_size = 64
batch_bytes = batch_size * img_res * img_res * img_channels * BYTES_FP32.magnitude
batch_mb_value = (batch_bytes * byte).to(MB).magnitude
...
resnet_training_min_gb_str = fmt(resnet_training_min_gb_value, precision=0, commas=False)
resnet_training_max_gb_str = fmt(resnet_training_max_gb_value, precision=0, commas=False)
resnet_training_ratio_str = fmt(resnet_training_ratio_min_value, precision=0, commas=False)
...
pcie4_1gb_equiv_ops_str = fmt((pcie4_1gb_equiv_ops_value * flop).to(TFLOPs).magnitude, precision=1, commas=False)
