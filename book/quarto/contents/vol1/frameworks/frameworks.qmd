...
The cost of device transfers varies dramatically with interconnect technology. @tbl-device-transfer-overhead quantifies this for a 1000x1000 float32 tensor (4 MB), revealing why the memory wall discussed earlier in this chapter makes device placement a primary optimization concern:
