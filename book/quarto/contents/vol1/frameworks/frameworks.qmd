...
Nsight Compute provides kernel-level analysis with hardware counters, as @lst-nsight-compute demonstrates.
...
:::{.callout-tip title="Framework Selection Constraints"}
