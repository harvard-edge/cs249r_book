...
::: {.column-margin}
![](images/svg/vol1_frameworks_margin_001.svg){width="100%" fig-alt="Margin illustration showing ResNet-50 inference footprint versus training footprint."}
...
::: {.column-margin}
![](images/svg/vol1_frameworks_margin_002.svg){width="100%" fig-alt="Margin illustration showing Serial copy-plus-compute versus overlapped max(copy, compute)."}
