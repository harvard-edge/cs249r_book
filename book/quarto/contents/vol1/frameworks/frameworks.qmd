...
PyTorch optimizers expose their internal state through a standardized interface:
...
Resuming training requires loading both model parameters and optimizer state:
