...
class MemoryWallSpecs:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    a100_tflops_fp16_str = fmt_qty(flops_fp16_q, TFLOP/second, precision=0, commas=False)
    a100_bw_tbs_str = fmt_qty(bw_q, TB/second, precision=2, commas=False)
...
class A100BLASMemoryWallRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    dense_tflops_str = fmt_qty(dense_flops_q, TFLOP/second, precision=0, commas=False)
```
...
class CompilationBenchmark:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────
    resnet_eager_str = fmt_rate(resnet["eager"], 'img/s', precision=0, commas=True)
    resnet_compile_str = fmt_rate(resnet["compile"], 'img/s', precision=0, commas=True)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int,  fmt, check, fmt_math, fmt_percent, fmt_time
...
*   **Software overhead**: $T_{\text{sw}} \approx$ `{python} DispatchTaxSmallLarge.dispatch_n_ops_str` ops $\times$ `{python} DispatchTaxSmallLarge.dispatch_us_per_op_str` = `{python} DispatchTaxSmallLarge.dispatch_sw_time_us_str`.
...
# │          hbm_4mb_ms_str, pcie4_1gb_ms_str, pcie4_1gb_equiv_ops_str, a100_mem_gib_str,
...
class DeviceBandwidthHierarchy:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    pcie4_gbs_str = fmt_qty(pcie4, GB/second, precision=0, commas=False)
    pcie4_bidir_gbs_str = fmt_qty(pcie4 * 2, GB/second, precision=0, commas=False)
    nvlink_a100_gbs_str = fmt_qty(nvlink_a100, GB/second, precision=0, commas=False)
    nvlink_a100_per_direction_gbs_str = fmt_qty(nvlink_a100_per_direction, GB/second, precision=0, commas=False)
    a100_bw_gbs_str = fmt_qty(a100_bw, GB/second, precision=0, commas=False)
    a100_bw_tbs_str = fmt_qty(a100_bw, TB/second, precision=2, commas=False)
    a100_tflops_fp16_str = fmt_qty(a100_flops_fp16, TFLOP/second, precision=0, commas=False)
    ...
    pcie4_1gb_equiv_ops_str = fmt_qty(pcie4_1gb_equiv_ops, TFLOP, precision=1, commas=False)
...
class DataloaderThroughput:
    ...
    dataloader_mbs_str = fmt_qty(dataloader, MB/second, precision=1, commas=False)
...
# │ Exports: train_mm1_flops_str, train_mm1_mem_mb_str, train_mm1_ai_str,
# │          train_relu_flops_str, train_relu_mem_kb_str, train_relu_ai_str,
# │          train_mm2_flops_str, train_mm2_mem_kb_str, train_mm2_ai_str, train_ce_flops_str,
# │          train_ce_mem_kb_str, train_ce_ai_str, train_bwd_flops_str,
...
class TrainingStepCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    train_mm1_flops_str = fmt_qty(mm1_flops, MFLOPs, precision=1, commas=False)
    ...
    train_relu_flops_str = fmt_qty(relu_flops, KFLOPs, precision=1, commas=False)
    ...
    train_mm2_flops_str = fmt_qty(mm2_flops, KFLOPs, precision=1, commas=False)
    ...
    train_ce_flops_str = fmt_qty(ce_flops, KFLOPs, precision=1, commas=False)
    ...
    train_bwd_flops_str = fmt_qty(bwd_flops, MFLOPs, precision=1, commas=False)
...
|:---------------------------------|:-----------------------------------------------------------------------------------------:|:-------------------------------------------------:|:---------------------------------------------:|
| **MatMul (x @ W1)**              | 2 $\times$ 32 $\times$ $784{\times}256$ = `{python} TrainingStepCalc.train_mm1_flops_str` |  `{python} TrainingStepCalc.train_mm1_mem_mb_str` |  `{python} TrainingStepCalc.train_mm1_ai_str` |
| **ReLU**                         |             $32{\times}256$ = `{python} TrainingStepCalc.train_relu_flops_str`            | `{python} TrainingStepCalc.train_relu_mem_kb_str` | `{python} TrainingStepCalc.train_relu_ai_str` |
| **MatMul (h @ W2)**              |  2 $\times$ 32 $\times$ $256{\times}10$ = `{python} TrainingStepCalc.train_mm2_flops_str` |  `{python} TrainingStepCalc.train_mm2_mem_kb_str` |  `{python} TrainingStepCalc.train_mm2_ai_str` |
| **Cross-entropy**                |                      ~`{python} TrainingStepCalc.train_ce_flops_str`                      |  `{python} TrainingStepCalc.train_ce_mem_kb_str`  |  `{python} TrainingStepCalc.train_ce_ai_str`  |
| **Backward (2$\times$ forward)** |                      ~`{python} TrainingStepCalc.train_bwd_flops_str`                     |  `{python} TrainingStepCalc.train_bwd_mem_mb_str` |  `{python} TrainingStepCalc.train_bwd_ai_str` |
...
# │ Exports: mnist_total_flops_str, mnist_mem_traffic_mb_str, a100_peak_tflops_str,
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, check, MarkdownStr, fmt_time, fmt_qty
...
class MnistTrainingStepCalc:
    ...
    mnist_total_flops_str = fmt_qty(total_flops, MFLOPs, precision=1, commas=False)
    ...
    a100_peak_tflops_str = fmt_qty(peak_flops, TFLOP/second, precision=0, commas=False)
    a100_mem_bw_tbs_str = fmt_qty(mem_bw, TB/second, precision=1, commas=False)
```

Total: ~`{python} MnistTrainingStepCalc.mnist_total_flops_str`, ~`{python} MnistTrainingStepCalc.mnist_mem_traffic_mb_str` memory traffic. On an A100:
...
- $T_{\text{memory}} \approx$ `{python} MnistTrainingStepCalc.mnist_mem_traffic_mb_str`/`{python} MnistTrainingStepCalc.a100_mem_bw_tbs_str` ≈ `{python} MnistTrainingStepCalc.mnist_t_memory_us_str`
