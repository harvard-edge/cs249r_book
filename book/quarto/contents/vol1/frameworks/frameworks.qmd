...
\noindent
![](images/png/cover_frameworks_blueprint.png){fig-alt="Layered blueprint showing high-level model intent lowering through graph capture, autograd, fusion, and kernel dispatch into executable work."}
