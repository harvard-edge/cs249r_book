...
*Useful device work (green) pulls away from the fixed dispatch cost (blue) as operations grow; the widening gap is the tax shrinking.*
:::
...
*Shows why training memory dwarfs inference memory.*
:::
...
*Shows overlapping copy and compute as max(copy, compute), not copy plus compute.*
:::
...
*Maps DataLoader knobs to the bottlenecks they relieve.*
:::
...
*Locate framework design philosophies by the system problem they optimize for.*
:::
