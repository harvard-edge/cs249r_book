...
* The memory wall (compute capacity growing orders of magnitude faster than memory bandwidth over the past two decades) drives framework optimization strategies like kernel fusion
