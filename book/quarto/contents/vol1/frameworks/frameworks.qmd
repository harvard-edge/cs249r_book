...
\node[Box={col5!50},below=\vi of B5](BB5){TensorFlow revolutionizes distributed ML};
...
ax.text(30, (y_eager + y_compiled) / 2, "Gap = The Python Tax", color=COLORS['RedLine'], ha='center', va='center', fontsize=8, fontweight='bold', bbox=dict(facecolor='white', alpha=0.8, edgecolor='none', pad=0.5))
plt.show()
plt.close()
```
...
![](images/jpeg/onnx_new.jpg){width=65%}
