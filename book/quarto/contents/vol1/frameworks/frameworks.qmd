...
As @fig-mlfm-timeline illustrates, frameworks bridge the gap between mathematical intent and silicon reality. Moving up the ladder increases *productivity* while reducing *transparency*, a trade-off explored in @sec-ml-frameworks-execution-problem-e1e1.
