...
Calling `loss.backward()`\index{Backward Pass!triggering gradient computation} triggers a three-stage backward pass:
...
The training step is overhead-bound.\index{Overhead-Bound!small model training} For small models, Python dispatch and kernel launch dominate, which drives three common production practices:
