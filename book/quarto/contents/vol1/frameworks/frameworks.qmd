...
# │          pageable_transfer_ms_str, pcie4_gb_per_s_str
# └─────────────────────────────────────────────────────────────────────────────
...
class DataloaderThroughput:
    ...
    pageable_transfer = 3 * millisecond
    ...
    check(2 <= (pageable_transfer / batch_transfer).to_base_units().magnitude <= 3, "Pageable transfer example should remain a 2--3x slowdown.")
    ...
    pageable_transfer_ms_str = fmt_time(pageable_transfer, millisecond, precision=0, commas=False)
    pcie4_gb_per_s_str = fmt_qty(pcie4, GB / second, precision=0, commas=False)
```
