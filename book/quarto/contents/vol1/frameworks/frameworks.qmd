...
Frameworks build on decades of foundational work in computational libraries, progressing through three distinct levels of abstraction: **Hardware Primitives** (BLAS/LAPACK), **Vectorized Productivity** (NumPy), and **Automatic Differentiation** (PyTorch/TensorFlow). @fig-mlfm-timeline traces this evolution, revealing a consistent pattern: each generation abstracts the complexity of its predecessor to enable higher developer velocity.
