...
class TrainingStepCalc:
    ...
    train_mm1_mem_str = fmt((mm1_mem_bytes * byte).m_as(MB), precision=1, commas=False, suffix=" MB")
    ...
    train_relu_mem_str = fmt((relu_mem_bytes * byte).m_as(KB), precision=1, commas=False, suffix=" KB")
    ...
    train_mm2_mem_str = fmt((mm2_mem_bytes * byte).m_as(KB), precision=1, commas=False, suffix=" KB")
    ...
    train_ce_mem_str = fmt((ce_mem_bytes * byte).m_as(KB), precision=1, commas=False, suffix=" KB")
    ...
    train_bwd_mem_str = fmt((bwd_mem_bytes * byte).m_as(MB), precision=1, commas=False, suffix=" MB")
