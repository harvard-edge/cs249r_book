...
- $T_{\text{compute}} \approx 40\text{M} / `{python} f"{a100_peak_tflops/1e12:.0f}"`\text{T} \approx `{python} mnist_t_compute_us`\mu\text{s}$
- $T_{\text{memory}} \approx 5\text{MB} / `{python} f"{a100_mem_bw_bytes/1e12:.0f}"`\text{TB/s} \approx `{python} mnist_t_memory_us`\mu\text{s}$
