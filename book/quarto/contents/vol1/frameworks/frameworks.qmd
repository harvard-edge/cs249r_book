...
class TrainingStepCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    train_mm1_flops_str = fmt((mm1_flops * flop).m_as(MFLOPs), precision=1, commas=False, suffix=" MFLOPs")
    ...
    train_relu_flops_str = fmt((relu_flops * flop).m_as(KFLOPs), precision=1, commas=False, suffix=" KFLOPs")
    ...
    train_mm2_flops_str = fmt((mm2_flops * flop).m_as(KFLOPs), precision=1, commas=False, suffix=" KFLOPs")
    ...
    train_ce_flops_str = fmt((ce_flops * flop).m_as(KFLOPs), precision=1, commas=False, suffix=" KFLOPs")
    ...
    train_bwd_flops_str = fmt((bwd_flops * flop).m_as(MFLOPs), precision=1, commas=False, suffix=" MFLOPs")
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, check, MarkdownStr, fmt_time
