...
TTFT and TPOT capture distinct user experience aspects, so interactive LLM services usually need separate SLOs for responsiveness, generation fluidity, and fleet throughput. The values below are illustrative targets rather than universal requirements:
