...
::: {.column-margin}
![](images/svg/vol1_model_serving_margin_001.svg){width="100%" fig-alt="Margin illustration showing 50 ms SLO threshold with model-load latency far beyond it."}

*Shows model loading as far outside a tight serving SLO.*
:::
...
::: {.column-margin}
![](images/svg/vol1_model_serving_margin_002.svg){width="100%" fig-alt="Margin illustration showing Contiguous KV allocation waste versus paged allocation waste."}

*Shows PagedAttention recovering KV-cache waste from contiguous allocation.*
:::
...
::: {.column-margin}
![](images/svg/vol1_model_serving_margin_003.svg){width="100%" fig-alt="Margin illustration showing Batching window decreases while achieved batch size increases with QPS."}

*Shows the dynamic batching trade-off as QPS changes.*
:::
...
::: {.column-margin}
![](images/svg/vol1_model_serving_margin_004.svg){width="100%" fig-alt="Margin illustration showing TTFT point on compute plateau and TPOT point on memory slope."}

*Shows TTFT and TPOT living in different bottleneck regimes.*
:::
