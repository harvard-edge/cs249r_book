...
from mlsysim.fmt import MarkdownStr, check, fmt, fmt_time, fmt_qty, fmt_rate
...
class ResNetServingSpectrum:
    ...
    cloud_throughput_str = fmt_rate(cloud_throughput, 'img/s', precision=0)
    ...
    mobile_throughput_str = fmt_rate(mobile_throughput, 'img/s', precision=0, commas=False)
...
# └─────────────────────────────────────────────────────────────────────────────
import math
from mlsysim.fmt import fmt_int, fmt, fmt_math, check, fmt_percent, fmt_time, fmt_rate
...
class CapacityPlanningCalc:
    ...
    cp_v100_throughput_str = fmt_rate(cp_v100_throughput_value, 'img/s', precision=0)
...
class BatchingAnalysisCalc:
    ...
    b1_throughput_str = fmt_rate(round(throughputs_value[1]), 'img/s', precision=0, commas=False)
    b32_throughput_str = fmt_rate(round(throughputs_value[32]), 'img/s', precision=0, commas=False)
    ...
    tp_b4_str = fmt_rate(round(throughputs_value[4]), 'img/s', precision=0, commas=False)
    tp_b8_str = fmt_rate(round(throughputs_value[8]), 'img/s', precision=0, commas=False)
    tp_b16_str = fmt_rate(round(throughputs_value[16]), 'img/s', precision=0, commas=False)
...
class BatchingOptimization:
    ...
    s1_throughput_str = fmt_rate(round(s1_tput), 'img/s', precision=0)
    ...
    s2_throughput_str = fmt_rate(round(s2_tput), 'img/s', precision=0)
...
class PracticalConfigCalc:
    ...
    pc_qps_str = fmt_rate(pc_qps_value, 'img/s', precision=0, commas=False)
    ...
    pc_predicted_throughput_str = fmt_rate(pc_predicted_throughput_value, 'img/s', precision=1)
```
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt, fmt_qty, check, fmt_percent, fmt_rate
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt_usd, check, fmt, fmt_qty, fmt_time, fmt_rate
