...
: **Practical Batching Configuration**: Working backward from a 50 ms SLO and 500 QPS traffic estimate yields a 12 ms batching window and batch-32 cap. The predicted p99 latency remains within the SLO, while the batch cap leaves headroom for bursts. {#tbl-practical-batching-config tbl-colwidths="[30,27,43]"}
