...
class LlmCaseStudyHwSpecs:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    a100_mem_str = fmt_qty(h_a100.memory.capacity, GiB, precision=0, commas=False, unit_label="GB")
    a100_bw_tbs_str = fmt(a100_bw_tbs_value, precision=2, commas=False, suffix=" TB/s")
    h100_mem_str = fmt_qty(h_h100.memory.capacity, GiB, precision=0, commas=False, unit_label="GB")
