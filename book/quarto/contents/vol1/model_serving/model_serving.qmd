...
**Metric**: As LLMs scale, joules per token becomes a first-class operational metric alongside latency. For an H100 GPU (`{python} CarbonCostH100Tdp.h100_tdp_str` W TDP), we can quantify the energy footprint of serving:
