...
from mlsysim.fmt import MarkdownStr, check, fmt, fmt_time, fmt_qty
...
class ResNetServingSpectrum:
    ...
    tiny_sram_kb_str = fmt_qty(s_tiny.ram, KB, precision=1, commas=True)
...
class CarbonCostCalc:
    ...
    cc_response_joules_str = fmt_qty(cc_response_joules, joule, precision=1, commas=False)
    ...
    cc_low_util_joules_str = fmt_qty(cc_low_util_joules, joule, precision=1, commas=False, per='token')
```
