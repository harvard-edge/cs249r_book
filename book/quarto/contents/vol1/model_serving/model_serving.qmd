...
- **Pickle path**: Loading through PyTorch's pickle-based `torch.load` takes `{python} SafetensorsLoadingSpeed.pickle_load_s_str` in this scenario because Python has to reconstruct objects before tensors are usable.
