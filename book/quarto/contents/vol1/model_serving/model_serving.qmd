...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, fmt_usd, fmt_time
...
class SerializationEfficiency:
    ...
    json_parse_str = fmt_time(round(json_parse_us), 'microsecond', precision=0, commas=False)
    protobuf_size_str = MarkdownStr("4 KB")
    protobuf_parse_str = fmt_time(round(proto_parse_us), 'microsecond', precision=0, commas=False)
...
class LatencyTableCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    l_jpeg_str = fmt_time(l_jpeg_value, 'millisecond', precision=0, commas=False)
    l_resize_str = fmt_time(l_resize_value, 'millisecond', precision=0, commas=False)
    l_norm_str = fmt_time(l_norm_value, 'millisecond', precision=1, commas=False)
    l_transfer_str = fmt_time(l_transfer_value, 'millisecond', precision=1, commas=False)
    l_inf_str = fmt_time(l_inf_value, 'millisecond', precision=0, commas=False)
    l_post_str = fmt_time(l_post_value, 'millisecond', precision=1, commas=False)
    l_total_str = fmt_time(l_total_value, 'millisecond', precision=1, commas=False)
...
class LatencyBudgetCalc:
    ...
    total_latency_str = fmt_time(total_latency_ms_value, 'millisecond', precision=1, commas=False)
...
class DlrmLatencyCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    dlrm_input_str = fmt_time(dlrm_input_ms_value, 'millisecond', precision=1, commas=False)
    dlrm_embed_str = fmt_time(dlrm_embed_ms_value, 'millisecond', precision=0, commas=False)
    dlrm_mlp_str = fmt_time(dlrm_mlp_ms_value, 'millisecond', precision=1, commas=False)
    dlrm_post_str = fmt_time(dlrm_post_ms_value, 'millisecond', precision=0, commas=False)
    dlrm_total_str = fmt_time(dlrm_total_ms_value, 'millisecond', precision=0, commas=False)
...
class AmdahlServingCalc:
    ...
    optimized_total_str = fmt_time(optimized_total_ms_value, 'millisecond', precision=1, commas=False)
...
class CapacityPlanningAnchor:
    ...
    slo_str = fmt_time(slo_ms, 'millisecond', precision=0, commas=False)
...
class CapacityPlanning:
    ...
    littles_w_str = fmt_time(latency_slo_s, 'second', precision=2, commas=False)
...
# └─────────────────────────────────────────────────────────────────────────────
import math
from mlsysim.fmt import fmt_int, fmt, fmt_math, check, fmt_percent, fmt_time
...
from mlsysim.fmt import MarkdownStr, fmt_time
class ColdStartCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    cs_local_str = fmt_time(cs_local_total_value, 'second', precision=1, commas=False, approx=True)
    cs_cloud_str = fmt_time(cs_cloud_total_value, 'second', precision=0, commas=False, approx=True)
    cs_ssd_str = fmt_time(cs_ssd_value, 'second', precision=1, commas=False)
    ...
    cs_warmup_str = fmt_time(cs_warmup_value, 'second', precision=1, commas=False)
    cs_runtime_overhead_str = fmt_time(cs_runtime_overhead_value, 'second', precision=1, commas=False)
```
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_math, fmt_time
...
class ModelSwapCalc:
    ...
    model_swap_ms_str = fmt_time(model_swap_ms_value, 'millisecond', precision=1, commas=False)
...
class BatchThroughputCalc:
    ...
    batch32_inference_ms_str = fmt_time(batch32_inference_ms_value, 'millisecond', precision=0, commas=False)
    batch32_total_str = fmt_time(batch32_total_ms_value, 'millisecond', precision=0, commas=False)
    batch1_inference_total_ms_str = fmt_time(batch1_inference_total_ms_value, 'millisecond', precision=0, commas=False)
```
...
class BatchingBudgetCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    avg_wait_str = fmt_time(avg_wait_ms_value, 'millisecond', precision=0, commas=False)
    max_wait_str = fmt_time(max_wait_ms_value, 'millisecond', precision=0, commas=False)
...
class BatchingAnalysisCalc:
    ...
    b1_latency_str = fmt_time(latencies_value[1], 'millisecond', precision=1, commas=False)
    b32_latency_str = fmt_time(latencies_value[32], 'millisecond', precision=1, commas=False)
    il_overhead_str = fmt_time(il_overhead_ms_value, 'millisecond', precision=0, commas=False)
    il_compute_b1_str = fmt_time(il_compute_b1_ms_value, 'millisecond', precision=1, commas=False)
    il_compute_b32_str = fmt_time(il_compute_b32_ms_value, 'millisecond', precision=1, commas=False)
    ...
    T_window_str = fmt_time(T_window_value, 'millisecond', precision=0, commas=False)

    # Per-batch exports for @tbl-batching-throughput
    st_b1_str = fmt_time(service_times_value[1], 'millisecond', precision=1, commas=False)
    st_b4_str = fmt_time(service_times_value[4], 'millisecond', precision=1, commas=False)
    st_b8_str = fmt_time(service_times_value[8], 'millisecond', precision=1, commas=False)
    st_b16_str = fmt_time(service_times_value[16], 'millisecond', precision=1, commas=False)
    st_b32_str = fmt_time(service_times_value[32], 'millisecond', precision=1, commas=False)
    tl_b4_str = fmt_time(latencies_value[4], 'millisecond', precision=1, commas=False)
    tl_b8_str = fmt_time(latencies_value[8], 'millisecond', precision=1, commas=False)
    tl_b16_str = fmt_time(latencies_value[16], 'millisecond', precision=1, commas=False)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int,  MarkdownStr, check, fmt, fmt_percent, fmt_time
...
class SloViolationCalc:
    ...
    T_slo_str = fmt_time(T_slo_value, 'millisecond', precision=0, commas=False)
    mean_wait_str = fmt_time(mean_wait_value, 'millisecond', precision=0, commas=False)
    mean_batch_str = fmt(mean_batch_value, precision=0, commas=False)
    mean_service_str = fmt_time(mean_service_value, 'millisecond', precision=0, commas=False)
    mean_latency_str = fmt_time(mean_latency_value, 'millisecond', precision=0, commas=False)
    p99_service_str = fmt_time(p99_service_value, 'millisecond', precision=1, commas=False)
    p99_latency_str = fmt_time(p99_latency_value, 'millisecond', precision=1, commas=False)
...
class LlmCaseStudyHwSpecs:
    ...
    a100_token_ms_str = fmt_time(a100_token_ms_value, 'millisecond', precision=1, commas=False)
```
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt_usd, check, fmt, fmt_qty, fmt_time
...
class LlmServingCalc:
    ...
    token_time_theoretical_ms_str = fmt_time(token_time_theoretical_ms_value, 'millisecond', precision=1, commas=False)
...
class FallacyColdstartCalc:
    ...
    cs_compile_time_str = fmt_time(cs_compile_time_s_value, 'second', precision=0, commas=False)
    cs_aggregate_cold_str = fmt(cs_aggregate_cold_s_value, precision=0, commas=False, suffix=" instance-seconds")
    cs_parallel_warm_str = fmt_time(cs_parallel_warm_s_value, 'second', precision=0, commas=False)
    cs_steady_latency_str = fmt_time(cs_steady_latency_ms_value, 'millisecond', precision=0, commas=False)
    cs_cold_latency_str = fmt_time(cs_cold_latency_ms_value, 'millisecond', precision=0, commas=False)
