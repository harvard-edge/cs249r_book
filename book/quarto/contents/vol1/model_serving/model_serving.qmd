...
**Scenario**: An e-commerce recommendation serving system experiences a `{python} BlackFridayCalc.bf_spike_factor_mult_str` traffic surge (`{python} BlackFridayCalc.bf_qps_spike_str` QPS) during Black Friday sales events.
