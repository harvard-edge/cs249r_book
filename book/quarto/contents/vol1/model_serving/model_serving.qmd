...
Online serving systems may receive variable, unbatched request streams while still needing predictable response times across diverse physical environments. When a traffic spike exceeds a system's reserved headroom, performance degrades nonlinearly; the queueing curve in @fig-tail-latency-explosion makes that collapse visible.
