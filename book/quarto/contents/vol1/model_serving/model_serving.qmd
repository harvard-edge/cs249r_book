...
class ResolutionBottleneckCalc:
    ...
    ai_224_flops_per_byte_str = fmt_qty(ai_224_value, flop / byte, precision=0, commas=False, unit_label="FLOP/byte")
    ai_384_flops_per_byte_str = fmt_qty(ai_384_value, flop / byte, precision=0, commas=False, unit_label="FLOP/byte")
    ai_512_flops_per_byte_str = fmt_qty(ai_512_value, flop / byte, precision=0, commas=False, unit_label="FLOP/byte")
    ai_640_flops_per_byte_str = fmt_qty(ai_640_value, flop / byte, precision=0, commas=False, unit_label="FLOP/byte")

    ridge_point_flops_per_byte_str = fmt_qty(ridge_point_value, flop / byte, precision=0, commas=False, unit_label="FLOP/byte")
```
...
GPUs needed = `{python} CapacityPlanningCalc.cp_mu_required_req_s_str` / `{python} CapacityPlanningCalc.cp_v100_throughput_str` = `{python} CapacityPlanningCalc.cp_gpus_raw_str` → `{python} CapacityPlanningCalc.cp_gpus_ceil_str`$\times$
...
class LlmCaseStudyHwSpecs:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    a100_mem_gb_str = fmt_qty(h_a100.memory.capacity, GiB, precision=0, commas=False, unit_label="GB")
    a100_bw_tbs_str = fmt_bandwidth(a100_bw, unit=TB / second, precision=2, commas=False)
    h100_mem_gb_str = fmt_qty(h_h100.memory.capacity, GiB, precision=0, commas=False, unit_label="GB")
