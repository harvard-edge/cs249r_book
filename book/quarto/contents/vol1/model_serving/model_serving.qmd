...
*   **Ahead-of-Time (AOT)**\index{AOT Compilation!pre-deployment}: Compiles the graph before deployment (for example, `torch.export`, TensorRT `trtexec`).
