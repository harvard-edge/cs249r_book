...
class ColdStartCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    cs_local_str = fmt(cs_local_total_value, precision=1, commas=False, approx=True, suffix=" s")
    cs_cloud_str = fmt(cs_cloud_total_value, precision=0, commas=False, approx=True, suffix=" s")
