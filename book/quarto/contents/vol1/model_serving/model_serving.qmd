...
# │          bf_spike_factor_mult_str, bf_collapse_latency_s_str
# └─────────────────────────────────────────────────────────────────────────────
...
**The event**: On Black Friday, traffic spikes `{python} BlackFridayCalc.bf_spike_factor_mult_str` to `{python} BlackFridayCalc.bf_qps_spike_str`.

**Failure**: The system does not slow down `{python} BlackFridayCalc.bf_spike_factor_mult_str`. It *collapses*. Latency hits `{python} BlackFridayCalc.bf_collapse_latency_s_str`, then requests start timing out. The servers are `{python} BlackFridayCalc.bf_full_util_pct_str` loaded, but useful throughput drops to near zero because most completed requests have already timed out from the client's perspective.
...
# │          cost_increase_str, cost_ratio_mult_str
# └─────────────────────────────────────────────────────────────────────────────
...
# │          protobuf_parse_us_str, requests_per_sec_str, efficiency_gain_mult_str
# └─────────────────────────────────────────────────────────────────────────────
...
# │
# │ Imports: mlsysim.book (fmt)
# │ Exports: non_model_pct_str, optimized_total_ms_str, amdahl_speedup_mult_str
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_percent, fmt_time
...
# │ Exports: r1_str, r2_str, theoretical_slowdown_mult_str, measured_slowdown_mult_str
# └─────────────────────────────────────────────────────────────────────────────
...
# │
# │ Imports: mlsysim.book (fmt)
# │ Exports: adaptive_throughput_improvement_mult_str, adaptive_accuracy_retention_str
# └─────────────────────────────────────────────────────────────────────────────
...
# │ Exports: wait_time_b1_ms_str, wait_time_b32_ms_str, lat_b1_ms_str, lat_b32_ms_str, penalty_ratio_mult_str
# └─────────────────────────────────────────────────────────────────────────────
...
# │
# │ Imports: mlsysim.book (fmt)
# │ Exports: throughput_ratio_mult_str, batch_window_ms_str, batch32_inference_ms_str,
...
# │          p99_latency_ms_str, p99_ratio_mult_str, p99_batch_str
# └─────────────────────────────────────────────────────────────────────────────
...
# │          rt_pytorch_speedup_mult_str, rt_torchscript_speedup_mult_str,
# │          rt_onnx_speedup_mult_str, rt_trt_fp32_speedup_mult_str,
# │          rt_trt_fp16_speedup_mult_str, rt_trt_int8_speedup_mult_str
# └─────────────────────────────────────────────────────────────────────────────
...
# │          pt_int8_speedup_mult_str, pt_fp16_speedup_mult_str,
# │          pt_int8_vs_fp16_speedup_mult_str, pt_int8_acc_loss_str
# └─────────────────────────────────────────────────────────────────────────────
...
# │          fl_inference_gain_ms_str, fl_queuing_improvement_mult_str,
# │          fl_total_slow_ms_str, fl_total_fast_ms_str,
# │          fl_system_speedup_mult_str, fl_model_speedup_mult_str
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_percent, fmt_time
...
# │          fu_wait_high_factor_mult_str, fu_total_high_factor_mult_str,
# │          fu_cost_reduction_str, fu_latency_increase_mult_str,
