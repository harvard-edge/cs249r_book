...
class CostLatencyCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    gpu_cost_per_hour_str = fmt_usd(gpu_cost_per_hour_value, precision=0, commas=False)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt_usd, check, fmt, fmt_qty
...
For an H100 SXM5 instance at approximately `{python} LlmServingCalc.hourly_cost_str` per hour (specialized cloud providers; major hyperscaler on-demand rates were in the \$2--\$13 per hour range in 2026):
