...
::: {.column-margin}
![](images/png/model_serving_blast_radius.png){width="100%" fig-alt="Schematic of one red source node on the left fanning out through four arrows to four identical blue consumer nodes on the right, showing one-to-many propagation from a single source."}
