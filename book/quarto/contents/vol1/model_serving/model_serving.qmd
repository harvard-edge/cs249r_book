...
**The Physics**: This is Little's Law and queueing theory in action. As utilization approaches 100 percent, queue lengths grow exponentially, not linearly. The system spends more time managing the queue (context switching, thrashing) than doing useful work.
...
# ┌── 1. CANVAS ────────────────────────────────────────────────────────────────
# │ Visualize the ~10× per-18-month collapse in inference token cost that
import numpy as np
from mlsysim import viz
