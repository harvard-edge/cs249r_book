...
class ResNetServingSpectrum:
    ...
    mobile_energy_npu = 0.8 * mJ
    mobile_energy_cpu = 4.2 * mJ
    ...
    mobile_energy_npu_mj_str = fmt_qty(mobile_energy_npu, mJ, precision=1, commas=False)
    mobile_energy_cpu_mj_str = fmt_qty(mobile_energy_cpu, mJ, precision=1, commas=False)
    ...
    tiny_energy_mj_str = fmt_qty(tiny_energy, mJ, precision=0, commas=False)
```
...
class MobileServingCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    m_cam_ms_str = fmt_qty(m_cam_ms, ms, precision=0, commas=False)
    m_jpeg_ms_str = fmt_qty(m_jpeg_ms, ms, precision=0, commas=False)
    m_resize_ms_str = fmt_qty(m_resize_ms, ms, precision=0, commas=False)
    m_npu_ms_str = fmt_qty(m_npu_ms, ms, precision=0, commas=False)
    m_ui_ms_str = fmt_qty(m_ui_ms, ms, precision=0, commas=False)
    m_total_ms_str = fmt_qty(m_total_ms, ms, precision=0, commas=False)
    m_cam_mj_str = fmt_qty(m_cam_mj, mJ, precision=2, commas=False)
    m_jpeg_mj_str = fmt_qty(m_jpeg_mj, mJ, precision=1, commas=False)
    m_resize_mj_str = fmt_qty(m_resize_mj, mJ, precision=1, commas=False)
    m_npu_mj_str = fmt_qty(m_npu_mj, mJ, precision=1, commas=False)
    m_ui_mj_str = fmt_qty(m_ui_mj, mJ, precision=1, commas=False)
    m_total_mj_str = fmt_qty_int(m_total_mj, mJ, commas=False)
    battery_wh_str = fmt_qty(10 * Wh, Wh, precision=0, commas=False, unit_label="Wh")
