...
from mlsysim.fmt import fmt_int,  MarkdownStr, fmt, fmt_percent
...
class DlrmLatencyCalc:
    ...
    dlrm_mlp_pct_str = fmt_percent(round(dlrm_mlp_pct_value)/100, precision=0, commas=False, style='symbol')
```
...
class FallacyBatchingCalc:
    ...
    fb_throughput_gain_str = fmt_percent(round(fb_throughput_gain_pct_value)/100, precision=0, commas=False, style='symbol')
