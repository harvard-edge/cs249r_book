...
class ResNetServingSpectrum:
    ...
    cloud_model_mb_str = fmt_qty(cloud_size, MB, precision=1, commas=True)
    ...
    cloud_vram_gb_str = fmt_qty(cloud_vram, GB, precision=0, commas=False)

    mobile_model_mb_str = fmt_qty(mobile_size, MB, precision=1, commas=True)
    ...
    mobile_energy_npu_mj_str = fmt_qty(mobile_energy_npu, ureg.millijoule, precision=1, commas=False)
    mobile_energy_cpu_mj_str = fmt_qty(mobile_energy_cpu, ureg.millijoule, precision=1, commas=False)
    mobile_mem_mb_str = MarkdownStr("150 MB")

    tiny_model_mb_str = fmt_qty(tiny_original, MB, precision=1, commas=True)
    tiny_alt_mb_str = fmt_qty(tiny_alt, MB, precision=1, commas=True)
    ...
    tiny_energy_mj_str = fmt_qty(tiny_energy, ureg.millijoule, precision=0, commas=False)
```
...
class ResolutionBottleneckCalc:
    ...
    # ┌── 1. LOAD (Constants) ──────────────────────────────────────────────
    act_224 = 12.5 * MB                   # 224×224 activation size
    act_384 = 36.8 * MB                   # 384×384 activation size
    act_512 = 65.5 * MB                   # 512×512 activation size
    act_640 = 102.4 * MB                  # 640×640 activation size
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    act_224_mb_str = fmt_qty(act_224, MB, precision=1, commas=False)
    act_384_mb_str = fmt_qty(act_384, MB, precision=1, commas=False)
    act_512_mb_str = fmt_qty(act_512, MB, precision=1, commas=False)
    act_640_mb_str = fmt_qty(act_640, MB, precision=1, commas=False)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_math, fmt_qty, fmt_time
...
class ModelSwapCalc:
    ...
    pcie_bw_gbs_str = fmt_qty(pcie_bw, GB/second, precision=0, commas=False)
...
class MobileServingCalc:
    ...
    battery_wh_str = fmt_qty(10 * ureg.watt_hour, ureg.watt_hour, precision=0, commas=False, unit_label="Wh")
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_percent, fmt_qty, fmt_time
...
class PrecisionTradeoffCalc:
    ...
    pt_fp32_mem_mb_str = fmt_qty(pt_fp32_mem, MB, precision=0, commas=False)
    ...
    pt_fp16_mem_mb_str = fmt_qty(pt_fp16_mem, MB, precision=0, commas=False)
    ...
    pt_int8_mem_mb_str = fmt_qty(pt_int8_mem, MB, precision=0, commas=False)
...
from mlsysim.fmt import fmt, fmt_qty, fmt_time
...
class LlmCaseStudyHwSpecs:
    ...
    case_study_model_weight_gb_str = fmt_qty(case_study_model_weight, GB, precision=1, commas=False)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt_usd, check, fmt, fmt_count, fmt_qty, fmt_qty_int, fmt_time, fmt_rate
...
class LlmServingCalc:
    ...
    remaining_vram_gb_str = fmt_qty_int(remaining_vram, GB, commas=False)
```
