...
# │ Exports: ca_cpu_cost_str, ca_cpu_throughput_str, ca_cpu_cpm_usd_str,
# │          ca_t4_cost_str, ca_t4_throughput_str, ca_t4_cpm_usd_str,
# │          ca_v100_cost_str, ca_v100_throughput_str, ca_v100_cpm_usd_str,
...
|:--------------------------|:--------------------------------------------:|:--------------------------------------------------:|:-----------------------------------------------:|
| **c5.xlarge (CPU)**       | `{python} CostAnalysisCalc.ca_cpu_cost_str`  | `{python} CostAnalysisCalc.ca_cpu_throughput_str`  |  `{python} CostAnalysisCalc.ca_cpu_cpm_usd_str` |
| **g4dn.xlarge (T4 GPU)**  |  `{python} CostAnalysisCalc.ca_t4_cost_str`  |  `{python} CostAnalysisCalc.ca_t4_throughput_str`  |  `{python} CostAnalysisCalc.ca_t4_cpm_usd_str`  |
| **p3.2xlarge (V100 GPU)** | `{python} CostAnalysisCalc.ca_v100_cost_str` | `{python} CostAnalysisCalc.ca_v100_throughput_str` | `{python} CostAnalysisCalc.ca_v100_cpm_usd_str` |
