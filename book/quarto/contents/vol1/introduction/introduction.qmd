...
\node[Box2,draw=VioletLine](BB3)at($(B3.south west)+(-3mm,0)$){Operating System};
...
{\small\usefont{T1}{phv}{m}{n} 18 GPUs, Shared Memory}};
\node[BoxD1,above=20pt of F2]{Distributed Fleet Stack \\ 
{\small\usefont{T1}{phv}{m}{n} 1,000100,000+ GPUs}};
\end{tikzpicture}
...
\node[Box,node distance=36mm,right=of B2,fill=VioletL,draw=VioletLine](B3){Model \ Deployment};
