...
\textbf{OpenAI introduces GPT-3}, establishing foundation-model scale with 175 billion parameters.};
...
in digitized literature that mention artificial intelligence};
\end{axis}
\end{tikzpicture}
```
