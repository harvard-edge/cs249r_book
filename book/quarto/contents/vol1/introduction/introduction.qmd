...
class AmdahlsPitfall:
    ...
    t_inference_str = fmt_time(t_inference, "ms", precision=0, commas=False)
    t_inf_new_str = fmt_time(t_inf_new, "ms", precision=0, commas=False)
    t_pre_str = fmt_time(t_pre, "ms", precision=0, commas=False)
    t_post_str = fmt_time(t_post, "ms", precision=0, commas=False)
    total_ms_str = fmt_time(t_total, "ms", precision=0, commas=False)
    new_total_ms_str = fmt_time(t_total_new, "ms", precision=0, commas=False)
