...
**The Context**: Google engineers published a landmark paper [@keyf51475af] that changed how the industry views ML engineering.
...
3.  **Common Pitfall:** A frequent misconception is that an ML system is the model. Google's audit of production ML systems found that model code comprises approximately five percent of total lines; the other 95 percent is data pipelines, serving infrastructure, and monitoring [@keyf51475af].
