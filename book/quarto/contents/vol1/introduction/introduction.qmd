...
#| echo: false
#| label: gpt3-training
from calc.ch_introduction import calc_gpt3_training

_gpt3 = calc_gpt3_training()
num_gpus = _gpt3["num_gpus"]
num_gpus_str = _gpt3["num_gpus_str"]
efficiency_eta = _gpt3["efficiency_eta"]
target_eta = _gpt3["target_eta"]
efficiency_eta_pct_str = _gpt3["efficiency_eta_pct_str"]
target_eta_pct_str = _gpt3["target_eta_pct_str"]
ops_coeff = _gpt3["ops_coeff"]
ops_exp = _gpt3["ops_exp"]
peak_tflops = _gpt3["peak_tflops"]
days_initial = _gpt3["days_initial"]
days_optimized = _gpt3["days_optimized"]
days_saved = _gpt3["days_saved"]
```
