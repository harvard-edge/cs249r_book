...
::: {.callout-fallacy title="Better algorithms automatically produce better systems."}
:::
...
::: {.callout-pitfall title="Treating ML systems as traditional software that happens to include a model."}
:::
...
::: {.callout-fallacy title="High accuracy on benchmark[^fn-benchmark] datasets indicates production readiness."}
:::
...
::: {.callout-pitfall title="Optimizing individual components without considering system interactions."}
:::
...
::: {.callout-fallacy title="ML systems can be deployed once and left to run indefinitely."}
:::
...
::: {.callout-pitfall title="Assuming that ML expertise alone is sufficient for ML systems engineering."}
:::
