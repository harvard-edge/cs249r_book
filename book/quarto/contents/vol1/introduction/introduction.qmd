...
| **Modern Deep Learning (2020+)** | Large-scale transformers       | ImageNet top-5 accuracy       | 90%+ (ViT)                                                           | Hours on distributed systems                                                                                                                                                                                                                   |
| **Modern Deep Learning (2023)**  | Foundation models              | MMLU benchmark                | 86.4% (GPT-4)                                                        | Not disclosed; public-estimate regime of about `{python} GPT4ScaleEstimate.a100_gpu_days_million_str` (same scale as `{python} GPT4ScaleEstimate.a100_class_gpu_count_str` A100-class GPUs for `{python} GPT4ScaleEstimate.training_days_str`) |
