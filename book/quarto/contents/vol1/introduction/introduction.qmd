...
As you proceed through this text, distinguish between **Data-Centric Computing** (the systems paradigm defined here) and **Data-Centric AI** (the development methodology discussed in @sec-data-engineering-ml).
