...
class AIMomentStats:
    ...
    h_cpu = Hardware.Infrastructure.HighEnd_CPU

    # ┌── 2. CALCULATION (The Physics) ─────────────────────────────────────────
    searches_b = searches_per_day / BILLION
    gpu_tflops = h_h100.peak_flops.to(TFLOPs / second).magnitude
    cpu_tflops = h_cpu.peak_flops.to(TFLOPs / second).magnitude
