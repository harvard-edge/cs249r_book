...
# │
# │ Imports: mlsysim.core.units (Models.Language.GPT3.parameters, BYTES_FP16, Bparam, GB),
...
# │
# │ Imports: mlsysim.core.units (Models.Vision.AlexNet.parameters)
...
# │
# │ Imports: mlsysim.core.units (Models.Language.GPT3.parameters, Models.Language.GPT3.training_ops, Models.Language.GPT3.training_tokens)
...
# │
# │ Imports: mlsysim.fmt (fmt, fmt_count), mlsysim.core.units
...
# │
# │ Imports: mlsysim.core.units (Models.Language.GPT3.training_ops, Hardware.Cloud.A100.compute.peak_flops,
# │          TFLOPs, second, day),
...
# │          Hardware.Tech.Op.OpInt8.energy; mlsysim.core.units (byte, flop, count),
# │          mlsysim.fmt (fmt, check)
...
# │
# │ Imports: mlsysim.core.units (Datasets.ImageNet.training_examples)
...
# │
# │ Imports: mlsysim.core.units (Models.Language.GPT4.training_gpu_days, MILLION),
...
# │
# │ Imports: mlsysim (ReferenceStats.Workloads.WaymoDataPerHour{Low,High}), mlsysim.core.units
