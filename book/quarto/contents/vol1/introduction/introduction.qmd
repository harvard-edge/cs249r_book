...
**Scenario**: Traditional computer vision pipelines processed raw images through hand-crafted feature extractors (Scale-Invariant Feature Transform [SIFT], histogram of oriented gradients [HOG]) before passing representations to shallow classifiers (support vector machines [SVMs]).
