...
[^fn-radar-robustness]: **Radar (Radio Detection and Ranging)**: Radar is generally more robust than optical cameras in rain and fog, although adverse weather can still attenuate or clutter its signal. This complementary failure profile makes radar useful in sensor fusion. Automotive operation near 77 GHz supports fine range and velocity resolution; performance also depends on antenna design, signal processing, and conditions. \index{Radar!sensor robustness}
