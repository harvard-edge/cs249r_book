...
+:=====================+===================:+===============:+:=========================+:=======================+:======================+
| **ResNet-50**        | 25.6 M             | 102 MB         | High (compute-bound)     | Throughput             | Cloud / Edge          |
+----------------------+--------------------+----------------+--------------------------+------------------------+-----------------------+
| **GPT-2 XL**         | 1.5 Billion        | 6.0 GB         | Medium (memory-bound)    | Memory bandwidth       | Cloud                 |
+----------------------+--------------------+----------------+--------------------------+------------------------+-----------------------+
| **MobileNetV2**      | 3.5 M              | 14 MB          | Medium                   | Latency, power         | Mobile                |
+----------------------+--------------------+----------------+--------------------------+------------------------+-----------------------+
| **DLRM**             | 25 Billion         | 100 GB         | Very low (memory-bound)  | Memory capacity        | Cloud (distributed)   |
+----------------------+--------------------+----------------+--------------------------+------------------------+-----------------------+
| **Keyword Spotting** | 200 K              | 800 KB         | Low                      | Power, memory          | TinyML / MCU          |
+----------------------+--------------------+----------------+--------------------------+------------------------+-----------------------+
