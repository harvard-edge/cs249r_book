...
# │ Exports: GPT4ScaleEstimate.accelerator_count_str, training_days_str, accelerator_days_million_str
# └─────────────────────────────────────────────────────────────────────────────
...
| **Modern Deep Learning (2023)**  | Foundation models              | MMLU benchmark                | 86.4 percent (GPT-4)                                                 | Not disclosed; public-estimate regime of about `{python} GPT4ScaleEstimate.accelerator_days_million_str` (same scale as `{python} GPT4ScaleEstimate.accelerator_count_str` accelerators for `{python} GPT4ScaleEstimate.training_days_str`) |
