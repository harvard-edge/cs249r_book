...
gpt4_gpu_days = fmt(GPT4_TRAINING_GPU_DAYS, precision=0)
```
...
# Format for LaTeX: 3.14e+23 -> 3.14 \times 10^{23}
_coeff, _exp = ops_mag.split('e+')
ops_sci = f"{_coeff} \\times 10^{{{int(_exp)}}}"
...
The following plot (@fig-systems-gap) visualizes this **Systems Gap**: the divergence between what models demand and what hardware naturally provides.
