...
# │          DeploymentSystems.cloud_power_str, DeploymentSystems.edge_mem_gb_str,
# │          DeploymentSystems.edge_compute_tflops_str, DeploymentSystems.edge_power_str,
...
|:--------------|:-------------------|:----------------------------------------------:|:-----------------------------------------------------:|:----------------------------------------------:|
| **Cloud**     | H100 GPU           | `{python} DeploymentSystems.cloud_mem_gb_str`  | `{python} DeploymentSystems.cloud_compute_tflops_str` |  `{python} DeploymentSystems.cloud_power_str`  |
| **Edge**      | Jetson Robotics    |  `{python} DeploymentSystems.edge_mem_gb_str`  |  `{python} DeploymentSystems.edge_compute_tflops_str` |  `{python} DeploymentSystems.edge_power_str`   |
| **Mobile**    | Smartphone         | `{python} DeploymentSystems.mobile_mem_gb_str` |    `{python} DeploymentSystems.mobile_compute_str`    | `{python} DeploymentSystems.mobile_power_str`  |
