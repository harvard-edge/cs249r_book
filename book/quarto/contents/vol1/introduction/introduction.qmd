...
#| echo: false
#| label: intro-setup
from calc.ch_introduction import calc_intro_setup

_intro = calc_intro_setup()
google_search_b = _intro["google_search_b"]
gmail_emails_t = _intro["gmail_emails_t"]
gpt4_gpu_m = _intro["gpt4_gpu_m"]
gpt3_params_b = _intro["gpt3_params_b"]
gpt3_params_billion = _intro["gpt3_params_billion"]
gpt3_training_zflops_str = _intro["gpt3_training_zflops_str"]
gpt3_gpus = _intro["gpt3_gpus"]
...
from calc.formulas import calc_training_time_days, md_math
...
ops_coeff, ops_exp_str = ops_mag.split("e+")
ops_exp = int(ops_exp_str)
...
time_value_math = md_math(
    rf"\text{{Time}} \approx \frac{{{ops_coeff} \times 10^{{{ops_exp}}}}}{{{num_gpus} \times ({peak_tflops} \times 10^{{12}}) \times {efficiency_eta}}}"
)
time_days_math = md_math(rf"\text{{Time}} \approx {days_initial}\ \text{{days}}")
```
...
from calc.ch_introduction import calc_waymo_data_rates
...
from calc.ch_introduction import calc_amdahls_pitfall
