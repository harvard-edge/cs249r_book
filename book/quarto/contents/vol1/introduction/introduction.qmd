...
The equation is dimensionally consistent—each term resolves to seconds. (For a general treatment of dimensional analysis as an engineering verification technique, see @sec-system-foundations-dimensional-analysis.)
