...
::: {.column-margin}
![](images/svg/vol1_introduction_margin_001.svg){width="100%" fig-alt="Margin illustration showing Small ML-code box inside a much larger production-support frame."}

*Shows that production ML work is mostly the surrounding system, not the model code alone.*
:::
...
::: {.column-margin}
![](images/svg/vol1_introduction_margin_002.svg){width="100%" fig-alt="Margin illustration showing Log ladder contrasting total input space with test-set coverage."}

*Makes the verification gap between input space and test coverage physically visible.*
:::
...
::: {.column-margin}
![](images/svg/vol1_introduction_margin_003.svg){width="100%" fig-alt="Margin illustration showing Accuracy declines from initial to degraded accuracy as drift increases."}

*Shows silent degradation as accuracy decay under drift.*
:::
...
::: {.column-margin}
![](images/svg/vol1_introduction_margin_004.svg){width="100%" fig-alt="Margin illustration showing Before and after latency bars where inference shrinks but pre/post remain."}

*Shows why optimizing only inference leaves end-to-end latency mostly intact.*
:::
