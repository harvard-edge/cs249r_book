...
class ResNet50DamExample:
    ...
    a100_ridge_flops_per_byte_str = fmt_qty_int(a100_ridge, flop / byte, commas=False, unit_label="FLOP/byte")
    workload_ai_flops_per_byte_str = fmt_qty_int(workload_ai, flop / byte, commas=False, unit_label="FLOP/byte")
```
