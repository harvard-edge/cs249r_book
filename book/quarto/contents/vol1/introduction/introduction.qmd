...
class GPT4ScaleEstimate:
    ...
    check(0.8 <= estimate_ratio <= 1.1, "Illustrative reference-GPU x days estimate should be near the mlsysim GPU-day anchor. The two differ by ~10%, so the prose states the shape of the estimate rather than printing it as an exact product.")
