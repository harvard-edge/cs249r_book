...
time_value_math = md_math(
    rf"\approx \frac{{{GPT3Training.ops_coeff_str} \times 10^{{{GPT3Training.ops_exp_value}}}}}{{{GPT3Training.num_gpus} \times ({GPT3Training.peak_tflops_str} \times 10^{{12}}) \times {GPT3Training.eta_base}}}"
)
time_days_math = md_math(rf"\approx {GPT3Training.days_initial_str}\ \text{{days}}")
ops_math = md_math(rf"\approx {GPT3Training.ops_coeff_str} \times 10^{{{GPT3Training.ops_exp_value}}}")
```
