...
class ScenarioRegistry:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    frontier_mission = app_frontier.mission_goal
    frontier_limit   = app_frontier.critical_constraint

    drive_mission = app_drive.mission_goal
    drive_limit   = app_drive.critical_constraint

    doorbell_mission = app_doorbell.mission_goal
    doorbell_limit   = app_doorbell.critical_constraint
```
