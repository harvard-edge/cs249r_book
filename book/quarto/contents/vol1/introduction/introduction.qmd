...
class AIMomentStats:
    ...
    # ┌── 1. LOAD (Constants) ───────────────────────────────────────────────
    from mlsysim.fmt import fmt, fmt_qty, fmt_memory, check
    ...
    gpu_tflops = h100_flops.to(TFLOPs / second)
    cpu_tflops = cpu_flops.to(TFLOPs / second)
    gpu_cpu_ratio = (gpu_tflops / cpu_tflops).to("").magnitude
    ...
    h100_fp16_tflops_str = fmt_qty(gpu_tflops, TFLOPs / second, precision=0, commas=False)
    cpu_fp32_tflops_str = fmt_qty(cpu_tflops, TFLOPs / second, precision=0, commas=False)
```
...
class GPT3WeightFootprint:
    ...
    fp16_weights = params * bytes_per_param
