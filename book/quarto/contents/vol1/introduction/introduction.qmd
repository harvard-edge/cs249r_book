...
def calc_intro_setup():
    ...
    # PROCESS
    # =============================================================================
    google_search_b_str = fmt(GOOGLE_SEARCHES_PER_DAY / 1e9, precision=1)
    gmail_emails_t_str = fmt(GMAIL_EMAILS_PER_DAY * 365 / 1e12, precision=0)
    gpt4_gpu_m_str = fmt(GPT4_TRAINING_GPU_DAYS / 1e6, precision=1)
    ...
    gpt3_training_zflops_str = str(gpt3_training_zflops_value)

    gpt3_gpus_value = 1024
    gpt3_gpus_str = f"{gpt3_gpus_value:,}"
    ...
    # =============================================================================
    return {
        "google_search_b_str": google_search_b_str,
        "gmail_emails_t_str": gmail_emails_t_str,
        "gpt4_gpu_m_str": gpt4_gpu_m_str,
        "gpt3_params_b_str": gpt3_params_b_str,
        "gpt3_params_billion_str": gpt3_params_billion_str,
        "gpt3_training_zflops_str": gpt3_training_zflops_str,
        "gpt3_gpus_value": gpt3_gpus_value,
...
google_search_b_str = _intro["google_search_b_str"]
gmail_emails_t_str = _intro["gmail_emails_t_str"]
gpt4_gpu_m_str = _intro["gpt4_gpu_m_str"]
gpt3_params_b_str = _intro["gpt3_params_b_str"]
gpt3_params_billion_str = _intro["gpt3_params_billion_str"]
gpt3_training_zflops_str = _intro["gpt3_training_zflops_str"]
gpt3_gpus_value = _intro["gpt3_gpus_value"]
gpt3_gpus_str = _intro["gpt3_gpus_str"]
h100_fp16_tflops_str = _intro["h100_fp16_tflops_str"]
h100_fp8_tflops_str = _intro["h100_fp8_tflops_str"]
cpu_fp32_tflops_str = _intro["cpu_fp32_tflops_str"]
```
...
peak_tflops_str = f"{peak_tflops_value:.0f}"

# =============================================================================
# OUTPUT
# =============================================================================
num_gpus_str = f"{num_gpus_value}"
efficiency_eta_pct_str = f"{int(efficiency_eta_value * 100)}"
target_eta_pct_str = f"{int(target_eta_value * 100)}"
training_days_value = training_time_value.to(day).magnitude
optimized_days_value = optimized_time_value.to(day).magnitude
days_initial_str = f"{training_days_value:.0f}"
days_optimized_str = f"{optimized_days_value:.0f}"
days_saved_str = f"{training_days_value - optimized_days_value:.0f}"
...
def calc_waymo_data_rates():
    ...
    # =============================================================================
    return {
        "waymo_data_low_str": waymo_data_low_str,
        "waymo_data_high_str": waymo_data_high_str,
    }


_waymo = calc_waymo_data_rates()
waymo_data_low_str = _waymo["waymo_data_low_str"]
waymo_data_high_str = _waymo["waymo_data_high_str"]
```
...
def calc_amdahls_pitfall():
    ...
    # =============================================================================
    return {
        "t_inference_str": str(t_inference_value),
        "t_pre_str": str(t_pre_value),
        "t_post_str": str(t_post_value),
        "total_ms": f"{t_total_value}",
        "new_total_ms": f"{t_total_new_value:.0f}",
        "improv_pct": f"{improvement_pct_value:.0f}",
        "naive_p": f"{naive_pct_value:.0f}",
        "t_inf_new_str": f"{int(t_inf_new_value)}",
    }


_amdahl = calc_amdahls_pitfall()
t_inference_str = _amdahl["t_inference_str"]
t_pre_str = _amdahl["t_pre_str"]
t_post_str = _amdahl["t_post_str"]
total_ms = _amdahl["total_ms"]
new_total_ms = _amdahl["new_total_ms"]
improv_pct = _amdahl["improv_pct"]
naive_p = _amdahl["naive_p"]
t_inf_new_str = _amdahl["t_inf_new_str"]
```
