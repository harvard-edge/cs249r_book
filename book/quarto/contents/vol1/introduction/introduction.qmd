...
3.  **Common Pitfall:** A frequent misconception is that an ML system is the model. Google's 2015 audit of production ML systems found that model code comprises approximately 5 percent of total lines; the other 95 percent is data pipelines, serving infrastructure, and monitoring [@sculley2015hidden].
