...
**Transparency and Privacy** requirements constrain design. Many deep networks function as "black boxes." In domains like healthcare or finance, stakeholders require interpretability. Furthermore, systems must be resilient against inference attacks[^fn-inference] that attempt to extract sensitive training data from model predictions.
