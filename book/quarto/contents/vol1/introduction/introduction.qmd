...
**Systems insight**: While researchers optimize for *accuracy*, systems engineers optimize for *useful work per dollar*. Let $O_{\text{total}}$ denote the total operations performed across all sample presentations, and let hardware efficiency denote useful operations delivered per dollar. @Eq-cost-scaling provides a dimensionally consistent first-order cost model:
...
*   $\lambda$: Locally fitted sensitivity to the chosen distribution-shift measure
