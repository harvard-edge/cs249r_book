...
The additive form assumes sequential execution. When movement and computation overlap, @eq-intro-iron-law-pipelined gives their critical-path lower bound:
...
As George Box\index{Box, George!modeling aphorism} famously said, "All models are wrong, but some are useful" [@box1976science].[^fn-box-ironlaw]
