...
**Insight**: They demonstrated that in mature ML systems, the *ML Code* (the model itself) is only a tiny fraction $(\approx 5\%)$ of the total code base. The rest is *glue code*: data collection, verification, feature extraction, resource management, monitoring, and serving infrastructure.
