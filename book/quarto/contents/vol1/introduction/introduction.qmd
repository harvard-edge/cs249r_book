...
The shift from rule-based to data-driven systems constitutes a deep reconception of computing. Andrej Karpathy[^fn-karpathy-sw2] formalized this distinction as the shift from **Software 1.0**\index{Software 1.0} to **Software 2.0**\index{Software 2.0} [@karpathy2017software], a framing that captures *why* ML systems require entirely new engineering approaches. @Tbl-software-1-vs-2 maps the shift term by term, and the row that drives the rest of this chapter is the failure mode: Software 1.0 fails loudly with a crash, while Software 2.0 degrades silently through metric degradation, so the failure stays invisible until a monitoring system catches it.
...
That integrated discipline is AI Engineering.
