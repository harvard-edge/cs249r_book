...
***Machine Learning Systems***\index{Machine Learning Systems} are software architectures where **Behavior** is learned from data rather than specified by explicit code. They extend the traditional software stack (OS, Network, DB) with a **Data Stack** (Ingestion, Training, Serving).
...
::: {.callout-definition title="D·A·M Taxonomy"}
