...
::: {.column-margin}
![](images/png/introduction_energy_hierarchy.png){width="100%" fig-alt="Vertical ladder of three blue bars on a log scale, longest at top: DRAM 160 pJ towers far above FP16 1.1 pJ and INT8 0.2 pJ, showing data movement costs orders of magnitude more energy than arithmetic."}
:::
...
::: {.column-margin}
![](images/png/introduction_iron_law_bars.png){width="100%" fig-alt="Horizontal three-segment bar labeled D, C, L for the iron law's data, compute, and latency terms. The data segment is widest and shaded blue, dominating; the compute and latency segments are narrow and gray."}
:::
