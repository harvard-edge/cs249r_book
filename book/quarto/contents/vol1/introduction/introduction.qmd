...
::: {#fig-ai-timeline fig-env="figure" fig-pos="t!" fig-cap="**AI Development Timeline**: A chronological Google Books/Ngram-style proxy curve traces mentions of artificial intelligence in digitized books [@michel2011quantitative], with light-brown bands marking the two AI Winter periods (1974--1980, 1987--1993). Callout boxes highlight key milestones including Turing's 1950 paper [@turing1950], the Dartmouth conference [@mccarthy1955dartmouth], the Perceptron [@rosenblatt1958], ELIZA [@weizenbaum1966], Deep Blue [@campbell2002], and GPT-3 [@brown2020language]." fig-alt="Timeline from the 1950s to the 2020s with a red line showing AI publication frequency. Light-brown bands mark two AI winters. Callout boxes mark milestones including Turing's 1950 paper, Dartmouth conference, Perceptron, ELIZA, Deep Blue, and GPT-3."}
