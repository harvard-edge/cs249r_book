...
- **Algorithms**[^fn-algorithm]: Mathematical models and methods that learn patterns from data to make predictions or decisions
...
However, this interdependence creates new vulnerabilities. When any component degrades—data distributions shift, model assumptions break, or infrastructure fails—the entire system can fail in ways that traditional software never experiences. Understanding *how* these failures differ from conventional software bugs establishes why ML systems engineering has emerged as a distinct discipline.

## How ML Systems Differ from Traditional Software {#sec-introduction-ml-systems-differ-traditional-software-7ea8}

The AI Triad framework reveals what ML systems comprise: data that guides behavior, algorithms that extract patterns, and infrastructure that enables learning and inference[^fn-inference-etymology]. Understanding these components alone does not capture how ML systems engineering differs from traditional software engineering. The critical distinction lies in how these systems fail.
