...
The machine learning systems landscape spans roughly `{python} DeploymentSystems.compute_span_str` in computational power and `{python} DeploymentSystems.mem_span_str` in memory capacity. We categorize this continuum into four **System Archetypes**\index{System Archetype!deployment constraints} that define the constraints for every subsequent chapter:
