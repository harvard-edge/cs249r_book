...
This volume makes a stronger claim: ML systems engineering is a distinct engineering discipline because every design sits under constraints no software layer can repeal. The iron law decomposes inference into data movement, computation, and overhead. The degradation equation explains why deployed models drift as the live world separates from the training distribution. The memory wall explains why faster arithmetic cannot compensate when bytes cannot reach the processor quickly enough. Later chapters extend these constraints into data pipelines, neural computation, architectures, frameworks, training, optimization, serving, operations, and responsible engineering. The shared vocabulary is physical rather than intuitive.
