...
**The Failure**: The system does not just slow down 10x. It **collapses**. Latency hits 10 seconds, then requests start timing out. The servers are 100% utilized, but *useful* throughput drops to near zero—most completed requests have already timed out from the client's perspective.
