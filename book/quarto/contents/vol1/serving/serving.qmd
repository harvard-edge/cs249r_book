...
Moving preprocessing to GPU\index{GPU Preprocessing!NVIDIA DALI} can reduce total latency by 6x in some pipelines by eliminating CPU-GPU data transfers between stages [@nvidia_triton]. Effective optimization targets the largest time consumers first.
