...
**The Physics**: This is **Little's Law** and **Queueing Theory** in action (see @sec-algorithm-foundations for derivations). As utilization approaches 100%, queue lengths grow exponentially, not linearly. The system spends more time managing the queue (context switching, thrashing) than doing useful work.
