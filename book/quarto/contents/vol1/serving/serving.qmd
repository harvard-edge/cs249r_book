...
::: {.callout-notebook title="Benchmarks: JSON vs Protobuf Serialization"}
...
::: {.callout-notebook title="ResNet-50 Capacity Planning" collapse="true"}
...
::: {.callout-notebook title="ResNet-50 Batching Efficiency" collapse="true"}
...
::: {.callout-notebook title="The Little's Law of Queues"}
...
::: {.callout-notebook title="ResNet-50: Mobile Single-User Serving (Pixel 6 NPU)"}
...
3. **Memory Constraints**: Mobile devices share limited RAM between applications. A model consuming 500MB may be evicted during background operation, requiring reload (cold start) that adds 200-500ms latency. Memory-efficient quantization directly improves user experience through faster model restoration.
