...
class ResNetServingSpectrum:
    ...
    # TinyML (Cortex-M7)
    tiny_original_mb = 98 # ResNet-50
    tiny_limit_mb = 2.0   # Flash limit for many MCUs
    tiny_alt_mb = 1.4     # MobileNetV2-0.35 INT8
    tiny_inf_ms = 120.0
    tiny_energy_mj = 12.0
    ...
    if tiny_feasibility:
        raise ValueError(f"Narrative broken: ResNet-50 ({tiny_original_mb}MB) should NOT fit on TinyML (<{tiny_limit_mb}MB).")
    ...
    cloud_model_mb_str = f"{cloud_size_mb}"
    ...
    mobile_model_mb_str = f"{mobile_size_mb}"
    ...
    tiny_model_mb_str = f"{tiny_original_mb}"
    tiny_alt_mb_str = f"{tiny_alt_mb}"
