...
This convergence explains why techniques transfer effectively between scales. Three examples illustrate this transfer:
...
\index{latency mirage!edge vs cloud}##### Fallacy: *Edge deployment always reduces latency compared to cloud.* {.unnumbered}
