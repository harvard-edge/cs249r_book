...
**Physics is non-negotiable.** You cannot optimize your way out of the speed of light or thermodynamics; you must design *around* them.
:::
...
**Fix the bottleneck.** Improving a non-binding constraint (e.g., faster compute on a memory-bound system) yields exactly zero speedup.
:::
...
| **Mobile ML** | Flagship Smartphone (e.g., iPhone, Pixel) | Modern mobile SoC (multi-core CPU, GPU, NPU) | 8-16 GB RAM | 128 GB-1 TB | 3-5 W | $999+ | Face ID, computational photography, voice recognition | 1-10 TOPS compute, <2W sustained power, <50ms UI response |
...
**Complexity is a tax.** Always measure the value of intelligence against a simple non-ML baseline before paying the maintenance cost.
:::
