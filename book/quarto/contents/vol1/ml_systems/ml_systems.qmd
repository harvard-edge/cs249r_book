...
| **Edge ML**   | ~`{python} HardwareSpectrumSetup.edge_thresh_pflops_str` PFLOPS AI | >`{python} HardwareSpectrumSetup.edge_thresh_bw_str` GB/s  |                                    100 W class                                   |  `{python} MLSystemsSetup.edge_latency_range_str` ms  |
