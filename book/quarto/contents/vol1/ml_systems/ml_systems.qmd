...
class EnergyTransmission:
    ...
    tx_energy_str = fmt_qty(tx_energy_per_mb, mJ/MB, precision=0, commas=False)
    compute_energy_str = fmt_qty(local_energy_op, mJ, precision=1, commas=False, per="inference")
    cloud_total_str = fmt_qty(cloud_energy_total, mJ, precision=0, commas=False)
    local_total_str = fmt_qty(local_energy_total, mJ, precision=1, commas=False)
