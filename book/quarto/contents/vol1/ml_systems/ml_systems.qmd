...
class ThermalQuantCalc:
    ...
    mobile_tdp_w_value = ReferenceStats.MobilePower.MobileNpuTypical.m_as(watt)
...
class EnergyInference:
    ...
    batt_cap_mah_str = fmt(ReferenceStats.PhoneBattery.CapacityMah.m_as('mAh'), precision=0, commas=False, suffix=" mAh")
    batt_volt_str = fmt(ReferenceStats.PhoneBattery.VoltageV.m_as('V'), precision=1, commas=False, suffix=" V")
```
