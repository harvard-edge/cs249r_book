...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim import Hardware
from mlsysim.fmt import fmt_percent, fmt_int, fmt_usd, fmt, check, MarkdownStr, fmt_count
...
class CloudEdgeTCO:
    ...
    requests_str = fmt_count(requests_per_day, scale='M', precision=0, commas=False)
...
class BatteryTax:
    ...
    budget_pct_str = fmt_percent(daily_budget_pct.m_as("")/100, precision=0, commas=False, style='symbol', max_ratio=4)
