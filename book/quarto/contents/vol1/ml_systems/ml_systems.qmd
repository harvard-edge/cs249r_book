...
**Problem**: An unoptimized LLM requires `{python} ThermalQuantCalc.baseline_w_str` peak compute. Can it be deployed on a mobile device, or does it hit the thermal wall\index{Thermal Wall!mobile constraints} and the mobile power wall\index{Power Wall!mobile implications}?
