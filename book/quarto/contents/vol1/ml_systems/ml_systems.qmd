...
\noindent
![](images/png/cover_ml_systems_blueprint.png){fig-alt="Isometric blueprint showing one model artifact moving across cloud, edge, mobile, and tiny-device deployment environments with shrinking resource envelopes."}
...
2.  **Distinction**: Unlike Amdahl's Law, which focuses on parallel speedup, the iron law binds model work to data movement and fixed overhead at the deployment boundary.
