...
from mlsysim.fmt import fmt_percent, fmt, fmt_usd, check, MarkdownStr, fmt_qty, fmt_time
...
from mlsysim.fmt import fmt_percent, fmt, check, fmt_rate, fmt_qty, fmt_multiple, fmt_time
...
class MobileBatteryCapacity:
    ...
    phone_battery_high = 22 * Wh
    baseline_runtime = 24 * hour
    added_ml_power = 1 * watt
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    phone_battery_str = fmt_qty(phone_battery, Wh, precision=0, commas=True)
    added_ml_runtime_low_str = fmt_time(added_ml_runtime_low, hour, precision=1, commas=False, style="word")
    added_ml_runtime_high_str = fmt_time(added_ml_runtime_high, hour, precision=1, commas=False, style="word")
```
