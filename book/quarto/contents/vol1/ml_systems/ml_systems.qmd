...
::: {layout-narrow}
\index{ML systems!deployment paradigms} \index{deployment paradigms|see{ML systems}}
::: {.column-margin}
...
kws_params_str = "70,000"  # Typical KWS model
kws_size_kb = "100"
...
compute_growth_per_yr = 1.6
mem_bw_growth_per_yr = 1.2
mem_wall_ratio = compute_growth_per_yr / mem_bw_growth_per_yr

# Pre-formatted strings
compute_growth_str = str(compute_growth_per_yr)
mem_bw_growth_str = str(mem_bw_growth_per_yr)
...
resnet_fp32_mb = f"{(RESNET50_PARAMS.magnitude * 4 * byte).to(MB).magnitude:.0f}"
gpt2_params_b = f"{GPT2_PARAMS.to(Mparam).magnitude/1000:.1f}"
```
...
##### Fallacy: *Optimizing the slowest component proportionally improves overall system performance.* {.unnumbered}
