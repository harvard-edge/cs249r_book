...
::: {.column-margin}
![](images/svg/vol1_ml_systems_margin_001.svg){width="100%" fig-alt="Margin illustration showing Mini roofline with batch-1 dot left of the ridge."}
...
::: {.column-margin}
![](images/svg/vol1_ml_systems_margin_002.svg){width="100%" fig-alt="Margin illustration showing Bandwidth ladder comparing raw 100-camera demand with a 10G link."}

*Shows that raw edge data can be wider than the network pipe.*
:::
...
::: {.column-margin}
![](images/svg/vol1_ml_systems_margin_003.svg){width="100%" fig-alt="Margin illustration showing Throughput drops from peak to throttled sustained rate."}
...
::: {.column-margin}
![](images/svg/vol1_ml_systems_margin_004.svg){width="100%" fig-alt="Margin illustration showing Camera-pipeline bars before and after 10x model-stage speedup."}

*Shows that a faster model stage does not linearly speed up a camera pipeline.*
:::
