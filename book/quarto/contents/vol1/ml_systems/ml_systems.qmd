...
|:-------------------------|:-----------------------------------------------------------------------------------------------------------|----------------------------------------:|
| **GPU inference (A10G)** | `{python} CloudEdgeTCO.gpu_instances_str` instances × 8,760 hrs × `{python} CloudEdgeTCO.gpu_price_str`/hr |       `{python} CloudEdgeTCO.c_gpu_str` |
| **Network egress**       | `{python} CloudEdgeTCO.egress_gb_str` GB/day × 365 × USD 0.09/GB                                           |    `{python} CloudEdgeTCO.c_egress_str` |
...
| **Power (24/7)**     | `{python} CloudEdgeTCO.power_str` × 8,760 hrs × `{python} CloudEdgeTCO.electricity_str`/kWh        |     `{python} CloudEdgeTCO.e_power_str` |
...
| **DevOps labor**     | `{python} CloudEdgeTCO.devops_fte_str` FTE × `{python} CloudEdgeTCO.devops_salary_str` salary      |     `{python} CloudEdgeTCO.e_labor_str` |
