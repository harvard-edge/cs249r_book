...
\noindent
![](images/png/cover_ml_systems_blueprint_print.png){fig-alt="Isometric blueprint showing one model artifact moving across cloud, edge, mobile, and tiny-device deployment environments with shrinking resource envelopes."}
:::

::: {.content-visible unless-format="pdf"}
![](images/webp/cover_ml_systems_blueprint.webp){fig-alt="Isometric blueprint showing one model artifact moving across cloud, edge, mobile, and tiny-device deployment environments with shrinking resource envelopes."}
:::
