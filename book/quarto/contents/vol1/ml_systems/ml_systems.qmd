...
**The context**: Zillow, a real-estate marketplace, launched "Zillow Offers"\index{Zillow Offers!distribution shift failure} to buy homes directly using an algorithmic valuation model ("Zestimate").
