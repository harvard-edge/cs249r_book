...
4.  **Hardware (The Silicon)**: The physical foundation where bits are transformed. This layer is defined by HBM capacity, memory bandwidth, high-speed intra-node interconnects such as NVLink, and compute throughput. Here, the memory wall acts as the primary physical constraint (@sec-hardware-acceleration).
