...
1.  **Significance (Quantitative):** It is constrained by the **Heat Dissipation** capacity of passive cooling (typically 2–3 W), requiring architectures that prioritize **Sustained Energy Efficiency** over peak throughput ($R_{peak}$).
