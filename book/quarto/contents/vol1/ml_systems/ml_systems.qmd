...
::: {.column-margin}
![](images/png/ml_systems_deployment_span.png){width="100%" fig-alt="Vertical bar ladder of four deployment tiers by power on a log scale: Cloud 3 MW, Edge 200 W, Mobile 5 W, TinyML 50 mW, spanning megawatts to milliwatts."}
...
class EnergyTransmission:
    ...
    tx_energy_per_mb = NETWORK_5G_ENERGY_PER_MB_MJ
    local_energy_op = ENERGY_MOBILENET_INF_MJ
...
::: {.column-margin}
![](images/png/ml_systems_dam_locator.png){width="100%" fig-alt="Triangle diagram with three labeled nodes connected by violet edges: D for data at top, A for algorithm at lower left, M for machine at lower right, showing the three axes are coupled."}
:::
...
class ThermalQuantCalc:
    ...
    mobile_tdp_w_value = MOBILE_TDP_W.m_as(watt)
...
class EnergyInference:
    ...
    batt_cap_mah_str = fmt(BATTERY_CAPACITY_MAH.m_as('mAh'), precision=0, commas=False, suffix=" mAh")
    batt_volt_str = fmt(BATTERY_VOLTAGE_V.m_as('V'), precision=1, commas=False, suffix=" V")
```
