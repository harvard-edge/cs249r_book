...
**TCO over `{python} EdgeSizing.years_str` years** (Coral): Hardware USD `{python} EdgeSizing.coral_fleet_k_str` K + Power (`{python} EdgeSizing.coral_power_w_str` W/1000 $\times$ `{python} EdgeSizing.stores_str` $\times$ `{python} EdgeSizing.hours_per_year_str` h$\times$ `{python} EdgeSizing.years_str` yr$\times$ USD `{python} EdgeSizing.elec_cost_str`/kWh) = USD `{python} EdgeSizing.coral_fleet_k_str` K + USD `{python} EdgeSizing.coral_pwr_k_str` K = **USD `{python} EdgeSizing.coral_tco_k_str`,000 total** vs. cloud inference at ~USD `{python} EdgeSizing.cloud_cost_k_str` K.
