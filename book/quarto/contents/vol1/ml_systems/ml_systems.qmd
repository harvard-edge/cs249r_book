...
|:------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Cloud ML**  | >`{python} cloud_thresh_tflops_str` TFLOPS compute, real-time video processing, >`{python} cloud_thresh_bw_str` GB/s memory bandwidth, PUE[^fn-pue] 1.1–1.3, 100–500 ms latency |
...
Development complexity varies inversely with hardware capability: Cloud and TinyML require deep expertise (cloud infrastructure and embedded systems, respectively), while Mobile and Edge leverage more accessible SDKs and tooling. Cost structures follow a similar pattern: Cloud incurs ongoing operational expenses ($1,000s+/month), Edge requires moderate upfront investment ($100s-$1,000s), Mobile leverages existing devices ($0-$10s), and TinyML minimizes hardware costs ($1-$10s) while demanding higher development investment.
