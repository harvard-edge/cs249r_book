...
: **D·A·M$\times$ Phase**\index{D·A·M Taxonomy!training vs. inference}: The same model imposes starkly different demands on Data, Algorithm, and Machine depending on whether the system is training or serving. When bottlenecks shift unexpectedly, check which phase you are optimizing for. {#tbl-dam-phase}
