...
class LightLatency:
    ...
    # ┌── 1. PARAMETERS (Inputs) ───────────────────────────────────────────────
    distance_km = 3600  # California to Virginia (straight-line)
    safety_budget_ms = 10

    # ┌── 2. CALCULATION (The Physics) ─────────────────────────────────────────
    # Function import local to avoid pollution, or rely on top-level
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsys.constants import RESNET50_FLOPs, RESNET50_PARAMS, GPT2_PARAMS, GFLOPs, Mparam, Bparam, byte, MB
from mlsys.formatting import fmt
...
class BandwidthBottleneck:
    ...
    network_cap_raw = NETWORK_10G_BW
    ...
    network_cap_bytes = network_cap_raw.to("byte/second")
    ...
    net_cap_gbs_str = fmt(network_cap_raw.to(GB/second).magnitude, precision=2, commas=False)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsys.constants import YOLOV8_NANO_FLOPs, GFLOPs, CLOUD_ELECTRICITY_PER_KWH, HOURS_PER_YEAR
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsys.constants import PHONE_BATTERY_WH, OBJECT_DETECTOR_POWER_W, ureg
