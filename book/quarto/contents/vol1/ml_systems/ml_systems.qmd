...
California to Virginia (~3,600 km straight-line) requires **~36 ms minimum** before any computation begins. Real systems add 60–150 ms of software overhead. Applications requiring <10 ms response *cannot* use distant cloud infrastructure—physics forbids it.
...
+:==========================+==============:+==========:+==============:+===============:+
| **NVIDIA Jetson Orin NX** | 100 TOPS      | 10-40 W   | $600          | $300,000       |
+---------------------------+---------------+-----------+---------------+----------------+
