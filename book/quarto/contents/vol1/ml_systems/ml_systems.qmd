...
**The Light Barrier**\index{Light Barrier!latency floor} establishes the absolute latency[^fn-latency-etymology] floor. The minimum round-trip time is governed by @eq-latency-physics:
...
\index{Iron Law of ML Systems!components} \index{Silicon Contract!Iron Law}@sec-introduction established the **Iron Law of ML Systems** (@sec-silicon-contract), restated here as @eq-iron-law:
...
**Break-even Analysis**: @eq-edge-breakeven determines when edge deployment becomes cost-effective:
...
Additional patterns including federated and collaborative learning, which enable privacy-preserving distributed training across devices, constitute advanced topics covered in @sec-security-privacy.
:::
