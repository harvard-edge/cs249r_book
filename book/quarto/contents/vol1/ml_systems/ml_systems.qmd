...
| **TinyML**    | ESP32-CAM           |                                                   Dual-core @ 240 MHz |   520 KB RAM   | `{python} HardwareSpectrumSetup.tiny_flash_mb_str` MB Flash | `{python} HardwareSpectrumSetup.tiny_pwr_min_str`–`{python} HardwareSpectrumSetup.tiny_pwr_max_str` W active board power | \$`{python} HardwareSpectrumSetup.tiny_price_str`                                                          |
