...
# ML System Architecture {#sec-ml-systems}
...
The detailed comparison table appears in @sec-ml-systems-comparative-analysis-selection-framework-832e after we've built intuition for each paradigm.
:::
...
::: {.callout-perspective title="Back-of-the-Napkin: The Complexity Tax"}
...
::: {.callout-perspective title="Back-of-the-Napkin: The Distance Penalty"}
...
::: {.callout-perspective title="Back-of-the-Napkin: The Bandwidth Bottleneck"}
...
::: {.callout-perspective title="Back-of-the-Napkin: The 1000x Energy Gap"}
...
::: {.callout-perspective title="Back-of-the-Napkin: The Battery Tax"}
...
::: {.callout-perspective title="Back-of-the-Napkin: The Thermal Wall"}
...
## Comparative Analysis and Paradigm Selection {#sec-ml-systems-comparative-analysis-selection-framework-832e}
...
### Quantitative Trade-off Analysis {#sec-ml-systems-quantitative-tradeoff-analysis}
...
### Decision Framework {#sec-ml-systems-decision-framework-deployment-selection-f748}
...
### Integration Patterns {#sec-ml-systems-multitier-integration-patterns-c96b}
...
### Production System Integration {#sec-ml-systems-production-system-case-studies-17a6}
...
### Why Hybrid Approaches Work {#sec-ml-systems-shared-principles-across-deployment-paradigms-915d}
...
The remaining chapters in this volume explore each layer: @sec-data-engineering examines data pipelines, @sec-model-compression addresses optimization, and @sec-ml-operations covers operational aspects—all applying whether you deploy to a TPU Pod or an ESP32.
