...
class LighthouseModels:
    ...
    # ┌── 2. CALCULATION (The Physics) ─────────────────────────────────────────
    resnet_flops_g = m_resnet.parameters.magnitude * 160 # Approx multiplier if ops not in twin, or use constant
    # Wait, resnet50_flops is in constants.
    from mlsys.constants import RESNET50_FLOPs
