...
class LighthouseModels:
    ...
    resnet_fp32_mb = resnet_fp32_size.to(MB).magnitude
    ...
    kws_params_str = fmt_count(m_kws.parameters, scale="K", precision=0, commas=False, label="parameter")
...
class ResnetCloud:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    a100_tflops_str = fmt_qty(p.peak_flops_actual, TFLOPs / second, precision=0, commas=False)
...
class DeploymentThresholdsTable:
    ...
    mobile_bw_range_str = fmt_qty_range(
        mobile_bw_min * (GB / second),
        mobile_bw_max * (GB / second),
        GB / second,
        precision=0,
        commas=False,
    )
...
class AmdahlCameraCalc:
    ...
    cam_ml_pct_str = fmt_percent(cam_ml_frac_value, precision=0, commas=False, style="symbol")
    cam_non_ml_pct_str = fmt_percent(cam_non_ml_frac_value, precision=0, commas=False, style="symbol")
