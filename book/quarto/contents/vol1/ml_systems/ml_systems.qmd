...
class MLSystemsNvlinkAnchor:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    nvlink_h100_bw_gb_per_s_str = fmt_qty_int(Hardware.Cloud.H100.nvlink.bandwidth, GB/second, commas=False)
```
...
# │ Exports: ResnetCloud.a100_tflop_per_s_str, .a100_bw_tb_per_s_str, .cloud_ratio_mult_str,
...
class ResnetCloud:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    a100_tflop_per_s_str = fmt_qty(p.peak_flops_actual, TFLOPs / second, precision=0, commas=False)
    a100_bw_tb_per_s_str = fmt_qty(p.peak_bw_actual, TB / second, precision=2, commas=False)
...
- Peak compute: `{python} ResnetCloud.a100_tflop_per_s_str` (FP16)
- Memory bandwidth: `{python} ResnetCloud.a100_bw_tb_per_s_str` (HBM2e)
...
# │          HardwareSpectrumSetup.cloud_thresh_tflop_per_s_str,
# │          HardwareSpectrumSetup.edge_thresh_pflop_per_s_str,
...
class HardwareSpectrumSetup:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    cloud_thresh_tflop_per_s_str = MarkdownStr("1000")            # TFLOP/s threshold for cloud
    cloud_thresh_bw_gb_per_s_str = MarkdownStr("1000 GB/s")
    edge_thresh_pflop_per_s_str = MarkdownStr("1")                # PFLOP/s AI compute threshold
