...
4.  **Hardware (The Silicon)**: The physical foundation where bits are transformed. This layer is defined by HBM (High Bandwidth Memory) capacity and high-speed intra-node interconnects like **NVLink (900 GB/s)**\index{NVLink!intra-node interconnect}. Here, the memory wall acts as the primary physical constraint (@sec-hardware-acceleration).
