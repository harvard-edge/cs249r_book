...
These archetypes map naturally to deployment paradigms: Compute Beast and Sparse Scatter workloads gravitate toward cloud ML where resources are abundant. Bandwidth Hog workloads span cloud and edge depending on latency requirements. Tiny Constraint workloads are exclusively TinyML territory. To make these abstractions concrete, we anchor each archetype to a specific model that recurs throughout this book as one of five reference workloads.
