...
class DistancePenalty:
    ...
    rtt_formatted_str = fmt_time(round_trip_ms_value, "ms", precision=0, commas=False)
    deficit_str = fmt_time(deficit_ms_value, "ms", precision=0, commas=False, allow_negative=True)
    distance_km_str = fmt(distance_km_value, precision=0, suffix=" km")
    safety_budget_str = fmt_time(safety_budget_ms_value, "ms", precision=0, commas=False)
```
...
class CloudEdgeTCO:
    ...
    inference_str = fmt_time(inference_ms, "ms", precision=0, commas=False)
...
class VoiceAssistantWall:
    ...
    vi_gpu_ms_str = fmt_time(vi_gpu_ms_per_query, "ms", precision=0, commas=False)
...
class DataLocalityInvariant:
    ...
    tx_time_ms_str = fmt_time(tx_time_ms, "ms", precision=1, commas=True)
    remote_ms_str = fmt_time(remote_total_ms, "ms", precision=0)
...
class EdgeSizingFleetTCO:
    ...
    stores_str = fmt(stores, precision=0, commas=False)
    hours_per_year_str = fmt_time(HOURS_PER_YEAR, "h", precision=0, commas=False)
...
class ThermalQuantCalc:
    ...
    trip_time_str = fmt_time(trip_time_s_value, "s", precision=0, commas=False)
...
class AmdahlCameraCalc:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    cam_isp_str = fmt_time(cam_isp_ms_value, "ms", precision=0, commas=False)
    cam_ml_str = fmt_time(cam_ml_ms_value, "ms", precision=0, commas=False)
    cam_post_str = fmt_time(cam_post_ms_value, "ms", precision=0, commas=False)
    cam_total_str = fmt_time(cam_total_ms_value, "ms", precision=0, commas=False)
    ...
    cam_ml_opt_str = fmt_time(cam_ml_optimized_ms_value, "ms", precision=0, commas=False)
    cam_total_opt_str = fmt_time(cam_total_optimized_ms_value, "ms", precision=0, commas=False)
