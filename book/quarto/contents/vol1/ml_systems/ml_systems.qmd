...
class CloudEdgeTCO:
    ...
    egress_price_str = fmt_usd(egress_per_gb, precision=2, commas=False, per="GB")
    ...
    c_total_str = fmt_usd(c_total, precision=0, approx=True, per="year")
    ...
    e_total_str = fmt_usd(e_total, approx=True, per="year", commas=True)
    ...
    electricity_str = fmt_usd(electricity_per_kwh, precision=2, commas=False, per="kWh")
...
class BandwidthBottleneck:
    ...
    egress_cost_str = fmt_usd(Infrastructure.Pricing.Cloud.EgressPerGB.rate.m_as("dollar / GB"), precision=2, commas=False, per="GB")
...
class EdgeSizingFleetTCO:
    ...
    elec_cost_str = fmt_usd(Infrastructure.Pricing.Cloud.ElectricityPerKwh.rate.m_as("dollar / kilowatt_hour"), precision=2, commas=False, per="kWh")
...
class TcoPitfallCalc:
    ...
    cloud_compute_str = fmt_usd(cloud_compute_value, precision=0, commas=True, per="month")
    edge_hw_str = fmt_usd(edge_hardware_value, precision=0, commas=False, per="month")
    edge_network_str = fmt_usd(edge_network_value, precision=0, commas=True, per="month")
    edge_maint_str = fmt_usd(edge_maintenance_value, precision=0, commas=False, per="month")
    edge_reliability_str = fmt_usd(edge_reliability_value, precision=0, commas=True, per="month")
