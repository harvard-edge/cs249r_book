...
| **Power (24/7)**     | `{python} CloudEdgeTCO.power_str` $\times$ `{python} CloudEdgeTCO.hours_per_year_str` $\times$ `{python} CloudEdgeTCO.electricity_usd_str` |     `{python} CloudEdgeTCO.e_power_usd_str` |
...
| **DevOps labor**     | `{python} CloudEdgeTCO.devops_fte_str` FTE $\times$ `{python} CloudEdgeTCO.devops_salary_usd_str` salary                                   |     `{python} CloudEdgeTCO.e_labor_usd_str` |
