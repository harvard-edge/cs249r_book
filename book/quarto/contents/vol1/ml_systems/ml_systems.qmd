...
class MLSystemsSetup:
    ...
    gpt3_petaflop_days = (m_gpt3.training_ops / (PFLOPs * SEC_PER_DAY)).magnitude
...
class VoiceAssistantWall:
    ...
    vi_gpu_seconds_day = vi_total_queries_day * vi_gpu_ms_per_query / 1000
    vi_gpu_hours_day = vi_gpu_seconds_day / 3600
    vi_datacenters_avg = vi_gpu_hours_day / (vi_gpus_per_datacenter * 24)
    vi_peak_ratio = vi_peak_multiplier * (24 / vi_waking_hours)
    vi_datacenters_peak = vi_datacenters_avg * vi_peak_ratio

    # Infrastructure - Bandwidth
    vi_audio_bytes_per_sec = vi_audio_sample_rate * (vi_audio_bits / 8)
    vi_audio_kb_per_sec = vi_audio_bytes_per_sec / 1024
    # TB/s = (Bytes/s * Devices) / 1e12. 1e12 = 1000 * BILLION
    vi_total_audio_tb_per_sec = (vi_audio_bytes_per_sec * vi_devices_b * BILLION) / (1000 * BILLION)
