...
**Problem**: Should a drone's object avoidance system (4K, 60 FPS) offload to the cloud, or does this become a locality crossover\index{Locality Crossover!worked example}?
...
**Systems insight**: A TinyML wake-word detector at ten µJ/inference is 100,000,000$\times$ more energy-efficient than a cloud LLM query. This TinyML energy-efficiency gap\index{TinyML!energy efficiency} explains why always-on sensing is only practical at the TinyML tier—a smartphone running continuous cloud queries would drain in minutes.
