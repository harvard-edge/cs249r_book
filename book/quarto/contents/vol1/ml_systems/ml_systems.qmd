...
Algorithms live in a world of abstract mathematics, but models must execute in a physical reality defined by hard constraints. The speed of light makes distant cloud servers useless for emergency braking—a self-driving car cannot wait 100ms for a datacenter to decide whether to stop. Thermodynamics prevents datacenter-class models from running in your pocket before batteries drain or chips overheat. Memory physics dictates that moving data often costs more energy than processing it, creating bandwidth ceilings that faster chips cannot overcome. These are not temporary engineering hurdles awaiting better technology but permanent laws of nature. We define distinct deployment paradigms—Cloud, Edge, Mobile, and TinyML—not as style choices but as necessary adaptations to the non-negotiable physical boundaries of where intelligence must live.
...
[^fn-entropy-etymology]: **Entropy**: From Greek *entropia* (transformation), coined by Rudolf Clausius in 1865 for thermodynamics. Claude Shannon adapted it for information theory in 1948 to measure uncertainty. In ML systems, "entropy" describes the inevitable degradation of model accuracy as real-world distributions drift from training data—a form of informational disorder that requires continuous monitoring and retraining to counteract.
