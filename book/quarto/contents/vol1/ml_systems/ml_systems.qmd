...
|:------------|:----------------------------------------|--------------------------------------------------------:|-------------------------------------:|:----------------------------------|--------------------------------:|:----------------------------|:-------------------------------------------------------------|
| **Cloud ML**  | Google TPU v4 Pod                         |                      4,096 TPU v4 chips (>1 exaflop peak) |                            131 TB HBM2 | Cloud-scale (PB-scale)              |                             ~3 MW | Cloud service (rental only)   | Large language models, massive-scale training                  |
| **Edge ML**   | NVIDIA DGX Spark                          | GB10 Grace Blackwell Superchip (20-core Arm, 1 PFLOPS AI) |                         128 GB LPDDR5x | 4 TB NVMe                           |                            ~200 W | ~$3,000-5,000 (2025 estimate) | Model fine-tuning, on-premise inference, prototype development |
...
| **TinyML**    | ESP32-CAM                                 |                                        Dual-core @ 240MHz |                             520 KB RAM | 4 MB Flash                          |                       0.05-0.25 W | $10                           | Image classification, motion detection                         |
...
|:------------|:----------------------------------------------------------------------------------------------------------------------|
| **Cloud ML**  | >1000 TFLOPS compute, real-time video processing, >100 GB/s memory bandwidth, PUE 1.1-1.3, 100-500 ms latency           |
| **Edge ML**   | ~1 PFLOPS AI compute, >270 GB/s memory bandwidth, desktop deployment, local processing                                  |
| **Mobile ML** | `{python} mobile_npu_range_str` TOPS compute, <2 W sustained power, <`{python} mobile_latency_range_str` ms UI response |
| **TinyML**    | <1 TOPS compute, <1 mW power, microsecond response times                                                                |
