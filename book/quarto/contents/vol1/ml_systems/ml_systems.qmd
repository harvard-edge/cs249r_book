...
The Iron Law ($T = \frac{D_{vol}}{BW} + \frac{O}{R_{peak} \cdot \eta} + L_{lat}$) governs all ML performance. For a formal dimensional analysis and physical derivation of this equation, see @sec-machine-foundations.
...
For a systematic diagnostic guide to identifying these bottlenecks, see @sec-appendix-dam.
