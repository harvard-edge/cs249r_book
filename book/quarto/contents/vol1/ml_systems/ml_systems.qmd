...
# OUTPUT
# =============================================================================
mobile_tdp_str = f"{mobile_tdp_w_value:.0f}"
mobile_tdp_range_str = "3-5"
mobile_npu_tops_str = f"{mobile_npu_tops_value:.0f}"
mobile_npu_range_str = "1-10"
phone_battery_str = f"{phone_battery_wh_value:.0f}"
...
# OUTPUT
# =============================================================================
compute_growth_str = f"{compute_growth_per_yr_value:.1f}"
mem_bw_growth_str = f"{mem_bw_growth_per_yr_value:.1f}"
mem_wall_ratio_str = f"{mem_wall_ratio_value:.2f}"
```
...
# OUTPUT
# =============================================================================
et_data_mb_str = str(et_data_mb_value)
et_tx_energy_str = str(et_tx_energy_mj_value)
et_compute_energy_str = str(et_compute_energy_mj_value)
et_cloud_energy_str = str(int(et_cloud_energy_mj_value))
et_local_energy_str = str(et_local_energy_mj_value)
...
*   **Data (Dvol)**: `{python} et_data_mb_str` MB (e.g., 1 second of audio).
*   **Transmission Energy (Etx)**: `{python} et_tx_energy_str` mJ/MB (Wi-Fi/LTE).
*   **Compute Energy (Eop)**: `{python} et_compute_energy_str` mJ/inference (MobileNet on NPU).

**The Calculation**:

1.  **Cloud Approach**: Ecloud ≈ Dvol × Etx = `{python} et_data_mb_str` MB × `{python} et_tx_energy_str` mJ/MB = **`{python} et_cloud_energy_str` mJ**.
2.  **Local Approach**: Elocal ≈ Inference = **`{python} et_local_energy_str` mJ**.
...
# OUTPUT
# =============================================================================
resnet_gflops_str = f"{resnet_flops_g_value:.1f}"
resnet_params_m_str = f"{resnet_params_m_value:.1f}"
resnet_fp32_mb_str = f"{resnet_fp32_mb_value:.0f}"
gpt2_params_b_str = f"{gpt2_params_b_value:.1f}"
```
...
# OUTPUT
# =============================================================================
resnet_gflops_str = f"{resnet_gflops_value:.1f}"
resnet_params_m_str = f"{resnet_params_m_value:.1f}"
resnet_fp32_mb_str = f"{resnet_fp32_bytes_value.to(MB).magnitude:.0f}"
resnet_fp16_mb_str = f"{resnet_fp16_bytes_value.to(MB).magnitude:.0f}"
resnet_int8_mb_str = f"{resnet_int8_bytes_value.to(MB).magnitude:.0f}"
```
...
# OUTPUT
# =============================================================================
a100_tflops_str = f"{a100_tflops_value:.0f}"
a100_bw_tbs_str = f"{a100_bw_tbs_value:.0f}"
cloud_compute_ms_str = f"{cloud_compute_ms_value:.3f}"
cloud_memory_ms_str = f"{cloud_memory_ms_value:.3f}"
cloud_ratio_x_str = f"{cloud_ratio_x_value:.0f}"
cloud_bottleneck_str = str(cloud_bottleneck_value)
```
...
# OUTPUT
# =============================================================================
mobile_tops_str = f"{mobile_tops_value:.0f}"
mobile_bw_gbs_str = f"{mobile_bw_gbs_value:.0f}"
mobile_ratio_x_str = f"{mobile_ratio_x_value:.0f}"
mobile_bottleneck_str = str(mobile_bottleneck_value)
bw_advantage_x_str = f"{bw_advantage_x_value:.0f}"
inference_speed_x_str = f"{inference_speed_x_value:.0f}"
```
...
rtt_formatted_str = f"{round_trip_ms_value:.0f}"
deficit_str = f"{deficit_ms_value:.0f}"
...
egress_gb_str = f"{egress_gb_per_day_value:.0f}"
...
# OUTPUT
# =============================================================================
ww_devices_b_str = str(ww_devices_b_value)
ww_cloud_cost_str = f"{ww_cloud_cost_per_device_value:.2f}"
ww_total_cost_str = f"{ww_total_cloud_cost_value:,.0f}"
ww_edge_power_range_str = f"{ww_edge_power_min_mw_value}--{ww_edge_power_max_mw_value}"
ww_edge_cost_str = f"{ww_edge_cost_per_year_value:.2f}"
```
...
# OUTPUT
# =============================================================================
cam_rate_mbs_str = f"{raw_bytes_per_sec_value.to(MB/second).magnitude:.0f}"
total_rate_gbs_str = f"{total_bytes_per_sec_value.to(GB/second).magnitude:.1f}"
monthly_cost_m_str = f"{monthly_cost_value / 1e6:.1f}"
net_cap_gbs_str = f"{NETWORK_10G_BW.to(GB/second).magnitude:.2f}"
bw_short_x_str = f"{bw_shortage_value:.0f}"
...
video_width_str = str(VIDEO_1080P_WIDTH)
video_height_str = str(VIDEO_1080P_HEIGHT)
bytes_per_pixel_str = str(VIDEO_BYTES_PER_PIXEL_RGB)
```
...
# OUTPUT
# =============================================================================
tx_energy_str = f"{tx_energy_total_value.to(ureg.millijoule).magnitude:.0f}"
npu_energy_str = f"{npu_energy_total_value.to(ureg.millijoule).magnitude}"
energy_gap_str = f"{energy_gap_ratio_value.magnitude:.0f}"
```
...
yolo_gflops_str = f"{YOLOV8_NANO_FLOPs.to(GFLOPs).magnitude:.1f}"
sustained_gf_str = f"{sustained_gflops_value:.0f}"
req_tflops_str = f"{required_tflops_value:.0f}"
...
coral_fleet_k_str = f"{coral_fleet_value / 1000:.0f}"
jetson_fleet_k_str = f"{jetson_fleet_value / 1000:.0f}"
nuc_fleet_k_str = f"{nuc_cost_value * stores_value / 1000:.0f}"
coral_pwr_k_str = f"{coral_power_cost_value / 1000:.0f}"
coral_tco_k_str = f"{coral_tco_value / 1000:.0f}"
years_str = f"{years_value}"
hours_per_year_str = f"{hours_per_year_value}"
power_ratio_str = f"{jetson_power_w_value / coral_power_w_value:.0f}"
...
# OUTPUT
# =============================================================================
runtime_str = f"{runtime_q_value.to(ureg.hour).magnitude:.1f}"
pwr_w_str = f"{OBJECT_DETECTOR_POWER_W.to(ureg.watt).magnitude:.0f}"
batt_wh_str = f"{PHONE_BATTERY_WH.to(ureg.watt * ureg.hour).magnitude:.0f}"
budget_pct_str = f"{daily_budget_pct_value.magnitude:.0f}"
...
# OUTPUT
# =============================================================================
baseline_str = f"{baseline_power_w_value:.0f}"
quant_power_str = f"{quant_power_w_value:.0f}"
quant_red_str = f"{quant_reduction_value:.0f}"
```
...
cloud_total_str = f"{cloud_total_ms_value:.0f}"
edge_net_str = f"{edge_network_ms_value}"
edge_inf_str = f"{edge_inference_ms_value}"
edge_total_str = f"{edge_total_ms_value:.0f}"
```
