...
| **TinyML**    |      ESP32-CAM      |                                               Dual-core @ 240 MHz                                                |                           520 KB RAM                           |      `{python} HardwareSpectrumSetup.tiny_flash_mb_str` Flash      | `{python} HardwareSpectrumSetup.tiny_pwr_min_w_str`–`{python} HardwareSpectrumSetup.tiny_pwr_max_w_str` active board power |                           `{python} HardwareSpectrumSetup.tiny_price_usd_str`                            |
