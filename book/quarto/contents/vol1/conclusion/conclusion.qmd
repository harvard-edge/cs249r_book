...
- **Personalized education**: Protecting sensitive student-interaction data used for personalization at global scale stresses the latency budget and the data-as-code principle (\ref{pri-data-as-code}).
