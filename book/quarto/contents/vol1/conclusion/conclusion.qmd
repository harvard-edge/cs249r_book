...
::: {.column-margin}
![](images/svg/vol1_conclusion_margin_001.svg){width="100%" fig-alt="Margin illustration showing Cascade from architecture to INT8 to P99 and drift obligations."}

*Shows the synthesis chain from architecture choice to compression, serving, drift, and governance obligations.*
:::
...
::: {.column-margin}
![](images/svg/vol1_conclusion_margin_002.svg){width="100%" fig-alt="Margin illustration showing Llama decode dot on H100 memory-bound slope."}

*Reinforce decode as memory-bound in the final synthesis.*
:::
...
*Shows why mean latency hides the user experience governed by P99.*
:::
