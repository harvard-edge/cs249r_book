...
|:--------------------------------|:----------------------------|:---------------|:-----------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------|
| \ref{pri-data-as-code}          | Data as Code Heuristic      | I: Foundations | Behavior $=f(\text{data, algorithm, code, randomness})$                                                                      | Data changes behavior; other inputs also matter         |
...
: **Thirteen Quantitative Principles**: Each tool appears in the Part where its governing constraint or diagnostic use first becomes visible. The collection combines bounds, decompositions, fitted models, policy requirements, and heuristics. Each row is useful only under its stated assumptions; together they provide a shared analytical vocabulary for system design, optimization, and deployment rather than a set of universal invariants. {#tbl-thirteen-principles tbl-colwidths="[3,16,12,30,39]"}
