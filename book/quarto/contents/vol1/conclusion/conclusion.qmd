...
# │          h100_bw_tb_s_str, h100_peak_tflops_str, t_mem_ms_str, t_comp_ms_str,
# │          ratio_mult_str, t_mem_eq, t_comp_eq
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim import Hardware, Models
from mlsysim.physics import calc_transformer_decode_flops
from mlsysim.fmt import fmt, fmt_math, MarkdownStr, check, fmt_qty
...
class ConclusionRoofline:
    ...
    llama_compute_gflops_str = fmt_qty(compute_req, GFLOPs, precision=0, commas=False)

    h100_bw_tb_s_str = fmt_qty(gpu.memory.bandwidth, TB/second, precision=2, commas=False)
    h100_peak_tflops_str = fmt_qty(gpu.compute.peak_flops, TFLOP/second, precision=0, commas=False)
...
- **Hardware**: H100 with $\text{BW}$ = `{python} ConclusionRoofline.h100_bw_tb_s_str`, $R_{\text{peak}} \approx$ `{python} ConclusionRoofline.h100_peak_tflops_str` FP16.
