...
| \ref{pri-bias-feedback}         | Bias Feedback Invariant     | IV: Deploy     | $\Delta_g(k) \approx \Delta_g(0) \cdot \alpha_{\text{fb}}^k$, $\alpha_{\text{fb}} > 1$                                              | Errors against subgroups compound across cycles when outputs reshape inputs    |
