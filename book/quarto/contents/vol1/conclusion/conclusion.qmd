...
+-----+-----------------------------------------+------------------+------------------------------------------------------+---------------------------------------------+
| 3   | Iron Law of ML Systems                  | II: Build         | $L = \frac{D_{move} + \text{Compute} +               | Every optimization pulls one of three        |
...
|     |                                         |                  | \lambda \cdot D(P_t \| P_0)$                        | the world drifts away from training data     |
+-----+-----------------------------------------+------------------+------------------------------------------------------+---------------------------------------------+
| 11  | Training-Serving Skew Law               | IV: Deploy        | $\Delta\text{Acc} \geq                               | Even subtle preprocessing differences        |
|     |                                         |                  | \mathbb{E}[|f_{serve}(x) - f_{train}(x)|]$          | silently degrade accuracy                    |
+-----+-----------------------------------------+------------------+------------------------------------------------------+---------------------------------------------+
