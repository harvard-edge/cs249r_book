...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt, fmt_multiple, check
...
class EnergyMovementMath:
    ...
    # OUTPUT
    dram_vs_fp32_str = fmt_multiple(round(dram_vs_fp32.to("").magnitude), precision=0, commas=False)
    dram_vs_fp16_str = fmt_multiple(round(dram_vs_fp16.to("").magnitude), precision=0, commas=False)
```
