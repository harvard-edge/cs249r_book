...
- Standard: PIPO calc blocks + physx inline usage rules
...
- Shifted calc output formatting to `physx.formatting` helpers (reduced inline f-strings).
...
## Notes
- Canonical guidance lives in `book/quarto/physx/README.md` and `book/quarto/physx/calc.qmd`.
