...
ML systems require a fundamentally different operational model than traditional software.
...
::: {.callout-lighthouse title="Monitoring Strategy by Archetype" collapse="true"}

The dominant failure modes and monitoring priorities differ fundamentally across workload archetypes:
...
: Monitoring strategy varies by workload archetype's dominant failure mode. {#tbl-monitoring-archetype-strategy}
