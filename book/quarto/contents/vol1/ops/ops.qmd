...
::: {.callout-note}
**Beyond Single-Node Monitoring**: Multi-region and distributed ML deployments introduce additional monitoring coordination challenges—consensus-based alerting, distributed circuit breakers[^fn-circuit-breaker], and cross-region metric aggregation. These platform-scale monitoring patterns are covered in Volume II (@sec-ops-scale).
:::
