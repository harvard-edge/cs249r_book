...
The following framework transforms retraining from an intuition-driven decision into a quantifiable optimization. We will derive the staleness cost function, compute optimal retraining intervals, and work through a complete fraud detection example. The mathematics require basic calculus, but the resulting formula provides actionable guidance: plug in your system's parameters and calculate when retraining becomes economically justified.
...
::: {.callout-perspective title="Back-of-the-Napkin: The Drift Detection Delay"}
