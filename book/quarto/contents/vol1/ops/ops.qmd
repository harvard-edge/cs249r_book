...
Yet operational excellence alone does not guarantee beneficial outcomes. A system can achieve 99.9% uptime, sub-10ms latency, and continuous retraining—and still cause harm through biased decisions, environmental damage, or erosion of human autonomy. The next chapter, @sec-responsible-engineering, examines the ethical and societal dimensions of ML systems engineering. Where this chapter asked "does the system *work*?", the next asks "does the system work *responsibly*?" As machine learning systems influence increasingly consequential decisions, engineering choices must be guided by responsibility as well as reliability.
