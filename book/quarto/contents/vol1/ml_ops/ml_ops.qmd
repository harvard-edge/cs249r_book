...
class ObservabilitySampling:
    ...
    high_gb_s_str = fmt_qty(high_bytes_per_second / second, GB/second, precision=0, commas=False)
    low_mb_s_str = fmt_qty(low_bytes_per_second / second, MB/second, precision=1, commas=False)
    sampling_ratio_str = fmt(sampling_ratio, precision=0, commas=False)
    telemetry_kb_str = fmt_qty(telemetry_per_request, KB, precision=0, commas=False)
...
class MonitoringBudget:
    ...
    storage_gb_str = fmt_qty(storage_q, GB, precision=1, commas=False)
