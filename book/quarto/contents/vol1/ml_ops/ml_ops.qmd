...
$$
\text{ROI} = `{python} MonitoringROI.incidents_prevented_str` \times \text{USD }`{python} MonitoringROI.avg_incident_cost_str` / \text{USD }`{python} MonitoringROI.annual_monitoring_cost_str` = `{python} MonitoringROI.monitoring_roi_str`\times
$$
...
$$
\text{ROI} = (\text{USD }`{python} SingleModelROI.incident_savings_k_str`\text{ K} + \text{USD }`{python} SingleModelROI.time_savings_k_str`\text{ K}) / \text{USD }`{python} SingleModelROI.mlops_investment_k_str`\text{ K} = `{python} SingleModelROI.single_model_roi_str`\times
$$
