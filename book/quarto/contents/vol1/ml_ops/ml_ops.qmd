...
The study yielded `{python} OuraValidationGap.recording_nights_str` of data and `{python} OuraValidationGap.recording_hours_str` of time-synchronized recordings, capturing physiological diversity and variability in environmental and behavioral factors critical for generalizing across a real-world user base.
