...
\foreach \i/\j/\radius/\sho [count=\k] in {
  red/{Configuration Debt}/3.6/7pt,
  cyan/{Feedback Loops}/3.6/7pt,
  Siva/{Data Debt}/4.4/10pt,
  green!65!black/{Pipeline Debt}/3.6/7pt,
  orange/{Correction Cascades}/3.6/7pt,
  yellow!80!red/{Boundary Erosion}/4.4/10pt
}
{
%Satelit
