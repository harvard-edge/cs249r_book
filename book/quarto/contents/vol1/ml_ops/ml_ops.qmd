...
class LatencyBudget:
    ...
    network_share_pct_str = fmt_percent(network / total, precision=0, commas=False, style='symbol')
    feature_fetch_share_pct_str = fmt_percent(feature_fetch / total, precision=0, commas=False, style='symbol')
    request_parse_share_pct_str = fmt_percent(request_parse / total, precision=0, commas=False, style='symbol')
    inference_share_pct_str = fmt_percent(inference / total, precision=0, commas=False, style='symbol')
    post_proc_share_pct_str = fmt_percent(post_proc / total, precision=0, commas=False, style='symbol')
    serialization_share_pct_str = fmt_percent(serialization / total, precision=0, commas=False, style='symbol')
