...
|:--------------------------------------------------|:------------------------------------------:|:---------------------------------------------:|:---------------------------------------------|
| **Network RTT**\index{Network RTT!latency budget} |                    15%                     |    `{python} LatencyBudget.network_ms_str`    | Edge deployment, connection pooling          |
| **Feature retrieval**                             |                    25%                     | `{python} LatencyBudget.feature_fetch_ms_str` | Feature caching, precomputation              |
| **Request parsing**                               |                     5%                     | `{python} LatencyBudget.request_parse_ms_str` | Binary protocols (gRPC), schema optimization |
...
| **Postprocessing**                                |                     5%                     |   `{python} LatencyBudget.post_proc_ms_str`   | Async processing, result caching             |
| **Response serialization**                        |                     5%                     | `{python} LatencyBudget.serialization_ms_str` | Efficient formats (Protobuf, MessagePack)    |
