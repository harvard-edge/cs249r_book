...
::: {.column-margin}
![](images/svg/vol1_ml_ops_margin_001.svg){width="100%" fig-alt="Margin illustration showing Manual cumulative work crosses one-time pipeline investment around 20 weeks."}

*Shows manual operational work crossing the one-time automation investment.*
:::
...
::: {.column-margin}
![](images/svg/vol1_ml_ops_margin_002.svg){width="100%" fig-alt="Margin illustration showing U-shaped total retraining cost with optimum near one day."}

*Shows retraining cadence as a U-shaped cost optimum.*
:::
...
::: {.column-margin}
![](images/svg/vol1_ml_ops_margin_003.svg){width="100%" fig-alt="Margin illustration showing Sensor milliwatts, gateway watts, and automotive tens of watts."}

*Shows edge deployment power budgets spanning sensors, gateways, and vehicles.*
:::
...
::: {.column-margin}
![](images/svg/vol1_ml_ops_margin_004.svg){width="100%" fig-alt="Margin illustration showing D-A-M triangle with Data highlighted for incident debugging."}
