...
# │          OuraValidationGap.recording_hours_str,
...
class OuraValidationGap:
    ...
    recording_hours_str = fmt_time(recording_hours, hour, precision=0, commas=True, style="word")
