...
class LatencyBudget:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    slo_p99_str = fmt_time(slo_p99, "ms", precision=0, commas=False)
    network_str = fmt_time(network, "ms", precision=0, commas=False)
    feature_fetch_str = fmt_time(feature_fetch, "ms", precision=0, commas=False)
    request_parse_str = fmt_time(request_parse, "ms", precision=0, commas=False)
    inference_str = fmt_time(inference, "ms", precision=0, commas=False)
    post_proc_str = fmt_time(post_proc, "ms", precision=0, commas=False)
    serialization_str = fmt_time(serialization, "ms", precision=0, commas=False)
    non_inference_str = fmt_time(non_inference, "ms", precision=0, commas=False)
    ...
    new_total_after_model_speedup_str = fmt_time(new_total_after_model_speedup, "ms", precision=1, commas=False)
...
class ObservabilitySampling:
    ...
    high_seconds_str = fmt_time(high_frequency_seconds, "s", precision=0, commas=False)
    low_seconds_str = fmt_time(low_frequency_seconds, "s", precision=0, commas=False)
