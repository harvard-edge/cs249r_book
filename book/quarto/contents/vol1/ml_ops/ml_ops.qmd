...
::: {.column-margin}
![](images/png/ml_ops_drift_threshold_knee.png){width="100%" fig-alt="A curve stays low and nearly flat, then bends sharply upward at a marked knee point. A shaded zone to the right of the knee flags the region past the drift threshold where the model degrades and retraining is triggered."}
:::
