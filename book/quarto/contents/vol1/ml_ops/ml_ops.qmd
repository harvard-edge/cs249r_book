...
@Fig-technical-debt-taxonomy maps these patterns into six categories spanning data concerns (quality issues, freshness), model concerns (feedback loops, correction cascades), and infrastructure concerns (configuration sprawl, pipeline fragmentation). The representative examples that follow connect each pattern to the engineering response it demands.
