...
# │
# │ Imports: mlsysim.book (fmt)
# │ Exports: incidents_prevented_str, avg_incident_cost_str, monitoring_roi_factor_str
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_usd, check
...
class MonitoringROI:
    ...
    monitoring_roi_factor_str = fmt_multiple(monitoring_roi, precision=0, commas=False)
```
...
$$
\text{ROI} = \frac{`{python} MonitoringROI.incidents_prevented_str` \times `{python} MonitoringROI.avg_incident_cost_str`}{`{python} MonitoringROI.annual_monitoring_cost_str`} = `{python} MonitoringROI.monitoring_roi_factor_str`\times
$$
...
# │
# │ Imports: mlsysim.book (fmt)
# │ Exports: incidents_avoided_str, incident_savings_k_str, single_model_roi_factor_str,
...
class SingleModelROI:
    ...
    single_model_roi_factor_str = fmt_multiple(single_model_roi, precision=1, commas=False)
```
...
$$
\text{ROI} = \frac{`{python} SingleModelROI.incident_savings_k_str` + `{python} SingleModelROI.time_savings_k_str`}{`{python} SingleModelROI.mlops_investment_k_str`} = `{python} SingleModelROI.single_model_roi_factor_str`\times
$$
