...
<!-- TODO(bib-pass): The Significance bullet below contains specific empirical claims
     (10--20 percent accuracy loss within six months, KL-style threshold of 0.1 with
     >5 percent accuracy drop, MTTR reduction from days to <1 hour) that need source
     attribution or recasting as illustrative scenarios. Same audit pass that covers
     model_compression fallacies and benchmarking pricing. -->
...
<!-- TODO(bib-pass): The retail-company example below uses specific numbers
     (15 percent sales boost, 5 percent later loss, USD 10M revenue impact) without
     a source. Either cite the specific case if it is a known incident, or recast as
     an explicitly hypothetical scenario with stated assumptions. Same audit pass. -->
