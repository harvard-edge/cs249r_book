...
# │          OuraValidationGap.participants_str,
# │          OuraValidationGap.nights_str,
...
class OuraValidationGap:
    ...
    accel_only_accuracy = study.AccelerometerOnlyFourStageAccuracy
    enhanced_accuracy = study.EnhancedFourStageAccuracy
    ...
    nights_str = fmt_count(nights, label="night")
...
The study yielded `{python} OuraValidationGap.nights_str` of data and `{python} OuraValidationGap.recording_hours_str` of time-synchronized recordings, capturing physiological diversity and variability in environmental and behavioral factors critical for generalizing across a real-world user base.
