...
**Applying the formula** gives `{python} RetrainingInterval.T_star_eq`.
...
::: {.column-margin}
![](images/svg/ml_ops_drift_threshold_knee.svg){width="100%" fig-alt="A curve stays low and nearly flat, then bends sharply upward at a marked knee point. A shaded zone to the right of the knee flags the region past the drift threshold where the model degrades and retraining is triggered."}

*Past the drift threshold, accuracy collapses; retraining triggers here.*
:::
