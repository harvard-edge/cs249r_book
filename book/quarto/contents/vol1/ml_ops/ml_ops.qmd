...
Schema\index{Schema Validation!structural data checks}[^fn-schema-validation-ml] validation catches structural problems before they reach the model. @Lst-ops-schema-validation demonstrates common validation rules, including column existence checks, type enforcement, null detection, and statistical bounds.
