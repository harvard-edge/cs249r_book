...
::: {.column-margin}
![](images/svg/vol1_data_engineering_margin_001.svg){width="100%" fig-alt="Margin illustration showing Monthly false wakes versus per-window false-positive rate threshold."}

*Shows small per-window false-positive rates compounding into operational failure.*
:::
...
::: {.column-margin}
![](images/svg/vol1_data_engineering_margin_002.svg){width="100%" fig-alt="Margin illustration showing Drift locator for p(x), p(y), and p(y|x)."}
