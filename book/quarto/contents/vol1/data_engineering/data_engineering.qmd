...
gpt3_params_b_value = GPT3_PARAMS.magnitude / 1e9  # 175B
...
kws_storage_s3_cost_value = kws_dataset_size_gb_value / 1000 * storage_cost_s3_val
kws_storage_nvme_low_cost_value = kws_dataset_size_gb_value / 1000 * storage_cost_nvme_low_val
kws_storage_nvme_high_cost_value = kws_dataset_size_gb_value / 1000 * storage_cost_nvme_high_val
...
**The Math**: If duplicates contribute little training signal, removing 30% reduces training time to approximately 10 days, saving $1,500 per run. Over 10 training iterations (hyperparameter tuning, architecture search), this totals $15,000 saved. If deduplication takes 2 engineer-days ($2,000), the ROI is 7.5×.
...
# PROCESS
# =============================================================================
throughput_gbs_value = events_per_sec_value * event_size_kb_value / 1e6  # GB/s
stream_cost_day_value = (
    stream_cores_value * stream_hours_value * stream_cost_per_hr_value
)
hourly_data_tb_value = throughput_gbs_value * 3600 / 1000  # TB per hour
...
required_bw_gbs_value = (
    max_img_per_sec_value * image_size_kb_value * 1e3 / 1e9
)
...
a100_flops_t_str = str(int(a100_flops_val_value / 1e12))
resnet_flops_g_str = str(int(resnet_flops_per_img_value / 1e9))
