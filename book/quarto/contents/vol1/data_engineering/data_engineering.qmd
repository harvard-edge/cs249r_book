...
Unlike image models that are often limited by arithmetic throughput or language models that can be limited by streaming bandwidth, large recommendation systems are limited by memory capacity and the logistics of serving many random embedding-table lookups efficiently.
