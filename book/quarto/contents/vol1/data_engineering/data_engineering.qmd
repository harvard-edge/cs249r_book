...
a100_tflops_fp16_sparse_str = f"{a100_tflops_fp16_sparse_value:.0f}"

energy_dram_str = f"{energy_dram_pj_value:.0f}"
energy_flop_fp32_str = f"{energy_flop_fp32_pj_value:.1f}"
energy_flop_int8_str = f"{energy_flop_int8_pj_value:.1f}"
...
gpt3_params_str = f"{gpt3_params_b_value:.0f}"
gpt3_fp32_str = f"{gpt3_fp32_gb_value:.0f}"
gpt3_fp16_str = f"{gpt3_fp16_gb_value:.0f}"
...
# OUTPUT
# =============================================================================
transfer_seconds_str = f"{transfer_seconds_value:,.0f}"
transfer_hours_str = f"{transfer_hours_value:.0f}"
transfer_cost_str = f"{transfer_cost_value:,.0f}"
tpu_hours_str = f"{equivalent_tpu_hours_value:,.0f}"
network_gbs_str = f"{network_gbs_value:.1f}"
dataset_gb_str = f"{dataset_gb_gravity_value:,}"
network_gbps_str = f"{network_gbps_value}"
egress_cost_per_gb_str = f"{egress_cost_per_gb_value:.2f}"
tpu_cost_per_hour_str = f"{tpuv4_cost_per_hour_value:.1f}"
```
...
# OUTPUT
# =============================================================================
sec_str = str(seconds_per_minute_value)
min_str = str(minutes_per_hour_value)
hr_str = str(hours_per_day_value)
day_str = str(days_per_month_value)
windows_per_month_str = f"{windows_per_month_value:,}"
fpr_str = f"{fpr_value:.1e}"
rejection_pct_str = f"{rejection_pct_value:.5f}"
```
...
# OUTPUT
# =============================================================================
cost_per_label_str = f"{cost_per_label_value:.2f}"
review_overhead_pct_str = str(review_overhead_pct_value)
...
effective_cost_str = f"{effective_cost_value:.2f}"
...
# OUTPUT
# =============================================================================
ks_dcrit_str = f"{ks_dcrit_value:.3f}"
```
...
# OUTPUT
# =============================================================================
throughput_str = f"{throughput_gbs_value:.0f}"
hourly_tb_str = f"{hourly_data_tb_value:.1f}"
stream_cost_str = f"{stream_cost_day_value:.0f}"
batch_cost_str = f"{batch_cost_day_value:.0f}"
cost_ratio_str = f"{cost_ratio_value:.0f}"
events_per_sec_str = f"{events_per_sec_value / 1e6:.0f}M"
event_size_kb_str = str(event_size_kb_value)
stream_cores_str = str(stream_cores_value)
stream_hours_str = str(stream_hours_value)
stream_cost_per_hr_str = f"{stream_cost_per_hr_value}"
batch_core_hours_str = f"{batch_core_hours_value:.0f}"
```
...
daily_raw_tb_str = str(daily_raw_tb_value)
spark_per_tb_str = str(spark_per_tb_value)
etl_datasets_str = str(etl_datasets_value)
etl_tb_each_str = str(etl_tb_each_value)
etl_storage_tb_str2 = str(etl_storage_tb_value)
s3_per_tb_mo_str = str(s3_per_tb_mo_value)
retention_days_str = str(retention_days_value)
query_cost_per_str = str(query_cost_per_value)
n_models_str = str(n_models_value)
```
...
# OUTPUT
# =============================================================================
amdahl_speedup_str = f"{amdahl_speedup_value:.2f}"
...
tcdo_label_vs_compute_str = f"{tcdo_label_vs_compute_value:.0f}"
```
...
# OUTPUT
# =============================================================================
nvme_load_str = f"{nvme_load_s_value:.0f}"
obj_load_str = f"{obj_load_s_value:,.0f}"
load_speedup_str = f"{load_speedup_value:.0f}"
```
...
# OUTPUT
# =============================================================================
eta_csv_str = f"{eta_csv_value:.1f}"
eta_parquet_str = f"{eta_parquet_value:.1f}"
waste_pct_str = f"{waste_pct_value:.0f}"
throughput_ratio_str = f"{throughput_ratio_value:.0f}"
...
# OUTPUT
# =============================================================================
decompress_speedup_str = f"{decompress_speedup_value:.0f}"
gzip_min_str = f"{gzip_decompress_min_value:.0f}"
snappy_min_str = f"{snappy_decompress_min_value:.0f}"
time_diff_str = f"{time_diff_min_value:.0f}"
total_diff_hours_str = f"{total_diff_hours_value:.0f}"
...
# OUTPUT
# =============================================================================
retrieval_str = f"{retrieval_cost_value:,.0f}"
equiv_months_str = f"{equiv_months_per_tb_value:.0f}"
daily_retrieval_str = f"{daily_retrieval_value:,.0f}"
s3_monthly_str = f"{s3_monthly_cost_value:,.0f}"
nvme_per_tb_str = f"{nvme_per_tb_value:.0f}"
```
