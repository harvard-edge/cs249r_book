...
A common fallacy is this: *More data always improves model performance.*
...
A recurring pitfall is this: *Planning petabyte migration as a bandwidth-only transfer.*
...
A common fallacy is this: *Data preprocessing can be finished once and left alone.*
...
A recurring pitfall is this: *Ignoring data serialization cost.*
...
A common fallacy is this: *High training accuracy indicates production readiness.*
...
A recurring pitfall is this: *Ignoring training-serving skew until deployment.*
...
A common fallacy is this: *Synthetic data can fully replace real-world data collection.*
...
A recurring pitfall is this: *Neglecting data versioning until model debugging requires it.*
