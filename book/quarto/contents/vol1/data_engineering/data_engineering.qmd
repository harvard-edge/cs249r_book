...
The workflow becomes concrete in the data pipeline: raw inputs pass through collection, ingestion, analysis, labeling, validation, and preparation before they become ML-ready datasets. The effort breakdown in @fig-ds-time (Chapter 3) explains why that pipeline needs its own systems treatment: in a 2016 survey, 60 percent of respondents selected cleaning and organizing data as their most time-consuming task, and 19 percent selected collecting datasets [@crowdflower2016data]. The data axis of the D·A·M taxonomy becomes real only as infrastructure: acquisition systems, validation checks, labeling workflows, storage layouts, and governance.
