...
**Problem**: A `{python} DataGravity.dataset_pb_str` training dataset resides in a US East data center, while a Tensor Processing Unit (TPU) pod is available in US West. Is it faster to move the data or to move the compute?
