...
3.  **Determine Significance**: Compare $D_{KS}$ to critical value $D_{\text{crit}}$ based on sample size $n$ and confidence level ($\alpha = 0.05$).
