...
2.  **Transfer time**: Moving `{python} DataGravity.dataset_gb_str` at `{python} DataGravity.network_gb_per_s_str` takes `{python} DataGravity.transfer_seconds_str`, approximately `{python} DataGravity.transfer_hours_str`.
