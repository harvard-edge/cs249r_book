...
Data has physical mass. Pruning `{python} EnergyAccessCosts.prune_pct_str` of training data through deduplication does more than save disk space; it reduces work in data-intensive stages of the training lifecycle. This is *why* data selection is a high-leverage tool in the systems engineer's toolkit: it addresses the problem at the most expensive source.
