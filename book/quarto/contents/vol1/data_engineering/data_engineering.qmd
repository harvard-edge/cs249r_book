...
\end{scope}
%
\node[Box,  node distance=1.0,below=of $(2B1)!0.5!(2B2)$](3B1){Storage Layer};
%
...
\node[Box, fill=OrangeL,draw=OrangeLine, node distance=0.5,below =of 4B1](5B1){Model Training};
\node[Box,fill=RedL,draw=RedLine,node distance=0.5,below =of 4B2](5B2){Transformation};
\node[Box, fill=RedL,draw=RedLine, node distance=0.5,below =of 5B2](6B1){Feature Creation / Engineering};
\node[Box, fill=RedL,draw=RedLine, node distance=0.5,below =of 6B1](7B1){Data Labeling};
%
\scoped[on background layer]
...
nvme_bw_gbs_str = fmt(nvme_bw_gbs_value, precision=0, commas=False)
```
