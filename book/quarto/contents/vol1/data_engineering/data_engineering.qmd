...
Pre-existing datasets from repositories such as Kaggle [@kaggle_website], UCI [@uci_repo], and ImageNet\index{ImageNet!benchmark dataset}[^fn-imagenet-feifei] [@imagenet_website] offer cost-efficient starting points with established benchmarks for consistent performance comparison.
