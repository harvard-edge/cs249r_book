...
3.  **Determine Significance**: Compare $D_{\text{KS}}$ to critical value $D_{\text{crit}}$ based on sample size $n$ and confidence level ($\alpha = 0.05$).
    $$D_{\text{crit}} \approx \frac{1.36}{\sqrt{n}}$$

**Example Calculation**

- Sample size $n = 1000$.
- Critical value $D_{\text{crit}} \approx 1.36 / \sqrt{1000}$ ≈ `{python} KSTest.ks_dcrit_str`.
