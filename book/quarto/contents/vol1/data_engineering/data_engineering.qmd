...
*Maps drift types to the distribution component that moved.*
:::
...
*Shows local aggregation beating gather-all coordination because network latency dominates.*
:::
...
*Shows annotation granularity turning into storage and processing scale.*
:::
