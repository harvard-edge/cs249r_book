...
*   **Hardware peak**: NVIDIA A100 = `{python} StorageBandwidth.a100_fp16_tflop_per_s_str` (FP16 Tensor Core, dense operations).
...
*   **Maximum theoretical throughput**: `{python} StorageBandwidth.max_img_per_s_str` (A100 peak FP16 throughput divided by ResNet-50 forward-plus-backward FLOPs per image).
