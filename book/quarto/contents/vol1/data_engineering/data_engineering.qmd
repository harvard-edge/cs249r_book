...
hourly_data_tb_value = (throughput_gbs_value * SEC_PER_HOUR * GB).to(TB).magnitude  # TB per hour
...
events_per_sec_str = f"{events_per_sec_value / MILLION:.0f}M"
...
sata_max_img_sec_value = int(sata_bw_mbs_value * MILLION / (image_size_kb_value * 1e3))
