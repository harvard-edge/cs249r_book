...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt_usd, fmt, check, fmt_math
...
class DataGravity:
    ...
    egress_cost_per_gb_str = fmt_usd(egress_cost_gb, precision=2, commas=False, suffix="/GB")
    tpu_cost_per_hour_str = fmt_usd(tpu_hourly_cost, precision=0, commas=False, suffix="/hour")
```
...
class BudgetAllocation:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    cost_per_label_str = fmt_usd(cost_per_label, precision=2, commas=False, suffix="/label")
    review_overhead_pct_str = fmt_percent(review_overhead_pct/100, precision=0, commas=False, style='symbol')
    labeling_k_str = fmt_usd(labeling_budget/THOUSAND, precision=0, commas=False, suffix="K")
    storage_k_str = fmt_usd(storage_budget/THOUSAND, precision=1, commas=False, suffix="K")
    governance_k_str = fmt_usd(governance_budget/THOUSAND, precision=1, commas=False, suffix="K")
    effective_cost_str = fmt_usd(effective_cost, precision=2, commas=False, suffix="/label")
...
class KWSDesignConstraints:
    ...
    kws_budget_str = fmt_usd(kws_budget/THOUSAND, precision=0, commas=False, suffix="K")
...
class LabelingComputeRatio:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────
    labeling_budget_str = fmt_usd(labeling_budget/THOUSAND, precision=0, commas=False, suffix="K")
...
class GlacierRetrievalPricing:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    retrieval_cost_glacier_str = fmt_usd(retrieval_cost_glacier, precision=2, commas=False, suffix="/GB")
    retrieval_cost_glacier_expedited_str = fmt_usd(retrieval_cost_glacier_expedited, precision=2, commas=False, suffix="/GB")
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt_usd, fmt, check, fmt_count
...
class RealtimeCost:
    ...
    stream_cost_str = fmt_usd(stream_cost_day, precision=0, commas=False, suffix="/day")
    batch_cost_str = fmt_usd(batch_cost_day, precision=0, commas=False, suffix="/day")
    ...
    stream_cost_per_hr_str = fmt_usd(stream_cost_per_hr, precision=2, commas=False, suffix="/hr")
...
class EtlEltCost:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    etl_spark_str = fmt_usd(etl_spark_daily, precision=0, commas=False, suffix="/day")
    etl_storage_str = fmt_usd(etl_storage_mo, precision=0, commas=False, suffix="/month")
    elt_storage_tb_str = fmt(elt_storage_tb, precision=0, commas=False, suffix=" TB")
    elt_storage_str = fmt_usd(elt_storage_mo, precision=0, suffix="/month")
    elt_query_str = fmt_usd(elt_query_mo, precision=0, commas=False, suffix="/month")
    savings_str = fmt_usd(storage_savings_mo, precision=0, suffix="/month")
    etl_spark_monthly_str = fmt_usd(etl_spark_monthly, precision=0, suffix="/month")
    etl_total_str = fmt_usd(etl_total_mo, precision=0, suffix="/month")
    elt_total_str = fmt_usd(elt_total_mo, precision=0, suffix="/month")
    total_savings_str = fmt_usd(total_savings_mo, precision=0, suffix="/month")
    daily_raw_tb_str = fmt(daily_raw_tb, precision=0, commas=False, suffix=" TB")
    spark_per_tb_str = fmt_usd(spark_per_tb, precision=0, commas=False, suffix="/TB")
    ...
    s3_per_tb_mo_str = fmt_usd(s3_per_tb_mo, precision=0, commas=False, suffix="/TB/month")
    retention_days_str = fmt(retention_days, precision=0, commas=False, suffix=" days")
    query_cost_per_str = fmt_usd(query_cost_per, precision=0, commas=False, suffix="/query")
...
class ActiveLearningBudget:
    ...
    label_budget_str = fmt_usd(label_budget / THOUSAND, precision=0, commas=False, suffix="K")
    label_cost_str = fmt_usd(label_cost, precision=2, commas=False, suffix="/label")
    inference_cost_str = fmt_usd(inference_cost_per_image, precision=2, commas=False, suffix="/image")
    random_labels_str = fmt_count(random_labels_needed, scale='M', precision=0, commas=False)
    random_label_cost_str = fmt_usd(random_label_cost / THOUSAND, precision=0, commas=False, suffix="K")
    ...
    active_label_cost_low_str = fmt_usd(active_label_cost_low / THOUSAND, precision=0, commas=False, suffix="K")
    active_label_cost_high_str = fmt_usd(active_label_cost_high / THOUSAND, precision=0, commas=False, suffix="K")
    full_pool_inference_cost_str = fmt_usd(full_pool_inference_cost / THOUSAND, precision=0, commas=False, suffix="K")
    active_total_low_str = fmt_usd(active_total_low / THOUSAND, precision=0, commas=False, suffix="K")
    active_total_high_str = fmt_usd(active_total_high / THOUSAND, precision=0, commas=False, suffix="K")
    compute_budget_pct_str = fmt_percent(compute_budget_fraction, precision=0, commas=False, style='symbol')
    compute_budget_str = fmt_usd(compute_budget / THOUSAND, precision=0, commas=False, suffix="K")
...
class KWSStorageEconomics:
    ...
    storage_s3_cost_str = fmt_usd(storage_s3_cost, precision=1, commas=False, suffix="/month")
    storage_nvme_low_cost_str = fmt_usd(storage_nvme_low_cost, precision=1, commas=False, suffix="/month")
    storage_nvme_high_cost_str = fmt_usd(storage_nvme_high_cost, precision=1, commas=False, suffix="/month")
