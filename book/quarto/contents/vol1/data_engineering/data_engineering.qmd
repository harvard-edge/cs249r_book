...
kws_label_hours_value = kws_dataset_size_m_value * 1e6 * kws_label_seconds_per_example / 3600
kws_label_years_value = kws_label_hours_value / 2000  # full-time work hours/year
kws_label_hours_str = fmt(kws_label_hours_value, precision=0, commas=True)
kws_label_years_str = fmt(kws_label_years_value, precision=1, commas=False)
...
### Four Foundational Pillars {#sec-data-engineering-ml-four-foundational-pillars-c119}
...
### KWS Design Space {#sec-data-engineering-ml-kws-design-space}
...
compress_dataset_gb_str = f"{dataset_gb_value}"
