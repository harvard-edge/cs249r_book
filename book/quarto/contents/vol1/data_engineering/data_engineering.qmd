...
::: {#fig-debug-flowchart fig-env="figure" fig-pos="htb" fig-cap="**Data Pipeline Debugging Flowchart**: Four sequential checks prioritize hypotheses involving drift, overfitting or data artifacts, training-serving skew, and subgroup coverage. Each branch suggests a hypothesis to investigate rather than a conclusive diagnosis; if no listed condition holds, model architecture or capacity is only one remaining possibility." fig-alt="Vertical flowchart with four blue diamond decision nodes and result boxes suggesting hypotheses involving data drift, overfitting or data artifacts, training-serving skew, and subgroup coverage. A gray box at the bottom suggests examining model architecture or capacity after the listed checks."}
