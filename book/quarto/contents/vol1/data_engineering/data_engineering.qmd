...
[^fn-cap-theorem-ml-storage]: **CAP Theorem**\index{CAP Theorem!feature store trade-off}: Conjectured by @brewer2000 and formally proved by @gilbert2002. During a network partition, linearizable consistency may require rejecting requests, whereas an available system may return stale or divergent values. CAP does not guarantee feature-transformation parity or point-in-time correctness.
