...
**Population Stability Index (PSI)** provides an industry-standard metric for detecting changes in feature distributions. PSI discretizes continuous features into bins (typically 10-20 bins) and compares actual serving distribution against expected training distribution:
