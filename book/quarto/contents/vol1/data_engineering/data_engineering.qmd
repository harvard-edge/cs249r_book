...
class DataGravity:
    ...
    transfer_hours_str = fmt_time(round(transfer_hours), "h", precision=0, commas=False)
...
class KWSProblemTargets:
    ...
    kws_latency_limit_ms_str = fmt_time(kws_latency_limit_ms, "ms", precision=0, commas=False)
```
...
class KWSQualityThresholds:
    ...
    sample_duration_ms_low_str = fmt_time(sample_duration_ms_low, "ms", precision=0, commas=False)
    sample_duration_ms_high_str = fmt_time(sample_duration_ms_high, "ms", precision=0, commas=False)
```
...
class StorageLoading:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    nvme_load_str = fmt_time(nvme_load_s, "s", precision=1, commas=False)
    obj_load_str = fmt_time(obj_load_s, "s", precision=0, commas=True)
    load_speedup_str = fmt_multiple(load_speedup, precision=0, commas=False)
