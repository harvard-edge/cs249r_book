...
The systems framing reveals optimization opportunities invisible to the ML framing. To see why, consider how data efficiency interacts with the Iron Law introduced in @sec-ml-systems.
...
::: {.callout-example title="KWS Data Efficiency"}
...
::: {.callout-lighthouse title="Lighthouse Data Efficiency"}
