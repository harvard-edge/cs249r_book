...
**Next: Model Compression (@sec-model-compression)**

Data efficiency optimizes what goes *into* the model. Model compression optimizes what comes *out*. The next chapter examines how to shrink the trained model through:

- **Pruning**: Removing redundant weights and neurons
- **Quantization**: Reducing numerical precision from FP32 to INT8 or INT4
- **Knowledge Distillation**: Training smaller models to mimic larger ones

These techniques compound with data efficiency: a coreset-trained model that is then quantized delivers multiplicative savings. Together, data efficiency and model compression form the software-side of the optimization triad, reducing both the *volume* and *cost* of computation before hardware acceleration can do its work.
:::
