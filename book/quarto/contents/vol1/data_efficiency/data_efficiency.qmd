...
**The Fix**: Use a **Proxy Model** ($10\times$ smaller) for selection. $T_{selection} = 0.1 \times C_{epoch}$. Total time = $0.1 + 10 = 10.1$. You preserve the speedup. The figure below visualizes this trade-off.
:::
