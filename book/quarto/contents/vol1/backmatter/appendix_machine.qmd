...
|:-------------------------------|--------------------------------------------:|:----------------------------------|
| Accelerator memory (HBM) vs. L1 cache  |        ~`{python} hbm_vs_l1`$\times$ slower | On-chip vs. off-chip              |
...
| Accelerator memory BW vs. CPU↔Accelerator link |   ~`{python} gpu_bw_vs_pcie`$\times$ faster | Architectural investment priority |
