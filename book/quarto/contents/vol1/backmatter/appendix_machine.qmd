...
: **The Energy Wall.** Moving data costs ~580 $\times$ more energy than computing on it. This ratio is physics, not engineering.[^fn-horowitz-energy] {#tbl-energy-ratios-ref}
...
| Training FLOPs                | ~6 $\times$ parameters $\times$ tokens | 7B on 1T tokens → 4 $\times$ 10²² FLOPs |
