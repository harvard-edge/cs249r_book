...
For capacity planning in inference systems, **Little's Law** [@little1961proof] relates concurrency ($N_{\text{req}}$), arrival rate ($\lambda$), and latency ($T_{\text{lat}}$):[^fn-little]
