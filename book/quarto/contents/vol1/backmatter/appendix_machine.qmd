...
3. An inference service must handle 500 QPS at 100ms latency. Using Little's Law, how many concurrent requests must the system support? If each request needs 2 GB of KV cache memory, what is the minimum GPU memory required?
