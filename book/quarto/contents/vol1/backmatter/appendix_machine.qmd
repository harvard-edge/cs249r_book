...
2. **16 bytes/parameter for training**: Model weights (2B FP16) + gradients (2B FP16) + master weights (4B FP32) + optimizer states for Adaptive Moment Estimation (Adam) at 8B. A 7B model needs 112 GB just to start training.
