...
from mlsysim.fmt import fmt_int, fmt_int,  fmt, check, fmt_math, sci_latex, MarkdownStr, fmt_percent, fmt_count, fmt_time
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt_int,  fmt, fmt_math, fmt_time
...
class ArchReferenceTables:
    ...
    h100_flops_str = fmt(h100_flops_value, precision=0, commas=False, suffix=" TFLOP/s")
    h100_bw_str = fmt(h100_bw_value, precision=2, commas=False, suffix=" TB")
    h100_cap_str = fmt(h100_cap_value, precision=0, commas=False, suffix=" GB")
    h100_nvlink_str = fmt(h100_nvlink_value, precision=0, commas=False, suffix=" GB")
    h100_l2_mb_str = fmt(h100_l2_mb_value, precision=0, commas=False, suffix=" MB")

    tpuv5_flops_str = fmt(tpuv5_flops_value, precision=0, commas=False, suffix=" TFLOP/s")
    tpuv5_bw_str = fmt(tpuv5_bw_value, precision=2, commas=False, suffix=" TB")
    tpuv5_cap_str = fmt(tpuv5_cap_value, precision=0, commas=False, suffix=" GB")
    tpuv5_ici_str = fmt(tpuv5_ici_value, precision=0, commas=False, suffix=" GB")
    tpuv5_l2_mb_str = fmt(tpuv5_l2_mb_value, precision=0, commas=False, suffix=" MB")
