...
With the common misconceptions out of the way, the best next step is to connect these reference numbers back to the concrete system design problems—training throughput, serving latency, and accelerator selection—in the main chapters.
