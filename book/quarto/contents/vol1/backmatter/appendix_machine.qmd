...
Consider an NVIDIA A100 GPU with FP16 Tensor Core performance of `{python} a100_fp16` TFLOP/s and HBM2e bandwidth of `{python} a100_bw_tb` TB/s. The ridge point is $312 / 2.0 = 156$ FLOP/byte.
...
$$ T = \frac{1.2 \times 10^{20}}{1.25 \times 10^{14}} \approx 960 \text{ seconds} \approx 16 \text{ minutes} $$
