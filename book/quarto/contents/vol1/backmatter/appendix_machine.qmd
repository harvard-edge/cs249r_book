...
relu_util_str = f"{relu_utilization_value:.2f}"
...
# OUTPUT
# =============================================================================
amdahl_8_str = f"{amdahl_8_value:.1f}"
amdahl_inf_str = f"{amdahl_inf_value:.0f}"
```

*   With $n=1$, speedup is 1.
*   With n=8, speedup is 1/(0.05 + 0.95/8) ≈ `{python} amdahl_8_str`×.
*   With n=infinity, speedup is capped at 1/0.05 = `{python} amdahl_inf_str`×.
...
# OUTPUT
# =============================================================================
gustafson_8_str = f"{gustafson_8_value:.2f}"
gustafson_8_serial = f"{gustafson_8_serial_value:.2f}"
gustafson_1000_str = f"{gustafson_1000_value:.0f}"
```
...
# OUTPUT
# =============================================================================
T_seconds_str = f"{t_seconds_value:.0f}"
T_minutes_str = f"{t_minutes_value:.0f}"
```
...
# OUTPUT
# =============================================================================
L_concurrent_str = f"{l_concurrent_value:.0f}"
```
...
# OUTPUT
# =============================================================================
tx_time_us_str = f"{tx_time_us_value:.1f}"
```
