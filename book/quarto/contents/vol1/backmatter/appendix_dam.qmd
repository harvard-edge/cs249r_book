...
$$\text{Achieved FLOP/s} = \frac{`{python} ex2_flops_per_pass_str` \text{ TFLOPs}}{0.050 \text{ s}} = `{python} ex2_achieved_str` \text{ TFLOP/s}$$

Then calculate utilization:
$$\eta = \frac{`{python} ex2_achieved_str`}{`{python} h100_fp16_tflops_str`} \approx 28.3\%$$
