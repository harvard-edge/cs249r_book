...
: **D·A·M Screening Indicators**: Context-dependent signals for investigation, not universal grades. {#tbl-dam-scorecard tbl-colwidths="[14,18,30,19,19]"}
...
[^fn-bayes-error]: **Bayes Error Rate**: The lowest achievable error rate for any classifier on a given data distribution, determined by the overlap between class-conditional distributions [@goodfellow2016deep]. Named after Thomas Bayes (1701–1761). No amount of data, parameters, or compute can reduce error below this theoretical floor.
