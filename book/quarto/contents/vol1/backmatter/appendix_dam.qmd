...
The additive iron law represents **sequential execution**\index{Sequential execution!D·A·M coordination}. Overlap can move the sum toward a max, but dependencies, contention, and incomplete overlap keep measured time above this ideal lower bound:
...
: **D·A·M Overlap Techniques**: Each technique overlaps work across axes, moving part of $T = a + b$ toward the ideal lower bound $T = \max(a, b)$. Dependencies and contention limit realized overlap. {#tbl-dam-overlap tbl-colwidths="[19,27,54]"}
