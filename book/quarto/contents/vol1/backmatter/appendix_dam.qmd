...
class DAMTaxonomy:
    ...
    h100_fp16_tflops_peak = H100_FLOPS_FP16_TENSOR.to(TFLOPs / second).magnitude
    ...
    # Exercise 2 logic
    ex2_flops_per_pass = (ex2_params * ex2_flops_per_param * flop).to(TFLOPs).magnitude
    ex2_achieved_tflops = ex2_flops_per_pass / ex2_latency_s
    ex2_util = (ex2_achieved_tflops / h100_fp16_tflops_peak) * 100
    ex2_model_size_gb = (ex2_params * ex2_bytes_per_param * byte).to(GB).magnitude
    ...
    ex4_gpu_old_str = f"{ex4_gpu_old_n}× A100"
    ex4_gpu_new_str = f"{ex4_gpu_new_n}× H100"
...
### Case 1: The Starving GPU (Data) {#sec-dam-taxonomy-case-1-starving-gpu-data-9a56}
