...
::: {#fig-dam-venn fig-env="figure" fig-pos="htb" fig-cap="**The D·A·M Intersection Landscape**: Each circle is a diagnostic lens: Data (information), Algorithm (logic), and Machine (physics). Pairwise intersections span two lenses. The center is ML Systems Engineering, balancing data flow, algorithmic complexity, and hardware constraints." fig-alt="Venn diagram with three overlapping circles labeled data, algorithm, and machine. Pairwise intersections are labeled: Data-Algorithm shows data selection and curriculum learning; Data-Machine shows I/O bandwidth and data formats; Algorithm-Machine shows quantization and kernel fusion. The center intersection is labeled ML systems engineering with iron law and roofline."}
```{.tikz}
