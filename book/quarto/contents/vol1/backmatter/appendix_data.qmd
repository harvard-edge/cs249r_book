...
$\exp($`{python} lse_z0`$) \approx$ `{python} LogSumExp.naive0_str`, $\exp($`{python} lse_z1`$) \approx$ `{python} LogSumExp.naive1_str`, $\exp($`{python} lse_z2`$) \approx$ `{python} LogSumExp.naive2_str`
...
$\exp($`{python} lse_shifted0`$) \approx$ `{python} LogSumExp.sexp0_str`, $\exp($`{python} lse_shifted1`$) \approx$ `{python} LogSumExp.sexp1_str`, $\exp($`{python} lse_shifted2`$) =$ `{python} LogSumExp.sexp2_str`
