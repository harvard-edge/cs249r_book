...
from physx.constants import TB, PB, Gbps
...
# INPUT
# =============================================================================
tb_value = TB.magnitude  # bytes
pb_value = PB.magnitude  # bytes
...
**Transfer Time Equation**: $T = \text{Data Volume} / \text{Bandwidth}$ (for the large volumes here, latency is negligible; see @sec-system-foundations-bandwidth-vs-latency-e155 for the full equation)
...
**The Problem**: If $z_i$ is large (e.g., `{python} logit_val`), $e^{{python} logit_val}$ overflows floating-point range.
