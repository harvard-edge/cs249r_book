...
class SerializationCost:
    ...
    csv_speed_str = fmt(csv_speed_mb, precision=0, commas=False, approx=True, suffix=' MB/s')
    parquet_speed_str = fmt(parquet_speed_mb, precision=0, lower_bound=True, suffix=' MB/s')
    csv_cycles_str = MarkdownStr("High")
    parquet_cycles_str = MarkdownStr("Low")
    proto_speed_str = fmt(proto_speed_mb, precision=0, commas=False, approx=True, suffix=' MB/s')
...
class DataAlgebra:
    ...
    join_network_tb_str = fmt(join_network_tb, precision=0, commas=False, approx=True, suffix=' TB')
```
