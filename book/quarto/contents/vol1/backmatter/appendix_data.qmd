...
Neural-network classifiers commonly output a vector of *logits*[^fn-logit] $\mathbf{z}$ (unnormalized scores). For class index $i$, softmax normalizes $z_i$ over all class indices $j$ to produce a probability:
