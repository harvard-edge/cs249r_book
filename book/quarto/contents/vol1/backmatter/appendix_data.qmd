...
# │ Exports: csv_speed_mb_s_str, parquet_speed_mb_s_str, csv_cycles_str,
# │          parquet_cycles_str, proto_speed_mb_s_str, proto_cycles_str
# └─────────────────────────────────────────────────────────────────────────────
...
class SerializationCost:
    ...
    csv_speed_mb_s_str = fmt_qty(csv_speed, MB/second, precision=0, commas=False, approx=True)
    parquet_speed_mb_s_str = fmt_qty(parquet_speed, MB/second, precision=0, commas=True, lower_bound=True)
    csv_cycles_str = MarkdownStr("High")
    parquet_cycles_str = MarkdownStr("Low")
    proto_speed_mb_s_str = fmt_qty(proto_speed, MB/second, precision=0, commas=False, approx=True)
