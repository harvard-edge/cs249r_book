...
class GPT2TrainingMem:
    ...
    act_small_gb_str = fmt(act_small_q.to(GB).magnitude, precision=1, commas=False)
    ...
    accel_class_gb_str = fmt_qty(accel_q, GiB, precision=0, commas=False, unit_label="GB")
