...
total_elements_str = f"{total_elements_value/1e9:.0f}"
dense_gb_str = f"{dense_gb_value:.0f}"
nonzeros_str = f"{nonzeros_value/1e6:.0f}"
sparse_mb_str = f"{sparse_mb_value:.0f}"
```
