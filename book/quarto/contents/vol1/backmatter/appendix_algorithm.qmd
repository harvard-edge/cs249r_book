...
Now that we know how numbers are stored, we must understand how they are manipulated. **Linear Algebra**, and specifically the General Matrix Multiply (GEMM), is the computational engine of Deep Learning.
...
This table provides a quantitative reference for the most common building blocks. Use these formulas for **Napkin Math** estimation of model size and compute requirements.
...
\begin{tikzpicture}[font=\small\usefont{T1}{phv}{m}{n}, scale=0.75]
  \tikzset{
    ...
    Active/.style={fill=BlueFill, draw=BlueLine, text=white, font=\small\bfseries},
    Ghost/.style={fill=BlueFill!20, draw=BlueLine!40, dashed, text=BlueLine!60, font=\scriptsize},
