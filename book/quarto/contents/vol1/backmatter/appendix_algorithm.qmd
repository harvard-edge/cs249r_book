...
::: {.callout-perspective title="Why this matters"}
When training fails---loss goes to NaN, gradients explode, or memory runs out---understanding what backpropagation actually does is essential for diagnosing the problem. This section gives you the mental model to reason about gradient flow and memory usage during training.
:::
