...
class GPT2TrainingMem:
    ...
    total_small_gb_str = fmt(total_small_gb, precision=1, commas=False, approx=True, suffix=' GB')
    batch_large_str = fmt(batch_large, precision=0, commas=False)
    act_large_gb_str = fmt(act_large_gb, precision=1, commas=False, approx=True, suffix=' GB')
