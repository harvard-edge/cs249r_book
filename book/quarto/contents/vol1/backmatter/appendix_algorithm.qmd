...
# │ Exports: GemmIntensityExample.*_str
...
$$
\text{Intensity} = \frac{O}{D_{\text{vol}}} = \frac{2n^3}{3n^2 \times `{python} GemmIntensityExample.bytes_fp16_value_str`} = \frac{n}{3} \text{ FLOP/byte}
$$
