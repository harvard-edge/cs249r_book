...
2. If the same model processes batch size thirty-two with sequence length 2048 and twenty-four layers of hidden dimension 1024, would you expect activations to be larger or smaller than the nonactivation memory? Why?
