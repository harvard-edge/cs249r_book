...
**How much energy does one GPT-3 training run cost?** An A100 draws 400 W at TDP. GPT-3 training used roughly $3.14 \times 10^{23}$ FLOPS across ~3,640 accelerator-days. At \$0.10/kWh: 3,640 accelerator-days$\times$ 24 h/day$\times$ 0.4 kW$\times$ \$0.10/kWh $\approx$ \$3,500 in electricity alone—a small fraction of the total cost, which is dominated by accelerator amortization.
