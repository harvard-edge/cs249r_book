...
## 3 {#sec-glossary-volume-foundations-3-86ab}
...
## A {#sec-glossary-volume-foundations--d281}
...
: A controlled experimental method for comparing two versions of a system or model by randomly dividing users into groups and measuring performance differences between the variants
  *Appears in: @sec-machine-learning-operations-mlops, @sec-ai-development-workflow*
...
: A mathematical function applied to the weighted sum of inputs in a neural network neuron to introduce nonlinearity, enabling the network to learn complex patterns beyond simple linear combinations.
  *Appears in: @sec-deep-learning-systems-foundations, @sec-dnn-architectures, @sec-ai-frameworks, @sec-ai-training*
...
: Iteratively selecting the most informative samples for labeling to maximize learning efficiency, achieving target performance with 50-90% less labeled data compared to random sampling strategies
  *Appears in: @sec-data-engineering-ml, @sec-introduction*
...
**ai triad**
: The three interdependent components of every machine learning system: Data (the fuel that powers learning), Algorithm (the blueprint that defines how patterns are captured), and Machine (the engine that executes computation). Like a rocket: without fuel, the engine sits idle; without a blueprint, the fuel burns aimlessly; without an engine, fuel and blueprints remain theoretical. Formalized as the DAM Taxonomy, a diagnostic framework where engineers ask "Where is the flow blocked? Check the DAM."
  *Appears in: @sec-introduction, @sec-ai-development-workflow, @sec-deep-learning-systems-foundations, @sec-conclusion*
...
: The field of computer science focused on creating systems that can perform tasks typically requiring human intelligence, such as perception, reasoning, learning, and decision-making.
  *Appears in: @sec-benchmarking-ai, @sec-conclusion, @sec-deep-learning-systems-foundations, @sec-introduction, @sec-ml-system-architecture*
...
: Automated Machine Learning that uses machine learning itself to automate model design decisions, including architecture search, hyperparameter optimization, and feature selection to create efficient models without manual intervention
  *Appears in: @sec-introduction, @sec-model-compression*
...
## B {#sec-glossary-volume-foundations-b-4adb}
...
: The process of using a trained machine learning model to make predictions or decisions on new, previously unseen data.
  *Appears in: @sec-benchmarking-ai, @sec-ml-system-architecture, @sec-machine-learning-operations-mlops*
...
: The technique of processing multiple data samples simultaneously to amortize computation and memory access costs, improving overall throughput in neural network training and inference
  *Appears in: @sec-benchmarking-ai, @sec-data-engineering-ml, @sec-ai-acceleration*
...
## C {#sec-glossary-volume-foundations-c-c3f3}
...
: A specialized neural network architecture designed for processing grid-like data such as images, using convolutional layers that apply filters to detect local features.
  *Appears in: @sec-benchmarking-ai, @sec-deep-learning-systems-foundations, @sec-dnn-architectures*
...
## D {#sec-glossary-volume-foundations--a665}

**dam taxonomy**
: A diagnostic framework formalizing the AI Triad (Data, Algorithm, Machine) for identifying bottlenecks in ML systems. The acronym DAM provides a memorable mnemonic: when performance stalls, engineers ask "Where is the flow blocked? Check the DAM." The framework embodies the insight that scale is the relentless pursuit of the moving bottleneck—fixing one constraint often shifts the limitation to another component.
  *Appears in: @sec-introduction, @sec-ai-development-workflow, @sec-deep-learning-systems-foundations, @sec-conclusion*
...
: A facility that houses computer systems and associated components such as telecommunications and storage systems, typically containing thousands of servers for cloud computing operations.
  *Appears in: @sec-ml-system-architecture*
...
: The process of collecting and importing raw data from various sources into a system where it can be stored, processed, and prepared for machine learning applications
  *Appears in: @sec-data-engineering-ml, @sec-ai-development-workflow*
...
: A distributed training strategy that splits the dataset across multiple devices while each device maintains a complete copy of the model, enabling parallel computation of gradients.
  *Appears in: @sec-benchmarking-ai, @sec-introduction, @sec-ai-frameworks, @sec-ai-training*
...
: A mathematical framework for quantifying and limiting the privacy loss when releasing statistical information about datasets, ensuring individual privacy while enabling useful data analysis
  *Appears in: @sec-conclusion, @sec-data-engineering-ml*
...
: A method of training machine learning models across multiple machines or devices to handle larger datasets and models that exceed single-device computational or memory capacity.
  *Appears in: @sec-benchmarking-ai, @sec-conclusion, @sec-ai-training*
...
## E {#sec-glossary-volume-foundations-e-3d64}
...
: A distributed computing paradigm that brings computation and data storage closer to the sources of data, reducing latency and bandwidth usage.
  *Appears in: @sec-conclusion, @sec-ai-acceleration, @sec-ml-system-architecture*
...
: One complete pass through the entire training dataset during neural network training, consisting of multiple batch iterations depending on dataset size and batch size.
  *Appears in: @sec-deep-learning-systems-foundations, @sec-ai-frameworks*
...
## F {#sec-glossary-volume-foundations-f-63a0}
...
: The process of manually designing and extracting relevant features from raw data to improve machine learning model performance, largely automated in deep learning systems.
  *Appears in: @sec-data-engineering-ml, @sec-deep-learning-systems-foundations*
...
: A machine learning approach that trains algorithms across decentralized edge devices or servers holding local data samples, without exchanging the raw data.
  *Appears in: @sec-conclusion, @sec-ai-frameworks, @sec-ml-system-architecture, @sec-ai-development-workflow*
...
: Floating Point Operations Per Second, a measure of computational throughput that quantifies the number of mathematical operations involving decimal numbers a system can perform.
  *Appears in: @sec-benchmarking-ai, @sec-deep-learning-systems-foundations, @sec-introduction, @sec-model-compression*
...
## G {#sec-glossary-volume-foundations-g-b7e1}
...
: Graphics Processing Unit, a specialized electronic circuit designed to rapidly manipulate and alter memory to accelerate the creation of images and parallel processing tasks.
  *Appears in: @sec-benchmarking-ai, @sec-ml-system-architecture*
...
: A specialized processor originally designed for rendering graphics that provides parallel processing capabilities essential for efficient neural network computation and training.
  *Appears in: @sec-deep-learning-systems-foundations, @sec-ai-training*
...
## H {#sec-glossary-volume-foundations-h-d67e}
...
: A configuration setting that controls the learning process but is not learned from data, such as learning rate, batch size, or network architecture choices.
  *Appears in: @sec-benchmarking-ai, @sec-deep-learning-systems-foundations, @sec-ai-frameworks*
...
## I {#sec-glossary-volume-foundations--80be}
...
: A massive visual database containing over 14 million labeled images across 20,000+ categories, created by Stanford's Fei-Fei Li starting in 2009, whose annual challenge became instrumental in driving breakthrough advances in computer vision
  *Appears in: @sec-benchmarking-ai, @sec-introduction, @sec-introduction*
...
## J {#sec-glossary-volume-foundations-j-293c}
...
## K {#sec-glossary-volume-foundations-k-b035}
...
: A model compression technique where a smaller "student" network learns to mimic the behavior of a larger "teacher" network by training on the teacher's soft output probabilities rather than just hard labels
  *Appears in: @sec-conclusion, @sec-introduction, @sec-model-compression*

## L {#sec-glossary-volume-foundations-l-355e}
...
: The time delay between a request for data and the delivery of that data, critical in real-time applications where immediate responses are required.
  *Appears in: @sec-benchmarking-ai, @sec-ai-acceleration, @sec-ml-system-architecture*
...
## M {#sec-glossary-volume-foundations--e093}
...
: A subset of artificial intelligence that enables systems to automatically improve performance on tasks through experience and data rather than explicit programming.
  *Appears in: @sec-benchmarking-ai, @sec-deep-learning-systems-foundations, @sec-introduction, @sec-ml-system-architecture*
...
: A training methodology that combines different numerical precisions (typically FP16 and FP32) to optimize memory usage and computational speed while maintaining training stability.
  *Appears in: @sec-benchmarking-ai, @sec-conclusion, @sec-model-compression, @sec-ai-training*
...
: Techniques used to reduce the size and computational requirements of machine learning models while preserving accuracy, enabling deployment on resource-constrained devices.
  *Appears in: @sec-conclusion, @sec-ml-system-architecture, @sec-machine-learning-operations-mlops, @sec-model-compression*
...
: The systematic refinement of machine learning models to enhance their efficiency while maintaining effectiveness, balancing trade-offs between accuracy, computational cost, memory usage, latency, and energy efficiency
  *Appears in: @sec-model-compression, @sec-ai-development-workflow*
...
: A distributed training strategy that splits a neural network model across multiple devices, with each device responsible for computing a portion of the network.
  *Appears in: @sec-benchmarking-ai, @sec-conclusion, @sec-introduction, @sec-ai-frameworks, @sec-ai-training*
...
## N {#sec-glossary-volume-foundations-n-1b3a}
...
## O {#sec-glossary-volume-foundations--c812}
...
## P {#sec-glossary-volume-foundations-p-163c}
...
: The fundamental building block of neural networks, consisting of weighted inputs, a bias term, and an activation function that produces a single output.
  *Appears in: @sec-deep-learning-systems-foundations, @sec-introduction*
...
**pruning**
: Removing unimportant neural network connections to reduce model size, with techniques achieving 9× compression on models like AlexNet without accuracy loss.
  *Appears in: @sec-introduction*
...
## Q {#sec-glossary-volume-foundations-q-437a}
...
: A model compression technique that reduces the precision of model parameters and activations from higher precision formats (like 32-bit floats) to lower precision (like 8-bit integers), significantly reducing memory usage and computational requirements
  *Appears in: @sec-conclusion, @sec-introduction, @sec-ai-frameworks, @sec-ai-acceleration*
...
## R {#sec-glossary-volume-foundations-r-5398}
...
## S {#sec-glossary-volume-foundations--fe0e}
...
: The ability of machine learning systems to handle increasing amounts of data, users, or computational demands without significant degradation in performance or user experience
  *Appears in: @sec-benchmarking-ai, @sec-ai-development-workflow*
...
: A variant of gradient descent that estimates gradients using individual training examples or small batches rather than the entire dataset, reducing memory requirements and enabling online learning.
  *Appears in: @sec-introduction, @sec-ai-training*
...
: An approach to understanding complex systems by considering how individual components interact and affect the whole system, particularly important in ML where data, algorithms, hardware, and deployment environments must work together effectively
  *Appears in: @sec-introduction, @sec-ai-development-workflow*
...
## T {#sec-glossary-volume-foundations--b566}
...
: A multi-dimensional array used to represent data in neural networks, generalizing scalars (0D), vectors (1D), and matrices (2D) to higher dimensions.
  *Appears in: @sec-benchmarking-ai, @sec-deep-learning-systems-foundations, @sec-ai-frameworks, @sec-ai-acceleration*
...
: Machine learning on microcontrollers and edge devices with less than 1KB-1MB memory and less than 1mW power consumption, enabling AI in IoT devices where traditional deployment is impossible
  *Appears in: @sec-conclusion, @sec-introduction*
...
: Tensor Processing Unit, Google's custom Application-Specific Integrated Circuits (ASICs) designed specifically for accelerating tensor operations in machine learning workloads, offering significant performance and energy efficiency improvements over general-purpose processors
  *Appears in: @sec-introduction, @sec-ai-frameworks*
...
: The process of adjusting neural network parameters using labeled data and optimization algorithms to minimize prediction errors and improve performance.
  *Appears in: @sec-benchmarking-ai, @sec-deep-learning-systems-foundations, @sec-ai-acceleration, @sec-ml-system-architecture*
...
: A machine learning technique that leverages knowledge gained from pre-trained models on related tasks, allowing faster training and better performance on new tasks with limited data by reusing learned features and representations
  *Appears in: @sec-conclusion, @sec-data-engineering-ml, @sec-introduction, @sec-ai-frameworks, @sec-ai-development-workflow*
...
## U {#sec-glossary-volume-foundations-u-f596}
...
## V {#sec-glossary-volume-foundations-v-726f}
...
## W {#sec-glossary-volume-foundations-w-6afc}
...
## X {#sec-glossary-volume-foundations-x-d552}
...
## About This Glossary {#sec-glossary-volume-foundations-glossary-ab0f}

This glossary was automatically generated from chapter glossaries in Volume I: Foundations. Each term is defined in the context of machine learning systems and includes references to help you explore related concepts.
