...
**gemm**
: General Matrix Multiply (GEMM) operations that follow the pattern \(C = \alpha AB + \beta C\), representing the fundamental computational kernel underlying most neural network operations including fully connected layers and convolutional layers.
