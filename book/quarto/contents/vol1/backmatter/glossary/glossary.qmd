...
: The phenomenon where increasing computing resources (e.g., doubling accelerators) results in sub-linear performance gains due to communication overhead and synchronization costs.
