...
+--------------------------+--------------------------------------------+--------------------------------------------------------------+
| **Little's Law**         | Size serving infrastructure for target QPS | @sec-model-serving-systems                                   |
+--------------------------+--------------------------------------------+--------------------------------------------------------------+
...
+--------------------------+--------------------------------------------+--------------------------------------------------------------+
| **GEMM Operations**      | Understand the core computation in         | @sec-deep-learning-systems-foundations, @sec-ai-acceleration |
|                          | neural networks                            |                                                              |
+--------------------------+--------------------------------------------+--------------------------------------------------------------+
...
## Performance Analysis Models {#sec-mathematical-foundations-performance-analysis-models-3abc}
...
### The Roofline Model {#sec-mathematical-foundations-roofline-model-32fb}
...
In the **memory-bound region** (the sloped portion), performance scales with bandwidth (@eq-memory-bound):

$$ \text{Attainable Performance} = \text{Bandwidth} \times \text{Arithmetic Intensity} $$ {#eq-memory-bound}

In the **compute-bound region** (the flat portion), you hit the hardware ceiling (@eq-compute-bound):
...
#### A Concrete Example {#sec-mathematical-foundations-concrete-example-b803}
...
### Amdahl's Law and Gustafson's Law {#sec-mathematical-foundations-amdahls-law-gustafsons-law-ce70}
...
**Amdahl's Law** [@amdahl1967validity] captures the fundamental limit of parallelization (@eq-amdahl). If a fraction $p$ of your workload can be parallelized, the maximum speedup with $n$ processors is:
...
This sounds pessimistic, but **Gustafson's Law** [@gustafson1988reevaluating] offers a more optimistic view for ML workloads (@eq-gustafson). In practice, when you get more hardware, you often train larger models or use larger batches rather than just trying to finish faster. Under this "weak scaling" model, speedup becomes:
...
### Little's Law {#sec-mathematical-foundations-littles-law-a361}

Shifting from training to serving, **Little's Law** [@little1961proof] is the essential tool for capacity planning (@eq-little). It relates the average number of items in a system ($L$), the arrival rate ($\lambda$), and the average wait time ($W$):
...
## Computer Architecture Essentials {#sec-mathematical-foundations-computer-architecture-essentials-59df}
...
### The Memory Hierarchy {#sec-mathematical-foundations-memory-hierarchy-a996}
...
### Bandwidth vs. Latency {#sec-mathematical-foundations-bandwidth-vs-latency-ccd9}
...
## Numerical Representations {#sec-mathematical-foundations-numerical-representations-5a20}
...
### Floating-Point Format Comparison {#sec-mathematical-foundations-floatingpoint-format-comparison-67c3}
...
### Integer Quantization {#sec-mathematical-foundations-integer-quantization-78a5}
...
## Linear Algebra for Neural Networks {#sec-mathematical-foundations-linear-algebra-neural-networks-2550}
...
### Tensor Operations and Notation {#sec-mathematical-foundations-tensor-operations-notation-0d7d}
...
### General Matrix Multiply (GEMM) {#sec-mathematical-foundations-general-matrix-multiply-gemm-c421}
...
### Memory Layouts and Performance {#sec-mathematical-foundations-memory-layouts-performance-76b7}
...
## Calculus for Backpropagation {#sec-mathematical-foundations-calculus-backpropagation-7555}
...
### The Chain Rule in Deep Networks {#sec-mathematical-foundations-chain-rule-deep-networks-cd3f}
...
### The Backpropagation Algorithm {#sec-mathematical-foundations-backpropagation-algorithm-9fc1}
...
### Automatic Differentiation {#sec-mathematical-foundations-automatic-differentiation-74a5}
...
## Sparse Matrix Formats {#sec-mathematical-foundations-sparse-matrix-formats-7bd3}
...
## Computational Graphs and Optimization {#sec-mathematical-foundations-computational-graphs-optimization-bade}
