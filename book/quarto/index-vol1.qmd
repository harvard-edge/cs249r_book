...
This volume is the reading spine for a broader AI engineering curriculum. Pair the chapters with [Co-Labs](https://mlsysbook.ai/labs/) to test predictions, [TinyTorch](https://mlsysbook.ai/tinytorch/) to build framework internals, [MLSys·im](https://mlsysbook.ai/mlsysim/) to model hardware constraints, and [Hardware Kits](https://mlsysbook.ai/kits/) to deploy on real devices. Instructors can adopt the full sequence through [The AI Engineering Blueprint](https://mlsysbook.ai/instructors/).
