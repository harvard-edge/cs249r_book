...
% Half-title hook. Per-volume preamble files (theme-colors-volX.tex or
% theme-colors-volX-copyedit.tex) may \renewcommand\halftitle to emit a
% half-title page that prints at the very start of the frontmatter, before
% the Quarto titlepage extension renders the title page proper. The default
% is empty so volumes that have no half-title still build cleanly.
