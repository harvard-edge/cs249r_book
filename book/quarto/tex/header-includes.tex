...
\newcommand{\mlsysstack}[8]{
    \begin{tikzpicture}
        % Stack layers with 0.75cm height and no gap (contiguous)
        % Layers are 2.8cm wide; data bar sits to the right with a gap
        
        % Layer 7: Applications
        \stacklayer{4.50}{Applications}{#7}{icon_applications}

        % Layer 6: Operations
        \stacklayer{3.75}{Operations}{#6}{icon_operations}

        % Layer 5: Serving
        \stacklayer{3.00}{Serving}{#5}{icon_serving}

        % Layer 4: Training
        \stacklayer{2.25}{Training}{#4}{icon_training}

        % Layer 3: Models
        \stacklayer{1.50}{Models}{#3}{icon_models}

        % Layer 2: Frameworks
        \stacklayer{0.75}{Frameworks}{#2}{icon_frameworks}
        ...
        \fill[\datacol, rounded corners=1.5pt]
            (2.95, -0.1) rectangle (3.25, 5.35);
        
        % Horizontal connectors from each layer into the data bar
        \foreach \ypos in {0.375, 1.125, 1.875, 2.625, 3.375, 4.125, 4.875} {
...
\newcommand{\mlsysstackfull}[8]{
    \begin{tikzpicture}
        % Stack layers with 0.85cm height and no gap (contiguous)
        
        % Layer 7: Applications
        \stacklayerfull{5.10}{Applications}{End-user products, responsible AI}{#7}{icon_applications}

        % Layer 6: Operations
        \stacklayerfull{4.25}{Operations}{MLOps, monitoring, CI/CD}{#6}{icon_operations}

        % Layer 5: Serving
        \stacklayerfull{3.40}{Serving}{Inference runtime, deployment}{#5}{icon_serving}

        % Layer 4: Training
        \stacklayerfull{2.55}{Training}{Training loops, distributed training}{#4}{icon_training}

        % Layer 3: Models
        \stacklayerfull{1.70}{Models}{Neural network architectures}{#3}{icon_models}

        % Layer 2: Frameworks
        \stacklayerfull{0.85}{Frameworks}{PyTorch, TensorFlow, compilers}{#2}{icon_frameworks}
        ...
        \fill[\datacol, rounded corners=2pt]
            (4.02, -0.15) rectangle (4.32, 6.10);
        
        % Horizontal connectors from each layer into the data bar
        \foreach \ypos in {0.425, 1.275, 2.125, 2.975, 3.825, 4.675, 5.525} {
