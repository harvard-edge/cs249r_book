...
\newcommand{\mlsysstack}[7]{
    \begin{tikzpicture}
        ...
        % Layer 6: Serving
        \stacklayer{3.0}{Serving}{#6}{icon_serving}

        % Layer 5: Training
        \stacklayer{2.4}{Training}{#5}{icon_training}

        % Layer 4: Architectures (Replaces Frameworks position, Frameworks moves down)
        \stacklayer{1.8}{Architectures}{#4}{icon_architectures}

        % Layer 3: Frameworks (Replaces Runtimes position)
        \stacklayer{1.2}{Frameworks}{#3}{icon_frameworks}

        % Layer 2: Accelerators
        \stacklayer{0.6}{Accelerators}{#2}{icon_accelerators}

        % Layer 1: Silicon
        \stacklayer{0.0}{Silicon}{#1}{icon_silicon}
