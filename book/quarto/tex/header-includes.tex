...
\long\def\mfx@mn@place#1{\ifinner\mfxOrigMarginnote{#1}\else
  \marginpar{\normalcolor#1}\fi}
\makeatother
...
\newcommand{\fleetstacklayermarginparts}[5]{%
    ...
    \node[anchor=west,text=\fleettext,
        ...
        at ($(fleetbox.west)+(0.52,0)$) {#2};
    \fill[\fleetfill] (2.98,#1+0.05) rectangle ++(0.14,0.70);
}
