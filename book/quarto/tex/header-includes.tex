...
\newcommand{\mlsysstack}[8]{
    \begin{tikzpicture}
        ...
        % Vertical data bar (gap visible but compact for margin fit)
        ...
        \foreach \ypos in {0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5} {
            \draw[\datacol, line width=1.2pt] (2.6, \ypos) -- (2.85, \ypos);
        }
...
\newcommand{\mlsysstackfull}[8]{
    \begin{tikzpicture}
        ...
        % Gap between layers and bar must be wide enough for connectors to be visible
        \ifnum#8=0
            \def\datacol{black!8}
            \def\datatextcol{black!25}
        \else
