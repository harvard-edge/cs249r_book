...
quiz-refresh pattern. The **spec** — what "good" looks like — lives at:
...
python3 book/tools/scripts/genai/quiz_refresh/generate_quizzes.py \
...
2. `book/tools/scripts/genai/quiz_refresh/_reviews/{chapter}_memo.md` —
...
`book/tools/scripts/genai/quiz_refresh/_legacy/quizzes_reference.py` is a
...
- Write a lean runner in `book/tools/scripts/genai/{artifact}/generate.py`.
