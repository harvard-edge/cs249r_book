...
chapter_lookup = [
    ...
    ("contents/vol1/responsible_ai/responsible_ai.qmd", "Responsible AI", 16),
    ("contents/vol1/sustainable_ai/sustainable_ai.qmd", "Sustainable AI", 17),
    ("contents/vol1/robust_ai/robust_ai.qmd", "Robust AI", 18),
    ("contents/vol1/ai_for_good/ai_for_good.qmd", "AI for Good", 19),
    ("contents/vol1/conclusion/conclusion.qmd", "Conclusion", 20),
