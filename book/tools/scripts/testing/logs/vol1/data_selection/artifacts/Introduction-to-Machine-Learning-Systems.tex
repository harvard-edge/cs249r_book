...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, breakable, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame, colback=white, leftrule=.75mm, titlerule=0mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, left=2mm, rightrule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Learning Objectives}, opacityback=0]
...
\begin{fbx}{callout-notebook}{AI Engineer’s Notebook:}{The Scaling Asymmetry}
...
\begin{fbx}{callout-definition}{Definition:}{Data Selection}
...
the decision boundary, reducing the \textbf{Total Operations} (\(Ops\))
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.4651}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5349}}@{}}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{``Fewer samples for same accuracy''} \textbf{``Better
generalization''} \textbf{``Sample complexity bounds''}
\textbf{``Learning theory''} & ``Fewer FLOPs for same accuracy'' ``Lower
training cost (time, money, energy)'' ``End-to-end resource efficiency''
``Cost engineering'' \\
\end{longtable}
...
\begin{fbx}{callout-perspective}{Systems Perspective:}{Data Selection and the Iron Law}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/c80110756f62699fb0674d5995fe1fd4adbedd68.pdf}}
...
\begin{fbx}{callout-checkpoint}{Checkpoint:}{Data Selection Efficiency}
...
\begin{fbx}{callout-example}{Example:}{Computing ICR: Coresets}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/34378514eeb16873697d2ff127732e0579d8a8ea.pdf}}
...
\begin{fbx}{callout-notebook}{AI Engineer’s Notebook:}{The Data Quality Multiplier}
...
\(N_{clean} \propto 1/\epsilon\) * \(N_{noisy} \propto 1/\epsilon^2\)

\textbf{Example}: For target error \(\epsilon = 0.01\) (1\%): *
\(N_{clean} \approx 100\) * \(N_{noisy} \approx 10,000\) *
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/802350abdc0e848a44779d8f805b19c9380f5998.pdf}}
...
\begin{fbx}{callout-lighthouse}{Lighthouse:}{DLRM and Embedding Deduplication}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/80b2152d8333f88e9ea68dac44047b0ec60951fc.pdf}}
...
\begin{fbx}{callout-notebook}{AI Engineer’s Notebook:}{The Active Learning ROI}
...
The following plot (Figure~\ref{fig-active-learning-multiplier})
quantifies this advantage, showing how Active Learning shifts the
learning curve to the left, achieving target accuracy with exponentially
fewer samples than random selection.
...
\begin{fbx}{callout-lighthouse}{Lighthouse:}{Mining for Hard Negatives}
...
\begin{fbx}{callout-example}{Example:}{FixMatch on CIFAR-10}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.3778}}@{}}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{50,000 (100\%)} \textbf{4,000 (8\%)} \textbf{250 (0.5\%)}
\textbf{40 (0.08\%)} & Fully Supervised FixMatch FixMatch FixMatch &
96.1\% 95.7\% 94.9\% 88.6\% & Baseline \textbf{12.5\(\times\) more
efficient} \textbf{200\(\times\) more efficient} 1250\(\times\) more
efficient \\
\end{longtable}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2935}}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Text} \textbf{Text} \textbf{Images} \textbf{Images}
\textbf{Multi-modal} & Masked language modeling Next-token prediction
Contrastive learning Masked autoencoding CLIP-style alignment & Predict
{[}MASK{]} from context Predict next word in sequence Same image
(augmented) vs.~different images Reconstruct masked patches Match
image-text pairs \\
\end{longtable}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2202}}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Train from scratch} \textbf{Fine-tune foundation model} &
100K--1M labeled 100--1K labeled & 100\% full training 1--5\% of full
training & Task-specific collection Reuse pre-training corpus \\
\end{longtable}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/7e14863984d2a779655716787dea954e0a405b52.pdf}}
...
\begin{fbx}{callout-lighthouse}{Lighthouse:}{MobileNet and Aggressive Augmentation}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/e127e5ab46e80ae384a97d7843c3069799c4bb93.pdf}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.4079}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5921}}@{}}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{100\% synthetic} \textbf{80\% synthetic + 20\% real}
\textbf{50\% synthetic + 50\% real} \textbf{100\% real} & Poor
real-world generalization Good performance, significant cost savings
Best performance in many domains Baseline (expensive) \\
\end{longtable}
...
\begin{fbx}{callout-example}{Example:}{KWS Data Selection}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/9963e6d52b6f692ce75fde8d6530195765054395.pdf}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.3034}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.6966}}@{}}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Active Learning} \textbf{Coreset Selection} \textbf{Curriculum
Learning} \textbf{Semi-Supervised} \textbf{Self-Supervised}
\textbf{Augmentation} \textbf{Synthetic Generation} & Access to oracle,
unlabeled pool, retraining infrastructure Proxy model or embedding
extractor, full dataset accessible Difficulty scoring method, pacing
schedule Some labeled data, unlabeled data from same distribution Large
unlabeled corpus, pre-training compute budget Domain knowledge of
invariances, augmentation library Generative model or simulator, domain
gap mitigation \\
\end{longtable}
...
\begin{fbx}{callout-example}{Example:}{Selection Inequality in Practice}
...
\begin{fbx}{callout-notebook}{AI Engineer’s Notebook:}{The Selection Inequality}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/ce60cba7baa95cfc806387c3b942afc79ceaefdb.pdf}}
...
This visualization captures a critical point: selection overhead can
negate the benefits of training on a smaller subset. Before examining
hardware-aware optimizations, verify your understanding of this
trade-off.

\phantomsection\label{callout-checkpointux2a-1.17}
\begin{fbx}{callout-checkpoint}{Checkpoint:}{The Selection Inequality}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{\(C_{\text{acquire}}\)} \textbf{\(C_{\text{label}}\)}
\textbf{\(C_{\text{store}}\)} \textbf{\(C_{\text{process}}\)} &
\(N \times c_{\text{sample}}\)
\(N_{\text{labeled}} \times c_{\text{label}}\)
\(S_{\text{bytes}} \times c_{\text{storage}} \times T\)
\(N \times E \times c_{\text{FLOP}}\) & \$0.001--\$10/sample (web scrape
vs.~licensed) \$0.10--\$100/sample (crowd vs.~expert)
\$0.02--\$0.10/GB/month Proportional to training FLOPs \\
\end{longtable}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.5076}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Raw data (1.2M images)} \textbf{Labels (1.2M × \$0.05)}
\textbf{Storage (150 GB × 12 months)} \textbf{Training (100 epochs × 8
A100s × 24 h)} \textbf{Total} \textbf{Data vs.~Compute ratio} & Licensed
dataset Crowd annotation Cloud storage GPU compute & \$50,000 \textbar{}
\$60,000 \textbar{} \$200 \textbar{} \$25,000 \textbar{}
\textbf{\$135,200} \textbar{} \textbf{82\% data, 18\% compute}
\textbar{} \\
\end{longtable}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.4054}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Component}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Build deduplication pipeline} \textbf{Compute MinHash signatures
(one-time)} \textbf{Per-run savings (20\% less data)} & \$50,000
(engineering time) \$5,000 \$10,000/run \\
\end{longtable}

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.2917}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.3889}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
...
\bottomrule\noalign{}
\endlastfoot
1 run 5 runs 10 runs 50 runs & -82\% (net loss) -9\% (near break-even)
+82\% (positive) +809\% (highly profitable) \\
\end{longtable}
...
\begin{fbx}{callout-perspective}{Systems Perspective:}{When to Invest in Data Selection}
...
The distributed training infrastructure that underlies these challenges
is covered in depth in \emph{Distributed Training Systems} (Volume II).
This section focuses specifically on how data selection techniques adapt
to distributed settings, and where they fail to do so.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Coreset Selection} \textbf{Active Learning} \textbf{Curriculum
Learning} \textbf{Deduplication} & Global view of dataset Centralized
uncertainty scoring Global difficulty ordering Hash table fits in memory
& Each worker sees only its shard Scoring requires model synchronization
Workers may have different ``hardest'' samples Distributed hash tables
add latency \\
\end{longtable}
...
\begin{fbx}{callout-example}{Example:}{Distributed Coreset Selection}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/7495b486dbe9376b88d996a377e2103d89201cb6.pdf}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2783}}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Large, sequential dataset} \textbf{Small, curated dataset}
\textbf{Dynamic selection} & Memory bandwidth Compute (GPU idle waiting
for data) Selection compute & Larger batch sizes, gradient accumulation
Faster data loaders, data echoing Proxy models, cached embeddings \\
\end{longtable}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/44637171763159b00e49fcb8a1c26e50e06f54eb.pdf}}

Optimizing early in the pipeline (data selection) has a
...
Model}\label{sec-data-selection-data-roofline-model-b400}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/8fdb417b1a6d493808b0444cd7a7e512a5d62b06.pdf}}
...
performance, so invest in data collection. Above the diagonal
(compute-bound), more data will not help without more training compute,
so invest in GPUs. The optimal operating point is at the knee where data
and compute are balanced. Data selection techniques move you along the
diagonal by extracting more value per sample.}
...
\item
  ...
  data quality, not compute. More FLOPs will not help. Invest in better
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/a4eafa454561381625d472d89f5c3c3a4dc4ffa0.pdf}}
...
\begin{fbx}{callout-lighthouse}{Lighthouse:}{Lighthouse Data Selection}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.1894}}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.6288}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Lighthouse}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\bottomrule\noalign{}
\endlastfoot
\textbf{ResNet-50} \textbf{GPT-2/Llama} \textbf{MobileNet} \textbf{DLRM}
\textbf{Keyword Spotting} & Compute Memory bandwidth Latency/Power
Memory capacity Extreme constraints & Coreset selection directly reduces
training FLOPs Deduplication reduces corpus size; curriculum learning
improves token efficiency Aggressive augmentation compensates for
reduced model capacity Interaction deduplication and embedding pruning
reduce table size Augmentation and synthesis create datasets from
minimal seeds \\
\end{longtable}
