...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colframe=quarto-callout-tip-color-frame, left=2mm, opacitybacktitle=0.6, rightrule=.15mm, toptitle=1mm, bottomrule=.15mm, titlerule=0mm, toprule=.15mm, arc=.35mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Learning Objectives}, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, breakable, leftrule=.75mm, coltitle=black]
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/291299e083695df3a5a073c7cba3a78c5a67ea7c.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/a2870a17c3bf5c5d863ccfefaae10edca5835bdc.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/59f23396dbf6861b76cdd58965382b10eea8e34d.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/5a5251ac2b8952f129dc9ba478ac082617580c9f.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/006f98775e81333fa58261acbdee7142b29e7751.pdf}}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Input requirement} \textbf{Control flow} \textbf{Conversion
ease} \textbf{Type annotations} \textbf{Error detection} \textbf{Best
for} & Example inputs needed Cannot handle data-dependent Simpler (just
run function) Not required Runtime (wrong results) Feed-forward models &
No inputs needed Supports data-dependent Harder (restricted Python)
Required when inference fails Compile time (syntax errors) Models with
conditionals \\
\end{longtable}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2482}}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3901}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1720}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2434}}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{ResNet-50} \textbf{(Compute Beast)} &
\(\frac{O}{R_{peak} \cdot \eta}\) (Compute) & \textbf{TensorRT}
(inference) \textbf{torch.compile} (training) & Kernel fusion maximizes
MFU; compute-bound workloads benefit most from optimization \\
\textbf{GPT-2} \textbf{(Bandwidth Hog)} & \(\frac{D_{vol}}{BW}\) (Memory
Bandwidth) & \textbf{torch.compile} & Kernel fusion reduces HBM
round-trips; keeps data in cache to mitigate bandwidth \\
\textbf{DLRM} \textbf{(Sparse Scatter)} & \(\frac{D_{vol}}{BW}\) (Random
Access) + \(T_{network}\) & \textbf{Eager} with specialized kernels
(FBGEMM) & Embedding lookups are inherently irregular and dynamic;
compilation gains are small \\
\textbf{DS-CNN} \textbf{(Tiny Constraint)} & \(L_{lat}\) (Overhead) &
\textbf{AOT compilation} (TFLite, ONNX) & Sub-ms inference; every
microsecond of Python overhead is unacceptable \\
\end{longtable}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/a1c85e5f6227ca847c2635a375d0888350fed8cd.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/56874d296d87e72cead644bda4ec24621b986f53.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/ad124e537ed0a722b1b126de17c76c29388e9907.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/84ce6bad9100125cb8877e92c12a2673ca676b3d.pdf}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2604}}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{PCIe 3.0 x16} \textbf{PCIe 4.0 x16} \textbf{NVLink 3.0}
\textbf{GPU Memory} & 16 GB/s 32 GB/s 600 GB/s bidirectional 2000 GB/s &
0.25 ms 0.125 ms 0.007 ms 0.002 ms & 10x slower than GPU compute 5x
slower than GPU compute Comparable to GPU compute Optimal \\
\end{longtable}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{SM Occupancy} \textbf{Memory Throughput} \textbf{Compute
Throughput} \textbf{Tensor Core Active} & Active warps / maximum warps
Achieved / peak bandwidth Achieved / peak FLOPS Time in Tensor Core ops
& Increase parallelism if low Optimize memory access patterns Reduce
memory bottlenecks Verify mixed-precision utilization \\
\end{longtable}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/f8121b525601155a39b4a701f961cf6fbb789556.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/d401bfa026058e8939d3475d9ce3f210dfc2cb87.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/8e8339609a467742921f4bcc36732df58677ad15.pdf}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1288}}
...
\textbf{Microcontroller} \textbf{(TinyML)} & TF Lite Micro, uTensor &
4-bit quantization, static allocation & \textless256KB RAM, no dynamic
memory \\
\end{longtable}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1603}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2079}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2673}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Component}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
