...
consistency). \emph{No amount of compute (\(Ops\)) can overcome a low
statistical ceiling.}
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colframe=quarto-callout-caution-color-frame, breakable, left=2mm, colbacktitle=quarto-callout-caution-color!10!white, rightrule=.15mm, leftrule=.75mm, bottomtitle=1mm, titlerule=0mm, coltitle=black, colback=white, arc=.35mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Data-Centric Computing vs.~Data-Centric AI}, bottomrule=.15mm]
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3238}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Operation}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{32-bit Floating Point Add} &
\multicolumn{2}{>{\raggedleft\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.6381} + 2\tabcolsep}@{}}{%
3.7 pJ \textbar{} 1× \textbar{}} \\
\textbf{DRAM Memory Access (32-bit)} &
\multicolumn{2}{>{\raggedleft\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.6381} + 2\tabcolsep}@{}}{%
\textbf{640 pJ} \textbar{} \textbf{172×} \textbar{}} \\
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/39e028258cde4fece64c600b736a07fdcdb43da1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/1cd9e21ff5732d60ca95564d98b0bff61d6dae73.pdf}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.1705}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.1786}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/d1ec0ac7bc0fb5fa0c15ae93192cff00f7f61a5a.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/f10486a30642797f339a6b3eb640e215fd2f571b.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/1155bd9be917958c5c96299d2d678f34372e6fa7.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/84f46bff70c287434afb6841fee45e11c1641f89.pdf}}
...
\emph{the cost of transformation placement}.
...
\NormalTok{etl\_spark\_str }\OperatorTok{=} \SpecialStringTok{f"}\SpecialCharTok{\{}\NormalTok{etl\_spark\_daily}\SpecialCharTok{\}}\SpecialStringTok{"}
\NormalTok{etl\_storage\_str }\OperatorTok{=} \SpecialStringTok{f"}\SpecialCharTok{\{}\NormalTok{etl\_storage\_mo}\SpecialCharTok{\}}\SpecialStringTok{"}
\NormalTok{elt\_storage\_tb\_str }\OperatorTok{=} \SpecialStringTok{f"}\SpecialCharTok{\{}\NormalTok{elt\_storage\_tb}\SpecialCharTok{\}}\SpecialStringTok{"}
\NormalTok{elt\_storage\_str }\OperatorTok{=} \SpecialStringTok{f"}\SpecialCharTok{\{}\NormalTok{elt\_storage\_mo}\SpecialCharTok{:,\}}\SpecialStringTok{"}
\NormalTok{elt\_query\_str }\OperatorTok{=} \SpecialStringTok{f"}\SpecialCharTok{\{}\NormalTok{elt\_query\_mo}\SpecialCharTok{\}}\SpecialStringTok{"}
\NormalTok{savings\_str }\OperatorTok{=} \SpecialStringTok{f"}\SpecialCharTok{\{}\NormalTok{storage\_savings\_mo}\SpecialCharTok{:,\}}\SpecialStringTok{"}
\end{Highlighting}
\end{Shaded}
...
\item
  ...
  \tightlist
  \item
    Storage: 10 TB raw/day, 30-day retention = 300 TB at \$23/TB/month =
    \$6,900/month
  \item
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/47cfc3076699d32a5e78ae511c0af75ae2d7c59c.pdf}}
...
\endlastfoot
\textbf{Acquire} &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.7671} + 2\tabcolsep}@{}}{%
\$50K \textbar{} 21\% \textbar{}} \\
\textbf{Label} &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.7671} + 2\tabcolsep}@{}}{%
\$138K \textbar{} \textbf{59\%} \textbar{}} \\
\textbf{Store} &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.7671} + 2\tabcolsep}@{}}{%
\$15K \textbar{} 6\% \textbar{}} \\
\textbf{Process} &
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/ce041fdc5a4c986ac0b73f7de02e62dbb8f831ed.pdf}}
...
& \textless{} 70\% \\
\textbf{Schema} & Schema version branches &
...
\end{quote}
\end{minipage} \\
\textbf{Schema} & \% transformations with try/catch &
\begin{minipage}[t]{\linewidth}\raggedleft
\begin{quote}
20\%
\end{quote}
...
\end{quote}
\end{minipage} \\
\textbf{Quality} & Known label error rate &
\begin{minipage}[t]{\linewidth}\raggedleft
\begin{quote}
1\%
\end{quote}
...
not mitigated \\
\textbf{Freshness} & Days since last retraining &
\begin{minipage}[t]{\linewidth}\raggedleft
\begin{quote}
90 days
\end{quote}
...
\end{quote}
\end{minipage} \\
\textbf{Freshness} & PSI vs training baseline &
\begin{minipage}[t]{\linewidth}\raggedleft
\begin{quote}
0.1
\end{quote}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/4394111fc6e994a74e0ae37cc6035d88e8c1e3be.pdf}}
...
Symposium on Principles of Distributed Computing}, 7.
