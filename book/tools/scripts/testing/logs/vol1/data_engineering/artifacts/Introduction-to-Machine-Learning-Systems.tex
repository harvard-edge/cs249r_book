...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, titlerule=0mm, arc=.35mm, opacityback=0, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Learning Objectives}, leftrule=.75mm, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, breakable, left=2mm, colframe=quarto-callout-tip-color-frame, coltitle=black, toptitle=1mm, bottomrule=.15mm, toprule=.15mm, bottomtitle=1mm]
...
\begin{fbxSimple}{callout-definition}{Definition:}{Data Engineering}
...
\begin{fbxSimple}{callout-perspective}{Systems Perspective:}{The Statistical Ceiling}
...
\begin{fbxSimple}{callout-notebook}{AI Engineer’s Notebook:}{The Deduplication Dividend}
...
\begin{fbxSimple}{callout-definition}{Definition:}{Model-Centric AI}
...
\begin{fbxSimple}{callout-definition}{Definition:}{Data-Centric AI}
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, titlerule=0mm, arc=.35mm, opacityback=0, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Data-Centric Computing vs.~Data-Centric AI}, leftrule=.75mm, rightrule=.15mm, colbacktitle=quarto-callout-caution-color!10!white, colback=white, breakable, left=2mm, colframe=quarto-callout-caution-color-frame, coltitle=black, toptitle=1mm, bottomrule=.15mm, toprule=.15mm, bottomtitle=1mm]
...
\begin{fbxSimple}{callout-perspective}{Systems Perspective:}{The Energy-Movement Invariant}
...
\begin{fbxSimple}{callout-notebook}{AI Engineer’s Notebook:}{The Physics of Data Gravity}
...
\item
  \textbf{Transfer Time}: 1,000,000 GB / 12.5 GB/s = 80,000 seconds ≈
  \textbf{22 hours}.
\item
...
\begin{fbxSimple}{callout-checkpoint}{Checkpoint:}{The Physics of Data}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/a2130a19e27be595e6f6796de9a47cd3964b52d6.pdf}}
...
\begin{fbxSimple}{callout-example}{Example:}{The Pipeline Jungle}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/a28eb8fa45aedf2cc08633157306b1a20b32a740.pdf}}
...
\begin{fbxSimple}{callout-perspective}{Systems Perspective:}{Key Data Engineering Numbers}
...
\textbf{S3 retrieval (Glacier)} & \$0.01/GB & Standard: 3-5 hours \\
...
S3 Glacier offers multiple retrieval tiers: Standard (\$0.01/GB, 3-5
hours), Expedited (\$0.03/GB, 1-5 minutes), and Bulk (free, 5-12 hours).
Glacier Deep Archive has longer retrieval times.
...
lighthouse example. With approximately 200K parameters and an 800 KB
...
\begin{fbxSimple}{callout-notebook}{AI Engineer’s Notebook:}{False Positive Targets}
...
\item
  \textbf{Windows per Month}: \(60 \times 60 \times 24 \times 30\) =
  2,592,000 windows.
\end{itemize}
...
\tightlist
\item
  \textbf{False Positive Rate (FPR)}: \(\frac{1}{\text{windows}}\) ≈
  3.9e-07
\item
...
100ms & \$0 vs \$0.001/query & 16 KB vs unlimited \\
...
\begin{fbxSimple}{callout-example}{Example:}{Optimizing the KWS Design Space}
...
\item
  \textbf{Memory}: 64 KB model size limit (always-on island)
\item
...
From Table~\ref{tbl-kws-design-space}, the 64 KB memory limit
eliminates:
...
spend (under budget), 48 KB model (under limit).
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/a03a830eff47d53c2431d399de81e0eaa35d5121.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/25c463510345bb43c951045ee1bb1af3c79b912e.pdf}}
...
storage, and ML training.

\begin{figure}[htb]

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/d7866db602cbb2bccbce2d995e86f7e2e4c74c5e.pdf}}
...
Each layer plays a specific role in the data preparation workflow.
Selecting appropriate technologies requires understanding how our four
framework pillars manifest at each stage. Quality requirements at one
stage affect scalability constraints at another, reliability needs shape
governance implementations, and the pillars interact to determine
...
\begin{fbxSimple}{callout-example}{Example:}{Detecting Drift with K-S Test}
...
\begin{fbxSimple}{callout-perspective}{Systems Perspective:}{Mechanical vs. Semantic Quality}
...
\begin{fbxSimple}{callout-notebook}{AI Engineer’s Notebook:}{The Physics of Data Locality}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{32-bit Integer Add} & 0.1 pJ & 1× \\
\textbf{32-bit Float Add} & 0.9 pJ & 9× \\
\textbf{32-bit DRAM Read} & 640 pJ & \textbf{6,400×} \\
...
Figure~\ref{fig-dataloader-choke-point} visualizes this
\textbf{Dataloader Choke Point}, showing the ``Starvation Region'' where
the CPU limits performance.
...
\begin{fbxSimple}{callout-notebook}{AI Engineer’s Notebook:}{The Cost of Real-Time}
\phantomsection\label{callout-notebook*-1.18}
\textbf{Problem}: Ingest 1M events/second. Compare Batch (hourly)
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/7ad46d70199435488c3ec3f5a1e2aab231634e5e.pdf}}
...
\begin{fbxSimple}{callout-notebook}{AI Engineer’s Notebook:}{The Cost of Transformation Placement}
\phantomsection\label{callout-notebook*-1.19}
\textbf{Problem}: Your team processes 10 TB of raw clickstream data
daily. You need to compute user session features for 3 ML models, each
...
\begin{fbxSimple}{callout-definition}{Definition:}{The Consistency Imperative}
...
\begin{fbxSimple}{callout-checkpoint}{Checkpoint:}{Defensive Processing}
...
\begin{fbxSimple}{callout-notebook}{AI Engineer’s Notebook:}{The Coordination Tax}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/45d4bb1f32e928ff7e866946bb847d7b1c4eaeac.pdf}}
...
\begin{fbxSimple}{callout-notebook}{AI Engineer’s Notebook:}{Amdahl's Law for Data Pipelines}
\phantomsection\label{notebook-amdahl-pipelines}
...
\begin{fbxSimple}{callout-perspective}{Systems Perspective:}{The Total Cost of Data Ownership (TCDO)}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/9312f8544efc03152992efa252d50bb1a9a9f9f7.pdf}}
...
\begin{fbxSimple}{callout-notebook}{AI Engineer’s Notebook:}{The Active Learning Multiplier}
...
compared to 7,360 seconds at typical object storage speeds. This 50×
difference determines whether teams can iterate multiple times daily or
must wait hours between experiments.
...
These latency numbers originated from Jeff Dean,\sidenote{\textbf{Jeff
Dean}: Google Senior Fellow and co-founder of Google Brain. He is the
systems architect behind many of the technologies that define modern
distributed computing, including MapReduce, BigTable, Spanner, and
TensorFlow. His focus on ``systems that scale'' and ``numbers everyone
should know'' established the quantitative engineering culture that
allowed ML to transition from academic research to planetary-scale
deployment. } and understanding them is foundational to ML systems
engineering.
...
approximately 2,916-fold in eight years (60M to 175B parameters).
...
\begin{fbxSimple}{callout-notebook}{AI Engineer’s Notebook:}{Storage Bandwidth Budget}
...
\begin{fbxSimple}{callout-notebook}{AI Engineer’s Notebook:}{Format Efficiency}
...
\item
  ...
  \tightlist
  \item
    \(\eta_{format}\) ≈ 1.0 (ignoring metadata overhead).
  \item
    \textbf{Result}: You get \textbf{5× higher effective throughput}.
  \end{itemize}
\end{itemize}
...
\begin{fbxSimple}{callout-definition}{Definition:}{Feature Store}
...
\begin{fbxSimple}{callout-definition}{Definition:}{Data Debt}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/f03b7f268e2be8cc99dc7b3203d0dd5eca1e8b88.pdf}}
...
\emph{Proceedings of the 2nd SysML
Conference}.\href{\%0A\%20\%20\%20\%20https://proceedings.mlsys.org/paper/_files/paper/2019/hash/928f1160e52192e3e0017fb63ab65391-Abstract.html\%0A\%20\%20}{https://proceedings.mlsys.org/paper\textbackslash\_files/paper/2019/hash/928f1160e52192e3e0017fb63ab65391-Abstract.html
}.
...
Smith, Benjamin. 2025. {``CRAN: Contributed Packages.''} The R
Foundation. \url{https://doi.org/10.32614/cran.package.rkaggle}.
...
Thyagarajan, Aditya, Elı́as Snorrason, Curtis G. Northcutt, and Jonas
