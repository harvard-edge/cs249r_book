...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colback=white, leftrule=.75mm, bottomtitle=1mm, rightrule=.15mm, opacityback=0, colframe=quarto-callout-tip-color-frame, toptitle=1mm, left=2mm, toprule=.15mm, titlerule=0mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Learning Objectives}, bottomrule=.15mm, coltitle=black]
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/fa4b60be3905fd73ce69a9d07b2c51813e4738e3.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/128ae87eb5392ca1aafa8def58a465058c281e38.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/616df994586d104d5ea1c4d6c0f0d9c55db1f33f.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/8c460d882a7c98bf17c82c80cc4727db73eceada.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/670c4e74eb702588d3f799026f02cf1e170a2299.pdf}}
...
\item
  FLOPs:
  \(3 \times 32 \times 512 \times 768 \times 768 = `{python} qkv_flops_b_str`\)
  billion FLOPs
\item
  Bytes: (input + weights + output)
  \(= (32 \times 512 \times 768 + 3 \times 768 \times 768 + 32 \times 512 \times 768 \times 3) \times 2 \approx `{python} qkv_mb_str`\)
  MB
\item
  AI
  \(= `{python} qkv_flops_b_str`\text{B} / `{python} qkv_mb_str`\text{M} = `{python} qkv_ai_str`\)
...
\item
  FLOPs:
  \(32 \times 12 \times 512 \times 512 \times 3 \approx `{python} softmax_flops_m_str`\text{M}\)
  FLOPs (exp, sum, div)
\item
  Bytes:
  \(32 \times 12 \times 512 \times 512 \times 2 \times 2 = `{python} softmax_mb_str`\)
  MB
\item
  AI
  \(= `{python} softmax_flops_m_str`\text{M} / `{python} softmax_mb_str`\text{M} = `{python} softmax_ai_str`\)
  FLOP/byte, which is \textbf{memory-bound}
\end{itemize}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/83763a899dc4a7b6a9b2c1ad61033c7d8e9f01f0.pdf}}
