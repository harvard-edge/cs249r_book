...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, left=2mm, arc=.35mm, titlerule=0mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white, breakable, bottomtitle=1mm, bottomrule=.15mm, colback=white, leftrule=.75mm, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Learning Objectives}, toprule=.15mm, coltitle=black, opacityback=0]
...
The Introduction posed a foundational question: \emph{why} does building
machine learning systems require engineering principles fundamentally
different from those governing traditional software? Every chapter since
has answered a piece of that question, and the answer is deeper than any
single component could reveal.

This book began with a simple mathematical formula: the \textbf{Iron Law
of ML Systems} (\textbf{?@sec-silicon-contract}). At the time, the terms
\textbf{Data Movement}, \textbf{Compute}, and \textbf{Overhead} may have
seemed abstract. Today, they are \emph{your} primary engineering levers.
You have mastered the quantitative analysis of systems that seemed
opaque at the start. You now understand that building intelligence is
not just about writing algorithms; it is about honoring the
\textbf{Silicon Contract}, the \emph{physical and economic agreement}
...
\begin{fbxSimple}{callout-checkpoint}{Checkpoint:}{Systems Thinking}
...
This insight has guided our exploration throughout this book. You now
...
Throughout this book, five Lighthouse Models have served as our systems
detectives, revealing how different workloads expose different
bottlenecks:
...
Throughout this book, each Part introduced quantitative principles that
govern ML system behavior. These are not rules of thumb or best
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.0250}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1350}}
...
Lighthouse models and to each other.
...
NPU constraints. Each Lighthouse model represents a different bet under
the Silicon Contract, and \textbf{?@sec-ai-training} showed that
...
Figure~\ref{fig-invariants-cycle} visualizes the perpetual flow of
engineering complexity. Decisions in the \textbf{Build} phase (governed
by the \emph{Iron Law}) constrain the \textbf{Optimize} phase (bounded
by \emph{Arithmetic Intensity}). Operational realities like \emph{Drift}
and \emph{Skew} force feedback into the \textbf{Foundations}, requiring
new data to stabilize the system. The engineer's role is to manage this
flow, ensuring that complexity lands where it can be handled most
efficiently.
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/646d5a39d1b1506eee8220aebf0899ec1319db85.pdf}}

}

\caption{\label{fig-invariants-cycle}\textbf{The Cycle of ML Systems
(The 12 Invariants)}: The complete systems engineering lifecycle. The
meta-principle of \emph{Conservation of Complexity} (center) unifies the
process: complexity is neither created nor destroyed, only shifted
between Data, Model, Hardware, and Operations. Each transition is
governed by specific quantitative invariants that constrain valid
...
Throughout this book, you have seen these twelve invariants manifest
across three areas that connect the Lighthouse models to real
engineering decisions.
...
\begin{fbxSimple}{callout-definition}{Definition:}{Artificial General Intelligence (AGI)}
...
\begin{fbxSimple}{callout-definition}{Definition:}{Compound AI Systems}
...
\begin{fbxSimple}{callout-perspective}{Systems Perspective:}{A New Golden Age}
...
twelve invariants you have learned in this book, from the \textbf{Iron
...
throughout this book will remain essential. The final sections examine
