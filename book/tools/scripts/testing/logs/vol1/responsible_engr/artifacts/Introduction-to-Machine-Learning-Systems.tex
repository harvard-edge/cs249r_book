...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, opacityback=0, bottomrule=.15mm, coltitle=black, breakable, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Learning Objectives}, leftrule=.75mm, bottomtitle=1mm, opacitybacktitle=0.6, titlerule=0mm, arc=.35mm, left=2mm, colback=white, colbacktitle=quarto-callout-tip-color!10!white]
...
\begin{fbx}{callout-example}{Example:}{The COMPAS Recidivism Algorithm Audit}
...
\begin{fbx}{callout-checkpoint}{Checkpoint:}{Responsible Design}
...
\begin{fbx}{callout-notebook}{AI Engineer’s Notebook:}{The Alignment Gap}
...
\begin{fbx}{callout-perspective}{Systems Perspective:}{The DAM Taxonomy}
...
\toprule\noalign{}
\textbf{Demographic Group} & \textbf{Error Rate (\%)} & \textbf{Relative
Disparity} \\
\midrule\noalign{}
\endfirsthead
\toprule\noalign{}
...
\begin{fbx}{callout-notebook}{AI Engineer’s Notebook:}{The Statistics of Representation}
...
fairness is physically impossible at scale. You effectively need
100\(\times\) more data to validate the minority group than the majority
group. Fairness requires \textbf{intentional data engineering}, not just
more data.
...
\begin{fbx}{callout-lighthouse}{Lighthouse:}{Fairness Concerns by Archetype}
...
\NormalTok{    tp, fp, tn, fn }\OperatorTok{=}\NormalTok{ (confusion\_matrix[k] }\ControlFlowTok{for}\NormalTok{ k }\KeywordTok{in}\NormalTok{ [}\StringTok{"TP"}\NormalTok{, }\StringTok{"FP"}\NormalTok{, }\StringTok{"TN"}\NormalTok{, }\StringTok{"FN"}\NormalTok{])}
\NormalTok{    total }\OperatorTok{=}\NormalTok{ tp }\OperatorTok{+}\NormalTok{ fp }\OperatorTok{+}\NormalTok{ tn }\OperatorTok{+}\NormalTok{ fn}
    \ControlFlowTok{return}\NormalTok{ \{}
        \StringTok{"approval\_rate"}\NormalTok{: (tp }\OperatorTok{+}\NormalTok{ fp) }\OperatorTok{/}\NormalTok{ total,         }\CommentTok{\# Demographic parity}
        \StringTok{"tpr"}\NormalTok{: tp }\OperatorTok{/}\NormalTok{ (tp }\OperatorTok{+}\NormalTok{ fn) }\ControlFlowTok{if}\NormalTok{ (tp }\OperatorTok{+}\NormalTok{ fn) }\ControlFlowTok{else} \DecValTok{0}\NormalTok{,  }\CommentTok{\# Equal opportunity}
        \StringTok{"fpr"}\NormalTok{: fp }\OperatorTok{/}\NormalTok{ (fp }\OperatorTok{+}\NormalTok{ tn) }\ControlFlowTok{if}\NormalTok{ (fp }\OperatorTok{+}\NormalTok{ tn) }\ControlFlowTok{else} \DecValTok{0}\NormalTok{,  }\CommentTok{\# Equalized odds (with TPR)}
\NormalTok{    \}}
...
\NormalTok{    disparity }\OperatorTok{=} \BuiltInTok{abs}\NormalTok{(metrics\_a[metric] }\OperatorTok{{-}}\NormalTok{ metrics\_b[metric])}
    \ControlFlowTok{if}\NormalTok{ disparity }\OperatorTok{\textgreater{}}\NormalTok{ FAIRNESS\_THRESHOLD:  }\CommentTok{\# e.g., 0.05 for high{-}stakes}
...
\toprule\noalign{}
\textbf{Metric} & \textbf{Group A} & \textbf{Group B} &
\textbf{Disparity} \\
\midrule\noalign{}
\endfirsthead
\toprule\noalign{}
...
\begin{fbx}{callout-notebook}{AI Engineer’s Notebook:}{The Price of Fairness}
...
\begin{fbx}{callout-checkpoint}{Checkpoint:}{Ethical Deployment}
...
\toprule\noalign{}
\textbf{Cost Component} & \textbf{Annual Estimate} & \textbf{3-Year
Total} \\
\midrule\noalign{}
\endfirsthead
\toprule\noalign{}
...
and operations \$510K (24\%). The 40:1 ratio between inference and
...
\toprule\noalign{}
\textbf{Category} & \textbf{3-Year Cost} & \textbf{Percentage} &
\textbf{Carbon Impact} \\
\midrule\noalign{}
\endfirsthead
\toprule\noalign{}
...
\textbf{Inference} & \$1.52M & 73\% & 97.4 tons \\
...
\begin{fbx}{callout-notebook}{AI Engineer’s Notebook:}{The Carbon Cost of Scale}
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, opacityback=0, bottomrule=.15mm, coltitle=black, breakable, toptitle=1mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Compliance as Engineering Need}, leftrule=.75mm, bottomtitle=1mm, opacitybacktitle=0.6, titlerule=0mm, arc=.35mm, left=2mm, colback=white, colbacktitle=quarto-callout-warning-color!10!white]
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/91099f8c068232de6db6816a2e37bf2bf862d994.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/e8f8c35c2fe999276a6f4f23e7139726cb3d2e02.pdf}}
...
Bird, Sarah, Miro Dudík, Richard Edgar, Brandon Horn, Roman Lutz,
