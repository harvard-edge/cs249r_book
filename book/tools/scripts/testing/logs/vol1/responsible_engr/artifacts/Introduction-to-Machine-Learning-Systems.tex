...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, opacitybacktitle=0.6, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, colback=white, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm, breakable, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Learning Objectives}, coltitle=black, toprule=.15mm, arc=.35mm, leftrule=.75mm, opacityback=0]
...
\bottomrule\noalign{}
\endlastfoot
\textbf{ResNet-50} \textbf{(Compute Beast)} & Training data bias
...
\textbf{GPT-2} \textbf{(Bandwidth Hog)} & Corpus bias
(overrepresentation of majority viewpoints in web text) &
\textbf{Toxicity rate} by demographic prompt context; \textbf{stereotype
score} & LLMs produce more toxic completions for prompts mentioning
minority groups \\
\textbf{DLRM} \textbf{(Sparse Scatter)} & Feedback loop amplification
(popular items get more data) & \textbf{Exposure fairness} across item
...
creators \\
\textbf{DS-CNN} \textbf{(Tiny Constraint)} & Deployment context mismatch
(trained on clean audio, deployed in noisy real-world environments) &
...
kg \\
\textbf{Subtotal per training cycle} & &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.4426} + 2\tabcolsep}@{}}{%
\textbf{\$3,200} \textbar{} \textbf{128 kg} \textbar{}} \\
\textbf{Retraining frequency} & cycles/year × years & 4/year × 3 years =
12 & 12 \\
\textbf{Total training cost} & subtotal x cycles &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.4426} + 2\tabcolsep}@{}}{%
\textbf{\$38,400} \textbar{} \textbf{1,536 kg} \textbar{}} \\
\end{longtable}
...
\$507K & 32,470 kg \\
\textbf{3-year inference cost} & annual x 3 &
\multicolumn{2}{>{\raggedleft\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.4904} + 2\tabcolsep}@{}}{%
\textbf{\$1.52M} \textbar{} \textbf{97,410 kg} \textbar{}} \\
\end{longtable}
...
\textbf{Total operational} & & \textbf{\$510K} \textbar{} \\
\end{longtable}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2925}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1887}}@{}}
...
\endlastfoot
\textbf{Training} &
\multicolumn{3}{>{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.8208} + 4\tabcolsep}@{}}{%
\$38K \textbar{} 2\% \textbar{} 1.5 tons \textbar{}} \\
\textbf{Inference} &
\multicolumn{3}{>{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.8208} + 4\tabcolsep}@{}}{%
\$1.52M \textbar{} 73\% \textbar{} 97.4 tons \textbar{}} \\
\textbf{Operations} &
\multicolumn{3}{>{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.8208} + 4\tabcolsep}@{}}{%
\$510K \textbar{} 25\% \textbar{} - \textbar{}} \\
\textbf{Total TCO} &
\multicolumn{3}{>{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.8208} + 4\tabcolsep}@{}}{%
\textbf{\$2.07M} \textbar{} 100\% \textbar{} \textbf{\textasciitilde99
tons} \textbar{}} \\
\end{longtable}
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, opacitybacktitle=0.6, bottomrule=.15mm, colframe=quarto-callout-warning-color-frame, colback=white, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm, breakable, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Compliance as Engineering Need}, coltitle=black, toprule=.15mm, arc=.35mm, leftrule=.75mm, opacityback=0]
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/cd422a2144556f9ad429f9a006105027e9e784af.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/d8698fe849984a689ca71255e4d6b79f76859e20.pdf}}
