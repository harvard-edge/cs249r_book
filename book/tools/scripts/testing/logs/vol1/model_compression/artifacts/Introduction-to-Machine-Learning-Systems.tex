...
model consumes over 300 GB in FP16 representation alone, yet a
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/8a7960bf3554ab019cebcf6e9b8acd367f8cf59b.pdf}}
...
\begin{fbx}{callout-notebook}{AI Engineer’s Notebook:}{The Physics of Quantization}
...
\textbf{Operation} \textbar{} \textbf{Bit-Width} \textbar{}
\textbf{Relative Energy} \textbar{}

+:==================+==============:+====================:+

\textbf{Integer Add} \textbar{} 8-bit \textbar{} 1x \textbar{}

+-------------------+---------------+---------------------+

\textbf{Float Add} \textbar{} 32-bit \textbar{} 30x \textbar{}

+-------------------+---------------+---------------------+

\textbf{Memory Access} \textbar{} 64-bit \textbar{} \textbf{40,000x}
\textbar{}
...
The following plot (Figure~\ref{fig-quantization-free-lunch}) visualizes
this robustness, showing the ``Free Lunch'' where reducing precision has
minimal impact on accuracy---until you hit the ``Cliff.''
...
\begin{fbx}{callout-notebook}{AI Engineer’s Notebook:}{The Quantization Speedup}
...
\begin{fbx}{callout-example}{Example:}{The 4x MobileNet Win}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1730}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1568}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1622}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1784}}@{}}
...
\end{minipage} &
\multicolumn{3}{>{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.4973} + 4\tabcolsep}@{}}{%
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Cloud} \textbar{} \textbf{Mobile} \textbar{} \textbf{TinyML}
\textbf{(\textasciitilde100 GiB)} \textbar{} \textbf{(\textasciitilde8
GiB)} \textbar{} \textbf{(\textasciitilde512 KiB)} \textbar{}
\end{minipage}} \\
\midrule\noalign{}
\endfirsthead
\toprule\noalign{}
...
\endlastfoot
\textbf{DLRM} &
\multicolumn{5}{>{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.8432} + 8\tabcolsep}@{}}{%
100 GiB \textbar{} 100 GiB \textbar{} ✓ \textbar{} ✗ (12 dimensionless×)
\textbar{} ✗ (0 GiB / KiB×) \textbar{}} \\
\textbf{GPT-2 XL} &
\multicolumn{5}{>{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.8432} + 8\tabcolsep}@{}}{%
6 GiB \textbar{} 6 GiB \textbar{} ✓ \textbar{} ✓ \textbar{} ✗ (0 GiB /
KiB×) \textbar{}} \\
\textbf{ResNet-50} &
\multicolumn{5}{>{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.8432} + 8\tabcolsep}@{}}{%
100 MiB \textbar{} 100 MiB \textbar{} ✓ \textbar{} ✓ \textbar{} ✗ (0 MiB
/ KiB×) \textbar{}} \\
\textbf{MobileNetV2} &
\multicolumn{5}{>{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.8432} + 8\tabcolsep}@{}}{%
14 MiB \textbar{} 14 MiB \textbar{} ✓ \textbar{} ✓ \textbar{} ✗ (0 MiB /
KiB×) \textbar{}} \\
\textbf{MobileNetV2 (INT8)} &
\multicolumn{5}{>{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.8432} + 8\tabcolsep}@{}}{%
3.5 MiB \textbar{} 3.5 MiB \textbar{} ✓ \textbar{} ✓ \textbar{} ✗ (0 MiB
/ KiB×) \textbar{}} \\
\textbf{DS-CNN (KWS)} &
\multicolumn{5}{>{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.8432} + 8\tabcolsep}@{}}{%
500 KiB \textbar{} 500 KiB \textbar{} ✓ \textbar{} ✓ \textbar{} ✓
\textbar{}} \\
\end{longtable}
...
\begin{fbx}{callout-perspective}{Systems Perspective:}{The Compression-Accuracy Tradeoff Curve}
...
\begin{fbx}{callout-checkpoint}{Checkpoint:}{The Efficiency Frontier}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/6d5004de5e38f8474ffa226e4076d83d941a9e9f.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/b663474053618aa450b613cd7c61bbaf1abb31a8.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/ea688be33fd304dfcfc4401d64c7d2fe20d0c8e6.pdf}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1115}}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.3692}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/0fca639877ab3767a7d194874c21ef217d420652.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/677a876bd358180f36ea8c1962b47767597eb0cc.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/e8820fb19b5a553633e68701c94e89425220d93c.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/32b353cd1077edc073e853748ad474ecbe4ebb70.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/f599be14a707957c9be0380c54733f8b78471b09.pdf}}
...
\begin{fbx}{callout-notebook}{AI Engineer’s Notebook:}{The Bandwidth-Compute Trade-off}
...
64MiB (at FP32). Fetching this matrix for a single inference is a
massive memory bandwidth hit, especially when limited by physical memory
bandwidth constraints.

If we factorize it with rank \(k=128\), we store two matrices
(\(4096 \times 128\) and \(128 \times 4096\)), totaling only 4MiB, a
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/2da7b869338ec763ad2fb59c9194af24d657c967.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/ad41996e23f2b152546f1a00f3732f3231178023.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/63fa4f97fcd2a1b0c3b5067651921cb75be5e330.pdf}}
...
\begin{fbx}{callout-checkpoint}{Checkpoint:}{Structural Optimization Checkpoint}
...
\begin{fbx}{callout-lighthouse}{Lighthouse:}{DLRM and Embedding Quantization}
...
\begin{fbx}{callout-lighthouse}{Lighthouse:}{The TinyML Quantization Imperative}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/373217f73f6564c5b5f41ad14bc65dff938f560d.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/0446218120967aabb963912fdd161a44b0c0caf7.pdf}}
...
\begin{fbx}{callout-notebook}{AI Engineer’s Notebook:}{Quantization Savings}
...
\begin{fbx}{callout-notebook}{AI Engineer’s Notebook:}{The SIMD Multiplier}
...
\begin{fbx}{callout-notebook}{AI Engineer’s Notebook:}{The Quantization Speedup: Compute-Bound vs. Memory-Bound}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/5a500026be554843c088ebf884faac1dd85b6561.pdf}}
...
\begin{fbx}{callout-lighthouse}{Lighthouse:}{Keyword Spotting and Extreme Compression}
...
per operation. An INT8 multiply, for example, uses roughly
\(18.5\times\) less energy than its FP32 equivalent, compounding the
memory energy savings into substantial reductions at system scale.
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/8356696cf9a5f3c16d3ed5249f2746f84fb0c705.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/f94ee289a729fa89707a6b4d4e3028a9cc0f649e.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/80ad7e153d38a87ca732315d3833d82a1b0d8eb1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/d1bd2081fac7e0ed02477d087b7ab0e4337ab258.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/5cb0bbaca1323f34f9c92823493acaf072c49d18.pdf}}
...
\begin{fbx}{callout-checkpoint}{Checkpoint:}{The Quantization Gate}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/d010b42fe076ac2ff8d31cd7198959bf8dfedc33.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/e54630825a1098cfdc4292aae9c190d00b63885f.pdf}}
...
\begin{fbx}{callout-checkpoint}{Checkpoint:}{Quantization and Precision Checkpoint}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/7d3fa97fad4e4b35f9347e0f4240f253d31b7041.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/7d156c7b16b2c1175f9df6a0c7437ba82ff298d5.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/b90e70941e38cb5326a456a1b5294b592c804201.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/c027236d764247acef3d59e421a4fbeee3a2a648.pdf}}
...
\begin{fbx}{callout-perspective}{Systems Perspective:}{The Optimization Composition Problem}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/7abd48d330f21dcb0d97c88d8e1c84f7e02de8a6.pdf}}
...
\begin{fbx}{callout-example}{Example:}{BERT-Base Mobile Deployment Pipeline}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/b779b21b0a52173e7acb94e5c665f0b02f2bf290.pdf}}
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, opacityback=0, left=2mm, bottomtitle=1mm, arc=.35mm, opacitybacktitle=0.6, toptitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{FLOPs Reduction ≠ Proportional Speedup}, coltitle=black, colback=white, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, bottomrule=.15mm, breakable]
