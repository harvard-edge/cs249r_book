...
## Overview {#sec-ondevice-learning-overview-3555}
...
## Deployment Drivers {#sec-ondevice-learning-deployment-drivers-2eb7}
...
### On-Device Learning Benefits {#sec-ondevice-learning-ondevice-learning-benefits-5ae7}
...
### Application Domains {#sec-ondevice-learning-application-domains-1595}
...
### Training Paradigms {#sec-ondevice-learning-training-paradigms-af01}
...
## Design Constraints {#sec-ondevice-learning-design-constraints-d887}
...
### Data Constraints {#sec-ondevice-learning-data-constraints-f2ca}
...
### Compute Constraints {#sec-ondevice-learning-compute-constraints-4244}
...
## Model Adaptation {#sec-ondevice-learning-model-adaptation-0b2b}
...
### Weight Freezing {#sec-ondevice-learning-weight-freezing-797c}
...
::: {#lst-bias-adaptation .callout-important title="**Bias-Only Adaptation**: Freezes model parameters except for biases to reduce memory usage and enable on-device learning."}
```{.python}
...
#| lst-cap: "**Bias-Only Adaptation**: Freezes model parameters except for biases to reduce memory usage and enable on-device learning."
#| eval: false
# Freeze all parameters
for name, param in model.named_parameters():
    param.requires_grad = False
...
### Residual and Low-Rank Updates {#sec-ondevice-learning-residual-lowrank-updates-2add}
...
#### Adapter-Based Adaptation {#sec-ondevice-learning-adapterbased-adaptation-04de}
...
#### Low-Rank Techniques {#sec-ondevice-learning-lowrank-techniques-2817}
...
::: {.content-visible when-format="html"}
::: {#lst-lowrank-adapter .callout-important title="**Low-Rank Adapter**: The code implements a low-rank adapter module by approximating weight updates using matrices \(u\) and \(v\), reducing parameter count while enabling efficient model adaptation on edge devices."}
```{.python}
...
#| lst-cap: "**Low-Rank Adapter**: The code implements a low-rank adapter module by approximating weight updates using matrices u and v, reducing parameter count while enabling efficient model adaptation on edge devices."
#| eval: false
class Adapter(nn.Module):
    def __init__(self, dim, bottleneck_dim):
        super().__init__()
...
#### Edge Personalization {#sec-ondevice-learning-edge-personalization-a892}
...
#### Tradeoffs {#sec-ondevice-learning-tradeoffs-bb7b}
...
### Sparse Updates {#sec-ondevice-learning-sparse-updates-eefe}
...
#### Sparse Update Design {#sec-ondevice-learning-sparse-update-design-ecbc}
...
#### Layer Selection {#sec-ondevice-learning-layer-selection-c339}
...
#### Code Fragment: Selective Layer Updating (PyTorch) {#sec-ondevice-learning-code-fragment-selective-layer-updating-pytorch-d094}

::: {.content-visible when-format="html"}
::: {#lst-selective-update .callout-important title="**Selective Layer Updating**: This technique enables fine-tuning specific layers of a pre-trained model while keeping others frozen, optimizing computational resources for targeted improvements. *Source: PyTorch Documentation*"}
```{.python}
...
#| lst-cap: "**Selective Layer Updating**: This technique enables fine-tuning specific layers of a pre-trained model while keeping others frozen, optimizing computational resources for targeted improvements. *Source: PyTorch Documentation*"
#| eval: false
## Assume model has named layers: ['conv1', 'conv2', 'fc']
## We selectively update only conv2 and fc
...
#### TinyTrain Personalization {#sec-ondevice-learning-tinytrain-personalization-bdf2}
...
#### Tradeoffs {#sec-ondevice-learning-tradeoffs-effd}
...
#### Adaptation Strategy Comparison {#sec-ondevice-learning-adaptation-strategy-comparison-8bd5}
...
### Few-Shot and Streaming {#sec-ondevice-learning-fewshot-streaming-7b2b}
...
### Experience Replay {#sec-ondevice-learning-experience-replay-bc9e}
...
#| lst-cap: "**Replay Buffer**: Implements a circular storage mechanism for efficient memory management in constrained environments. This approach allows models to efficiently retain and sample from recent data points, balancing the need to leverage historical information while incorporating new insights."
#| eval: false
# Replay Buffer Techniques
class ReplayBuffer:
    def __init__(self, capacity):
...
### Data Compression {#sec-ondevice-learning-data-compression-98a0}
...
### Tradeoffs Summary {#sec-ondevice-learning-tradeoffs-summary-b256}
...
## Federated Learning {#sec-ondevice-learning-federated-learning-6534}
...
### Federated Learning Motivation {#sec-ondevice-learning-federated-learning-motivation-e16d}
...
### Learning Protocols {#sec-ondevice-learning-learning-protocols-2916}
...
#### Local Training {#sec-ondevice-learning-local-training-3430}
...
#### Protocols Overview {#sec-ondevice-learning-protocols-overview-64b2}
...
#### Client Scheduling {#sec-ondevice-learning-client-scheduling-aa1e}
...
#### Efficient Communication {#sec-ondevice-learning-efficient-communication-fb5c}
...
#### Federated Personalization {#sec-ondevice-learning-federated-personalization-4673}
...
#### Federated Privacy {#sec-ondevice-learning-federated-privacy-8320}
...
## Practical System Design {#sec-ondevice-learning-practical-system-design-3914}
...
#### Heterogeneity {#sec-ondevice-learning-heterogeneity-ac2d}
...
#### Data Fragmentation {#sec-ondevice-learning-data-fragmentation-378d}
...
#### Monitoring and Validation {#sec-ondevice-learning-monitoring-validation-3151}
...
#### Resource Management {#sec-ondevice-learning-resource-management-4bbd}
...
#### Deployment Risks {#sec-ondevice-learning-deployment-risks-92aa}
...
#### Challenges Summary {#sec-ondevice-learning-challenges-summary-7983}
...
## Summary {#sec-ondevice-learning-summary-ef13}
