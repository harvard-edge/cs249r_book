...
::: {.callout-video title="Convolutional Network Demo from 1989" icon="play-circle"}
::: {.content-visible when-format="html"}
<div class="video-enhanced-container" style="margin: 2rem 0; background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: 16px; padding: 1.5rem; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.1); border: 1px solid rgba(0, 0, 0, 0.05);">
  <div class="video-header" style="margin-bottom: 1rem; padding-bottom: 0.5rem; border-bottom: 2px solid #007bff;">
    <h4 style="margin: 0 0 0.5rem 0; color: #2c3e50; font-weight: 600; font-size: 1.25rem;">Convolutional Network Demo from 1989</h4>
    <div class="video-meta" style="display: flex; gap: 1rem; font-size: 0.9em; color: #6c757d; flex-wrap: wrap;">
      <span style="display: flex; align-items: center; gap: 0.25rem;"><i class="fas fa-clock"></i> 2:45</span>
      <span style="display: flex; align-items: center; gap: 0.25rem;"><i class="fas fa-user"></i> Yann LeCun</span>
    </div>
  </div>
  <div class="video-wrapper" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; border-radius: 12px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.15); transition: transform 0.3s ease;">
    <iframe src="https://www.youtube.com/embed/FwFduRA_L6Q" 
            style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0; border-radius: 12px;" 
            allowfullscreen>
    </iframe>
  </div>
  <div class="video-description" style="margin-top: 1rem; padding: 1rem; background: rgba(255, 255, 255, 0.8); border-radius: 8px; font-size: 0.95em; color: #495057; line-height: 1.5;">
    A demonstration of early convolutional neural networks from 1989, showing how these networks process visual information.
  </div>
</div>
:::
...
The video above uses enhanced HTML styling for better presentation. Here's the simple approach:

**Enhanced HTML with Inline Styles:**
```html
<div class="video-enhanced-container" style="margin: 2rem 0; background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: 16px; padding: 1.5rem; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.1);">
  <div class="video-header">
    <h4>Video Title</h4>
...
This approach is simple, reliable, and gives you full control over the styling.
:::
