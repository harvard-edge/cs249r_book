...
::: {.content-visible when-format="html"}
<div class="video-container" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
...
<div style="margin-top: 8px; font-size: 0.9em; color: #666; text-align: center;">
  <i class="fas fa-clock"></i> Duration: 2:45 | <i class="fas fa-user"></i> Yann LeCun
</div>
:::
