...
2. **Seeed XIAOML Kit**
   - The Seeed Studio XIAOML Kit is based on the XIAO ESP32S3 Sense, a tiny, feature-packed board designed for makers, hobbyists, and students interested in exploring edge AI applications. The kit comes equipped with a camera, microphone, and IMU, making it easy to get started with projects such as image classification, keyword spotting, and motion detection.
...
3. **Seeed Grove Vision AI V2 board**
...
- For the XIAOML Kit, you can use the XIAO ESP32S3 onboard Wi-Fi module or connect an external Wi-Fi or Ethernet module using the available pins.
