...
## Our Featured Platform {#sec-kits-hero}

![Complete XIAOML Kit with all components](seeed/xiao_esp32s3/images/png/XIAOML_Kit_Complete.png){width=600 fig-align="center"}

*The XIAOML Kit represents our flagship platform - a complete TinyML development ecosystem with wireless connectivity, camera, sensors, and comprehensive documentation. This ultra-compact board demonstrates how modern embedded systems can deliver sophisticated ML capabilities in a cost-effective package.*

## Hardware Platform Overview {#sec-kits-overview}

Our curriculum features four carefully selected platforms that span the full spectrum of embedded computing capabilities. Each platform has been chosen to illustrate specific engineering trade-offs and learning objectives.
