...
% Pandoc citeproc fallback compatibility
\providecommand{\citeproc}[2]{#2}
\providecommand{\includesvg}[2][]{\includegraphics[#1]{#2}}
...
\usepackage{lettrine}       % Dropped capitals for chapter openers
...
\usepackage[dvipsnames,svgnames]{xcolor}  % Extended color support (dvips + svg color names)
...
\usepackage{mathtools}      % Mathematical tools to use with amsmath (provides \coloneqq, etc.)
...
%     ./binder/binder build pdf --vol1 --print-marks
...
% MLSys Textbook TikZ Palette (shared across all chapters and volumes)
...
% Legacy semantic aliases used across certain TikZ figures
\providecolor{TextDark}{RGB}{30, 41, 59}
\providecolor{TextMuted}{RGB}{100, 116, 139}
\providecolor{CardBorder}{RGB}{203, 213, 225}
\providecolor{CardBg}{RGB}{248, 250, 252}
\providecolor{CardFill}{RGB}{248, 250, 252}
\providecolor{CanvasBorder}{RGB}{203, 213, 225}
\providecolor{CanvasBg}{RGB}{248, 250, 252}
\providecolor{BlueLine}{RGB}{31, 64, 122}
\providecolor{GreenLine}{RGB}{22, 163, 74}
\providecolor{RedLine}{RGB}{220, 38, 38}
\providecolor{OrangeLine}{RGB}{217, 119, 6}
\providecolor{PurpleLine}{RGB}{124, 58, 237}
\providecolor{SlateLine}{RGB}{100, 116, 139}
\providecolor{SlateFill}{RGB}{241, 245, 249}
\providecolor{SlateGray}{RGB}{112, 128, 144}
\providecolor{SlateGrey}{RGB}{112, 128, 144}
\providecolor{DarkGreen}{RGB}{20, 110, 60}
\providecolor{DarkBlue}{RGB}{20, 41, 78}
\providecolor{DarkNavy}{RGB}{15, 23, 42}
\providecolor{DarkSlate}{RGB}{47, 79, 79}
\providecolor{DarkRed}{RGB}{185, 28, 28}
\providecolor{DarkOrange}{RGB}{180, 83, 9}
\providecolor{DarkPurple}{RGB}{109, 40, 217}
\providecolor{LightBlue}{RGB}{234, 241, 248}
\providecolor{LightGreen}{RGB}{220, 252, 231}
\providecolor{LightRed}{RGB}{254, 226, 226}
\providecolor{LightOrange}{RGB}{254, 243, 199}
\providecolor{LightPurple}{RGB}{243, 232, 255}
\providecolor{LightGray}{RGB}{241, 245, 249}
\providecolor{LightSlate}{RGB}{241, 245, 249}
\providecolor{MidGray}{RGB}{100, 116, 139}
\providecolor{MutedSlate}{RGB}{100, 116, 139}
\providecolor{DarkGray}{RGB}{30, 41, 59}
\providecolor{NavyBlue}{RGB}{20, 41, 78}
\providecolor{OceanBlue}{RGB}{30, 144, 255}
\providecolor{AmberOrange}{RGB}{217, 119, 6}
\providecolor{SoftBlue}{RGB}{234, 241, 248}
\providecolor{SoftGreen}{RGB}{220, 252, 231}
\providecolor{SoftRed}{RGB}{254, 226, 226}
\providecolor{SoftOrange}{RGB}{254, 243, 199}
\providecolor{SoftPurple}{RGB}{243, 232, 255}
\providecolor{SoftAmber}{RGB}{254, 243, 199}
\providecolor{SoftGrey}{RGB}{241, 245, 249}
\providecolor{SoftTeal}{RGB}{204, 251, 241}
\providecolor{CrimsonRed}{RGB}{185, 28, 28}
\providecolor{CoralRed}{RGB}{248, 113, 113}
\providecolor{EmeraldGreen}{RGB}{16, 185, 129}
\providecolor{MintGreen}{RGB}{52, 211, 153}
\providecolor{WarmOrange}{RGB}{249, 115, 22}
\providecolor{PurpleHeart}{RGB}{107, 33, 168}
\providecolor{PurpleViolet}{RGB}{139, 92, 246}
\providecolor{PurpleFill}{RGB}{243, 232, 255}
\providecolor{BorderAmber}{RGB}{245, 158, 11}
\providecolor{BorderBlue}{RGB}{59, 130, 246}
\providecolor{BorderGreen}{RGB}{34, 197, 94}
\providecolor{BorderPurple}{RGB}{168, 85, 247}
\providecolor{BorderRed}{RGB}{239, 68, 68}
\providecolor{BorderGray}{RGB}{203, 213, 225}
\providecolor{BorderGrey}{RGB}{203, 213, 225}

% Colors referenced by TikZ figures that had no global definition.
% Values follow the palette above so these read as first-class members of it.
\providecolor{mlsysdark}{RGB}{30, 41, 59}       % figure body text (= TextDark)
\providecolor{mlsysteal}{RGB}{13, 148, 136}     % teal accent
\providecolor{DeepBlue}{RGB}{31, 64, 122}       % blue border (= BlueLine)
\providecolor{MutedGray}{RGB}{100, 116, 139}    % secondary text (= mlsysgray)
\providecolor{AmberStage}{RGB}{217, 119, 6}     % amber stage accent (= OrangeLine)
\providecolor{OrangeBorder}{RGB}{217, 119, 6}   % orange border (= OrangeLine)
\providecolor{GridLine}{RGB}{203, 213, 225}     % dashed plot gridlines (= CardBorder)
\providecolor{TealLine}{RGB}{13, 148, 136}      % teal border
\providecolor{TealFill}{RGB}{204, 251, 241}     % teal fill (= SoftTeal)

% Background grouping boxes ("\scoped[on background layer]" fit nodes).
\providecolor{BackLine}{RGB}{203, 213, 225}     % grouping-box border (= CardBorder)
\providecolor{BackColor}{RGB}{241, 245, 249}    % grouping-box fill (= LightGray)
\providecolor{darknavy}{RGB}{15, 23, 42}        % lowercase alias of DarkNavy
\providecolor{VioletL2}{RGB}{232, 224, 255}     % light violet fill (matches BlueL/RedL/GreenL)
\providecolor{OliveLine}{RGB}{128, 128, 74}     % muted olive line (matches BrownLine's tone)

% Canonical diagram colors from diagram.yml
\providecolor{BlueFill}{HTML}{D6EAF8}
\providecolor{GreenFill}{HTML}{D5F5E3}
\providecolor{GreenL0}{HTML}{D5F5E3}
\providecolor{OrangeFill}{HTML}{FDEBD0}
\providecolor{RedFill}{HTML}{F2D7D5}
\providecolor{VioletFill}{RGB}{243, 243, 255}
\providecolor{YellowFill}{RGB}{254, 247, 224}
\providecolor{GrayLine}{HTML}{666666}
\providecolor{GrayL}{HTML}{E0E0E0}
\providecolor{BlueD}{RGB}{62,100,125}
\providecolor{BlueL}{RGB}{209,243,255}
\providecolor{GreenD}{RGB}{40,117,40}
\providecolor{GreenL}{RGB}{219,253,166}
\providecolor{OrangeL}{RGB}{250,212,175}
\providecolor{RedL}{RGB}{253,226,240}
\providecolor{TextColor}{RGB}{224,224,224}
...
yshift=-30mm,font={%
\normalfont\fontsize{98pt}{104}\selectfont\bfseries}]  (BG) at (current page text area.north east){\thepart};
%
...
font={\normalfont\fontsize{30pt}{34}\selectfont}]
...
\normalfont\fontsize{20pt}{20}\selectfont\bfseries}](BP)  at
...
font={\normalfont\fontsize{48pt}{48}\selectfont\bfseries}]  (BG) at ($(S2)!0.5!(SS2)$){\hphantom{Part}};
%%%
...
align=right,font={\normalfont\fontsize{40pt}{40}\selectfont}]
...
\node[inner sep=0mm,draw=none,anchor=center,text width=0.8\textwidth,
align=center,font={\normalfont\fontsize{44pt}{44}\selectfont\bfseries}]
(BGG) at (current page.center)  {\color{crimson}\MakeUppercase {#1}};
...
\node[crimson,align=flush right,inner sep=0,outer sep=0mm,draw=none,anchor=south,
font={\normalfont\fontsize{48pt}{48}\selectfont\bfseries}]  (BG) at ($(S2)!0.5!(SS2)$){\hphantom{Workshop}};
%%%
\path[green]([yshift=15mm]D2)-|coordinate(TPD)(BG.south east);
\node[inner sep=0mm,draw=none,anchor=south east,%text width=0.9\textwidth,
align=right,font={\normalfont\fontsize{40pt}{40}\selectfont}]
...
\newcommand{\mlsysChapNumFont}{\normalfont\fontsize{70pt}{70pt}\selectfont\bfseries}
  ...
  {%
    ...
    \begin{tikzpicture}[remember picture, overlay]
      \node[anchor=north east,
        ...
        {\mlsysChapNum};
    \end{tikzpicture}%
    % Title at normal chapter-start position, full text width (fits on single line)
    {\adjustbox{max width=\textwidth}{\fontsize{26pt}{30pt}\selectfont #1}}%
  }
  []
...
\renewcommand{\DefaultLoversize}{0}   % Exact 3-line height for clean baseline alignment
\renewcommand{\DefaultLraise}{0}      % No vertical shift
% J and Q have descenders; lift them so their tails clear the following lines.
\LettrineOptionsFor{J}{lraise=0.15}
\LettrineOptionsFor{Q}{lraise=0.10}
\setlength{\DefaultFindent}{2pt}      % Gap between drop cap and following text (prevents collision)
...
% use `./binder/binder build pdf --volN --print-marks` when production requests them.
...
% after the chapter heading, in place of a cover-image caption:
%
...
\newcommand{\stacklayer}[4]{
    ...
    % Text
    % Helvetica bold: matches the book's figure typography convention (figure-tikz.md)
    % for crisp legibility across tint levels, dark backgrounds, and margin scanning.
    \node[anchor=west, text=\textcol, font=\usefont{T1}{phv}{b}{n}\fontsize{7.5}{8.5}\selectfont] at ($(box.west)+(0.12,0)$) {#2};
...
\newcommand{\mlsysstack}[8]{
    \begin{tikzpicture}
        ...
        \else
            ...
            \fi
        \fi
        \node[rotate=90, text=\datatextcol, font=\usefont{T1}{phv}{b}{n}\fontsize{6.5}{7.5}\selectfont]
            at (3.0, 3.5) {Data};
...
\newcommand{\stacklayerfull}[5]{
    ...
    % Title
    \node[anchor=west, text=\textcol, font=\usefont{T1}{phv}{b}{n}\fontsize{8.5}{9.5}\selectfont]
        at ($(box.west)+(0.28,0.15)$) {#2};

    % Subtitle
    \node[anchor=west, text=\textcol, font=\usefont{T1}{phv}{m}{n}\fontsize{6.2}{7.2}\selectfont, opacity=0.90]
        at ($(box.west)+(0.28,-0.15)$) {#3};
    
    % Icon (positioned on the right)
    \path (box.east) +(-0.55,0) pic[scale=0.85, draw=\textcol, fill=\textcol, text=\textcol] {#5};
}
    ...
    \begin{tikzpicture}
        ...
        \foreach \layerint/\ypos in {#1/0.55, #2/1.65, #3/2.75, #4/3.85, #5/4.95, #6/6.05, #7/7.15} {
            ...
            \else
                \edef\wirecol{crimson!\lint}
            \fi
            \draw[\wirecol, line width=1.5pt] (5.6, \ypos) -- (6.05, \ypos);
        }
        ...
        \else
            ...
            \fi
        \fi
        \node[rotate=90, text=\datatextcol, font=\usefont{T1}{phv}{b}{n}\fontsize{7.5}{8.5}\selectfont]
            at (6.20, 3.85) {Data};
...
% Set \MarginDebugfalse for production builds; \MarginDebugfalse to show guides.
% ─────────────────────────────────────────────────────────────────────────────
\newif\ifMarginDebug
\MarginDebugfalse% <<< set to \MarginDebugfalse to show margin alignment guides
\ifMarginDebug
