...
% Global font setting for all TikZ diagrams: use the canonical figure sans font.
% Applies to all tikzpicture environments without interfering with internal PGF pictures/fadings.
\AtBeginEnvironment{tikzpicture}{\mlsysFigureSans}
