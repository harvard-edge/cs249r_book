...
\newcommand{\mlphysicalstackfull}[5]{%
  \begin{tikzpicture}
    \physrowfull{4.80}{Brain}{1--50 Hz}%
      {foundation models, SLAM, planning}{#1}{\faBrain}
    ...
    \physrowfull{2.80}{Nervous System}{1000 Hz}%
      {TSN, intent leases, lock-free IPC}{#2}{\faNetworkWired}
    \physrowfull{1.20}{Body}{continuous}%
      {real-time MCU, safety filters, CBFs}{#3}{\faMicrochip}
    \physrowfull{-0.40}{Boundary}{continuous}%
      {sensors, actuators, kinematics}{#4}{\faRobot}
    \physrowfull{-2.00}{Physical World}{continuous}%
      {contact mechanics, friction, mass}{#5}{\faGlobe}
  \end{tikzpicture}%
}
