...
\begin{tikzpicture}[
    ...
    \node[font=\scriptsize\bfseries\color{BurntOrange!80!black}, anchor=east] at (2.4, 3.68) {Cross-rack Spine: $\sim$25 GB/s effective (2:1 oversubscribed)};
    ...
    \node[draw=DarkOrchid, fill=DarkOrchid, rounded corners=3pt, inner sep=4pt, text=white, font=\footnotesize\bfseries, anchor=north west] (rack_badge) at (-7.4, 2.7) {Rack / Leaf Switch Domain};
    \node[font=\scriptsize\bfseries\color{DarkOrchid!80!black}, anchor=east] at (2.1, 2.48) {InfiniBand NDR: 50 GB/s per port (400 Gbps)};
