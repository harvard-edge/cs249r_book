...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, fmt_count, fmt_math, fmt_time, sci_latex
...
from mlsysim.fmt import check, fmt, fmt_int, fmt_percent, fmt_time
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, fmt_memory_capacity, fmt_time
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import MarkdownStr, check, fmt, fmt_count, fmt_rate, fmt_time
...
from mlsysim.fmt import check, fmt, fmt_int, fmt_text, fmt_time
...
from mlsysim.fmt import check, fmt, fmt_memory, fmt_qty
...
class FaultToleranceIntroRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    gpt3_ckpt_tb_str = fmt_memory(gpt3_ckpt_bytes, unit=TB, precision=1, commas=False)
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.physics import memory_from_params
from mlsysim.fmt import check, fmt_memory, fmt_memory_capacity, fmt_params, fmt_qty
...
class OomAdamwFootprint:
    ...
    footprint_gb_str = fmt_memory(footprint, unit=GB, precision=0, commas=False)
...
class FaultToleranceCheckpointRecap:
    ...
    gpt3_ckpt_tb_str = fmt_memory(gpt3_ckpt_bytes, unit=TB, precision=1, commas=False)
    gpt3_adam_tb_str = fmt_memory(gpt3_adam_bytes, unit=TB, precision=1, commas=False)
    gpt3_shard_gb_str = fmt_memory(gpt3_ckpt_bytes / n_workers, unit=GB, precision=1, commas=False)
    ckpt_write_s_str = fmt_time(ckpt_write, second, precision=None, commas=False)
    aggregate_read_gb_per_s_str = fmt_bandwidth(aggregate_ckpt_bw, unit=GB / second, precision=0, commas=False)
```
...
class CheckpointOverheadCalc:
    ...
    archA_fp32_tb_str = fmt_memory(archA_fp32_bytes, unit=TB, precision=1, commas=False)
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt_count, fmt_memory, fmt_qty
...
class CheckpointStorm:
    ...
    storm_shard_gb_str = fmt_memory(shard_size, unit=GB, precision=0, commas=False)
    storm_payload_tb_str = fmt_memory(payload, unit=TB, precision=0, commas=False)
```
...
```{python}
#| echo: false
from mlsysim.fmt import fmt_bandwidth, fmt_count, fmt_int, fmt_params, fmt_qty, fmt_qty_int, fmt_time, fmt_usd
...
class CheckpointDebug:
    ...
    nfs_gb_per_s_str = fmt_bandwidth(nfs_bw, unit=GB / second, precision=2, commas=False)
...
class RecoveryBudget:
    ...
    aggregate_read_gb_per_s_str = fmt_bandwidth(aggregate_ckpt_bw, unit=GB / second, precision=0, commas=False)
    shard_read_gb_per_s_str = fmt_bandwidth(shard_read_bw, unit=GB / second, precision=0, commas=False)
...
from mlsysim.fmt import check, fmt, fmt_int, fmt_percent, fmt_usd
...
from mlsysim.fmt import check, fmt_display_math, fmt_int, fmt_time
...
from mlsysim.fmt import check, fmt, fmt_count, fmt_math, fmt_time
