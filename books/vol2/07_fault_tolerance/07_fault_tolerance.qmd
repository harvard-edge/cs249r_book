...
\begin{tikzpicture}[
  ...
  % Titles above bars
  \node[font=\footnotesize\bfseries, text=DarkGreen] at (-4.9, 0.45) {Fast Recovery (Soft Errors)};
  \node[font=\footnotesize\bfseries, text=OrangeLine!95!black] at (0, 0.45) {Marginal / Environmental (Intermittent)};
  \node[font=\footnotesize\bfseries, text=DarkRed] at (4.9, 0.45) {Permanent Hardware Loss (Hard Faults)};
...
\begin{tikzpicture}[
  ...
  \node[draw=GreenLine, fill=GreenFill!70, rounded corners=3pt, line width=0.6pt,
        minimum width=\gW cm, minimum height=\gH cm, align=center, inner sep=1pt] at (\xL-2.32, \gYt) {
  ...
  \node[draw=GreenLine, fill=GreenFill!70, rounded corners=3pt, line width=0.6pt,
        minimum width=\gW cm, minimum height=\gH cm, align=center, inner sep=1pt] at (\xL-1.16, \gYt) {
  ...
  \node[draw=GreenLine!60, fill=GreenFill!50, rounded corners=3pt, line width=0.6pt,
        minimum width=6.25cm, minimum height=0.72cm, align=center, inner sep=2pt] at (\xL, \yT-1.38) {
  ...
  \node[draw=GreenLine, fill=GreenFill!70, rounded corners=3pt, line width=0.6pt,
        minimum width=\gW cm, minimum height=\gH cm, align=center, inner sep=1pt] at (\xR-2.32, \gYt) {
    \textbf{\fontsize{6.2pt}{7.2pt}\selectfont\textcolor{DarkGreen}{GPU 0}}\\[1.5pt]
    \fontsize{5.0pt}{5.8pt}\selectfont\bfseries\textcolor{DarkGreen}{ACTIVE}
  };
  \node[draw=GreenLine, fill=GreenFill!70, rounded corners=3pt, line width=0.6pt,
        minimum width=\gW cm, minimum height=\gH cm, align=center, inner sep=1pt] at (\xR-1.16, \gYt) {
    \textbf{\fontsize{6.2pt}{7.2pt}\selectfont\textcolor{DarkGreen}{GPU 1}}\\[1.5pt]
    \fontsize{5.0pt}{5.8pt}\selectfont\bfseries\textcolor{DarkGreen}{ACTIVE}
  };
  ...
  \node[draw=DarkRed!60, fill=RedFill!60, rounded corners=3pt, line width=0.6pt,
    ...
    \fontsize{5.4pt}{6.6pt}\selectfont\textcolor{DarkRed}{Gradient checksum mismatch / activation norm outlier on rank 2}
  };
  \node[draw=RedLine!40, fill=RedFill!35, rounded corners=3pt, line width=0.5pt,
        minimum width=6.25cm, minimum height=0.72cm, align=center, inner sep=2pt] at (\xR, \yT-1.38) {
  ...
  \node[draw=GreenLine, fill=GreenFill!70, rounded corners=3pt, line width=0.6pt,
        minimum width=\gW cm, minimum height=\gH cm, align=center, inner sep=1pt] at (\xL-2.32, \gYb) {
    \textbf{\fontsize{6.2pt}{7.2pt}\selectfont\textcolor{DarkGreen}{GPU 0}}\\[1.5pt]
    \fontsize{5.0pt}{5.8pt}\selectfont\bfseries\textcolor{DarkGreen}{ACTIVE}
  };
  \node[draw=GreenLine, fill=GreenFill!70, rounded corners=3pt, line width=0.6pt,
        minimum width=\gW cm, minimum height=\gH cm, align=center, inner sep=1pt] at (\xL-1.16, \gYb) {
    \textbf{\fontsize{6.2pt}{7.2pt}\selectfont\textcolor{DarkGreen}{GPU 1}}\\[1.5pt]
    \fontsize{5.0pt}{5.8pt}\selectfont\bfseries\textcolor{DarkGreen}{ACTIVE}
  };
  ...
  \node[draw=CardBorder, fill=CardFill, rounded corners=3pt, line width=0.5pt,
    ...
    \fontsize{5.4pt}{6.6pt}\selectfont\textcolor{TextMuted}{NCCL communicators re-initialized $\cdot$ Last good shard loaded into spare}
  };
  \node[draw=OrangeLine!60, fill=OrangeL!45, rounded corners=3pt, line width=0.6pt,
        minimum width=6.25cm, minimum height=0.72cm, align=center, inner sep=2pt] at (\xL, \yB-1.38) {
    \textbf{\fontsize{6.0pt}{7.0pt}\selectfont\textcolor{OrangeLine!95!black}{Zero Job Rescheduling Penalty}}\\[1.5pt]
    \fontsize{5.4pt}{6.6pt}\selectfont\textcolor{OrangeLine!95!black}{Training restarts from iteration N-1 with 4-GPU ring preserved}
  };
  ...
  \node[draw=GreenLine, fill=GreenFill!70, rounded corners=3pt, line width=0.6pt,
        minimum width=\gW cm, minimum height=\gH cm, align=center, inner sep=1pt] at (\xR-2.32, \gYb) {
    \textbf{\fontsize{6.2pt}{7.2pt}\selectfont\textcolor{DarkGreen}{GPU 0}}\\[1.5pt]
    \fontsize{5.0pt}{5.8pt}\selectfont\bfseries\textcolor{DarkGreen}{ACTIVE}
  };
  \node[draw=GreenLine, fill=GreenFill!70, rounded corners=3pt, line width=0.6pt,
        minimum width=\gW cm, minimum height=\gH cm, align=center, inner sep=1pt] at (\xR-1.16, \gYb) {
    \textbf{\fontsize{6.2pt}{7.2pt}\selectfont\textcolor{DarkGreen}{GPU 1}}\\[1.5pt]
    \fontsize{5.0pt}{5.8pt}\selectfont\bfseries\textcolor{DarkGreen}{ACTIVE}
  };
  \node[draw=GreenLine, fill=GreenFill!70, rounded corners=3pt, line width=0.6pt,
  ...
  \node[draw=DarkRed!70, fill=RedFill!40, dashed, rounded corners=3pt, line width=0.7pt,
        minimum width=\gW cm, minimum height=\gH cm, align=center, inner sep=1pt] (defNode) at (\xR+2.32, \gYb) {
  ...
  \node[draw=CardBorder, fill=CardFill, rounded corners=3pt, line width=0.5pt,
    ...
    \fontsize{5.4pt}{6.6pt}\selectfont\textcolor{TextMuted}{Defective sled dispatched for repair $\cdot$ New spare re-provisioned into pool}
  };
  \node[draw=SteelBlue!50, fill=LightBlue!60, rounded corners=3pt, line width=0.6pt,
        minimum width=6.25cm, minimum height=0.72cm, align=center, inner sep=2pt] at (\xR, \yB-1.38) {
...
\begin{tikzpicture}[
  ...
  \node[draw=SteelBlue, fill=LightBlue, rounded corners=3pt, line width=0.8pt,
    ...
    \fontsize{5.4pt}{6.6pt}\selectfont\textcolor{SteelBlue}{Heartbeat \& Timeout Monitor}
  };
  ...
  \node[draw=SteelBlue!50, fill=LightBlue!50, rounded corners=3pt, line width=0.6pt,
    ...
    \fontsize{5.2pt}{6.4pt}\selectfont\textcolor{TextMuted}{Detection: Lease timeout $\cdot$ Recovery: Replace node and restore checkpoint}
  };
  ...
  \node[draw=OrangeLine!50, fill=OrangeL!45, rounded corners=3pt, line width=0.6pt,
    ...
    \fontsize{5.2pt}{6.4pt}\selectfont\textcolor{TextMuted}{Detection: Gradient norms / cross-validation $\cdot$ Recovery: Byzantine agreement / rollback}
  };
  ...
  \node[align=center, font=\fontsize{5.8pt}{7.0pt}\selectfont, anchor=center]
    ...
    \textcolor{TextDark}{Deterministic timeout detection and lease renewal are sufficient.}
  };
  ...
  \node[align=center, font=\fontsize{5.8pt}{7.0pt}\selectfont, anchor=center]
    ...
    \textcolor{TextDark}{Requires mathematical checksums, outlier rejection, or replicated voting.}
  };
...
\begin{tikzpicture}[font=\sffamily, >=Stealth]
  ...
  \providecolor{mlsysbluedark}{RGB}{20, 41, 78}
  ...
  \begin{scope}[shift={(0, 8.0)}]
    ...
    \draw[draw=mlsysbordergray, fill=mlsyslightgray!50, rounded corners=2pt, line width=0.5pt] (0.5, 4.95) rectangle (7.1, 5.35);
    \node at (3.8, 5.15) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont, color=mlsystext] {Weight shifted $+4$ $\to$ Silent Data Corruption (SDC) risk};

    % SRAM Cell Explanation Box
    \draw[draw=mlsysbordergray, fill=white, rounded corners=3pt, line width=0.7pt] (0.35, 1.85) rectangle (7.25, 4.8);
    \node at (0.55, 4.55) [anchor=west, font=\fontsize{7.5}{9}\selectfont\bfseries, color=mlsystext] {Physical Mechanism: 6T SRAM Cell Inversion};

    % Cross-coupled inverters
    \draw[draw=mlsysdarkblue, fill=mlsyslightblue, rounded corners=2pt, line width=0.8pt] (0.6, 3.65) rectangle (2.6, 4.3);
    \node at (1.6, 4.08) [anchor=center, font=\fontsize{7}{8}\selectfont\bfseries, color=mlsysdarkblue] {Inverter 1};
    \node at (1.6, 3.82) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont, color=mlsysblue] {$Q = 0$ (Low)};

    \draw[-{Stealth[scale=0.8]}, draw=mlsysdarkblue, line width=0.8pt] (2.6, 4.1) -- (4.9, 4.1);
    \draw[-{Stealth[scale=0.8]}, draw=mlsysdarkblue, line width=0.8pt] (4.9, 3.85) -- (2.6, 3.85);

    \draw[draw=mlsysdarkblue, fill=mlsyslightblue, rounded corners=2pt, line width=0.8pt] (4.9, 3.65) rectangle (6.9, 4.3);
    \node at (5.9, 4.08) [anchor=center, font=\fontsize{7}{8}\selectfont\bfseries, color=mlsysdarkblue] {Inverter 2};
    \node at (5.9, 3.82) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont, color=mlsysblue] {$\bar{Q} = 1$ (High)};

    % Ionizing Strike Annotation
    \draw[-{Stealth[scale=0.8]}, draw=mlsysred, line width=1pt] (3.8, 3.35) -- (3.8, 3.6);
    \node at (3.8, 3.15) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont\bfseries, color=mlsysred] {Ionizing particle strike ($Q_{\text{dep}} > Q_{\text{crit}}$)};

    \draw[draw=mlsysred, fill=mlsyslightred, rounded corners=2pt, line width=0.8pt] (0.6, 2.05) rectangle (6.9, 2.85);
    \node at (3.75, 2.6) [anchor=center, font=\fontsize{7}{8}\selectfont\bfseries, color=mlsysdarkred] {Regenerative feedback flips latch state: $Q \to 1, \bar{Q} \to 0$};
    \node at (3.75, 2.25) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont, color=mlsysgray] {Silicon lattice undamaged $\cdot$ Correct state restored on overwrite};

    % Properties Card
    \draw[draw=mlsysgreen, fill=mlsyslightgreen, rounded corners=2.5pt, line width=0.7pt] (0.35, 0.35) rectangle (7.25, 1.55);
    \node at (0.55, 1.30) [anchor=west, font=\fontsize{7}{8}\selectfont\bfseries, color=mlsysdarkgreen] {Temporal Signature: Transient / Soft};
    \node at (0.55, 0.98) [anchor=west, font=\fontsize{5.9}{7}\selectfont, color=mlsystext] {\textbf{Mitigation:} SECDED ECC in HBM/SRAM $\cdot$ Algorithmic fault tolerance};
    \node at (0.55, 0.64) [anchor=west, font=\fontsize{5.9}{7}\selectfont, color=mlsystext] {\textbf{Fleet Impact:} Rewriting memory or retrying computation clears state};
  \end{scope}
  ...
  \begin{scope}[shift={(8.0, 8.0)}]
    ...
    \begin{scope}[shift={(0.4, 4.65)}]
      % AND gate inputs
      \draw[line width=1.2pt, draw=mlsysdarkblue] (0.4, 1.5) -- (1.4, 1.5);
      \node at (0.2, 1.5) [anchor=east, font=\fontsize{7.5}{9}\selectfont\bfseries, color=mlsysdarkblue] {A};

      \draw[line width=1.2pt, draw=mlsysred] (0.4, 0.45) -- (1.4, 0.45);
      \node at (0.2, 0.45) [anchor=east, font=\fontsize{7.5}{9}\selectfont\bfseries, color=mlsysred] {B};

      % Stuck-at-0 short to GND
      \draw[line width=1.2pt, draw=mlsysred] (0.8, 0.45) -- (0.8, 0.05);
      \draw[line width=1.4pt, draw=mlsysred] (0.6, 0.05) -- (1.0, 0.05);
      \draw[line width=1.1pt, draw=mlsysred] (0.67, -0.05) -- (0.93, -0.05);
      \draw[line width=0.8pt, draw=mlsysred] (0.74, -0.15) -- (0.86, -0.15);
      \node at (0.8, -0.32) [anchor=center, font=\fontsize{5.8}{6.8}\selectfont\bfseries, color=mlsysred] {SA0 (GND)};

      % AND Gate body
      \draw[line width=1.2pt, draw=mlsysamber, fill=mlsyslightamber!40]
        (1.4, 0.0) -- (1.9, 0.0) arc (-90:90:0.95) -- (1.4, 1.9) -- cycle;
      \node at (2.15, 0.95) [anchor=center, font=\fontsize{8}{9.5}\selectfont\bfseries, color=mlsysdarkamber] {AND};

      % AND Gate output
      \draw[-{Stealth[scale=0.9]}, line width=1.2pt, draw=mlsysred] (2.85, 0.95) -- (3.9, 0.95);

      % Output box
      \draw[draw=mlsysred, fill=mlsyslightred!30, rounded corners=2pt, line width=1pt] (4.0, 0.3) rectangle (6.7, 1.6);
      \node at (5.35, 1.15) [anchor=center, font=\fontsize{7.5}{9}\selectfont\bfseries, color=mlsysdarkred] {$Z \equiv 0$ (Always)};
      \node at (5.35, 0.65) [anchor=center, font=\fontsize{6.3}{7.5}\selectfont, color=mlsysred] {Degraded to constant 0};
    \end{scope}

    % Truth Table
    \begin{scope}[shift={(0.35, 1.8)}]
      \draw[draw=mlsysbordergray, fill=white, rounded corners=3pt, line width=0.7pt] (0, 0) rectangle (6.9, 2.2);

      % Table Header
      \path[fill=mlsysdarkblue, rounded corners=2pt] (0.05, 1.7) rectangle (6.85, 2.15);
      \node at (0.7, 1.92) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont\bfseries, color=white] {Input A};
      \node at (2.0, 1.92) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont\bfseries, color=white] {Input B (SA0)};
      \node at (3.5, 1.92) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont\bfseries, color=white] {Expected};
      \node at (4.8, 1.92) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont\bfseries, color=white] {Actual};
      \node at (6.0, 1.92) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont\bfseries, color=white] {Status};

      % Row 1: 0, 0
      \node at (0.7, 1.4) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont, color=mlsystext] {0};
      \node at (2.0, 1.4) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont, color=mlsysdarkred] {0 (0)};
      \node at (3.5, 1.4) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont, color=mlsystext] {0};
      \node at (4.8, 1.4) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont, color=mlsystext] {0};
      \node at (6.0, 1.4) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont\bfseries, color=mlsysdarkgreen] {Masked};

      % Row 2: 1, 0
      \node at (0.7, 0.95) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont, color=mlsystext] {1};
      \node at (2.0, 0.95) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont, color=mlsysdarkred] {0 (0)};
      \node at (3.5, 0.95) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont, color=mlsystext] {0};
      \node at (4.8, 0.95) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont, color=mlsystext] {0};
      \node at (6.0, 0.95) [anchor=center, font=\fontsize{6.5}{7.5}\selectfont\bfseries, color=mlsysdarkgreen] {Masked};

      % Row 3: 1, 1 (Activated)
      \path[fill=mlsyslightred!50] (0.05, 0.1) rectangle (6.85, 0.75);
    ...
    % Properties Card
    \draw[draw=mlsysred, fill=mlsyslightred, rounded corners=2.5pt, line width=0.7pt] (0.35, 0.35) rectangle (7.25, 1.55);
    \node at (0.55, 1.30) [anchor=west, font=\fontsize{7}{8}\selectfont\bfseries, color=mlsysdarkred] {Temporal Signature: Permanent / Irreversible};
    \node at (0.55, 0.98) [anchor=west, font=\fontsize{5.9}{7}\selectfont, color=mlsystext] {\textbf{Physical Origin:} Gate-oxide breakdown, electromigration, short to rail};
    \node at (0.55, 0.64) [anchor=west, font=\fontsize{5.9}{7}\selectfont, color=mlsystext] {\textbf{Fleet Impact:} Deterministic defect $\to$ demands node drain and repair};
  \end{scope}
  ...
  \begin{scope}[shift={(0, 0)}]
    ...
    % Waveform Diagram
    \begin{scope}[shift={(0.6, 2.25)}]
      % Sampling edge vertical dashed lines
      \draw[draw=mlsysgray, dashed, line width=0.8pt] (3.0, 0.2) -- (3.0, 4.0);
      \node at (3.0, 4.2) [anchor=center, font=\fontsize{6.2}{7.5}\selectfont\bfseries, color=mlsysgray] {Sampling Edge 1};

      \draw[draw=mlsysgray, dashed, line width=0.8pt] (5.4, 0.2) -- (5.4, 4.0);
      \node at (5.4, 4.2) [anchor=center, font=\fontsize{6.2}{7.5}\selectfont\bfseries, color=mlsysgray] {Sampling Edge 2};

      % Shaded Violation window (drawn BEFORE waveforms so lines stay on top)
      \fill[mlsyslightred!35] (2.0, 0.3) rectangle (3.6, 2.5);
      \draw[draw=mlsysred!70, dashed, line width=0.7pt] (2.0, 0.3) rectangle (3.6, 2.5);

      % Delay annotation arrow
      \draw[{Stealth[scale=0.7]}-{Stealth[scale=0.7]}, draw=mlsysred, line width=0.8pt] (2.0, 2.65) -- (3.6, 2.65);
      \node at (2.8, 2.85) [anchor=center, font=\fontsize{5.8}{7}\selectfont\bfseries, color=mlsysred] {$\Delta t_{\text{droop}}$ (Path delay)};

      % Clock waveform
      \node at (0.6, 3.4) [anchor=east, font=\fontsize{7}{8}\selectfont\bfseries, color=mlsysdarkblue] {Clock};
      \draw[line width=1.1pt, draw=mlsysdarkblue]
        (0.8, 3.7) -- (1.8, 3.7) -- (1.8, 3.1) -- (3.0, 3.1) -- (3.0, 3.7) -- (4.2, 3.7) -- (4.2, 3.1) -- (5.4, 3.1) -- (5.4, 3.7) -- (6.4, 3.7);

      % Expected Data waveform (Green)
      \node at (0.6, 2.1) [anchor=east, font=\fontsize{7}{8}\selectfont\bfseries, color=mlsysdarkgreen] {Expected};
      \draw[line width=1.2pt, draw=mlsysgreen]
        (0.8, 2.4) -- (1.9, 2.4) -- (2.1, 1.8) -- (6.4, 1.8);
      \node at (1.4, 2.55) [anchor=center, font=\fontsize{5.5}{6.5}\selectfont\bfseries, color=mlsysdarkgreen] {Settles early};

      % Observed Data waveform (Red - Delayed transition)
      \node at (0.6, 0.8) [anchor=east, font=\fontsize{7}{8}\selectfont\bfseries, color=mlsysdarkred] {Observed};
      \draw[line width=1.2pt, draw=mlsysred]
        (0.8, 1.1) -- (3.5, 1.1) -- (3.7, 0.5) -- (6.4, 0.5);

      % Sampling point results
      \fill[mlsysred] (3.0, 1.1) circle (2.5pt);
      \node at (3.0, 1.35) [anchor=south, font=\fontsize{6}{7}\selectfont\bfseries, color=mlsysred] {WRONG (High)};

      \fill[mlsysdarkgreen] (5.4, 0.5) circle (2.5pt);
      \node at (5.4, 0.75) [anchor=south, font=\fontsize{6}{7}\selectfont\bfseries, color=mlsysdarkgreen] {CORRECT (Low)};
    \end{scope}

    % Recovery Note
    \draw[draw=mlsysamber, fill=mlsyslightamber!50, rounded corners=2pt, line width=0.6pt] (0.35, 1.68) rectangle (7.25, 2.15);
    \node at (3.8, 1.91) [anchor=center, font=\fontsize{6.2}{7.2}\selectfont\bfseries, color=mlsysdarkamber] {$L(di/dt)$ droop recovers $\to$ subsequent clock cycles sample correctly};

    % Properties Card
    \draw[draw=mlsysgreen, fill=mlsyslightgreen, rounded corners=2.5pt, line width=0.7pt] (0.35, 0.35) rectangle (7.25, 1.55);
    \node at (0.55, 1.30) [anchor=west, font=\fontsize{7}{8}\selectfont\bfseries, color=mlsysdarkgreen] {Temporal Signature: Transient / Dynamic};
    \node at (0.55, 0.98) [anchor=west, font=\fontsize{5.9}{7}\selectfont, color=mlsystext] {\textbf{Physical Cause:} Supply bounce, thermal jitter, dynamic clock skew};
    \node at (0.55, 0.64) [anchor=west, font=\fontsize{5.9}{7}\selectfont, color=mlsystext] {\textbf{Fleet Impact:} Micro-rollback or retry recovers without node reboot};
  \end{scope}
  ...
  \begin{scope}[shift={(8.0, 0)}]
    ...
    \begin{scope}[shift={(0.45, 4.3)}]
      \node at (1.5, 2.1) [anchor=center, font=\fontsize{7}{8}\selectfont\bfseries, color=mlsysdarkgreen] {Cool / Idle (28$^\circ$C)};
      % Die
      ...
      \node at (1.5, 0.9) [anchor=center, font=\fontsize{5.5}{6.5}\selectfont, color=mlsystext] {Cu Bump};
      ...
      \draw[draw=mlsysgreen, fill=mlsyslightgreen, rounded corners=2pt, line width=0.6pt] (0.2, -0.45) rectangle (2.8, -0.15);
      \node at (1.5, -0.3) [anchor=center, font=\fontsize{5.8}{6.8}\selectfont\bfseries, color=mlsysdarkgreen] {Continuity: INTACT (100\%)};
    \end{scope}

    % Sub-panel 2: Hot State (Fatigued Crack Opens)
    \begin{scope}[shift={(4.15, 4.3)}]
      \node at (1.5, 2.1) [anchor=center, font=\fontsize{7}{8}\selectfont\bfseries, color=mlsysdarkred] {Full Load (95$^\circ$C)};
      ...
      \node at (2.32, 1.1) [anchor=west, font=\fontsize{5.5}{6.5}\selectfont\bfseries, color=mlsysred] {Crack};
      ...
      % Status Pill (width matches substrate)
      \draw[draw=mlsysred, fill=mlsyslightred, rounded corners=2pt, line width=0.6pt] (0.1, -0.45) rectangle (2.9, -0.15);
      \node at (1.5, -0.3) [anchor=center, font=\fontsize{5.8}{6.8}\selectfont\bfseries, color=mlsysdarkred] {Continuity: OPEN (Flapping)};
    \end{scope}

    % Thermal cycling graph snippet (width expanded to 6.9 to match column)
    \begin{scope}[shift={(0.35, 1.85)}]
      \draw[draw=mlsysbordergray!80, fill=mlsyslightgray!30, rounded corners=2pt, line width=0.6pt] (0, 0) rectangle (6.9, 1.45);
      \node at (0.2, 1.25) [anchor=west, font=\fontsize{6.5}{7.5}\selectfont\bfseries, color=mlsystext] {Thermal Cycling Pattern:};
      % Sawtooth waveform
      \draw[line width=1pt, draw=mlsysamber]
        (0.4, 0.3) -- (1.2, 0.9) -- (1.8, 0.3) -- (2.6, 0.9) -- (3.2, 0.3) -- (4.0, 0.9) -- (4.6, 0.3);
      \node at (0.4, 0.15) [anchor=center, font=\fontsize{5}{6}\selectfont, color=mlsysgray] {Cold};
      \node at (1.2, 1.05) [anchor=center, font=\fontsize{5}{6}\selectfont, color=mlsysamberdark] {Hot};
      \node at (4.7, 0.8) [anchor=west, font=\fontsize{5.3}{6.5}\selectfont, color=mlsystext] {Backward pass $\to$ heat};
      \node at (4.7, 0.4) [anchor=west, font=\fontsize{5.3}{6.5}\selectfont\bfseries, color=mlsysred] {Crack opens under strain};
    \end{scope}

    % Properties Card
    \draw[draw=mlsyspurple, fill=mlsyslightpurple, rounded corners=2.5pt, line width=0.7pt] (0.35, 0.35) rectangle (7.25, 1.55);
    \node at (0.55, 1.30) [anchor=west, font=\fontsize{7}{8}\selectfont\bfseries, color=mlsysdarkpurple] {Temporal Signature: Intermittent / Sporadic};
    \node at (0.55, 0.98) [anchor=west, font=\fontsize{5.9}{7}\selectfont, color=mlsystext] {\textbf{Operational Dilemma:} Passes cold test; defect surfaces only under load};
    \node at (0.55, 0.64) [anchor=west, font=\fontsize{5.9}{7}\selectfont, color=mlsystext] {\textbf{Fleet Defense:} Health canary runs under load $\cdot$ Auto-cordoning};
  \end{scope}
...
\begin{tikzpicture}[
  ...
  \node[anchor=west, font=\fontsize{7.5pt}{9pt}\selectfont, text=DarkRed] at (0.5, \cTwoY + 0.42)
    {Error detected: Receiver counts 3 ones (odd) but received parity = 0 (even) $\to$ mismatch triggers retransmission request.};
  ...
  \node[anchor=west, font=\fontsize{7pt}{8.5pt}\selectfont, text=TextDark] at (0.6, \cThreeY + 1.55)
    {\textbf{\textcolor{DarkGreen}{Odd Parity:}} Flags any odd error sum};
  \node[anchor=west, font=\fontsize{7pt}{8.5pt}\selectfont, text=TextDark] at (0.6, \cThreeY + 1.20)
    {\textbf{\textcolor{DarkGreen}{Payload:}} Zero payload modification};
  ...
  \node[anchor=west, font=\fontsize{7pt}{8.5pt}\selectfont, text=TextDark] at (5.3, \cThreeY + 1.90)
    {\textbf{\textcolor{OrangeLine!90!black}{No Location:}} Cannot locate flipped bit};
  \node[anchor=west, font=\fontsize{7pt}{8.5pt}\selectfont, text=TextDark] at (5.3, \cThreeY + 1.55)
    {\textbf{\textcolor{OrangeLine!90!black}{No Repair:}} Cannot correct corrupted data};
  \node[anchor=west, font=\fontsize{7pt}{8.5pt}\selectfont, text=TextDark] at (5.3, \cThreeY + 1.20)
    {\textbf{\textcolor{OrangeLine!90!black}{Blind Spot:}} Cancels on even-bit errors};
  ...
  \node[anchor=west, font=\fontsize{7pt}{8.5pt}\selectfont, text=TextDark] at (10.0, \cThreeY + 1.90)
    {\textbf{\textcolor{SteelBlue}{Correction:}} Corrects 1-bit soft errors};
  \node[anchor=west, font=\fontsize{7pt}{8.5pt}\selectfont, text=TextDark] at (10.0, \cThreeY + 1.55)
    {\textbf{\textcolor{SteelBlue}{Detection:}} Detects \& halts on 2-bit flips};
  \node[anchor=west, font=\fontsize{7pt}{8.5pt}\selectfont, text=TextDark] at (10.0, \cThreeY + 1.20)
    {\textbf{\textcolor{SteelBlue}{Standard:}} Mandatory in HBM3 / DDR5};
...
\begin{tikzpicture}[
    ...
    % COLUMN 1: METRICS
    % =========================================================================
    \node[colbox=NavyBlue, minimum width=5.1cm, minimum height=7.5cm] (col1) at (-5.4, 1.0) {};
    \node[colheader=NavyBlue, minimum width=4.9cm] (c1_hdr) at (-5.4, 4.4) {1. METRICS (TIMESERIES)};

    \node[innercard, minimum width=4.7cm] at (-5.4, 3.1) {
    ...
    \node[innercard, minimum width=4.7cm] at (-5.4, 1.25) {
    ...
    \node[innercard, minimum width=4.7cm] at (-5.4, -0.75) {
        ...
        {\scriptsize\textbf{Step:} AllReduce communication time ratio}
    };

    % =========================================================================
    % COLUMN 2: LOGS
    % =========================================================================
    \node[colbox=ForestGreen, minimum width=5.1cm, minimum height=7.5cm] (col2) at (0, 1.0) {};
    \node[colheader=ForestGreen, minimum width=4.9cm] (c2_hdr) at (0, 4.4) {2. LOGS (STRUCTURED EVENTS)};

    \node[innercard, minimum width=4.7cm] at (0, 2.5) {
    ...
    \node[innercard, minimum width=4.7cm] at (0, -0.9) {
    ...
    % COLUMN 3: TRACES
    % =========================================================================
    \node[colbox=BurntOrange, minimum width=5.1cm, minimum height=7.5cm] (col3) at (5.4, 1.0) {};
    \node[colheader=BurntOrange, minimum width=4.9cm] (c3_hdr) at (5.4, 4.4) {3. TRACES (DISTRIBUTED SPANS)};

    \node[innercard, minimum width=4.7cm] at (5.4, 2.8) {
        ...
        {\scriptsize\textbf{Context:} Propagated baggage \& correlation ID}
    };

    \node[innercard, minimum width=4.7cm] at (5.4, -0.65) {
        ...
        \begin{tikzpicture}
            ...
            % bar 5: serializer
            \node[draw=BrickRed!50, fill=BrickRed!12, rounded corners=2pt, minimum width=3.2cm, minimum height=0.38cm, font=\fontsize{7pt}{8pt}\selectfont\color{BrickRed!90!black}] at (0.3, -2.35) {token-stream output serializer};
        \end{tikzpicture}
    };
    ...
    % =========================================================================
    \draw[->, very thick, NavyBlue] (-5.4, -2.75) -- (-5.4, -3.35);
    \draw[->, very thick, ForestGreen] (0, -2.75) -- (0, -3.35);
    \draw[->, very thick, BurntOrange] (5.4, -2.75) -- (5.4, -3.35);

    % =========================================================================
    % BOTTOM PANEL: CORRELATION ENGINE
    % =========================================================================
    \node[draw=gray!40, fill=gray!4, rounded corners=4pt, line width=0.9pt, minimum width=15.9cm, minimum height=3.1cm] (bottom_panel) at (0, -4.95) {};

    \node[align=center] at (0, -3.9) {
    ...
    \node[innercard, minimum width=4.8cm] at (-5.4, -5.3) {
    ...
    \node[innercard, minimum width=4.8cm] at (0, -5.3) {
