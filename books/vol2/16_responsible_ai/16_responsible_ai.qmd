...
\begin{tikzpicture}[
    ...
    \draw[line width=2.8pt, color4, line cap=round] ($(Center)+(-0.35,-0.35)$) -- ($(Center)+(0.35,0.35)$);
    \draw[line width=2.8pt, color4, line cap=round] ($(Center)+(-0.35,0.35)$) -- ($(Center)+(0.35,-0.35)$);
    ...
    \node[font=\LARGE\bfseries\color{color4}] at (-2.0, \yBot) {$\neq$};
    ...
    % Red accent line
    \draw[line width=1.8pt, color4] (1.5, \yBot) -- (2.3, \yBot);

    % Takeaway text
    \node[anchor=west, align=left, font=\bfseries\footnotesize\color{color4}] at (2.5, \yBot) {
