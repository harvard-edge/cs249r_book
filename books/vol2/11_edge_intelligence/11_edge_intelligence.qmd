...
\begin{tikzpicture}[
    ...
    \node[fill=AmberOrange, text=white, rounded corners=3pt, font=\scriptsize\bfseries, inner xsep=6pt, inner ysep=3pt, anchor=north west]
        at ([xshift=0.35cm, yshift=-0.35cm]colB.north west) {B --- HEAD-ONLY};
    ...
    \node[anchor=north east, font=\tiny\bfseries\color{EmeraldGreen}]
        at ([xshift=-0.35cm, yshift=-0.42cm]colC.north east) {Param-Efficient};
...
\begin{tikzpicture}[
    ...
    \node[subcard, minimum width=5.5cm, anchor=north] (a_sec)
        ...
        \begin{minipage}{5.2cm}
            ...
            \centering
            \colorbox{SoftGreen}{\tiny\bfseries\textcolor{EmeraldGreen!90!black}{\ding{51}\ Provably Blinded Transmission}}
        \end{minipage}
    };
    ...
    \node[subcard, draw=DeepBlue!40, fill=white, minimum width=5.4cm, anchor=north] (serv_canc)
        ...
        \begin{minipage}{5.1cm}
            ...
            \colorbox{SoftGreen!90}{\begin{minipage}{4.8cm}
                \centering\tiny\texttt{\textbf{\textcolor{EmeraldGreen!90!black}{$= \Delta\theta_A + \Delta\theta_B$ \ding{51}\ (Mask cancels)}}}
            \end{minipage}}
        \end{minipage}
    };
