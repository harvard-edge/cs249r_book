...
class EdgeMobilenetSizing:
    ...
    stm32_hidden_kb_str = fmt_memory(stm32_hidden, unit=KB, precision=3, commas=False)
...
class EdgeMobileNpuRecap:
    ...
    from mlsysim.fmt import check, fmt_ops_rate
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, fmt_int, fmt_memory, fmt_qty, fmt_qty_int
...
class EdgeTinyTlRecap:
    ...
    from mlsysim.fmt import check, fmt_int, fmt_qty
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt_int, fmt_memory, fmt_qty, fmt_qty_int
...
class EdgeBrainEfficiencyRecap:
    ...
    from mlsysim.fmt import check, fmt, fmt_int, fmt_power

    check(brain_tops_per_w == 50, f"Brain efficiency should be 50 TOPS/W under stated operands, got {brain_tops_per_w:.1f}")
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    brain_tops_per_w_str = fmt_power(brain_tops_per_w * TOPS / watt, unit=TOPS / watt, precision=0, commas=False)
