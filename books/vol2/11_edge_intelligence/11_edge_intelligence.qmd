...
class EdgeDeviceSpectrum:
    ...
    tiny_clock_mhz_str = fmt_frequency(tiny_clock, unit=ureg.megahertz, precision=0, commas=False)
    mobile_clock_ghz_str = fmt_frequency(mobile_clock, unit=ureg.gigahertz, precision=0, commas=False)
