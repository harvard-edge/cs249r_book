...
\begin{tikzpicture}[
  ...
  \node[
    ...
    \tiny\textcolor{TextDark}{Host CPU cores consumed by network interrupt handlers and staging copies}\\[1pt]
  ...
  \node[layer_node, draw=OrangeLine, fill=OrangeL, minimum width=4.9cm] (r_nic) at (\xr-0.5, 1.6) {
    ...
    \tiny\textcolor{OrangeLine!85!black}{\textbf{GPUDirect RDMA:} Hardware offloads Go-Back-N / Selective ACK}
  };

  % Bypass Green Arrow: routed on the right side of the bypass box
  \draw[->, line width=1.5pt, DarkGreen]
    (r_layer2.east) -- (\xr+2.5, 6.9) -- coordinate (bp_mid) (\xr+2.5, 1.6) -- (r_nic.east);
  ...
  \node[
    ...
    \tiny\textcolor{TextDark}{Host CPU free: cores dedicated 100\% to forward/backward matrix math}\\[1pt]
