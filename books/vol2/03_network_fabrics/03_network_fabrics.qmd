...
\begin{tikzpicture}[
  ...
  \node[anchor=center, font=\scriptsize\bfseries, text=OrangeLine!95!black]
  ...
  \node[anchor=north west, inner sep=0pt] at ($(bcard.north west) + (0.35, -0.56)$) {
    \begin{minipage}{10.4cm}
      ...
      \makebox[3.35cm][l]{\textbf{\textcolor{DarkGreen}{Fleet Mitigation:}}}\text{Multi-stage Ring/Tree collectives (no hotspot) + DCQCN/ECN throttling}
    \end{minipage}
  };
