...
\begin{tikzpicture}[
  ...
  \node[font=\tiny\color{EmeraldGreen!90!black}, anchor=west] at (0.6, 2.45) {Condition Check: If signature or MAC fails, branch diverts to halt routine};
  \node[font=\tiny\color{SlateGrey}, anchor=west] at (0.6, 2.15) {Only cryptographically authenticated clients can trigger model inference};
  ...
  \node[draw=CoralRed!70, fill=SoftRed!30, rounded corners=2pt, minimum width=2.1cm, minimum height=0.9cm] (f_s3) at (7.1, 0.8) {
    \begin{minipage}{1.9cm}\centering
      ...
      \tiny\color{CrimsonRed}$\triangle$ Broken
    \end{minipage}
  };
  ...
  \node[font=\tiny\bfseries\color{CrimsonRed}, anchor=west] at (0.6, -0.15) {Exploit Result: Laser pulse forces instruction decoder to read opcode as NOP};
  \node[font=\tiny\color{DarkNavy}, anchor=west] at (0.6, -0.55) {Attacker bypasses signature check without knowing private keys or password};
  \node[font=\tiny\color{SlateGrey}, anchor=west] at (0.6, -0.90) {In ML systems: Corrupts ReLU bias values or extracts raw neural weights};
...
\begin{tikzpicture}[
  ...
  \node[draw=MintGreen!50, fill=SoftGreen!40, rounded corners=2pt, minimum width=2.6cm, minimum height=0.55cm, font=\tiny\bfseries\color{EmeraldGreen!90!black}] at (-8.6, -2.5) {VERIFICATION};
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, fmt_memory, fmt_memory_capacity, fmt_percent, fmt_qty, fmt_time
...
% STAGE 2
% ====================================================
\node[draw=blueborder, fill=white, rounded corners=4pt, inner sep=5pt, text width=4.6cm] (s2) at (2.5, 1.5) {
...
\node[draw=greenborder, fill=white, rounded corners=4pt, inner sep=5pt, text width=6.3cm] (v2) at (8.9, 1.5) {
...
% STAGE 3
% ====================================================
\node[draw=blueborder, fill=white, rounded corners=4pt, inner sep=5pt, text width=4.6cm] (s3) at (2.5, -0.8) {
...
\node[draw=greenborder, fill=white, rounded corners=4pt, inner sep=5pt, text width=6.3cm] (v3) at (8.9, -0.8) {
...
% STAGE 4
% ====================================================
\node[draw=purpleborder, fill=white, line width=0.8pt, rounded corners=4pt, inner sep=5pt, text width=4.6cm] (s4) at (2.5, -3.1) {
...
\node[draw=greenborder, fill=white, rounded corners=4pt, inner sep=5pt, text width=6.3cm] (v4) at (8.9, -3.1) {
...
% ====================================================
\draw[draw=greenborder, fill=greenbg!40, line width=0.8pt, rounded corners=5pt] (0.0, -6.1) rectangle (15.6, -4.9);
\node[fill=greentxt, rounded corners=3pt, inner sep=3pt, font=\sffamily\bfseries\tiny, text=white]
    at (2.1, -5.5) {ROOT OF TRUST ESTABLISHED};

\node[anchor=west, text width=11.2cm] at (3.9, -5.5) {
