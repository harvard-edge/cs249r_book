...
\begin{tikzpicture}[
    ...
    \node[anchor=west] at ([shift={(0.3cm, 0)}] t3_pill.east) {
        \tiny\color{black!65} GPU worker fleet, iteration-level continuous batching, disaggregated prefill/decode
    };
    % SLA
...
\begin{tikzpicture}[
    ...
    \node[draw=BorderGreen, fill=white, rounded corners=4pt, line width=1pt, inner sep=7pt, text width=4.5cm, align=left] (dense) at (20.8, 0) {
        ...
        \centering
        \colorbox{SoftGreen}{\scriptsize\bfseries\textcolor{ForestGreen}{COMPUTE-BOUND (TENSOR CORES)}}
    };
...
\begin{tikzpicture}[
    ...
    \node[card, draw=BorderBlue, text width=4.8cm] (prefill) at (10.9, -4.5) {
        ...
        \centering
        \colorbox{SoftBlue}{\tiny\bfseries\textcolor{BorderBlue}{COMPUTE-BOUND $\cdot$ FP8 TENSOR CORES}}
    };
...
\begin{tikzpicture}[
    ...
    \node[draw=BorderGreen, fill=white, rounded corners=4pt, line width=0.85pt, inner sep=8pt, text width=3.4cm, align=center] (scale_card) at (17.5, -7.75) {
        ...
        \colorbox{SoftGreen}{\small\bfseries\textcolor{ForestGreen}{4$\times$ Peak Throughput}}
    };
