...
% Footnote below
\node[inner sep=0pt, text width=3.4cm, align=center] at (6.2, 0.7) {
...
\node[fill=redbg, rounded corners=3pt, inner sep=2.5pt, font=\sffamily\bfseries\tiny, text=redtxt]
    at (1.9, 8.3) {PANEL A · BIT-FLIP PROPAGATION CASCADE};
\node[anchor=west, font=\sffamily\tiny, text=gray!70!black] at (3.8, 8.3) {Single Weight Exponent Flip Propagation};
...
\node[fill=bluebg, rounded corners=3pt, inner sep=2.5pt, font=\sffamily\bfseries\tiny, text=bluetxt]
    at (11.2, 8.3) {PANEL B · IEEE 754 REPRESENTATION \& HISTOGRAM};
\node[anchor=west, font=\sffamily\tiny, text=gray!70!black] at (13.7, 8.3) {Exponential Value Disruption};
...
\begin{scope}[shift={(-6.3, 0.9)}]
    ...
    \node[draw=color2, fill=color2!10!white, rounded corners=3pt, font=\scriptsize\bfseries, text=color2!80!black, inner sep=3.5pt] at (2.4, 2.0) {\checkmark\ Perfect Margin Separation};
...
\node[draw=gray!25, fill=white, rounded corners=4pt, inner sep=4pt] (geom_d) at (20.4, 2.5) {
    \begin{tikzpicture}[scale=0.8]
        ...
        % Class labels
        \node[font=\tiny\bfseries, color1!80!black] at (-1.3, 0.9) {Class: Panda};
...
\node[samplebox=color2] (s1) at (-8.1, 2.5) {\scriptsize\texttt{\textcolor{color2!80!black}{\checkmark\ Sample \#101: ($x_1$, $y=0$)}}};
\node[samplebox=color2, below=0.15cm of s1] (s2) {\scriptsize\texttt{\textcolor{color2!80!black}{\checkmark\ Sample \#102: ($x_2$, $y=1$)}}};
\node[samplebox=color2, below=0.15cm of s2] (s3) {\scriptsize\texttt{\textcolor{color2!80!black}{\checkmark\ Sample \#103: ($x_3$, $y=0$)}}};
...
\node[draw=gray!30, fill=white, rounded corners=4pt, inner sep=5pt, below=0.25cm of h_col1, text width=6.8cm] (matrix_box) {
    ...
    \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lcccc@{}}
        \textbf{Client Account} & \textbf{Item 1} & \textbf{Item 2} & \textbf{Item 3} & \textbf{Item 4} \\
        \hline\noalign{\smallskip}
        \textcolor{color2!80!black}{User\_001 (Clean)} & 5 $\bigstar$ & 1 $\bigstar$ & -- & 4 $\bigstar$ \\
        \textcolor{color2!80!black}{User\_002 (Clean)} & 4 $\bigstar$ & 2 $\bigstar$ & 5 $\bigstar$ & -- \\
        \textcolor{color2!80!black}{User\_003 (Clean)} & -- & 1 $\bigstar$ & 4 $\bigstar$ & 5 $\bigstar$ \\
        \textcolor{color2!80!black}{User\_004 (Clean)} & 3 $\bigstar$ & -- & 2 $\bigstar$ & 4 $\bigstar$ \\
        \noalign{\smallskip}\hline\noalign{\smallskip}
        \multicolumn{5}{@{}l@{}}{%
            \tikz[baseline=-0.5ex]{\node[draw=color4, fill=color4!8!white, rounded corners=2pt, inner sep=2pt, text width=6.6cm] {
                \texttt{\textcolor{color4!90!black}{Bot\_Sybil\_1 [POISON] \hfill 1 $\bigstar$ \hspace{0.6cm} 5 $\bigstar$}}
            };}%
        }\\[3pt]
        \multicolumn{5}{@{}l@{}}{%
            \tikz[baseline=-0.5ex]{\node[draw=color4, fill=color4!8!white, rounded corners=2pt, inner sep=2pt, text width=6.6cm] {
                \texttt{\textcolor{color4!90!black}{Bot\_Sybil\_2 [POISON] \hfill 1 $\bigstar$ \hspace{0.6cm} 5 $\bigstar$}}
            };}%
        }
    \end{tabular*}
};
