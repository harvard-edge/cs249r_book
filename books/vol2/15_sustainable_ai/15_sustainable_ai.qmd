...
\node[below=4pt, rotate=45, anchor=north east, font=\footnotesize\bfseries, text=bodytext] at (m_rm4) {RM-4};
...
\node[below=4pt, rotate=45, anchor=north east, font=\footnotesize\bfseries, text=bodytext] at (m_rm5) {RM-5};
...
\node[below=4pt, rotate=45, anchor=north east, font=\footnotesize\bfseries, text=bodytext] at (p_nas) {BERT-NAS};
...
\node[below=4pt, rotate=45, anchor=north east, font=\footnotesize\bfseries, text=bodytext] at (p_et) {Evolved Transformer};

% T5
\coordinate (p_t5) at (9.3, 0);
\draw[draw=bookgreen!90, pattern=north east lines, pattern color=bookgreen!80, line width=0.7pt]
    ($(p_t5)+(-\bw/2, 0)$) rectangle ($(p_t5)+(\bw/2, 0.05*\ys)$);
\node[below=4pt, rotate=45, anchor=north east, font=\footnotesize\bfseries, text=bodytext] at (p_t5) {T5};

% Meena
\coordinate (p_mee) at (10.3, 0);
\draw[draw=bookgreen!90, pattern=north east lines, pattern color=bookgreen!80, line width=0.7pt]
    ($(p_mee)+(-\bw/2, 0)$) rectangle ($(p_mee)+(\bw/2, 0.09*\ys)$);
\node[below=4pt, rotate=45, anchor=north east, font=\footnotesize\bfseries, text=bodytext] at (p_mee) {Meena};

% GShard-600B
\coordinate (p_gsh) at (11.3, 0);
\draw[draw=bookgreen!90, fill=bookgreen!30, line width=0.7pt]
    ($(p_gsh)+(-\bw/2, 0)$) rectangle ($(p_gsh)+(\bw/2, 0.008*\ys)$);
\node[below=4pt, rotate=45, anchor=north east, font=\footnotesize\bfseries, text=bodytext] at (p_gsh) {GShard-600B};

% Switch Transformer
\coordinate (p_swt) at (12.3, 0);
\draw[draw=bookgreen!90, pattern=north east lines, pattern color=bookgreen!80, line width=0.7pt]
    ($(p_swt)+(-\bw/2, 0)$) rectangle ($(p_swt)+(\bw/2, 0.07*\ys)$);
\node[below=4pt, rotate=45, anchor=north east, font=\footnotesize\bfseries, text=bodytext] at (p_swt) {Switch Transformer};

% GPT-3
\coordinate (p_gp3) at (13.3, 0);
\draw[draw=bookgreen!90, pattern=north east lines, pattern color=bookgreen!80, line width=0.7pt]
    ($(p_gp3)+(-\bw/2, 0)$) rectangle ($(p_gp3)+(\bw/2, 0.55*\ys)$);
\node[below=4pt, rotate=45, anchor=north east, font=\footnotesize\bfseries, text=bodytext] at (p_gp3) {GPT-3};
...
\node[panel, anchor=north west, minimum width=7.4cm, minimum height=8.4cm] (panelA) at (0, 0) {};
...
\node[panel, anchor=north west, minimum width=7.4cm, minimum height=8.4cm] (panelB) at (7.9, 0) {};
...
\begin{tikzpicture}[
    ...
    % Subtitle at top
    \node[font=\itshape\color{MutedGray}] at (0, 4.0) {Semiconductor Fab Water Cycle --- from Intake to Reclaim};
...
\begin{tikzpicture}[
    ...
    \node[draw=BorderGray!60, fill=white, rounded corners=4pt, text width=\pW-0.7cm, inner sep=4pt, anchor=north] (t2) at (\pX, 4.1) {
    ...
    \node[draw=BorderGreen, fill=LightGreen!30, rounded corners=4pt, text width=\pW-0.7cm, inner sep=4pt, anchor=north] (t3) at (\pX, 1.95) {
    ...
    % Principle footer
    \node[font=\tiny\color{MutedGray}, anchor=south] at (\pX, -0.65) {Economic Principle: Jevons (1865) / Khazzoom-Brookes};
