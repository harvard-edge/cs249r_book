...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import MarkdownStr, check, fmt, fmt_qty
```
...
from mlsysim.fmt import check, fmt, fmt_math, fmt_params, fmt_qty, sci_latex
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, fmt_emissions, fmt_energy, fmt_multiple, fmt_qty, fmt_ratio
...
from mlsysim.fmt import assert_qty_close, check, fmt, fmt_power, fmt_qty
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, fmt_carbon_intensity, fmt_emissions, fmt_energy, fmt_qty
from mlsysim.physics.quantities import carbon_from_energy
...
```{python}
#| echo: false
from mlsysim.fmt import fmt_int, fmt_mass, fmt_power, fmt_qty, fmt_qty_int
...
class MatMulEnergyAnalysis:
    ...
    # ┌── 4. OUTPUT (Formatting) ───────────────────
    e_compute_str = fmt_qty(Hardware.Tech.EffectiveCompute.Gpu.energy_per_flop, pJ / flop, precision=0, commas=False)
    e_move_str = fmt_qty(Hardware.Tech.Memory.DRAM.energy_per_byte, pJ / byte, precision=0, commas=False)
...
from mlsysim.fmt import fmt_power, fmt_qty, fmt_time
...
from mlsysim.fmt import check, fmt, fmt_emissions, fmt_energy, fmt_percent, fmt_power, fmt_qty, fmt_time
from mlsysim.physics.quantities import energy_from_power, carbon_from_energy
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim import Hardware, Infrastructure, Systems
from mlsysim.fmt import check, fmt, fmt_count, fmt_emissions, fmt_energy, fmt_int, fmt_qty, fmt_time
from mlsysim.physics.quantities import energy_from_power, carbon_from_energy
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim import Infrastructure
from mlsysim.fmt import check, fmt, fmt_percent, fmt_power, fmt_qty, fmt_usd
...
```{python}
#| echo: false
from mlsysim.fmt import check, fmt, fmt_count, fmt_power, fmt_qty, fmt_qty_int
...
from mlsysim.fmt import check, fmt, fmt_int, fmt_magnitude, fmt_power, fmt_qty, fmt_specific_heat
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim import ReferenceStats
from mlsysim.fmt import check, fmt, fmt_count, fmt_energy, fmt_params, fmt_percent, fmt_qty
