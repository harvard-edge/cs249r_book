...
\node[below=4pt, rotate=45, anchor=north east, font=\tiny\bfseries, text=bodytext] at (m_rm4) {RM-4};
...
\node[below=4pt, rotate=45, anchor=north east, font=\tiny\bfseries, text=bodytext] at (m_rm5) {RM-5};
...
\node[below=4pt, rotate=45, anchor=north east, font=\tiny\bfseries, text=bodytext] at (p_nas) {BERT-NAS};
...
\node[below=4pt, rotate=45, anchor=north east, font=\tiny\bfseries, text=bodytext] at (p_et) {Evolved Transformer};

% T5
\coordinate (p_t5) at (9.3, 0);
\draw[draw=bookgreen!90, pattern=north east lines, pattern color=bookgreen!80, line width=0.7pt]
    ($(p_t5)+(-\bw/2, 0)$) rectangle ($(p_t5)+(\bw/2, 0.05*\ys)$);
\node[below=4pt, rotate=45, anchor=north east, font=\tiny\bfseries, text=bodytext] at (p_t5) {T5};

% Meena
\coordinate (p_mee) at (10.3, 0);
\draw[draw=bookgreen!90, pattern=north east lines, pattern color=bookgreen!80, line width=0.7pt]
    ($(p_mee)+(-\bw/2, 0)$) rectangle ($(p_mee)+(\bw/2, 0.09*\ys)$);
\node[below=4pt, rotate=45, anchor=north east, font=\tiny\bfseries, text=bodytext] at (p_mee) {Meena};

% GShard-600B
\coordinate (p_gsh) at (11.3, 0);
\draw[draw=bookgreen!90, fill=bookgreen!30, line width=0.7pt]
    ($(p_gsh)+(-\bw/2, 0)$) rectangle ($(p_gsh)+(\bw/2, 0.008*\ys)$);
\node[below=4pt, rotate=45, anchor=north east, font=\tiny\bfseries, text=bodytext] at (p_gsh) {GShard-600B};

% Switch Transformer
\coordinate (p_swt) at (12.3, 0);
\draw[draw=bookgreen!90, pattern=north east lines, pattern color=bookgreen!80, line width=0.7pt]
    ($(p_swt)+(-\bw/2, 0)$) rectangle ($(p_swt)+(\bw/2, 0.07*\ys)$);
\node[below=4pt, rotate=45, anchor=north east, font=\tiny\bfseries, text=bodytext] at (p_swt) {Switch Transformer};

% GPT-3
\coordinate (p_gp3) at (13.3, 0);
\draw[draw=bookgreen!90, pattern=north east lines, pattern color=bookgreen!80, line width=0.7pt]
    ($(p_gp3)+(-\bw/2, 0)$) rectangle ($(p_gp3)+(\bw/2, 0.55*\ys)$);
\node[below=4pt, rotate=45, anchor=north east, font=\tiny\bfseries, text=bodytext] at (p_gp3) {GPT-3};
