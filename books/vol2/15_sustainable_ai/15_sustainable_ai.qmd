...
\node[
    ...
    \begin{minipage}{5.2cm}
        {\bfseries\scriptsize\textcolor{bodytext}{256-GPU H100 Cluster TCO}}\\[4pt]
        \begin{tikzpicture}[x=1cm, y=0.35cm]
            \draw[sharp corners, draw=bookblue!80, fill=hwblue, line width=0.6pt] (0, 0.7) rectangle (0.3, 1.0);
            \node[right=2pt, font=\tiny, text=bodytext] at (0.3, 0.85) {Hardware (CapEx)};
            \draw[sharp corners, draw=bookred!80, fill=coolred, line width=0.6pt] (2.7, 0.7) rectangle (3.0, 1.0);
            \node[right=2pt, font=\tiny, text=bodytext] at (3.0, 0.85) {Cooling (OpEx)};

            \draw[sharp corners, draw=bookorange!80, fill=elecorange, line width=0.6pt] (0, 0.05) rectangle (0.3, 0.35);
            \node[right=2pt, font=\tiny, text=bodytext] at (0.3, 0.2) {Electricity (OpEx)};
            \draw[sharp corners, draw=bookgreen!80, fill=carbongreen, line width=0.6pt] (2.7, 0.05) rectangle (3.0, 0.35);
            \node[right=2pt, font=\tiny, text=bodytext] at (3.0, 0.2) {Carbon Tax (OpEx)};
        \end{tikzpicture}
    \end{minipage}
};
