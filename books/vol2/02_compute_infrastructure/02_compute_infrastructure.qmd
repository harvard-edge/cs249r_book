...
```{python}
#| echo: false
from mlsysim.fmt import fmt_flop_rate, fmt_power, fmt_qty
...
```{python}
#| echo: false
from mlsysim.fmt import fmt_bandwidth, fmt_flop_rate, fmt_power, fmt_qty
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_bandwidth, fmt_flop_rate, fmt_memory_capacity
...
```{python}
#| echo: false
from mlsysim.fmt import fmt_bandwidth, fmt_memory_capacity, fmt_qty
...
```{python}
#| echo: false
from mlsysim.fmt import fmt_bandwidth, fmt_flop_rate, fmt_qty
...
```{python}
#| echo: false
from mlsysim.fmt import fmt, fmt_bandwidth, fmt_int, fmt_memory, fmt_qty, fmt_qty_range, fmt_time
...
```{python}
#| echo: false
from mlsysim.fmt import fmt_flop_rate, fmt_qty
...
```{python}
#| echo: false
from mlsysim.fmt import fmt_power, fmt_qty
...
class B200PerformanceScenarioSecComputeTdpRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    tdp_w_str = fmt_power(Hardware.Cloud.B200.tdp, unit=watt, precision=0, commas=False)
```
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, fmt_power, fmt_qty
...
```{python}
#| echo: false
from mlsysim.fmt import fmt_memory, fmt_qty
...
class InfraFrontierTdpServingRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    frontier_params_b_str = fmt_params(Models.Language.GPT3.parameters, scale="B", precision=0, commas=False)
    weight_gb_str = fmt_memory(Models.Language.GPT3.parameters * BYTES_FP16, unit=GB, precision=0, commas=False)
```
...
```{python}
#| echo: false
from mlsysim.fmt import fmt_bandwidth, fmt_multiple, fmt_qty
...
```{python}
#| echo: false
from mlsysim.fmt import fmt_flop_rate, fmt_memory_capacity, fmt_qty
...
class BandwidthHierarchyNvlinkPodRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    nvlink_bw_gb_per_s_str = fmt_bandwidth(Hardware.Cloud.H100.nvlink.bandwidth_per_direction, unit=GB / second, precision=0, commas=False)
    nvlink_bidirectional_gb_per_s_str = fmt_bandwidth(Hardware.Cloud.H100.nvlink.bandwidth, unit=GB / second, precision=0, commas=False)
```
...
from mlsysim.fmt import fmt, fmt_bandwidth, fmt_int, fmt_qty
