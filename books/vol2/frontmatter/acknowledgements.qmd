...
For the complete and most up-to-date list of all GitHub contributors, please visit the online version at [mlsysbook.ai](https://mlsysbook.ai/vol2/frontmatter/acknowledgements.html). For those interested in contributing, please consult our [GitHub repository](https://github.com/harvard-edge/cs249r_book).
:::
