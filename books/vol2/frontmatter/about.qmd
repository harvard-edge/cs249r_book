...
::: {layout-ncol=4}
![](../compute_infrastructure/images/svg/compute_infrastructure_cxl_bandwidth_gap.svg){width="100%" fig-alt="Margin visual example: a log-scale bandwidth ladder comparing HBM3 with CXL3 and annotating the ratio."}

![](../network_fabrics/images/svg/network_fabrics_pfc_pause_blast.svg){width="100%" fig-alt="Margin visual example: a blast-radius fan showing one pause event propagating to multiple dependent flows."}

![](../data_storage/images/svg/data_storage_checkpoint_storm_write_time.svg){width="100%" fig-alt="Margin visual example: a log-scale time ladder comparing naive checkpoint write time with ZeRO-3 write time."}

![](../sustainable_ai/images/svg/vol2_sustainable_ai_margin_004.svg){width="100%" fig-alt="Margin visual example: an energy ladder showing radio transmission dwarfing local arithmetic on a log scale."}
:::
