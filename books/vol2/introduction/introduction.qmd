...
\tikzset{%
  ...
  TxtCOL/.style={font=\fontsize{7.5}{9.5}\selectfont\sffamily,text=purple!80!black,align=center},
  TxtCENT/.style={font=\fontsize{6.5}{8}\selectfont\sffamily,align=center,text=c1col},
...
\node[TxtC,text=c2col](NC2) at (-3.10, -0.55) {Communication ($C_2$)};
...
\node[TxtC,text=c3col](NC3) at (3.10, -0.55) {Coordination ($C_3$)};
...
\node[TxtC,text=black!80](PC1C2) at (-1.85, 1.75) {$C_1 \cap C_2$};
\node[TxtCOL,below=0pt of PC1C2](THNL) {Hiding Network\\Latency};
\draw[LineA]([xshift=-2pt]THNL.150)--++(150:3.8)coordinate(BOX1);
...
\node[TxtC,text=black!80](PC1C3) at (1.85, 1.75) {$C_1 \cap C_3$};
\node[TxtCOL,below=0pt of PC1C3](TMFG) {Maximizing\\Fleet Goodput};
\draw[LineA]([xshift=2pt]TMFG.30)--++(30:3.8)coordinate(BOX2);
...
\node[font=\fontsize{7}{8.5}\selectfont\sffamily\bfseries,text=c1col] at (0, 0.70) (CENT) {$C_1 \cap C_2 \cap C_3$};
\node[TxtCENT,below=1pt of CENT](CENT_TITLE) {Fleet-Scale\\ML Systems\\Engineering};
\draw[LineA]([xshift=-3pt,yshift=0.5mm]CENT_TITLE.west)--++(175:6.6)coordinate(BOX4);
