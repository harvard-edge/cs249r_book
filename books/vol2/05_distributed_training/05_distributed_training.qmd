...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, fmt_int, fmt_memory_capacity, fmt_percent, fmt_qty, fmt_qty_int
```
...
from mlsysim.fmt import fmt, fmt_params, fmt_percent
...
from mlsysim.fmt import check, fmt_memory, fmt_qty
...
from mlsysim.fmt import check, fmt, fmt_display_math, fmt_int, fmt_memory_capacity, fmt_params, fmt_qty_int
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_count, fmt_magnitude, fmt_math, fmt_memory, fmt_params, fmt_percent, fmt_qty, fmt_time, fmt_tokens
...
class DistTrainNvlinkScaling:
    from mlsysim.core.units import GB, second
    from mlsysim.fmt import fmt, fmt_bandwidth, fmt_qty
...
class DistTrainNvlinkHybridRecap:
    from mlsysim.core.units import GB, second
    from mlsysim.fmt import fmt, fmt_bandwidth, fmt_memory_capacity, fmt_qty
...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, fmt_magnitude, fmt_memory, fmt_memory_capacity, fmt_params, fmt_qty
from mlsysim.physics import memory_from_params
...
class HybridMemoryAccounting:
    ...
    budgeted_static_gb_str = fmt_memory(15 * GB, unit=GB, precision=0, commas=False)
...
from mlsysim.fmt import check, fmt, fmt_memory_capacity, fmt_params, fmt_percent, fmt_qty
...
from mlsysim.fmt import fmt, fmt_count, fmt_count_range, fmt_memory, fmt_memory_capacity, fmt_params, fmt_qty
from mlsysim.physics import memory_from_params
import math
...
from mlsysim import Models
from mlsysim.core.units import GB, second
from mlsysim.fmt import MarkdownStr, fmt, fmt_bandwidth, fmt_memory, fmt_qty

class DistTrainSummaryRecap:
    nvlink_a100_gb_per_s_str = fmt_bandwidth(Hardware.Cloud.A100.nvlink.bandwidth, unit=GB / second, precision=0, commas=False)
    nvlink_h100_gb_per_s_str = fmt_bandwidth(Hardware.Cloud.H100.nvlink.bandwidth, unit=GB / second, precision=0, commas=False)
    gpt4_mem_tb_str = fmt_memory(Models.Language.GPT4.parameters.to(param).magnitude * 2 / TRILLION * TB, unit=TB, precision=1, commas=False)
    dlrm_mem_tb_str = fmt_memory(10 * TB, unit=TB, precision=0, commas=False)
```
