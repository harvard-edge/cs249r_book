...
- Model a multi-tier cache from its hit rate and hit-and-miss service times, including the effect of tail-latency misses
...
- Distinguish storage durability, availability, and consistency by the failure each property addresses
- Specify replay, idempotence, and event-time policies that preserve distributed-pipeline correctness
