...
from mlsysim.fmt import MarkdownStr, check, fmt, fmt_bandwidth, fmt_int, fmt_memory, fmt_qty, fmt_qty_int
...
from mlsysim.fmt import MarkdownStr, check, fmt, fmt_bandwidth, fmt_int, fmt_memory, fmt_qty
...
from mlsysim.fmt import check, fmt, fmt_int, fmt_memory, fmt_qty, fmt_qty_int, fmt_time
...
from mlsysim.fmt import fmt_bandwidth, fmt_qty, fmt_time
...
from mlsysim import Hardware
from mlsysim.fmt import check, fmt, fmt_bandwidth, fmt_qty
...
class HbmModelBudget:
    ...
    adam_eq_math = fmt_math(
        rf"{params.to(Bparam).magnitude:.0f} \times 10^9 \times {bytes_fp32.to(byte).magnitude:.0f} \times {adam_states} = {_adam_res}\text{{ GB}}"
    )
```
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import MarkdownStr, check, fmt, fmt_bandwidth, fmt_time
import math
...
from mlsysim.fmt import check, fmt, fmt_math, fmt_memory, fmt_time
...
from mlsysim.fmt import check, fmt_count, fmt_int, fmt_memory, fmt_multiple, fmt_percent, fmt_qty, fmt_rate, fmt_time
...
class GDSLatency:
    ...
    image_kb_str = fmt_memory(150 * KB, unit=KB, precision=0, commas=False)
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, fmt_int, fmt_memory, fmt_qty, fmt_usd
...
from mlsysim import Models
from mlsysim.fmt import fmt, fmt_count, fmt_memory, fmt_qty, fmt_ratio
