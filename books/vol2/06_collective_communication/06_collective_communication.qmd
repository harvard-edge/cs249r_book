...
from mlsysim.fmt import check, fmt_bandwidth, fmt_count, fmt_math, fmt_memory, fmt_qty, fmt_time
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt, fmt_bandwidth, fmt_count, fmt_memory, fmt_params, fmt_qty, fmt_ratio, fmt_time
...
from mlsysim.fmt import check, fmt_bandwidth, fmt_memory, fmt_qty, fmt_qty_range
...
from mlsysim.fmt import check, fmt_bandwidth, fmt_math, fmt_memory, fmt_qty, fmt_time, sci_latex
...
from mlsysim.core.units import GB, byte, microsecond, ms, param, second
from mlsysim.fmt import check, fmt_int, fmt_memory, fmt_qty, fmt_time
from mlsysim.physics import (
    calc_ring_allreduce_time,
...
from mlsysim.fmt import check, fmt, fmt_bandwidth, fmt_memory, fmt_qty, fmt_time
from mlsysim import Systems
...
import math
from mlsysim.fmt import check, fmt, fmt_bandwidth, fmt_count, fmt_memory, fmt_percent, fmt_qty, fmt_qty_range, fmt_time
...
class CommInfraScenario:
    ...
    # ┌── 3. GUARD (Invariants) ──────────────────────────────────────────
    from mlsysim.fmt import check, fmt_bandwidth, fmt_multiple, fmt_qty
...
from mlsysim.fmt import check, fmt, fmt_bandwidth, fmt_count, fmt_int, fmt_memory, fmt_multiple, fmt_qty, fmt_time
from mlsysim.physics import (
    calc_ring_allreduce_time,
    calc_ring_allreduce_latency_time,
    calc_ring_collective_data_factor,
...
class OverlapBudgetCalc:
    ...
    # ┌── 3. GUARD (Invariants) ──────────────────────────────────────────
    from mlsysim.fmt import check, fmt, fmt_count, fmt_memory, fmt_params, fmt_percent, fmt_qty, fmt_time
...
from mlsysim.fmt import check, fmt_bandwidth, fmt_math, fmt_multiple, fmt_percent, fmt_qty, fmt_time
from mlsysim.physics import (
    calc_ring_allreduce_latency_time,
    calc_ring_allreduce_time,
    calc_ring_collective_data_factor,
...
class CommInfraRecap:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    nvlink_h100_bw_gb_per_s_str = fmt_bandwidth(nvlink_bw, unit=GB / second, precision=0, commas=False)
