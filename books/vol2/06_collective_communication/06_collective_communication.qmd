...
\begin{tikzpicture}[line join=round, line cap=round, font=\small\sffamily]
  ...
  \tikzset{
    ...
    shard_idle/.style={
      ...
      minimum width=0.52cm, minimum height=0.65cm, font=\scriptsize\sffamily, text=black!50
    },
    shard_reduced/.style={
      draw=GreenLine, fill=GreenFill!85, line width=0.8pt, rounded corners=1.5pt,
      minimum width=0.52cm, minimum height=0.65cm, font=\scriptsize\bfseries\sffamily, text=GreenLine!90!black
    },
    ring_arr_blue/.style={
  ...
  \begin{scope}[shift={(0, 5.0)}]
    ...
    \node[anchor=west, font=\normalsize\bfseries\sffamily, text=TextBlack] at (-0.2, 1.9)
      {Phase 1: Scatter-Reduce \mdseries\footnotesize($N-1 = 3$ Transmission Rounds)};
    \node[anchor=east, font=\scriptsize\bfseries\sffamily, text=BlueLine] at (14.2, 1.9)
      {Each Rank Obtains $1/N$ Fully Reduced Shard};
    ...
    \foreach \idx/\rank/\reduced in {
      ...
      \foreach \sidx/\slabel in {1/A, 2/B, 3/C, 4/D} {
        \pgfmathsetmacro{\sxpos}{\xpos - 0.84 + (\sidx - 1) * 0.56}
        \ifnum\sidx=\reduced
          \node[shard_reduced] at (\sxpos, 0.55) {$\slabel^*$};
        \else
    ...
    \node[anchor=north, font=\scriptsize\sffamily, text=GreenLine!90!black] at (6.8, -0.78)
      {\textbf{Scatter-Reduce Result:} Rank $i$ holds global sum $\sum x^{(i)}$ ($A^*$ on G0, $B^*$ on G1, $C^*$ on G2, $D^*$ on G3)};
  ...
  \begin{scope}[shift={(0, 1.2)}]
    % Section Header Band
    \node[anchor=west, font=\normalsize\bfseries\sffamily, text=TextBlack] at (-0.2, 1.9)
      {Phase 2: AllGather \mdseries\footnotesize($N-1 = 3$ Transmission Rounds)};
    \node[anchor=east, font=\scriptsize\bfseries\sffamily, text=GreenLine] at (14.2, 1.9)
      {All Ranks Circulate Shards to Reach Full Vector};
    ...
    \node[anchor=north, font=\scriptsize\sffamily, text=GreenLine!90!black] at (6.8, -0.78)
      {\textbf{AllGather Final State:} Every GPU possesses the complete synchronized gradient tensor $[A^*, B^*, C^*, D^*]$};
