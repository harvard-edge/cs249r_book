...
from mlsysim.fmt import fmt, fmt_count, fmt_int, check, MarkdownStr, fmt_time
...
from mlsysim.fmt import fmt_count, fmt_flop_rate, check
...
from mlsysim.fmt import fmt, fmt_count, fmt_sci_flops, check, fmt_memory, fmt_params, fmt_time
...
\begin{tikzpicture}[
  ...
  \node[anchor=north west, align=left, text width=6.5cm, text=mlsysdarkgray]
    ...
    {\fontsize{8}{11.5}\selectfont
      \checkmark\hspace{5pt}Zero network packet drop or jitter\\[3pt]
      \checkmark\hspace{5pt}Failures are exceptional rare events\\[3pt]
      \checkmark\hspace{5pt}Single OS \& driver control plane\\[3pt]
      \checkmark\hspace{5pt}Deterministic synchronous execution\\[3pt]
      \checkmark\hspace{5pt}Throughput fixed by arithmetic intensity
    }
  };
...
\begin{tikzpicture}[
  ...
  \node[worker] (gw0) at (10.2, -1.6) {
    ...
    {\fontsize{7}{9}\selectfont\textcolor{mlsysblue}{Gradient: ready \checkmark}}
  };
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import check, fmt_time, fmt_length, fmt_rate
