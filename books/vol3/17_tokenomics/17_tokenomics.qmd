...
::: {#exmp-17-amdahls-law-on-an-automated .callout-example title="Amdahl's Law on Regression Repair Fleets"}
...
::: {#exmp-17-cost-and-latency-trade-offs-in .callout-example title="Cost and Latency in Three-Tier Cascades"}
...
::: {#exmp-17-sizing-queue-capacity-and-tail .callout-example title="Queue Sizing under Heavy-Tailed Traffic"}
...
::: {#callout-def-vol3-mlfq-transition-protocol .callout-tip title="Definition 17.1: Multi-Level Feedback Queue Discipline"}
...
::: {#exmp-17-financial-break-even-utilization-for-dedicated .callout-example title="Break-Even for Dedicated Accelerator Fleets"}
...
::: {#exmp-17-hierarchical-multi-agent-budget-allocation-and .callout-example title="Multi-Agent Budget Allocation and Recovery"}
...
::: {#pri-17-end-to-end-verification .callout-principle title="End-to-End Verification in Agent Runtimes"}
...
::: {#exmp-17-architectural-frontier-migration-under-cost .callout-example title="Frontier Migration Under Cost Scaling"}
...
::: {#exmp-17-quantitative-evaluation-of-fleet-goodput .callout-example title="Evaluation of Fleet Goodput per Dollar"}
