...
To eliminate over-subscription and race conditions under concurrent execution, the agent runtime structures financial governance as a *Hierarchical Budget Reservation Ledger* (@fig-vol3-hierarchical-budget-ledger). This architecture treats the parent agent as an authoritative escrow bank and downstream child agents as isolated borrowers operating under non-overlapping credit partitions.
