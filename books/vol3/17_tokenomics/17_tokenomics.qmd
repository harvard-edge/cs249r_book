...
Part VII (*System Synthesis*) runs every subsystem together on one trajectory. @Sec-vol3-conclusion assembles the closure each part built into a single reference architecture and checks the interface contracts between its layers.
:::
