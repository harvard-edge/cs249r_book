...
At 12 agents, the fleet operates at `{python} MultiAgentFleetSizing.s_12_mult_str` the throughput of a single agent while consuming $19.4\times$ the raw token volume. The optimal concurrency boundary is tight ($M^* = 4$), proving that unconstrained multi-agent scaling is mathematically self-defeating.
:::
