...
::: {#dfn-tri-axial-evaluation .callout-definition title="Tri-axial multi-agent evaluation frontier"}
...
::: {#chk-15-orphaned-worker-hazard .callout-checkpoint title="Orphaned worker state corruption hazard"}
