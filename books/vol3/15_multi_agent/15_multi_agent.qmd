...
::: {#exmp-15-critical-path-makespan-and-dag-scheduling .callout-example title="Critical-Path Makespan and DAG Scheduling in Multi-Agent Execution"}
...
::: {#exmp-15-context-desorption-and-serialization-overhead .callout-example title="Context Desorption and Serialization Overhead in Task Delegation"}
...
::: {#exmp-15-provisioning-latency-and-io-bandwidth .callout-example title="Provisioning Latency and I/O Bandwidth in Concurrent Worker Fleets"}
...
::: {#exmp-15-cryptographic-macaroon-verification-latency-at .callout-example title="Cryptographic Macaroon Verification Latency at the Tool Gateway"}
...
::: {#exmp-15-quantitative-evaluation-of-a-parallel .callout-example title="Quantitative Evaluation of a Parallel Refactoring Fleet"}
