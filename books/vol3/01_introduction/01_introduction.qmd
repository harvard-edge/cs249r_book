...
| **CPU Scheduler / Time-Slicing**      | Continuous Batcher & MLFQ          | GPU inference scheduler (vLLM, SGLang)            | Interleaves compute bursts with asynchronous tool waits                  | Chapter 08       |
