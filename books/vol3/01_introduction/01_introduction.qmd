...
class ToolWaitTax:
    ...
    m_hbm_dynamic = c_hbm_node - m_weights
    m_hbm_dynamic_per_gpu = m_hbm_dynamic / n_gpus
    m_kv_gb = 51.2 * GB
    pct_stranded_single = (m_kv_gb / m_hbm_dynamic).magnitude
    m_stranded_concurrent = n_agents_concurrent * m_kv_gb
    pct_stranded_concurrent = (m_stranded_concurrent / m_hbm_dynamic).magnitude
    cost_turn = t_wait.to(second).magnitude * cost_rate_s
    cost_pipeline = n_tools_pipeline * cost_turn
