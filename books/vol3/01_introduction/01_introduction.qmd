...
fig, (ax_en, ax_tm) = plt.subplots(1, 2, figsize=(10.5, 3.8))
...
ax_en.set_title("AC Mains Electrical Energy Breakdown\n(116.9 kJ Total: 69.3% Host vs. 30.7% GPU)", fontsize=9.5, fontweight="bold", pad=8)
...
ax_tm.set_title("Wall-Clock Execution Time Breakdown\n(510s / 8.5 min Total: 82.4% Host vs. 17.6% GPU)", fontsize=9.5, fontweight="bold", pad=8)
