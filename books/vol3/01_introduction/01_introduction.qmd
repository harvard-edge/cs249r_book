...
**Pitfall**: *Holding accelerator High-Bandwidth Memory allocated during blocking tool executions.*
...
* **Hierarchical context memory management:** Transformer context windows operate as the working memory of the agent, constrained by accelerator memory bandwidth and High-Bandwidth Memory capacity. Runtimes must manage state across a multi-tier memory hierarchy: active working context sets, paged virtual memory, prefix caches, and persistent episodic storage.
