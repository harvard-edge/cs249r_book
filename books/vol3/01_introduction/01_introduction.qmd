...
- Classify a task by its horizon, state, and authority exposures (H·S·A) and derive the mechanical bounds and closure evidence level its runtime must supply.
