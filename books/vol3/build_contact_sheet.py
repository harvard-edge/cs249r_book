...
chapters = [
    ...
    ('06_episodic_memory', 'Chapter 06 — Trajectory Memory', 'Part II: The Context Memory Hierarchy'),
    ('07_checkpointing', 'Chapter 07 — Trajectory Checkpointing', 'Part II: The Context Memory Hierarchy'),
    ('08_actuation', 'Chapter 08 — Tool Actuation', 'Part III: The Actuation Boundary'),
    ('09_virtualization', 'Chapter 09 — Execution Sandboxing', 'Part III: The Actuation Boundary'),
    ('10_interrupts', 'Chapter 10 — Asynchronous Interrupts', 'Part III: The Actuation Boundary'),
    ('11_scheduling', 'Chapter 11 — Trajectory Scheduling', 'Part IV: The Policy Compiler'),
    ('12_data_flywheel', 'Chapter 12 — Trajectory Flywheels', 'Part IV: The Policy Compiler'),
    ('13_sft', 'Chapter 13 — Trajectory Fine-Tuning', 'Part IV: The Policy Compiler'),
    ('14_rlvr', 'Chapter 14 — Verifiable Rewards', 'Part IV: The Policy Compiler'),
    ('15_multi_agent', 'Chapter 15 — Multi-Agent Consensus', 'Part V: The Distributed Fleet'),
    ('16_observability', 'Chapter 16 — Trajectory Observability', 'Part V: The Distributed Fleet'),
    ('17_tokenomics', 'Chapter 17 — System Tokenomics', 'Part V: The Distributed Fleet'),
