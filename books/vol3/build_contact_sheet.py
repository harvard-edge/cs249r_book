...
chapters = [
    ('01_introduction', 'Chapter 01 — Introduction', 'The Von Neumann Agent Architecture'),
    ('02_processor', 'Chapter 02 — The Stochastic Processor Contract', 'Part I: The Stochastic Processor'),
    ('03_deliberation', 'Chapter 03 — Test-Time Deliberation & Search', 'Part I: The Stochastic Processor'),
    ('04_working_sets', 'Chapter 04 — Context Working Sets & Budgets', 'Part II: The Context Memory Hierarchy'),
    ('05_virtual_memory', 'Chapter 05 — Virtual Memory & PagedAttention', 'Part II: The Context Memory Hierarchy'),
    ('06_episodic_memory', 'Chapter 06 — Episodic & External Memory', 'Part II: The Context Memory Hierarchy'),
    ('07_checkpointing', 'Chapter 07 — State Checkpointing & Recovery', 'Part II: The Context Memory Hierarchy'),
    ('08_actuation', 'Chapter 08 — Tool Actuation & The Environment', 'Part III: The Actuation Boundary'),
    ('09_virtualization', 'Chapter 09 — System Virtualization & Isolation', 'Part III: The Actuation Boundary'),
    ('10_interrupts', 'Chapter 10 — Asynchronous Interrupts & Escrow', 'Part III: The Actuation Boundary'),
    ('11_scheduling', 'Chapter 11 — Trajectory Scheduling & Cluster', 'Part III: The Actuation Boundary'),
    ('12_data_flywheel', 'Chapter 12 — Trajectory Data Flywheels', 'Part IV: The Policy Compiler'),
    ...
    ('15_multi_agent', 'Chapter 15 — Multi-Agent Topologies & Consensus', 'Part V: The Distributed Fleet'),
    ('16_observability', 'Chapter 16 — Telemetry, Tracing & Evaluation', 'Part V: The Distributed Fleet'),
    ('17_tokenomics', 'Chapter 17 — Sizing & Cost Modeling', 'Part V: The Distributed Fleet'),
    ('18_conclusion', 'Chapter 18 — The Autonomous Frontier', 'Synthesis & Systems Invariants'),
]
