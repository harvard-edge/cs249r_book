...
::: {#nbk-02-kv-cache-memory-explosion-in .callout-notebook title="KV Cache Memory Explosion in a 128k Long-Context Serving Node"}
...
::: {#nbk-02-the-roofline-bound-on-single-token .callout-notebook title="The Roofline Bound on Single-Token Generation"}
