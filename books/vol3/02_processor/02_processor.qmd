...
class KvCacheMemoryExplosion:
    ...
    # ┌── 2. EXECUTE (Compute) ─────────────────────────────────────────────
    mem_kv_token_fp16 = 2 * n_layers * (n_kv_heads * d_head) * bytes_per_elem_fp16
    mem_kv_token_fp8 = 2 * n_layers * (n_kv_heads * d_head) * bytes_per_elem_fp8
...
class StreamCancellationReclamation:
    ...
    # ┌── 2. EXECUTE (Compute) ─────────────────────────────────────────────
    mem_kv_token = 2 * 2 * n_layers * n_kv_heads * d_head * byte
