...
Reclaiming uncommitted speculative cache slots immediately after Phase 3 limits physical memory fragmentation, allowing the serving system to run wide speculation windows without inflating the resident memory tax.
