...
df = pd.read_csv("vol3/tool_interfaces/data/syntax_error_rates.csv")
...
for gen, color, marker in zip(generations, colors, markers):
    ...
    ax.plot(gen_data['Date'], gen_data['ErrorRate'], marker=marker, markersize=5, linewidth=2, label=gen, color=color, alpha=0.9)
