...
```{python}
#| echo: false
#| label: deliberation-pareto-breakeven-notebook
# ┌─────────────────────────────────────────────────────────────────────────────
# │ DELIBERATION PARETO BREAK-EVEN (NOTEBOOK)
# ├─────────────────────────────────────────────────────────────────────────────
...
class DeliberationParetoBreakeven:
    ...
    n_branches_b = 8  # parallel candidate branches
    ...
    vram_ratio_str = fmt(vram_ratio, precision=2)
```
