...
class PhysicalBlockSizing:
    ...
    m_token_gpu = (2 * n_layers * n_kv_heads_gpu * d_head * bytes_per_elem).to(byte)
...
class BreakEvenFrontier:
    ...
    # ┌── 2. EXECUTE (Compute) ─────────────────────────────────────────────
    m_token = 2 * n_layers * n_kv_heads * d_head * bytes_per_elem
...
class HbmSizingMultiTurnAgent:
    ...
    m_token = (2 * n_layers * n_kv_heads * d_head * bytes_per_elem).to(byte)
