...
::: {.column-margin}
![**Contiguous Memory Fragmentation**: Memory allocation breakdown under contiguous tensor layouts, illustrating external fragmentation holes and internal reservation waste as requests arrive and complete.](images/svg/fig-vol3-kv-fragmentation.svg){#fig-vol3-kv-fragmentation width=\"95%\"}
