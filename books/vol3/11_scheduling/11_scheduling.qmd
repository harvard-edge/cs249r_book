...
Forward recovery reduces end-to-end recovery latency by **91.5 percent** ($7.34\text{ s}$ vs. $86.6\text{ s}$) and financial expenditure by **92.5 percent** ($\$0.021$ vs. $\$0.284$). The runtime preserves the completed infrastructure work while resolving the failure via localized state transformation.
:::
...
- Total time elapsed: $4 \times 10.0 \text{ s} = 40.0 \text{ seconds}$ (a 92.0 percent reduction in wall-clock latency).
- Cluster energy expended: $8 \times 700 \text{ W} \times 40 \text{ s} = 0.224 \times 10^6 \text{ J} = 0.062 \text{ kWh}$ (a 92.0 percent reduction in thermal and power load).
- Financial expenditure: Prompt tokens processed drop to approximately $21,000$, resulting in an API charge of $\$0.08$ (a 98.2 percent cost reduction).
:::
