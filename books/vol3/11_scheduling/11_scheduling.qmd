...
::: {#chk-vol3-08-roofline-phase-contention .callout-checkpoint title="The arithmetic intensity divergence and phase contention"}
...
::: {#chk-vol3-08-pareto-mlfq-scheduling .callout-checkpoint title="Heavy-tailed Pareto scheduling and MLFQ"}
...
- [ ] **Chunked prefill budget napkin math**: derive how an iteration token budget $T_{\text{budget}} = B_{\text{dec}} + C$ maintains a stable $25\text{ ms}$ Inter-Token Latency upper bound.
