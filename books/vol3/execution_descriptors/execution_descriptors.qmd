...
@Fig-acb-memory-swapping illustrates the physical hardware data paths and direct memory access (DMA) transfers governing context swapping.
...
# Load data
data = pd.read_csv("vol3/execution_descriptors/data/breakeven_thresholds.csv")
