...
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim import *
from mlsysim.fmt import fmt_memory, fmt_qty_int
...
class CallPrice:
    ...
    kv_final_gb_str = fmt_memory(kv_final_gb * GB, unit=GB, precision=1)
    weights_gb_str = fmt_memory(weights_gb * GB, unit=GB, precision=1)
    resident_gb_str = fmt_memory(resident_gb * GB, unit=GB, precision=1)
    accel_gb_str = fmt_memory(accel_gb * GB, unit=GB, precision=1)
