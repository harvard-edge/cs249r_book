...
## Task Cost Accounting {#sec-vol3-agent-economics-accounting}
...
## Tiered Model Cascades {#sec-vol3-agent-economics-cascades}
...
## Speculative Decoding Acceleration {#sec-vol3-agent-economics-speculative}
...
Even under zero kernel launch overhead and zero runtime software latency, the physical memory bus caps generation at under 24 tokens per second. Over 99.6 percent of the accelerator's compute silicon remains unutilized.
:::
...
## Fleet Capacity Provisioning {#sec-vol3-agent-economics-capacity}
...
## Monotonic Spending Governance {#sec-vol3-agent-economics-governance}
...
## Architectural Selection Frameworks {#sec-vol3-agent-economics-selection}
