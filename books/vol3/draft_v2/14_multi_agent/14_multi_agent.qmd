...
Across the preceding chapters of this book, we engineered the internal architecture of the single autonomous agent: modeling its stochastic processor, managing its volatile context working sets and virtual KV-cache memory [@kwon2023vllm], structuring its non-volatile episodic storage and checkpointing, scheduling its execution lifecycle and unprivileged system calls, and adapting its underlying policy through synthetic rollouts [@silver2016mastering] and reinforcement learning [@schulman2017proximal].
...
-->
![Diagram](/assets/images/diagrams/vol3/fig-mermaid-14_multi_agent-2.png){width="100%"}
