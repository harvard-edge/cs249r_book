...
## The Capstone Reference Architecture {#sec-vol3-conclusion-capstone}[]{#sec-vol3-conclusion-intro}{#sec-vol3-conclusion-synthesis}
...
## Execution Harness Synthesis {#sec-vol3-conclusion-execution}[]{#sec-vol3-conclusion-invariants}
...
## Empirical Safety Cases {#sec-vol3-conclusion-safety}[]{#sec-vol3-conclusion-challenges}
...
3. **Evidence:** Concrete, empirical verification data supporting the argument:
   - Level 1: Deterministic mechanical verification (AST parsers, compiler assertions).
...
## Essential Complexity {#sec-vol3-conclusion-brooks}[]{#sec-vol3-conclusion-hourglass}
