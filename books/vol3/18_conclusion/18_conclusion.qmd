...
::: {#exmp-18-operating-envelope .callout-example title="Sizing the Physical Operating Envelope for an Automated Patch Worker"}
...
::: {#exmp-18-cache-invalidation .callout-example title="Quantitative Cache Invalidation and Memory Footprint across the Agent Hierarchy"}
...
::: {#exmp-18-latency-overhead-mediation .callout-example title="Latency Breakdown and Storage Overhead of Defensive Execution Mediation"}
...
::: {#exmp-18-break-even-weight-adaptation .callout-example title="Quantitative Break-Even Analysis of Weight Adaptation"}
...
::: {#exmp-18-compression-complexity .callout-example title="Quantitative Compression of Accidental vs. Essential Complexity"}
**Problem Statement:**
...
::: {#exmp-18-backtracking-cost .callout-example title="The Combinatorial Cost of Backtracking Search in Dense Trajectories"}
