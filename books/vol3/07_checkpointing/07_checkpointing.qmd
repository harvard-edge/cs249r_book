...
The expected latency $\mathbb{E}[T_{\text{saga}}]$ across all possible execution outcomes over an $N$-step saga evaluates to @eq-checkpoint-expected-saga:
