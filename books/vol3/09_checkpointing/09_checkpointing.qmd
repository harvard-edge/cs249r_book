...
3. **Saga Orchestration for External Tools:** Structuring forward-recovering and backward-compensating sagas, establishing the invariant that compensating actions must be deterministic code rather than LLM prompts.
