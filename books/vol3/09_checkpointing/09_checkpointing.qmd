...
::: {.column-margin}
![](images/svg/vol3_checkpointing_margin_003.svg){width="100%" fig-alt="Paired bar comparison showing 140.6 GiB of memory consumed by 36,000 synchronous thread stacks versus 4.4 GiB consumed by asynchronous Agent Control Block stubs during human approval pauses."}

*Asynchronous escrow stubs reduce dormant memory footprint by 32x during multi-hour human-in-the-loop pauses.*
:::
