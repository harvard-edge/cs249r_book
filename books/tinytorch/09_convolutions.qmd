...
## 9.1 The Failure of Dense Layers for Spatial Data
...
## 9.2 The Mathematics of 2D Convolutions
...
## 9.3 Spatial Dimensions, Padding, and Striding Arithmetic
...
## 9.4 Implementing Conv2d in TinyTorch
...
## 9.5 Spatial Downsampling: MaxPool2d and AvgPool2d
...
## 9.6 Systems Reality: The `im2col` GEMM Transformation
...
## 9.7 Assembling a Convolutional Neural Network (CNN)
