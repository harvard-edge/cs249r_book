...
## 16.1 Overparameterization and the Lottery Ticket Hypothesis
...
## 16.2 Unstructured Magnitude Pruning
...
::: {#fig-pruning-types}
![](../../packages/tinytorch/quarto/assets/images/diagrams/16_compression-diag-1.svg)
...
## 16.3 Structured Pruning: Physically Shrinking Layers
...
## 16.4 Unstructured vs. Structured Hardware Realities
...
| **Hardware Exceptions** | NVIDIA Ampere 2:4 Sparse Tensor Cores | Universal support |

---

## 16.5 Knowledge Distillation: Soft Targets
...
## 16.6 Low-Rank Matrix Factorization (SVD / LoRA)
