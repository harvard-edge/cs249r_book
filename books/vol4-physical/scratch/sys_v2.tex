...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=center, inner sep=0pt] at ([xshift=0.50in, yshift=1.52in]current page.center) {%
    \includegraphics[width=0.96\paperwidth]{/Users/VJ/.gemini/antigravity-cli/brain/8b585c3b-011b-489f-9f2f-84cfe7c1da0e/v2_repeated_network_pw.png}%
  };

  \node[anchor=south west, inner sep=0pt] at ([xshift=\leftm, yshift=2.40in]current page.south west) {%
    {\fontsize{23.5pt}{27.5pt}\rmfamily\selectfont\color{ink}Scaling}%
  };
