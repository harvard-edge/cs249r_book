...
\begin{tikzpicture}[remember picture,overlay]
  ...
  % Artwork node
  \node[anchor=center, inner sep=0pt] at ([xshift=1.10in, yshift=1.90in]current page.center) {%
    \includegraphics[width=0.94\paperwidth]{/Users/VJ/GitHub/MLSysBook-integrate-physical/physical/book/assets/covers/cover-physical-scurve-runnerup-art.png}%
  };
