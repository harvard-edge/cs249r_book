...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=center, inner sep=0pt] at ([xshift=1.15in, yshift=1.50in]current page.center) {%
    \includegraphics[width=1.06\paperwidth]{/Users/VJ/GitHub/MLSysBook-integrate-physical/book/quarto/assets/images/covers/cover-image-transparent-vol1.png}%
  };
