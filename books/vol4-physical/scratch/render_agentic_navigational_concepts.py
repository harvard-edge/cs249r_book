...
concepts = [
    {
        "id": "ag_astrolabe",
        "label": "1. The Digital Astrolabe & Navigational Core ★★★",
        "art": f"{brain_dir}/cover_agentic_astrolabe_1788367890842.jpg",
        "width": "0.96\\paperwidth", "x": "0.50in", "y": "1.52in"
    },
    {
        "id": "ag_sextant_prisms",
        "label": "2. Navigational Dial & Prismatic Tool Crystals ★★",
        "art": f"{brain_dir}/cover_agentic_sextant_prisms_1788368047976.jpg",
        "width": "0.96\\paperwidth", "x": "0.50in", "y": "1.52in"
    },
    {
        "id": "ag_calipers",
        "label": "3. Optical Iris & Precision Tool Calipers ★",
        "art": f"{brain_dir}/cover_agentic_optical_calipers_1788367982000.jpg",
        "width": "0.96\\paperwidth", "x": "0.50in", "y": "1.52in"
    },
    {
        "id": "ag_escapement",
        "label": "4. Clockwork Deliberation Dial & Architectural Steps",
        "art": f"{brain_dir}/cover_agentic_escapement_1788368015608.jpg",
        "width": "0.96\\paperwidth", "x": "0.50in", "y": "1.52in"
    }
]
...
draw.text((25, 18), 'AGENTIC ML SYSTEMS: DIGITAL NAVIGATOR & TOOL-WIELDING CONCEPTS', font=font_title, fill=(20, 20, 20))
...
master_contact_path = os.path.join(brain_dir, 'contact_sheet_agentic_navigational_concepts.png')
grid.save(master_contact_path)

print("Agentic navigational concepts contact sheet saved successfully!")
