...
\begin{tikzpicture}[remember picture,overlay]
  ...
  % Artwork node
  \node[anchor=center, inner sep=0pt] at ([xshift=0.85in, yshift=1.90in]current page.center) {%
    \includegraphics[width=0.90\paperwidth]{/Users/VJ/GitHub/MLSysBook-integrate-physical/physical/book/assets/covers/cover_concept_3_causal_loop.png}%
  };
