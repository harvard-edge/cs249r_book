...
\begin{tikzpicture}[remember picture,overlay]
  ...
  % Artwork node
  \node[anchor=center, inner sep=0pt] at ([xshift=1.15in, yshift=1.52in]current page.center) {%
    \includegraphics[width=1.02\paperwidth]{/Users/VJ/GitHub/MLSysBook-integrate-physical/physical/book/assets/covers/cover-physical-loop-recommended-art.png}%
  };
