...
\begin{tikzpicture}[remember picture,overlay]
  ...
  % Artwork node
  \node[anchor=center, inner sep=0pt] at ([xshift=1.10in, yshift=1.92in]current page.center) {%
    \includegraphics[width=0.98\paperwidth]{/Users/VJ/GitHub/MLSysBook-integrate-physical/book/quarto/assets/images/covers/cover-image-transparent-vol2.png}%
  };
  ...
  \node[anchor=south west, inner sep=0pt] at ([xshift=\leftm, yshift=2.95in]current page.south west) {%
    {\fontsize{23pt}{27pt}\rmfamily\selectfont\color{ink}At Scale}%
  };
