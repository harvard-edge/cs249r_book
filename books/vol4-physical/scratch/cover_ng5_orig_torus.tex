...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=center, inner sep=0pt] at ([xshift=1.15in, yshift=1.95in]current page.center) {%
    \includegraphics[width=0.96\paperwidth]{/Users/VJ/GitHub/MLSysBook-integrate-physical/physical/book/assets/covers/cover-physical-loop-recommended-art.png}%
  };
