...
books = [
    {
        ...
        "color": "A51C30",
        "label": "VOL I: Introduction to (Harvard Crimson #A51C30)",
    ...
    },
    {
        ...
        "author": "Vijay Janapa Reddi",
        "color": "1F407A",
        "label": "VOL II: Scaling (ETH Zurich Blue #1F407A) ★ NEW",
        "art": f"{brain_dir}/cover_vol2_scaling_clean_1788368954957.jpg",
        "width": "0.96\\paperwidth", "x": "0.50in", "y": "1.52in"
    },
    {
        "id": "master_v3_agentic",
        "sub": "Agentic",
        "title": "Machine Learning Systems",
        "author": "Vijay Janapa Reddi",
        "color": "6B21A8",
        "label": "AGENTIC: Decision Waypoints Trajectory (Amethyst #6B21A8) ★ NEW",
        "art": f"{brain_dir}/cover_agentic_waypoints_clean_1788368996111.jpg",
        "width": "0.96\\paperwidth", "x": "0.50in", "y": "1.52in"
    },
    {
        "id": "master_v4_physical",
        "sub": "Physical AI",
        "title": "Machine Learning Systems",
        "author": "Vijay Janapa Reddi",
        "color": "1A4D3E",
        "label": "PHYSICAL AI: Closed Feedback Loop (Deep Emerald #1A4D3E)",
        "art": "/Users/VJ/GitHub/MLSysBook-integrate-physical/physical/book/assets/covers/cover-physical-loop-recommended-art.png",
        "width": "0.96\\paperwidth", "x": "0.50in", "y": "1.52in"
    }
]
...
draw.text((25, 18), 'THE REDESIGNED MACHINE LEARNING SYSTEMS TETRALOGY (Clean Matte Textbook Style)', font=font_title, fill=(20, 20, 20))
...
master_contact_path = os.path.join(brain_dir, 'contact_sheet_clean_matte_tetralogy_series.png')
grid.save(master_contact_path)

print("Clean matte tetralogy series contact sheet saved successfully!")
