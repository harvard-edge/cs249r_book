...
# Render Volume 1 Cover (with its gold-standard right-offset artwork)
...
# Option A: Large Right-Offset Artwork (+1.15in, matching Vol 1 & 2 right offset)
...
# Option B: Moderate Right-Offset Artwork (+0.60in)
...
# Option C: Centered Large Artwork (+0.15in)
...
# Option D: Extra Large Bleed Artwork (+1.30in)
