...
class SystolicEnergy:
    ...
    # ┌── 4. OUTPUT (Formatting) ──────────────────────────────────────────────
    dram_access_pj_str = fmt_energy(ENERGY_DRAM_ACCESS_PJ, unit=pJ, precision=0, commas=False)
    ...
    compute_energy_pj_str = fmt_energy(mac_pj * pJ, unit=pJ, precision=0, commas=False)
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_multiple, fmt_rate
...
class AcceleratorEconomics:
    ...
    # ┌── 4. OUTPUT (Formatting) ─────────────────────────────────────────────
    # V100 specs
    v100_tflop_per_s_str = fmt_flop_rate(h_v100.compute.peak_flops, unit=TFLOP / second, precision=0, commas=False)
    v100_bw_gb_per_s_str = fmt_bandwidth(h_v100.memory.bandwidth, unit=GB / second, precision=0, commas=False)
    ...
    a100_fp16_tflop_per_s_str = fmt_flop_rate(h_a100.compute.peak_flops, unit=TFLOP / second, precision=0, commas=False)
    a100_bw_gb_per_s_str = fmt_bandwidth(h_a100.memory.bandwidth, unit=GB / second, precision=0, commas=True)
    a100_bw_tb_per_s_str = fmt_bandwidth(h_a100.memory.bandwidth, unit=TB / second, precision=2, commas=False)
    ...
    # H100 specs
    h100_tf32_tflop_per_s_str = fmt_flop_rate(h_h100.compute.precision_flops['tf32'], unit=TFLOP / second, precision=0, commas=False)
    ...
    h100_bw_gb_per_s_str = fmt_bandwidth(h_h100.memory.bandwidth, unit=GB / second, precision=0, commas=True)
    ...
    # TPUv4 specs
    tpuv4_tflop_per_s_str = fmt_flop_rate(h_tpu.compute.peak_flops, unit=TFLOP / second, precision=0, commas=False)
    tpuv4_bw_gb_per_s_str = fmt_bandwidth(h_tpu.memory.bandwidth, unit=GB / second, precision=0, commas=True)
...
from mlsysim.fmt import fmt, fmt_bandwidth, fmt_flop_rate, fmt_percent
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt_int, fmt, fmt_energy_per_bit, fmt_flop_rate, fmt_magnitude, fmt_memory, fmt_time
...
# │
# └─────────────────────────────────────────────────────────────────────────────
from mlsysim.fmt import fmt, fmt_bandwidth, fmt_energy, fmt_flop_rate, fmt_percent
...
class FpMemoryEnergyCalc:
    ...
    fp_dram_pj_str = fmt_energy(ENERGY_DRAM_ACCESS_PJ, unit=pJ, precision=0, commas=False)
    fp_sram_pj_str = fmt_energy(ENERGY_SRAM_L1_PJ, unit=pJ, precision=1, commas=False)
