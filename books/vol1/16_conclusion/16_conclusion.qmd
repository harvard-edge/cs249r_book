...
- **ResNet-50**\index{ResNet-50!batching efficiency}: Batch size turns image inference from memory-bound weight movement into compute-bound matrix throughput.
