...
::: {layout-ncol=4}
![](../11_hw_acceleration/images/svg/hw_acceleration_energy_ladder.svg){width="100%" fig-alt="Margin visual example: three horizontal orange bars on a log scale compare DRAM access at 640 pJ, FP32 multiplication at 3.7 pJ, and SRAM access at 0.5 pJ."}

![](../04_data_engineering/images/svg/data_engineering_debt_compounding.svg){width="100%" fig-alt="Margin visual example: two rising curves showing data debt diverging as the accumulation rate increases."}

![](../12_benchmarking/images/svg/vol1_benchmarking_margin_002.svg){width="100%" fig-alt="Margin visual example: a roofline thumbnail showing a batch-size operating point moving toward the compute roof."}

![](../12_benchmarking/images/svg/vol1_benchmarking_margin_001.svg){width="100%" fig-alt="Margin visual example: two stacked latency bars showing that component speedup only partly improves end-to-end latency."}
:::
...
- **The Optimization Path** (efficiency-focused): For engineers working on model efficiency, edge deployment, or resource-constrained systems. After Part I, move directly to @sec-data-selection, @sec-model-compression, @sec-hardware-acceleration, and @sec-benchmarking.
