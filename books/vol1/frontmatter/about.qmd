...
::: {layout-ncol=4}
![](../hw_acceleration/images/svg/hw_acceleration_energy_ladder.svg){width="100%" fig-alt="Margin visual example: three horizontal orange bars on a log scale compare DRAM access at 640 pJ, FP32 multiplication at 3.7 pJ, and SRAM access at 0.5 pJ."}
