...
**Invariant**: Statistical verification holds only over a defined deployment population $P_{\text{deploy}}$, task distance $d$, tolerance $\tau$, and target error $\epsilon$, estimated by a finite-sample procedure at a stated confidence level:
