...
from mlsysim.fmt import fmt_energy, fmt_force, fmt_multiple, fmt_latency, fmt_acceleration, fmt_length, fmt_int, check
...
class BiomechanicalImpactEnvelope:
    ...
    f_unbraked_str = fmt_force(f_unbraked, unit=newton, precision=1)
    f_limit_str = fmt_force(f_iso_limit, unit=newton, precision=0)
