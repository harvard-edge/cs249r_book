...
***Goal-structured physical safety case***\index{Goal-structured physical safety case!definition}\index{Safety case!physical AI} is an explicit claim, argument, and evidence chain for a stated machine, operating envelope, hazard criteria, and fault set. Its warrants identify how tests, analysis, and runtime permission support the bounded claim and where they remain conditional.
...
::: {.column-margin .margin-pointer}
↳ **Downstream:** Cryptographic release manifests enforce runtime configuration locking against field drift in @sec-frontier-epistemic-governance.
:::
