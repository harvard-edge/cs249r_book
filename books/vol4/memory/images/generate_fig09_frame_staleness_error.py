...
def generate_svg():
    ...
    os.makedirs(os.path.dirname('/Users/VJ/GitHub/MLSysBook-vol4-physical/books/vol4/memory/images/svg/fig09_frame_staleness_error.svg'), exist_ok=True)
    with open('/Users/VJ/GitHub/MLSysBook-vol4-physical/books/vol4/memory/images/svg/fig09_frame_staleness_error.svg', 'w') as f:
        f.write('\\n'.join(svg))
