...
- [ ] **Epoch classification**: Can you distinguish the acquisition epoch ($t_0$) from the estimate epoch ($t_{\text{est}}$) and the publication epoch ($t_{\text{pub}}$), and explain why stamping an estimate with its publication time hides the displacement accumulated since capture?
