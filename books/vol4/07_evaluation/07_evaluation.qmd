...
class ClopperPearsonZeroFailure:
    ...
    p_lower_pct_str = fmt_percent(p_lower, precision=1, style="prose")
    failure_upper_pct_str = fmt_percent(failure_upper, precision=1, style="prose")
