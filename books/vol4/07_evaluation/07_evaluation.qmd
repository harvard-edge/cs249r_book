...
The same gap separates each offline metric commonly reported for a learned policy from the machine failure it hides, and @tbl-07-offline-closed-loop-disconnect pairs each with the closed-loop measure that exposes it.
