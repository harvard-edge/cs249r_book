...
|:------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------|
| **`target_odd_boundary`**     | Target ODD bounds: passage width $w \ge 1.5\text{ m}$, illuminance $[200, 1000]\text{ lx}$, surface friction $\mu \ge 0.60$, payload $m \in [0, 15]\text{ kg}$                         | Signed ODD specification; must lie inside the policy manifest's `declared_odd_boundary` | Defining tested conditions and calibrated OOD alerts; physical gating remains independent                      |
