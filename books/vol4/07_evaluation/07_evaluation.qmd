...
::: {#chk-eval-measuring-tuple .callout-checkpoint title="Condition tuples and the target ODD"}
...
- *Mobile Systems:* As derived above, a $1.0^\circ$ heading error spends the aisle's `{python} AisleDrift.clearance_str` side clearance within `{python} AisleDrift.x_impact_str` of travel.
...
- [ ] **Unsupported coverage catalogs**: Can you distinguish supported empirical claims within the target ODD from explicit catalogs of unvisited state spaces?
