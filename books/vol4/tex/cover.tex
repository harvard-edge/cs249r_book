...
\begin{titlepage}\thispagestyle{empty}%
  ...
  {\fontsize{15pt}{17pt}\rmfamily\selectfont Physical AI\par}
  \vspace{0.8\baselineskip}
  {\fontsize{12pt}{14pt}\rmfamily\itshape\color{accentcolor}Machine Learning Systems That Sense and Act\par}
