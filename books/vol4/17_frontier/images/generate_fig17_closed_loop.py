...
SVG_OUT = "svg/fig17_closed_loop_synthesis.svg"
...
svg_template = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 600" font-family="sans-serif">
    ...
    <defs>
        ...
        <!-- Gradients -->
        <linearGradient id="bg-brain" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stop-color="#EBF4FF"/>
            <stop offset="100%" stop-color="#D1E3F8"/>
        </linearGradient>
        <linearGradient id="bg-nervous" x1="0" y1="0" x2="0" y2="1">
    ...
    <text x="500" y="40" font-size="24" font-weight="bold" fill="#2D3748" text-anchor="middle">The Closed Causal Loop and Epistemic Boundary Synthesis</text>
    ...
    <g transform="translate(50, 100)">
        ...
        <path fill="none" d="M 125 140 L 125 200" stroke="#1F407A" stroke-width="2" marker-end="url(#arrow-blue)"/>
    </g>
    ...
    <g transform="translate(375, 100)">
        ...
        <path fill="none" d="M 125 260 L 125 300" stroke="#2D3748" stroke-width="2" marker-end="url(#arrow)"/>
    </g>
    ...
    <g transform="translate(700, 100)">
        ...
        <path fill="none" d="M 125 140 L 125 200" stroke="#A51C30" stroke-width="2" marker-end="url(#arrow-red)"/>
        <path fill="none" d="M 125 260 L 125 320" stroke="#A51C30" stroke-width="2" marker-end="url(#arrow-red)"/>
    </g>

    <!-- Connectors -->
    <!-- Brain to Nervous System (Proposal) -->
    <path fill="none" d="M 300 230 L 375 230" stroke="#1F407A" stroke-width="2" marker-end="url(#arrow-blue)"/>
    ...
    <text x="662" y="320" font-size="12" font-weight="bold" fill="#2D3748" text-anchor="middle">Command</text>

    <!-- Body to Brain/Nervous System (Feedback) -->
    <path fill="none" d="M 825 380 L 825 540 L 150 540 L 150 500" stroke="#A51C30" stroke-width="2" marker-end="url(#arrow-red)"/>
    <path fill="none" d="M 150 540 L 500 540 L 500 500" stroke="#A51C30" stroke-width="2" marker-end="url(#arrow-red)"/>
    
    <text x="500" y="530" font-size="12" font-weight="bold" fill="#A51C30" text-anchor="middle">Sensor DMA Ring Buffers (y(t))</text>
