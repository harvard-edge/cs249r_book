...
from mlsysim.fmt import check, fmt, fmt_qty, fmt_latency
...
class PlanningStalePoseGap:
    ...
    w_joint_str = fmt_qty(w_joint, ureg.radian / second, precision=2)
    gap_str = fmt_qty(gap, ureg.radian, precision=3)
...
from mlsysim.fmt import check, fmt_length, fmt_qty
...
class PlanningMonitorTrip:
    ...
    f_contact_str = fmt_qty(f_contact, ureg.newton, precision=0)
```
