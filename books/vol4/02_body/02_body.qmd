...
::: {.column-margin .margin-pointer}
↰ **Prerequisite:** Kinetic momentum dissipation limits enforce the non-smooth contact mechanics derived in @sec-body-actuator-limits.
:::
...
::: {.column-margin .margin-pointer}
↰ **Prerequisite:** Thermal and power integrity budgets depend on the deterministic fieldbus clocks analyzed in @sec-nervous-deterministic-fieldbuses.
:::
