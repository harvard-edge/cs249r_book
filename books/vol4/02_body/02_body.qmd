...
To build physical intuition, consider trying to swing a sledgehammer holding the very tip of the handle versus choking up near the iron head, or riding a multi-speed bicycle up a steep hill in the highest gear ($N \gg 1$). In high gear, every tiny push on the pedal requires massive leg force because your legs fight the high mechanical leverage of the rear wheel. Now reverse the perspective: try to spin the rear wheel backward by hand while the bike is in top gear—the wheel feels completely locked, because the pedal crank inertia is reflected back to the wheel multiplied by the square of the gear ratio ($N^2$). In a robotic arm with a $100:1$ strain-wave transmission, when an obstacle impacts the gripper, the environment does not meet a lightweight compliant motor; it collides with a massive, unyielding $11.2\text{ kg}$ flywheel locked in place. Any rapid external deflection or sudden command step cannot spin up the motor rotor in time; instead, the impact shock wave concentrates directly into the tooth root fillets of the flexspline, risking fatigue shear fracture (@fig-02-real-broken-gear-tooth).
