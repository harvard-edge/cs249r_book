...
def generate_svg():
    ...
    <g transform="translate(50, 80)">
        ...
        <text x="200" y="140" class="label" text-anchor="middle">Time (ms)</text>
        ...
        <path d="M 0 100 Q 100 90 200 80" class="chunk-a" />
        <path d="M 200 40 Q 300 50 400 60" class="chunk-b" />
        ...
        <text x="200" y="340" class="label" text-anchor="middle">Time (ms)</text>
        ...
        <!-- Torque Plot -->
        <path d="M 0 300 Q 100 295 199 290" class="chunk-a" />
        <path d="M 201 290 Q 300 295 400 300" class="chunk-b" />
        <path d="M 199 290 L 200 170 L 201 290" class="error-line" />
        
        <!-- Torque callout -->
        <rect x="220" y="180" width="160" height="55" class="callout-box" />
        <text x="230" y="195" class="alert-text">τ = 324 N·m impulse</text>
        <text x="230" y="210" class="callout-text">Exceeds yield limit!</text>
        <text x="230" y="225" class="callout-text">Result: Drive pin fracture</text>
    </g>
    ...
    <g transform="translate(550, 80)">
        ...
        <!-- Velocity Plot -->
        <path d="M 0 100 Q 75 92 150 85" class="chunk-a" />
        <!-- 5th order spline bridge from (150, 85) to (250, 45) -->
        <path d="M 150 85 C 190 80, 210 50, 250 45" class="bridge-line" />
        <path d="M 250 45 Q 325 55 400 65" class="chunk-b" />
        ...
        <!-- Torque Plot -->
        <path d="M 0 300 Q 75 296 150 292" class="chunk-a" />
        <path d="M 150 292 C 180 310, 220 270, 250 298" class="bridge-line" />
        <path d="M 250 298 Q 325 301 400 304" class="chunk-b" />
