...
::: {#pri-nervous-silicon-privilege .callout-note title="Silicon Privilege Partitioning"}
...
::: {#dfn-nervous-lock-free-sequence-lock-seqlock .callout-definition title="Lock-Free Sequence Lock (`seqlock`)"}
...
::: {#pri-nervous-cadence-decoupling .callout-note title="Lock-Free Cadence Decoupling"}
...
::: {#pri-nervous-hardware-authority .callout-important title="Hardware Authority Invariant"}
