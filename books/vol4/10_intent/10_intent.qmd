...
class IntentLeaseArchetypes:
    ...
    # Class 3 contrast
    c_thermal_str = fmt_qty(c_thermal_bess, joule / kelvin, precision=0)
    p_heat_str = fmt_qty(p_heat_in, watt, precision=0)
    dt_overshoot_str = fmt_qty(delta_t_overshoot_max, kelvin, precision=0)
