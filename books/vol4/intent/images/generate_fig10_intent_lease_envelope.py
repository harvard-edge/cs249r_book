...
svg_content = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 600" width="1000" height="600" style="background-color: white; font-family: sans-serif;">
  ...
  <text x="40" y="40" class="title">Panel A: Spatial Tolerance Volume &amp; Admissible Envelope</text>
  ...
  <g transform="translate(240, 310)">
    ...
    <text x="10" y="-10" class="text-bold" fill="#1F407A">p₀ (Nominal Target)</text>
    
    <!-- Semi-axes labels -->
    <text x="60" y="-20" class="text-small">a_x = 11.2 mm</text>
    <text x="50" y="40" class="text-small">a_y = 16.8 mm</text>
    <text x="-90" y="100" class="text-small">a_z = 41.9 mm</text>
    
    <!-- Approach velocity -->
    <line x1="-120" y1="-150" x2="-20" y2="-25" class="vector-blue" />
    <text x="-160" y="-140" class="text-bold" fill="#1F407A">v_approach ≤ 0.25 m/s</text>
    ...
    <text x="-130" y="60" class="text-bold" fill="#A51C30">F_max ≤ 12 N</text>
    <text x="-130" y="75" class="text-small" fill="#A51C30">(Admissible Wrench)</text>
  ...
  <text x="480" y="40" class="title">Panel B: Temporal Expiration Timelines (Multi-rate Execution)</text>
  ...
  <g transform="translate(500, 260)">
    ...
    <text x="35" y="30" class="text-small">0ms</text>
    <circle cx="40" cy="40" r="4" fill="#38A169" />
    <text x="35" y="20" class="text-small" fill="#38A169">Lease Issued</text>
    
    <line x1="120" y1="35" x2="120" y2="45" class="axis" />
    <text x="110" y="30" class="text-small">80ms</text>
    <circle cx="120" cy="40" r="4" fill="#A51C30" />
    <text x="100" y="15" class="text-small" fill="#A51C30">Host Hangs</text>
    <text x="100" y="75" class="text-small" fill="#A51C30">(No Abort Msg)</text>
    
    <line x1="190" y1="35" x2="190" y2="45" class="axis" />
    <text x="180" y="30" class="text-small">150ms</text>
    <circle cx="190" cy="40" r="4" fill="#E53E3E" />
    <text x="180" y="15" class="text-small" fill="#E53E3E">TTL Expires</text>
    
    <line x1="302" y1="35" x2="302" y2="45" class="axis" />
    <text x="290" y="30" class="text-small">262ms</text>
    ...
    <text x="210" y="110" class="text-small" fill="#1F407A">Autonomous Deceleration</text>
    <text x="210" y="125" class="text-small" fill="#1F407A">t_decel = 112ms, d_stop = 28mm</text>
    <text x="310" y="135" class="text-small" fill="#1F407A">Active Hold</text>
  </g>
  ...
  <g transform="translate(500, 440)">
    ...
    <text x="35" y="30" class="text-small">0ms</text>
    <circle cx="40" cy="40" r="4" fill="#38A169" />
    <text x="35" y="20" class="text-small" fill="#38A169">Goal Sent</text>
    ...
    <path d="M 40 80 L 320 80 L 320 10" fill="none" stroke="#A51C30" stroke-width="2.5" />
    
    <text x="310" y="5" class="text-bold" fill="#A51C30">IMPACT!</text>
    <text x="200" y="75" class="text-small" fill="#A51C30">Open-loop continuation at 1.4 m/s</text>
    <text x="250" y="100" class="text-small" fill="#A51C30">F_peak = 1420 N</text>
  </g>

</svg>
"""

with open("/Users/VJ/GitHub/MLSysBook-vol4-physical/books/vol4/intent/images/svg/fig10_intent_lease_envelope.svg", "w") as f:
    f.write(svg_content)
