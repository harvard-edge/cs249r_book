...
- [ ] **Transport lag vs. braking power**: Can you distinguish between the spatial cost of computational transport delay ($v \cdot \tau_{\text{delay}}$) and active braking ($v^2 / 2 a_{\max}$), identifying which term dominates at low crawling speeds versus high transit speeds?
