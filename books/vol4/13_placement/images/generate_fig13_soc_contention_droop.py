...
def build_svg():
    ...
    ET.SubElement(svg, 'text', x="410", y="215", class_="warn").text = "Wait: 27.6 µs"
    
    # Timing Waterfall
    ET.SubElement(svg, 'text', x="20", y="270", class_="title").text = "Timing Waterfall (1.0 ms control loop)"
    
    # Axis
    ET.SubElement(svg, 'path', d="M 20 290 L 480 290", class_="line")
    ET.SubElement(svg, 'text', x="20", y="305", class_="small").text = "0"
    ET.SubElement(svg, 'text', x="370", y="305", class_="small").text = "120 µs Budget"
    ET.SubElement(svg, 'path', d="M 360 285 L 360 350", class_="line-dashed")
    ...
    # Vertical Divider
    ET.SubElement(svg, 'path', d="M 500 20 L 500 430", class_="line-dashed")
    ...
    ET.SubElement(svg, 'path', d="M 580 140 L 640 140 L 650 60 L 920 60", class_="line-red")
    ...
    ET.SubElement(svg, 'path', d="M 580 180 L 640 180 L 655 260 L 680 190 L 710 200 L 740 185 L 920 185", class_="line-blue")
    ET.SubElement(svg, 'path', d="M 580 250 L 920 250", class_="line-dashed")
    ET.SubElement(svg, 'text', x="920", y="245", class_="warn", text_anchor="end").text = "Vmin = 0.78 V"
    ET.SubElement(svg, 'text', x="520", y="185", class_="text").text = "0.85 V"
    
    ET.SubElement(svg, 'text', x="660", y="295", class_="warn").text = "ΔV = 138 mV Droop (16.2% collapse)"
