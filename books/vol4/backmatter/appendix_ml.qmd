...
class AppxTsdfVoxelGrid:
    ...
    # ┌── 4. OUTPUT (Formatting) ───────────────────
    workspace_str = fmt_qty(workspace, meter**3, precision=0)
    side_x_str = fmt_qty(side_x, meter, precision=0)
    side_y_str = fmt_qty(side_y, meter, precision=0)
    side_z_str = fmt_qty(side_z, meter, precision=0)
    pitch_coarse_str = fmt_qty(pitch_coarse, ureg.cm, precision=0)
    pitch_fine_str = fmt_qty(pitch_fine, ureg.mm, precision=0)
    ...
    depth_rate_str = fmt_qty(depth_rate, Hz, precision=0)
    ray_rate_str = fmt_count(ray_rate.magnitude, scale="M", precision=3, scale_style="word")
    ray_range_str = fmt_qty(ray_range, meter, precision=0)
