...
## Artificial Intelligence Beyond Glass {#sec-boundary-1-1}
...
## The Causal Boundary {#sec-boundary-1-2}
...
Before examining the four architectural pillars, verify your diagnostic ability to categorize ambiguous autonomous machines:

- [ ] **Three-pillar scope evaluation**: Can you evaluate whether an automated system qualifies as Physical AI by testing for the simultaneous presence of an unspecifiable learned model, consequential physical feedback, and delegated actuator authority?
...
## When the Boundary Fails {#sec-boundary-1-6}
...
## The Architecture of This Book {#sec-boundary-1-10}
