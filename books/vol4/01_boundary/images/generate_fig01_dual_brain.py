...
<!-- Sensor Input Arrow -->
<g id="sensor_input">
    <line x1="400" y1="20" x2="400" y2="40" stroke="#333333" stroke-width="4" marker-end="url(#arrow-down)"/>
    <text x="400" y="15" font-family="Arial, sans-serif" font-size="16" font-weight="bold" fill="#333333" text-anchor="middle">Sensor Data</text>
</g>
...
<!-- IPC Arrows: NPU to Mailbox -->
<line x1="260" y1="300" x2="260" y2="340" stroke="#333333" stroke-width="4" marker-end="url(#arrow-down)"/>
<text x="240" y="325" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#333333" text-anchor="end">Action Proposals</text>

<!-- IPC Arrows: Mailbox to NPU -->
<line x1="540" y1="350" x2="540" y2="310" stroke="#333333" stroke-width="4" marker-end="url(#arrow-up)"/>
...
<!-- IPC Arrows: Mailbox to MCU -->
<line x1="260" y1="500" x2="260" y2="540" stroke="#333333" stroke-width="4" marker-end="url(#arrow-down)"/>
<text x="240" y="525" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#333333" text-anchor="end">Read Commands</text>

<!-- IPC Arrows: MCU to Mailbox -->
<line x1="540" y1="550" x2="540" y2="510" stroke="#333333" stroke-width="4" marker-end="url(#arrow-up)"/>
