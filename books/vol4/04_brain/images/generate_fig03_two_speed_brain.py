...
def create_svg():
    ...
    <rect x="380" y="70" width="240" height="30" rx="4" fill="#FFFFFF" stroke="#2D3748" stroke-width="2" />
    ...
    <rect x="155" y="440" width="200" height="50" rx="6" fill="#1F407A" />
    ...
    <path d="M 845 465 C 930 465, 950 400, 950 305 L 920 305" class="arrow" fill="none" />
    <text x="960" y="380" text-anchor="middle" class="text-small" transform="rotate(-90 960 380)">1000 Hz State Feedback</text>
