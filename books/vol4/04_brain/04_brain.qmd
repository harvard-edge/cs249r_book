...
The cognitive tier in @fig-04-locator traces the path from ingestion and perception through memory, intent, and planning. Together, these stages turn sensory evidence into a proposal about what the body should attempt next. The physical budgets established in @sec-body still bound that proposal, and the nervous system retains execution authority. Building on the causal boundary established in @sec-boundary-1-2, this division lets the brain reason about an uncertain scene without making physical protection depend on the success of that reasoning.
