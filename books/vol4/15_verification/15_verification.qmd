...
class RackEndVerification:
    ...
    payload_str = fmt_mass(payload, unit=kilogram, precision=0)
...
fig, ax = plt.subplots(figsize=(14.0, 8.0), dpi=300, facecolor="#FFFFFF")
...
ax.plot(
    ...
    color="#1E3A8A",
    linewidth=2.8,
    label=r"Required 0-Failure Hours: $T_{95\%} = 3.0 / \lambda$ (95% Conf.)",
)
ax.plot(
    lam,
    T_99,
    ...
    linewidth=1.6,
    linestyle="--",
    label=r"Upper 99% Confidence Bound ($T_{99\%} = 4.61 / \lambda$)",
)
...
standards = [
    {
        "name": "Police Crashes",
        "sub": r"$6 \times 10^{-5}$/hr",
        "val": 6e-5,
        "color": "#64748B",
        "y_pos": 8e1,
    },
    {
        "name": "IEC 61508 SIL 1",
        "sub": r"$10^{-5}$/hr",
        "val": 1e-5,
        "color": "#D97706",
        "y_pos": 8e2,
    ...
    {
        "name": "Human Fatality (NHTSA)",
        "sub": r"$3.5 \times 10^{-7}$/hr",
        "val": 3.5e-7,
        "color": "#047857",
        "y_pos": 2e4,
    },
    ...
    },
    {
        ...
        "sub": r"10 FIT ($10^{-8}$/hr)",
        "val": 1e-8,
        "color": "#DC2626",
        "y_pos": 3e5,
    },
    {
        "name": "FAA Aviation / SIL 4",
        "sub": r"1 FIT ($10^{-9}$/hr)",
        "val": 1e-9,
        "color": "#7C3AED",
        "y_pos": 1e6,
...
fleets = [
    {
        "name": "Cruise (Pre-Oct 2023 Suspension)",
        "hrs": 4.0e5,
        "color": "#FB7185",
        "y_text": 6.2e5,
        "desc": "10M miles @ 25 mph",
        "label_hrs": "~400,000 hrs",
    },
    {
        "name": "Waymo Rider-Only (L4 Fleet 2025–2026)",
        "hrs": 7.0e6,
        "color": "#06B6D4",
        "y_text": 1.1e7,
        "desc": "200M miles @ 28 mph",
        "label_hrs": "~7.0 Million hrs",
    },
    {
        "name": "Tesla FSD Supervised (L2 Fleet 2026)",
        "hrs": 2.5e8,
        "color": "#1E3A8A",
        "y_text": 3.8e8,
        "desc": "8.5B miles @ 35 mph (L2)",
        "label_hrs": "~250 Million hrs",
    },
]
...
ax.annotate(
    ...
    xytext=(1e-8, 7e6),
    textcoords="data",
    arrowprops=dict(arrowstyle="<->", color="#DC2626", linewidth=2.4),
)
...
ax_yr.set_ylabel(
    "Continuous Single-Vehicle Operating Years ($T / 8760$)",
    fontsize=11,
    fontweight="bold",
    color="#1E293B",
    labelpad=12,
...
ax.set_xlabel(
    r"Target Failure Rate $\lambda$ per Operating Hour (Failures / Hour, log scale)",
    fontsize=11,
    fontweight="bold",
    color="#1E293B",
)
ax.set_ylabel(
    r"Required Zero-Failure Operating Hours ($N = 3 / \lambda$, log scale)",
    fontsize=11,
    fontweight="bold",
    color="#1E293B",
)
ax.set_title(
    "The Astronomical Exposure Wall: Target Failure Rates vs. Required Zero-Failure Operating Hours",
    fontsize=13.0,
    fontweight="bold",
    pad=16,
    color="#1E293B",
)
ax.legend(loc="lower left", fontsize=9.0, framealpha=0.95, edgecolor="#CBD5E1")
