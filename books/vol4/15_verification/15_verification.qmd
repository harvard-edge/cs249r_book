...
A machine can pass every isolated fault test and still fail when a shared rail, bus, or clock couples the faults or disables their detectors. These are the compound faults that @sec-verification-compound-faults enumerates from shared causes. Compound tests catch such failures only when enough galvanically or logically independent instrumentation survives the fault to establish the sequence of events.\index{Fault coupling!shared resources}
