...
python3 ./tools/content/cross_refs/cross_refs.py \
    -g \
    -m ./tools/content/cross_refs/t5-mlsys-domain-adapted/ \
...
python3 ./tools/content/cross_refs/cross_refs.py ... -t 0.6

# More references, lower quality (294 refs)  
python3 ./tools/content/cross_refs/cross_refs.py ... -t 0.4

# Very high quality, very few (36 refs)
python3 ./tools/content/cross_refs/cross_refs.py ... -t 0.65
```
...
python3 ./tools/content/cross_refs/evaluate_explanations.py \
...
python3 ./tools/content/cross_refs/cross_refs.py ... --verbose
```
...
python3 ./tools/content/cross_refs/cross_refs.py -g ... 
...
# Test with sample
python3 ./tools/content/cross_refs/cross_refs.py ... --ollama-model new-model:version --sample 10
