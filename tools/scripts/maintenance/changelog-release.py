...
def generate_release_notes_from_changelog(version, previous_version, description, changelog_entry, model="gemma2:9b", verbose=False):
    """Generate AI-powered release notes using changelog data."""
