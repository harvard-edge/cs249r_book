...
# Use specific model
python3 tools/content/improve_figure_captions.py -d contents/core/ -m gemma2:9b

# Process specific files
python3 tools/content/improve_figure_captions.py -f contents/core/introduction/introduction.qmd
```
...
python3 tools/content/improve_figure_captions.py --improve -d contents/core/

# With different model
python3 tools/content/improve_figure_captions.py -i -d contents/core/ -m gemma2:9b

# Multiple directories
python3 tools/content/improve_figure_captions.py -d contents/core/ -d contents/frontmatter/
```
...
python3 tools/content/improve_figure_captions.py -b -d contents/core/

# Analyze caption quality and validate structure
python3 tools/content/improve_figure_captions.py --analyze -d contents/core/
python3 tools/content/improve_figure_captions.py -a -d contents/core/

# Fix formatting issues only (no LLM)
python3 tools/content/improve_figure_captions.py --repair -d contents/core/
python3 tools/content/improve_figure_captions.py -r -d contents/core/
```

### Development and Debugging
```bash
# Save detailed JSON output for inspection
python3 tools/content/improve_figure_captions.py -d contents/core/ --save-json

# List available Ollama models
python3 tools/content/improve_figure_captions.py --list-models

# Process single file for testing
python3 tools/content/improve_figure_captions.py -f contents/core/introduction/introduction.qmd -m gemma2:9b
```
...
# Check specific file
python3 tools/content/improve_figure_captions.py -f problematic_file.qmd --save-json
```
