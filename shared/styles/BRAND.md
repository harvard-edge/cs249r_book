...
- [`books/config/_quarto-html-vol1.yml`](../../books/config/_quarto-html-vol1.yml) — `#A51C30`
- [`books/config/_quarto-html-vol2.yml`](../../books/config/_quarto-html-vol2.yml) — `#1F407A`
...
- TinyTorch site: SCSS at [`packages/tinytorch/quarto/assets/styles/style.scss`](../../packages/tinytorch/quarto/assets/styles/style.scss) and [`dark-mode.scss`](../../packages/tinytorch/quarto/assets/styles/dark-mode.scss)

### Inline CSS in `.qmd`

- [`materials/instructors/index.qmd`](../../materials/instructors/index.qmd) — uses `#A51C30` extensively in inline styles.
...
- [`materials/instructors/assets/styles/style.scss`](../../materials/instructors/assets/styles/style.scss)
- [`labs/assets/styles/style.scss`](../../labs/assets/styles/style.scss)
- [`kits/assets/styles/style.scss`](../../kits/assets/styles/style.scss)
- [`materials/slides/assets/styles/style.scss`](../../materials/slides/assets/styles/style.scss)
- [`packages/mlsysim/docs/styles/style.scss`](../../packages/mlsysim/docs/styles/style.scss)
...
- Python: [`packages/mlsysim/mlsysim/viz/plots.py`](../../packages/mlsysim/mlsysim/viz/plots.py) defines `crimson = "#A51C30"`.
