...
The maintained [work checklist](docs/internal/WORK_CHECKLIST.md) shows what is complete, what
...
[local execution plan](docs/internal/LOCAL_EXECUTION_PLAN.md). The promoted-evidence snapshot
...
- [Proposal](docs/internal/PROPOSAL.md)
...
- [Initial usability readiness](docs/internal/READINESS.md)
- [Product readiness plan](docs/internal/PRODUCT_READINESS_PLAN.md)
