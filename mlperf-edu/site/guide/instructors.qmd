...
The plan hash proves which design ran, but the current grader does not compare a
student plan with the handout. For Examples 2 and 3, instructors must review the
submitted plan diff and accept only the documented candidate edit.
