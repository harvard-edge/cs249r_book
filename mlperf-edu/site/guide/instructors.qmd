...
interpret the quality card, then confirm configuration and checkpoint lineage,
and finally verify the provenance manifest. A `min` dashboard is evidence that
the setup works, not that the benchmark target was met.
