...
four-game review gate, pinned source files, workload-specific resumable
execution, and final run command. A handoff documents the reference path. It is
not a quality result and does not satisfy the local-execution milestone.
