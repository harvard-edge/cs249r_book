...
usage: mlperf doctor [-h]
                     [--suite {language,vision,tiny,graph,timeseries} | --workload WORKLOAD | --collection {starter,standard,research,all}]
                     [--profile {min,max,pro}] [--variant VARIANT]
                     [--format {summary,json}]

options:
  -h, --help            show this help message and exit
  --suite {language,vision,tiny,graph,timeseries}
...
usage: mlperf init [-h] [--profile {min,max,pro}]
                   [--suite {language,vision,tiny,graph,timeseries} | --workload WORKLOAD | --collection {starter,standard,research,all}]
                   [--variant VARIANT] [--model MODEL] [--no-smoke]
...
```text
usage: mlperf list [-h] [--suite {language,vision,tiny,graph,timeseries}]
...
```text
usage: mlperf info [-h]
                   (--suite {language,vision,tiny,graph,timeseries} | --profile {min,max,pro} | --workload WORKLOAD | --model MODEL | --dataset DATASET | --run RUN)
                   [--variant VARIANT]
...
options:
  ...
  --collection {starter,standard,research,all}
                        Run an explicit workload collection
  --profile {min,max,pro}
                        Run scale: min=quick representative path, max=full
                        suite, pro=research variants and knobs. Defaults to
                        min.
...
usage: mlperf run [-h]
                  [--suite {language,vision,tiny,graph,timeseries} | --workload WORKLOAD | --collection {starter,standard,research,all}]
                  [--profile {min,max,pro}] [--variant VARIANT]
                  [--output-dir OUTPUT_DIR] [--open-report] [--dry-run]
                  [--model MODEL] [--mode {training,inference}]
...
```text
usage: mlperf audit [-h] [--suite {language,vision,tiny,graph,timeseries}]
...
```text
usage: mlperf validate [-h] [--suite {language,vision,tiny,graph,timeseries}]
...
usage: mlperf cache [-h]
                    [--suite {language,vision,tiny,graph,timeseries} | --workload WORKLOAD]
                    [--profile {min,max,pro}] [--variant VARIANT]
                    [--format {summary,json}]
                    [{list,verify}]
