...
|---|---|---|---|---|
| `nanogpt-train` | `nanogpt-train` | `language` | `score-bearing` | [nanogpt-train.md](nanogpt-train.md) |
| `micro-dlrm-train` | `micro-dlrm-train` | `recommender` | `score-bearing` | [micro-dlrm-train.md](micro-dlrm-train.md) |
| `anomaly-ae-train` | `anomaly-ae-train` | `tiny` | `score-bearing` | [anomaly-ae-train.md](anomaly-ae-train.md) |
| `resnet18-train` | `resnet18-train` | `vision` | `score-bearing` | [resnet18-train.md](resnet18-train.md) |
| `mobilenetv2-train` | `mobilenetv2-train` | `vision` | `score-bearing` | [mobilenetv2-train.md](mobilenetv2-train.md) |
