...
| Condition | checkpoint-backed prefill completes and records positive throughput |
| Reference runs | 5 |
| Reviewer notes | Quality is inherited from the nanogpt-train checkpoint; this workload reports serving prefill performance. |
