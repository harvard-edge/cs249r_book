...
- replacement blocker: the committed packet is historical and uses a protocol superseded by the current benchmark contract; a clean reference sweep is required before promotion. Reason: The current contract evaluates the complete nonoverlapping held-out validation split and measures the canonical train-and-evaluation region; this packet predates both protections.
