...
def run_benchmark(provd_path: str, scenario: str):
    # Standalone CIFAR-100 reference hook. The product runner imports only the
    # ResNet18WhiteBox architecture from this module.
    ...
    console.print(
        "[Edge:Train] 🎓 Initializing Pedagogical White-Box Training for ResNet-18"
    )
    ...
    console.print(
        f"[Edge:Train] ⚙ Hardware Lock: Accelerating Native Graph over [bold green]{device}[/bold green]"
    )
    ...
    console.print("[Edge:Train] ✅ Pedagogical Native Convergence Verified.")
    ...
    console.print(
        "[Edge:Train] 💾 Model Graph sealed into ./data/resnet_student_weights.pt"
    )
