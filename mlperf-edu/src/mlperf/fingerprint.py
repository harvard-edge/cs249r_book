...
PERFORMANCE_ENVIRONMENT_ALLOWLIST = (
    ...
    "MLPERF_EDU_DEVICE",
    "MLPERF_EDU_FUNCTION_CALLING_PRECISION",
    ...
    "MLPERF_EDU_IMAGE_CLASSIFICATION_PRECISION",
    "MLPERF_EDU_INFORMATION_RETRIEVAL_PRECISION",
    ...
    "MLPERF_EDU_KEYWORD_SPOTTING_PRECISION",
    ...
    "MLPERF_EDU_PLAN_SETTLE_SECONDS",
    ...
    "MLPERF_EDU_VISUAL_WAKE_WORDS_PRECISION",
    "NCCL_ALGO",
    "NCCL_IB_DISABLE",
    "NCCL_P2P_DISABLE",
    "NCCL_PROTO",
