...
The Roofline model maps operational intensity (FLOPs/byte) against memory bandwidth (GB/s), based on \citet{williams2009roofline}. This mapping classifies the 14 single-node workloads into two categories, as illustrated in \Cref{fig:roofline}. The runtime distribution across workloads is shown in \Cref{fig:runtime}.
