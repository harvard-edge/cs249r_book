...
![The performance of the language model improves smoothly with model size, dataset size and the amount of compute used for training [@scaling_laws_NLM].](images/sustainable_ai/model_scaling.png){#fig-scaling-laws}
...
![The carbon footprint of large-scale ML tasks. It includes various models running at Meta. The emissions are categorized by offline training, online training, and inference [@wu2022sustainable].](images/sustainable_ai/model_carbonfootprint.png){#fig-model_carbonfootprint}
...
![Carbon footprint of NLP model in lbs of $\textrm{CO}_2$ equivalent. Source: [@dayarathna2015data]](images/sustainable_ai/carbon_benchmarks.png){#fig-carboncars}
...
![Energy is supplied by various sources which vary throughout the day. Renewable energy production shows high variability with time. Source: [Energy Charts](https://www.energy-charts.info/?l=en&c=DE).](images/sustainable_ai/europe_energy_grid.png){#fig-energyprod}
...
Beyond energy efficiency, sustainability assessment tools help evaluate the broader environmental impact of AI systems. These tools can analyze factors like the carbon footprint of AI operations, the lifecycle impact of hardware components [@gupta2022act], and the overall sustainability of AI projects [@prakashCFUPlaygroundFullStack2023].
