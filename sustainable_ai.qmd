...
![At both the data centers and the edge, demand for training and inference hardware is growing.](images/sustainable_ai/mckinsey_analysis.png ""){#fig-mckinsey}
...
![Infrastructure and the servers consume the most energy in a datacenter.](images/sustainable_ai/energy_datacenter.png){#fig-energydemand}
...
![Carbon footprint of NLP model in lbs of CO2 equivalent. Source: [@dayarathna2015data]](images/sustainable_ai/carbon_benchmarks.png){#fig-carboncars}
...
![Energy is supplied by various sources which vary throughout the day. Renewable energy production shows high variability with time. [Source](https://www.energy-charts.info/?l=en&c=DE).](images/sustainable_ai/europe_energy_grid.png){#fig-energyprod}
...
![A chart depicting the stages of the AI lifecycle, broken into 3 parts including Design, Develop, and Deploy.](images/sustainable_ai/ai_lifecycle.jpeg){#fig-lifecycle}
...
![Microsoft Azure now provides [dashboards](https://techcommunity.microsoft.com/t5/green-tech-blog/charting-the-path-towards-sustainable-ai-with-azure-machine/ba-p/2866923) to describe energy consumption for a job that is run](images/sustainable_ai/azure_dashboard.png){#fig-azuredashboard}
