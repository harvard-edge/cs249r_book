...
\newenvironment{fbxSimple}[3]{\begin{tcolorbox}[
  ...
  overlay={
      \node [left,outer sep=0em, black,draw=none,anchor=west,
        rectangle,fill=none,inner sep=0pt]
        at ([xshift=2mm]frame.west) {};%\includegraphics[width=4.2mm]{_extensions/custom-numbered-blocks/style/icons/icon_#1.pdf}
    },
  },
  colframe=#1-color2,
  colbacktitle=#1-color1,
  ...
  bottomtitle=1mm,
  toptitle=1mm,
  title={\begin{minipage}[t]{0.12\linewidth}%
    \raisebox{-0.6ex}{\includegraphics[width=4.2mm]{_extensions/custom-numbered-blocks/style/icons/icon_#1.pdf}}%
      \end{minipage}
       \hfill \begin{minipage}[t]{0.84\linewidth}\raggedright
        \textbf{#2}\hspace{0.1em}{#3}\end{minipage}},
  extras middle and last={top=3pt}
]}
{\end{tcolorbox}}
