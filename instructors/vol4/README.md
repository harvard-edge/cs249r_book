...
The [student competency matrix](../../labs/vol4/student-competencies.md) supplies a platform-independent 2×2 checklist. The [course operating plan](../../labs/vol4/course-architecture.md) and [lab blueprints](../../labs/vol4/lab-blueprints.md) provide instructor detail. The [feasibility plan](../../labs/vol4/feasibility-plan.md) tells the teaching team what must work before these briefs become runnable student assignments.
