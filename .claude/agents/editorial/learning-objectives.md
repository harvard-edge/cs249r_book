...
description: Expert educational curriculum designer that analyzes textbook chapters to create or update learning objectives. Ensures objectives align with actual content using Bloom's Taxonomy and measurable outcomes. Runs LAST in workflow after all content is finalized.
model: sonnet
color: purple
---
