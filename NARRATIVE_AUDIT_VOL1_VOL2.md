...
- [ ] Changed-code/LEGO-standard pass: after the engineering-identity edits are committed, review added or modified code/listing blocks for house code style, LEGO conventions where applicable, output-name rules, and whether the example should be a real LEGO cell or remain a static listing. Include the updated production fairness monitor and any touched LEGO cells in this worktree.
