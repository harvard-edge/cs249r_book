...
"""
    ...
    section_replacements = [
        ...
        ("## A Model Call in the Stochastic Computer {#sec-vol3-foundation-model-role}", "## The Model Invocation Boundary {#sec-vol3-foundation-model-role}"),
        ("#### Section 2.2: Tokens as the Processor Interface [core]", "#### Section 2.2: Discrete Token Representation [core]"),
        ("## Tokens as the Processor Interface {#sec-vol3-foundation-model-tokenization}", "## Discrete Token Representation {#sec-vol3-foundation-model-tokenization}"),
        ("#### Section 2.3: Next-Token Computation [core]", "#### Section 2.3: Autoregressive Generation [core]"),
        ("## Next-Token Computation {#sec-vol3-foundation-model-autoregressive}", "## Autoregressive Generation {#sec-vol3-foundation-model-autoregressive}"),
        ("#### Section 2.4: Candidate Sequences Versus Valid Conclusions [core]", "#### Section 2.4: Candidate Sequence Verification [core]"),
        ("## Candidate Sequences Versus Valid Conclusions {#sec-vol3-foundation-model-continuations}", "## Candidate Sequence Verification {#sec-vol3-foundation-model-continuations}"),
        ("#### Section 2.5: The Invocation Contract [core]", "#### Section 2.5: The Invocation Contract [core]"),
        ("## The Invocation Contract {#sec-vol3-foundation-model-contract}", "## The Invocation Contract {#sec-vol3-foundation-model-contract}"),
        ("#### Section 2.6: Constraining the Output Surface [core]", "#### Section 2.6: Grammar-Guided Decoding [core]"),
        ("## Constraining the Output Surface {#sec-vol3-foundation-model-grammar-constrained}", "## Grammar-Guided Decoding {#sec-vol3-foundation-model-grammar-constrained}"),
        ("#### Section 2.7: The Cost of an Invocation [core]", "#### Section 2.7: Accelerator Serving Latency [core]"),
        ("## The Cost of an Invocation {#sec-vol3-foundation-model-cost}", "## Accelerator Serving Latency {#sec-vol3-foundation-model-cost}"),
        ("#### Section 2.8: Processor Interface Evaluation [synthesis]", "#### Section 2.8: Interface Benchmarking [synthesis]"),
        ("## Processor Interface Evaluation {#sec-vol3-foundation-model-interface-design}", "## Interface Benchmarking {#sec-vol3-foundation-model-interface-design}"),
        # Chapter 03
        ("#### Section 3.3: Candidate Diversity and Selection [core]", "#### Section 3.3: Candidate Selection [core]"),
        ("## Candidate Diversity and Selection {#sec-vol3-test-time-compute-candidate-diversity}", "## Candidate Selection {#sec-vol3-test-time-compute-candidate-diversity}"),
        ("#### Section 3.4: Verification and Its Failure Modes [core]", "#### Section 3.4: Process Verification [core]"),
        ("## Verification and Its Failure Modes {#sec-vol3-test-time-compute-verification}", "## Process Verification {#sec-vol3-test-time-compute-verification}"),
        ("#### Section 3.6: Bounded Search and Stopping Rules [core]", "#### Section 3.6: Search Stopping Criteria [core]"),
        ("## Bounded Search and Stopping {#sec-vol3-test-time-compute-bounded-search}", "## Search Stopping Criteria {#sec-vol3-test-time-compute-bounded-search}"),
        # Chapter 04
        ("#### Section 4.2: Capacity, Cost, and Relevance [core]", "#### Section 4.2: Working Set Capacity [core]"),
        ("## Capacity, Cost, and Relevance {#sec-vol3-context-engineering-physics}", "## Working Set Capacity {#sec-vol3-context-engineering-physics}"),
        ("#### Section 4.4: Filtering and Lossy Compaction [core]", "#### Section 4.4: Context Compaction [core]"),
        ("## Filtering and Lossy Compaction {#sec-vol3-context-engineering-compaction}", "## Context Compaction {#sec-vol3-context-engineering-compaction}"),
        ("#### Section 4.5: Working Buffers and Checkpoint Summaries [core]", "#### Section 4.5: Context Checkpointing [core]"),
        ("## Working Buffers and Checkpoint Summaries {#sec-vol3-context-engineering-summarization}", "## Context Checkpointing {#sec-vol3-context-engineering-summarization}"),
        ("#### Section 4.6: Freshness and Context Invalidation [core]", "#### Section 4.6: Context Invalidation [core]"),
        ("## Freshness and Context Invalidation {#sec-vol3-context-engineering-context-rot}", "## Context Invalidation {#sec-vol3-context-engineering-context-rot}"),
        # Chapter 05
        ...
        ("## Peripheral Subsystem Abstraction {#sec-vol3-tool-calling-unix-analogy}", "## Tool Subsystem Architecture {#sec-vol3-tool-calling-unix-analogy}"),
        # Chapter 11
        ...
        ("## Fleet Performance and Serving Economics Synthesis {#sec-vol3-agent-economics-synthesis}", "## Serving Economics Synthesis {#sec-vol3-agent-economics-synthesis}"),
    ]
